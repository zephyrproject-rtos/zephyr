...
/*
 * @file
 * OpenHwGroup CVA6 test harness success/failure callback
 */
...
/**
 *
 * @brief In the cv[32|64]a6_testbench boards, inform the hardware simulator that
 *        a test case is over. In other cva6 boards, halts the CPU.
 *
 * @param status test status: 0 for success, other for failure
 */
