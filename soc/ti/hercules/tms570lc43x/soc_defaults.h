...
/*
 ...
 - PLLDIV = 31 (R = 32)
 - REFCLKDIV = 7 (ref clock divider = 8)
...
#define GHVSRC_INIT_VALUE	(1 << GHVWAKE_OFFSET | \
     1 << HVLPM_OFFSET | \
     1 << GHVSRC_OFFSET)
...
*/
#define VCLKACON1_INIT_VALUE	(0 << VCLKA4R_OFFSET | VCLKA4_DIV_CDDIS | \
    9 << VCLKA4S_OFFSET)
