...
/* Input / Hysteresis */
#define IOC_INPUT_ENABLE BIT(29) /* bit 29 */
#define IOC_HYST_ENABLE  BIT(30) /* bit 30 */

/* IOMODE field bits[26:24] */
#define IOC_IOMODE_OPEN_DRAIN_NORMAL BIT(26)
#define IOC_IOMODE_OPEN_SRC_NORMAL   (BIT(26) | BIT(25))

/* Pull field bits[15:14] — CC13x4 specific */
#define IOC_NO_IOPULL   (BIT(14) | BIT(15))
#define IOC_IOPULL_UP   BIT(15)
#define IOC_IOPULL_DOWN BIT(14)
