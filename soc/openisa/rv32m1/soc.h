 ...
 * CONFIG_MAX_IRQ_PER_2ND_LEVEL_AGGREGATOR interrupts to its level 1
 * interrupt.
 *
...
#if defined(CONFIG_DT_HAS_OPENISA_RI5CY_ENABLED)
#include <ri5cy_csr.h>
#elif defined(CONFIG_DT_HAS_OPENISA_ZERO_RI5CY_ENABLED)
