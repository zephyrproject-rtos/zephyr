...
#define REG_EP_BUF_STA_EP0_INBUF_FULL_Pos   0
#define REG_EP_BUF_STA_EP0_INBUF_EMPTY_Pos  1
#define REG_EP_BUF_STA_EP1_INBUF_FULL_Pos   2
#define REG_EP_BUF_STA_EP1_INBUF_EMPTY_Pos  3
#define REG_EP_BUF_STA_EP2_INBUF_FULL_Pos   4
#define REG_EP_BUF_STA_EP2_INBUF_EMPTY_Pos  5
#define REG_EP_BUF_STA_EP3_INBUF_FULL_Pos   6
#define REG_EP_BUF_STA_EP3_INBUF_EMPTY_Pos  7
#define REG_EP_BUF_STA_EP4_INBUF_FULL_Pos   8
#define REG_EP_BUF_STA_EP4_INBUF_EMPTY_Pos  9
#define REG_EP_BUF_STA_EP0_OUTBUF_FULL_Pos  10
#define REG_EP_BUF_STA_EP0_OUTBUF_EMPTY_Pos 11
#define REG_EP_BUF_STA_EP1_OUTBUF_FULL_Pos  12
#define REG_EP_BUF_STA_EP1_OUTBUF_EMPTY_Pos 13
#define REG_EP_BUF_STA_EP2_OUTBUF_FULL_Pos  14
#define REG_EP_BUF_STA_EP2_OUTBUF_EMPTY_Pos 15
#define REG_EP_BUF_STA_EP3_OUTBUF_FULL_Pos  16
#define REG_EP_BUF_STA_EP3_OUTBUF_EMPTY_Pos 17
#define REG_EP_BUF_STA_EP4_OUTBUF_FULL_Pos  18
#define REG_EP_BUF_STA_EP4_OUTBUF_EMPTY_Pos 19
...
/* Sys Ctrl Group */
#define REG_EM32_SYS_CTRL ((uint32_t)(EM32_SYS_CTRL_BASE + SYSCTRL_SYS_CTRL_OFF))
/* AIP Group */
