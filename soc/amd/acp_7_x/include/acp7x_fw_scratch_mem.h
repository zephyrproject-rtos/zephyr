...
#ifndef ZEPHYR_SOC_AMD_ACP_7_X_ACP7X_FW_SCRATCH_MEM_H_
#define ZEPHYR_SOC_AMD_ACP_7_X_ACP7X_FW_SCRATCH_MEM_H_
...
typedef struct acp_scratch_memory_config {
	...
	uint8_t acp_transmit_fifo_buffer[256] __aligned(128);

	/* ACP receive fifo buffer */
	uint8_t acp_receive_fifo_buffer[256] __aligned(128);
	/* Reserved for future use */
	uint32_t reserve[];
} __packed __aligned(4) acp_scratch_mem_config_t;

#endif /* ZEPHYR_SOC_AMD_ACP_7_X_ACP7X_FW_SCRATCH_MEM_H_ */
