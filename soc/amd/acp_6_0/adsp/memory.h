...
#define UUID_ENTRY_ELF_SIZE 0x6000/* Log buffer  base need to be updated properly, these are used in linker scripts */
...
#define HEAP_RUNTIME_SIZE (HEAP_RT_COUNT8 * 8 + HEAP_RT_COUNT16 * 16 + \
