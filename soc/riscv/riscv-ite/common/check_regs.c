...
/* SPI register structure check */
IT8XXX2_REG_SIZE_CHECK(spi_it8xxx2_regs, 0x34);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPIDATA, 0x00);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPICTRL1, 0x01);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPICTRL2, 0x02);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPISTS, 0x03);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPICTRL3, 0x04);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0CMDADDRLB, 0x05);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0CMDADDRHB, 0x06);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, DMATCNTLB, 0x07);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, DMATCNTHB, 0x08);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPIWRCMDL, 0x09);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0DMARDLB, 0x0A);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0DMARDHB, 0x0B);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, INTSTS, 0x0C);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPICTRL5, 0x0D);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0WRMEMADDRLB, 0x0E);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0WRMEMADDRHB, 0x0F);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CMDQINVPR, 0x10);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0WTSR, 0x11);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1CMDADDRLB, 0x12);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1CMDADDRHB, 0x13);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1WRMEMADDRLB, 0x14);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1WRMEMADDRHB, 0x15);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1WTSR, 0x16);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1DMARDLB, 0x17);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1DMARDHB, 0x18);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0CMDADDRHB2, 0x21);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH0WRMEMADDRHB2, 0x23);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1CMDADDRHB2, 0x25);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, CH1WRMEMADDRHB2, 0x27);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, DSFBCR, 0x2D);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPIRDATA, 0x2E);
IT8XXX2_REG_OFFSET_CHECK(spi_it8xxx2_regs, SPICTRL6, 0x33);
