...
def parse_args():
    ...
    parser.add_argument('-F',
                        ...
                        type=int,
                        dest="spi_freq",
                        choices=[SYS_CLK_DIV_2, SYS_CLK_DIV_4, SYS_CLK_DIV_8, SYS_CLK_DIV_16],
                        default=SYS_CLK_DIV_16,
...
def main():
    ...
    img_gen(args.load_addr, args.spi_freq, args.spi_rdcmd, args.original_bin, args.signed_bin)
