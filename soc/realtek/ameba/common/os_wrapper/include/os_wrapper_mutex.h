...
/**
 * @brief  Take a mutex. The API internally determines whether it is in the interrupt state and
 *         calls the corresponding RTOS interface.
 * @param  p_handle: Address of the mutex
 * @param  wait_ms: The time in milliseconds to wait, 0xFFFFFFFF means Block infinitely until
 *                  the semaphore taken.
 * @retval The status is RTK_SUCCESS or RTK_FAIL
 */
...
/**
 * @brief  Give a semaphore. The API internally determines whether it is in the interrupt state and
 *         calls the corresponding RTOS interface.
 * @param  p_handle: Address of the mutex
 * @retval The status is RTK_SUCCESS or RTK_FAIL
 */
...
/**
 * @brief  Creates a new recursive mutex, compared to semaphores, Mutex has a priority
 *         inheritance mechanism. Dynamic allocate memory.
 * @note   Usage example:
 * Create:
 *          rtos_mutex_t mutex_handle;
