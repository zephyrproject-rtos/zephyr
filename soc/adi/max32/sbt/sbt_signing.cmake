...
if(signing_tool_path STREQUAL signing_tool_path-NOTFOUND)
  ...
  set(key_path ${CONFIG_SOC_FAMILY_MAX32_SECURE_SOC_KEY_PATH})
  string(CONFIGURE "${key_path}" key_path)
  ...
  if(key_path STREQUAL "")
    ...
    message(STATUS "\"${key_path}\" will be used to sign the image.")

    # sign_app expects the SOC name in uppercase in order to identify corresponding device .ini file.
    string(TOUPPER "${CONFIG_SOC}" soc_string)
