...
/* Upper bound of the cache MMU entries shared between flash
 * instruction and rodata regions, used by the boot loader to split
 * the cache MMU. The esp32c61 soc headers do not provide it.
 */
