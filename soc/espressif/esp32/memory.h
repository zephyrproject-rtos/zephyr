...
#define SRAM0_START           0x40070000
#define SRAM0_CACHE_SIZE      0x10000
#define SRAM0_IRAM_SIZE       0x20000
#define SRAM0_IRAM_START      (SRAM0_START + SRAM0_CACHE_SIZE)
...
#define SRAM1_USER_SIZE       (SRAM1_DRAM_END - SRAM1_DRAM_USER_START)
