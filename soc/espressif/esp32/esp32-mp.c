		    ...
		    arch_cpustart_t fn, void *arg)
{
	...
	esp_intr_alloc(DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, irq),
		esp_intr_level_to_flags(DT_IRQ_BY_IDX(
			DT_NODELABEL(ipi0), 0, priority)) |
		esp_intr_flags_check(DT_IRQ_BY_IDX(
			DT_NODELABEL(ipi0), 0, flags)) | ESP_INTR_FLAG_IRAM,
		esp_crosscore_isr,
		NULL,
		NULL);
	...
	esp_intr_alloc(DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, irq),
		esp_intr_level_to_flags(DT_IRQ_BY_IDX(
			DT_NODELABEL(ipi1), 0, priority)) |
		esp_intr_flags_check(DT_IRQ_BY_IDX(
			DT_NODELABEL(ipi1), 0, flags)) | ESP_INTR_FLAG_IRAM,
		esp_crosscore_isr,
		NULL,
		NULL);
