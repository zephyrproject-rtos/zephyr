		    ...
		    arch_cpustart_t fn, void *arg)
{
	...
	IRQ_CONNECT(DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, irq),
		    DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, priority), esp_crosscore_isr, (void *)0,
		    DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, flags));
	irq_matrix_enable(DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, irq),
			  DT_IRQ_BY_IDX(DT_NODELABEL(ipi0), 0, source));

	IRQ_CONNECT(DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, irq),
		    DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, priority), esp_crosscore_isr, (void *)1,
		    DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, flags));
	irq_matrix_enable(DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, irq),
			  DT_IRQ_BY_IDX(DT_NODELABEL(ipi1), 0, source));
