...
/* AMP. CONFIG_SOC_ENABLE_APPCPU is set on both images of an AMP pair, so
 * it is what tells the PROCPU image to keep the APPCPU areas out of its
 * own regions.
 */
...
#elif defined(CONFIG_SOC_ESP32S3_APPCPU)
