...
/* Cached memory */
#if USE_APPCPU_AMP
#define APPCPU_IROM_SIZE   0x100000 // dts
#define APPCPU_DROM_SIZE   0x100000 // dts
#else
...
#define ICACHE_START  0x42000000 // dts
#define ICACHE_SIZE   0x2000000 // dts
#define DCACHE_START  0x3c000000 // dts
#define DCACHE_SIZE   0x2000000 //dts
				//
