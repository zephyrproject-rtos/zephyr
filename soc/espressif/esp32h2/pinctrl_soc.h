...
/**
 * @file
 * ESP32H2 SoC specific helpers for pinctrl driver
 */

#ifndef ZEPHYR_SOC_RISCV_ESP32H2_PINCTRL_SOC_H_
#define ZEPHYR_SOC_RISCV_ESP32H2_PINCTRL_SOC_H_
...
#endif /* ZEPHYR_SOC_RISCV_ESP32H2_PINCTRL_SOC_H_ */
