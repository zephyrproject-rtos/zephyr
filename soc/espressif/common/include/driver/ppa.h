...
#ifndef ZEPHYR_SOC_ESPRESSIF_COMMON_INCLUDE_DRIVER_PPA_H_
#define ZEPHYR_SOC_ESPRESSIF_COMMON_INCLUDE_DRIVER_PPA_H_
...
#endif /* ZEPHYR_SOC_ESPRESSIF_COMMON_INCLUDE_DRIVER_PPA_H_ */
