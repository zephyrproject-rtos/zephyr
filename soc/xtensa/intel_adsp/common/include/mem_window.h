...
#define HP_SRAM_WIN0_SIZE HP_SRAM_WIN0_BASE + WIN_SIZE(0)

#define HP_SRAM_WIN1_BASE L2_SRAM_BASE + WIN1_OFFSET
#define HP_SRAM_WIN1_SIZE HP_SRAM_WIN1_BASE + WIN_SIZE(1)

#define HP_SRAM_WIN2_BASE L2_SRAM_BASE + WIN2_OFFSET
#define HP_SRAM_WIN2_SIZE HP_SRAM_WIN2_BASE + WIN_SIZE(2)
