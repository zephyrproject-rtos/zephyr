...
#define DT_USB_DW_IRQ			DT_SNPS_DWC_USBD_0_IRQ_0
#define DT_USB_DW_IRQ_PRI		DT_SNPS_DWC_USBD_0_IRQ_0_PRIORITY
#define DT_USB_IRQ_FLAGS		DT_SNPS_DWC_USBD_0_IRQ_0_SENSE
#define DT_USB_DW_BASE			DT_SNPS_DWC_USBD_0_BASE_ADDRESS
