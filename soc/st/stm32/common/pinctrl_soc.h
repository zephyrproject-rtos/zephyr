...
/* Port Mode */
#define STM32_MODE_INOUT_Pos		0
#define STM32_MODE_INOUT_Msk		(0x1 << STM32_MODE_INOUT_Pos)
#define STM32_MODE_INPUT		(0x0 << STM32_MODE_INOUT_Pos)
#define STM32_MODE_OUTPUT		(0x1 << STM32_MODE_INOUT_Pos)

/* Input Port configuration */
#define STM32_CNF_IN_Pos		1
#define STM32_CNF_IN_Msk		(0x3 << STM32_CNF_IN_Pos)
#define STM32_CNF_IN_ANALOG		(0x0 << STM32_CNF_IN_Pos)
#define STM32_CNF_IN_FLOAT		(0x1 << STM32_CNF_IN_Pos)
#define STM32_CNF_IN_PUPD		(0x2 << STM32_CNF_IN_Pos)

/* Output Port configuration */
#define STM32_MODE_OSPEED_Pos		3
#define STM32_MODE_OSPEED_Msk		(0x3 << STM32_MODE_OSPEED_Pos)
#define STM32_MODE_OUTPUT_MAX_10	(0x0 << STM32_MODE_OSPEED_Pos)
#define STM32_MODE_OUTPUT_MAX_2		(0x1 << STM32_MODE_OSPEED_Pos)
#define STM32_MODE_OUTPUT_MAX_50	(0x2 << STM32_MODE_OSPEED_Pos)

#define STM32_CNF_OUT_0_Pos		5
#define STM32_CNF_OUT_0_Msk		(0x1 << STM32_CNF_OUT_0_Pos)
#define STM32_CNF_PUSH_PULL		(0x0 << STM32_CNF_OUT_0_Pos)
#define STM32_CNF_OPEN_DRAIN		(0x1 << STM32_CNF_OUT_0_Pos)

#define STM32_CNF_OUT_1_Pos		6
#define STM32_CNF_OUT_1_Msk		(0x1 << STM32_CNF_OUT_1_Pos)
#define STM32_CNF_GP_OUTPUT		(0x0 << STM32_CNF_OUT_1_Pos)
#define STM32_CNF_ALT_FUNC		(0x1 << STM32_CNF_OUT_1_Pos)

/* GPIO High impedance/Pull-up/Pull-down */
#define STM32_PUPD_Pos			7
#define STM32_PUPD_Msk			(0x3 << STM32_PUPD_Pos)
#define STM32_PUPD_NO_PULL		(0x0 << STM32_PUPD_Pos)
#define STM32_PUPD_PULL_UP		(0x1 << STM32_PUPD_Pos)
#define STM32_PUPD_PULL_DOWN		(0x2 << STM32_PUPD_Pos)

/* GPIO plain output value */
#define STM32_ODR_Pos			9
...
#define Z_PINCTRL_STM32_PINCFG_INIT(node_id)				       \
	(((STM32_NO_PULL * DT_PROP(node_id, bias_disable)) << STM32_PUPD_Pos) | \
	 ((STM32_PULL_UP * DT_PROP(node_id, bias_pull_up)) << STM32_PUPD_Pos) | \
	 ((STM32_PULL_DOWN * DT_PROP(node_id, bias_pull_down)) << STM32_PUPD_Pos) | \
	 ((STM32_PUSH_PULL * DT_PROP(node_id, drive_push_pull)) << STM32_CNF_OUT_0_Pos) | \
	 ((STM32_OPEN_DRAIN * DT_PROP(node_id, drive_open_drain)) << STM32_CNF_OUT_0_Pos) | \
	 ((STM32_OUTPUT_LOW * DT_PROP(node_id, output_low)) << STM32_ODR_Pos) | \
	 ((STM32_OUTPUT_HIGH * DT_PROP(node_id, output_high)) << STM32_ODR_Pos) | \
	 (DT_ENUM_IDX(node_id, slew_rate) << STM32_MODE_OSPEED_Pos))
#else
 ...
 */
#define Z_PINCTRL_STM32_PINCFG_INIT(node_id)				       \
	(((STM32_NO_PULL * DT_PROP(node_id, bias_disable)) << STM32_PUPDR_Pos) | \
	 ((STM32_PULL_UP * DT_PROP(node_id, bias_pull_up)) << STM32_PUPDR_Pos) | \
	 ((STM32_PULL_DOWN * DT_PROP(node_id, bias_pull_down)) << STM32_PUPDR_Pos) | \
	 ((STM32_PUSH_PULL * DT_PROP(node_id, drive_push_pull)) << STM32_OTYPER_Pos) | \
	 ((STM32_OPEN_DRAIN * DT_PROP(node_id, drive_open_drain)) << STM32_OTYPER_Pos) | \
	 ((STM32_OUTPUT_LOW * DT_PROP(node_id, output_low)) << STM32_ODR_Pos) | \
	 ((STM32_OUTPUT_HIGH * DT_PROP(node_id, output_high)) << STM32_ODR_Pos) | \
	 ((STM32_GPIO_OUTPUT * DT_PROP(node_id, output_low)) << STM32_MODER_Pos) | \
	 ((STM32_GPIO_OUTPUT * DT_PROP(node_id, output_high)) << STM32_MODER_Pos) | \
	 (DT_ENUM_IDX(node_id, slew_rate) << STM32_OSPEEDR_Pos) | \
