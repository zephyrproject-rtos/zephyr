...
/**
 * @file
 * STM32 SoC specific definitions for wake-up pins config
 */

#ifndef ZEPHYR_SOC_ARM_ST_STM32_COMMON_WKUP_PINS_CTRL_H_
#define ZEPHYR_SOC_ARM_ST_STM32_COMMON_WKUP_PINS_CTRL_H_
...
#endif /* ZEPHYR_SOC_ARM_ST_STM32_COMMON_WKUP_PINS_CTRL_H_ */
