...
static const struct arm_mmu_region mmu_regions[] = {
	...
	MMU_REGION_FLAT_ENTRY("AHB2", 0x48000000, 0x4000, MPERM_R | MPERM_W | MT_DEVICE),

	MMU_REGION_FLAT_ENTRY("APB6", 0x4C000000, 0xC400, MPERM_R | MPERM_W | MT_DEVICE),

	MMU_REGION_FLAT_ENTRY("AHB4", 0x50000000, 0x1D400, MPERM_R | MPERM_W | MT_DEVICE),
	...
	MMU_REGION_FLAT_ENTRY("DAPBUS", 0xE0080000, 0x5DD00, MPERM_R | MPERM_W | MT_DEVICE),
};
