...
/******************************************************************/
const struct gpio_dt_spec general_debug_table[RT_DEBUG_SIGNALS_TOTAL_NUM] = {
  [RT_DEBUG_SIGNAL_UNUSED] = { 0 },
  ...
  [RT_DEBUG_LOW_POWER_STOP2_MODE_ENTER] = GPIO_DEBUG_LOW_POWER_STOP2_MODE_ENTER,
#endif /* USE_RT_DEBUG_LOW_POWER_STOP2_MODE_ENTER */

#if (USE_RT_DEBUG_LOW_POWER_STOP2_MODE_EXIT == 1)
  [RT_DEBUG_LOW_POWER_STOP2_MODE_EXIT] = GPIO_DEBUG_LOW_POWER_STOP2_MODE_EXIT,
#endif /* USE_RT_DEBUG_LOW_POWER_STOP2_MODE_EXIT */

#if (USE_RT_DEBUG_LOW_POWER_STOP2_MODE_ACTIVE == 1)
  [RT_DEBUG_LOW_POWER_STOP2_MODE_ACTIVE] = GPIO_DEBUG_LOW_POWER_STOP2_MODE_ACTIVE,
...
void RT_DEBUG_GPIO_Init(void)
{
  ...
  if (general_table_size > 1)
  {
    for(unsigned int cpt = 1; cpt<general_table_size ; cpt++)
    {
        if (gpio_is_ready_dt(&general_debug_table[cpt])) 
        {
          gpio_pin_configure_dt(&general_debug_table[cpt], (GPIO_OUTPUT_ACTIVE | STM32_GPIO_PWR_RETENTION_STANDBY_ON));
        }
    }
  }
#endif /* CFG_RT_DEBUG_GPIO_MODULE */
