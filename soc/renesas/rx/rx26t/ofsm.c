 ...
 *
 * Address range: 0x00120040 to 0x001200ff
 */
...
/* Option function select register 0 (OFS0) at 0x00120068 (Watchdog settings)
 */

const unsigned long __OFS0 __OFS0reg = 0xffffffffU;

/* Option Function Select Register 1 (OFS1) at 0x0012006C (Voltage detection and
 * HOCO)
 */
