...
"""
    ...
    def __write_shared_table(self, fp):
        ...
        for i in range(self.__nv):
            if self.__aligned_swt()[i] is None:
                client_num = 0
                client_list = None
            else:
                client_num = len(self.__aligned_swt()[i])
                client_list = self.__aligned_swt()[i]
    ...
    def write_source(self, fp):
        ...
        for i in range(self.__nv):
            if len(self.__aligned_swt()[i]) == 0:
                ...
                # Single interrupt
                param = "{0:#x}".format(self.__aligned_swt()[i][0][0])
                func = self.__aligned_swt()[i][0][1]
            else:
                # Shared interrupt
