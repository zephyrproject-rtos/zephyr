...
const struct xtensa_mmu_range xtensa_soc_mmu_ranges[] = {
	...
	MEM_MAP_CONST_REGION(
		IMR_BOOT_LDR_LIT_BASE,
		IMR_BOOT_LDR_LIT_BASE + IMR_BOOT_LDR_LIT_SIZE,
		XTENSA_MMU_PERM_W | XTENSA_MMU_PERM_X | XTENSA_MMU_MAP_SHARED,
		"imr lit"
	)

	MEM_MAP_CONST_REGION(
		IMR_BOOT_LDR_TEXT_BASE,
		IMR_BOOT_LDR_TEXT_BASE + IMR_BOOT_LDR_TEXT_SIZE,
		XTENSA_MMU_PERM_W | XTENSA_MMU_PERM_X | XTENSA_MMU_MAP_SHARED,
		"imr text"
	)

	MEM_MAP_CONST_REGION(
		IMR_BOOT_LDR_DATA_BASE,
		IMR_BOOT_LDR_DATA_BASE + IMR_BOOT_LDR_DATA_SIZE,
