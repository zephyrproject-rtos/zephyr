...
/**
 * @file Common power management for Nordic nRF54H SoCs.
 */

#ifndef ZEPHYR_SOC_NORDIC_NRF54H_SOC_POWER_H_
#define ZEPHYR_SOC_NORDIC_NRF54H_SOC_POWER_H_
...
#endif /* ZEPHYR_SOC_NORDIC_NRF54H_SOC_POWER_H_ */
