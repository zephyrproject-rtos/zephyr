...
#elif defined(CONFIG_NRFX_GPPI_EXT_ALLOCATOR)
...
#else /* defined(CONFIG_NRFX_GPPI_EXT_ALLOCATOR) */
#if defined(NRFX_GPPI_MULTI_DOMAIN) && !defined(NRFX_GPPI_FIXED_CONNECTIONS)
	gppi_instance.routes = nrfx_gppi_routes_get();
	gppi_instance.route_map = nrfx_gppi_route_map_get();
	gppi_instance.nodes = nrfx_gppi_nodes_get();
...
#error "Not supported"
#endif
#endif /* defined(CONFIG_NRFX_GPPI_EXT_ALLOCATOR) */
...
#define GPPI_INIT_PRIO                                                                             \
	COND_CODE_1(IS_ENABLED(CONFIG_NRFX_GPPI_SD2PPI_GLOBAL),                 \
		    (UTIL_INC(COND_CODE_1(CONFIG_GPPI_EXT_ALLOCATOR_CLI,        \
			(CONFIG_IPC_SERVICE_REG_BACKEND_PRIORITY),              \
			(CONFIG_IRONSIDE_SE_CALL_INIT_PRIORITY)))), (0))
