...
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_RX == 3)
#define PIN_USART0_RXD {gpioPortE, 12, gpioModeInput, 1}
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_RX == 4)
#define PIN_USART0_RXD {gpioPortB, 8, gpioModeInput, 1}
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_RX == 5) || \
	(DT_SILABS_GECKO_USART_USART_0_LOCATION_RX == 6)
...
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_TX == 3)
#define PIN_USART0_TXD {gpioPortE, 13, gpioModePushPull, 1}
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_TX == 4)
#define PIN_USART0_TXD {gpioPortB, 7, gpioModePushPull, 1}
#elif (DT_SILABS_GECKO_USART_USART_0_LOCATION_TX == 5) || \
	(DT_SILABS_GECKO_USART_USART_0_LOCATION_TX == 6)
...
#define PIN_USART1_RXD {gpioPortC, 1, gpioModeInput, 1}
	...
	(DT_SILABS_GECKO_USART_USART_1_LOCATION_RX == 3)
#define PIN_USART1_RXD {gpioPortD, 6, gpioModeInput, 1}
#elif (DT_SILABS_GECKO_USART_USART_1_LOCATION_RX == 4)
#define PIN_USART1_RXD {gpioPortA, 0, gpioModeInput, 1}
#elif (DT_SILABS_GECKO_USART_USART_1_LOCATION_RX == 5)
...
#define PIN_USART1_TXD {gpioPortC, 0, gpioModePushPull, 1}
	...
	(DT_SILABS_GECKO_USART_USART_1_LOCATION_TX == 3)
...
#elif (DT_SILABS_GECKO_USART_USART_1_LOCATION_TX == 5)
