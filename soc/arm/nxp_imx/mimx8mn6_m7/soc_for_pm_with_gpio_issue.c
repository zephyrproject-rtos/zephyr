...
static void SOC_RdcInit(void)
{
	...
	/*
	 *Needed fro static partioning of resource between M7 and A53 cores
	 *
	 */
...
{
    /* switch everything to 24MHz since Linux kernel disables PLL (for now) */
