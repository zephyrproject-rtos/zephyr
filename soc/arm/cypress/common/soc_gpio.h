...
#define SOC_GPIO_FLAGS_MASK             (31 << SOC_GPIO_FLAGS_POS)
...
#define SOC_GPIO_STRONG_POS             (3)
#define SOC_GPIO_STRONG                 (1 << SOC_GPIO_STRONG_POS)
#define SOC_GPIO_INPUTBUFFER_POS        (4)
#define SOC_GPIO_INPUTBUFFER            (1 << SOC_GPIO_INPUTBUFFER_POS)

/* Bit field: SOC_GPIO_IN_FILTER */
#define SOC_GPIO_IN_FILTER_POS          (5)
...
#define SOC_GPIO_FUNC_MASK              (31 << SOC_GPIO_FUNC_POS)
 ...
 * - connect pin(s) to a peripheral function and enable pull-up.
