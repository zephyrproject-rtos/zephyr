...
//#define ispip                ((ISPIP_T *) ISPIP_BASE)                   /* ISPIP Struct       */
//#define ISPIP                ((volatile unsigned long  *) ISPIP_BASE)   /* ISPIP  array       */
...
//-- For OEM Use -----------------------------------------------
unsigned char ISPIP_Protect_Set(unsigned char, unsigned short, unsigned short, unsigned char, unsigned char);
