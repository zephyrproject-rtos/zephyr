...
//-- For OEM Use -----------------------------------------------
void ADC_Init(unsigned short ADC_Ch);                       //start convert
unsigned short ADC_Get_Data(unsigned char ADC_Ch);
void ADC_Disable(unsigned short ADC_Ch);
void ADC_Scan_Enable(void);
void ADC_Scan_Disable(void);
#endif  //ADC_SUPPORT
