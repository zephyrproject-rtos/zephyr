...
//#define spih                ((SPIH_T *) SPIH_BASE)             /* SPIH Struct       */
//#define SPIH                ((volatile unsigned long  *) SPIH_BASE)     /* SPIH  array       */

//***************************************************************
// User Define                                                
//***************************************************************
#define SUPPORT_SPIH                    USR_SUPPORT_SPIH
#define SUPPORT_SPIH_CS_OpenDrain       USR_SUPPORT_SPIH_CS_OpenDrain
#define SELECT_SPIH_DI                  USR_SELECT_SPIH_DI
...
//#define SPIH_PINOUT_GPIO24252627        0x01 
//#define SPIH_PINOUT_GPIO5A585C5B        0x02
//#define SPIH_PINOUT_GPIO60616278        0x03
...
//-- For OEM Use -----------------------------------------------
#if SUPPORT_SPIH
void SPIH_Init(unsigned char bBus, unsigned char bMode, unsigned char bCLKSpeed);
void SPIH_RAM_Rearrange(unsigned char *pDat, unsigned short bLen);
unsigned char SPIH_ByteMode(unsigned char bDat);
void SPIH_BlockTransaction(unsigned char *pTxDat, unsigned char bLen, unsigned char *pRxDat, unsigned char bNum_RxIgnore);
void SPIH_GPIO_Enable(unsigned char bBus);
void SPIH_GPIO_Disable(unsigned char bBus);
