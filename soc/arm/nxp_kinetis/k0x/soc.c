...
/**
 * @file
 * @brief System/hardware module for fsl_frdm_k0xf platform
 *
 * This module provides routines to initialize and support board-level
 * hardware for the fsl_frdm_k0xf platform.
 */
...
static ALWAYS_INLINE void clkInit(void)
{
	...
	MCG->C1 = ((MCG->C1 & ~MCG_C1_FRDIV_MASK) | MCG_C1_FRDIV(0x3U));

	CLOCK_BootToFeeMode(kMCG_OscselOsc, 0x3U/* FLL reference clock divider: divided by 256 */, kMCG_Dmx32Default, kMCG_DrsHigh, NULL);
...
static int fsl_frdm_k0xf_init(struct device *arg)
{
	ARG_UNUSED(arg);
...
SYS_INIT(fsl_frdm_k0xf_init, PRE_KERNEL_1, 0);
