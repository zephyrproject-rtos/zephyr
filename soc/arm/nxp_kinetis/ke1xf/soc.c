...
#endif
#ifdef DT_ALIAS_I2C_0_CLOCK_IP_SOURCE
	CLOCK_SetIpSrc(kCLOCK_Lpi2c0, DT_ALIAS_I2C_0_CLOCK_IP_SOURCE);
#endif
#ifdef DT_ALIAS_I2C_1_CLOCK_IP_SOURCE
	CLOCK_SetIpSrc(kCLOCK_Lpi2c1, DT_ALIAS_I2C_1_CLOCK_IP_SOURCE);
#endif
#ifdef DT_ALIAS_SPI_0_CLOCK_IP_SOURCE
	CLOCK_SetIpSrc(kCLOCK_Lpspi0, DT_ALIAS_SPI_0_CLOCK_IP_SOURCE);
#endif
#ifdef DT_ALIAS_SPI_1_CLOCK_IP_SOURCE
	CLOCK_SetIpSrc(kCLOCK_Lpspi1, DT_ALIAS_SPI_1_CLOCK_IP_SOURCE);
#endif
