...
/** RTC Frequency */
/*  Divider = 2 ^ (DT_INST_0_ATMEL_SAM0_RTC_PRESCALER), see 19.8.1 */
#if   DT_INST_0_ATMEL_SAM0_RTC_CLOCK_GENERATOR == 0
#define SOC_ATMEL_SAM0_RTC_FREQ_HZ (SOC_ATMEL_SAM0_GCLK0_FREQ_HZ \
		/ (1 << DT_INST_0_ATMEL_SAM0_RTC_PRESCALER))
#elif DT_INST_0_ATMEL_SAM0_RTC_CLOCK_GENERATOR == 1
#define SOC_ATMEL_SAM0_RTC_FREQ_HZ (SOC_ATMEL_SAM0_GCLK1_FREQ_HZ \
		/ (1 << DT_INST_0_ATMEL_SAM0_RTC_PRESCALER))
#elif DT_INST_0_ATMEL_SAM0_RTC_CLOCK_GENERATOR == 2
#define SOC_ATMEL_SAM0_RTC_FREQ_HZ (SOC_ATMEL_SAM0_GCLK2_FREQ_HZ \
		/ (1 << DT_INST_0_ATMEL_SAM0_RTC_PRESCALER))
#endif /* DT_INST_0_ATMEL_SAM0_RTC_CLOCK_GENERATOR */
