...
#define PMC_CKGR_PLLAR_MULA	\
	(CKGR_PLLAR_MULA(CONFIG_SOC_ATMEL_SAMV70_PLLA_MULA))
#define PMC_CKGR_PLLAR_DIVA	\
	(CKGR_PLLAR_DIVA(CONFIG_SOC_ATMEL_SAMV70_PLLA_DIVA))

#if CONFIG_SOC_ATMEL_SAMV70_MDIV == 1
#define SOC_ATMEL_SAMV70_MDIV PMC_MCKR_MDIV_EQ_PCK
#elif CONFIG_SOC_ATMEL_SAMV70_MDIV == 2
#define SOC_ATMEL_SAMV70_MDIV PMC_MCKR_MDIV_PCK_DIV2
#elif CONFIG_SOC_ATMEL_SAMV70_MDIV == 3
#define SOC_ATMEL_SAMV70_MDIV PMC_MCKR_MDIV_PCK_DIV3
#elif CONFIG_SOC_ATMEL_SAMV70_MDIV == 4
#define SOC_ATMEL_SAMV70_MDIV PMC_MCKR_MDIV_PCK_DIV4
#else
#error "Invalid CONFIG_SOC_ATMEL_SAMV70_MDIV define value"
#endif
...
static ALWAYS_INLINE void clock_init(void)
{
...
#ifdef CONFIG_SOC_ATMEL_SAMV70_EXT_SLCK
...
#endif /* CONFIG_SOC_ATMEL_SAMV70_EXT_SLCK */

#ifdef CONFIG_SOC_ATMEL_SAMV70_EXT_MAINCK
	/*
...
#ifdef CONFIG_SOC_ATMEL_SAMV70_WAIT_MODE
	/*
...
#endif /* CONFIG_SOC_ATMEL_SAMV70_EXT_MAINCK */
	...
	PMC->PMC_MCKR = reg_val | SOC_ATMEL_SAMV70_MDIV;
 ...
 * @return 0
 */
static int atmel_samv70_init(const struct device *arg)
{
	uint32_t key;
...
SYS_INIT(atmel_samv70_init, PRE_KERNEL_1, 0);
