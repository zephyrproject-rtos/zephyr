...
/** @file
 * @brief System module to support early Atmel SAM V70 MCU configuration
 */
 ...
 * @return 0
 */
static int atmel_samv70_config(const struct device *dev)
{
#ifdef CONFIG_SOC_ATMEL_SAMV70_DISABLE_ERASE_PIN
...
SYS_INIT(atmel_samv70_config, PRE_KERNEL_1, 1);
