...
#ifndef ZEPHYR_SOC_MICROCHIP_PIC32C_PIC32CM_PL_COMMON_PINCTRL_SOC_H
#define ZEPHYR_SOC_MICROCHIP_PIC32C_PIC32CM_PL_COMMON_PINCTRL_SOC_H
...
#define Z_PINCTRL_MCHP_PINFLAG_INIT(node_id, prop, idx)                                            \
	((DT_PROP(node_id, bias_pull_up) << MCHP_PINCTRL_PULLUP_POS) |                             \
	 ...
	 (DT_PROP(node_id, slew_limit_en) << MCHP_PINCTRL_SLEWRATE_POS)),
...
#define MCHP_PINCTRL_INPUTENABLE_POS   (MCHP_PINCTRL_PULLDOWN_POS + 1U)
...
#define MCHP_PINCTRL_SLEWRATE          (1U << MCHP_PINCTRL_SLEWRATE_POS)
...
#endif /*ZEPHYR_SOC_MICROCHIP_PIC32C_PIC32CM_PL_COMMON_PINCTRL_SOC_H*/
