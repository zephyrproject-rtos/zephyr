...
static const struct arm_mmu_region mmu_regions[] = {
	...
	IF_ENABLED(DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(qspi0)),
		   (MMU_REGION_FLAT_ENTRY("qspi0", QSPI0_BASE_ADDRESS, 0x4000,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))

	IF_ENABLED(DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(qspi0)),
		(MMU_REGION_FLAT_ENTRY("qspi0mem", QSPI_MEM0_ADDR, 0x10000000,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))

	IF_ENABLED(DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(qspi1)),
		   (MMU_REGION_FLAT_ENTRY("qspi1", QSPI1_BASE_ADDRESS, 0x4000,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))

	IF_ENABLED(DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(qspi1)),
		(MMU_REGION_FLAT_ENTRY("qspi1mem", QSPI_MEM1_ADDR, 0x10000000,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))
