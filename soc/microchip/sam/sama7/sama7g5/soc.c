...
static const struct arm_mmu_region mmu_regions[] = {
	...
	DT_HAS_COMPAT_STATUS_OKAY(microchip_udphs_g1_udc)
	...
	IF_ENABLED(DT_HAS_COMPAT_STATUS_OKAY(microchip_smc_g1_memc),
		   (MMU_REGION_FLAT_ENTRY("hsmc", HSMC_BASE_ADDRESS, 0x4000,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))

	FOR_EACH_IDX(MMU_REGION_MCAN_DEFN, (), 0, 1, 2, 3, 4, 5)

	IF_ENABLED(DT_HAS_COMPAT_STATUS_OKAY(microchip_nfc_g1_flash),
		   (MMU_REGION_FLAT_ENTRY("nfc-sram", NFC_RAM_ADDR, NFC_RAM_SIZE,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),
		    MMU_REGION_FLAT_ENTRY("nfc-io", NFC_ADDR, NFC_SIZE,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W |
					  MATTR_MAY_MAP_L1_SECTION),
		    MMU_REGION_FLAT_ENTRY("nand-io", EBI_CS3_ADDR, CONFIG_MMU_PAGE_SIZE,
					  MT_STRONGLY_ORDERED | MPERM_R | MPERM_W),))
