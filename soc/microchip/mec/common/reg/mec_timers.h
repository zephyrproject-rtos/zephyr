...
#define MCHP_WKTMR_SWKC_PWRUP_EV_STS_MASK    BIT(MCHP_WKTMR_SWKC_PWRUP_EV_STS_POS)
#define MCHP_WKTMR_SWKC_PWRUP_EV_STS         BIT(MCHP_WKTMR_SWKC_PWRUP_EV_STS_POS)
#define MCHP_WKTMR_SWKC_SYSPWR_PRES_STS_POS  4
#define MCHP_WKTMR_SWKC_SYSPWR_PRES_STS_MASK BIT(MCHP_WKTMR_SWKC_SYSPWR_PRES_STS_POS)
...
#define MCHP_WKTMR_SWKC_SYSPWR_PRES_EN_MASK  BIT(MCHP_WKTMR_SWKC_SYSPWR_PRES_EN_POS)
#define MCHP_WKTMR_SWKC_SYSPWR_PRES_EN       BIT(MCHP_WKTMR_SWKC_SYSPWR_PRES_EN_POS)
#define MCHP_WKTMR_SWKC_AUTO_RELOAD_POS      6
#define MCHP_WKTMR_SWKC_AUTO_RELOAD_MASK     BIT(MCHP_WKTMR_SWKC_AUTO_RELOAD_POS)
#define MCHP_WKTMR_SWKC_AUTO_RELOAD          BIT(MCHP_WKTMR_SWKC_AUTO_RELOAD_POS)
