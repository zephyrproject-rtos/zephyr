...
/* Slave-to-Master VW byte index values or byte offset in 64 bit register */
...
/*
 * src is 0 through 3
 * isel = MEC_MSVW_SRC_IRQ_SEL_LVL_xxx values
 */
...
/** @brief eSPI 96-bit Controller-to-Target Virtual Wire register */
...
/** @brief eSPI 96-bit Controller-to-Target Virtual Wire register as bytes */
struct espi_msvwb_reg {
	volatile uint8_t HTVWB[12];
};

/** @brief HW implements 11 Controller-to-Target VW registers as an array */
struct espi_msvw_ar_regs {
	struct espi_msvw_reg MSVW[11];
};

/** @brief HW implements 11 Controller-to-Target VW registers as named registers */
