...
/** @file
 * @brief Microchip PIC32CXSG MCU family I/O Pin Controller (PORT)
 */

#ifndef MICROCHIP_PIC32CXSG_SOC_PORT_H_
#define MICROCHIP_PIC32CXSG_SOC_PORT_H_
...
#endif /* MICROCHIP_PIC32CXSG_SOC_PORT_H_ */
