...
#include <stdint.h>
#ifndef __cplusplus
typedef volatile const uint32_t RoReg;   /** Read only 32-bit reg (volatile const unsigned int) */
typedef volatile const uint16_t RoReg16; /** Read only 16-bit reg (volatile const unsigned int) */
typedef volatile const uint8_t RoReg8;   /** Read only  8-bit reg (volatile const unsigned int) */
#else                                    /* #ifndef __cplusplus */
typedef volatile uint32_t RoReg;   /** Read only 32-bit reg (volatile const unsigned int) */
typedef volatile uint16_t RoReg16; /** Read only 16-bit reg (volatile const unsigned int) */
typedef volatile uint8_t RoReg8;   /** Read only  8-bit reg (volatile const unsigned int) */
#endif
typedef volatile uint32_t WoReg;   /** Write only 32-bit reg (volatile unsigned int) */
typedef volatile uint16_t WoReg16; /** Write only 16-bit reg (volatile unsigned int) */
typedef volatile uint8_t WoReg8;   /** Write only  8-bit reg (volatile unsigned int) */
typedef volatile uint32_t RwReg;   /** Read-Write 32-bit reg (volatile unsigned int) */
typedef volatile uint16_t RwReg16; /** Read-Write 16-bit reg (volatile unsigned int) */
typedef volatile uint8_t RwReg8;   /** Read-Write  8-bit reg (volatile unsigned int) */
...
#define _UL_(x) x##UL /** C code: Unsigned Long literal constant value */
#else                 /* Assembler */
#define _U_(x)  x     /** Assem: Unsigned integer literal constant value */
#define _L_(x)  x     /** Assem: Long literal constant value */
#define _UL_(x) x     /** Assem: Unsigned Long literal constant value */
...
#define NVMCTRL_TEMP_LOG (0x00800100UL)            /**< \brief (NVMCTRL) TEMP_LOG Base Addr */
...
#define OSC32KCTRL          ((Osc32kctrl *)0x40001400UL) /**< \brief (OSC32KCTRL) APB Base Addr */
