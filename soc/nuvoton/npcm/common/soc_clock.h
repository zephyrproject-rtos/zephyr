...
#ifndef _NUVOTON_NPCM_SOC_CLOCK_H_
#define _NUVOTON_NPCM_SOC_CLOCK_H_

#ifdef __cplusplus
extern "C" {
#endif

/* Common clock control device name for all NPCM series */
#define NPCM_CLK_CTRL_NODE DT_NODELABEL(pcc)

/**
 * @brief NPCM clock configuration structure
 *
 ...
 */
void npcm_clock_capture_low_freq_timer(void);
 ...
 *
 */
void npcm_clock_compensate_system_timer(void);
 ...
 *
 */
uint64_t npcm_clock_get_sleep_ticks(void);
 ...
 *                   enabled
 */
void npcm_clock_control_turn_on_system_sleep(bool is_deep, bool is_instant);

/**
 * @brief Function to turn off system sleep mode.
 */
void npcm_clock_control_turn_off_system_sleep(void);

#ifdef __cplusplus
}
#endif

#endif /* _NUVOTON_NPCM_SOC_CLOCK_H_ */
