...
/* M4 status register */
#define SIWX91X_M4_WAKEUP_TA             BIT(0)  /* M4 requests to the NWP to wake up */
#define SIWX91X_M4_IS_ACTIVE             BIT(1)  /* M4 is awake */
#define SIWX91X_TA_WAKEUP_M4             BIT(2)  /* NWP request to the M4 to wake up (Read only) */
#define SIWX91X_TA_IS_ACTIVE             BIT(3)  /* NWP is awake (Read only) */
