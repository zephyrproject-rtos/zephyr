...
#if defined(CONFIG_LV_USE_DRAW_VG_LITE) || defined(CONFIG_VGLITE)
...
void gpu_cache_flush_range(void *addr, size_t size)
{
	sys_cache_data_flush_all();
}
#endif /* CONFIG_LV_USE_DRAW_VG_LITE || CONFIG_VGLITE */
