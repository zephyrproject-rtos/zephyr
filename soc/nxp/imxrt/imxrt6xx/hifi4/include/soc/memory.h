...
#define DATA_NOCACHE_BASE (CONFIG_RT685_ADSP_DATA_NOCACHE_MEM_ADDR)
#define DATA_NOCACHE_SIZE (CONFIG_RT685_ADSP_DATA_NOCACHE_MEM_SIZE - CONFIG_RT685_ADSP_STACK_SIZE)

#define FLASH_BASE (CONFIG_RT685_ADSP_FLASH_MEM_ADDR)
#define FLASH_SIZE (CONFIG_RT685_ADSP_FLASH_MEM_SIZE)
