...
#define IOPCTL_PIO_ODENA(x)		 (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_ODENA_SHIFT)) \
									& IOPCTL_PIO_ODENA_MASK)

#define IOPCTL_PIO_IBENA_MASK    (0x40U)
#define IOPCTL_PIO_IBENA_SHIFT   (6U)
#define IOPCTL_PIO_IBENA(x)      (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_IBENA_SHIFT)) \
									& IOPCTL_PIO_IBENA_MASK)
...
#define IOPCTL_PIO_SLEWRATE(x)    (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_SLEWRATE_SHIFT)) \
									& IOPCTL_PIO_SLEWRATE_MASK)
...
#define IOPCTL_PIO_FULLDRIVE(x)    (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_FULLDRIVE_SHIFT)) \
									& IOPCTL_PIO_FULLDRIVE_MASK)

#define IOPCTL_PIO_IIENA_MASK      (0x800U)
#define IOPCTL_PIO_IIENA_SHIFT     (11U)
#define IOPCTL_PIO_IIENA(x)        (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_IIENA_SHIFT)) \
									& IOPCTL1_PIO_IIENA_MASK)

/* Please note there is no AMENA attribution on IOPCTL2 */
#define IOPCTL_PIO_AMENA_MASK      (0x200U)
#define IOPCTL_PIO_AMENA_SHIFT     (9U)
#define IOPCTL_PIO_AMENA(x)        (((uint32_t)(((uint32_t)(x)) << IOPCTL_PIO_AMENA_SHIFT)) \
									& IOPCTL_PIO_AMENA_MASK)
