...
#define IOCON_PIO_DIGITAL_EN	IOCON_PIO_DIGIMODE(0x1)
...
#define IOCON_PIO_INPFILT_OFF	IOCON_PIO_FILTEROFF(0x1)
#define IOCON_PIO_INV_DI	0x00u
#define IOCON_PIO_MODE_INACT	0x00u
#define IOCON_PIO_OPENDRAIN_DI	0x00u
#define IOCON_PIO_SLEW_STANDARD	0x00u
#define IOCON_PIO_MODE_PULLUP	IOCON_PIO_MODE(0x2)
#define IOCON_PIO_MODE_PULLDOWN	IOCON_PIO_MODE(0x1)
