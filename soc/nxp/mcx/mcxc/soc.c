...
const mcglite_config_t mcgliteConfig_BOARD_BootClockRUN = {
	...
	.fcrdiv = CONFIG_MCG_FCRDIV,             /* Low-frequency Reference Clock Divider */
	.lircDiv2 = CONFIG_MCG_LIRCDIV2,         /* Second Low-frequency Reference Clock Divider */
...
const osc_config_t oscConfig_BOARD_BootClockRUN = {
	...
	.capLoad = 0,
#if defined(CONFIG_MCXC_OSC_EXTERNAL)
	.workMode = kOSC_ModeExt,
#elif defined(CONFIG_MCXC_OSC_LOW_POWER)
	.workMode = kOSC_ModeOscLowPower,
#elif defined(CONFIG_MCXC_OSC_HIGH_GAIN)
