 ...
 *
 * @param p_backend	Backend instance.
...
#define LOG_INIT(timstamp_func, freq) log_init(timstamp_func, freq)
#define LOG_PANIC() log_panic()
#define LOG_PROCESS() log_process()
#else
#define LOG_INIT(timstamp_func, freq) (int)0
