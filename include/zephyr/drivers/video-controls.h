...
#define VIDEO_CID_HFLIP			(VIDEO_CID_BASE + 0)
/** Mirror the picture vertically */
#define VIDEO_CID_VFLIP			(VIDEO_CID_BASE + 1)
 ...
 * @{
 */
#define VIDEO_CID_CAMERA_EXPOSURE	(VIDEO_CID_CAMERA_CLASS_BASE + 0)
#define VIDEO_CID_CAMERA_GAIN		(VIDEO_CID_CAMERA_CLASS_BASE + 1)
#define VIDEO_CID_CAMERA_ZOOM		(VIDEO_CID_CAMERA_CLASS_BASE + 2)
#define VIDEO_CID_CAMERA_BRIGHTNESS	(VIDEO_CID_CAMERA_CLASS_BASE + 3)
#define VIDEO_CID_CAMERA_SATURATION	(VIDEO_CID_CAMERA_CLASS_BASE + 4)
#define VIDEO_CID_CAMERA_WHITE_BAL	(VIDEO_CID_CAMERA_CLASS_BASE + 5)
#define VIDEO_CID_CAMERA_CONTRAST	(VIDEO_CID_CAMERA_CLASS_BASE + 6)
#define VIDEO_CID_CAMERA_COLORBAR	(VIDEO_CID_CAMERA_CLASS_BASE + 7)
#define VIDEO_CID_CAMERA_QUALITY	(VIDEO_CID_CAMERA_CLASS_BASE + 8)
#define VIDEO_CID_CAMERA_HUE		(VIDEO_CID_CAMERA_CLASS_BASE + 9)
/**
 * @}
 */
