...
/** Amount of time an image sensor is exposed to light, affecting how much comes in */
#define VIDEO_CID_EXPOSURE (VIDEO_CID_BASE + 17)

/** Amount of amplification performed to the image signal, affecting the brightness */
 ...
 * @{
 */
#define VIDEO_CID_VENDOR_CLASS_BASE 0x00ff0900
