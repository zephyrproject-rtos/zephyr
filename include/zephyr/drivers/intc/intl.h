 ...
 * @param node_id Interrupt controller's devicetree node
 */
#define INTC_DT_INTLS(node_id) \
	_CONCAT(SYS_DT_IRQ_INTLS_, DT_DEP_ORD(node_id))
 ...
 * @param node_id Interrupt controller's devicetree node
 */
#define INTC_DT_IMPL_INTLS(node_id) \
	_CONCAT(SYS_DT_IRQ_IMPL_INTLS_, DT_DEP_ORD(node_id))
...
#define INTC_DT_INST_INTLS(inst) \
	INTC_DT_INTLS(DT_DRV_INST(inst))

#define INTC_DT_INST_IMPL_INTLS(inst) \
	INTC_DT_IMPL_INTLS(DT_DRV_INST(inst))
