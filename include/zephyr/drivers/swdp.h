...
/**
 * @brief Interfaces to Serial Wire Debug Port (SWDP).
...
/**
 * @name SWDP Packet Request Bits
 *
 * Bit definitions for SWDP packet request fields.
 * These bits are used to construct the 8-bit request packet header sent during SWDP transactions.
 *
 * @{
 */
...
/**
 * @name SWDP Acknowledge Response Bits
 *
 * Bit definitions for SWDP acknowledge response fields.
 * These bits are used to indicate the result of an SWDP transaction.
 *
 * @{
 */
