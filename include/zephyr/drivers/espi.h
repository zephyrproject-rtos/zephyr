 ...
 */
enum espi_bus_event {
	/** Indicates the eSPI bus was reset.
	 * eSPI drivers should conveyed the eSPI reset status in an event following eSPI reset pin convention.
	 ...
	 * eSPI drivers should conveyed the eSPI virtual wire latest status.
	 */
