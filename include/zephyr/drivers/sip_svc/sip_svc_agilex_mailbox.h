...
#ifndef ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_SIP_SVC_AGILEX_MAILBOX_H_
#define ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_SIP_SVC_AGILEX_MAILBOX_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_SIP_SVC_AGILEX_MAILBOX_H_ */
