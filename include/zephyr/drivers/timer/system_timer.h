 ...
 *
 * This is only available when CONFIG_SYSTEM_CLOCK_HW_CYCLES_PER_SEC_RUNTIME_UPDATE
 * is enabled.
 *
 ...
 *
 * @param old_hz Previous system timer frequency in Hz.
 * @param new_hz New system timer frequency in Hz.
 */
