...
/**
 * @brief Interrupt Latency Counter(ILC) Interface
 * @defgroup interrupt_latency_counter_interface SingleInterrupt Latency Counter(ILC) Interface
 ...
 *
 *  @param  dev             : ILC device instance.
 *  @param  params          : Pointer to read ILC parameters.
 *
 *  @return  0 on success, negative errno code on fail.
 */
