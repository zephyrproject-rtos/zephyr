...
/**
 * @brief VL53L0X-specific sensor attributes.
 *
 * These attributes are used with sensor_attr_set() and sensor_attr_get() to
 * configure ranging mode, timing, limits, calibration, and measurement
 * profiles.
 */
