...
/**
 * @file
 * @brief Header file for HX7xx family of sensors
 * @ingroup hx7xx_interface
 */
...
/**
 * @defgroup hx7xx_interface HX7xx
 * @ingroup sensor_interface_ext
 * @brief 24-Bit Analog-to-Digital Converter (ADC) for Weigh Scales
 * @{
 */
...
/**
 * Allowed set of gains used in HX7xx sensors.
 */
enum hx7xx_gain {
	/** Gain factor 8 */
	HX7xx_GAIN_8X = 8,
...
/**
 * Allowed set of rates used in HX7xx sensors.
 */
enum hx7xx_rate {
