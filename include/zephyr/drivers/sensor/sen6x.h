...
/**
 * @brief Custom sensor channels for SEN6X.
 */
enum sensor_channel_sen6x {
	/** NOx index **/
	SENSOR_CHAN_SEN6X_NOX_INDEX = SENSOR_CHAN_PRIV_START,
	/** VOC index **/
	SENSOR_CHAN_SEN6X_VOC_INDEX,
};
...
/**
 * @brief SEN6X temperature offset parameters.
 */
...
/**
 * @brief SEN6X temperature acceleration parameters.
 */
...
/**
 * @brief SEN6X algorithm tuning parameters.
 */
...
/**
 * @brief SEN6X VOX algorithm state.
 */
