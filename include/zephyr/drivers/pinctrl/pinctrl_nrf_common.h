...
#ifndef ZEPHYR_INCLUDE_DRIVERS_PINCTRL_PINCTRL_NRF_COMMON_H_
#define ZEPHYR_INCLUDE_DRIVERS_PINCTRL_PINCTRL_NRF_COMMON_H_
...
struct nrf_pinctrl_pin {
	...
	bool invert;
	bool clock_pin_en;
	bool gpd_fast_active1;
	uint8_t fun;
};

/** Pin level initialization */
enum nrf_pinctrl_write {
	NRF_PINCTRL_WRITE_CLEAR = 0,
	NRF_PINCTRL_WRITE_SET = 1,
	NRF_PINCTRL_WRITE_NONE,
};

/** Struct describing nrf_gpio configuration to be applied. */
struct nrf_pinctrl_config {
	enum nrf_pinctrl_write write;
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_PINCTRL_PINCTRL_NRF_COMMON_H_ */
