...
/**
 * @defgroup max2221x_interface MAX2221X MISC
...
enum max2221x_fault_pin_masks {
	...
	MAX2221X_FAULT_PIN_INVALID, /**< Invalid fault pin sentinel */
};
...
enum max2221x_vm_threshold {
	MAX2221X_VM_THRESHOLD_DISABLED = 0, /**< Threshold disabled */
	MAX2221X_VM_THRESHOLD_4500MV,       /**< 4500 mV threshold */
	MAX2221X_VM_THRESHOLD_6500MV,       /**< 6500 mV threshold */
	MAX2221X_VM_THRESHOLD_8500MV,       /**< 8500 mV threshold */
	MAX2221X_VM_THRESHOLD_10500MV,      /**< 10500 mV threshold */
	MAX2221X_VM_THRESHOLD_12500MV,      /**< 12500 mV threshold */
	MAX2221X_VM_THRESHOLD_14500MV,      /**< 14500 mV threshold */
	MAX2221X_VM_THRESHOLD_16500MV,      /**< 16500 mV threshold */
	MAX2221X_VM_THRESHOLD_18500MV,      /**< 18500 mV threshold */
	MAX2221X_VM_THRESHOLD_20500MV,      /**< 20500 mV threshold */
	MAX2221X_VM_THRESHOLD_22500MV,      /**< 22500 mV threshold */
	MAX2221X_VM_THRESHOLD_24500MV,      /**< 24500 mV threshold */
	MAX2221X_VM_THRESHOLD_26500MV,      /**< 26500 mV threshold */
	MAX2221X_VM_THRESHOLD_28500MV,      /**< 28500 mV threshold */
	MAX2221X_VM_THRESHOLD_30500MV,      /**< 30500 mV threshold */
	MAX2221X_VM_THRESHOLD_32500MV,      /**< 32500 mV threshold */

	MAX2221X_VM_THRESHOLD_INVALID, /**< Invalid threshold sentinel */
};

/** @brief Control mode options */
enum max2221x_ctrl_mode {
	MAX2221X_CTRL_MODE_VOLT = 0,     /**< Voltage drive mode */
	MAX2221X_CTRL_MODE_CDR,          /**< Current drive mode */
	MAX2221X_CTRL_MODE_LIMITER_VOLT, /**< Voltage drive with current limiter mode */
	MAX2221X_CTRL_MODE_VOLT_CDR,     /**< Voltage and current drive mode */

	MAX2221X_CTRL_MODE_INVALID, /**< Invalid control mode sentinel */
};

/** @brief Channel frequency divisor options */
enum max2221x_ch_freq_div {
	MAX2221X_CH_FREQ_DIV_1 = 0, /**< No frequency division */
	MAX2221X_CH_FREQ_DIV_2,     /**< Frequency divided by 2 */
	MAX2221X_CH_FREQ_DIV_4,     /**< Frequency divided by 4 */
	MAX2221X_CH_FREQ_DIV_8,     /**< Frequency divided by 8 */

	MAX2221X_CH_FREQ_DIV_INVALID, /**< Invalid frequency divisor sentinel */
};

/** @brief Slew rate options */
enum max2221x_slew_rate {
	MAX2221X_SLEW_RATE_FAST = 0,    /**< Fast slew rate */
	MAX2221X_SLEW_RATE_400V_PER_US, /**< 400 V/us slew rate */
	MAX2221X_SLEW_RATE_200V_PER_US, /**< 200 V/us slew rate */
	MAX2221X_SLEW_RATE_100V_PER_US, /**< 100 V/us slew rate */

	MAX2221X_SLEW_RATE_INVALID, /**< Invalid slew rate sentinel */
};

/** @brief Gain scale options */
enum max2221x_gain {
	MAX2221X_SCALE_1 = 0, /**< Gain scale factor 1 */
	MAX2221X_SCALE_2,     /**< Gain scale factor 2 */
	MAX2221X_SCALE_3,     /**< Gain scale factor 3 */
	MAX2221X_SCALE_4,     /**< Gain scale factor 4 */

	MAX2221X_GAIN_INVALID, /**< Invalid gain sentinel */
};

/** @brief Sense filter options */
enum max2221x_snsf {
	MAX2221X_SNSF_FULL_SCALE = 0, /**< Full scale sense filter */
 ...
 *
 * int ret = max2221x_set_master_chop_freq(dev, MAX2221X_FREQ_50KHZ);
 * if (ret)
 ...
 * #include <zephyr/drivers/misc/max2221x/max2221x.h>
 *
 * int ret = max2221x_set_vm_upper_threshold(dev, MAX2221X_VM_THRESHOLD_4500MV);
 * if (ret)
 ...
 * #include <zephyr/drivers/misc/max2221x/max2221x.h>
 *
 * int ret = max2221x_set_vm_lower_threshold(dev, MAX2221X_VM_THRESHOLD_4500MV);
 * if (ret)
 ...
 * #include <zephyr/drivers/misc/max2221x/max2221x.h>
 *
 * int ret = max2221x_set_snsf(dev, 1, MAX2221X_SNSF_2_3);
 * if (ret)
