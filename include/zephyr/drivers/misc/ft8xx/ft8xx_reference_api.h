...
static inline void cmd_slider(int16_t x,
			      ...
			      uint16_t range)
{
	ft8xx_copro_cmd_slider(x, y, w, h, options, val, range);
}
...
static inline void cmd_toggle(int16_t x,
			      ...
			      const char *s)
{
	ft8xx_copro_cmd_toggle(x, y, w, font, options, state, s);
}
...
static inline void cmd_track(int16_t x,
			     ...
			     int16_t tag)
{
	ft8xx_copro_cmd_track(x, y, w, h, tag);
}
