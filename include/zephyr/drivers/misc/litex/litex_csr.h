...
#ifndef ZEPHYR_INCLUDE_DRIVERS_MISC_LITEX_LITEX_CSR_H_
#define ZEPHYR_INCLUDE_DRIVERS_MISC_LITEX_LITEX_CSR_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_MISC_LITEX_LITEX_CSR_H_ */
