...
#ifndef ZEPHYR_INCLUDE_DRIVERS_BLUETOOTH_HCI_NXP_SETUP_H_
#define ZEPHYR_INCLUDE_DRIVERS_BLUETOOTH_HCI_NXP_SETUP_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_BLUETOOTH_HCI_NXP_SETUP_H_ */
