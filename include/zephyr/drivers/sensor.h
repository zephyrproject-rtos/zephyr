...
enum sensor_channel {
	...
	/** 1.0 micro-meters Particulate Matter (under atmospheric environment), in ug/m^3 */
	SENSOR_CHAN_PM_1_0_ATM,
	/** 2.5 micro-meters Particulate Matter (under atmospheric environment), in ug/m^3 */
	SENSOR_CHAN_PM_2_5_ATM,
	/** 10.0 micro-meters Particulate Matter (under atmospheric environment), in ug/m^3 */
	SENSOR_CHAN_PM_10_0_ATM,
