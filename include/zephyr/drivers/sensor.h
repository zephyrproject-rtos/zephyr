...
int sensor_fn_with_no_documentation(int p1, int p2);

/**
 * @brief This function has incomplete documentation.
 *
 * @param p1 This is the first parameter.
 * @return int This is the return value.
 */
int sensor_fn_with_incomplete_documentation(int p1, int p2);
