 ...
 */
__syscall int i2c_configure_dt(const struct i2c_dt_spec *spec, uint32_t dev_config);

static inline int z_impl_i2c_configure_dt(const struct i2c_dt_spec *spec,
						uint32_t dev_config)
{
