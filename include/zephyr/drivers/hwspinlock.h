...
/**
 * @file
 * @brief Public APIs for HWSPINLOCK drivers
 */
 ...
 */
#define HWSPINLOCK_DT_SPEC_GET(node_id) HWSPINLOCK_DT_SPEC_GET_BY_IDX(node_id, 0)
 ...
 */
#define HWSPINLOCK_DT_SPEC_INST_GET(inst) HWSPINLOCK_DT_SPEC_GET(DT_DRV_INST(inst))
