...
/**
 * @file
 * @brief Public Single Event Upsets(SEU) driver APIs
 */
...
/**
 * @brief Single Event Upsets(SEU) Interface
 * @defgroup single_event_upsets_interface Single Event Upsets(SEU) Interface
...
enum inject_seu_error {
	/** Enum for inject Single bit SEU error type */
	INJECT_SINGLE_BIT_SEU_ERROR = 0,
	/** Enum for inject double bit SEU error type */
...
enum inject_ecc_error {
	/** Enum for inject Single bit ECC error type */
	INJECT_SINGLE_BIT_ECC_ERROR = 1,
	/** Enum for inject Double bit ECC error type */
 ...
 */
enum seu_reg_mode {
	/** Enum for SEU error type */
	SEU_ERROR_MODE = 0,
	/** Enum for ECC error type */
	ECC_ERROR_MODE,
	/** Enum for MISC CNT error type */
	MISC_CNT_ERROR_MODE,
	/** Enum for PMF error type */
	PMF_ERROR_MODE,
	/** Enum for MISC SDM error type */
	MISC_SDM_ERROR_MODE,
	/** Enum for EMIF error type */
	MISC_EMIF_ERROR_MODE,
	/** Enum for MAX error type */
	MAX_SEU_ERROR_MODE
};
 ...
 *
 * @param dev          Pointer to the device structure for the driver instance.
 * @param ecc_error_frame  Pointer to the error frame structure containing ECC error information.
 *
 * @return             0 if the SEU error frame is successfully inserted, an error code otherwise.
 */
