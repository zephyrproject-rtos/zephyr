...
#ifndef ZEPHYR_INCLUDE_BLUETOOTH_DRIVERS_WUC_NXP_WUU_H_
#define ZEPHYR_INCLUDE_BLUETOOTH_DRIVERS_WUC_NXP_WUU_H_
...
#endif /* ZEPHYR_INCLUDE_BLUETOOTH_DRIVERS_WUC_NXP_WUU_H_ */
