 ...
 */
typedef int (*board_id_read_t)(const struct device *dev, uint8_t *buffer, size_t length);
 ...
 */
__syscall int board_id_read(const struct device *dev, uint8_t *buffer, size_t length);

static inline int z_impl_board_id_read(const struct device *dev, uint8_t *buffer, size_t length)
{
