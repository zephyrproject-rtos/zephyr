...
/**
 * @brief Check if two flash ranges on the same device overlap.
 *
 * @param a_start offset of first range.
 * @param a_size size of first range.
 * @param b_start offset of second range.
 * @param b_size size of second range.
 *
 * @retval 0 if the ranges do not overlap.
 * @retval 1 if the ranges overlap.
 ...
 *
 * The caller must supply a buffer of suitable size.
 *
