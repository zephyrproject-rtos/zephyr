 ...
 *
 * @note With the asynchronous functions, it is possible that the calling thread
 *       can be preempted and waiting after starting the transfer, and therefore
 *       appear that the notification happens before the function returns.
 *
 * @{
 */
