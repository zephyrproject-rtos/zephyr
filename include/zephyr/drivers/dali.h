...
/**
 * @brief Callback API up transmitting a DALI frame.
 ...
 * function is called in interruot context.
 ...
 *                  is blocking until frame is completely sent. The callback must
 *                  be ``NULL`` if called from user mode.
 * @param user_data User data to pass to callback function.
 *
