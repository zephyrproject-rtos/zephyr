...
{                                                                                                  \
	.dev = COND_CODE_1(DT_DMAS_HAS_NAME(node_id, name),                                        \
		DEVICE_DT_GET(DT_DMAS_CTLR_BY_NAME(node_id, name)), NULL),                         \
	.channel = DT_DMAS_CELL_BY_NAME_OR(node_id, name, channel, default_value),                 \
	.request = DT_DMAS_CELL_BY_NAME_OR(node_id, name, request, default_value),                 \
	.config = DT_DMAS_CELL_BY_NAME_OR(node_id, name, config, default_value),                   \
}
