...
#define ADS1220_REG0_MUX_V_REF       (0xCu << ADS1220_REG0_MUX_POS) /* (V_REFPx–V_REFNx) / 4 monitor */
#define ADS1220_REG0_MUX_AVDD_AVSS_1 (0xDu << ADS1220_REG0_MUX_POS) /* (AVDD–AVSS) / 4 monitor */
