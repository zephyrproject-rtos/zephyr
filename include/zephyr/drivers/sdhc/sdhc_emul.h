 ...
 *
 * @retval 0       Success.
 * @retval -ENODEV No emulated card is registered.
 */
int sdhc_emul_set_fault(const struct device *dev, uint8_t cmd_index);
 ...
 * @retval -ENODEV No emulated card is registered.
 */
int sdhc_emul_clear_fault(const struct device *dev);
 ...
 * @retval -ENODEV No emulated card is registered.
 */
int sdhc_emul_set_card_present(const struct device *dev, bool present);
 ...
 * @retval NULL No emulated card is registered.
 */
 ...
 * @retval -ENODEV No emulated card is registered.
 */
int sdhc_emul_get_block_count(const struct device *dev, uint32_t *count);
