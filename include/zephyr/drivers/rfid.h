 ...
 * @return 0 on success.
 */
__syscall int rfid_claim(const struct device *dev);

static inline int z_impl_rfid_claim(const struct device *dev)
{
 ...
 * @return 0 on success.
 */
__syscall int rfid_release(const struct device *dev);

static inline int z_impl_rfid_release(const struct device *dev)
{
