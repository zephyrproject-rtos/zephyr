 ...
 *
 * @param dev nPM1300 MFD device instance
 * @return Return value from i2c_write_dt
 */
int mfd_npm1300_ship(const struct device *dev);

/**
 * @brief Enter hibernate mode
 *
 * @param dev nPM1300 MFD device instance
 * @param time_ms Hibernation time in ms
 * @return Return value from mfd_npm1300_set_timer or i2c_write_dt
 */
