...
#ifndef ZEPHYR_INCLUDE_ZEPHYR_DRIVERS_LIN_TRANSCEIVER_H
#define ZEPHYR_INCLUDE_ZEPHYR_DRIVERS_LIN_TRANSCEIVER_H
...
/**
 * @brief Callback API upon enabling LIN transceiver
 * See @a lin_transceiver_enable() for argument description.
 */
typedef int (*lin_transceiver_enable_t)(const struct device *dev, uint8_t flags);

/**
 * @brief Callback API upon disabling LIN transceiver
 * See @a lin_transceiver_disable() for argument description.
 */
typedef int (*lin_transceiver_disable_t)(const struct device *dev);

/**
 * @driver_ops{LIN Transceiver}
 */
__subsystem struct lin_transceiver_driver_api {
	/** @driver_ops_mandatory @copybrief lin_transceiver_enable */
	lin_transceiver_enable_t enable;
	/** @driver_ops_mandatory @copybrief lin_transceiver_disable */
 ...
 * @param flags Flags to control the behavior of the transceiver. Specific to each transceiver.
...
#endif /* ZEPHYR_INCLUDE_ZEPHYR_DRIVERS_LIN_TRANSCEIVER_H */
