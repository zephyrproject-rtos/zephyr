...
#if defined(CONFIG_MODEM_CELLULAR_NEIGHBOR_CELLS)
	/**
	 * Optional script that measures neighbour cells. Runs in place of @c periodic
	 * every @kconfig{CONFIG_MODEM_CELLULAR_NEIGHBOR_SCAN_PERIODS} runs.
	 */
