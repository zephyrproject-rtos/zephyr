...
/** Structure given as input parameter when calling st87mxx_wifiscan function */
typedef struct {
...
/**
 * @brief API to get the state of the application services sequences.
 *
