...
/*
 * RCAUSE is 16 bits wide here, with four brown-out detectors (PORCORE,
 * BORVDDREG, BORVDDA, BORVDDIO) between POR and EXT, shifting EXT/WDT/SYST
 * up by one and putting BACKUP out of an 8-bit read's reach.
 */
enum rstc_g1_rcause {
