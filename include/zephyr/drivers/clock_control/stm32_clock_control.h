...
#define STM32_DOMAIN_CLOCK_INST_PARENT_SUPPORT(inst)	\
		DT_CLOCKS_HAS_IDX(DT_INST_PARENT(inst), 1) ||
#define STM32_DT_INST_PARENT_DEV_DOMAIN_CLOCK_SUPPORT				\
		(DT_INST_FOREACH_STATUS_OKAY(STM32_DOMAIN_CLOCK_INST_PARENT_SUPPORT) 0)
