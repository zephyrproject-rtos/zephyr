...
#if DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(pllsai), st_stm32f4_pllsai_clock, okay) || \
	DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(pllsai), st_stm32f7_pllsai_clock, okay)
...
/* On STM32F4 series - PLL and PLLSAI share the same source */
	...
	DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(pllsai), st_stm32f4_pllsai_clock, okay) && \
