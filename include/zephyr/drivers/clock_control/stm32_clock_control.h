...
#define STM32_PLL_DIVR_ENABLED	DT_NODE_HAS_PROP(DT_NODELABEL(pll), div_divr)
#define STM32_PLL_DIVR_DIVISOR	DT_PROP_OR(DT_NODELABEL(pll), div_divr, 1)
...
#define STM32_PLLI2S_DIVQ_ENABLED	DT_NODE_HAS_PROP(DT_NODELABEL(plli2s), div_divq)
#define STM32_PLLI2S_DIVQ_DIVISOR	DT_PROP_OR(DT_NODELABEL(plli2s), div_divq, 1)
...
#define STM32_PLLI2S_DIVR_ENABLED	DT_NODE_HAS_PROP(DT_NODELABEL(plli2s), div_divr)
#define STM32_PLLI2S_DIVR_DIVISOR	DT_PROP_OR(DT_NODELABEL(plli2s), div_divr, 1)
#endif
