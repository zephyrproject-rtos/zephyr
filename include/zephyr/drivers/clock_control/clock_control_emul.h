 ...
 */
static inline bool clock_control_emul_1cell_subsys_match(clock_control_subsys_t sys,
 ...
 */
static inline int clock_control_emul_1cell_rate_to_value(clock_control_subsys_rate_t rate,
							 uint32_t *value)
{
...
clock_control_emul_1cell_cells_to_subsys(const uint32_t *cells,
...
#define CLOCK_CONTROL_SUBSYS_MATCH_1CELL(compat)                                                   \
	/** @copydoc clock_control_emul_1cell_subsys_match */                                      \
	static inline bool compat##_subsys_match(clock_control_subsys_t sys,                       \
						 const uint32_t *cells, size_t num_cells)          \
	{                                                                                          \
		return clock_control_emul_1cell_subsys_match(sys, cells, num_cells);               \
	}
...
#define CLOCK_CONTROL_RATE_TO_VALUE_1CELL(compat)                                                  \
	/** @copydoc clock_control_emul_1cell_rate_to_value */                                     \
	static inline int compat##_rate_to_value(clock_control_subsys_rate_t rate,                 \
						 uint32_t *value)                                  \
	{                                                                                          \
		return clock_control_emul_1cell_rate_to_value(rate, value);                        \
	}
