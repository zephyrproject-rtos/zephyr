 ...
 *
 * @param dirp        Directory stream.
 * @param[out] entry  Buffer for the entry.
 * @param[out] result Pointer to @p entry, or NULL at end-of-directory.
 *
 ...
 * @param[out] namelist Allocated array of directory entry pointers.
 ...
 *
 * @return Number of entries in @p namelist on success, or -1 with errno set on failure.
 *
 * @posix_func{scandir}
 */
