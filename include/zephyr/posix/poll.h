...
/**
 * @brief An unsigned integer type used for a number of file descriptors.
 *
 * @note Zephyr's poll() declaration takes a plain @c int descriptor count.
 */
typedef	unsigned int nfds_t;

/**
 * @brief Alias of @c zsock_pollfd, the file descriptor poll structure.
 */
