 ...
 *
 * @deprecated STREAMS is an optional XSI extension marked obsolescent in
 * POSIX.1-2017; portable applications should use BSD sockets instead.
 *
...
#define RS_HIPRI BIT(0) /**< Flag: message carries high-priority data. */
 ...
 *
 * @param fildes         STREAMS file descriptor.
 * @param[out] ctlptr    Control part buffer, or NULL.
 * @param[out] dataptr   Data part buffer, or NULL.
 * @param[in,out] flagsp 0, or @c RS_HIPRI to request high-priority messages only.
 *
 ...
 * @param[out] ctlptr    Control part buffer, or NULL.
 * @param[out] dataptr   Data part buffer, or NULL.
 * @param[in,out] bandp  Priority band of the message.
 * @param[in,out] flagsp Message flags.
 *
 * @return 0 if a complete message was received, a positive value if more of the message
 *         remains, or -1 with errno set on failure.
 *
