...
#define PTHREAD_CREATE_DETACHED 1 /**< Thread is created in the detached state. */
 ...
 *
 * @param attr          Mutex attributes object.
 * @param[out] protocol @c PTHREAD_PRIO_NONE, @c PTHREAD_PRIO_INHERIT,
 ...
 *
 * @param attr      Mutex attributes object.
 * @param[out] type @c PTHREAD_MUTEX_NORMAL, @c PTHREAD_MUTEX_ERRORCHECK,
 *                  @c PTHREAD_MUTEX_RECURSIVE, or @c PTHREAD_MUTEX_DEFAULT.
 *
 * @return 0 on success, or a positive error number on failure.
 *
...
#define PTHREAD_PROCESS_PRIVATE		0 /**< Object is private to the process (default). */

#define PTHREAD_PROCESS_PUBLIC		1 /**< Non-standard alias for @c PTHREAD_PROCESS_SHARED. */
 ...
 *
 * @param attr         Barrier attributes object.
 * @param[out] pshared @c PTHREAD_PROCESS_SHARED or @c PTHREAD_PROCESS_PRIVATE.
 *
 * @return 0 on success, or a positive error number on failure.
 *
...
#if defined(CONFIG_POSIX_THREAD_PRIO_PROTECT) || defined(__DOXYGEN__)
/**
 * @brief Get the priority ceiling of a mutex.
 *
 * @param mutex            Mutex to query.
 * @param[out] prioceiling Priority ceiling value.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 * @param[out] old_ceiling Previous priority ceiling.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr             Mutex attributes object.
 * @param[out] prioceiling Priority ceiling.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 * @param[out] guardsize Guard size in bytes.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr        Thread attributes object.
 * @param[out] policy Scheduling policy (e.g. @c SCHED_FIFO, @c SCHED_RR, or @c SCHED_OTHER).
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr             Thread attributes object.
 * @param[out] detachstate @c PTHREAD_CREATE_DETACHED or @c PTHREAD_CREATE_JOINABLE.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr            Thread attributes object.
 * @param[out] schedparam Scheduling parameters.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 * @param[out] policy Scheduling policy.
 * @param[out] param  Scheduling parameters.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr           Thread attributes object.
 * @param[out] stackaddr Stack base address.
 * @param[out] stacksize Stack size in bytes.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr                 Thread attributes object.
 * @param[out] contentionscope @c PTHREAD_SCOPE_SYSTEM or @c PTHREAD_SCOPE_PROCESS.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param attr              Thread attributes object.
 * @param[out] inheritsched @c PTHREAD_INHERIT_SCHED or @c PTHREAD_EXPLICIT_SCHED.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 * @param[out] status Exit value of the thread, or @c PTHREAD_CANCELED.
 * @param abstime     Absolute timeout (@c CLOCK_REALTIME).
 *
 * @return 0 on success, or a positive error number on failure.
 * @retval ETIMEDOUT The timeout expired before the operation completed.
 ...
 * @param[out] status Exit value if joined, or unchanged if not yet terminated.
 *
 * @return 0 if joined, or a positive error number on failure.
 * @retval EBUSY The thread has not yet terminated.
 *
 ...
 *
 * @param[out] newthread Thread ID of the new thread.
 ...
 * @param[out] oldstate Previous cancelability state.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 * @param[out] oldtype Previous cancelability type.
 *
 * @return 0 on success, or a positive error number on failure.
 *
 ...
 *
 * @param[out] key   New thread-specific data key.
 ...
 *
 * @param thread POSIX thread whose name to set.
 * @param name   Name string.
 *
 * @return 0 on success, or a negative value on kernel error.
 ...
 * other definitions of this function.
 *
 * @param thread    POSIX thread whose name to obtain.
