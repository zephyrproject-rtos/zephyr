...
#define _POSIX_BARRIERS			  Z_SC_VAL_IFDEF(CONFIG_POSIX_BARRIERS, _POSIX_VERSION)
...
#define _POSIX_MESSAGE_PASSING		  Z_SC_VAL_IFDEF(CONFIG_POSIX_MESSAGE_PASSING, _POSIX_VERSION)
...
#define _POSIX_READER_WRITER_LOCKS Z_SC_VAL_IFDEF(CONFIG_POSIX_READER_WRITER_LOCKS, _POSIX_VERSION)
#define _POSIX_REALTIME_SIGNALS		  (-1L)
#define _POSIX_REGEXP			  (-1L)
#define _POSIX_SAVED_IDS		  (-1L)
#define _POSIX_SEMAPHORES		  Z_SC_VAL_IFDEF(CONFIG_POSIX_SEMAPHORES, _POSIX_VERSION)
#define _POSIX_SHARED_MEMORY_OBJECTS	  (-1L)
#define _POSIX_SHELL			  (-1L)
#define _POSIX_SPAWN			  (-1L)
#define _POSIX_SPIN_LOCKS		  Z_SC_VAL_IFDEF(CONFIG_POSIX_SPIN_LOCKS, _POSIX_VERSION)
#define _POSIX_SPORADIC_SERVER		  (-1L)
#define _POSIX_SYNCHRONIZED_IO		  (-1L)
#define _POSIX_THREAD_ATTR_STACKADDR                                                               \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_THREAD_ATTR_STACKADDR, _POSIX_VERSION)
#define _POSIX_THREAD_ATTR_STACKSIZE                                                               \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_THREAD_ATTR_STACKSIZE, _POSIX_VERSION)
...
#define _POSIX_THREAD_PRIORITY_SCHEDULING                                                          \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_THREAD_PRIORITY_SCHEDULING, _POSIX_VERSION)
...
#define _POSIX_THREAD_SAFE_FUNCTIONS                                                               \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_THREAD_SAFE_FUNCTIONS, _POSIX_VERSION)
#define _POSIX_THREAD_SPORADIC_SERVER	  (-1L)
#define _POSIX_THREADS			  Z_SC_VAL_IFDEF(CONFIG_POSIX_THREADS_BASE, _POSIX_VERSION)
...
#define _POSIX_THREAD_THREADS_MAX	COND_CODE_1(CONFIG_POSIX_THREADS_BASE,	      \
...
#define _POSIX_THREAD_KEYS_MAX	      COND_CODE_1(CONFIG_POSIX_THREADS_BASE,		  \
						  (CONFIG_POSIX_THREAD_KEYS_MAX), \
						  (0))
#define PTHREAD_KEYS_MAX          _POSIX_THREAD_KEYS_MAX
#define PTHREAD_THREADS_MAX	      _PTHREAD_THREADS_MAX
