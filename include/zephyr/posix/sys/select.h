...
#define FD_SETSIZE ZVFS_FD_SETSIZE /**< Maximum number of file descriptors in an fd_set. */

typedef struct zvfs_fd_set fd_set; /**< Set of file descriptors for select()/pselect(). */
