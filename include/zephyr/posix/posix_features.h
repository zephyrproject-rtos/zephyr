...
#define _POSIX_ASYNCHRONOUS_IO \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_ASYNCHRONOUS_IO, _POSIX_VERSION)
...
#define _POSIX_PRIORITY_SCHEDULING \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_PRIORITY_SCHEDULING, _POSIX_VERSION)
...
#define _POSIX_MQ_OPEN_MAX \
	Z_SC_VAL_IFDEF(CONFIG_POSIX_MQUEUE, CONFIG_MSG_COUNT_MAX)
...
#define HOST_NAME_MAX \
	COND_CODE_1(CONFIG_NETWORKING, (NET_HOSTNAME_MAX_LEN), (_POSIX_HOST_NAME_MAX))
...
#define PTHREAD_KEYS_MAX                                                                           \
	COND_CODE_1(CONFIG_PTHREAD_IPC, (CONFIG_MAX_PTHREAD_KEY_COUNT), (_POSIX_THREAD_KEYS_MAX))
