 ...
 *
 * POSIX only requires this policy to be numerically distinct; in Zephyr it
 * executes identically to @c SCHED_RR.
 */
...
#define SCHED_RR 2
	...
	|| defined(CONFIG_ARCMWDT_LIBC) || defined(__DOXYGEN__)
 ...
 * @param[out] param Current scheduling parameters.
 *
 * @return 0 on success, or -1 with errno set on failure.
 *
 ...
 *
 * @param pid           Process ID (0 = calling process).
 * @param[out] interval Round-robin interval.
 *
 * @return 0 on success, or -1 with errno set on failure.
 *
