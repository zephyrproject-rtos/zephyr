...
struct sensing_sensor_register_info {
	 ...
	 * Sensor flags
	 */
	uint16_t flags; /**< Flags for the sensor. */
	 ...
	 */
	uint16_t sample_size; /**< Sample size for a single sample of the registered sensor. */

	/**
	 * The number of sensor sensitivities
	 */
	uint8_t sensitivity_count; /**< The number of sensor sensitivities. */

	/**
	 * Sensor version.
	 * Version can be used to identify different versions of sensor implementation.
	 */
	struct sensing_sensor_version version; /**< Version of the sensor. */
};

/**
 * @brief Enumeration for configuration readiness event.
 *
 * This enumeration defines the event for configuration readiness.
 */
enum {
...
/**
 * @brief Enumeration for sensor later configuration bit.
 *
 * This enumeration defines the bit for sensor later configuration.
 */
enum {
...
struct sensing_sensor {
	...
	const struct sensing_sensor_register_info
		*register_info;      /**< Register info of the sensor instance. */
