 ...
 *
 * @param      _name    The publishers name.
 * @param      _p_chan  The channel the publisher publishes to.
 * @param      _p_msg   A pointer to the publishers message.
 */
 ...
 *
 * @warning Care should be taken when using publishers on channels with subscribers. If multiple
...
/**
 * @brief      Cancel a publishers queued message.
 *
 * @param      publisher  The publisher
 * @param[in]  delay      The delay
 *
...
/**
 * @brief      Synchronously cancel a publishers queued message.
 *
 * @param      publisher  The publisher
 * @param[in]  delay      The delay
 *
...
/**
 * @brief      Reschedules a publisher and configures it to reschedule its self at the period
 * provided.
 *
 * @param      publisher  The publisher
 * @param[in]  delay      The delay
...
/**
 * @brief      Cancel a publishers queued message and disables it from rescheduling itself.
 *
 * @param      publisher  The publisher
 *
 * @return as with k_work_cancel_delayable().
...
/**
 * @brief      Synchronously cancel a publishers queued message and disables it from rescheduling
 * itself.
 *
 * @param      publisher  The publisher
 *
