...
/**
 * @name USB Setup packet RequestType Direction values (from Table 9-2)
...
/**
 * @name USB Setup packet RequestType Type values (from Table 9-2)
...
/**
 * @name USB Setup packet RequestType Recipient values (from Table 9-2)
