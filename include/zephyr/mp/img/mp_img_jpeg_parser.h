...
#ifndef ZEPHYR_INCLUDE_MP_IMG_MP_IMG_JPEG_PARSER_H_
#define ZEPHYR_INCLUDE_MP_IMG_MP_IMG_JPEG_PARSER_H_
...
/**
 * @defgroup mp_img_jpeg_parsers Parsers
 * @ingroup mp_img
...
#endif /* ZEPHYR_INCLUDE_MP_IMG_MP_IMG_JPEG_PARSER_H_ */
