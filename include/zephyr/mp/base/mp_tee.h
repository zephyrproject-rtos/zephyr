...
#ifndef ZEPHYR_INCLUDE_MP_BASE_MP_BASE_TEE_H_
#define ZEPHYR_INCLUDE_MP_BASE_MP_BASE_TEE_H_
...
struct mp_tee {
	...
	struct mp_pad srcpads[CONFIG_MP_BASE_TEE_MAX_SRCPADS_NUM];
	/** Number of source pads */
	uint8_t srcpads_num;
};
...
#endif /* ZEPHYR_INCLUDE_MP_BASE_MP_BASE_TEE_H_ */
