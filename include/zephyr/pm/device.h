 ...
 *
 * @details Ensures device is either SUSPENDED or OFF, and will deinit the PM device
 * context if this is the case. Must be called at the beginning of a driver's deinit
 * function.
 *
 * @note If CONFIG_PM_DEVICE=n, PM_DEVICE_ACTION_SUSPEND will be invoked on the
