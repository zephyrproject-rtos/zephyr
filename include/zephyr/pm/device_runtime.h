 ...
 * until the reference is deactivated using @ref pm_device_runtime_release or
 * @ref pm_device_runtime_release_async.
 *
 ...
 *
 * @details Deactivates a reference to a device, allowing the device to be
 * suspended.
 *
 ...
 *
 * @details Deactivates a reference to a device, allowing the device to be
 * suspended after a specified delay asynchronously.
 *
 * @note If the reference is already inactive, this API is a no-op.
 *
 * @param dev Device instance to dereference.
