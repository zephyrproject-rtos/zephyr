 ...
 *
 * @param dev Device reference.
 * @param pm_state The state to check on whether it disables the device.
 ...
 */
bool pm_policy_device_is_disabling_state(const struct device *dev, enum pm_state, uint8_t substate_id);
