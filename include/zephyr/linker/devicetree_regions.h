...
#define LINKER_DT_NODE_REGION_FLAGS(n)                                                             \
	COND_CODE_1(DT_NODE_HAS_PROP(n, zephyr_memory_region_flags),                               \
		    (COND_CODE_1(_LINKER_IS_EMPTY_TOKEN(_DT_MEMORY_REGION_FLAGS_TOKEN(n)),         \
				 (),                                                               \
				 (_LINKER_ENCLOSE_PAREN(_DT_MEMORY_REGION_FLAGS_UNQUOTED(n))))),   \
