 ...
 * @param label lowercase-and-underscores label property value
 * @return 1 if the device has a <tt>"zephyr,mapped-partition"</tt> or
 *         <tt>"fixed-subpartitions"</tt> compatible, or parent has a <tt>"fixed-partitions"</tt>
...
/**
 * @brief Test if <tt>"zephyr,mapped-partition"</tt>, <tt>"fixed-partitions"</tt> or
