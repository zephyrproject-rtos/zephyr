...
/**
 * @brief Get display node by logical index from "displays" property of the 1st node with
 * compatible zephyr,displays
 *
 * @param idx logical index of display node's phandle in "displays" property
 *
 * @return number of displays designated by "displays" property, 0 otherwise
 */
