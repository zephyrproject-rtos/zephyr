...
/** Mesh model runtime-specific information */
struct bt_mesh_model_ctx {
	/* Internal information, mainly for persistent storage */
	uint8_t  elem_idx;   /* Belongs to Nth element */
	uint8_t  mod_idx;    /* Is the Nth model in the element */
	uint16_t flags;      /* Model internal states */
...
struct bt_mesh_model {
	...
	struct bt_mesh_models_metadata_entry ** const metadata;
#endif

	/** Model ctx variables. */
	struct bt_mesh_model_ctx * const ctx;
