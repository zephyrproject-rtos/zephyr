 ...
 */
struct bt_gatt_cpf {
	/** Format of the value of the characteristic. The format types can be
	 *  found in section 2.4.1 of the Bluetooth SIG Assigned Numbers document.
	 */
	uint8_t format;
	/** Exponent field to determine how the value of this characteristic is
	 *  further formatted. Only used on integer format types.
	 *  actual value = Characteristic Value x 10^Exponent
	 */
	int8_t exponent;
	/** UUID of the unit of the characteristic. The units can be found in
	 *  section 3.5 of the Bluetooth SIG Assigned Numbers document.
	 */
	uint16_t unit;
	/** Name space of the description, used to identify the organization
	 *  that is responsible for defining the enumerations for the
	 *  description field. See section 2.4.2 of the Bluetooth SIG Assigned
	 *  Numbers document.
	 */
	uint8_t name_space;
	/** Description of the characteristic as defined in a higher layer
	 *  profile. An enumerated value defined by the organization identified
	 *  by the name_space field. See section 2.4.2.1 of the Bluetooth SIG
