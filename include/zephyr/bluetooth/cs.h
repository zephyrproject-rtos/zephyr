...
enum bt_cs_test_main_mode {
	/** CS Test Mode-1 */
	BT_CS_TEST_MAIN_MODE_1 = BT_HCI_OP_LE_CS_TEST_MAIN_MODE_1,
	/** CS Test Mode-2 */
	BT_CS_TEST_MAIN_MODE_2 = BT_HCI_OP_LE_CS_TEST_MAIN_MODE_2,
	/** CS Test Mode-3 */
	BT_CS_TEST_MAIN_MODE_3 = BT_HCI_OP_LE_CS_TEST_MAIN_MODE_3,
};

/** CS Test Sub-Mode */
enum bt_cs_test_sub_mode {
	/** CS Test sub-mode-1 */
	BT_CS_TEST_SUB_MODE_1 = BT_HCI_OP_LE_CS_TEST_SUB_MODE_1,
	/** CS Test sub-mode-2 */
	BT_CS_TEST_SUB_MODE_2 = BT_HCI_OP_LE_CS_TEST_SUB_MODE_2,
	/** CS Test sub-mode-3 */
	BT_CS_TEST_SUB_MODE_3 = BT_HCI_OP_LE_CS_TEST_SUB_MODE_3,
	/** No CS Test sub-mode. */
	BT_CS_TEST_SUB_MODE_UNUSED = BT_HCI_OP_LE_CS_TEST_SUB_MODE_UNUSED,
};

/** CS Test Role */
enum bt_cs_test_role {
	BT_CS_TEST_ROLE_INITIATOR = BT_HCI_OP_LE_CS_TEST_INITIATOR_ROLE,
	BT_CS_TEST_ROLE_REFLECTOR = BT_HCI_OP_LE_CS_TEST_REFLECTOR_ROLE,
};

/** CS Test RTT type */
enum bt_cs_test_rtt_type {
	/** RTT AA Only */
	BT_CS_TEST_RTT_AA_ONLY = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_AA_ONLY,
	/** RTT with 32-bit sounding sequence */
	BT_CS_TEST_RTT_32_BIT_SOUNDING = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_32BIT_SOUND,
	/** RTT with 96-bit sounding sequence */
	BT_CS_TEST_RTT_96_BIT_SOUNDING = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_96BIT_SOUND,
	/** RTT with 32-bit random sequence */
	BT_CS_TEST_RTT_32_BIT_RANDOM = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_32BIT_RAND,
	/** RTT with 64-bit random sequence */
	BT_CS_TEST_RTT_64_BIT_RANDOM = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_64BIT_RAND,
	/** RTT with 96-bit random sequence */
	BT_CS_TEST_RTT_96_BIT_RANDOM = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_96BIT_RAND,
	/** RTT with 128-bit random sequence */
	BT_CS_TEST_RTT_128_BIT_RANDOM = BT_HCI_OP_LE_CS_TEST_RTT_TYPE_128BIT_RAND,
};

/** CS Test CS_SYNC PHY */
enum bt_cs_test_cs_sync_phy {
	BT_CS_TEST_CS_SYNC_LE_1M_PHY = BT_HCI_OP_LE_CS_TEST_CS_SYNC_1M,
	BT_CS_TEST_CS_SYNC_LE_2M_PHY = BT_HCI_OP_LE_CS_TEST_CS_SYNC_2M,
	BT_CS_TEST_CS_SYNC_LE_2M_2BT_PHY = BT_HCI_OP_LE_CS_TEST_CS_SYNC_2M_2BT,
};
