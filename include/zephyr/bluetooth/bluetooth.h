 ...
 *
 * @note The default identity address (corresponding to BT_ID_DEFAULT) cannot be reset, i.e. this
 ...
 *
 * @note The default identity address (corresponding to BT_ID_DEFAULT) cannot be deleted, i.e. this
 * API will return an error if asked to do that.
 *
 * @param id   Existing identity handle.
 *
