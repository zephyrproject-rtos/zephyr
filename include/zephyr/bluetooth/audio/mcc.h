 ...
 */
typedef void (*bt_mcc_send_cmd_cb)(struct bt_conn *conn, int err, const struct bt_mcp_cmd *cmd);
 ...
 */
typedef void (*bt_mcc_cmd_ntf_cb)(struct bt_conn *conn, int err, const struct bt_mcp_cmd_ntf *ntf);
