 ...
 *
 *  @param config_ie The codec info element of config.
 *
 *  @return the channel num.
 */
uint8_t bt_a2dp_sbc_get_channel_num(void *config_ie);
 ...
 */
uint32_t bt_a2dp_sbc_get_sampling_frequency(void *config_ie);
