...
/**
 * @brief BIP supported capabilites
 *
 * Defines the supported capabilites of the BIP device (responder).
 * These capabilites indicate the primary BIP services that the device supports.
 * Multiple capabilites can be combined using bitwise OR operations.
 */
enum __packed bt_bip_supported_capabilites {
...
enum __packed bt_bip_supported_functions {
	...
	/** @brief Get Monitoring Image function - supports retrieving monitoring images from remote
	 *  camera */
