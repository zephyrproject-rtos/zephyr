 ...
 */
typedef void(*bt_avrcp_notify_changed_cb_t)(uint8_t event_id, struct bt_avrcp_event_data *data);
...
struct bt_avrcp_ct_cb {
	 ...
	 */
	void (*get_total_number_of_items_rsp)(struct bt_avrcp_ct *ct, uint8_t tid,
					      struct net_buf *buf);
...
struct bt_avrcp_tg_cb {
	 ...
	 */
	void (*get_caps_req)(struct bt_avrcp_tg *tg, uint8_t tid, uint8_t cap_id);
