...
#define BT_HCI_VOICE_SETTING_AIR_CODING_ULAW        0x01
#define BT_HCI_VOICE_SETTING_AIR_CODING_ALAW        0x02
#define BT_HCI_VOICE_SETTING_AIR_CODING_TRANSPARENT 0x03
