...
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_PHY_1M_MASK    BIT(0)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_PHY_2M_MASK    BIT(1)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_PHY_CODED_MASK BIT(2)

#define BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_CP_MASK BIT(0)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_PC_MASK BIT(1)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_MCES_MASK       BIT(2)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_CIS_MASK    BIT(3)
#define BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_MSS_CIS_MASK    BIT(4)
...
#define BT_HCI_EVT_LE_FRAME_SPACE_UPDATE_INITIATOR_LOCAL_HOST       (0)
#define BT_HCI_EVT_LE_FRAME_SPACE_UPDATE_INITIATOR_LOCAL_CONTROLLER (1)
#define BT_HCI_EVT_LE_FRAME_SPACE_UPDATE_INITIATOR_PEER             (2)
