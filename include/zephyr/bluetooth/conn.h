...
struct bt_conn_le_cs_capabilities {
	...
	/** RTT Random Payload */
	bool rtt_random_payload_supported;
	/** RTT AA Only accuracy.
	 *
	 * - True: 10ns time-of-flight precision
	 * - False: 150ns time-of-flight precision (or not supported)
	 */
	bool rtt_aa_only_10ns_accurate;
	/** RTT Sounding accuracy.
	 *
	 * - True: 10ns time-of-flight precision
	 * - False: 150ns time-of-flight precision (or not supported)
	 */
	bool rtt_sounding_10ns_accurate;
	/** RTT Random Payload accuracy
	 *
	 * - True: 10ns time-of-flight precision
	 * - False: 150ns time-of-flight precision (or not supported)
	 */
	bool rtt_random_payload_10ns_accurate;
	...
	/** CS Subfeatures.
	 *
	 * - Bit 0: CS with no Frequency Actuation Error.
	...
	uint8_t t_sw_time;
	/** SNR levels used in RTT packets. */
