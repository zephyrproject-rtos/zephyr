...
#define BT_CONN_LE_FRAME_SPACE_TYPES_MASK_ACL_IFS                    \
	(BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_CP_MASK | \
	 BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_PC_MASK)

#define BT_CONN_LE_FRAME_SPACE_TYPES_MASK_ACL                        \
	(BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_CP_MASK | \
	 BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_ACL_PC_MASK | \
	 BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_MCES_MASK)

#define BT_CONN_LE_FRAME_SPACE_TYPES_MASK_CIS                     \
	(BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_IFS_CIS_MASK | \
	 BT_HCI_OP_LE_FRAME_SPACE_UPD_SPACING_TYPE_MSS_CIS_MASK)
...
struct bt_conn_cb {
	 ...
	 *  The frame space update parameters will be unchanged
