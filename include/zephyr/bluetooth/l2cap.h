...
struct bt_l2cap_fixed_chan {
	 ...
	 *
	 *  @note Shall be in the range 0x0001 to 0x003F (Core 3.A.2.1 v6.0).
	 *        The application needs to make sure that the CID is not already in use. See
	 *        @ref l2cap_cid for the CIDs used by the stack.
	 */
	uint16_t cid;
	 ...
	 *  fill in the channel reference to point to the @ref bt_l2cap_le_chan.chan field of an
	 *  allocated LE channel context, and assign the callbacks to the @ref bt_l2cap_chan_ops
	 *  field. The allocated context needs to be valid for the lifetime of the channel.
	 *
