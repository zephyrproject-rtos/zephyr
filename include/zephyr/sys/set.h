 ...
 *
 * @param node Pointer to a set_node structure.
 */
static inline void sys_set_makeset(struct set_node *node)
{
	node->parent = node;
	node->rank = 0;
}
 ...
 *
 * @param node Pointer to a set_node structure.
 * @return Pointer to the root set_node of the set containing the @p node.
 */
struct set_node *sys_set_find(struct set_node *node);
 ...
 *
 * @param node1 Pointer to a set_node structure.
 * @param node2 Pointer to a set_node structure.
 */
void sys_set_union(struct set_node *node1, struct set_node *node2);
