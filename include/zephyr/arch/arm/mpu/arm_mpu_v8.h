 ...
 *
 * Needed by any SMP configuration since ldrex and strex are only globally atomic
 * for shareable memory, this then ensures atomic_cas() don't resolve locally for
 * different cores watching the same RAM region.
 */
