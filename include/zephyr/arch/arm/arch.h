...
enum k_fatal_error_reason_arch {
	...
	K_ERR_ARM_ACCESS_FLAG_FAULT,
	K_ERR_ARM_CACHE_MAINTENANCE_INSTRUCTION_FAULT,
	K_ERR_ARM_DOMAIN_FAULT,
	K_ERR_ARM_SYNC_EXTERNAL_ABORT_TRANSLATION_TABLE,
	K_ERR_ARM_TBL_CONFLICT_FAULT,
	K_ERR_ARM_SYNC_PARITY_ERROR_TRANSLATION_TABLE,
};
