...
#define ARCH_ISR_DIAG_OFF \
	TOOLCHAIN_DISABLE_CLANG_WARNING("-Wextra") \
	TOOLCHAIN_DISABLE_GCC_WARNING("-Wattributes")
#define ARCH_ISR_DIAG_ON \
	TOOLCHAIN_ENABLE_CLANG_WARNING("-Wextra") \
	TOOLCHAIN_ENABLE_GCC_WARNING("-Wattributes")
