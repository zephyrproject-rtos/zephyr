...
#define Z_RISCV_STACK_PMP_ALIGN \
	GENERIC_MAX(CONFIG_PMP_GRANULARITY, ARCH_STACK_PTR_ALIGN)
...
#define Z_RISCV_STACK_GUARD_SIZE \
	Z_POW2_CEIL(GENERIC_MAX(sizeof(struct arch_esf) + CONFIG_PMP_STACK_GUARD_MIN_SIZE, \
...
#define ARCH_THREAD_STACK_SIZE_ADJUST(size) \
	Z_POW2_CEIL(GENERIC_MAX(GENERIC_MAX(size, CONFIG_PRIVILEGED_STACK_SIZE), \
			Z_RISCV_STACK_PMP_ALIGN))
