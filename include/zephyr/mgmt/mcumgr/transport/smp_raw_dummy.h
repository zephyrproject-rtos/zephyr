 ...
 */
#ifndef ZEPHYR_INCLUDE_MGMT_MCUMGR_TRANSPORT_SMP_RAW_DUMMY_H_
#define ZEPHYR_INCLUDE_MGMT_MCUMGR_TRANSPORT_SMP_RAW_DUMMY_H_
...
#endif /* ZEPHYR_INCLUDE_MGMT_MCUMGR_TRANSPORT_SMP_RAW_DUMMY_H_ */
