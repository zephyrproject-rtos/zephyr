...
/** UID range to be used by the FIDO2 PSA PS backend. */
#define ZEPHYR_PSA_FIDO2_PS_UID_RANGE_BEGIN 0x2C010000
#define ZEPHYR_PSA_FIDO2_PS_UID_RANGE_SIZE  0x10000 /**< 64 Ki */
