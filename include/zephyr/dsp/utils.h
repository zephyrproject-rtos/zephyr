 ...
 * @param n   The number of bits to left shift the input value (0 to 7).
 ...
 * @param n   The number of bits to left shift the input value (0 to 15).
 * @return The converted floating-point (float32_t) value.
 */
 ...
 * @param n   The number of bits to left shift the input value (0 to 31).
 * @return The converted floating-point (float32_t) value.
 */
 ...
 * @param n   The number of bits to right shift the input value (0 to 7).
 ...
 *
 * @param src The input floating-point (float32_t) value.
 * @param n   The number of bits to right shift the input value (0 to 15).
 ...
 *
 * @param src The input floating-point (float32_t) value.
 * @param n   The number of bits to right shift the input value (0 to 31).
