...
#define J1939_NODE_DEFINE(node_name, _can_dev, _source_address, _id_number, _manufacturer_code, \
						_ecu_instance, _function_instance, _function, _vehicle_system, \
						_vehicle_system_instance, _industry_group, _arbitrary_address_capable) \
 ...
 * @param device_info Pointer to a j1939_device_info_t structure to populate with device information
 */
