...
/**
 * @file
 * @brief UWB UCI interface
 *
 * This file contains definitions of GIDs, OIDs,
 * status codes and other UCI related definitions
 */
...
/**
 * @brief UWB UCI type definitions
 * @defgroup uci_types UWB UCI core definitions
 * @ingroup uwb
 * @{
 */
 ...
 */
/** DATA_MESSAGE_SND: Host sends Application Data to UWBS using Bypass LL Mode */
#define UCI_DPF_SEND    0x01
/** DATA_MESSAGE_RCV: Host receives Application Data from UWBS using Bypass LL Mode */
#define UCI_DPF_RECV    0x02
/** LL_DATA_MESSAGE_SND: Host sends Application Data to UWBS using Logical Link Mode */
#define UCI_DPF_LL_SEND 0x03
/** LL_DATA_MESSAGE_RCV: Host receives Application Data from UWBS using Logical Link Mode */
...
/** Packet contains a complete message, or the last segment of a segmented message */
#define UCI_PBF_NO_OR_LAST 0x00
/** Packet contains a segment of a message that is not the last segment */
#define UCI_PBF_ST_CONT    0x10
 ...
 * Ref: FiRa UCI Technical Specification v4.0.0, Table 70: GID and OID Definitions
 */
/** CORE_DEVICE_RESET_CMD/RSP: Request for UWBS reset */
#define UCI_MSG_CORE_DEVICE_RESET         0x00
/** CORE_DEVICE_STAT_NTF: UWBS notifies current state */
#define UCI_MSG_CORE_DEVICE_STATUS_NTF    0x01
/** CORE_GET_DEVICE_INFO_CMD/RSP: Get UWBS device information */
#define UCI_MSG_CORE_DEVICE_INFO          0x02
/** CORE_GET_CAPS_INFO_CMD/RSP: Get UWBS capability information */
#define UCI_MSG_CORE_GET_CAPS_INFO        0x03
/** CORE_SET_CONFIG_CMD/RSP: Set UWBS device configurations */
#define UCI_MSG_CORE_SET_CONFIG           0x04
/** CORE_GET_CONFIG_CMD/RSP: Get UWBS device configurations */
#define UCI_MSG_CORE_GET_CONFIG           0x05
/** RFU */
#define UCI_MSG_CORE_DEVICE_SUSPEND       0x06
/** CORE_GENERIC_ERROR_NTF: Notifies generic errors in UWBS */
#define UCI_MSG_CORE_GENERIC_ERROR_NTF    0x07
/** CORE_QUERY_UWBS_TIMESTAMP_CMD/RSP: Query the UWBS Timestamp */
 ...
 * Ref: FiRa UCI Technical Specification v4.0.0, Table 70: GID and OID Definitions
 */
/** SESSION_INIT_CMD/RSP: UWB session creation request */
#define UCI_MSG_SESSION_INIT                             0x00
/** SESSION_DEINIT_CMD/RSP: Request for destroying the UWB session */
#define UCI_MSG_SESSION_DEINIT                           0x01
/** SESSION_STATUS_NTF: Notifies the current UWB session state */
#define UCI_MSG_SESSION_STATUS_NTF                       0x02
/** SESSION_SET_APP_CONFIG_CMD/RSP: Configuration request for UWB session */
#define UCI_MSG_SESSION_SET_APP_CONFIG                   0x03
/** SESSION_GET_APP_CONFIG_CMD/RSP: Get current configuration for UWB session */
#define UCI_MSG_SESSION_GET_APP_CONFIG                   0x04
/** SESSION_GET_COUNT_CMD/RSP: Get number of UWB sessions in UWBS */
#define UCI_MSG_SESSION_GET_COUNT                        0x05
/** SESSION_GET_STATE_CMD/RSP: Get current state of the UWB session */
#define UCI_MSG_SESSION_GET_STATE                        0x06
/** SESSION_UPDATE_CONTROLLER_MULTICAST_LIST_CMD/RSP/NTF: Update the multicast list */
#define UCI_MSG_SESSION_UPDATE_CONTROLLER_MULTICAST_LIST 0x07
/** SESSION_UPDATE_DT_ANCHOR_RANGING_ROUNDS_CMD/RSP: Configure active ranging rounds */
#define UCI_MSG_UPDATE_ACTIVE_ROUNDS_OF_ANCHOR_DEVICE    0x08
/** SESSION_UPDATE_DT_TAG_RANGING_ROUNDS_CMD/RSP: Configure active ranging rounds for DT-Tags */
#define UCI_MSG_UPDATE_ACTIVE_ROUNDS_OF_RECEIVER_DEVICE  0x09
/** SESSION_QUERY_DATA_SIZE_IN_RANGING_CMD/RSP: Query max Application Data size per Ranging Round */
#define UCI_MSG_SESSION_QUERY_DATA_SIZE_IN_RANGING       0x0B
/** SESSION_SET_HUS_CONTROLLER_CONFIG_CMD/RSP: Configure Phase list for Controller HUS Session */
#define UCI_MSG_SESSION_SET_HUS_CONTROLLER_CONFIG_CMD    0x0C
/** SESSION_SET_HUS_CONTROLEE_CONFIG_CMD/RSP: Configure Phase list for Controlee HUS Session */
#define UCI_MSG_SESSION_SET_HUS_CONTROLEE_CONFIG_CMD     0x0D
/** SESSION_DTPCM_CONFIG_CMD/RSP/NTF: Configure the DTPCM configuration */
 ...
 * Ref: FiRa UCI Technical Specification v4.0.0, Table 70: GID and OID Definitions
 */
/** SESSION_START_CMD/RSP: Activate the UWB ranging session */
#define UCI_MSG_RANGE_START             0x00
/** SESSION_STOP_CMD/RSP: Deactivate the ranging session */
#define UCI_MSG_RANGE_STOP              0x01
/** SESSION_GET_RANGING_COUNT_CMD/RSP: Get number of ranging rounds attempted */
...
/** LOGICAL_LINK_CREATE_CMD/RSP/NTF: Create a logical link for data exchange */
#define UCI_MSG_LOGICAL_LINK_CREATE      0x07
/** LOGICAL_LINK_CLOSE_CMD/RSP: Close a logical link for data exchange */
#define UCI_MSG_LOGICAL_LINK_CLOSE       0x08
/** LOGICAL_LINK_UWBS_CLOSE_NTF: UWBS notification to close a logical link */
#define UCI_MSG_LOGICAL_LINK_UWBS_CLOSE  0x09
/** LOGICAL_LINK_UWBS_CREATE_NTF: UWBS notification to create a logical link */
#define UCI_MSG_LOGICAL_LINK_UWBS_CREATE 0x0A
/** LOGICAL_LINK_GET_PARAM_CMD/RSP: Get logical link layer parameter configurations */
#define UCI_MSG_LOGICAL_LINK_GET_PARAM   0x0B

/** Session Control Group (0x02) Notification OIDs */
/** SESSION_INFO_NTF: Notifies ranging results after session activation */
#define UCI_MSG_SESSION_INFO_NTF         0x00
/** SESSION_DATA_CREDIT_NTF: Indicates data packet successfully received by UWBS */
#define UCI_MSG_DATA_CREDIT_NTF          0x04
/** SESSION_DATA_TRANSFER_STATUS_NTF: Indicates status of in-band data transfer */
#define UCI_MSG_DATA_TRANSMIT_STATUS_NTF 0x05
/** SESSION_ROLE_CHANGE_NTF: Indicates role change of a Controlee */
#define UCI_MSG_SESSION_ROLE_CHANGE_NTF  0x06
/** Vendor specific CCC data notification */
...
enum uci_status_code {
	 ...
	 */
	UCI_STATUS_CODE_INVALID_PARAM = 0x04,
	/**
	 ...
	 */
	UCI_STATUS_CODE_ERROR_SESSION_INVALID_SLOT_DURATION = 0x19,
	/** STATUS_ERROR_UWB_INITIATION_TIME_TOO_OLD: The current UWBS time has gone past the
	 * configured UWB_INITIATION_TIME
	 */
	UCI_STATUS_CODE_ERROR_UWB_INITIATION_TIME_TOO_OLD = 0x1A,
	/**
	 ...
	 */
	UCI_STATUS_CODE_ERROR_NUMBER_OF_ACTIVE_RANGING_ROUNDS_EXCEEDED = 0x29,
	/**
	 ...
	 */
	UCI_STATUS_CODE_ERROR_DL_TDOA_DEVICE_ADDRESS_NOT_MATCHING_IN_REPLY_TIME_LIST = 0x2A,
};
...
/** MAX_RANGING_ROUND_RETRY_COUNT_REACHED: MAX_RR_RETRY consecutive failed ranging rounds */
...
/** SESSION_STOPPED_DUE_TO_INBAND_SIGNAL: Ranging stopped by RCM or DTPCM with stop bit set
 * (Controlee only)
 */
#define UWB_SESSION_STOPPED_DUE_TO_INBAND_SIGNAL            0x05
/** Vendor specific */
#define UWB_SESSION_INVALID_UL_TDOA_RANDOM_WINDOW           0x1D
/** ERROR_MIN_FRAMES_PER_RR_NOT_SUPPORTED: UWBS cannot transmit configured MIN_FRAMES_PER_RR within
 * RANGING_DURATION
 */
#define UWB_SESSION_MIN_RFRAMES_PER_RR_NOT_SUPPORTED        0x1E
/** ERROR_INTER_FRAME_INTERVAL_NOT_SUPPORTED: INTER_FRAME_INTERVAL exceeds RANGING_DURATION */
#define UWB_SESSION_INTER_FRAME_INTERVAL_NOT_SUPPORTED      0x1F
/** ERROR_SLOT_LENGTH_NOT_SUPPORTED */
#define UWB_SESSION_SLOT_LENTGH_NOT_SUPPORTED               0x20
/** ERROR_INSUFFICIENT_SLOTS_PER_RR: SLOTS_PER_RR not sufficient to complete the Ranging round */
#define UWB_SESSION_SLOTS_PER_RR_NOT_SUFFICIENT             0x21
/** ERROR_MAC_ADDRESS_MODE_NOT_SUPPORTED */
#define UWB_SESSION_MAC_ADDRESS_MODE_NOT_SUPPORTED          0x22
/** ERROR_INVALID_RANGING_DURATION */
...
/** ERROR_MAX_RANGING_REPLY_TIME_EXCEEDED */
...
/** ERROR_REF_UWB_SESSION_NONEXISTENT_OR_NOT_CONFIGURED */
...
/** ERROR_UWB_INITIATION_TIME_EXPIRED (spec 0x42) */
#define UWB_SESSION_ERROR_HUS_INVALID_SLOT_DURATION         0x42
/** Vendor specific: URSK TTL max value reached */
#define UWB_SESSION_ERROR_URSK_TTL_MAX_VALUE_REACHED        0xA1
/** SESSION_STOPPED_DUE_TO_MAX_STS: STS index reached its maximum value */
...
enum uci_control_gid_oid {
	 ...
	 * Ref: FiRa UCI Technical Specification v4.0.0, Table 70: GID and OID Definitions
	 */
	/** CORE_DEVICE_RESET_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_DEVICE_RESET = GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_DEVICE_RESET),
	/** CORE_DEVICE_STAT_NTF */
	UCI_CONTROL_GID_OID_CORE_GET_DEVICE_STATUS =
		GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_DEVICE_STATUS_NTF),
	/** CORE_GET_DEVICE_INFO_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_GET_DEVICE_INFO = GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_DEVICE_INFO),
	/** CORE_GET_CAPS_INFO_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_GET_CAPS_INFO = GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_GET_CAPS_INFO),
	/** CORE_SET_CONFIG_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_SET_CONFIG = GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_SET_CONFIG),
	/** CORE_GET_CONFIG_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_GET_CONFIG = GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_GET_CONFIG),
	/** CORE_GENERIC_ERROR_NTF */
	UCI_CONTROL_GID_OID_CORE_GENERIC_ERROR_NTF =
		GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_GENERIC_ERROR_NTF),
	/** CORE_QUERY_UWBS_TIMESTAMP_CMD/RSP */
	UCI_CONTROL_GID_OID_CORE_QUERY_UWBS_TIMESTAMP =
		GET_CORE_GROUP_GID_OID(UCI_MSG_CORE_QUERY_UWBS_TIMESTAMP),

	/** UWB Session Config Group - (0x01)
	 * Ref: FiRa UCI Technical Specification v4.0.0, Table 70: GID and OID Definitions
	 */
	/** SESSION_INIT_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_INIT = GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_INIT),
	/** SESSION_DEINIT_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_DEINIT =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_DEINIT),
	/** SESSION_STATUS_NTF */
	UCI_CONTROL_GID_OID_SESSION_STATUS =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_STATUS_NTF),
	/** SESSION_SET_APP_CONFIG_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_SET_APP_CONFIG =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_SET_APP_CONFIG),
	/** SESSION_GET_APP_CONFIG_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_GET_APP_CONFIG =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_GET_APP_CONFIG),
	/** SESSION_GET_COUNT_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_GET_COUNT =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_GET_COUNT),
	/** SESSION_GET_STATE_CMD/RSP */
	UCI_CONTROL_GID_OID_SESSION_GET_STATE =
		GET_SESSION_CONFIG_GROUP_GID_OID(UCI_MSG_SESSION_GET_STATE),
	/** SESSION_UPDATE_CONTROLLER_MULTICAST_LIST_CMD/RSP/NTF */
	UCI_CONTROL_GID_OID_SESSION_UPDATE_CONTROLLER_MULTICAST_LIST =
	...
	UCI_CONTROL_GID_OID_SESSION_UPDATE_DT_ANCHOR_RANGING_ROUND =
	...
	UCI_CONTROL_GID_OID_SESSION_UPDATE_DT_TAG_RANGING_ROUND =
...
enum uci_data_gid_oid {
	 ...
	 * Ref: FiRa UCI Technical Specification v4.0.0, Table 5: DPF Values
	 */
	/** DATA_MESSAGE_SND: Host sends Application Data using Bypass LL Mode */
	UCI_DATA_GID_OID_DATA_MESSAGE_SEND = (UCI_DPF_SEND << UCI_GID_GROUP_SHIFT),
	/** DATA_MESSAGE_RCV: Host receives Application Data using Bypass LL Mode */
	UCI_DATA_GID_OID_DATA_MESSAGE_RECV = (UCI_DPF_RECV << UCI_GID_GROUP_SHIFT),
	/** LL_DATA_MESSAGE_SND: Host sends Application Data using Logical Link Mode */
	UCI_DATA_GID_OID_LL_DATA_MESSAGE_SEND = (UCI_DPF_LL_SEND << UCI_GID_GROUP_SHIFT),
	/** LL_DATA_MESSAGE_RCV: Host receives Application Data using Logical Link Mode */
	UCI_DATA_GID_OID_LL_DATA_MESSAGE_RECV = (UCI_DPF_LL_RECV << UCI_GID_GROUP_SHIFT),
};
...
enum uwb_device_state {
	...
	UWB_DEVICE_STATE_NA = 0,
	/** DEVICE_STATE_READY: UWBS is initialized and ready for UWB session */
	UWB_DEVICE_STATE_READY = 0x01,
	/** DEVICE_STATE_ACTIVE: UWBS is busy with UWB session */
	UWB_DEVICE_STATE_ACTIVE = 0x02,
	/** DEVICE_STATE_ERROR: Error occurred within the UWBS */
...
enum uwb_session_status {
	/** SESSION_STATE_INIT: Session is initialized */
	UWB_SESSION_STATUS_INITIALIZED = 0,
	/** SESSION_STATE_DEINIT: Session is de-initialized */
	UWB_SESSION_STATUS_DE_INITIALIZED = 1,
	/** SESSION_STATE_ACTIVE: Session is active (ranging in progress) */
	UWB_SESSION_STATUS_ACTIVE = 2,
	/** SESSION_STATE_IDLE: Session is idle (configured but not ranging) */
	UWB_SESSION_STATUS_IDLE = 3,
	/** Error state */
	UWB_SESSION_STATUS_ERROR = 0xFF
};
