 ...
 * @brief UWB Fira APIs
 *
 * This file contains definitions of Fira based
 * APIs which shall be called by the application
 */
...
/**
 * @brief UWB Fira APIs
 * @defgroup uwb Ultra-Wideband subsystem APIs
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Initialization successful
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Initialization failed
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Deinitialization successful
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Device reset successful and device is ready
 * \retval UWB_STATUS_CODE_FAILED Reset failed or device not ready after reset
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Device info retrieved successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve or parse device info
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Capabilities retrieved successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve or parse capabilities
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Success
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to set one or more configurations
 */
 ...
 * \retval UWB_STATUS_CODE_SUCCESS Success
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve configurations
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Timestamp retrieved successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_INSUFFICIENT_BUFFER Response data exceeds buffer size
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve timestamp
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Device state retrieved successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve device state
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Session initialized successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid parameters or pSessionHandle is NULL
 * \retval UWB_STATUS_CODE_FAILED Session initialization failed or notification timeout
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Session deinitialize successfully
 * \retval UWB_STATUS_CODE_FAILED Session deinitialization failed or notification timeout
 */
 ...
 * \param[in] num_configs Number of configuration parameters in the array
 *
 * \retval UWB_STATUS_CODE_SUCCESS All configurations set successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_FAILED Failed to set one or more configurations
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS All parameters retrieved successfully
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid arguments passed
 * \retval UWB_STATUS_CODE_INSUFFICIENT_BUFFER Insufficient buffer for parameter value
 * \retval UWB_STATUS_CODE_FAILED Failed to retrieve parameters
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Success
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT Invalid parameters are passed
 * \retval UWB_STATUS_CODE_FAILED Otherwise
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS              Success
 * \retval UWB_STATUS_CODE_NOT_INITIALIZED       UWB stack is not initialized
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT      Invalid parameters are passed
 * \retval UWB_STATUS_CODE_FAILED               Otherwise
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS               on success
 * \retval UWB_STATUS_CODE_NOT_INITIALIZED  if UWB stack is not initialized
 * \retval UWB_STATUS_CODE_INVALID_ARGUMENT    if invalid parameters are passed
 * \retval #UWB_STATUS_CODE_FAILED           otherwise
 *
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Success
 * \retval UWB_STATUS_CODE_INSUFFICIENT_BUFFER Not enough buffer allocated
 */
 ...
 *
 * \retval UWB_STATUS_CODE_SUCCESS Success
 * \retval UWB_STATUS_CODE_FAILED Generic failure
 *
 */
 ...
 *
 *  \retval UWB_STATUS_CODE_SUCCESS Successfully serialized SendData payload
 *  \retval UWB_STATUS_CODE_INSUFFICIENT_BUFFER Passed buffer size was not sufficient to serialize
 * payload
 */
