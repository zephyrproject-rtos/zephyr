...
/**
 * @file
 * @brief UWB UCI core layer
 *
 * This file contains core UCI implementation
 * to handle control and data UCI packets
 */
 ...
 * @defgroup uci_core UWB UCI core API
 * @ingroup uwb
 * @{
 */

/** UCI control packet header structure */
typedef struct {
#if CONFIG_LITTLE_ENDIAN
	/** Group Identifier (GID) */
	uint8_t gid: 4;
	/** Packet Boundary Flag (PBF) to identify chained packets */
	uint8_t pbf: 1;
	/** Message Type - CMD / RSP / NTF */
	uint8_t mt: 3;
...
/** UCI data packet header structure */
typedef struct {
#if CONFIG_LITTLE_ENDIAN
	/** Data Packet Format */
	uint8_t dpf: 4;
