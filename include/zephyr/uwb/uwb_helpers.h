...
/**
 * @file
 * @brief UWB Helper functions
 *
 * This file contains functions to assist with
 * parsing and printing of incoming notifications
 */
...
/**
 * @brief UWB subsystem parsing and printing APIs
 * @addtogroup uwb
 * @{
 */
