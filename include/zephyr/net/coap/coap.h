...
enum coap_option_num {
	 ...
	 * OSCORE (RFC 8613)
	 *
	 * Critical option indicating the message is OSCORE-protected.
	 * A CoAP message with the OSCORE option present but no payload
	 * is malformed and SHALL be rejected (RFC 8613 Section 2).
	 */
