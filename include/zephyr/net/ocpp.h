...
/**
 * @brief OCPP IdTage authorization status in result to ocpp request
 *        authorization
 */
...
enum ocpp_meter_measurand {
	OCPP_OMM_CURRENT_FROM_EV,		/* in A */
	OCPP_OMM_CURRENT_TO_EV,			/* in A */
	OCPP_OMM_CURRENT_MAX_OFFERED_TO_EV,	/* in A */
	OCPP_OMM_ACTIVE_ENERGY_FROM_EV,		/* in Wh */
	OCPP_OMM_ACTIVE_ENERGY_TO_EV,		/* in Wh */
	OCPP_OMM_REACTIVE_ENERGY_FROM_EV,	/* in varh */
	OCPP_OMM_REACTIVE_ENERGY_TO_EV,		/* in varh */
	OCPP_OMM_ACTIVE_POWER_FROM_EV,		/* in W */
	OCPP_OMM_ACTIVE_POWER_TO_EV,		/* in W */
	OCPP_OMM_REACTIVE_POWER_FROM_EV,	/* in var */
	OCPP_OMM_REACTIVE_POWER_TO_EV,		/* in var */
	OCPP_OMM_POWERLINE_FREQ,		/* Hz */
	OCPP_OMM_POWER_FACTOR,
	OCPP_OMM_POWER_MAX_OFFERED_TO_EV,	/* in W */
	OCPP_OMM_FAN_SPEED,			/* in rpm */
	OCPP_OMM_CHARGING_PERCENT,
	OCPP_OMM_TEMPERATURE,			/* in Celsius */
	OCPP_OMM_VOLTAGE_AC_RMS,		/* in V */
 ...
 *
 * @return 0 or a negative error code (errono.h)
 */
 ...
 *
 * @result: 0 or a negative error code (errno.h) indicating reason of failure
 *
