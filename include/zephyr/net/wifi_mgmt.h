...
struct wifi_connect_req_params {
	 ...
	 *
	 * When PMKSA import is enabled, backends import supported, valid entries
	 * before association and ignore entries they cannot import. PMKSA import
	 * must not prevent normal association. Supplying entries when PMKSA import
	 * is disabled causes the connection request to fail with -ENOTSUP
