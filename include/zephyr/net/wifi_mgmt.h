...
#define _NET_WIFI_BASE                                                                             \
	(NET_MGMT_IFACE_BIT | NET_MGMT_LAYER(_NET_WIFI_LAYER) | NET_MGMT_LAYER_CODE(_NET_WIFI_CODE))
...
#define NET_REQUEST_WIFI_DPP (_NET_WIFI_BASE | NET_REQUEST_WIFI_CMD_DPP)
