...
#define NET_EVENT_IPV4_ACD_CONFLICT				\
	(NET_EVENT_IPV4_BASE | BIT64(NET_EVENT_IPV4_CMD_ACD_CONFLICT))

/** IPv4 Path MTU is changed. */
#define NET_EVENT_IPV4_PMTU_CHANGED				\
	(NET_EVENT_IPV4_BASE | BIT64(NET_EVENT_IPV4_CMD_PMTU_CHANGED))
...
#define NET_EVENT_L4_CONNECTED					\
	(NET_EVENT_L4_BASE | BIT64(NET_EVENT_L4_CMD_CONNECTED))
