...
enum net_event_if_cmd {
	...
	NET_EVENT_IF_CMD_CONNECTIVITY_TIMEOUT,
	NET_EVENT_IF_CMD_CONNECTIVITY_FATAL_ERROR,
};
...
#define NET_EVENT_IF_CONNECTIVITY_TIMEOUT		\
	(_NET_EVENT_IF_BASE | NET_EVENT_IF_CMD_CONNECTIVITY_TIMEOUT)

#define NET_EVENT_IF_CONNECTIVITY_FATAL_ERROR		\
	(_NET_EVENT_IF_BASE | NET_EVENT_IF_CMD_CONNECTIVITY_FATAL_ERROR)
