...
enum net_event_ppp_cmd {
	NET_EVENT_PPP_CMD_CARRIER_ON = BIT(0),
	NET_EVENT_PPP_CMD_CARRIER_OFF = BIT(1),
	NET_EVENT_PPP_CMD_PHASE_RUNNING = BIT(2),
	NET_EVENT_PPP_CMD_PHASE_DEAD = BIT(3),
};
