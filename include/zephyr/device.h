 ...
 * assigned priority. All such devices are placed in a dedicated band that
 ...
 * `PRE_KERNEL_2` level. A driver whose clock-control, pinctrl or other
 ...
 * automatic-ordering band used by DEVICE_DT_DEFINE_AUTO(), using the
