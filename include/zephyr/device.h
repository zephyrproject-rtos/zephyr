 ...
 *
 * Note: deinit_fn will only be used if CONFIG_DEVICE_PROVIDE_DEINIT is enabled.
 *
...
#ifdef CONFIG_DEVICE_PROVIDE_DEINIT
	/** De-initialization function */
	int (*deinit)(const struct device *dev);
#endif /* CONFIG_DEVICE_PROVIDE_DEINIT */
};
 ...
 *
 * Note: this will be available if CONFIG_DEVICE_PROVIDE_DEINIT is enabled.
 *
 ...
 *         feature is not enabled (see CONFIG_DEVICE_PROVIDE_DEINIT)
...
#define Z_DEVICE_OPS(init_fn_, deinit_fn_)                                     \
	{                                                                      \
		.init = (init_fn_),                                            \
		IF_ENABLED(CONFIG_DEVICE_PROVIDE_DEINIT,                       \
			   (.deinit = (deinit_fn_),))                          \
	}
