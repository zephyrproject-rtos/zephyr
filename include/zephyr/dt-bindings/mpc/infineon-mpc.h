...
#define IFX_MPC_SECURE     0
#define IFX_MPC_NON_SECURE 1

/* "access" field: the region's access permission for the protection context. */
#define IFX_MPC_ACCESS_NONE 0
#define IFX_MPC_ACCESS_R    1
#define IFX_MPC_ACCESS_W    2
#define IFX_MPC_ACCESS_RW   3
