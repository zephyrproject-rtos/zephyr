...
/**
 * @defgroup ICM4268X_ACCEL_SCALE Accelerometer scale options
 * @{
 */
#define ICM4268X_DT_ACCEL_FS_32		0
#define ICM4268X_DT_ACCEL_FS_16		1
#define ICM4268X_DT_ACCEL_FS_8		2
#define ICM4268X_DT_ACCEL_FS_4		3
#define ICM4268X_DT_ACCEL_FS_2		4
/** @} */

/**
 * @defgroup ICM4268X_GYRO_SCALE Gyroscope scale options
 * @{
 */
#define ICM4268X_DT_GYRO_FS_4000	0
#define ICM4268X_DT_GYRO_FS_2000	1
#define ICM4268X_DT_GYRO_FS_1000	2
#define ICM4268X_DT_GYRO_FS_500		3
#define ICM4268X_DT_GYRO_FS_250		4
#define ICM4268X_DT_GYRO_FS_125		5
#define ICM4268X_DT_GYRO_FS_62_5	6
#define ICM4268X_DT_GYRO_FS_31_25	7
#define ICM4268X_DT_GYRO_FS_15_625	8
/** @} */
