...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_IIS2DLPC_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_IIS2DLPC_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_SENSOR_IIS2DLPC_H_ */
