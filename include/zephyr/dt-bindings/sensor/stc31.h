 ...
 *
 * Values for the `binary-gas` devicetree property (STC31-C datasheet section 3.3.2).
 * @{
 */

/* Low-noise modes (STC31 and STC31-C) */
...
/* Low-cross-sensitivity modes (STC31-C only) */
