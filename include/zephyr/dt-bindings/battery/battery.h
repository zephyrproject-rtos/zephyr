...
/**
 * @file
 * @brief Main header file for battery-related constants to be used in devicetree.
 * @ingroup devicetree-battery
 */
...
/**
 * @defgroup devicetree-battery Devicetree battery helpers
 * @ingroup devicetree
 * @ingroup fuel_gauge_interface
 * @{
 *
 * @name Default Battery OCV curves
 * @brief Default Open-Circuit Voltage curves for different battery chemistries.
 *
...
/**
 * @brief Default open-circuit voltage curve for nickel-cadmium (NiCd) batteries.
 *
 * Based on Panasonic KR-1800SCE.
 */
...
/**
 * @brief Default open-circuit voltage curve for nickel-metal hydride (NiMH) batteries.
 *
 * Based on Panasonic BK-1100FHU.
 */
 ...
 *
 * Based on Drypower IFR18650 E1600.
 */
...
/**
 * @brief Default open-circuit voltage curve for lithium manganese (LiMn2O4) batteries.
 *
 * Based on FDK CR14250SE.
 */
