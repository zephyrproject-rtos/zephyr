...
#define USART2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 2, CCIPR1_REG)
#define USART3_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 4, CCIPR1_REG)
#define UART4_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 6, CCIPR1_REG)
#define UART5_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 8, CCIPR1_REG)
#define I2C1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 10, CCIPR1_REG)
#define I2C2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 12, CCIPR1_REG)
#define I2C4_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 14, CCIPR1_REG)
#define SPI2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 16, CCIPR1_REG)
#define LPTIM2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 18, CCIPR1_REG)
#define SPI1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 20, CCIPR1_REG)
#define SYSTICK_SEL(val)	STM32_DT_CLOCK_SELECT((val), 2, 22, CCIPR1_REG)
#define FDCAN1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 24, CCIPR1_REG)
#define ICKLK_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 26, CCIPR1_REG)
#define TIMIC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 29, CCIPR1_REG)
/** CCIPR2 devices */
#define MDF1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 0, CCIPR2_REG)
...
#define RNG_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 12, CCIPR2_REG)
...
#define OCTOSPI_SEL(val)	STM32_DT_CLOCK_SELECT((val), 2, 20, CCIPR2_REG)
#define HSPI_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 22, CCIPR2_REG)
#define I2C5_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 24, CCIPR2_REG)
#define I2C6_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 26, CCIPR2_REG)
#define OTGHS_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 30, CCIPR2_REG)
/** CCIPR3 devices */
#define LPUART1_SEL(val)	STM32_DT_CLOCK_SELECT((val), 3, 0, CCIPR3_REG)
#define SPI3_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 3, CCIPR3_REG)
#define I2C3_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 6, CCIPR3_REG)
...
#define ADCDAC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 12, CCIPR3_REG)
#define DAC1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 15, CCIPR3_REG)
#define ADF1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 16, CCIPR3_REG)
/** BDCR devices */
