...
/**
 * @file
 * @brief Clock-specifier indices for the NXP MCXL always-on (AON) clock controller.
 */
...
#define MCXL_AON_GATE_KPP      12
#define MCXL_AON_GATE_LPACMP   13
#define MCXL_AON_GATE_LCD      14
#define MCXL_AON_GATE_ACMP0    15
#define MCXL_AON_GATE_ACMP0RR  16
...
#define MCXL_AON_SEL_LPTMR    6
#define MCXL_AON_SEL_LCD      7
#define MCXL_AON_SEL_ACMP0    8
...
#define MCXL_AON_DIV_ACMP0CLK0 4
#define MCXL_AON_DIV_ACMP0CLK1 5
