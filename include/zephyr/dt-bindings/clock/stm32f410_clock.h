...
#define I2S1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 25, DCKCFGR_REG)
#define I2S2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 27, DCKCFGR_REG)
#define CKDFSDM_SEL(val)	STM32_DT_CLOCK_SELECT((val), 1, 31, DCKCFGR_REG)

/** DCKCFGR2 devices */
#define I2CFMP1_SEL(val)	STM32_DT_CLOCK_SELECT((val), 2, 22, DCKCFGR2_REG)
...
#define LPTIM1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 30, DCKCFGR2_REG)
