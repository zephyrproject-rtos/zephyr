/**
 * @file
 * @brief Clock module IDs for nuvoton m48x
 * @ingroup clock_control_nuvoton_m48x
 */
...
/**
 * @defgroup clock_control_nuvoton_m48x Nuvoton M48x Clock Controller Devicetree helpers
 * @ingroup clock_control_interface
 *
 * @details Devicetree macros/defines for clock module ids on Nuvoton M48x devices,
 * fur use with the <tt>nuvoton,numicro-m4-scc</tt> binding.
 *
 * @{
 */
...
/**
 * @name Clock enable register offsets
 * @{
 */
...
/**
 * @name Clock selection register offsets
 * @{
 */
...
/**
 * @name Clock divider register offsets
 * @{
 */
...
/**
 * @name Clock selection constants
 * @{
 */
