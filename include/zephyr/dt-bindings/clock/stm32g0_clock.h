...
#define RNG_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 26, CCIPR_REG)
#define ADC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 30, CCIPR_REG)
/** CCIPR2 devices */
#define I2S1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 0, CCIPR2_REG)
#define I2S2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 2, CCIPR2_REG)
#define FDCAN_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 8, CCIPR2_REG)
#define USB_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 12, CCIPR2_REG)
/** BDCR devices */
