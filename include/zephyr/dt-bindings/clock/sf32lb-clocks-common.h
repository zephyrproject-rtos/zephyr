...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SF32LB_CLOCKS_COMMON_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SF32LB_CLOCKS_COMMON_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SF32LB_CLOCKS_COMMON_H_ */
