...
#define STM32_SRC_PLL_DIVR	(STM32_SRC_PLL_R + 1)
/** PLLI2S clock outputs */
#define STM32_SRC_PLLI2S_P	(STM32_SRC_PLL_DIVR + 1)
#define STM32_SRC_PLLI2S_Q	(STM32_SRC_PLLI2S_P + 1)
#define STM32_SRC_PLLI2S_DIVQ	(STM32_SRC_PLLI2S_Q + 1)
#define STM32_SRC_PLLI2S_R	(STM32_SRC_PLLI2S_DIVQ + 1)
#define STM32_SRC_PLLI2S_DIVR	(STM32_SRC_PLLI2S_R + 1)
/* PLLSAI clock outputs */
#define STM32_SRC_PLLSAI_P	(STM32_SRC_PLLI2S_DIVR + 1)
...
/* CLK48MHz sources */
#define STM32_SRC_CK48		(STM32_SRC_PLLSAI_DIVR + 1)
/** Bus clock */
