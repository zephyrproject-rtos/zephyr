...
/* RM0456, Figure 36 Clock tree for STM32U3 Series */
...
/** Bus clock */
#define STM32_SRC_HCLK		(STM32_SRC_MSIS + 1)
...
#define SPI4_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 7, CCIPR2_REG)
#define I2C4_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 9, CCIPR2_REG)
...
#define USART2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 22, CCIPR2_REG)
/** CCIPR3 devices */
