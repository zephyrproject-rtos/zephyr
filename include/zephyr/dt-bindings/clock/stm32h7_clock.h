...
#define QSPI_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 4, D1CCIPR_REG)
...
#define OSPI_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 4, D1CCIPR_REG)
/** D2CCIP1R devices */
#define SAI1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 0, D2CCIP1R_REG)
#define SAI23_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 6, D2CCIP1R_REG)
#define SPI123_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 12, D2CCIP1R_REG)
#define SPI45_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 16, D2CCIP1R_REG)
#define SPDIF_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 20, D2CCIP1R_REG)
#define DFSDM1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 24, D2CCIP1R_REG)
#define FDCAN_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 28, D2CCIP1R_REG)
#define SWP_SEL(val)		STM32_DT_CLOCK_SELECT((val), 1, 31, D2CCIP1R_REG)
/** D2CCIP2R devices */
#define USART2345678_SEL(val)	STM32_DT_CLOCK_SELECT((val), 3, 0, D2CCIP2R_REG)
#define USART16_SEL(val)	STM32_DT_CLOCK_SELECT((val), 3, 3, D2CCIP2R_REG)
#define RNG_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 8, D2CCIP2R_REG)
#define I2C123_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 12, D2CCIP2R_REG)
#define USB_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 20, D2CCIP2R_REG)
#define CEC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 22, D2CCIP2R_REG)
#define LPTIM1_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 28, D2CCIP2R_REG)
/** D3CCIPR devices */
#define LPUART1_SEL(val)	STM32_DT_CLOCK_SELECT((val), 3, 0, D3CCIPR_REG)
#define I2C4_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 8, D3CCIPR_REG)
#define LPTIM2_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 10, D3CCIPR_REG)
#define LPTIM345_SEL(val)	STM32_DT_CLOCK_SELECT((val), 3, 13, D3CCIPR_REG)
#define ADC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 16, D3CCIPR_REG)
#define SAI4A_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 21, D3CCIPR_REG)
#define SAI4B_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 24, D3CCIPR_REG)
#define SPI6_SEL(val)		STM32_DT_CLOCK_SELECT((val), 3, 28, D3CCIPR_REG)
/** BDCR devices */
#define RTC_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 8, BDCR_REG)
/** CFGR devices */
#define MCO1_SEL(val)           STM32_DT_CLOCK_SELECT((val), 4, 22, CFGR_REG)
#define MCO1_PRE(val)           STM32_DT_CLOCK_SELECT((val), 3, 18, CFGR_REG)
#define MCO2_SEL(val)           STM32_DT_CLOCK_SELECT((val), 4, 29, CFGR_REG)
#define MCO2_PRE(val)           STM32_DT_CLOCK_SELECT((val), 3, 25, CFGR_REG)
