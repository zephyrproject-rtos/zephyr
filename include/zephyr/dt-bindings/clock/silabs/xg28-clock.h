...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_XG28_CLOCK_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_XG28_CLOCK_H_
...
#define CLOCK_MVP           (FIELD_PREP(CLOCK_REG_MASK, 1) | FIELD_PREP(CLOCK_BIT_MASK, 29))
