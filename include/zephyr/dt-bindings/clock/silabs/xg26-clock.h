...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_XG26_CLOCK_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_XG26_CLOCK_H_
...
#define CLOCK_EUSART2      (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 5))
#define CLOCK_EUSART3      (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 6))
...
#define CLOCK_I2C2         (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 9))
#define CLOCK_I2C3         (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 10))
...
#define CLOCK_TIMER5       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 0))
#define CLOCK_TIMER6       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 1))
#define CLOCK_TIMER7       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 2))
#define CLOCK_TIMER8       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 3))
#define CLOCK_TIMER9       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 4))
...
#define CLOCK_USART1       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 7))
#define CLOCK_USART2       (FIELD_PREP(CLOCK_REG_MASK, 2) | FIELD_PREP(CLOCK_BIT_MASK, 8))
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SILABS_XG26_CLOCK_H_ */
