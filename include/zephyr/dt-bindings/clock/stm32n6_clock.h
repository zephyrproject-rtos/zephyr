...
#define STM32_SRC_HCLK		(STM32_SRC_HSI_DIV + 1)
#define STM32_SRC_I2S_CKIN	(STM32_SRC_HCLK + 1)
#define STM32_SRC_TIMG		(STM32_SRC_I2S_CKIN + 1)
#define STM32_SRC_PCLK1		(STM32_SRC_TIMG + 1)
