...
#define STM32_SRC_HSE_DIV2_OSC	(STM32_SRC_HSI_DIV + 1)
#define STM32_SRC_TIMG		(STM32_SRC_HSE_DIV2_OSC + 1)
...
#define ICx_PLLy_SEL(ic, pll)	STM32_DT_CLOCK_SELECT((pll) - 1, 29, 28, ICxCFGR_REG(ic))
