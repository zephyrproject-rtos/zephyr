...
/**
 * @file
 * @brief Clock-specifier indices for the NXP MCXL main-domain clock controller.
 */
...
#define MCXL_MAIN_GATE_CTIMER0       19
#define MCXL_MAIN_GATE_CTIMER1       20
#define MCXL_MAIN_GATE_CTIMER2       21
#define MCXL_MAIN_GATE_ACMP0         22
#define MCXL_MAIN_GATE_SGLCD         23
...
#define MCXL_MAIN_SEL_CTIMERG0      7
#define MCXL_MAIN_SEL_CTIMERG1      8
#define MCXL_MAIN_SEL_CMP0_RR       9
...
#define MCXL_MAIN_DIV_CTIMER0       7
#define MCXL_MAIN_DIV_CTIMER1       8
#define MCXL_MAIN_DIV_CMP0_FUNC     9
#define MCXL_MAIN_DIV_CMP0_RR       10
