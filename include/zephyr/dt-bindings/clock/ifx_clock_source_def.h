...
#define CLK_SOURCE_IMO       /*!< Internal Main Oscillator */
#define CLK_SOURCE_ILO       /*!< Internal Low-speed Oscillator */
#define CLK_SOURCE_WCO       /*!< Watch Crystal Oscillator */
#define CLK_SOURCE_EXTCLK    /*!< External clock input */

/* Clock block IDs for CAT2 */
#define IFX_CAT2_CLOCK_BLOCK_IMO    1  /*!< Internal Main Oscillator Clock Block */
#define IFX_CAT2_CLOCK_BLOCK_ILO    2  /*!< Internal Low-speed Oscillator Clock Block */
#define IFX_CAT2_CLOCK_BLOCK_WCO    3  /*!< Watch Crystal Oscillator Clock Block */
#define IFX_CAT2_CLOCK_BLOCK_EXT    4  /*!< External Input Clock Block */

#define IFX_CAT2_BLOCK_HFCLK_SEL    5
#define IFX_CAT2_BLOCK_PUMP_SEL     6
#define IFX_CAT2_BLOCK_WDT_CLKEN    7

#define IFX_CAT2_CLOCK_BLOCK_HF     10 /*!< High Frequency Clock */
#define IFX_CAT2_CLOCK_BLOCK_MF     11 /*!< Medium Frequency Clock */
#define IFX_CAT2_CLOCK_BLOCK_LF     12 /*!< Low Frequency Clock */
#define IFX_CAT2_CLOCK_BLOCK_PERI   13 /*!< Peripheral Clock */

/* HF Clock dividers */
#define IFX_CAT2_CLKHF_NO_DIVIDE    0  /**< Don't divide HF clock */
#define IFX_CAT2_CLKHF_DIV_BY_2     1
#define IFX_CAT2_CLKHF_DIV_BY_4     2
#define IFX_CAT2_CLKHF_DIV_BY_8     3

/* Path mux selections (only clocks available on PSoC4) */
#define IFX_CAT2_CLKPATH_IN_IMO     0  /**< Select IMO as path mux output */
#define IFX_CAT2_CLKPATH_IN_ILO     1  /**< Select ILO as path mux output */
#define IFX_CAT2_CLKPATH_IN_WCO     2  /**< Select WCO as path mux output */
#define IFX_CAT2_CLKPATH_IN_EXTCLK  3  /**< Select EXTCLK as path mux output */
