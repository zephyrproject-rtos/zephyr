...
#define LPUART3_SEL(val)	STM32_DT_CLOCK_SELECT((val), 2, 6, CCIPR_REG)
#define LPUART2_SEL(val)	STM32_DT_CLOCK_SELECT((val), 2, 8, CCIPR_REG)
...
#define LPTIM3_SEL(val)		STM32_DT_CLOCK_SELECT((val), 2, 22, CCIPR_REG)
