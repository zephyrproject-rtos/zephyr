...
#define LPUART3_SEL(val)	STM32_DOMAIN_CLOCK(val, 3, 6, CCIPR_REG)
#define LPUART2_SEL(val)	STM32_DOMAIN_CLOCK(val, 3, 8, CCIPR_REG)
...
#define TIM1_SEL(val)		STM32_DOMAIN_CLOCK(val, 1, 24, CCIPR_REG)
#define TIM15_SEL(val)		STM32_DOMAIN_CLOCK(val, 1, 25, CCIPR_REG)
