 ...
 */
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_WCH_CH32V00X_CLOCK_COMMON_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_WCH_CH32V00X_CLOCK_COMMON_H_

#include "wch_clock_common.h"

#define WCH_CLOCK_CONFIG_BUS_HB  0
#define WCH_CLOCK_CONFIG_BUS_PB2 1
#define WCH_CLOCK_CONFIG_BUS_PB1 2

#define CH32V00X_CLOCK_CONFIG(bus, bit) WCH_CLOCK_CONFIG(bus, bit)
...
#define WCH_CLOCK_COUNT 4

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_WCH_CH32V00X_CLOCK_COMMON_H_ */
