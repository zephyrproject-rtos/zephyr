...
/**
 * @brief Pin Enable Disable Values
 */

#define PIN_ENABLE              0x1
#define PIN_DISABLE             0x0

/**
 * @brief PinCfg Offsets
 */

#define PIN_ENABLE_OFFSET       0x0
