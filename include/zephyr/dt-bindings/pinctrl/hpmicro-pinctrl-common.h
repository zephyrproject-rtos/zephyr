...
#define HPMICRO_PORTB                   32  /* IO port B */
#define HPMICRO_PORTC                   64  /* IO port C */
#define HPMICRO_PORTD                   96  /* IO port D */
#define HPMICRO_PORTE                   128 /* IO port E */
#define HPMICRO_PORTF                   160 /* IO port F */
#define HPMICRO_PORTX                   416 /* IO port X */
#define HPMICRO_PORTY                   448 /* IO port Y */
 ...
 */
#define HPMICRO_PIN(_port, _pin)        (_port + _pin)
...
#define HPMICRO_PINMUX(port, pin, ioc, is_analog, alt)			\
	HPMICRO_PINMUX_1(HPMICRO_PIN(HPMICRO_PORT##port, pin), IOC_TYPE_##ioc, is_analog, alt)
