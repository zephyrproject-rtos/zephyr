...
/**
 * @file
 * @brief Devicetree pin control helpers for Espressif ESP32H2
...
/**
 * @defgroup pinctrl_esp32h2 Espressif ESP32H2 pin control helpers
 * @brief Macros for pin control configuration of Espressif ESP32H2
