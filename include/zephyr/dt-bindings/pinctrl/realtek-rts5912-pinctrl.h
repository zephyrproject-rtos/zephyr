...
#define REALTEK_RTS5912_GPIO_PINON		BIT(1)		// Input detection : 1 enable 0 disable
...
#define REALTEK_RTS5912_GPIO_DRIVING	BIT(11)		// DRIVING : 0 low driving capability 1 high driving capability
#define REALTEK_RTS5912_GPIO_SLEW		BIT(12)		// SLEW : 0 fast slew rate 1 slow slew rate
...
#define REALTEK_RTS5912_GPIO_TYPE		BIT(16)		// TYPE : 0 push pull 1 open drain
...
#define REALTEK_RTS5912_PINMUX(n, f)							  \
	(((((n) >> 5) & REALTEK_RTS5912_GPIO_HIGH_MSK) << REALTEK_RTS5912_GPIO_HIGH_POS)	| \
	 (((n) & REALTEK_RTS5912_GPIO_LOW_MSK) << REALTEK_RTS5912_GPIO_LOW_POS)		| \
	 (f) )
...
#define REALTEK_RTS5912_GET_PURE_PINMUX(n)							  \
	( n & 0xFF03FF07 )

#define STD_GPIO_FUNC1		   ((REALTEK_RTS5912_FUNC1) | (REALTEK_RTS5912_GPIO_PINON) | (REALTEK_RTS5912_GPIO_SCHMITTER))
#define STD_GPIO_FUNC2		   ((REALTEK_RTS5912_FUNC2) | (REALTEK_RTS5912_GPIO_PINON) | (REALTEK_RTS5912_GPIO_SCHMITTER))
#define STD_GPIO_FUNC3		   ((REALTEK_RTS5912_FUNC3) | (REALTEK_RTS5912_GPIO_PINON) | (REALTEK_RTS5912_GPIO_SCHMITTER))
