...
/* I2S_I_BCK */
#define I2S_I_BCK_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

#define I2S_I_BCK_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SI_BCK_IN, ESP_I2SI_BCK_OUT)

/* I2S_I_SD */
#define I2S_I_SD_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SI_SD_IN, ESP_NOSIG)

#define I2S_I_SD_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SI_SD_IN, ESP_NOSIG)

/* I2S_I_WS */
#define I2S_I_WS_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

#define I2S_I_WS_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SI_WS_IN, ESP_I2SI_WS_OUT)

/* I2S_MCLK */
#define I2S_MCLK_GPIO0 \
	ESP32_PINMUX(0, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO1 \
	ESP32_PINMUX(1, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO2 \
	ESP32_PINMUX(2, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO3 \
	ESP32_PINMUX(3, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO4 \
	ESP32_PINMUX(4, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO5 \
	ESP32_PINMUX(5, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO6 \
	ESP32_PINMUX(6, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO7 \
	ESP32_PINMUX(7, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO8 \
	ESP32_PINMUX(8, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO9 \
	ESP32_PINMUX(9, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO10 \
	ESP32_PINMUX(10, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO11 \
	ESP32_PINMUX(11, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO12 \
	ESP32_PINMUX(12, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO13 \
	ESP32_PINMUX(13, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO14 \
	ESP32_PINMUX(14, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO15 \
	ESP32_PINMUX(15, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO16 \
	ESP32_PINMUX(16, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO17 \
	ESP32_PINMUX(17, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO18 \
	ESP32_PINMUX(18, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO19 \
	ESP32_PINMUX(19, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO20 \
	ESP32_PINMUX(20, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

#define I2S_MCLK_GPIO21 \
	ESP32_PINMUX(21, ESP_I2S_MCLK_IN, ESP_I2S_MCLK_OUT)

/* I2S_O_BCK */
#define I2S_O_BCK_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

#define I2S_O_BCK_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SO_BCK_IN, ESP_I2SO_BCK_OUT)

/* I2S_O_SD */
#define I2S_O_SD_GPIO0 \
	ESP32_PINMUX(0, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO1 \
	ESP32_PINMUX(1, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO2 \
	ESP32_PINMUX(2, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO3 \
	ESP32_PINMUX(3, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO4 \
	ESP32_PINMUX(4, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO5 \
	ESP32_PINMUX(5, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO6 \
	ESP32_PINMUX(6, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO7 \
	ESP32_PINMUX(7, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO8 \
	ESP32_PINMUX(8, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO9 \
	ESP32_PINMUX(9, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO10 \
	ESP32_PINMUX(10, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO11 \
	ESP32_PINMUX(11, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO12 \
	ESP32_PINMUX(12, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO13 \
	ESP32_PINMUX(13, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO14 \
	ESP32_PINMUX(14, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO15 \
	ESP32_PINMUX(15, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO16 \
	ESP32_PINMUX(16, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO17 \
	ESP32_PINMUX(17, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO18 \
	ESP32_PINMUX(18, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO19 \
	ESP32_PINMUX(19, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO20 \
	ESP32_PINMUX(20, ESP_NOSIG, ESP_I2SO_SD_OUT)

#define I2S_O_SD_GPIO21 \
	ESP32_PINMUX(21, ESP_NOSIG, ESP_I2SO_SD_OUT)

/* I2S_O_WS */
#define I2S_O_WS_GPIO0 \
	ESP32_PINMUX(0, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO1 \
	ESP32_PINMUX(1, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO2 \
	ESP32_PINMUX(2, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO3 \
	ESP32_PINMUX(3, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO4 \
	ESP32_PINMUX(4, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO5 \
	ESP32_PINMUX(5, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO6 \
	ESP32_PINMUX(6, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO7 \
	ESP32_PINMUX(7, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO8 \
	ESP32_PINMUX(8, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO9 \
	ESP32_PINMUX(9, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO10 \
	ESP32_PINMUX(10, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO11 \
	ESP32_PINMUX(11, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO12 \
	ESP32_PINMUX(12, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO13 \
	ESP32_PINMUX(13, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO14 \
	ESP32_PINMUX(14, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO15 \
	ESP32_PINMUX(15, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO16 \
	ESP32_PINMUX(16, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO17 \
	ESP32_PINMUX(17, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO18 \
	ESP32_PINMUX(18, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO19 \
	ESP32_PINMUX(19, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO20 \
	ESP32_PINMUX(20, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)

#define I2S_O_WS_GPIO21 \
	ESP32_PINMUX(21, ESP_I2SO_WS_IN, ESP_I2SO_WS_OUT)
