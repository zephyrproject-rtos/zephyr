...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_ALIF_BALLETTO_B1_PINCTRL_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_ALIF_BALLETTO_B1_PINCTRL_H_

/**
 * @file
 * @brief Pinctrl definitions for Alif Balletto B1 series
 *
 * This header provides pin multiplexing definitions for the Alif Balletto B1 series.
 ...
 *
 * @param port Port number (0-8 for regular GPIO, 15 for LPGPIO)
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_ALIF_BALLETTO_B1_PINCTRL_H_ */
