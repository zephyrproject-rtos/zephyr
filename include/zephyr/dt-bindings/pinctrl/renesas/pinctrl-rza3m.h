...
/**
 * @file
 * @brief Renesas RZ/A3M pin control (pinctrl) definitions for Zephyr.
 *
 * This header provides macro constants for encoding pin function selections
 * and pin indices for Renesas RZ/A3M SoCs. These values are used by the DeviceTree
...
/**
 * @name  Renesas RZ/A3M Dedicated Pins
 * @{
 */
...
/**
 * @name  Renesas RZ/A3M Digital Noise Filter Options
 *
