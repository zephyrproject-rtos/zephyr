...
#define P010_AMP2M        RA_PINCFG__40(0, 0, 0x02, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P010_AN005        RA_PINCFG__40(0, 0, 0x01, RA_PINCFG_ANALOG)
#define P010_TS30         RA_PINCFG__40(0, 0, 0x0C, RA_PINCFG_FUNC)
#define P010_VREFH0       RA_PINCFG__40(0, 0, 0x03, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P011_AN006        RA_PINCFG__40(0, 1, 0x01, RA_PINCFG_ANALOG)
#define P011_TS31         RA_PINCFG__40(0, 1, 0x0C, RA_PINCFG_FUNC)
#define P011_VREFL0       RA_PINCFG__40(0, 1, 0x03, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P012_AN007        RA_PINCFG__40(0, 2, 0x01, RA_PINCFG_ANALOG)
#define P012_VREFH        RA_PINCFG__40(0, 2, 0x03, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P013_AN008        RA_PINCFG__40(0, 3, 0x01, RA_PINCFG_ANALOG)
#define P013_VREFL        RA_PINCFG__40(0, 3, 0x03, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P014_AN009        RA_PINCFG__40(0, 4, 0x01, RA_PINCFG_ANALOG)
#define P014_DA0          RA_PINCFG__40(0, 4, 0x02, RA_PINCFG_FUNC | RA_PINCFG_ANALOG)
#define P015_AN010        RA_PINCFG__40(0, 5, 0x01, RA_PINCFG_ANALOG)
#define P015_TS28         RA_PINCFG__40(0, 5, 0x0C, RA_PINCFG_FUNC)
...
#define P110_CRX0         RA_PINCFG__40(1, 0, 0x10, RA_PINCFG_FUNC)
#define P110_CTS2_RTS2    RA_PINCFG__40(1, 0, 0x04, RA_PINCFG_FUNC)
#define P110_GTIOC1B      RA_PINCFG__40(1, 0, 0x03, RA_PINCFG_FUNC)
#define P110_GTOVLO       RA_PINCFG__40(1, 0, 0x02, RA_PINCFG_FUNC)
#define P110_MISO9        RA_PINCFG__40(1, 0, 0x05, RA_PINCFG_FUNC)
#define P110_MISOB        RA_PINCFG__40(1, 0, 0x06, RA_PINCFG_FUNC)
#define P110_RXD9         RA_PINCFG__40(1, 0, 0x05, RA_PINCFG_FUNC)
#define P110_SCL9         RA_PINCFG__40(1, 0, 0x05, RA_PINCFG_FUNC)
#define P110_SEG24        RA_PINCFG__40(1, 0, 0x0D, RA_PINCFG_FUNC)
#define P110_SS2          RA_PINCFG__40(1, 0, 0x04, RA_PINCFG_FUNC)
#define P110_VCOUT        RA_PINCFG__40(1, 0, 0x09, RA_PINCFG_FUNC)
#define P111_CAPH         RA_PINCFG__40(1, 1, 0x0D, RA_PINCFG_FUNC)
#define P111_GTIOC3A      RA_PINCFG__40(1, 1, 0x03, RA_PINCFG_FUNC)
#define P111_RSPCKB       RA_PINCFG__40(1, 1, 0x06, RA_PINCFG_FUNC)
#define P111_SCK2         RA_PINCFG__40(1, 1, 0x04, RA_PINCFG_FUNC)
#define P111_SCK9         RA_PINCFG__40(1, 1, 0x05, RA_PINCFG_FUNC)
#define P111_TS12         RA_PINCFG__40(1, 1, 0x0C, RA_PINCFG_FUNC)
#define P112_CAPL         RA_PINCFG__40(1, 2, 0x0D, RA_PINCFG_FUNC)
#define P112_GTIOC3B      RA_PINCFG__40(1, 2, 0x03, RA_PINCFG_FUNC)
#define P112_MOSI2        RA_PINCFG__40(1, 2, 0x04, RA_PINCFG_FUNC)
#define P112_SCK1         RA_PINCFG__40(1, 2, 0x05, RA_PINCFG_FUNC)
#define P112_SDA2         RA_PINCFG__40(1, 2, 0x04, RA_PINCFG_FUNC)
#define P112_SSIBCK0      RA_PINCFG__40(1, 2, 0x12, RA_PINCFG_FUNC)
#define P112_SSLB0        RA_PINCFG__40(1, 2, 0x06, RA_PINCFG_FUNC)
#define P112_TSCAP        RA_PINCFG__40(1, 2, 0x0C, RA_PINCFG_FUNC)
#define P112_TXD2         RA_PINCFG__40(1, 2, 0x04, RA_PINCFG_FUNC)
#define P113_GTIOC2A      RA_PINCFG__64(1, 3, 0x03, RA_PINCFG_FUNC)
#define P113_SEG00COM4    RA_PINCFG__64(1, 3, 0x0D, RA_PINCFG_FUNC)
#define P113_SSIFS0       RA_PINCFG__64(1, 3, 0x12, RA_PINCFG_FUNC)
#define P113_SSILRCK0     RA_PINCFG__64(1, 3, 0x12, RA_PINCFG_FUNC)
#define P113_TS27         RA_PINCFG__64(1, 3, 0x0C, RA_PINCFG_FUNC)
#define P114_GTIOC2B      RA_PINCFG_100(1, 4, 0x03, RA_PINCFG_FUNC)
#define P114_SEG25        RA_PINCFG_100(1, 4, 0x0D, RA_PINCFG_FUNC)
#define P114_SSIRXD0      RA_PINCFG_100(1, 4, 0x12, RA_PINCFG_FUNC)
#define P114_TS29         RA_PINCFG_100(1, 4, 0x0C, RA_PINCFG_FUNC)
#define P115_GTIOC4A      RA_PINCFG_100(1, 5, 0x03, RA_PINCFG_FUNC)
#define P115_SEG26        RA_PINCFG_100(1, 5, 0x0D, RA_PINCFG_FUNC)
#define P115_SSITXD0      RA_PINCFG_100(1, 5, 0x12, RA_PINCFG_FUNC)
#define P115_TS35         RA_PINCFG_100(1, 5, 0x0C, RA_PINCFG_FUNC)
...
#define P212_AGTEE1       RA_PINCFG__40(2, 2, 0x01, RA_PINCFG_FUNC)
#define P212_GTETRGB      RA_PINCFG__40(2, 2, 0x02, RA_PINCFG_FUNC)
#define P212_GTIOC0B      RA_PINCFG__40(2, 2, 0x03, RA_PINCFG_FUNC)
#define P212_MISO1        RA_PINCFG__40(2, 2, 0x05, RA_PINCFG_FUNC)
#define P212_RXD1         RA_PINCFG__40(2, 2, 0x05, RA_PINCFG_FUNC)
#define P212_SCL1         RA_PINCFG__40(2, 2, 0x05, RA_PINCFG_FUNC)
#define P213_GTETRGA      RA_PINCFG__40(2, 3, 0x02, RA_PINCFG_FUNC)
#define P213_GTIOC0A      RA_PINCFG__40(2, 3, 0x03, RA_PINCFG_FUNC)
#define P213_MOSI1        RA_PINCFG__40(2, 3, 0x05, RA_PINCFG_FUNC)
#define P213_SDA1         RA_PINCFG__40(2, 3, 0x05, RA_PINCFG_FUNC)
#define P213_TXD1         RA_PINCFG__40(2, 3, 0x05, RA_PINCFG_FUNC)
...
#define P410_AGTOB1       RA_PINCFG__64(4, 0, 0x01, RA_PINCFG_FUNC)
#define P410_GTIOC6B      RA_PINCFG__64(4, 0, 0x04, RA_PINCFG_FUNC)
#define P410_GTOVLO       RA_PINCFG__64(4, 0, 0x03, RA_PINCFG_FUNC)
#define P410_MISO0        RA_PINCFG__64(4, 0, 0x04, RA_PINCFG_FUNC)
#define P410_MISOA        RA_PINCFG__64(4, 0, 0x06, RA_PINCFG_FUNC)
#define P410_RXD0         RA_PINCFG__64(4, 0, 0x04, RA_PINCFG_FUNC)
#define P410_SCL0         RA_PINCFG__64(4, 0, 0x04, RA_PINCFG_FUNC)
#define P410_SEG08        RA_PINCFG__64(4, 0, 0x0D, RA_PINCFG_FUNC)
#define P410_TS06         RA_PINCFG__64(4, 0, 0x0C, RA_PINCFG_FUNC)
#define P411_AGTOA1       RA_PINCFG__64(4, 1, 0x01, RA_PINCFG_FUNC)
#define P411_GTIOC6A      RA_PINCFG__64(4, 1, 0x04, RA_PINCFG_FUNC)
#define P411_GTOVUP       RA_PINCFG__64(4, 1, 0x03, RA_PINCFG_FUNC)
#define P411_MOSI0        RA_PINCFG__64(4, 1, 0x04, RA_PINCFG_FUNC)
#define P411_MOSIA        RA_PINCFG__64(4, 1, 0x06, RA_PINCFG_FUNC)
#define P411_SDA0         RA_PINCFG__64(4, 1, 0x04, RA_PINCFG_FUNC)
#define P411_SEG07        RA_PINCFG__64(4, 1, 0x0D, RA_PINCFG_FUNC)
#define P411_TS07         RA_PINCFG__64(4, 1, 0x0C, RA_PINCFG_FUNC)
#define P411_TXD0         RA_PINCFG__64(4, 1, 0x04, RA_PINCFG_FUNC)
#define P412_RSPCKA       RA_PINCFG_100(4, 2, 0x06, RA_PINCFG_FUNC)
#define P412_SCK0         RA_PINCFG_100(4, 2, 0x04, RA_PINCFG_FUNC)
#define P413_CTS0_RTS0    RA_PINCFG_100(4, 3, 0x04, RA_PINCFG_FUNC)
#define P413_SS0          RA_PINCFG_100(4, 3, 0x04, RA_PINCFG_FUNC)
#define P413_SSLA0        RA_PINCFG_100(4, 3, 0x06, RA_PINCFG_FUNC)
#define P414_GTIOC0B      RA_PINCFG_100(4, 4, 0x04, RA_PINCFG_FUNC)
#define P414_SSLA1        RA_PINCFG_100(4, 4, 0x06, RA_PINCFG_FUNC)
#define P415_GTIOC0A      RA_PINCFG_100(4, 5, 0x04, RA_PINCFG_FUNC)
#define P415_SSLA2        RA_PINCFG_100(4, 5, 0x06, RA_PINCFG_FUNC)
...
#define P610_GTIOC5B      RA_PINCFG_100(6, 0, 0x01, RA_PINCFG_FUNC)
#define P610_SEG29        RA_PINCFG_100(6, 0, 0x0D, RA_PINCFG_FUNC)
...
#define P914_USB_DP       RA_PINCFG__40(9, 4, 0x00, RA_PINCFG_GPIO)
#define P915_USB_DM       RA_PINCFG__40(9, 5, 0x00, RA_PINCFG_GPIO)
#endif
