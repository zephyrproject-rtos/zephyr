 ...
 *
 * Pin Control for Silicon Labs xG28 devices
 *
...
/**
 * @file
 * @brief Devicetree pin control helpers for Silicon Labs xG28
 * @ingroup pinctrl_xg28
 */

#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG28_PINCTRL_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG28_PINCTRL_H_
...
/**
 * @defgroup pinctrl_xg28 Silicon Labs xG28 pin control helpers
 * @brief Macros for pin control configuration of Silicon Labs xG28
 ...
 * - @c I2C0: @c SCL, @c SDA
 * - @c I2C1: @c SCL, @c SDA
 * - @c KEYSCAN: @c COLOUT0, @c COLOUT1, @c COLOUT2, @c COLOUT3, @c COLOUT4, @c COLOUT5, @c COLOUT6,
 *   @c COLOUT7, @c ROWSENSE0, @c ROWSENSE1, @c ROWSENSE2, @c ROWSENSE3, @c ROWSENSE4, @c ROWSENSE5
 * - @c LESENSE: @c CH0OUT, @c CH10OUT, @c CH11OUT, @c CH12OUT, @c CH13OUT, @c CH14OUT, @c CH15OUT,
 *   @c CH1OUT, @c CH2OUT, @c CH3OUT, @c CH4OUT, @c CH5OUT, @c CH6OUT, @c CH7OUT, @c CH8OUT,
 *   @c CH9OUT
...
#define SILABS_DBUS_PTI_DCLK(port, pin)   SILABS_DBUS(port, pin, 57, 1, 0, 1)
#define SILABS_DBUS_PTI_DFRAME(port, pin) SILABS_DBUS(port, pin, 57, 1, 1, 2)
#define SILABS_DBUS_PTI_DOUT(port, pin)   SILABS_DBUS(port, pin, 57, 1, 2, 3)
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG28_PINCTRL_H_ */
