...
/**
 * @file
 * @brief Devicetree pin control helpers for Silicon Labs xG22
 * @ingroup pinctrl_xg22
 */

#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG22_PINCTRL_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG22_PINCTRL_H_
...
/**
 * @defgroup pinctrl_xg22 Silicon Labs xG22 pin control helpers
 * @brief Macros for pin control configuration of Silicon Labs xG22
 ...
 * - @c DCDC: @c DCDCCOREHIDDEN
 * - @c EUART0: @c CTS, @c RTS, @c RX, @c TX
 ...
 * - @c USART1: @c CLK, @c CS, @c CTS, @c RTS, @c RX, @c TX
 *
 * @{
 */
...
#define SILABS_DBUS_CMU_CLKIN0(port, pin)  SILABS_DBUS(port, pin, 4, 0, 0, 1)

#define SILABS_DBUS_PTI_DCLK(port, pin)   SILABS_DBUS(port, pin, 15, 1, 0, 1)
#define SILABS_DBUS_PTI_DFRAME(port, pin) SILABS_DBUS(port, pin, 15, 1, 1, 2)
#define SILABS_DBUS_PTI_DOUT(port, pin)   SILABS_DBUS(port, pin, 15, 1, 2, 3)

#define SILABS_DBUS_I2C0_SCL(port, pin) SILABS_DBUS(port, pin, 20, 1, 0, 1)
#define SILABS_DBUS_I2C0_SDA(port, pin) SILABS_DBUS(port, pin, 20, 1, 1, 2)

#define SILABS_DBUS_I2C1_SCL(port, pin) SILABS_DBUS(port, pin, 24, 1, 0, 1)
#define SILABS_DBUS_I2C1_SDA(port, pin) SILABS_DBUS(port, pin, 24, 1, 1, 2)

#define SILABS_DBUS_LETIMER0_OUT0(port, pin) SILABS_DBUS(port, pin, 28, 1, 0, 1)
#define SILABS_DBUS_LETIMER0_OUT1(port, pin) SILABS_DBUS(port, pin, 28, 1, 1, 2)

#define SILABS_DBUS_EUART0_RTS(port, pin) SILABS_DBUS(port, pin, 32, 1, 0, 2)
#define SILABS_DBUS_EUART0_TX(port, pin)  SILABS_DBUS(port, pin, 32, 1, 1, 4)
#define SILABS_DBUS_EUART0_CTS(port, pin) SILABS_DBUS(port, pin, 32, 0, 0, 1)
#define SILABS_DBUS_EUART0_RX(port, pin)  SILABS_DBUS(port, pin, 32, 0, 0, 3)

#define SILABS_DBUS_MODEM_ANT0(port, pin)        SILABS_DBUS(port, pin, 38, 1, 0, 1)
#define SILABS_DBUS_MODEM_ANT1(port, pin)        SILABS_DBUS(port, pin, 38, 1, 1, 2)
#define SILABS_DBUS_MODEM_ANTROLLOVER(port, pin) SILABS_DBUS(port, pin, 38, 1, 2, 3)
#define SILABS_DBUS_MODEM_ANTRR0(port, pin)      SILABS_DBUS(port, pin, 38, 1, 3, 4)
#define SILABS_DBUS_MODEM_ANTRR1(port, pin)      SILABS_DBUS(port, pin, 38, 1, 4, 5)
#define SILABS_DBUS_MODEM_ANTRR2(port, pin)      SILABS_DBUS(port, pin, 38, 1, 5, 6)
#define SILABS_DBUS_MODEM_ANTRR3(port, pin)      SILABS_DBUS(port, pin, 38, 1, 6, 7)
#define SILABS_DBUS_MODEM_ANTRR4(port, pin)      SILABS_DBUS(port, pin, 38, 1, 7, 8)
#define SILABS_DBUS_MODEM_ANTRR5(port, pin)      SILABS_DBUS(port, pin, 38, 1, 8, 9)
#define SILABS_DBUS_MODEM_ANTSWEN(port, pin)     SILABS_DBUS(port, pin, 38, 1, 9, 10)
#define SILABS_DBUS_MODEM_ANTSWUS(port, pin)     SILABS_DBUS(port, pin, 38, 1, 10, 11)
#define SILABS_DBUS_MODEM_ANTTRIG(port, pin)     SILABS_DBUS(port, pin, 38, 1, 11, 12)
#define SILABS_DBUS_MODEM_ANTTRIGSTOP(port, pin) SILABS_DBUS(port, pin, 38, 1, 12, 13)
#define SILABS_DBUS_MODEM_DCLK(port, pin)        SILABS_DBUS(port, pin, 38, 1, 13, 14)
#define SILABS_DBUS_MODEM_DOUT(port, pin)        SILABS_DBUS(port, pin, 38, 1, 14, 16)
#define SILABS_DBUS_MODEM_DIN(port, pin)         SILABS_DBUS(port, pin, 38, 0, 0, 15)

#define SILABS_DBUS_PDM_CLK(port, pin)  SILABS_DBUS(port, pin, 56, 1, 0, 1)
#define SILABS_DBUS_PDM_DAT0(port, pin) SILABS_DBUS(port, pin, 56, 0, 0, 2)
#define SILABS_DBUS_PDM_DAT1(port, pin) SILABS_DBUS(port, pin, 56, 0, 0, 3)

#define SILABS_DBUS_PRS0_ASYNCH0(port, pin)  SILABS_DBUS(port, pin, 61, 1, 0, 1)
#define SILABS_DBUS_PRS0_ASYNCH1(port, pin)  SILABS_DBUS(port, pin, 61, 1, 1, 2)
#define SILABS_DBUS_PRS0_ASYNCH2(port, pin)  SILABS_DBUS(port, pin, 61, 1, 2, 3)
#define SILABS_DBUS_PRS0_ASYNCH3(port, pin)  SILABS_DBUS(port, pin, 61, 1, 3, 4)
#define SILABS_DBUS_PRS0_ASYNCH4(port, pin)  SILABS_DBUS(port, pin, 61, 1, 4, 5)
#define SILABS_DBUS_PRS0_ASYNCH5(port, pin)  SILABS_DBUS(port, pin, 61, 1, 5, 6)
#define SILABS_DBUS_PRS0_ASYNCH6(port, pin)  SILABS_DBUS(port, pin, 61, 1, 6, 7)
#define SILABS_DBUS_PRS0_ASYNCH7(port, pin)  SILABS_DBUS(port, pin, 61, 1, 7, 8)
#define SILABS_DBUS_PRS0_ASYNCH8(port, pin)  SILABS_DBUS(port, pin, 61, 1, 8, 9)
#define SILABS_DBUS_PRS0_ASYNCH9(port, pin)  SILABS_DBUS(port, pin, 61, 1, 9, 10)
#define SILABS_DBUS_PRS0_ASYNCH10(port, pin) SILABS_DBUS(port, pin, 61, 1, 10, 11)
#define SILABS_DBUS_PRS0_ASYNCH11(port, pin) SILABS_DBUS(port, pin, 61, 1, 11, 12)
#define SILABS_DBUS_PRS0_SYNCH0(port, pin)   SILABS_DBUS(port, pin, 61, 1, 12, 13)
#define SILABS_DBUS_PRS0_SYNCH1(port, pin)   SILABS_DBUS(port, pin, 61, 1, 13, 14)
#define SILABS_DBUS_PRS0_SYNCH2(port, pin)   SILABS_DBUS(port, pin, 61, 1, 14, 15)
#define SILABS_DBUS_PRS0_SYNCH3(port, pin)   SILABS_DBUS(port, pin, 61, 1, 15, 16)

#define SILABS_DBUS_TIMER0_CC0(port, pin)   SILABS_DBUS(port, pin, 79, 1, 0, 1)
#define SILABS_DBUS_TIMER0_CC1(port, pin)   SILABS_DBUS(port, pin, 79, 1, 1, 2)
#define SILABS_DBUS_TIMER0_CC2(port, pin)   SILABS_DBUS(port, pin, 79, 1, 2, 3)
#define SILABS_DBUS_TIMER0_CDTI0(port, pin) SILABS_DBUS(port, pin, 79, 1, 3, 4)
#define SILABS_DBUS_TIMER0_CDTI1(port, pin) SILABS_DBUS(port, pin, 79, 1, 4, 5)
#define SILABS_DBUS_TIMER0_CDTI2(port, pin) SILABS_DBUS(port, pin, 79, 1, 5, 6)

#define SILABS_DBUS_TIMER1_CC0(port, pin)   SILABS_DBUS(port, pin, 87, 1, 0, 1)
#define SILABS_DBUS_TIMER1_CC1(port, pin)   SILABS_DBUS(port, pin, 87, 1, 1, 2)
#define SILABS_DBUS_TIMER1_CC2(port, pin)   SILABS_DBUS(port, pin, 87, 1, 2, 3)
#define SILABS_DBUS_TIMER1_CDTI0(port, pin) SILABS_DBUS(port, pin, 87, 1, 3, 4)
#define SILABS_DBUS_TIMER1_CDTI1(port, pin) SILABS_DBUS(port, pin, 87, 1, 4, 5)
#define SILABS_DBUS_TIMER1_CDTI2(port, pin) SILABS_DBUS(port, pin, 87, 1, 5, 6)

#define SILABS_DBUS_TIMER2_CC0(port, pin)   SILABS_DBUS(port, pin, 95, 1, 0, 1)
#define SILABS_DBUS_TIMER2_CC1(port, pin)   SILABS_DBUS(port, pin, 95, 1, 1, 2)
#define SILABS_DBUS_TIMER2_CC2(port, pin)   SILABS_DBUS(port, pin, 95, 1, 2, 3)
#define SILABS_DBUS_TIMER2_CDTI0(port, pin) SILABS_DBUS(port, pin, 95, 1, 3, 4)
#define SILABS_DBUS_TIMER2_CDTI1(port, pin) SILABS_DBUS(port, pin, 95, 1, 4, 5)
#define SILABS_DBUS_TIMER2_CDTI2(port, pin) SILABS_DBUS(port, pin, 95, 1, 5, 6)

#define SILABS_DBUS_TIMER3_CC0(port, pin)   SILABS_DBUS(port, pin, 103, 1, 0, 1)
#define SILABS_DBUS_TIMER3_CC1(port, pin)   SILABS_DBUS(port, pin, 103, 1, 1, 2)
#define SILABS_DBUS_TIMER3_CC2(port, pin)   SILABS_DBUS(port, pin, 103, 1, 2, 3)
#define SILABS_DBUS_TIMER3_CDTI0(port, pin) SILABS_DBUS(port, pin, 103, 1, 3, 4)
#define SILABS_DBUS_TIMER3_CDTI1(port, pin) SILABS_DBUS(port, pin, 103, 1, 4, 5)
#define SILABS_DBUS_TIMER3_CDTI2(port, pin) SILABS_DBUS(port, pin, 103, 1, 5, 6)

#define SILABS_DBUS_TIMER4_CC0(port, pin)   SILABS_DBUS(port, pin, 111, 1, 0, 1)
#define SILABS_DBUS_TIMER4_CC1(port, pin)   SILABS_DBUS(port, pin, 111, 1, 1, 2)
#define SILABS_DBUS_TIMER4_CC2(port, pin)   SILABS_DBUS(port, pin, 111, 1, 2, 3)
#define SILABS_DBUS_TIMER4_CDTI0(port, pin) SILABS_DBUS(port, pin, 111, 1, 3, 4)
#define SILABS_DBUS_TIMER4_CDTI1(port, pin) SILABS_DBUS(port, pin, 111, 1, 4, 5)
#define SILABS_DBUS_TIMER4_CDTI2(port, pin) SILABS_DBUS(port, pin, 111, 1, 5, 6)

#define SILABS_DBUS_USART0_CS(port, pin)  SILABS_DBUS(port, pin, 119, 1, 0, 1)
#define SILABS_DBUS_USART0_RTS(port, pin) SILABS_DBUS(port, pin, 119, 1, 1, 3)
#define SILABS_DBUS_USART0_RX(port, pin)  SILABS_DBUS(port, pin, 119, 1, 2, 4)
#define SILABS_DBUS_USART0_CLK(port, pin) SILABS_DBUS(port, pin, 119, 1, 3, 5)
#define SILABS_DBUS_USART0_TX(port, pin)  SILABS_DBUS(port, pin, 119, 1, 4, 6)
#define SILABS_DBUS_USART0_CTS(port, pin) SILABS_DBUS(port, pin, 119, 0, 0, 2)

#define SILABS_DBUS_USART1_CS(port, pin)  SILABS_DBUS(port, pin, 127, 1, 0, 1)
#define SILABS_DBUS_USART1_RTS(port, pin) SILABS_DBUS(port, pin, 127, 1, 1, 3)
#define SILABS_DBUS_USART1_RX(port, pin)  SILABS_DBUS(port, pin, 127, 1, 2, 4)
#define SILABS_DBUS_USART1_CLK(port, pin) SILABS_DBUS(port, pin, 127, 1, 3, 5)
#define SILABS_DBUS_USART1_TX(port, pin)  SILABS_DBUS(port, pin, 127, 1, 4, 6)
#define SILABS_DBUS_USART1_CTS(port, pin) SILABS_DBUS(port, pin, 127, 0, 0, 2)
...
#define EUART0_RTS_PA0 SILABS_DBUS_EUART0_RTS(0x0, 0x0)
#define EUART0_RTS_PA1 SILABS_DBUS_EUART0_RTS(0x0, 0x1)
#define EUART0_RTS_PA2 SILABS_DBUS_EUART0_RTS(0x0, 0x2)
#define EUART0_RTS_PA3 SILABS_DBUS_EUART0_RTS(0x0, 0x3)
#define EUART0_RTS_PA4 SILABS_DBUS_EUART0_RTS(0x0, 0x4)
#define EUART0_RTS_PA5 SILABS_DBUS_EUART0_RTS(0x0, 0x5)
#define EUART0_RTS_PA6 SILABS_DBUS_EUART0_RTS(0x0, 0x6)
#define EUART0_RTS_PA7 SILABS_DBUS_EUART0_RTS(0x0, 0x7)
#define EUART0_RTS_PA8 SILABS_DBUS_EUART0_RTS(0x0, 0x8)
#define EUART0_RTS_PB0 SILABS_DBUS_EUART0_RTS(0x1, 0x0)
#define EUART0_RTS_PB1 SILABS_DBUS_EUART0_RTS(0x1, 0x1)
#define EUART0_RTS_PB2 SILABS_DBUS_EUART0_RTS(0x1, 0x2)
#define EUART0_RTS_PB3 SILABS_DBUS_EUART0_RTS(0x1, 0x3)
#define EUART0_RTS_PB4 SILABS_DBUS_EUART0_RTS(0x1, 0x4)
#define EUART0_RTS_PC0 SILABS_DBUS_EUART0_RTS(0x2, 0x0)
#define EUART0_RTS_PC1 SILABS_DBUS_EUART0_RTS(0x2, 0x1)
#define EUART0_RTS_PC2 SILABS_DBUS_EUART0_RTS(0x2, 0x2)
#define EUART0_RTS_PC3 SILABS_DBUS_EUART0_RTS(0x2, 0x3)
#define EUART0_RTS_PC4 SILABS_DBUS_EUART0_RTS(0x2, 0x4)
#define EUART0_RTS_PC5 SILABS_DBUS_EUART0_RTS(0x2, 0x5)
#define EUART0_RTS_PC6 SILABS_DBUS_EUART0_RTS(0x2, 0x6)
#define EUART0_RTS_PC7 SILABS_DBUS_EUART0_RTS(0x2, 0x7)
#define EUART0_RTS_PD0 SILABS_DBUS_EUART0_RTS(0x3, 0x0)
#define EUART0_RTS_PD1 SILABS_DBUS_EUART0_RTS(0x3, 0x1)
#define EUART0_RTS_PD2 SILABS_DBUS_EUART0_RTS(0x3, 0x2)
#define EUART0_RTS_PD3 SILABS_DBUS_EUART0_RTS(0x3, 0x3)
#define EUART0_TX_PA0  SILABS_DBUS_EUART0_TX(0x0, 0x0)
#define EUART0_TX_PA1  SILABS_DBUS_EUART0_TX(0x0, 0x1)
#define EUART0_TX_PA2  SILABS_DBUS_EUART0_TX(0x0, 0x2)
#define EUART0_TX_PA3  SILABS_DBUS_EUART0_TX(0x0, 0x3)
#define EUART0_TX_PA4  SILABS_DBUS_EUART0_TX(0x0, 0x4)
#define EUART0_TX_PA5  SILABS_DBUS_EUART0_TX(0x0, 0x5)
#define EUART0_TX_PA6  SILABS_DBUS_EUART0_TX(0x0, 0x6)
#define EUART0_TX_PA7  SILABS_DBUS_EUART0_TX(0x0, 0x7)
#define EUART0_TX_PA8  SILABS_DBUS_EUART0_TX(0x0, 0x8)
#define EUART0_TX_PB0  SILABS_DBUS_EUART0_TX(0x1, 0x0)
#define EUART0_TX_PB1  SILABS_DBUS_EUART0_TX(0x1, 0x1)
#define EUART0_TX_PB2  SILABS_DBUS_EUART0_TX(0x1, 0x2)
#define EUART0_TX_PB3  SILABS_DBUS_EUART0_TX(0x1, 0x3)
#define EUART0_TX_PB4  SILABS_DBUS_EUART0_TX(0x1, 0x4)
#define EUART0_TX_PC0  SILABS_DBUS_EUART0_TX(0x2, 0x0)
#define EUART0_TX_PC1  SILABS_DBUS_EUART0_TX(0x2, 0x1)
#define EUART0_TX_PC2  SILABS_DBUS_EUART0_TX(0x2, 0x2)
#define EUART0_TX_PC3  SILABS_DBUS_EUART0_TX(0x2, 0x3)
#define EUART0_TX_PC4  SILABS_DBUS_EUART0_TX(0x2, 0x4)
#define EUART0_TX_PC5  SILABS_DBUS_EUART0_TX(0x2, 0x5)
#define EUART0_TX_PC6  SILABS_DBUS_EUART0_TX(0x2, 0x6)
#define EUART0_TX_PC7  SILABS_DBUS_EUART0_TX(0x2, 0x7)
#define EUART0_TX_PD0  SILABS_DBUS_EUART0_TX(0x3, 0x0)
#define EUART0_TX_PD1  SILABS_DBUS_EUART0_TX(0x3, 0x1)
#define EUART0_TX_PD2  SILABS_DBUS_EUART0_TX(0x3, 0x2)
#define EUART0_TX_PD3  SILABS_DBUS_EUART0_TX(0x3, 0x3)
#define EUART0_CTS_PA0 SILABS_DBUS_EUART0_CTS(0x0, 0x0)
#define EUART0_CTS_PA1 SILABS_DBUS_EUART0_CTS(0x0, 0x1)
#define EUART0_CTS_PA2 SILABS_DBUS_EUART0_CTS(0x0, 0x2)
#define EUART0_CTS_PA3 SILABS_DBUS_EUART0_CTS(0x0, 0x3)
#define EUART0_CTS_PA4 SILABS_DBUS_EUART0_CTS(0x0, 0x4)
#define EUART0_CTS_PA5 SILABS_DBUS_EUART0_CTS(0x0, 0x5)
#define EUART0_CTS_PA6 SILABS_DBUS_EUART0_CTS(0x0, 0x6)
#define EUART0_CTS_PA7 SILABS_DBUS_EUART0_CTS(0x0, 0x7)
#define EUART0_CTS_PA8 SILABS_DBUS_EUART0_CTS(0x0, 0x8)
#define EUART0_CTS_PB0 SILABS_DBUS_EUART0_CTS(0x1, 0x0)
#define EUART0_CTS_PB1 SILABS_DBUS_EUART0_CTS(0x1, 0x1)
#define EUART0_CTS_PB2 SILABS_DBUS_EUART0_CTS(0x1, 0x2)
#define EUART0_CTS_PB3 SILABS_DBUS_EUART0_CTS(0x1, 0x3)
#define EUART0_CTS_PB4 SILABS_DBUS_EUART0_CTS(0x1, 0x4)
#define EUART0_CTS_PC0 SILABS_DBUS_EUART0_CTS(0x2, 0x0)
#define EUART0_CTS_PC1 SILABS_DBUS_EUART0_CTS(0x2, 0x1)
#define EUART0_CTS_PC2 SILABS_DBUS_EUART0_CTS(0x2, 0x2)
#define EUART0_CTS_PC3 SILABS_DBUS_EUART0_CTS(0x2, 0x3)
#define EUART0_CTS_PC4 SILABS_DBUS_EUART0_CTS(0x2, 0x4)
#define EUART0_CTS_PC5 SILABS_DBUS_EUART0_CTS(0x2, 0x5)
#define EUART0_CTS_PC6 SILABS_DBUS_EUART0_CTS(0x2, 0x6)
#define EUART0_CTS_PC7 SILABS_DBUS_EUART0_CTS(0x2, 0x7)
#define EUART0_CTS_PD0 SILABS_DBUS_EUART0_CTS(0x3, 0x0)
#define EUART0_CTS_PD1 SILABS_DBUS_EUART0_CTS(0x3, 0x1)
#define EUART0_CTS_PD2 SILABS_DBUS_EUART0_CTS(0x3, 0x2)
#define EUART0_CTS_PD3 SILABS_DBUS_EUART0_CTS(0x3, 0x3)
#define EUART0_RX_PA0  SILABS_DBUS_EUART0_RX(0x0, 0x0)
#define EUART0_RX_PA1  SILABS_DBUS_EUART0_RX(0x0, 0x1)
#define EUART0_RX_PA2  SILABS_DBUS_EUART0_RX(0x0, 0x2)
#define EUART0_RX_PA3  SILABS_DBUS_EUART0_RX(0x0, 0x3)
#define EUART0_RX_PA4  SILABS_DBUS_EUART0_RX(0x0, 0x4)
#define EUART0_RX_PA5  SILABS_DBUS_EUART0_RX(0x0, 0x5)
#define EUART0_RX_PA6  SILABS_DBUS_EUART0_RX(0x0, 0x6)
#define EUART0_RX_PA7  SILABS_DBUS_EUART0_RX(0x0, 0x7)
#define EUART0_RX_PA8  SILABS_DBUS_EUART0_RX(0x0, 0x8)
#define EUART0_RX_PB0  SILABS_DBUS_EUART0_RX(0x1, 0x0)
#define EUART0_RX_PB1  SILABS_DBUS_EUART0_RX(0x1, 0x1)
#define EUART0_RX_PB2  SILABS_DBUS_EUART0_RX(0x1, 0x2)
#define EUART0_RX_PB3  SILABS_DBUS_EUART0_RX(0x1, 0x3)
#define EUART0_RX_PB4  SILABS_DBUS_EUART0_RX(0x1, 0x4)
#define EUART0_RX_PC0  SILABS_DBUS_EUART0_RX(0x2, 0x0)
#define EUART0_RX_PC1  SILABS_DBUS_EUART0_RX(0x2, 0x1)
#define EUART0_RX_PC2  SILABS_DBUS_EUART0_RX(0x2, 0x2)
#define EUART0_RX_PC3  SILABS_DBUS_EUART0_RX(0x2, 0x3)
#define EUART0_RX_PC4  SILABS_DBUS_EUART0_RX(0x2, 0x4)
#define EUART0_RX_PC5  SILABS_DBUS_EUART0_RX(0x2, 0x5)
#define EUART0_RX_PC6  SILABS_DBUS_EUART0_RX(0x2, 0x6)
#define EUART0_RX_PC7  SILABS_DBUS_EUART0_RX(0x2, 0x7)
#define EUART0_RX_PD0  SILABS_DBUS_EUART0_RX(0x3, 0x0)
#define EUART0_RX_PD1  SILABS_DBUS_EUART0_RX(0x3, 0x1)
#define EUART0_RX_PD2  SILABS_DBUS_EUART0_RX(0x3, 0x2)
#define EUART0_RX_PD3  SILABS_DBUS_EUART0_RX(0x3, 0x3)
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_SILABS_XG22_PINCTRL_H_ */
