...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_CH32V00X_PINCTRL_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_CH32V00X_PINCTRL_H_
...
/** Special, unused remap value that puts the pin in analog mode */
#define CH32V00X_PINMUX_ADC1_RM         23
...
#define ADC1_A0_PA2_0 CH32V00X_PINMUX_DEFINE(PA, 2, ADC1, 0) /**< ADC_IN0 on PA2 */
#define ADC1_A1_PA1_0 CH32V00X_PINMUX_DEFINE(PA, 1, ADC1, 0) /**< ADC_IN1 on PA1 */
#define ADC1_A2_PC4_0 CH32V00X_PINMUX_DEFINE(PC, 4, ADC1, 0) /**< ADC_IN2 on PC4 */
#define ADC1_A3_PD2_0 CH32V00X_PINMUX_DEFINE(PD, 2, ADC1, 0) /**< ADC_IN3 on PD2 */
#define ADC1_A4_PD3_0 CH32V00X_PINMUX_DEFINE(PD, 3, ADC1, 0) /**< ADC_IN4 on PD3 */
#define ADC1_A5_PD5_0 CH32V00X_PINMUX_DEFINE(PD, 5, ADC1, 0) /**< ADC_IN5 on PD5 */
#define ADC1_A6_PD6_0 CH32V00X_PINMUX_DEFINE(PD, 6, ADC1, 0) /**< ADC_IN6 on PD6 */
#define ADC1_A7_PD4_0 CH32V00X_PINMUX_DEFINE(PD, 4, ADC1, 0) /**< ADC_IN7 on PD4 */

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_CH32V00X_PINCTRL_H_ */
