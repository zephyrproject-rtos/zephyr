...
/** Enable input detect */
#define RTS5912_GPIO_INDETEN         (1U << 7)
/** Set pin driving current */
#define RTS5912_GPIO_OUTDRV          (1U << 8)
/** Set GPIO slew rate */
#define RTS5912_GPIO_SLEWRATE        (1U << 9)
/** Enable Schmitt-trigger*/
#define RTS5912_GPIO_SCHEN           (1U << 10)
/** Multi function */
#define RTS5912_GPIO_MFCTRL_POS      13
#define RTS5912_GPIO_MFCTRL_MASK     (7U << RTS5912_GPIO_MFCTRL_POS)
