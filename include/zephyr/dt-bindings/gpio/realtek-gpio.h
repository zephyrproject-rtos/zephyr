...
#define RTS5912_GPIO_VOLTAGE_1P8     (1U << RTS5912_GPIO_VOLTAGE_POS)
/** Set pin voltage level at 3.3 V */
#define RTS5912_GPIO_VOLTAGE_3P3     (2U << RTS5912_GPIO_VOLTAGE_POS)
/** Set pin voltage level at 5.0 V */
#define RTS5912_GPIO_VOLTAGE_5P0     (3U << RTS5912_GPIO_VOLTAGE_POS)
