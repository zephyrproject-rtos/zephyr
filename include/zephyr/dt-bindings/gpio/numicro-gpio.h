 ...
 */
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_NUMICRO_GPIO_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_NUMICRO_GPIO_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_NUMICRO_GPIO_H_ */
