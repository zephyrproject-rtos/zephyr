...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_RASPBERRYPI_CSI_CONNECTOR_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_RASPBERRYPI_CSI_CONNECTOR_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_GPIO_RASPBERRYPI_CSI_CONNECTOR_H_ */
