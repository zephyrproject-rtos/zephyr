 ...
 *
 * Must match CONFIG_3RD_LEVEL_INTERRUPT_BITS for this SoC (see
 * soc/espressif/esp32h2/Kconfig.defconfig). It cannot be read from Kconfig here,
 * because devicetree headers are preprocessed before Kconfig is available.
 */
