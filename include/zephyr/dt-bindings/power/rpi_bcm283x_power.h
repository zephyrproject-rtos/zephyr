...
/**
 * @file
 * @brief Raspberry Pi BCM283x power domain identifiers.
 *
 * Power domain IDs correspond to the Raspberry Pi firmware mailbox property interface
 * power device IDs.
 *
 * @see https://github.com/raspberrypi/firmware/wiki/Mailbox-property-interface#power
 */

#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_POWER_RPI_BCM283X_POWER__H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_POWER_RPI_BCM283X_POWER__H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_POWER_RPI_BCM283X_POWER__H_ */
