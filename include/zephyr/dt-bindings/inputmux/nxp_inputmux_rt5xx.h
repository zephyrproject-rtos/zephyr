...
#ifndef __DT_BINDINGS_INPUTMUX_NXP_INPUTMUX_RT5XX_H__
#define __DT_BINDINGS_INPUTMUX_NXP_INPUTMUX_RT5XX_H__
...
#define MUX_USB0_FRAME_TOGGLE_TO_SCT0                (15U + (SCT0_PMUX_ID << PMUX_SHIFT))
...
#define MUX_FLEXCOMM14_TO_DSP_INTERRUPT              (8U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM16_TO_DSP_INTERRUPT              (9U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_TO_DSP_INTERRUPT               (10U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT1_TO_DSP_INTERRUPT               (11U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT2_TO_DSP_INTERRUPT               (12U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT3_TO_DSP_INTERRUPT               (13U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT4_TO_DSP_INTERRUPT               (14U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT5_TO_DSP_INTERRUPT               (15U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT6_TO_DSP_INTERRUPT               (16U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT7_TO_DSP_INTERRUPT               (17U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_NS_HS_GPIO_INT0_TO_DSP_INTERRUPT         (18U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_NS_HS_GPIO_INT1_TO_DSP_INTERRUPT         (19U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_WDT1_TO_DSP_INTERRUPT                    (20U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_DMAC0_TO_DSP_INTERRUPT                   (21U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_DMAC1_TO_DSP_INTERRUPT                   (22U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_MU_BTO_DSP_INTERRUPT                     (23U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_UTICK0_TO_DSP_INTERRUPT                  (24U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_MRT0_TO_DSP_INTERRUPT                    (25U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_OS_EVENT_TIMER_TO_DSP_INTERRUPT          (26U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER0_TO_DSP_INTERRUPT                 (27U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER1_TO_DSP_INTERRUPT                 (28U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER2_TO_DSP_INTERRUPT                 (29U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER3_TO_DSP_INTERRUPT                 (30U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER4_TO_DSP_INTERRUPT                 (31U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_RTC_TO_DSP_INTERRUPT                     (32U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_I3C0_TO_DSP_INTERRUPT                    (33U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_I3C1_TO_DSP_INTERRUPT                    (34U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_DMIC0_TO_DSP_INTERRUPT                   (35U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_HWVAD_TO_DSP_INTERRUPT                   (36U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_LCDIF_TO_DSP_INTERRUPT                   (37U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_GPU_TO_DSP_INTERRUPT                     (38U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_SMART_DMA_TO_DSP_INTERRUPT               (39U + (DSP_INT_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXIO_TO_DSP_INTERRUPT                  (40U + (DSP_INT_PMUX_ID << PMUX_SHIFT))

/* Definitions for FREQMEAS */
#define MUX_XTALIN_TO_FREQMEAS                       (0U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))
#define MUX_FRO12M_TO_FREQMEAS                       (1U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))
#define MUX_FRO192M_TO_FREQMEAS                      (2U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))
#define MUX_LPOSC_TO_FREQMEAS                        (3U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))
#define MUX_32_KHZ_OSC_TO_FREQMEAS                   (4U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))
...
#define MUX_CLOCK_OUT_TO_FREQMEAS                    (11U + (FREQMEAS_PMUX_ID << PMUX_SHIFT))

/* Definitions for SMARTDMAINPUT */
#define MUX_GPIO_PORT0_PIN0_TO_SMART_DMA_INPUT       (0U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN1_TO_SMART_DMA_INPUT       (1U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN2_TO_SMART_DMA_INPUT       (2U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN3_TO_SMART_DMA_INPUT       (3U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN4_TO_SMART_DMA_INPUT       (4U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN5_TO_SMART_DMA_INPUT       (5U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN6_TO_SMART_DMA_INPUT       (6U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT0_PIN7_TO_SMART_DMA_INPUT       (7U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN0_TO_SMART_DMA_INPUT       (8U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN1_TO_SMART_DMA_INPUT       (9U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN2_TO_SMART_DMA_INPUT       (10U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN3_TO_SMART_DMA_INPUT       (11U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN4_TO_SMART_DMA_INPUT       (12U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN5_TO_SMART_DMA_INPUT       (13U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN6_TO_SMART_DMA_INPUT       (14U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_PORT1_PIN7_TO_SMART_DMA_INPUT       (15U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM0_IRQ_TO_SMART_DMA_INPUT         (16U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM1_IRQ_TO_SMART_DMA_INPUT         (17U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM2_IRQ_TO_SMART_DMA_INPUT         (18U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM3_IRQ_TO_SMART_DMA_INPUT         (19U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM4_IRQ_TO_SMART_DMA_INPUT         (20U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM5_IRQ_TO_SMART_DMA_INPUT         (21U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM6_IRQ_TO_SMART_DMA_INPUT         (22U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM7_IRQ_TO_SMART_DMA_INPUT         (23U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM14_IRQ_TO_SMART_DMA_INPUT        (24U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXCOMM16_IRQ_TO_SMART_DMA_INPUT        (25U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_I3C0_IRQ_TO_SMART_DMA_INPUT              (26U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_I3C1_IRQ_TO_SMART_DMA_INPUT              (27U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXIO_IRQ_TO_SMART_DMA_INPUT            (28U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ0_TO_SMART_DMA_INPUT        (29U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ1_TO_SMART_DMA_INPUT        (30U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ2_TO_SMART_DMA_INPUT        (31U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ3_TO_SMART_DMA_INPUT        (32U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ4_TO_SMART_DMA_INPUT        (33U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ5_TO_SMART_DMA_INPUT        (34U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ6_TO_SMART_DMA_INPUT        (35U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT0_IRQ7_TO_SMART_DMA_INPUT        (36U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_NS_GPIO_HS_IRQ0_TO_SMART_DMA_INPUT       (37U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_NS_GPIO_HS_IRQ1_TO_SMART_DMA_INPUT       (38U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT0_IRQ_TO_SMART_DMA_INPUT              (39U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER0_IRQ_TO_SMART_DMA_INPUT           (40U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER1_IRQ_TO_SMART_DMA_INPUT           (41U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER2_IRQ_TO_SMART_DMA_INPUT           (42U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER3_IRQ_TO_SMART_DMA_INPUT           (43U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_CTIMER4_IRQ_TO_SMART_DMA_INPUT           (44U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_UTICK0_IRQ_TO_SMART_DMA_INPUT            (45U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_MRT0_IRQ_TO_SMART_DMA_INPUT              (46U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_RTC_LITE0_IRQ_TO_SMART_DMA_INPUT         (47U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_OS_EVENT_IRQ_TO_SMART_DMA_INPUT          (48U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_WDT0_IRQ_TO_SMART_DMA_INPUT              (49U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_WDT1_IRQ_TO_SMART_DMA_INPUT              (50U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_ADC0_IRQ_TO_SMART_DMA_INPUT              (51U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_ACMP_IRQ_TO_SMART_DMA_INPUT              (52U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_DMIC0_TO_SMART_DMA_INPUT                 (53U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_HWVAD_TO_SMART_DMA_INPUT                 (54U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_SDIO0_IRQ_TO_SMART_DMA_INPUT             (55U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_SDIO1_IRQ_TO_SMART_DMA_INPUT             (56U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_USB0_IRQ_TO_SMART_DMA_INPUT              (57U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_USB0_NEED_CLK_TO_SMART_DMA_INPUT         (58U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_LCDIF_IRQ_TO_SMART_DMA_INPUT             (59U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPU_IRQ_TO_SMART_DMA_INPUT               (60U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_IRQ_TO_SMART_DMA_INPUT              (61U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA1_IRQ_TO_SMART_DMA_INPUT              (62U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_POWERQUAD_IRQ_TO_SMART_DMA_INPUT         (63U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI_IRQ_TO_SMART_DMA_INPUT           (64U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_DSP_TIE_EXPSTATE1_TO_SMART_DMA_INPUT     (65U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT_OUT8_TO_SMART_DMA_INPUT              (66U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT_OUT9_TO_SMART_DMA_INPUT              (67U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_T4_MAT3_TO_SMART_DMA_INPUT               (68U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_T4_MAT2_TO_SMART_DMA_INPUT               (69U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_T3_MAT3_TO_SMART_DMA_INPUT               (70U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_T3_MAT2_TO_SMART_DMA_INPUT               (71U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_ARM_TXEV_TO_SMART_DMA_INPUT              (72U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIOINT_BMATCH_TO_SMART_DMA_INPUT        (73U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_MIPI_IRQ_TO_SMART_DMA_INPUT              (74U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
#define MUX_USB_FS_TOGGLE_TO_SMART_DMA_INPUT         (75U + (SMART_DMA_PMUX_ID << PMUX_SHIFT))
...
#define MUX_GPIO_INT0_TO_DMA0                        (0U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT1_TO_DMA0                        (1U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT2_TO_DMA0                        (2U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT3_TO_DMA0                        (3U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_SCT_DMA0_TO_DMA0                         (18U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT_DMA1_TO_DMA0                         (19U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_FLEXSPI0_RX_TO_DMA0                      (22U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI0_TX_TO_DMA0                      (23U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_ADC_TO_DMA0                              (24U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI1_RX_TO_DMA0                      (25U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI1_TX_TO_DMA0                      (26U + (DMA0_ITRIG_PMUX_ID << PMUX_SHIFT))

/* Definitions for DMA1 */
#define MUX_GPIO_INT0_TO_DMA1                        (0U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT1_TO_DMA1                        (1U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT2_TO_DMA1                        (2U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_GPIO_INT3_TO_DMA1                        (3U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_DMA0_TRIG_OUT_ATO_DMA1                   (14U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_TRIG_OUT_BTO_DMA1                   (15U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_TRIG_OUT_CTO_DMA1                   (16U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_TRIG_OUT_DTO_DMA1                   (17U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT_DMA0_TO_DMA1                         (18U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_SCT_DMA1_TO_DMA1                         (19U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_FLEXSPI0_RX_TO_DMA1                      (22U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI0_TX_TO_DMA1                      (23U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_ADC_TO_DMA1                              (24U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI1_RX_TO_DMA1                      (25U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_FLEXSPI1_TX_TO_DMA1                      (26U + (DMA1_ITRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_DMA0_OTRIG_CHANNEL33_TO_TRIGIN_CHANNELS  (33U + (DMA0_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_OTRIG_CHANNEL34_TO_TRIGIN_CHANNELS  (34U + (DMA0_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_OTRIG_CHANNEL35_TO_TRIGIN_CHANNELS  (35U + (DMA0_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA0_OTRIG_CHANNEL36_TO_TRIGIN_CHANNELS  (36U + (DMA0_OTRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_DMA1_OTRIG_CHANNEL33_TO_TRIGIN_CHANNELS  (33U + (DMA1_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA1_OTRIG_CHANNEL34_TO_TRIGIN_CHANNELS  (34U + (DMA1_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA1_OTRIG_CHANNEL35_TO_TRIGIN_CHANNELS  (35U + (DMA1_OTRIG_PMUX_ID << PMUX_SHIFT))
#define MUX_DMA1_OTRIG_CHANNEL36_TO_TRIGIN_CHANNELS  (36U + (DMA1_OTRIG_PMUX_ID << PMUX_SHIFT))
...
#define MUX_DMIC0_CH0_TO_DMAC0_CH16_REQUEST_ENA      (16U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ (DMA0_CHMUX_SEL0_ID << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM8_RX_TO_DMAC0_CH16_REQUEST_ENA   (16U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ (DMA0_CHMUX_SEL0_ID << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH17REQUESTENA */
#define MUX_DMIC0_CH1_TO_DMAC0_CH17_REQUEST_ENA      (17U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 4) << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM8_TX_TO_DMAC0_CH17_REQUEST_ENA   (17U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 4) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH18REQUESTENA */
#define MUX_DMIC0_CH2_TO_DMAC0_CH18_REQUEST_ENA      (18U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 8) << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM9_RX_TO_DMAC0_CH18_REQUEST_ENA   (18U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 8) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH19REQUESTENA */
#define MUX_DMIC0_CH3_TO_DMAC0_CH19_REQUEST_ENA      (19U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 12) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM9_TX_TO_DMAC0_CH19_REQUEST_ENA   (19U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 12) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH20REQUESTENA */
#define MUX_DMIC0_CH4_TO_DMAC0_CH20_REQUEST_ENA      (20U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 16) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM10_RX_TO_DMAC0_CH20_REQUEST_ENA  (20U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 16) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH21REQUESTENA */
#define MUX_DMIC0_CH5_TO_DMAC0_CH21_REQUEST_ENA      (21U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 20) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM10_TX_TO_DMAC0_CH21_REQUEST_ENA  (21U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 20) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH22REQUESTENA */
#define MUX_DMIC0_CH6_TO_DMAC0_CH22_REQUEST_ENA      (22U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 24) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM13_RX_TO_DMAC0_CH22_REQUEST_ENA  (22U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 24) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH23REQUESTENA */
#define MUX_DMIC0_CH7_TO_DMAC0_CH23_REQUEST_ENA      (23U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 28) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM13_TX_TO_DMAC0_CH23_REQUEST_ENA  (23U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 28) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))
...
/* Definitions for DMAC0CH28REQUESTENA */
#define MUX_FLEXCOMM16_RX_TO_DMAC0_CH28_REQUEST_ENA  (28U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 32) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH29REQUESTENA */
#define MUX_FLEXCOMM16_TX_TO_DMAC0_CH29_REQUEST_ENA  (29U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 36) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH30REQUESTENA */
#define MUX_I3C1_RX_TO_DMAC0_CH30_REQUEST_ENA        (30U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 40) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH31REQUESTENA */
#define MUX_I3C1_TX_TO_DMAC0_CH31_REQUEST_ENA        (31U + \
		(DMA0_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA0_CHMUX_SEL0_ID + 44) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH32REQUESTENA */
#define MUX_FLEXCOMM11_RX_TO_DMAC0_CH32_REQUEST_ENA  (0U + ((DMA0_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA0_CHMUX_SEL0_ID \
		+ 48) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH33REQUESTENA */
#define MUX_FLEXCOMM11_TX_TO_DMAC0_CH33_REQUEST_ENA  (1U + ((DMA0_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA0_CHMUX_SEL0_ID \
		+ 52) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH34REQUESTENA */
#define MUX_FLEXCOMM12_RX_TO_DMAC0_CH34_REQUEST_ENA  (2U + ((DMA0_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA0_CHMUX_SEL0_ID \
		+ 56) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH35REQUESTENA */
#define MUX_FLEXCOMM12_TX_TO_DMAC0_CH35_REQUEST_ENA  (3U + ((DMA0_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA0_CHMUX_SEL0_ID \
		+ 60) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC0CH36REQUESTENA */
#define MUX_HASH_CRYPT_TO_DMAC0_CH36_REQUEST_ENA     (4U + ((DMA0_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT))
...
#define MUX_DMIC0_CH0_TO_DMAC1_CH16_REQUEST_ENA      (16U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ (DMA1_CHMUX_SEL0_ID << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM8_RX_TO_DMAC1_CH16_REQUEST_ENA   (16U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ (DMA1_CHMUX_SEL0_ID << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH17REQUESTENA */
#define MUX_DMIC0_CH1_TO_DMAC1_CH17_REQUEST_ENA      (17U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 4) << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM8_TX_TO_DMAC1_CH17_REQUEST_ENA   (17U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 4) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH18REQUESTENA */
#define MUX_DMIC0_CH2_TO_DMAC1_CH18_REQUEST_ENA      (18U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 8) << CHMUX_OFF_SHIFT) + (0U << CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM9_RX_TO_DMAC1_CH18_REQUEST_ENA   (18U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 8) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH19REQUESTENA */
#define MUX_DMIC0_CH3_TO_DMAC1_CH19_REQUEST_ENA      (19U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 12) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM9_TX_TO_DMAC1_CH19_REQUEST_ENA   (19U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 12) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH20REQUESTENA */
#define MUX_DMIC0_CH4_TO_DMAC1_CH20_REQUEST_ENA      (20U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 16) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM10_RX_TO_DMAC1_CH20_REQUEST_ENA  (20U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 16) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH21REQUESTENA */
#define MUX_DMIC0_CH5_TO_DMAC1_CH21_REQUEST_ENA      (21U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 20) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM10_TX_TO_DMAC1_CH21_REQUEST_ENA  (21U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 20) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH22REQUESTENA */
#define MUX_DMIC0_CH6_TO_DMAC1_CH22_REQUEST_ENA      (22U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 24) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM13_RX_TO_DMAC1_CH22_REQUEST_ENA  (22U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 24) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH23REQUESTENA */
#define MUX_DMIC0_CH7_TO_DMAC1_CH23_REQUEST_ENA      (23U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 28) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))
#define MUX_FLEXCOMM13_TX_TO_DMAC1_CH23_REQUEST_ENA  (23U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 28) << CHMUX_OFF_SHIFT) + (1U << \
		CHMUX_VAL_SHIFT))
...
/* Definitions for DMAC1CH28REQUESTENA */
#define MUX_FLEXCOMM16_RX_TO_DMAC1_CH28_REQUEST_ENA  (28U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 32) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH29REQUESTENA */
#define MUX_FLEXCOMM16_TX_TO_DMAC1_CH29_REQUEST_ENA  (29U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 36) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH30REQUESTENA */
#define MUX_I3C1_RX_TO_DMAC1_CH30_REQUEST_ENA        (30U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 40) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH31REQUESTENA */
#define MUX_I3C1_TX_TO_DMAC1_CH31_REQUEST_ENA        (31U + \
		(DMA1_REQ_ENA0_ID << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) \
		+ ((DMA1_CHMUX_SEL0_ID + 44) << CHMUX_OFF_SHIFT) + (0U << \
		CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH32REQUESTENA */
#define MUX_FLEXCOMM11_RX_TO_DMAC1_CH32_REQUEST_ENA  (0U + ((DMA1_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA1_CHMUX_SEL0_ID \
		+ 48) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH33REQUESTENA */
#define MUX_FLEXCOMM11_TX_TO_DMAC1_CH33_REQUEST_ENA  (1U + ((DMA1_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA1_CHMUX_SEL0_ID \
		+ 52) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH34REQUESTENA */
#define MUX_FLEXCOMM12_RX_TO_DMAC1_CH34_REQUEST_ENA  (2U + ((DMA1_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA1_CHMUX_SEL0_ID \
		+ 56) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH35REQUESTENA */
#define MUX_FLEXCOMM12_TX_TO_DMAC1_CH35_REQUEST_ENA  (3U + ((DMA1_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT) + (1U << CHMUX_AVL_SHIFT) + ((DMA1_CHMUX_SEL0_ID \
		+ 60) << CHMUX_OFF_SHIFT) + (1U << CHMUX_VAL_SHIFT))

/* Definitions for DMAC1CH36REQUESTENA */
#define MUX_HASH_CRYPT_TO_DMAC1_CH36_REQUEST_ENA     (4U + ((DMA1_REQ_ENA0_ID \
		+ 4) << ENA_SHIFT))

#endif /* __DT_BINDINGS_INPUTMUX_NXP_INPUTMUX_RT5XX_H__ */
