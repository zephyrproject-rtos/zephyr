...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA6M4 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra6m4_elc
 */
...
/**
 * @defgroup dt_renesas_ra6m4_elc Renesas RA6M4 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA6M4 ELC routing.
...
/* Event codes for Renesas RA6M4 Event Link Controller (ELC). */
