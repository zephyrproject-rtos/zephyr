...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA6E2 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra6e2_elc
 */
...
/**
 * @defgroup dt_renesas_ra6e2_elc Renesas RA6E2 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA6E2 ELC routing.
...
/* Event codes for Renesas RA6E2 Event Link Controller (ELC). */
