...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA4M2 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra4m2_elc
 */
...
/**
 * @defgroup dt_renesas_ra4m2_elc Renesas RA4M2 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA4M2 ELC routing.
...
/* Event codes for Renesas RA4M2 Event Link Controller (ELC). */
