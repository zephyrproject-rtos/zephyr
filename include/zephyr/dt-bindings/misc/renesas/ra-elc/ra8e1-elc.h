...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA8E1 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra8e1_elc
 */

#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_MISC_RENESAS_RA_ELC_RA8E1_ELC_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_MISC_RENESAS_RA_ELC_RA8E1_ELC_H_
...
/**
 * @defgroup dt_renesas_ra8e1_elc Renesas RA8E1 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA8E1 ELC routing.
 ...
 *
 * @code{.dts}
 * #include <zephyr/dt-bindings/misc/renesas/ra-elc/ra8e1-elc.h>
 *
 * &pwm0 {
...
/* Event codes for Renesas RA8E1 Event Link Controller (ELC). */
...
#define RA_ELC_EVENT_ACMPHS0_INT             0x07B /**< Comparator channel 0 interrupt. */
#define RA_ELC_EVENT_ACMPHS1_INT             0x07C /**< Comparator channel 1 interrupt. */
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_MISC_RENESAS_RA_ELC_RA8E1_ELC_H_ */
