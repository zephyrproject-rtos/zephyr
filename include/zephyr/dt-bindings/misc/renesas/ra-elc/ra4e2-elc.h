...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA4E2 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra4e2_elc
 */
...
/**
 * @defgroup dt_renesas_ra4e2_elc Renesas RA4E2 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA4E2 ELC routing.
