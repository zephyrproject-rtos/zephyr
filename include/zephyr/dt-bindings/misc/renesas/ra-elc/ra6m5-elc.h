...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA6M5 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra6m5_elc
 */
...
/**
 * @defgroup dt_renesas_ra6m5_elc Renesas RA6M5 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA6M5 ELC routing.
...
/* Event codes for Renesas RA6M5 Event Link Controller (ELC). */
