...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA8M1 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra8m1_elc
 */
...
/**
 * @defgroup dt_renesas_ra8m1_elc Renesas RA8M1 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA8M1 ELC routing.
...
/* Event codes for Renesas RA8M1 Event Link Controller (ELC). */
