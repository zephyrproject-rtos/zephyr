...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA4L1 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra4l1_elc
 */
...
/**
 * @defgroup dt_renesas_ra4l1_elc Renesas RA4L1 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA4L1 ELC routing.
...
/* Event codes for Renesas RA4L1 Event Link Controller (ELC). */
