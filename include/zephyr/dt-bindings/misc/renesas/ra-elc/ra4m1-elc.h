...
/**
 * @file
 * @brief Devicetree macros for the Renesas RA4M1 Event Link Controller (ELC).
 * @ingroup dt_renesas_ra4m1_elc
 */
...
/**
 * @defgroup dt_renesas_ra4m1_elc Renesas RA4M1 ELC devicetree macros
 * @brief Devicetree event and peripheral macros for Renesas RA4M1 ELC routing.
