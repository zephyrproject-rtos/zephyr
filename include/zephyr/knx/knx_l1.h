 ...
 *
 * KNX Physical Layer (L1) binding — public interface.
 *
...
typedef enum {
	p_ok                 = 0,
	p_transceiver_fault  = 1,
	p_collision_detected = 2,
	P_bus_not_free       = 3,
	p_error              = 4,
} P_Status;
...
#define FRAME_ACK      0xCCu
#define FRAME_NACK     0x0Cu
#define FRAME_BUSY     0xC0u
#define FRAME_NAK_BUSY 0x00u
