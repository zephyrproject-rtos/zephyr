...
/**
 * @brief Get the Charge Share Delay (CSD) of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 *
 * @return The Charge Share Delay value of the specified sensor node.
 */
uint8_t get_sensor_csd_val(const struct device *dev, uint16_t sensor_node);

/**
 * @brief Update the Charge Share Delay (CSD) of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 * @param new_csd_value New CSD value for the sensor node.
 */
void update_sensor_csd_val(const struct device *dev, uint16_t sensor_node, uint16_t new_csd_value);

/**
 * @brief Get the Prescaler value of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 *
 * @return The Prescaler value of the specified sensor node.
 */
uint8_t get_sensor_prescaler_val(const struct device *dev, uint16_t sensor_node);

/**
 * @brief Update the Prescaler value of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 * @param new_prescaler_value New Prescaler value for the sensor node.
 */
void update_sensor_prescaler_val(const struct device *dev, uint16_t sensor_node,
				 uint16_t new_prescaler_value);

/**
 * @brief Get the Threshold value of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 *
 * @return The Threshold value of the specified sensor node.
 */
uint8_t get_sensor_threshold_val(const struct device *dev, uint16_t sensor_node);

/**
 * @brief Update the Threshold value of a sensor node.
 *
 * @param dev Pointer to the PTC device.
 * @param sensor_node Sensor node number.
 * @param new_threshold_value New Threshold value for the sensor node.
 */
...
/**
 * @brief Get the number of configured scroller node.
 *
 * @param dev Pointer to the PTC device.
 *
 * @return The total number of configured Scroller nodes.
 */
uint8_t get_def_no_scrollers(const struct device *dev);

/**
 * @brief Get the delta value of a Scroller node.
 *
 * @param dev Pointer to the PTC device.
 * @param scroller_node Scroller node number.
 *
 * @return The delta value of the specified scroller node.
 */
uint16_t get_scroller_delta(const struct device *dev, uint16_t scroller_node);

/**
 * @brief Get the Threshold value of a Scroller node.
 *
 * @param dev Pointer to the PTC device.
 * @param scroller_node Scroller node number.
 *
 * @return The threshold of the specified sensor node.
 */
uint16_t get_scroller_threshold_val(const struct device *dev, uint16_t scroller_node);

/**
 * @brief Get the state of a scroller node.
 *
 * @param dev Pointer to the PTC device.
 * @param scroller_node Scroller node number.
 *
 * @return The current scroller state of the specified node.
 */
...
/**
 * @brief Get the current frequency of a measurement.
 *
 * @param dev Pointer to the PTC device.
 *
...
/**
 * @brief Get the total number of frequencies configured.
 *
 * @param dev Pointer to the PTC device.
 *
...
/**
 * @brief Get the frequency by index.
 *
 * @param dev Pointer to the PTC device.
 * @param index Index
 *
