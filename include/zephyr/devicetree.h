...
#define DT_ALL_INST_HAS_PROP_STATUS_OKAY(prop) \
	COND_CODE_1(IS_EMPTY(DT_ALL_INST_HAS_PROP_STATUS_OKAY_(prop)), (1), (0))
...
#define DT_ALL_INST_HAS_BOOL_STATUS_OKAY(prop) \
	COND_CODE_1(IS_EMPTY(DT_ALL_INST_HAS_BOOL_STATUS_OKAY_(prop)), (1), (0))
...
/** @brief Helper for DT_ALL_INST_HAS_PROP_STATUS_OKAY_
 *
 * This macro generates token "1," for instance of a device,
 ...
 *
 * This macro uses DT_ALL_INST_HAS_PROP_STATUS_OKAY_ with
 * DT_INST_FOREACH_STATUS_OKAY_VARG to generate comma separated list of 1,
 * where each 1 on the list represents instance that don't has a property
 * @p prop; the list may be empty, and the upper bound on number of
 * list elements is number of device instances.
 *
 * @param prop property to check
...
#define DT_ALL_INST_HAS_PROP_STATUS_OKAY_(prop)	\
	DT_INST_FOREACH_STATUS_OKAY_VARGS(DT_ALL_INST_HAS_PROP_STATUS_OKAY__, prop)

/** @brief Helper for DT_ALL_INST_HAS_BOOL_STATUS_OKAY_
 *
 * This macro generates token "1," for instance of a device,
 ...
 * DT_INST_FOREACH_STATUS_OKAY_VARG to generate comma separated list of 1,
 * where each 1 on the list represents instance that has a property
 * @p prop of value 0; the list may be empty, and the upper bound on number of
 * list elements is number of device instances.
 *
 * @param prop property to check
 *
...
#define DT_ALL_INST_HAS_BOOL_STATUS_OKAY_(prop)	\
	DT_INST_FOREACH_STATUS_OKAY_VARGS(DT_ALL_INST_HAS_BOOL_STATUS_OKAY__, prop)
