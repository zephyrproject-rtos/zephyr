 ...
 *
 *     DT_NODELABEL_C_TOKEN_BY_IDX(DT_PHANDLE_BY_IDX(TEST_PH, phs, 0), 0) // n2_1
 *     DT_NODELABEL_C_TOKEN_BY_IDX(DT_PHANDLE_BY_IDX(TEST_PH, phs, 1), 0) // n3_1
 *     DT_NODELABEL_C_TOKEN_BY_IDX(DT_PHANDLE_BY_IDX(TEST_PH, phs, 0), 1) // n2
 *     DT_NODELABEL_C_TOKEN_BY_IDX(DT_PHANDLE_BY_IDX(TEST_PH, phs, 1), 1) // n3
 * @endcode
 *
