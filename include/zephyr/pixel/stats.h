...
/**
 * @brief Collect red, gren, blue channel averages of all pixels in an RGB24 frame.
 *
...
/**
 * @brief Collect red, gren, blue channel averages of all pixels in an RGGB8 frame.
 *
...
/**
 * @brief Collect red, gren, blue channel averages of all pixels in an BGGR8 frame.
 * @copydetails pixel_rggb8frame_to_rgb24avg()
 */
void pixel_bggr8frame_to_rgb24avg(const uint8_t *buf, size_t size, uint16_t width,
				  uint8_t rgb24avg[3], uint16_t nval);
/**
 * @brief Collect red, gren, blue channel averages of all pixels in an GBRG8 frame.
 * @copydetails pixel_rggb8frame_to_rgb24avg()
 */
void pixel_gbrg8frame_to_rgb24avg(const uint8_t *buf, size_t size, uint16_t width,
				  uint8_t rgb24avg[3], uint16_t nval);
/**
 * @brief Collect red, gren, blue channel averages of all pixels in an GRBG8 frame.
 * @copydetails pixel_rggb8frame_to_rgb24avg()
 */
...
/**
 * @brief Collect an histogram for each of the red, gren, blue channels of an RGB24 frame.
 *
 * @param buf Buffer of pixels in RGB24 format (3 bytes per pixel) to collect the statistics from..
...
/**
 * @brief Collect an histogram for each of the red, gren, blue channels of an RGGB8 frame.
 *
...
/**
 * @brief Collect an histogram for each of the red, gren, blue channels of GBRG8 frame.
...
void pixel_gbrg8frame_to_rgb24hist(const uint8_t *buf, size_t buf_size, uint16_t width,
				   uint16_t *rgb24hist, size_t hist_size, uint16_t nval);
/**
 * @brief Collect an histogram for each of the red, gren, blue channels of BGGR8 frame.
 * @copydetails pixel_rggb8frame_to_rgb24hist()
 */
void pixel_bggr8frame_to_rgb24hist(const uint8_t *buf, size_t buf_size, uint16_t width,
				   uint16_t *rgb24hist, size_t hist_size, uint16_t nval);
/**
 * @brief Collect an histogram for each of the red, gren, blue channels of GRBG8 frame.
 * @copydetails pixel_rggb8frame_to_rgb24hist()
 */
