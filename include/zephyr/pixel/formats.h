...
{
	int32_t yy = (int32_t)y - 16;
	int32_t uu = (int32_t)u - 128;
 ...
 *
 * @param rgb24 The pixel in RGB24 format: {R, G, B}
 * @return The Y channel for this RGB value, also known as luma, lightness.
 */
 ...
 *
 * @param rgb24 The pixel in RGB24 format: {R, G, B}
 * @return The U channel for this RGB value, also known as chroma blue (Cb).
 */
 ...
 *
 * @param rgb24 The pixel in RGB24 format: {R, G, B}
 * @return The V channel for this RGB value, also known as chroma red (Cr).
 */
...
{
	yuv24[0] = pixel_rgb24_to_y8_bt709(rgb24);
	yuv24[1] = pixel_rgb24_to_u8_bt709(rgb24);
	yuv24[2] = pixel_rgb24_to_v8_bt709(rgb24);
}
...
{
	yuyv[0] = pixel_rgb24_to_y8_bt709(&rgb24x2[0]);
	yuyv[1] = pixel_rgb24_to_u8_bt709(&rgb24x2[0]);
	yuyv[2] = pixel_rgb24_to_y8_bt709(&rgb24x2[3]);
	yuyv[3] = pixel_rgb24_to_v8_bt709(&rgb24x2[3]);
}
