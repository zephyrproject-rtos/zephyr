...
/**
 * @brief Build TEST UNIT READY in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 *
 * @retval 0 Success
...
/**
 * @brief Build REQUEST SENSE in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param buf Data-in buffer
 * @param len Buffer length in bytes
...
/**
 * @brief Build READ CAPACITY(10) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param buf 8-byte data-in buffer
 * @param len Buffer length in bytes
 *
 * @retval 0 Success
 * @retval -EINVAL Invalid argument
...
/**
 * @brief Build READ CAPACITY(16) service action in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param buf Data-in buffer
 * @param len Buffer length in bytes
...
/**
 * @brief Build WRITE(10) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param lba Starting logical block address
 * @param blocks Number of blocks to write
 * @param buf Data-out buffer
 * @param len Data buffer length in bytes
 *
 * @retval 0 Success
 * @retval -EINVAL Invalid argument
...
/**
 * @brief Build WRITE(16) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param lba Starting logical block address
 * @param blocks Number of blocks to write
...
/**
 * @brief Build VERIFY(10) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param lba Starting logical block address
...
/**
 * @brief Build MODE SENSE(6) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param buf Data-in buffer
 * @param len Buffer length in bytes
...
/**
 * @brief Build MODE SENSE(6) with explicit page parameters in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 * @param buf Data-in buffer
 * @param len Buffer length in bytes
...
/**
 * @brief Build START STOP UNIT in @a xfer
 *
 * @param xfer Transfer descriptor to populate
...
/**
 * @brief Build SYNCHRONIZE CACHE(10) in @a xfer
 *
 * @param xfer Transfer descriptor to populate
 *
 * @retval 0 Success
