...
#ifndef ZEPHYR_SUBSYS_CPU_FREQ_POLICIES_CPU_FREQ_POLICY_H_
#define ZEPHYR_SUBSYS_CPU_FREQ_POLICIES_CPU_FREQ_POLICY_H_
 ...
 */
int cpu_freq_policy_select_pstate(struct pstate *pstate);

#ifdef __cplusplus
}
#endif

#endif /* ZEPHYR_SUBSYS_CPU_FREQ_POLICIES_CPU_FREQ_POLICY_H_ */
