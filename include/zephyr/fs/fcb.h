 ...
 */
struct fcb_entry {
	struct flash_sector const *fe_sector;
...
struct fcb {
	...
	struct flash_sector const *f_sectors;
	...
	struct flash_sector const *f_oldest;
 ...
 */
int fcb_walk(struct fcb *fcbp, struct flash_sector const *sector, fcb_walk_cb cb, void *cb_arg);
