...
/**
 * @file
 * @brief Public API for UFS query and SG operations.
...
#define UFS_QRY_IOCTL_ATTR	0x51 /**< IOCTL request code for UFS attribute query. */
#define UFS_QRY_IOCTL_FLAG	0x52 /**< IOCTL request code for UFS flag query. */
#define UFS_QRY_IOCTL_DESC	0x53 /**< IOCTL request code for UFS descriptor query. */
...
struct ufs_qry_ioctl_req {
	...
	/** Query data, varies by IOCTL type. */
	union {
