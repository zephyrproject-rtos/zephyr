...
/**
 * @file
 * @brief Public API for the UFS subsystem.
...
/**
 * @defgroup ufs_interface UFS Subsystem
 * @ingroup os_services
 * @{
 */

/* MACROS */
#define UFSHC_QRY_DESC_MAX_SIZE	(255U) /**< Max query descriptor size. */

#define UFSHC_PRDT_ENTRIES	(128U) /**< Max PRDT entries. */

#define UFSHC_MAX_LUNS		(32U) /**< Max LUNs supported. */

#define UFSHC_MAX_CDB_LEN	(16U) /**< Maximum length of Command Descriptor Block. */

#define UFSHC_DME_LINKSTARTUP_RETRIES	(3) /**< Maximum number of DME link-startup retries. */

#define UFS_TIMEOUT_US	(1000000U) /**< Timeout in microseconds used in UFS operations. */

#define UFSHC_HCE_MASK	(0x1U) /**< Host Controller Enable Register mask (HCE, offset 0x34h). */

/* Host Controller Status Register masks (HCS, offset 0x30h) */
#define UFSHC_HCS_DP_MASK	(0x1U) /**< Device Present mask. */
#define UFSHC_HCS_UTRLRDY_MASK	(0x2U) /**< UTRL Ready mask. */
#define UFSHC_HCS_UCRDY_MASK	(0x8U) /**< UIC Cmd Ready mask. */
#define UFSHC_HCS_UPMCRS_MASK	(0x700U) /**< Power Mode Change Status mask. */
#define UFSHC_HCS_CCS_MASK	(0x800U) /**< Crypto Compliance mask. */

#define UFSHCD_STATUS_READY	(UFSHC_HCS_UTRLRDY_MASK | UFSHC_HCS_UCRDY_MASK) /**< UFSHC ready. */

/* Interrupt Status Register masks (IS, offset 0x20h) */
#define UFSHC_IS_UTRCS_MASK	(0x1U) /**< Transfer Request Completion. */
#define UFSHC_IS_UE_MASK	(0x4U) /**< UIC Error mask. */
#define UFSHC_IS_PWR_STS_MASK	(0x10U) /**< Power Mode Status mask. */
#define UFSHC_IS_ULSS_MASK	(0x100U) /**< Link Lost Status mask. */
#define UFSHC_IS_UCCS_MASK	(0x400U) /**< UIC Cmd Completion mask. */

#define UFSHCD_UIC_MASK		(UFSHC_IS_UCCS_MASK | UFSHC_IS_PWR_STS_MASK) /**< UIC intr mask. */
#define UFSHCD_ERROR_MASK	(UFSHC_IS_UE_MASK) /**< Error intr mask. */
#define UFSHCD_ENABLE_INTRS	(UFSHC_IS_UTRCS_MASK | UFSHCD_ERROR_MASK) /**< Enabled intrs mask */

#define UFSHC_UCMDARG2_RESCODE_MASK	GENMASK(7, 0) /**< UCMDARG2 result code mask. */

#define UFSHC_UTRL_RUN	(0x1U) /**< UTRL Run-Stop value. */

#define UFSHC_256KB	(0x40000U) /**< 256 KB size constant used for UFS buffer operations. */

/* Events for UFS interrupt handling */
#define UFS_UIC_CMD_COMPLETION_EVENT	BIT(0) /**< UIC cmd completion. */
#define UFS_UPIU_COMPLETION_EVENT	BIT(1) /**< UPIU transfer completion. */
#define UFS_UIC_PWR_COMPLETION_EVENT	BIT(2) /**< Power mode change done. */

/* UFS Host Controller Register Offsets */
#define UFSHC_HOST_CTRL_CAP	0x00U /**< Host Controller Capabilities register offset. */
#define UFSHC_IS		0x20U /**< Interrupt Status register offset. */
#define UFSHC_IE		0x24U /**< Interrupt Enable register offset. */
#define UFSHC_HCS		0x30U /**< Host Controller Status register offset. */
#define UFSHC_HCE		0x34U /**< Host Controller Enable register offset. */
#define UFSHC_UTRLBA		0x50U /**< UTRL Base Address (lo) offset. */
#define UFSHC_UTRLBAU		0x54U /**< UTRL Base Address (hi) offset. */
#define UFSHC_UTRLDBR		0x58U /**< UTRL Door Bell offset. */
#define UFSHC_UTRLRSR		0x60U /**< UTRL Run-Stop offset. */
#define UFSHC_UICCMD		0x90U /**< UIC Command register offset. */
#define UFSHC_UCMDARG1		0x94U /**< UIC Command Argument 1 register offset. */
#define UFSHC_UCMDARG2		0x98U /**< UIC Command Argument 2 register offset. */
#define UFSHC_UCMDARG3		0x9CU /**< UIC Command Argument 3 register offset. */

#define UFSHC_TRANSFER_REQ_SLOT_MASK	GENMASK(4, 0) /**< Transfer request slots mask. */

/* DME Operations supported */
#define UFSHC_DME_GET_OPCODE		0x01U /**< DME GET opcode. */
#define UFSHC_DME_SET_OPCODE		0x02U /**< DME SET opcode. */
#define UFSHC_DME_LINKSTARTUP_OPCODE	0x16U /**< DME LINKSTARTUP opcode. */

/* Transaction Codes */
#define UFSHC_NOP_UPIU_TRANS_CODE	0x00U /**< Transaction code for NOP OUT UPIU. */
#define UFSHC_CMD_UPIU_TRANS_CODE	0x01U /**< Transaction code for Command UPIU. */
#define UFSHC_TSK_UPIU_TRANS_CODE	0x04U /**< Transaction code for Task Management UPIU. */
#define UFSHC_QRY_UPIU_TRANS_CODE	0x16U /**< Transaction code for Query Request UPIU. */

/* UPIU Read/Write flags */
#define UFSHC_UPIU_FLAGS_WRITE	0x20U /**< UPIU flag indicating a write operation. */
#define UFSHC_UPIU_FLAGS_READ	0x40U /**< UPIU flag indicating a read operation. */

/* Query function */
#define UFSHC_QRY_READ	0x01U /**< Query function code for read operations. */
#define UFSHC_QRY_WRITE	0x81U /**< Query function code for write operations. */

/* Flag IDN for Query Requests */
#define UFSHC_FDEVINIT_FLAG_IDN	0x01U /**< Flag IDN for Device Initialization flag. */

/* Attribute IDN for Query Requests */
#define UFSHC_BLUEN_ATTRID	0x00U /**< Attribute IDN for boot LUN enable. */

/* Descriptor IDN for Query Requests */
#define UFSHC_DEVICE_DESC_IDN	0x0U /**< Descriptor IDN for Device descriptor. */
#define UFSHC_CONFIG_DESC_IDN	0x1U /**< Descriptor IDN for Configuration descriptor. */
#define UFSHC_UNIT_DESC_IDN	0x2U /**< Descriptor IDN for Unit descriptor. */
#define UFSHC_GEOMETRY_DESC_IDN	0x7U /**< Descriptor IDN for Geometry descriptor. */

/* Unit Descriptor Parameters Offsets (bytes) */
#define UFSHC_UD_PARAM_UNIT_INDEX	0x2U /**< Unit Index offset. */
#define UFSHC_UD_PARAM_LU_ENABLE	0x3U /**< LU Enable offset. */
#define UFSHC_UD_PARAM_LOGICAL_BLKSZ	0xAU /**< Logical Block Size offset. */
#define UFSHC_UD_PARAM_LOGICAL_BLKCNT	0xBU /**< Logical Block Count offset. */

/* Geometry Descriptor Parameters Offsets (bytes) */
#define UFSHC_GEO_DESC_PARAM_MAX_NUM_LUN	0xCU /**< Max LUNs offset. */

/* UTP QUERY Transaction Specific Fields OpCode */
#define UFSHC_QRY_READ_DESC_CMD		0x1U /**< Query opcode for reading a descriptor. */
#define UFSHC_QRY_WRITE_DESC_CMD	0x2U /**< Query opcode for writing a descriptor. */
#define UFSHC_QRY_READ_ATTR_CMD		0x3U /**< Query opcode for reading an attribute. */
#define UFSHC_QRY_WRITE_ATTR_CMD	0x4U /**< Query opcode for writing an attribute. */
#define UFSHC_QRY_READ_FLAG_CMD		0x5U /**< Query opcode for reading a flag. */
#define UFSHC_QRY_SET_FLAG_CMD		0x6U /**< Query opcode for setting a flag. */
#define UFSHC_QRY_CLR_FLAG_CMD		0x7U /**< Query opcode for clearing a flag. */

/* UTP Transfer Request Descriptor definitions */
#define UFSHC_CT_UFS_STORAGE_MASK	0x10000000U /**< UFS storage cmd type. */
#define UFSHC_INTERRUPT_CMD_MASK	0x01000000U /**< Interrupt cmd mask. */
#define UFSHC_DD_DEV_TO_MEM_MASK	0x04000000U /**< Device-to-memory dir. */
#define UFSHC_DD_MEM_TO_DEV_MASK	0x02000000U /**< Memory-to-device dir. */

/* Speed Gears */
/* PWM Gears */
#define UFSHC_PWM_G1	0x2201U /**< PWM Gear 1 speed setting. */
#define UFSHC_PWM_G2	0x2202U /**< PWM Gear 2 speed setting. */
#define UFSHC_PWM_G3	0x2203U /**< PWM Gear 3 speed setting. */
#define UFSHC_PWM_G4	0x2204U /**< PWM Gear 4 speed setting. */

/* HS Rate-A Gears */
#define UFSHC_HS_G1	0x11101U /**< High Speed Gear 1, Rate A. */
#define UFSHC_HS_G2	0x11102U /**< High Speed Gear 2, Rate A. */
#define UFSHC_HS_G3	0x11103U /**< High Speed Gear 3, Rate A. */
#define UFSHC_HS_G4	0x11104U /**< High Speed Gear 4, Rate A. */

/* HS Rate-B Gears */
#define UFSHC_HS_G1_B	0x21101U /**< High Speed Gear 1, Rate B. */
#define UFSHC_HS_G2_B	0x21102U /**< High Speed Gear 2, Rate B. */
#define UFSHC_HS_G3_B	0x21103U /**< High Speed Gear 3, Rate B. */
#define UFSHC_HS_G4_B	0x21104U /**< High Speed Gear 4, Rate B. */

#define UFSHC_TX_RX_FAST	0x11U /**< TX/RX mode identifier for fast (HS) mode. */
#define UFSHC_TX_RX_SLOW	0x22U /**< TX/RX mode identifier for slow (PWM) mode. */

#define UFSHC_HSSERIES_A	1U /**< HS Series A identifier. */
#define UFSHC_HSSERIES_B	2U /**< HS Series B identifier. */

#define UFSHC_GEAR4		4U /**< Gear 4 speed setting constant. */

/* Power Mode change request status */
#define UFSHC_PWR_OK		0U /**< Power mode change completed successfully. */
#define UFSHC_PWR_LOCAL		1U /**< Power mode change completed locally. */
#define UFSHC_PWR_ERR_CAP	4U /**< Power mode change failed due to capability error. */
#define UFSHC_PWR_FATAL_ERR	5U /**< Power mode change resulted in a fatal error. */

#define UFSHC_PWR_MODE_VAL	0x100U /**< Power mode value constant. */

/* ENUMS */
/**
 * @brief Stages for link startup or power mode change notifications.
 */
enum ChangeStage {
	PRE_CHANGE,  /**< Pre-change notification stage. */
	POST_CHANGE, /**< Post-change notification stage. */
};

/**
 * @brief Overall Command Status (OCS) values for UTP transfer requests.
 */
enum CommandStatus {
	OCS_SUCCESS                 = 0x0,  /**< Command completed successfully. */
	OCS_INVALID_CMD_TABLE_ATTR  = 0x1,  /**< Invalid command table attributes. */
	OCS_INVALID_PRDT_ATTR       = 0x2,  /**< Invalid PRDT attributes. */
	OCS_MISMATCH_DATA_BUF_SIZE  = 0x3,  /**< Mismatch in data buffer size. */
	OCS_MISMATCH_RESP_UPIU_SIZE = 0x4,  /**< Mismatch in response UPIU size. */
	OCS_PEER_COMM_FAILURE       = 0x5,  /**< Peer communication failure. */
	OCS_ABORTED                 = 0x6,  /**< Command was aborted. */
	OCS_FATAL_ERROR             = 0x7,  /**< Fatal error occurred. */
	OCS_DEVICE_FATAL_ERROR      = 0x8,  /**< Device fatal error occurred. */
	OCS_INVALID_CRYPTO_CONFIG   = 0x9,  /**< Invalid crypto configuration. */
	OCS_GENERAL_CRYPTO_ERROR    = 0xA,  /**< General crypto error. */
	OCS_INVALID_COMMAND_STATUS  = 0x0F, /**< Invalid command status (sentinel value). */
};
...
struct ufshc_xfer_req_upiu {
	...
	/** UPIU payload, varies by transaction type. */
	union {
...
struct ufshc_xfer_resp_upiu {
	struct ufshc_upiu_header upiu_header;            /**< UPIU header structure */
	/** Response UPIU payload, varies by transaction type. */
	union {
 ...
 * @return 0 on success, a negative error code on failure.
 */
int ufshc_rw_descriptors(struct ufs_host_controller *ufshc, bool write,
 ...
 * @return 0 on success, a negative error code on failure.
 */
int ufshc_rw_attributes(struct ufs_host_controller *ufshc, bool write, uint8_t idn, void *data);
 ...
 * @return 0 on success, a negative error code on failure.
 */
int ufshc_rw_flags(struct ufs_host_controller *ufshc, bool write,
