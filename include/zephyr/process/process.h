...
typedef int (*k_process_entry_t)(size_t argc, const char **argv);
typedef int (*k_process_load_t)(struct k_process *process, k_process_entry_t *entry);
...
__syscall int k_process_start(struct k_process *process, size_t argc, const char **argv);
