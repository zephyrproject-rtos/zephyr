 ...
 */
/**
 * @file zephyr/secure_storage/its/transform.h
 * @brief The secure storage ITS transform module.
 *
 ...
 * ITS transform module (CONFIG_SECURE_STORAGE_ITS_TRANSFORM_IMPLEMENTATION_CUSTOM).
 */
...
enum { SECURE_STORAGE_ITS_TRANSFORM_OUTPUT_SIZE
 ...
 * @param[in]  create_flags    The entry's create flags. They get stored as part of `stored_data`.
