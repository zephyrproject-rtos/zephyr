 ...
 * @return -EFAULT Bad memory address for unused_ptr (user mode only)
 */
__syscall int k_thread_runtime_stack_safety_full_check(const struct k_thread *thread,
				size_t *unused_ptr,
 ...
 * @return -EFAULT Bad memory address for unused_ptr (user mode only)
 */
__syscall int k_thread_runtime_stack_safety_threshold_check(const struct k_thread *thread,
				size_t *unused_ptr,
				k_thread_stack_safety_handler_t handler,
				void *arg);
#endif
