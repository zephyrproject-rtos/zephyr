...
/**
 * @brief Define a toplevel thread stack memory region in a public (non-static) scope.
 *
 * This defines a region of memory suitable for use as a thread's stack.
 *
 * This is the generic, historical definition. Align to Z_THREAD_STACK_OBJ_ALIGN
...
/**
 * @brief Define a toplevel thread stack memory region in a private (static) scope.
 *
 * This defines a region of memory suitable for use as a thread's stack.
 *
 * This is the generic, historical definition. Align to Z_THREAD_STACK_OBJ_ALIGN
 ...
 * @param size Size of the stack memory region
 */
#define K_THREAD_STACK_DEFINE_STATIC(sym, size) \
	static Z_THREAD_STACK_DEFINE_IN(sym, size, __stackmem)
