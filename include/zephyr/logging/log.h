...
#if defined(CONFIG_LOG_RATELIMIT) || defined(__DOXYGEN__)
/**
 * @brief Core rate-limited logging macro
 *
 ...
 * Only one thread can successfully log a message within the specified rate limit period.
 *
 ...
 * @param _skipped_msg Message to show when messages are skipped.
 * @param _log_func Logging function to call (Z_LOG or Z_LOG_HEXDUMP)
 * @param ... Arguments to pass to the logging function.
 */
#define _LOG_RATELIMIT_CORE(_level, _rate_ms, _skipped_msg, _log_func, ...)	\
	do {									\
		...
		if (unlikely(__diff >= (_rate_ms))) {			\
			if (atomic_cas(&__last_log_time, __last, __now)) {	\
				...
				if (__skipped > 0) {				\
					Z_LOG(_level, _skipped_msg, __skipped);	\
				}						\
				_log_func(_level, __VA_ARGS__);			\
			} else {						\
...
#define LOG_WRN_RATELIMIT_RATE(_rate_ms, ...) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_WRN, _rate_ms, "Skipped %d messages", Z_LOG, __VA_ARGS__)
...
#define LOG_WRN_RATELIMIT(...) \
	LOG_WRN_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, __VA_ARGS__)
 ...
 * The message will be logged at most once per specified interval in milliseconds.
 *
 * @param _rate_ms Minimum interval in milliseconds between log messages.
 * @param ... A string optionally containing printk valid conversion specifier,
 * followed by as many values as specifiers.
...
#define LOG_ERR_RATELIMIT_RATE(_rate_ms, ...) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_ERR, _rate_ms, "Skipped %d messages", Z_LOG, __VA_ARGS__)
...
#define LOG_ERR_RATELIMIT(...) \
	LOG_ERR_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, __VA_ARGS__)
...
#define LOG_INF_RATELIMIT_RATE(_rate_ms, ...) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_INF, _rate_ms, "Skipped %d messages", Z_LOG, __VA_ARGS__)
...
#define LOG_INF_RATELIMIT(...) \
	LOG_INF_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, __VA_ARGS__)
...
#define LOG_DBG_RATELIMIT_RATE(_rate_ms, ...) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_DBG, _rate_ms, "Skipped %d messages", Z_LOG, __VA_ARGS__)
...
#define LOG_DBG_RATELIMIT(...) \
	LOG_DBG_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, __VA_ARGS__)
...
#define LOG_HEXDUMP_ERR_RATELIMIT_RATE(_rate_ms, _data, _length, _str) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_ERR, _rate_ms, "Skipped %d hexdump messages", \
			    Z_LOG_HEXDUMP, _data, _length, _str)
...
#define LOG_HEXDUMP_ERR_RATELIMIT(_data, _length, _str) \
	LOG_HEXDUMP_ERR_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, _data, _length, _str)
...
#define LOG_HEXDUMP_WRN_RATELIMIT_RATE(_rate_ms, _data, _length, _str) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_WRN, _rate_ms, "Skipped %d hexdump messages", \
			    Z_LOG_HEXDUMP, _data, _length, _str)
...
#define LOG_HEXDUMP_WRN_RATELIMIT(_data, _length, _str) \
	LOG_HEXDUMP_WRN_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, _data, _length, _str)
...
#define LOG_HEXDUMP_INF_RATELIMIT_RATE(_rate_ms, _data, _length, _str) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_INF, _rate_ms, "Skipped %d hexdump messages", \
			    Z_LOG_HEXDUMP, _data, _length, _str)
...
#define LOG_HEXDUMP_INF_RATELIMIT(_data, _length, _str) \
	LOG_HEXDUMP_INF_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, _data, _length, _str)
...
#define LOG_HEXDUMP_DBG_RATELIMIT_RATE(_rate_ms, _data, _length, _str) \
	_LOG_RATELIMIT_CORE(LOG_LEVEL_DBG, _rate_ms, "Skipped %d hexdump messages", \
			    Z_LOG_HEXDUMP, _data, _length, _str)
...
#define LOG_HEXDUMP_DBG_RATELIMIT(_data, _length, _str) \
	LOG_HEXDUMP_DBG_RATELIMIT_RATE(CONFIG_LOG_RATELIMIT_INTERVAL_MS, _data, _length, _str)

#else /* CONFIG_LOG_RATELIMIT */

/* Rate-limited logging macros when CONFIG_LOG_RATELIMIT is disabled */
#if defined(CONFIG_LOG_RATELIMIT_FALLBACK_DROP)
/* Fallback: Drop all prints (no output) */
#define LOG_WRN_RATELIMIT_RATE(_rate_ms, ...) (void)0
#define LOG_WRN_RATELIMIT(...) (void)0
#define LOG_ERR_RATELIMIT_RATE(_rate_ms, ...) (void)0
#define LOG_ERR_RATELIMIT(...) (void)0
#define LOG_INF_RATELIMIT_RATE(_rate_ms, ...) (void)0
#define LOG_INF_RATELIMIT(...) (void)0
#define LOG_DBG_RATELIMIT_RATE(_rate_ms, ...) (void)0
#define LOG_DBG_RATELIMIT(...) (void)0
#define LOG_HEXDUMP_ERR_RATELIMIT_RATE(_rate_ms, _data, _length, _str) (void)0
#define LOG_HEXDUMP_ERR_RATELIMIT(_data, _length, _str) (void)0
#define LOG_HEXDUMP_WRN_RATELIMIT_RATE(_rate_ms, _data, _length, _str) (void)0
#define LOG_HEXDUMP_WRN_RATELIMIT(_data, _length, _str) (void)0
#define LOG_HEXDUMP_INF_RATELIMIT_RATE(_rate_ms, _data, _length, _str) (void)0
#define LOG_HEXDUMP_INF_RATELIMIT(_data, _length, _str) (void)0
#define LOG_HEXDUMP_DBG_RATELIMIT_RATE(_rate_ms, _data, _length, _str) (void)0
#define LOG_HEXDUMP_DBG_RATELIMIT(_data, _length, _str) (void)0
#else /* Catch all, not just CONFIG_LOG_RATELIMIT_FALLBACK_LOG */
/* Fallback: Log all prints (ignore rate limiting) */
#define LOG_WRN_RATELIMIT_RATE(_rate_ms, ...) LOG_WRN(__VA_ARGS__)
#define LOG_WRN_RATELIMIT(...) LOG_WRN(__VA_ARGS__)
#define LOG_ERR_RATELIMIT_RATE(_rate_ms, ...) LOG_ERR(__VA_ARGS__)
#define LOG_ERR_RATELIMIT(...) LOG_ERR(__VA_ARGS__)
#define LOG_INF_RATELIMIT_RATE(_rate_ms, ...) LOG_INF(__VA_ARGS__)
#define LOG_INF_RATELIMIT(...) LOG_INF(__VA_ARGS__)
#define LOG_DBG_RATELIMIT_RATE(_rate_ms, ...) LOG_DBG(__VA_ARGS__)
#define LOG_DBG_RATELIMIT(...) LOG_DBG(__VA_ARGS__)
#define LOG_HEXDUMP_ERR_RATELIMIT_RATE(_rate_ms, _data, _length, _str) \
