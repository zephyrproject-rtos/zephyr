 ...
 *
 * @param src Source net_buf_simple containing data to encode
 * @param dst Destination net_buf_simple for encoded data
 *
 * @retval 0 Success
 * @retval -EINVAL Invalid parameters (NULL pointers)
 * @retval -ENOMEM Destination buffer too small
 */
int cobs_encode(struct net_buf_simple *src, struct net_buf_simple *dst);
 ...
 *
 * @param src Source net_buf_simple containing COBS-encoded data
 * @param dst Destination net_buf_simple for decoded data
 *
 * @retval 0 Success
 * @retval -EINVAL Invalid parameters (NULL pointers) or malformed COBS data
 * @retval -ENOMEM Destination buffer too small
 */
int cobs_decode(struct net_buf_simple *src, struct net_buf_simple *dst);
