...
#ifndef ZEPHYR_INCLUDE_VIRTUALIZATION_VDEV_VIRT_PSCI_H_
#define ZEPHYR_INCLUDE_VIRTUALIZATION_VDEV_VIRT_PSCI_H_
...
#endif /* ZEPHYR_INCLUDE_VIRTUALIZATION_VDEV_VIRT_PSCI_H_ */