...
#error "CONFIG_DCACHE_LINE_SIZE_DETECT shall be supported, or CONFIG_DCACHE_LINE_SIZE must be defined\
 and non-zero"
#else
	return 0;
#endif
...
#error "CONFIG_ICACHE_LINE_SIZE_DETECT shall be supported, or CONFIG_ICACHE_LINE_SIZE must be defined\
 and non-zero"
#else
	return 0;
#endif
