...
#if DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(pll2), st_stm32h7_pll_clock, okay)
#define STM32_PLL2_ENABLE	1
...
#define STM32_PLL2_P_ENABLE	DT_NODE_HAS_PROP(DT_NODELABEL(pll2), div_p)
#define STM32_PLL2_P_DIVISOR	DT_PROP(DT_NODELABEL(pll2), div_p)
#define STM32_PLL2_Q_ENABLE	DT_NODE_HAS_PROP(DT_NODELABEL(pll2), div_q)
#define STM32_PLL2_Q_DIVISOR	DT_PROP(DT_NODELABEL(pll2), div_q)
#define STM32_PLL2_R_ENABLE	DT_NODE_HAS_PROP(DT_NODELABEL(pll2), div_r)
#define STM32_PLL2_R_DIVISOR	DT_PROP(DT_NODELABEL(pll2), div_r)
#else
