 ...
 * (Internal use only.)
 */
typedef int (*peci_config_t)(const struct device *dev, u32_t bitrate);
 ...
 */
__syscall int peci_config(const struct device *dev, u32_t bitrate);

static inline int z_impl_peci_config(const struct device *dev, u32_t bitrate)
{
