...
#ifndef ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_AGILEX_SMC_H_
#define ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_AGILEX_SMC_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_SIP_SVC_AGILEX_SMC_H_ */
