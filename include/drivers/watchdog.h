 ...
 */
typedef int (*wdt_api_setup)(const struct device *dev, u8_t options);
 ...
 */
__syscall int wdt_setup(const struct device *dev, u8_t options);

static inline int z_impl_wdt_setup(const struct device *dev, u8_t options)
{
