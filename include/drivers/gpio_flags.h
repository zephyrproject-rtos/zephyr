...
/**
 * @file
 * @brief Public flags for GPIO
 */

#ifndef ZEPHYR_INCLUDE_DRIVERS_GPIO_FLAGS_H_
#define ZEPHYR_INCLUDE_DRIVERS_GPIO_FLAGS_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_GPIO_FLAGS_H_ */
