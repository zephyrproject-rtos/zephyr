...
#ifndef ZEPHYR_INCLUDE_ARCH_ARM_CORTEX_A_R_CMSIS_EXT_H_
#define ZEPHYR_INCLUDE_ARCH_ARM_CORTEX_A_R_CMSIS_EXT_H_
...
#endif /* ZEPHYR_INCLUDE_ARCH_ARM_CORTEX_A_R_CMSIS_EXT_H_ */
