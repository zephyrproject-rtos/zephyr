...
/**
 * @brief Get dma controller "name" (label property) by name
 *
 * It's an error if the dma controller referenced by the phandle
...
/**
 * @brief Get dma channel specifier "cell" value for a given cell idx
 *
 * Example devicetree fragment:
 *
 *     dma1: dma@... {
 ...
 * @param idx logical idx of the dma channel specifier
...
/**
 * @brief Get dma channel specifier "cell" value for a given cell name
 *
 * Example devicetree fragment:
 *
 *     dma1: dma@... {
 ...
 * as "name"
 * @param name reference of the tatgeted dma channel specifier
 * @return the value of "cell" inside the specifier
...
/**
 * @brief Does a DMA client has a DMA specifer for a given specificer idx
 * @param node_id node identifier
 * @param idx dma channel specifier index
...
/**
 * @brief Does a DMA client has a DMA specifer referenced as "name"
 * @param node_id node identifier
...
/**
 * @brief Does a DMA client instance has a DMA specifer referenced as "name"
 * @param inst instance number
 * @param name lowercase-and-underscores dma channel specifier name
 * @return 1 if it has a "name" dma channel specifier, 0 otherwise
 */
