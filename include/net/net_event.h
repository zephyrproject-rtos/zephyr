...
enum net_event_ipv6_cmd {
	...
	NET_EVENT_IPV6_CMD_MADDR_DEPRECATED,
};
...
#define NET_EVENT_IPV6_MADDR_DEPRECATED				\
	(_NET_EVENT_IPV6_BASE |	NET_EVENT_IPV6_CMD_MADDR_DEPRECATED)
...
enum net_event_ipv4_cmd {
	...
	NET_EVENT_IPV4_CMD_ADDR_DEPRECATED,
	NET_EVENT_IPV4_CMD_MADDR_DEPRECATED,
};
...
#define NET_EVENT_IPV4_ADDR_DEPRECATED				\
	(_NET_EVENT_IPV4_BASE |	NET_EVENT_IPV4_CMD_ADDR_DEPRECATED)

#define NET_EVENT_IPV4_MADDR_DEPRECATED				\
	(_NET_EVENT_IPV4_BASE |	NET_EVENT_IPV4_CMD_MADDR_DEPRECATED)
