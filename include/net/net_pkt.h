...
struct net_pkt {
	...
	uint16_t ipv6_fragment_flags;	/* Fragment offset and M flag of this packet */
...
{
	return pkt->ipv6_fragment_flags & 0xfff8;
}
static inline uint8_t net_pkt_ipv6_fragment_more(struct net_pkt *pkt)
{
	return pkt->ipv6_fragment_flags & 0x01;
}
