...
struct net_pkt {
	...
	uint8_t ieee802154_frame_secured : 1; /* Frame is authenticated and
					       ...
					       */
	uint8_t ieee802154_fc_is_set : 1; /* Frame Counter was set */
	uint8_t ieee802154_ie_is_updated : 1; /* Information Elements that contain
					       * precise timing data unknown to
					       * the upper layer, e.g. Coordinated
					       * Sample Listening IEs, were updated
					       */
...
static inline bool net_pkt_ieee802154_fc_is_set(struct net_pkt *pkt)
{
	return pkt->ieee802154_fc_is_set;
}

static inline void net_pkt_set_ieee802154_fc_is_set(struct net_pkt *pkt,
						    bool is_set)
{
	pkt->ieee802154_fc_is_set = is_set;
}

static inline bool net_pkt_ieee802154_ie_is_updated(struct net_pkt *pkt)
{
	return pkt->ieee802154_ie_is_updated;
}

static inline void net_pkt_set_ieee802154_ie_is_updated(struct net_pkt *pkt,
							bool is_updated)
{
	pkt->ieee802154_ie_is_updated = is_updated;
}
