...
enum net_request_stats_cmd {
	 ...
	 */
	NET_REQUEST_STATS_CMD_GET_ALL			= BIT(0),
	NET_REQUEST_STATS_CMD_GET_PROCESSING_ERROR	= BIT(1),
	NET_REQUEST_STATS_CMD_GET_BYTES		= BIT(2),
	NET_REQUEST_STATS_CMD_GET_IP_ERRORS		= BIT(3),
	NET_REQUEST_STATS_CMD_GET_IPV4			= BIT(4),
	NET_REQUEST_STATS_CMD_GET_IPV6			= BIT(5),
	NET_REQUEST_STATS_CMD_GET_IPV6_ND		= BIT(6),
	NET_REQUEST_STATS_CMD_GET_ICMP			= BIT(7),
	NET_REQUEST_STATS_CMD_GET_UDP			= BIT(8),
	NET_REQUEST_STATS_CMD_GET_TCP			= BIT(9),
	NET_REQUEST_STATS_CMD_GET_RPL			= BIT(10),
};
