...
/* Message types. */
#define GPTP_SYNC_MESSAGE 0x0
#define GPTP_DELAY_REQ_MESSAGE 0x1
#define GPTP_PATH_DELAY_REQ_MESSAGE 0x2
#define GPTP_PATH_DELAY_RESP_MESSAGE 0x3
#define GPTP_FOLLOWUP_MESSAGE 0x8
#define GPTP_DELAY_RESP_MESSAGE 0x9
#define GPTP_PATH_DELAY_FOLLOWUP_MESSAGE 0xA
#define GPTP_ANNOUNCE_MESSAGE 0xB
#define GPTP_SIGNALING_MESSAGE 0xC
#define GPTP_MANAGEMENT_MESSAGE 0xD
...
/* Header Flags. Byte 0. */
#define GPTP_FLAG_TWO_STEP 0x02

/* Header Flags. Byte 1. */
#define GPTP_FLAG_LEAP61 0x01
#define GPTP_FLAG_LEAP59 0x02
#define GPTP_FLAG_CUR_UTC_OFF_VALID 0x04
#define GPTP_FLAG_PTP_TIMESCALE 0x08
#define GPTP_FLAG_TIME_TRACEABLE 0x10
#define GPTP_FLAG_FREQ_TRACEABLE 0x20
...
#define GPTP_FUP_TLV_ORG_SUB_TYPE 1
...
struct gptp_flags {
	union {
		...
		struct {
		    ...
		    u8_t current_utc_offset_valid :1;

		    /** PTP timescale flag. */
		    u8_t ptp_timescale :1;

		    /** Time traceable flag. */
		    u8_t time_traceable :1;

		    /** Frequency traceable flag. */
		    u8_t freq_traceable :1;
		};
