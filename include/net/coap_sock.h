...
#ifndef ZEPHYR_INCLUDE_NET_COAP_SOCK_H_
#define ZEPHYR_INCLUDE_NET_COAP_SOCK_H_

/**
 * @brief COAP library over Sockets
 * @defgroup coap_sock COAP Library over Sockets
 * @ingroup networking
 * @{
 */
...
#endif /* ZEPHYR_INCLUDE_NET_COAP_SOCK_H_ */
