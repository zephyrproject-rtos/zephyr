...
enum net_request_ieee802154_cmd {
	 ...
	 */
	NET_REQUEST_IEEE802154_CMD_SET_ACK		= BIT(0),
	NET_REQUEST_IEEE802154_CMD_UNSET_ACK		= BIT(1),
	NET_REQUEST_IEEE802154_CMD_PASSIVE_SCAN	= BIT(2),
	NET_REQUEST_IEEE802154_CMD_ACTIVE_SCAN		= BIT(3),
	NET_REQUEST_IEEE802154_CMD_CANCEL_SCAN		= BIT(4),
	NET_REQUEST_IEEE802154_CMD_ASSOCIATE		= BIT(5),
	NET_REQUEST_IEEE802154_CMD_DISASSOCIATE	= BIT(6),
	NET_REQUEST_IEEE802154_CMD_SET_CHANNEL		= BIT(7),
	NET_REQUEST_IEEE802154_CMD_GET_CHANNEL		= BIT(8),
	NET_REQUEST_IEEE802154_CMD_SET_PAN_ID		= BIT(9),
	NET_REQUEST_IEEE802154_CMD_GET_PAN_ID		= BIT(10),
	NET_REQUEST_IEEE802154_CMD_SET_EXT_ADDR	= BIT(11),
	NET_REQUEST_IEEE802154_CMD_GET_EXT_ADDR	= BIT(12),
	NET_REQUEST_IEEE802154_CMD_SET_SHORT_ADDR	= BIT(13),
	NET_REQUEST_IEEE802154_CMD_GET_SHORT_ADDR	= BIT(14),
	NET_REQUEST_IEEE802154_CMD_GET_TX_POWER	= BIT(15),
	NET_REQUEST_IEEE802154_CMD_SET_TX_POWER	= BIT(0) | BIT(1),
	NET_REQUEST_IEEE802154_CMD_SET_SECURITY_SETTINGS = BIT(2) | BIT(3),
	NET_REQUEST_IEEE802154_CMD_GET_SECURITY_SETTINGS = BIT(4) | BIT(5),
};
