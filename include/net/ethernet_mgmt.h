...
enum net_request_ethernet_cmd {
	...
	NET_REQUEST_ETHERNET_CMD_SET_QAV_STATUS,
...
#define NET_REQUEST_ETHERNET_SET_QAV_STATUS				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_SET_QAV_STATUS)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_SET_QAV_STATUS);
...
#define NET_REQUEST_ETHERNET_GET_QAV_STATUS				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_GET_QAV_STATUS)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_GET_QAV_STATUS);
