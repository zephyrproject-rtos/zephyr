...
enum net_request_ethernet_cmd {
	...
	NET_REQUEST_ETHERNET_CMD_ADD_FILTER_SRC_MAC,
	NET_REQUEST_ETHERNET_CMD_DEL_FILTER_SRC_MAC,
	NET_REQUEST_ETHERNET_CMD_ADD_FILTER_DST_MAC,
	NET_REQUEST_ETHERNET_CMD_DEL_FILTER_DST_MAC,
};
...
#define NET_REQUEST_ETHERNET_ADD_FILTER_SRC_MAC				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_ADD_FILTER_SRC_MAC)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_ADD_FILTER_SRC_MAC);

#define NET_REQUEST_ETHERNET_DEL_FILTER_SRC_MAC				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_DEL_FILTER_SRC_MAC)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_DEL_FILTER_SRC_MAC);

#define NET_REQUEST_ETHERNET_ADD_FILTER_DST_MAC				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_ADD_FILTER_DST_MAC)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_ADD_FILTER_DST_MAC);

#define NET_REQUEST_ETHERNET_DEL_FILTER_DST_MAC				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_DEL_FILTER_DST_MAC)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_DEL_FILTER_DST_MAC);
