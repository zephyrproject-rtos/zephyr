...
#if defined(CONFIG_BT_BAP) && defined(CONFIG_BT_AUDIO_BROADCAST_SINK)
...
#else /* !(CONFIG_BT_BAP && CONFIG_BT_AUDIO_BROADCAST_SINK) */
#define BROADCAST_SNK_STREAM_CNT 0
#define BROADCAST_SUBGROUP_CNT 0
#endif /* CONFIG_BT_BAP && CONFIG_BT_AUDIO_BROADCAST_SINK*/
