 ...
 *  cental. Channels in a unicast group shall share the same interval, framing
 ...
 *
 *  Delete a audio unicast group as a cental. All channels in the group shall
 *  be in an idle or configured state.
 *
