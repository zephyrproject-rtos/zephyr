...
static inline k_spinlock_key_t k_spin_lock(struct k_spinlock_t *l)
{
	k_spinlock_key_t k;
...
static inline void k_spin_unlock(struct k_spinlock_t *l, k_spinlock_key_t key)
{
#ifdef CONFIG_SMP
# ifdef CONFIG_DEBUG
