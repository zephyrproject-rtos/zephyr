...
/* flag to configure the PWM complementary output */
#define STM32_PWM_COMPLEMENTARY_PIN	(0x1<<STM32_PWM_COMPLEMENTARY_SHIFT)
#define STM32_PWM_COMPLEMENTARY_MASK	0x1
#define STM32_PWM_COMPLEMENTARY_SHIFT	15
