...
#define STM32_MODE_OUTPUT_MAX_10	(0x1<<STM32_MODE_OSPEED_SHIFT)
#define STM32_MODE_OUTPUT_MAX_2		(0x2<<STM32_MODE_OSPEED_SHIFT)
#define STM32_MODE_OUTPUT_MAX_50	(0x3<<STM32_MODE_OSPEED_SHIFT)
