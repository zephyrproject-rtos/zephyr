 ...
 * if the device doesn't support MSI and we don't know the IRQ allocated by
 * the firmware ahead of time. (Detection requires CONFIG_DYNAMIC_INTERRUPTS.)
 */

#define PCIE_IRQ_DETECT		0xFFFFFFFFU
