...
struct apic_regs {
	...
	struct apic_lvt LVT_CMCI; unsigned int_u15[3];
	struct apic_icr_lo ICR_LO, _u16[3];
	struct apic_icr_hi ICR_HI, _u17[3];
	struct apic_lvt LVT_TIMER; unsigned int_u18[3];
	struct apic_lvt LVT_THERMAL; unsigned int_u19[3];
	struct apic_lvt LVT_PERF; unsigned int_u20[3];
	struct apic_lvt LVT_LINT0; unsigned int_u21[3];
	struct apic_lvt LVT_LINT1; unsigned int_u22[3];
	struct apic_lvt LVT_ERROR; unsigned int_u23[3];
...
/* Assumes one IO-APIC.  Note that becuase of the way the register API
