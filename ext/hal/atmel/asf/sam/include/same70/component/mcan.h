...
#define   MCAN_TEST_LBCK_ENABLED_Val        _U_(0x1)                                       /**< (MCAN_TEST) Loop Back mode is enabled (see Section 1.5.1.9).  */
...
#define MCAN_IR_MASK                        _U_(0xFFCFFFFF)                                /**< \deprecated (MCAN_IR) Register MASK  (Use MCAN_IR_Msk instead)  */
#define MCAN_IR_Msk                         _U_(0xFFCFFFFF)                                /**< (MCAN_IR) Register Mask  */
...
#define MCAN_IE_MASK                        _U_(0xFFCFFFFF)                                /**< \deprecated (MCAN_IE) Register MASK  (Use MCAN_IE_Msk instead)  */
#define MCAN_IE_Msk                         _U_(0xFFCFFFFF)                                /**< (MCAN_IE) Register Mask  */
...
#define MCAN_ILS_MASK                       _U_(0xFFCFFFFF)                                /**< \deprecated (MCAN_ILS) Register MASK  (Use MCAN_ILS_Msk instead)  */
#define MCAN_ILS_Msk                        _U_(0xFFCFFFFF)                                /**< (MCAN_ILS) Register Mask  */
