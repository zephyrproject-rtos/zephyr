...
#define WDT_REGS        ((MEC_WDT *) WDT_BASE)
#define B16TMR0_REGS    ((MEC_BTMR *) B16TMR0_BASE)
#define B16TMR1_REGS    ((MEC_BTMR *) B16TMR1_BASE)
#define B32TMR0_REGS    ((MEC_BTMR *) B32TMR0_BASE)
#define B32TMR1_REGS    ((MEC_BTMR *) B32TMR1_BASE)
#define CCT_REGS        ((MEC_CCT *) CCT_BASE)

#define DMAM_REGS       ((MEC_DMAM *) DMA_BASE)
/* Individual DMA channels */
#define DMA0_REGS       ((MEC_DMA_ALU *)(DMA_CHAN_BASE(0)))
#define DMA1_REGS       ((MEC_DMA_ALU *)(DMA_CHAN_BASE(1)))
#define DMA2_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(2)))
#define DMA3_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(3)))
#define DMA4_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(4)))
#define DMA5_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(5)))
#define DMA6_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(6)))
#define DMA7_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(7)))
#define DMA8_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(8)))
#define DMA9_REGS       ((MEC_DMA *)(DMA_CHAN_BASE(9)))
#define DMA10_REGS      ((MEC_DMA *)(DMA_CHAN_BASE(10)))
#define DMA11_REGS      ((MEC_DMA *)(DMA_CHAN_BASE(11)))

#define SMB0_REGS       ((MEC_SMB *) SMB0_BASE)
#define SMB1_REGS       ((MEC_SMB *) SMB1_BASE)
#define SMB2_REGS       ((MEC_SMB *) SMB2_BASE)
#define SMB3_REGS       ((MEC_SMB *) SMB3_BASE)
#define SMB4_REGS       ((MEC_SMB *) SMB4_BASE)

#define RTMR_REGS       ((MEC_RTMR *) RTMR_BASE)

#define HTMR0_REGS      ((MEC_HTMR *) HTMR0_BASE)
#define HTMR1_REGS      ((MEC_HTMR *) HTMR1_BASE)

#define KSCAN_REGS      ((MEC_KSCAN *)(KEYSCAN_BASE))

#define VBATR_REGS      ((MEC_VBATR *) VBATR_BASE)
#define VBATM_REGS      ((MEC_VBATM *) VBATM_BASE)
#define WKTMR_REGS      ((MEC_WKTMR *) WKTMR_BASE)

#define LED0_REGS       ((MEC_LED *) LED0_BASE)
#define LED1_REGS       ((MEC_LED *) LED1_BASE)
#define LED2_REGS       ((MEC_LED *) LED2_BASE)

#define ECIA_REGS       ((MEC_ECIA *) ECIA_BASE)
#define GIRQ08_REGS     ((MEC_GIRQ *) ECIA_BASE)
#define GIRQ09_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x14))
#define GIRQ10_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x28))
#define GIRQ11_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x3C))
#define GIRQ12_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x50))
#define GIRQ13_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x64))
#define GIRQ14_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x78))
#define GIRQ15_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x8C))
#define GIRQ16_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0xA0))
#define GIRQ17_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0xB4))
#define GIRQ18_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0xC8))
#define GIRQ19_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0xDC))
#define GIRQ20_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0xF0))
#define GIRQ21_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x104))
#define GIRQ22_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x118))
#define GIRQ23_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x12C))
#define GIRQ24_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x140))
#define GIRQ25_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x154))
#define GIRQ26_REGS     ((MEC_GIRQ *) ((ECIA_BASE) + 0x168))

#define ECS_REGS        ((MEC_ECS *) ECS_BASE)

#define QMSPI_REGS      ((MEC_QMSPI *) QMSPI_BASE)

#define PCR_REGS        ((MEC_PCR *) PCR_BASE)

#define GPIO_CTRL_REGS      ((MEC_GPIO_CTRL *)(GPIO_CTRL_BASE))
#define GPIO_CTRL2_REGS     ((MEC_GPIO_CTRL2 *)(GPIO_CTRL2_BASE))
#define GPIO_PARIN_REGS     ((MEC_GPIO_PARIN *)(GPIO_PARIN_BASE))
#define GPIO_PAROUT_REGS    ((MEC_GPIO_PAROUT *)(GPIO_PAROUT_BASE))
#define GPIO_LOCK_REGS      ((MEC_GPIO_LOCK *)(GPIO_LOCK_BASE))

#define MBOX_REGS       ((MEC_MBOX *)(MBOX_BASE))

#define KBC_REGS        ((MEC_KBC *)(KBC_BASE))

#define ACPI_EC_0_REGS  ((MEC_ACPI_EC *)(ACPI_EC_0_BASE))
#define ACPI_EC_1_REGS  ((MEC_ACPI_EC *)(ACPI_EC_1_BASE))
#define ACPI_EC_2_REGS  ((MEC_ACPI_EC *)(ACPI_EC_2_BASE))
#define ACPI_EC_3_REGS  ((MEC_ACPI_EC *)(ACPI_EC_3_BASE))

#define PORT92_REGS     ((MEC_PORT92 *)(PORT92_BASE))

#define UART0_REGS      ((MEC_UART *) UART0_BASE)
#define UART1_REGS      ((MEC_UART *) UART1_BASE)
#define UART2_REGS      ((MEC_UART *) UART2_BASE)

#define ESPI_PC_REGS        ((MEC_ESPI_IO_PC *)(ESPI_IO_PC_BASE))
#define ESPI_HIO_BAR_REGS   ((MEC_ESPI_IO_BAR_HOST *)(ESPI_IO_HOST_BAR_BASE))
#define ESPI_LTR_REGS       ((MEC_ESPI_IO_LTR *)(ESPI_IO_LTR_BASE))
#define ESPI_OOB_REGS       ((MEC_ESPI_IO_OOB *)(ESPI_IO_OOB_BASE))
#define ESPI_FC_REGS        ((MEC_ESPI_IO_FC *)(ESPI_IO_FC_BASE))
#define ESPI_CAP_REGS       ((MEC_ESPI_IO_CAP *)(ESPI_IO_CAP_BASE))
#define ESPI_EIO_BAR_REGS   ((MEC_ESPI_IO_BAR_EC *)(ESPI_IO_EC_BAR_BASE))
#define ESPI_SIRQ_REGS      ((MEC_ESPI_IO_SIRQ *)(ESPI_IO_SIRQ_BASE))

#define ESPI_MEM_EBAR_REGS  ((MEC_ESPI_MEM_BAR_EC *)(ESPI_MEM_EC_BAR_BASE))
#define ESPI_MEM_HBAR_REGS  ((MEC_ESPI_MEM_BAR_HOST *)(ESPI_MEM_HOST_BAR_BASE))

#define ESPI_MEM_SRAM_EBAR_REGS   ((MEC_ESPI_MEM_SRAM_BAR_EC *)(ESPI_MEM_SRAM_EC_BAR_BASE))
#define ESPI_MEM_SRAM_HBAR_REGS   ((MEC_ESPI_MEM_SRAM_BAR_HOST *)(ESPI_MEM_SRAM_HOST_BAR_BASE))

#define ESPI_MEM_BM_REGS  ((MEC_ESPI_MEM_BM *)(ESPI_MEM_BM_BASE))
...
#define EMI0_REGS       ((MEC_EMI *)(EMI0_BASE))
#define EMI1_REGS       ((MEC_EMI *)(EMI0_BASE))
