...
#define MEC_EMI_BASE_ADDR           0x400F4000ul
    
#define MEC_EMI_NUM_INSTANCES       2u
#define MEC_EMI_SPACING             0x0400ul
#define MEC_EMI_SPACING_PWROF2      10u
    
#define MEC_EMI0_ADDR               0x400F4000ul
#define MEC_EMI1_ADDR               0x400F4400ul
    
/*
 * EMI interrupts
 */ 
#define MEC_EMI_GIRQ                15u
#define MEC_EMI_GIRQ_NVIC           7u
/* Direct NVIC connections */ 
#define MEC_EMI0_NVIC               42u
#define MEC_EMI1_NVIC               43u
    
/* GIRQ Source, Enable_Set/Clr, Result registers bit positions */ 
#define MEC_EMI0_GIRQ_POS           2u
#define MEC_EMI1_GIRQ_POS           3u
    
#define MEC_EMI0_GIRQ               (1ul << 2)
#define MEC_EMI1_GIRQ               (1ul << 3)
    
/*
 * OS_INT_SRC_LSB
 */ 
#define MEC_EMI_OSIS_LSB_EC_WR_POS      0u
#define MEC_EMI_OSIS_LSB_EC_WR          (1ul << 0)
/* the following bits are also apply to OS_INT_MASK_LSB */ 
#define MEC_EMI_OSIS_LSB_SWI_POS        1u
#define MEC_EMI_OSIS_LSB_SWI_MASK0      0x7Ful
#define MEC_EMI_OSIS_LSB_SWI_MASK       0xFEul
#define MEC_EMI_OSIS_LSB_SWI1           (1u << 1)
#define MEC_EMI_OSIS_LSB_SWI2           (1u << 2)
#define MEC_EMI_OSIS_LSB_SWI3           (1u << 3)
#define MEC_EMI_OSIS_LSB_SWI4           (1u << 4)
#define MEC_EMI_OSIS_LSB_SWI5           (1u << 5)
#define MEC_EMI_OSIS_LSB_SWI6           (1u << 6)
#define MEC_EMI_OSIS_LSB_SWI7           (1u << 7)
    
/*
 * OS_INT_SRC_MSB and OS_INT_MASK_MSB
 */ 
#define MEC_EMI_OSIS_MSB_SWI_POS        0u
#define MEC_EMI_OSIS_MSB_SWI_MASK0      0xFFul
#define MEC_EMI_OSIS_MSB_SWI_MASK       0xFFul
#define MEC_EMI_OSIS_MSB_SWI8           (1u << 0)
#define MEC_EMI_OSIS_MSB_SWI9           (1u << 1)
#define MEC_EMI_OSIS_MSB_SWI10          (1u << 2)
#define MEC_EMI_OSIS_MSB_SWI11          (1u << 3)
#define MEC_EMI_OSIS_MSB_SWI12          (1u << 4)
#define MEC_EMI_OSIS_MSB_SWI13          (1u << 5)
#define MEC_EMI_OSIS_MSB_SWI14          (1u << 6)
#define MEC_EMI_OSIS_MSB_SWI15          (1u << 7)
    
/*
 * OS_APP_ID
 */ 
#define MEC_EMI_OS_APP_ID_MASK          0xFFul
 ...
 * be aligned >= 4 bytes.
 */ 
#define MEC_EMI_MEM_BASE_MASK           0xFFFFFFFCul
 ...
 */ 
#define MEC_EMI_EC_OS_SWI_MASK      0xFFFEul
#define MEC_EMI_EC_OS_SWI1          (1ul << 1)
#define MEC_EMI_EC_OS_SWI2          (1ul << 2)
#define MEC_EMI_EC_OS_SWI3          (1ul << 3)
#define MEC_EMI_EC_OS_SWI4          (1ul << 4)
#define MEC_EMI_EC_OS_SWI5          (1ul << 5)
#define MEC_EMI_EC_OS_SWI6          (1ul << 6)
#define MEC_EMI_EC_OS_SWI7          (1ul << 7)
#define MEC_EMI_EC_OS_SWI8          (1ul << 8)
#define MEC_EMI_EC_OS_SWI9          (1ul << 9)
#define MEC_EMI_EC_OS_SWI10         (1ul << 10)
#define MEC_EMI_EC_OS_SWI11         (1ul << 11)
#define MEC_EMI_EC_OS_SWI12         (1ul << 12)
#define MEC_EMI_EC_OS_SWI13         (1ul << 13)
#define MEC_EMI_EC_OS_SWI14         (1ul << 14)
#define MEC_EMI_EC_OS_SWI15         (1ul << 15)
