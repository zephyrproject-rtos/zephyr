...
/* BM_STS */
#define MEC_ESPI_BM_STS_DONE_1_POS          0u
#define MEC_ESPI_BM_STS_DONE_1              (1ul << 0)	/* RW1C */
#define MEC_ESPI_BM_STS_BUSY_1_POS          1u
#define MEC_ESPI_BM_STS_BUSY_1              (1ul << 1)	/* RO */
#define MEC_ESPI_BM_STS_AB_EC_1_POS         2u
#define MEC_ESPI_BM_STS_AB_EC_1             (1ul << 2)	/* RW1C */
#define MEC_ESPI_BM_STS_AB_HOST_1_POS       3u
#define MEC_ESPI_BM_STS_AB_HOST_1           (1ul << 3)	/* RW1C */
#define MEC_ESPI_BM_STS_AB_CH2_1_POS        4u
#define MEC_ESPI_BM_STS_CH2_AB_1            (1ul << 4)	/* RW1C */
#define MEC_ESPI_BM_STS_OVFL_1_POS          5u
#define MEC_ESPI_BM_STS_OVFL_1_CH2          (1ul << 5)	/* RW1C */
#define MEC_ESPI_BM_STS_OVRUN_1_POS         6u
#define MEC_ESPI_BM_STS_OVRUN_1_CH2         (1ul << 6)	/* RW1C */
#define MEC_ESPI_BM_STS_INC_1_POS           7u
#define MEC_ESPI_BM_STS_INC_1               (1ul << 7)	/* RW1C */
#define MEC_ESPI_BM_STS_FAIL_1_POS          8u
#define MEC_ESPI_BM_STS_FAIL_1              (1ul << 8)	/* RW1C */
#define MEC_ESPI_BM_STS_IBERR_1_POS         9u
#define MEC_ESPI_BM_STS_IBERR_1             (1ul << 9)	/* RW1C */
#define MEC_ESPI_BM_STS_BADREQ_1_POS        11u
#define MEC_ESPI_BM_STS_BADREQ_1            (1ul << 11)	/* RW1C */
#define MEC_ESPI_BM_STS_DONE_2_POS          16u
#define MEC_ESPI_BM_STS_DONE_2              (1ul << 16)	/* RW1C */
#define MEC_ESPI_BM_STS_BUSY_2_POS          17u
#define MEC_ESPI_BM_STS_BUSY_2              (1ul << 17)	/* RO */
#define MEC_ESPI_BM_STS_AB_EC_2_POS         18u
#define MEC_ESPI_BM_STS_AB_EC_2             (1ul << 18)	/* RW1C */
#define MEC_ESPI_BM_STS_AB_HOST_2_POS       19u
#define MEC_ESPI_BM_STS_AB_HOST_2           (1ul << 19)	/* RW1C */
#define MEC_ESPI_BM_STS_AB_CH1_2_POS        20u
#define MEC_ESPI_BM_STS_AB_CH1_2            (1ul << 20)	/* RW1C */
#define MEC_ESPI_BM_STS_OVFL_2_POS          21u
#define MEC_ESPI_BM_STS_OVFL_2_CH2          (1ul << 21)	/* RW1C */
#define MEC_ESPI_BM_STS_OVRUN_2_POS         22u
#define MEC_ESPI_BM_STS_OVRUN_CH2_2         (1ul << 22)	/* RW1C */
#define MEC_ESPI_BM_STS_INC_2_POS           23u
#define MEC_ESPI_BM_STS_INC_2               (1ul << 23)	/* RW1C */
#define MEC_ESPI_BM_STS_FAIL_2_POS          24u
#define MEC_ESPI_BM_STS_FAIL_2              (1ul << 24)	/* RW1C */
#define MEC_ESPI_BM_STS_IBERR_2_POS         25u
#define MEC_ESPI_BM_STS_IBERR_2             (1ul << 25)	/* RW1C */
#define MEC_ESPI_BM_STS_BADREQ_2_POS        27u
#define MEC_ESPI_BM_STS_BADREQ_2            (1ul << 27)	/* RW1C */

#define MEC_ESPI_BM_STS_ALL_RW1C_1          0x0BFDul
#define MEC_ESPI_BM_STS_ALL_RW1C_2          (0x0BFDul << 16)

/* BM_IEN */
#define MEC_ESPI_BM1_IEN_DONE_POS           0u
#define MEC_ESPI_BM1_IEN_DONE               (1ul << 0)
#define MEC_ESPI_BM2_IEN_DONE_POS           16u
#define MEC_ESPI_BM2_IEN_DONE               (1ul << 16)

/* BM_CFG */
#define MEC_ESPI_BM1_CFG_TAG_POS            0u
#define MEC_ESPI_BM1_CFG_TAG_MASK0          0x0Ful
#define MEC_ESPI_BM1_CFG_TAG_MASK           (0x0Ful << 0)
#define MEC_ESPI_BM2_CFG_TAG_POS            16u
#define MEC_ESPI_BM2_CFG_TAG_MASK0          0x0Ful
#define MEC_ESPI_BM2_CFG_TAG_MASK           (0x0Ful << 16)

/* BM1_CTRL */
#define MEC_ESPI_BM1_CTRL_START_POS         0u
#define MEC_ESPI_BM1_CTRL_START             (1ul << 0)	/* WO */
#define MEC_ESPI_BM1_CTRL_ABORT_POS         1u
#define MEC_ESPI_BM1_CTRL_ABORT             (1ul << 1)	/* WO */
#define MEC_ESPI_BM1_CTRL_EN_INC_POS        2u
#define MEC_ESPI_BM1_CTRL_EN_INC            (1ul << 2)	/* RW */
#define MEC_ESPI_BM1_CTRL_WAIT_NB2_POS      3u
#define MEC_ESPI_BM1_CTRL_WAIT_NB2          (1ul << 3)	/* RW */
#define MEC_ESPI_BM1_CTRL_CTYPE_POS         8u
#define MEC_ESPI_BM1_CTRL_CTYPE_MASK0       0x03ul
#define MEC_ESPI_BM1_CTRL_CTYPE_MASK        (0x03ul << 8)
#define MEC_ESPI_BM1_CTRL_CTYPE_RD_ADDR32   (0x00ul << 8)
#define MEC_ESPI_BM1_CTRL_CTYPE_WR_ADDR32   (0x01ul << 8)
#define MEC_ESPI_BM1_CTRL_CTYPE_RD_ADDR64   (0x02ul << 8)
#define MEC_ESPI_BM1_CTRL_CTYPE_WR_ADDR64   (0x03ul << 8)
#define MEC_ESPI_BM1_CTRL_LEN_POS           16u
#define MEC_ESPI_BM1_CTRL_LEN_MASK0         0x1FFFul
#define MEC_ESPI_BM1_CTRL_LEN_MASK          (0x1FFFul << 16)

/* BM1_EC_ADDR_LSW */
#define MEC_ESPI_BM1_EC_ADDR_LSW_MASK       0xFFFFFFFCul

/* BM2_CTRL */
#define MEC_ESPI_BM2_CTRL_START_POS         0u
#define MEC_ESPI_BM2_CTRL_START             (1ul << 0)	/* WO */
#define MEC_ESPI_BM2_CTRL_ABORT_POS         1u
#define MEC_ESPI_BM2_CTRL_ABORT             (1ul << 1)	/* WO */
#define MEC_ESPI_BM2_CTRL_EN_INC_POS        2u
#define MEC_ESPI_BM2_CTRL_EN_INC            (1ul << 2)	/* RW */
#define MEC_ESPI_BM2_CTRL_WAIT_NB2_POS      3u
#define MEC_ESPI_BM2_CTRL_WAIT_NB2          (1ul << 3)	/* RW */
#define MEC_ESPI_BM2_CTRL_CTYPE_POS         8u
#define MEC_ESPI_BM2_CTRL_CTYPE_MASK0       0x03ul
#define MEC_ESPI_BM2_CTRL_CTYPE_MASK        (0x03ul << 8)
#define MEC_ESPI_BM2_CTRL_CTYPE_RD_ADDR32   (0x00ul << 8)
#define MEC_ESPI_BM2_CTRL_CTYPE_WR_ADDR32   (0x01ul << 8)
#define MEC_ESPI_BM2_CTRL_CTYPE_RD_ADDR64   (0x02ul << 8)
#define MEC_ESPI_BM2_CTRL_CTYPE_WR_ADDR64   (0x03ul << 8)
#define MEC_ESPI_BM2_CTRL_LEN_POS           16u
#define MEC_ESPI_BM2_CTRL_LEN_MASK0         0x1FFFul
#define MEC_ESPI_BM2_CTRL_LEN_MASK          (0x1FFFul << 16)

/* BM2_EC_ADDR_LSW */
#define MEC_ESPI_BM2_EC_ADDR_LSW_MASK       0xFFFFFFFCul
...
/*
 * MEC_ESPI_MEM_BAR_EC @ 0x400F3930
 *
 ...
 */
#define MEC_ESPI_EBAR_H0_MEM_MASK_POS      0u
#define MEC_ESPI_EBAR_H0_MEM_MASK_MASK     0xFFul
#define MEC_ESPI_EBAR_H0_LDN_POS           8u
#define MEC_ESPI_EBAR_H0_LDN_MASK0         0x3Ful
#define MEC_ESPI_EBAR_H0_LDN_MASK          (0x3Ful << 8u)
...
/*
 * MEC_ESPI_MEM_BAR_HOST @ 0x400F3B30
 *
...
#define MEC_ESPI_HBAR_VALID_POS         0u
#define MEC_ESPI_HBAR_VALID_MASK        0x01ul
/*
 * Host address is in bits[47:16] of the HBAR
 * HBAR's are spaced every 10 bytes (80 bits) but
 * only implement bits[47:0]
 */
#define MEC_ESPI_HBAR_VALID_OFS         0x00u	/* byte 0 */
/* 32-bit Host Address */
#define MEC_ESPI_HBAR_ADDR_B0_OFS       0x02u	/* byte 2 */
#define MEC_ESPI_HBAR_ADDR_B1_OFS       0x03u	/* byte 3 */
#define MEC_ESPI_HBAR_ADDR_B2_OFS       0x04u	/* byte 4 */
#define MEC_ESPI_HBAR_ADDR_B3_OFS       0x05u	/* byte 5 */
 ...
 */
#define MEC_EC_SRAM_BAR_H0_VALID_POS        0u
#define MEC_EC_SRAM_BAR_H0_VALID_MASK0      0x01ul
#define MEC_EC_SRAM_BAR_H0_VALID_MASK       0x01ul
#define MEC_EC_SRAM_BAR_H0_VALID            0x01ul
#define MEC_EC_SRAM_BAR_H0_ACCESS_POS       1u
#define MEC_EC_SRAM_BAR_H0_ACCESS_MASK0     0x03ul
#define MEC_EC_SRAM_BAR_H0_ACCESS_MASK      (0x03ul << 1u)
#define MEC_EC_SRAM_BAR_H0_ACCESS_NONE      (0x00ul << 1u)
#define MEC_EC_SRAM_BAR_H0_ACCESS_RO        (0x01ul << 1u)
#define MEC_EC_SRAM_BAR_H0_ACCESS_WO        (0x02ul << 1u)
#define MEC_EC_SRAM_BAR_H0_ACCESS_RW        (0x03ul << 1u)
#define MEC_EC_SRAM_BAR_H0_SIZE_POS         4u
#define MEC_EC_SRAM_BAR_H0_SIZE_MASK0       0x0Ful
#define MEC_EC_SRAM_BAR_H0_SIZE_MASK        (0x0Ful << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_1B          (0x00ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_2B          (0x01ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_4B          (0x02ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_8B          (0x03ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_16B         (0x04ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_32B         (0x05ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_64B         (0x06ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_128B        (0x07ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_256B        (0x08ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_512B        (0x09ul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_1KB         (0x0Aul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_2KB         (0x0Bul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_4KB         (0x0Cul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_8KB         (0x0Dul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_16KB        (0x0Eul << 4u)
#define MEC_EC_SRAM_BAR_H0_SIZE_32KB        (0x0Ful << 4u)
/* EC and Host SRAM BAR start offset of EC or Host memory address */
#define MEC_EC_SRAM_BAR_MADDR_OFS1          2ul
#define MEC_EC_SRAM_BAR_MADDR_OFS2          4ul
...
} MEC_ESPI_MEM_SRAM_BAR_HOST;

enum mec_espi_sram_bar_size {
	MEC_ESPI_SRAM_SZ_1B = 0,
	MEC_ESPI_SRAM_SZ_2B,
	MEC_ESPI_SRAM_SZ_4B,
	MEC_ESPI_SRAM_SZ_8B,
	MEC_ESPI_SRAM_SZ_16B,
	MEC_ESPI_SRAM_SZ_32B,
	MEC_ESPI_SRAM_SZ_64B,
	MEC_ESPI_SRAM_SZ_128B,
	MEC_ESPI_SRAM_SZ_256B,
	MEC_ESPI_SRAM_SZ_512B,
	MEC_ESPI_SRAM_SZ_1KB,
	MEC_ESPI_SRAM_SZ_2KB,
	MEC_ESPI_SRAM_SZ_4KB,
	MEC_ESPI_SRAM_SZ_8KB,
	MEC_ESPI_SRAM_SZ_16KB,
	MEC_ESPI_SRAM_SZ_32KB
};

enum mec_espi_sram_bar_access {
	MEC_ESPI_SRAM_ACCESS_NONE = 0,
	MEC_ESPI_SRAM_ACCESS_RO,
	MEC_ESPI_SRAM_ACCESS_WO,
	MEC_ESPI_SRAM_ACCESS_RW
};

enum mec_espi_sram_bar_valid {
	MEC_ESPI_SRAM_BAR_NOT_VALID = 0,
	MEC_ESPI_SRAM_BAR_VALID
};

static __attribute__ ((always_inline))
inline uint32_t mec_espi_sram_bar_valid_get(uintptr_t bar_addr)
{
	return (REG16(bar_addr) >> MEC_EC_SRAM_BAR_H0_VALID_POS)
	    & MEC_EC_SRAM_BAR_H0_VALID_MASK0;
}

static __attribute__ ((always_inline))
inline void
mec_espi_sram_bar_valid_set(uintptr_t bar_addr,
			    enum mec_espi_sram_bar_valid valid)
{
	REG16(bar_addr) = (REG16(bar_addr) & ~(MEC_EC_SRAM_BAR_H0_VALID_MASK))
	    | (((uint32_t) valid << MEC_EC_SRAM_BAR_H0_VALID_POS)
	       & MEC_EC_SRAM_BAR_H0_VALID_MASK);
}

static __attribute__ ((always_inline))
inline uint32_t mec_espi_sram_bar_access_get(uintptr_t bar_addr)
{
	return (REG16(bar_addr) >> MEC_EC_SRAM_BAR_H0_ACCESS_POS)
	    & MEC_EC_SRAM_BAR_H0_ACCESS_MASK0;
}

static __attribute__ ((always_inline))
inline void
mec_espi_sram_bar_access_set(uintptr_t bar_addr, enum mec_espi_sram_bar_size sz)
{
	REG16(bar_addr) = (REG16(bar_addr) & ~(MEC_EC_SRAM_BAR_H0_ACCESS_MASK))
	    | (((uint32_t) sz << MEC_EC_SRAM_BAR_H0_ACCESS_POS)
	       & MEC_EC_SRAM_BAR_H0_ACCESS_MASK);
}

static __attribute__ ((always_inline))
inline uint32_t mec_espi_sram_bar_size_get(uintptr_t bar_addr)
{
	return (REG16(bar_addr) >> MEC_EC_SRAM_BAR_H0_SIZE_POS)
	    & MEC_EC_SRAM_BAR_H0_SIZE_MASK0;
}

static __attribute__ ((always_inline))
inline void
mec_espi_sram_bar_size_set(uintptr_t bar_addr, enum mec_espi_sram_bar_size sz)
{
	REG16(bar_addr) = (REG16(bar_addr) & ~(MEC_EC_SRAM_BAR_H0_SIZE_MASK))
	    | (((uint32_t) sz << MEC_EC_SRAM_BAR_H0_SIZE_POS)
	       & MEC_EC_SRAM_BAR_H0_SIZE_MASK);
}
 ...
 */
static __attribute__ ((always_inline))
inline uint32_t mec_espi_sram_bar_maddr_get(uintptr_t bar_addr)
{
	uint32_t maddr;
...
static __attribute__ ((always_inline))
inline void mec_espi_sram_bar_maddr_set(uintptr_t bar_addr, uint32_t maddr)
{
