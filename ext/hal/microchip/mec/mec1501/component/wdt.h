...
#define MEC_WDT_BASE_ADDR               0x40000400ul
    
#define MEC_WDT_CTRL_MASK               0x021Dul
#define MEC_WDT_CTRL_EN_POS             0u
#define MEC_WDT_CTRL_EN_MASK            (1u1 << (MEC_WDT_CTRL_EN_POS))
#define MEC_WDT_CTRL_EN                 (1u1 << (MEC_WDT_CTRL_EN_POS))
#define MEC_WDT_CTRL_HTMR_STALL_POS     2u
#define MEC_WDT_CTRL_HTMR_STALL_MASK    (1u1 << (MEC_WDT_CTRL_HTMR_STALL_POS))
#define MEC_WDT_CTRL_HTMR_STALL_EN      (1u1 << (MEC_WDT_CTRL_HTMR_STALL_POS))
#define MEC_WDT_CTRL_WKTMR_STALL_POS    3u
#define MEC_WDT_CTRL_WKTMR_STALL_MASK   (1u1 << (MEC_WDT_CTRL_WKTMR_STALL_POS))
#define MEC_WDT_CTRL_WKTMR_STALL_EN     (1u1 << (MEC_WDT_CTRL_WKTMR_STALL_POS))
#define MEC_WDT_CTRL_JTAG_STALL_POS     4u
#define MEC_WDT_CTRL_JTAG_STALL_MASK    (1u1 << (MEC_WDT_CTRL_JTAG_STALL_POS))
#define MEC_WDT_CTRL_JTAG_STALL_EN      (1u1 << (MEC_WDT_CTRL_JTAG_STALL_POS))
    
/* WDT Kick register. Write any value to reload counter */ 
#define MEC_WDT_KICK_OFS                0x08ul
    
/* WDT Count register. Read only */ 
#define MEC_WDT_CNT_RO_OFS              0x0Cul
#define MEC_WDT_CNT_RO_MASK             0xFFFFul
