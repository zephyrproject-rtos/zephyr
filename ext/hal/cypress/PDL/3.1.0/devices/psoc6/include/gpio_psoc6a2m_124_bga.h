/***************************************************************************//**
* \file gpio_psoc6a2m_124_bga.h
*
* \brief
* PSoC6A-2M device GPIO header for 124-BGA package
*
* \note
...
#ifndef _GPIO_PSOC6A2M_124_BGA_H_
#define _GPIO_PSOC6A2M_124_BGA_H_
...
/* Port List */
/* PORT 0 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5) */
...
/* PORT 1 (GPIO_OVT, SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5) */
...
/* PORT 2 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 3 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5) */
...
/* PORT 4 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3) */
...
/* PORT 5 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 6 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 7 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 8 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 9 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 10 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 11 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 12 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
/* PORT 13 (SLOW_IO0, SLOW_IO1, SLOW_IO2, SLOW_IO3, SLOW_IO4, SLOW_IO5, SLOW_IO6, SLOW_IO7) */
...
typedef enum
{
    ...
    P5_4_SCB10_UART_RX              = 18,       /* Digital Active - scb[10].uart_rx:0 */
    P5_4_SCB10_I2C_SCL              = 19,       /* Digital Active - scb[10].i2c_scl:0 */
    ...
    P5_5_SCB10_UART_TX              = 18,       /* Digital Active - scb[10].uart_tx:0 */
    P5_5_SCB10_I2C_SDA              = 19,       /* Digital Active - scb[10].i2c_sda:0 */
    ...
    P8_4_SCB11_UART_RX              = 18,       /* Digital Active - scb[11].uart_rx:0 */
    P8_4_SCB11_I2C_SCL              = 19,       /* Digital Active - scb[11].i2c_scl:0 */
    ...
    P8_5_SCB11_UART_TX              = 18,       /* Digital Active - scb[11].uart_tx:0 */
    P8_5_SCB11_I2C_SDA              = 19,       /* Digital Active - scb[11].i2c_sda:0 */
    ...
    P8_6_SCB11_UART_RTS             = 18,       /* Digital Active - scb[11].uart_rts:0 */
    ...
    P8_7_SCB11_UART_CTS             = 18,       /* Digital Active - scb[11].uart_cts:0 */
    ...
    P9_4_AUDIOSS0_RX_SCK            = 22,       /* Digital Active - audioss[0].rx_sck:1 */
    ...
    P9_5_AUDIOSS0_RX_WS             = 22,       /* Digital Active - audioss[0].rx_ws:1 */
    ...
    P9_6_AUDIOSS0_RX_SDI            = 22,       /* Digital Active - audioss[0].rx_sdi:1 */
    ...
    P12_0_SDHC1_CARD_EMMC_RESET_N   = 26,       /* Digital Active - sdhc[1].card_emmc_reset_n */
    ...
    P12_1_SDHC1_CARD_DETECT_N       = 26,       /* Digital Active - sdhc[1].card_detect_n */
    ...
    P12_2_SDHC1_CARD_MECH_WRITE_PROT = 26,      /* Digital Active - sdhc[1].card_mech_write_prot */
    ...
    P12_3_SDHC1_LED_CTRL            = 26,       /* Digital Active - sdhc[1].led_ctrl */
    ...
    P12_4_AUDIOSS0_PDM_CLK          = 21,       /* Digital Active - audioss[0].pdm_clk:1 */
    P12_4_SDHC1_CARD_CMD            = 26,       /* Digital Active - sdhc[1].card_cmd */
    ...
    P12_5_AUDIOSS0_PDM_DATA         = 21,       /* Digital Active - audioss[0].pdm_data:1 */
    P12_5_SDHC1_CLK_CARD            = 26,       /* Digital Active - sdhc[1].clk_card */
    ...
    P13_0_AUDIOSS1_CLK_I2S_IF       = 22,       /* Digital Active - audioss[1].clk_i2s_if:0 */
    P13_0_PERI_TR_IO_INPUT26        = 24,       /* Digital Active - peri.tr_io_input[26]:0 */
    P13_0_SDHC1_CARD_DAT_3TO00      = 26,       /* Digital Active - sdhc[1].card_dat_3to0[0] */
    ...
    P13_1_AUDIOSS1_TX_SCK           = 22,       /* Digital Active - audioss[1].tx_sck:0 */
    P13_1_PERI_TR_IO_INPUT27        = 24,       /* Digital Active - peri.tr_io_input[27]:0 */
    P13_1_SDHC1_CARD_DAT_3TO01      = 26,       /* Digital Active - sdhc[1].card_dat_3to0[1] */
    ...
    P13_2_AUDIOSS1_TX_WS            = 22,       /* Digital Active - audioss[1].tx_ws:0 */
    P13_2_SDHC1_CARD_DAT_3TO02      = 26,       /* Digital Active - sdhc[1].card_dat_3to0[2] */
    ...
    P13_3_AUDIOSS1_TX_SDO           = 22,       /* Digital Active - audioss[1].tx_sdo:0 */
    P13_3_SDHC1_CARD_DAT_3TO03      = 26,       /* Digital Active - sdhc[1].card_dat_3to0[3] */
    ...
    P13_4_SCB12_UART_RX             = 18,       /* Digital Active - scb[12].uart_rx:0 */
    P13_4_SCB12_I2C_SCL             = 19,       /* Digital Active - scb[12].i2c_scl:0 */
    P13_4_SCB6_SPI_SELECT1          = 20,       /* Digital Active - scb[6].spi_select1:1 */
    P13_4_AUDIOSS1_RX_SCK           = 22,       /* Digital Active - audioss[1].rx_sck:0 */
    P13_4_SDHC1_CARD_DAT_7TO40      = 26,       /* Digital Active - sdhc[1].card_dat_7to4[0] */
    ...
    P13_5_SCB12_UART_TX             = 18,       /* Digital Active - scb[12].uart_tx:0 */
    P13_5_SCB12_I2C_SDA             = 19,       /* Digital Active - scb[12].i2c_sda:0 */
    P13_5_SCB6_SPI_SELECT2          = 20,       /* Digital Active - scb[6].spi_select2:1 */
    P13_5_AUDIOSS1_RX_WS            = 22,       /* Digital Active - audioss[1].rx_ws:0 */
    P13_5_SDHC1_CARD_DAT_7TO41      = 26,       /* Digital Active - sdhc[1].card_dat_7to4[1] */
    ...
    P13_6_SCB12_UART_RTS            = 18,       /* Digital Active - scb[12].uart_rts:0 */
    P13_6_SCB6_SPI_SELECT3          = 20,       /* Digital Active - scb[6].spi_select3:1 */
    P13_6_AUDIOSS1_RX_SDI           = 22,       /* Digital Active - audioss[1].rx_sdi:0 */
    P13_6_SDHC1_CARD_DAT_7TO42      = 26,       /* Digital Active - sdhc[1].card_dat_7to4[2] */
...
#endif /* _GPIO_PSOC6A2M_124_BGA_H_ */
