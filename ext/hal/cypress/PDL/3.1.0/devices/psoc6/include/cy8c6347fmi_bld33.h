...
#ifndef _CY8C6347FMI_BLD33_H_
#define _CY8C6347FMI_BLD33_H_

/**
* \addtogroup group_device CY8C6347FMI-BLD33
* \{
*/
...
typedef enum {
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6347FMI-BLD33 Peripheral Interrupt Numbers */
...
/* CY8C6347FMI-BLD33 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
...
#include "gpio_psoc6able2_104_m_csp_ble.h"

#define CY_DEVICE_PSOC6ABLE2
#define CY_SILICON_ID                   0xE2282100UL
