...
#define NET_MGMT_SUPPLICANT_CODE NET_MGMT_LAYER_CODE_WIFI
...
#define NET_EVENT_SUPPLICANT_READY					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_READY))

#define NET_EVENT_SUPPLICANT_NOT_READY					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_NOT_READY))

#define NET_EVENT_SUPPLICANT_IFACE_ADDED					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_IFACE_ADDED))

#define NET_EVENT_SUPPLICANT_IFACE_REMOVED					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_IFACE_REMOVED))

#define NET_EVENT_SUPPLICANT_IFACE_REMOVING					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_IFACE_REMOVING))

#define NET_EVENT_SUPPLICANT_INT_EVENT					\
	(NET_MGMT_SUPPLICANT_EVENT | BIT64(NET_EVENT_SUPPLICANT_CMD_INT_EVENT))
