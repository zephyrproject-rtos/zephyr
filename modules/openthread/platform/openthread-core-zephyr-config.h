 ...
 *
 */
#ifdef CONFIG_OPENTHREAD_DEFAULT_TRANSMIT_POWER
#define OPENTHREAD_CONFIG_DEFAULT_TRANSMIT_POWER CONFIG_OPENTHREAD_DEFAULT_TRANSMIT_POWER
#endif /* CONFIG_OPENTHREAD_DEFAULT_TRANSMIT_POWER */
