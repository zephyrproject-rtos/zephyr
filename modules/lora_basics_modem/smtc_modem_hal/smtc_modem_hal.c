...
void smtc_modem_hal_start_radio_tcxo(void)
{
	 ...
	 * https://github.com/Lora-net/SWL2001/blob/master/lbm_lib/PORTING_GUIDE.md#void-smtc_modem_hal_start_radio_tcxo-void-
	 */
}
...
void smtc_modem_hal_stop_radio_tcxo(void)
{
	/* TODO: We only support TCXO's that are wired to the transceiver.
	 * In such cases, this function must be empty according to the porting guide.
	 * https://github.com/Lora-net/SWL2001/blob/master/lbm_lib/PORTING_GUIDE.md#void-smtc_modem_hal_stop_radio_tcxo-void-
	 */
}
