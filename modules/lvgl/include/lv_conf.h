...
#define LV_VG_LITE_HAL_GPU_SERIES DT_STRING_UNQUOTED(DT_INST(0, zephyr_lvgl_gpu_vglite), variant)
#define LV_VG_LITE_HAL_GPU_REVISION DT_STRING_UNQUOTED(DT_INST(0, zephyr_lvgl_gpu_vglite), revision)
