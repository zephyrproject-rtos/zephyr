...
#define LVGL_ADD_ROUNDER_EVENT_CB(_display)                                                       \
	IF_ENABLED(CONFIG_LV_Z_USE_ROUNDER_CB,                                                    \
		   (lv_display_add_event_cb((_display), lvgl_rounder_cb,                          \
					     LV_EVENT_INVALIDATE_AREA, (_display));))
