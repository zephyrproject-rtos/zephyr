...
#if defined(CONFIG_MBEDTLS_SSL_TLS1_3_COMPATIBILITY_MODE)
 ...
 */
#if defined(CONFIG_MBEDTLS_SSL_MAX_FRAGMENT_LENGTH)
...
#endif /* CONFIG_MBEDTLS_SSL_MAX_FRAGMENT_LENGTH */
...
#if defined(CONFIG_MBEDTLS_SSL_EARLY_DATA)
