...
#ifdef CONFIG_BT_ISO
#define SL_CATALOG_BLUETOOTH_FEATURE_ISO_CONN_PRESENT
#define SL_CATALOG_BLUETOOTH_FEATURE_ISO_BCAST_PRESENT
#endif
...
#define SL_BT_CONTROLLER_BUFFER_MEMORY      0 /* deprecated */
