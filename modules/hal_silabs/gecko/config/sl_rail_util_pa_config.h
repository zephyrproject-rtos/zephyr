...
#define SL_RAIL_UTIL_PA_CURVE_HEADER       CONFIG_SILABS_GECKO_RAIL_PA_CURVE_HEADER
#define SL_RAIL_UTIL_PA_CURVE_TYPES        CONFIG_SILABS_GECKO_RAIL_PA_CURVE_TYPES_HEADER
#define SL_RAIL_UTIL_PA_CALIBRATION_ENABLE CONFIG_SILABS_GECKO_RAIL_PA_ENABLE_CALIBRATION
