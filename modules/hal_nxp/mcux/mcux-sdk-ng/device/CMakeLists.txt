...
if(NOT (${CONFIG_MCUX_CORE_SUFFIX} MATCHES "^.*(_dsp|_hifi.)$"))
  set(CONFIG_MCUX_COMPONENT_driver.power ON)
endif()

# Include fsl_dsp.c for Cortex-M domains of RTxxx devices
if(CONFIG_SOC_MIMXRT685S AND NOT (${CONFIG_MCUX_CORE_SUFFIX} MATCHES "^.*(_dsp|_hifi.)$"))
