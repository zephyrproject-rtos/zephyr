...
/**
 * @brief NRFX_TWIS_ASSUME_INIT_AFTER_RESET_ONLY - Assume that any instance
...
/**
 * @brief NRFX_UARTE_CONFIG_SKIP_GPIO_CONFIG - If enabled, support for
 *        configuring GPIO pins is removed from the driver
 *
 * Boolean. Accepted values: 0 and 1.
 */
...
/**
 * @brief NRFX_UARTE_CONFIG_SKIP_PSEL_CONFIG - If enabled, support for
 *        configuring PSEL registers is removed from the driver
 *
 * Boolean. Accepted values: 0 and 1.
 */
...
/**
 * @brief NRFX_UARTE_CONFIG_TX_LINK - If enabled, driver supports linking
 *        of TX transfers.
 *
 * Boolean. Accepted values: 0 and 1.
 */
...
#endif /* NRFX_CONFIG_NRF54H20_PPR_H__ */
