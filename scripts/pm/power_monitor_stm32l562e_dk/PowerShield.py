...
class PowerShield(PowerMonitor):
    ...
    def init(self, power_device_path: str):
        ...
        self.target_temperature = self.__get_temperature(self.power_shield_conf.temperature_unit)
        self.target_voltage = self.__get_voltage_level()
    ...
    def __get_temperature(self, unit: str = PowerShieldConf.TemperatureUnit.CELCIUS) -> float:
        """
    ...
    def __set_acquisition_time(self, acquisition_time: str = '0'):
        ...
        if response:
            ...
            logging.warning(f"Failed to set acquisition time to {acquisition_time}.")
    ...
    def measure(self, time: int, freq: str = None, reset: bool = False):
        ...
        if freq is not None:
            ...
            self.__set_frequency(self.power_shield_conf.sampling_freqency)
