...
""",
                 dts_file,
                 f"'reg' property in <Node /sub in '{dts_file}' at line 8> has length 4, which is not evenly divisible by 12 (= 4*(<#address-cells> (= 1) + <#size-cells> (= 2))). Note that #*-cells properties come either from the parent node or from the controller (in the case of 'interrupts').")
...
""",
                 dts_file,
                 f"'interrupts' property in <Node /sub in '{dts_file}' at line 5> has length 4, which is not evenly divisible by 8 (= 4*<#interrupt-cells>). Note that #*-cells properties come either from the parent node or from the controller (in the case of 'interrupts').")
...
""",
                 dts_file,
                 f"'ranges' property in <Node /sub-1 in '{dts_file}' at line 7> has length 8, which is not evenly divisible by 24 (= 4*(<#address-cells> (= 2) + <#address-cells for parent> (= 1) + <#size-cells> (= 3))). Note that #*-cells properties come either from the parent node or from the controller (in the case of 'interrupts').")
