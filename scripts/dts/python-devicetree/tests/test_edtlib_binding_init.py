...
- extend inherited properties:
  ...
  - add a "const:" or "default:" value to a property which does not have one
...
- change the "const:" or "default:" value of an inherited property
...
YAML_BASE: Dict[str, str] = {
    # Base properties, also bottom of the diamond test case.
    "base.yaml": "test-bindings-init/base.yaml",
    # Amended properties, aso left (first) "include:" in the diamond test case.
    "base_amend.yaml": "test-bindings-init/base_amend.yaml",
    # Amended properties, also right (last) "include:" in the diamond test case.
