...
class Node:
    ...
    parent: Incomplete
    dt: Incomplete
    def __init__(self, name: str, parent: Node | None, dt: DT, filename: str, lineno: int) -> None: ...
    @property
    def name(self) -> str: ...
    @property
    def lineno(self) -> int: ...
...
class DT:
    alias2node: Incomplete
    label2node: Incomplete
    label2prop: Incomplete
    label2prop_offset: Incomplete
    phandle2node: Incomplete
    memreserves: Incomplete
    filename: Incomplete
    def __init__(self, filename: str | None, include_path: Iterable[str] = (), force: bool = False, base_dir: str | None = None) -> None: ...
    @property
    def root(self) -> Node: ...
