...
def run():
    ...
    verify_streq(edt.get_dev("/binding-include").props,
                 "{'foo': <Property, name: foo, type: int, value: 0>, 'bar': <Property, name: bar, type: int, value: 1>, 'baz': <Property, name: baz, type: int, value: 2>}")
    ...
    verify_streq(edt.get_dev("/multicompat/node-1").binding_path,
                 "test-bindings/multicompat.yaml")

    verify_streq(edt.get_dev("/multicompat/node-2").binding_path,
                 "test-bindings/multicompat.yaml")
