...
class CmakeTemplate:
    ...
    empty_app_smem = (
        ...
        zephyr_linker_section_configure(section = section_name, symbols="_app_smem{partition}_start") +
        zephyr_linker_section_configure(section = section_name, symbols="_app_smem{partition}_end") )
