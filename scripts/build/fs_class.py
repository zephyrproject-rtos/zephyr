...
class Fs(ABC):
    ...
    def _find_newest_sector_id(self, sectors):
        ...
        for idx, elem in enumerate(sectors):
            ...
            if elem.status == FsSectorStatus.CLOSED and \
                next_elem.status == FsSectorStatus.OPEN:
    ...
    def _get_sectors_range(self, sectors):
        ...
        if additional_metadata["sectors_with_records_cnt"] == 1:
            ...
            sectors_range = (additional_metadata["first_sector_with_records_idx"], additional_metadata["first_sector_with_records_idx"] + 1)
        else:
