...
- Configure can device (can0 in this document).
- Run `./recv_can_log can0 7ff` to receive logs over can.
...
Example: ./recv_can_log can0 7ff 00000001
...
Known limitations
*****************
This tool can only listen to a single CAN bus.
To receive data from multiple buses, one instance per bus is required.
