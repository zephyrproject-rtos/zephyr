...
from gdbstubs.arch.arm_cortex_a_r import GdbStub_ARM_CortexAR
...
def get_gdbstub(logfile, elffile):
    ...
    elif tgt_code == TgtCode.ARM_CORTEX_A_R:
        stub = GdbStub_ARM_CortexAR(logfile=logfile, elffile=elffile)
