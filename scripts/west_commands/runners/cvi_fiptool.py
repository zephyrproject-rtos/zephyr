...
class CviFiptoolBinaryRunner(ZephyrBinaryRunner):
    ...
    def do_add_parser(cls, parser):
        parser.add_argument('--fiptool', required=True,
                            help='path to fiptool.py script from SDK')
        parser.add_argument('--fip-bin', required=True,
                            help='path to fip.bin file to be updated')
