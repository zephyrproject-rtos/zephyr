...
class SilabsRPSSigner(Signer):
    ...
    def get_security_configs(self, build_conf, args, command):
        ...
        if not siwx91x_ota_encrypt_key:
        ...
        return siwx91x_ota_encrypt_key, commander_path, siwx91x_ota_sign_key
    ...
    def sign(self, command, build_dir, build_conf, formats):
        ...
        # Load configuration
        siwx91x_ota_encrypt_key, commander_path, siwx91x_ota_sign_key = self.get_security_configs(build_conf, args, command)
        ...
        sign_base = [
            ...
            str(output_rps),
            "--app", str(input_rps),
            "--mic", siwx91x_ota_mic_key,
            "--encrypt", siwx91x_ota_encrypt_key,
            "--sign", siwx91x_ota_sign_key,
            *args.tool_args
        ]
