...
@patch('runners.mdb.MdbNsimBinaryRunner.check_call')
@patch('runners.core.ZephyrBinaryRunner.require', side_effect=require_patch)
def test_debug_nsim(require, cc, test_case, mdb_nsim):
...
@patch('runners.mdb.MdbNsimBinaryRunner.check_call')
@patch('runners.core.ZephyrBinaryRunner.require', side_effect=require_patch)
def test_multicores_nsim(require, cc, test_case, mdb_nsim):
...
@patch('runners.mdb.MdbHwBinaryRunner.check_call')
@patch('runners.core.ZephyrBinaryRunner.require', side_effect=require_patch)
def test_debug_hw(require, cc, test_case, mdb_hw):
...
@patch('runners.mdb.MdbHwBinaryRunner.check_call')
@patch('runners.core.ZephyrBinaryRunner.require', side_effect=require_patch)
def test_multicores_hw(require, cc, test_case, mdb_hw):
