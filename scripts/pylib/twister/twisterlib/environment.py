...
Artificially long but functional example:
   ...
   "kernel.fifo.poll" is one of the test section names in
    ...
    parser.add_argument("--device-rtt", action="store_true", default=False,
                        ...
                        Twister also only runs those test cases that set
                        ``CONFIG_SHELL_PROMPT_RTT`` or ``CONFIG_RTT_CONSOLE`` symbols,
                        others are filtered at runtime.
                        """)
