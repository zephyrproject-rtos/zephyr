...
def find_api_structures(content):
    ...
    """
    # print("find_api_structures -- Entry")
    # print(content)
    api_declarations = []
    ...
    for match in macro_start_pattern.finditer(content):
        ...
        var_name = match.group(2)
        start_pos = match.start()
        # print(f"driver_class: {driver_class}, var_name: {var_name}")
                ...
                if self.dt_drv_compats == []:
                    ...
                    for match in pattern.finditer(content):
                        ...
                        try:
                            ...
                            print(f"FileNotFoundError: {include_file}")
                        if self.dt_drv_compats != []:
                            print(f"dt_compats: {self.dt_drv_compats}")
                            break
    ...
    def load_zephyr_def(self, api_def):
        ...
        if len(api_def):
            try:
                ...
                # print(f"mandatory: {self.zephyr_api_def['mandatory_apis']}")
                self.apis = {
                ...
                # accordingly
                # print(f"optional_apis: {self.zephyr_api_def['optional_apis']}")
                ...
                # print(f"runtime_optional_apis: {self.zephyr_api_def['runtime_optional_apis']}")
                self.apis.update(
                    {
                        item: (item in self.api_structures[0]['api_functions'])
