...
if (!top_of_zephyr_tree($lk_path)) {
    die "$P: The current directory does not appear to be "
	. "a Zephyr source tree.\n";
}
...
Notes:
  ...
  File ".get_maintainer.conf", if it exists in the Zephyr source root
