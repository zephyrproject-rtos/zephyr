...
function(sysbuild_add_subdirectory source_dir)
  ...
  while(TRUE)
    ...
    foreach(image ${added_images})
      ...
      # Only include the images's sysbuild.cmake if it hasn't been included before
      if(NOT "${SOURCE_DIR}/sysbuild.cmake" IN_LIST ran_sysbuild_cmake_list)
        list(APPEND ran_sysbuild_cmake_list "${SOURCE_DIR}/sysbuild.cmake")
