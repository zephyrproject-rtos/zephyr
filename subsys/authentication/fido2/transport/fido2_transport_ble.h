...
/**
 * @brief Check whether a connection is the current security-ready FIDO Bluetooth LE connection.
 * @param conn Connection to check
 * @retval true  @p conn is ready for FIDO Bluetooth LE protocol traffic
