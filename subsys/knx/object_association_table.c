...
struct property object_association_table_properties[] = {
    ...
    KNX_PROP_SCALAR(PID_TABLE_REFERENCE, PDT_UNSIGNED_LONG, false, ReadLv3 | WriteLv0, &table_reference_associations),
    /*
    ...
    KNX_PROP_ARRAY(PID_TABLE, PDT_GENERIC_04, false, ReadLv3 | WriteLv0,
                   MAX_NUMBER_OF_ASSOCIATIONS, &__memory.associations[0], __memory.associations, true),
