...
struct property object_interface_program_properties[] = {
    ...
    KNX_PROP_SCALAR(PID_PROGRAM_VERSION, PDT_GENERIC_05, true, ReadLv3 | WriteLv3, &__memory.program_version_2),
    KNX_PROP_SCALAR(PID_PEI_TYPE, PDT_UNSIGNED_CHAR, false, ReadLv3 | WriteLv0, &_pei_type),
    KNX_PROP_SCALAR(PID_TABLE_REFERENCE, PDT_UNSIGNED_LONG, false, ReadLv3 | WriteLv0, &table_reference_interface_program),
