 ...
 */
bool load_state_machine_event(uint8_t object_index, const uint8_t *data,
                              uint8_t data_length);
...
void interface_read_property_description(
    uint8_t object_index,
    uint8_t property_id,
    uint8_t property_index,
    bool *write_enable,
    uint8_t *property_datatype,
    uint16_t *max_nr_of_elem,
    uint8_t *access,
    uint8_t *property_index_found);

uint8_t interface_read_property(
    uint8_t object_index,
 ...
 */
uint8_t interface_function_property_command(
    uint8_t object_index,
    uint8_t property_id,
 ...
 */
uint8_t interface_function_property_state_read(
    uint8_t object_index,
    uint8_t property_id,
    const uint8_t *data_in,
    uint8_t data_in_len,
