...
struct property address_table_properties[] = {
    ...
    KNX_PROP_SCALAR(PID_TABLE_REFERENCE, PDT_UNSIGNED_LONG, false, ReadLv3 | WriteLv0, &table_reference_addresses),
    KNX_PROP_ARRAY(PID_TABLE, PDT_UNSIGNED_INT, false, ReadLv3 | WriteLv0,
                   MAX_NUMBER_OF_ADDRESS_GROUP, &__memory.addresses[0], __memory.addresses, true),
