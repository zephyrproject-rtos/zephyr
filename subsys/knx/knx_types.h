...
typedef enum { l_ok = 0x0, l_not_ok = 0x1 } L_Status;
typedef enum { n_ok = 0x0, n_not_ok = 0x1 } N_Status;
typedef enum { t_ok = 0x0, t_not_ok = 0x1 } T_Status;
typedef enum { a_ok = 0x0, a_not_ok = 0x1 } A_Status;
