...
#ifdef CONFIG_SYS_POWER_STATE_CPU_LPS_0_SUPPORTED
	CONFIG_SYS_PM_LPS_0_MIN_RES * SECS_TO_TICKS,
#endif
...
#ifdef CONFIG_SYS_POWER_STATE_DEEP_SLEEP_0_SUPPORTED
	CONFIG_SYS_PM_DEEP_SLEEP_0_MIN_RES * SECS_TO_TICKS,
#endif
