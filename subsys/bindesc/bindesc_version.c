...
#if defined(CONFIG_BINDESC_MANIFEST_GIT_DESC)
BINDESC_STR_DEFINE(manifest_git_desc, BINDESC_ID_APP_MANIFEST_GIT_DESC,
		   STRINGIFY(APP_MANIFEST_GIT_DESC));
#endif /* CONFIG_BINDESC_MANIFEST_GIT_DESC */
