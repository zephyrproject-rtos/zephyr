...
struct mcs_instance_t {
	 ...
	 *                     (mpl_cmd.opcode + bt_mcp_cmd.param)
	...
	/* TODO: Rewrite the bt_mcp_cmd to have the "use_param" parameter */
	/* separately, and the opcode and param alone as a struct */
	char write_buf[sizeof(((struct bt_mcp_cmd *)0)->opcode) +
		       sizeof(((struct bt_mcp_cmd *)0)->param)];
#endif /* CONFIG_BT_MCC_OTS */
