...
LOG_MODULE_REGISTER(bt_ccp_server, CONFIG_BT_CCP_SERVER_LOG_LEVEL);
...
static struct bt_ccp_server_bearer *get_free_bearer(void)
{
...
{
	struct bt_ccp_server_bearer *free_bearer;
	int ret;
