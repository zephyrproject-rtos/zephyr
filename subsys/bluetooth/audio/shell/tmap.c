...
SHELL_STATIC_SUBCMD_SET_CREATE(tmap_cmds, SHELL_CMD_ARG(init, NULL, HELP_NONE, cmd_tmap_init, 1, 0),
			       SHELL_CMD_ARG(discover, NULL, HELP_NONE, cmd_tmap_discover, 1, 0),
