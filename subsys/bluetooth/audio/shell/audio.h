...
#define BAP_UNICAST_AC_MAX_PAIR   GENERIC_MAX(BAP_UNICAST_AC_MAX_SNK, BAP_UNICAST_AC_MAX_SRC)
...
extern struct shell_stream unicast_streams[CONFIG_BT_MAX_CONN * GENERIC_MAX(
