...
#define PA_SYNC_IDX_NONE 0xFF
BUILD_ASSERT(PA_SYNC_IDX_NONE > ARRAY_SIZE(per_adv_syncs));
...
struct scan_delegator_sync_state {
	...
	bool past_avail;
	uint8_t src_id;
	uint8_t pa_sync_idx; /* index to per_adv_syncs - PA_SYNC_IDX_NONE if not set */
