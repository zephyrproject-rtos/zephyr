...
static inline const char *bt_hfp_technology_str(uint8_t status)
{
	switch (status) {
	case BT_HFP_TECHNOLOGY_3G:
		return "3G";
	case BT_HFP_TECHNOLOGY_4G:
		return "4G";
	case BT_HFP_TECHNOLOGY_LTE:
		return "LTE";
	case BT_HFP_TECHNOLOGY_WIFI:
		return "WIFI";
	case BT_HFP_TECHNOLOGY_5G:
		return "5G";
	case BT_HFP_TECHNOLOGY_GSM:
		return "GSM";
	case BT_HFP_TECHNOLOGY_CDMA:
		return "CDMA";
	case BT_HFP_TECHNOLOGY_2G:
		return "2G";
	case BT_HFP_TECHNOLOGY_WCDMA:
		return "WCDMA";
	default:
