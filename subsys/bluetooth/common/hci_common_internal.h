 ...
 */
#define BT_BUF_HCI_ACL_RX_COUNT          (BT_BUF_ACL_RX_COUNT - BT_BUF_ACL_RX_COUNT_EXTRA)
...
/* Based on Host + Controller, Host-only or Controller-only */
