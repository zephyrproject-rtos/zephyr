...
#define BT_MESH_BLOB_OP_XFER_GET_RAW     BT_MESH_MODEL_OP_SIG(0x83, 0x00)
#define BT_MESH_BLOB_OP_XFER_GET         BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_XFER_GET_RAW)
#define BT_MESH_BLOB_OP_XFER_START_RAW   BT_MESH_MODEL_OP_SIG(0x83, 0x01)
#define BT_MESH_BLOB_OP_XFER_START       BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_XFER_START_RAW)
#define BT_MESH_BLOB_OP_XFER_CANCEL_RAW  BT_MESH_MODEL_OP_SIG(0x83, 0x02)
#define BT_MESH_BLOB_OP_XFER_CANCEL      BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_XFER_CANCEL_RAW)
#define BT_MESH_BLOB_OP_XFER_STATUS_RAW  BT_MESH_MODEL_OP_SIG(0x83, 0x03)
#define BT_MESH_BLOB_OP_XFER_STATUS      BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_XFER_STATUS_RAW)
#define BT_MESH_BLOB_OP_BLOCK_GET_RAW    BT_MESH_MODEL_OP_SIG(0x83, 0x05)
#define BT_MESH_BLOB_OP_BLOCK_GET        BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_BLOCK_GET_RAW)
#define BT_MESH_BLOB_OP_BLOCK_START_RAW  BT_MESH_MODEL_OP_SIG(0x83, 0x04)
#define BT_MESH_BLOB_OP_BLOCK_START      BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_BLOCK_START_RAW)
#define BT_MESH_BLOB_OP_CHUNK_RAW        BT_MESH_MODEL_OP_SIG(0x66)
#define BT_MESH_BLOB_OP_CHUNK            BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_CHUNK_RAW)
#define BT_MESH_BLOB_OP_BLOCK_STATUS_RAW BT_MESH_MODEL_OP_SIG(0x67)
#define BT_MESH_BLOB_OP_BLOCK_STATUS     BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_BLOCK_STATUS_RAW)
#define BT_MESH_BLOB_OP_BLOCK_REPORT_RAW BT_MESH_MODEL_OP_SIG(0x68)
#define BT_MESH_BLOB_OP_BLOCK_REPORT     BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_BLOCK_REPORT_RAW)
#define BT_MESH_BLOB_OP_INFO_GET_RAW     BT_MESH_MODEL_OP_SIG(0x83, 0x06)
#define BT_MESH_BLOB_OP_INFO_GET         BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_INFO_GET_RAW)
#define BT_MESH_BLOB_OP_INFO_STATUS_RAW  BT_MESH_MODEL_OP_SIG(0x83, 0x07)
#define BT_MESH_BLOB_OP_INFO_STATUS      BT_MESH_MODEL_OPCODE(BT_MESH_BLOB_OP_INFO_STATUS_RAW)
