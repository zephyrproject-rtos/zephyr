...
#define OP_DIRECTED_CTL_GET		   BT_MESH_MODEL_OP_2(0x80, 0x7b)
#define OP_DIRECTED_CTL_SET		   BT_MESH_MODEL_OP_2(0x80, 0x7c)
#define OP_DIRECTED_CTL_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x7d)
#define OP_PATH_METRIC_GET		   BT_MESH_MODEL_OP_2(0x80, 0x7e)
#define OP_PATH_METRIC_SET		   BT_MESH_MODEL_OP_2(0x80, 0x7f)
#define OP_PATH_METRIC_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x80)
#define OP_DISCOV_CAP_GET		   BT_MESH_MODEL_OP_2(0x80, 0x81)
#define OP_DISCOV_CAP_SET		   BT_MESH_MODEL_OP_2(0x80, 0x82)
#define OP_DISCOV_CAP_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x83)
#define OP_FW_TABLE_ADD			   BT_MESH_MODEL_OP_2(0x80, 0x84)
#define OP_FW_TABLE_DEL			   BT_MESH_MODEL_OP_2(0x80, 0x85)
#define OP_FW_TABLE_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x86)
#define OP_FW_TABLE_DEP_ADD		   BT_MESH_MODEL_OP_2(0x80, 0x87)
#define OP_FW_TABLE_DEP_DEL		   BT_MESH_MODEL_OP_2(0x80, 0x88)
#define OP_FW_TABLE_DEP_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x89)
#define OP_FW_TABLE_DEP_GET		   BT_MESH_MODEL_OP_2(0x80, 0x8a)
#define OP_FW_TABLE_DEP_GET_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0x8b)
#define OP_FW_TABLE_ENT_COUNT_GET	   BT_MESH_MODEL_OP_2(0x80, 0x8c)
#define OP_FW_TABLE_ENT_COUNT_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0x8d)
#define OP_FW_TABLE_ENT_GET		   BT_MESH_MODEL_OP_2(0x80, 0x8e)
#define OP_FW_TABLE_ENT_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x8f)
#define OP_WANTED_LANES_GET		   BT_MESH_MODEL_OP_2(0x80, 0x90)
#define OP_WANTED_LANES_SET		   BT_MESH_MODEL_OP_2(0x80, 0x91)
#define OP_WANTED_LANES_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x92)
#define OP_TWO_WAY_PATH_GET		   BT_MESH_MODEL_OP_2(0x80, 0x93)
#define OP_TWO_WAY_PATH_SET		   BT_MESH_MODEL_OP_2(0x80, 0x94)
#define OP_TWO_WAY_PATH_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0x95)
#define OP_PATH_ECHO_INTV_GET		   BT_MESH_MODEL_OP_2(0x80, 0x96)
#define OP_PATH_ECHO_INTV_SET		   BT_MESH_MODEL_OP_2(0x80, 0x97)
#define OP_PATH_ECHO_INTV_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0x98)
#define OP_DIRECTED_NET_TRANSMIT_GET	   BT_MESH_MODEL_OP_2(0x80, 0x99)
#define OP_DIRECTED_NET_TRANSMIT_SET	   BT_MESH_MODEL_OP_2(0x80, 0x9a)
#define OP_DIRECTED_NET_TRANSMIT_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0x9b)
#define OP_DIRECTED_RELAY_RETRANS_GET	   BT_MESH_MODEL_OP_2(0x80, 0x9c)
#define OP_DIRECTED_RELAY_RETRANS_SET	   BT_MESH_MODEL_OP_2(0x80, 0x9d)
#define OP_DIRECTED_RELAY_RETRANS_STATUS   BT_MESH_MODEL_OP_2(0x80, 0x9e)
#define OP_RSSI_THRESHOLD_GET		   BT_MESH_MODEL_OP_2(0x80, 0x9f)
#define OP_RSSI_THRESHOLD_SET		   BT_MESH_MODEL_OP_2(0x80, 0xa0)
#define OP_RSSI_THRESHOLD_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0xa1)
#define OP_DIRECTED_PATH_GET		   BT_MESH_MODEL_OP_2(0x80, 0xa2)
#define OP_DIRECTED_PATH_STATUS		   BT_MESH_MODEL_OP_2(0x80, 0xa3)
#define OP_DIRECTED_PUB_POLICY_GET	   BT_MESH_MODEL_OP_2(0x80, 0xa4)
#define OP_DIRECTED_PUB_POLICY_SET	   BT_MESH_MODEL_OP_2(0x80, 0xa5)
#define OP_DIRECTED_PUB_POLICY_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0xa6)
#define OP_PATH_DISCOV_TIM_CTL_GET	   BT_MESH_MODEL_OP_2(0x80, 0xa7)
#define OP_PATH_DISCOV_TIM_CTL_SET	   BT_MESH_MODEL_OP_2(0x80, 0xa8)
#define OP_PATH_DISCOV_TIM_CTL_STATUS	   BT_MESH_MODEL_OP_2(0x80, 0xa9)
#define OP_DIRECTED_CTL_NET_TRANS_GET	   BT_MESH_MODEL_OP_2(0x80, 0xab)
#define OP_DIRECTED_CTL_NET_TRANS_SET	   BT_MESH_MODEL_OP_2(0x80, 0xac)
#define OP_DIRECTED_CTL_NET_TRANS_STATUS   BT_MESH_MODEL_OP_2(0x80, 0xad)
#define OP_DIRECTED_CTL_RELAY_RETRANS_GET  BT_MESH_MODEL_OP_2(0x80, 0xae)
#define OP_DIRECTED_CTL_RELAY_RETRANS_SET  BT_MESH_MODEL_OP_2(0x80, 0xaf)
#define OP_DIRECTED_CTL_RELAY_RETRANS_STATUS BT_MESH_MODEL_OP_2(0x80, 0xb0)
