...
int bt_mesh_brg_cfg_cli_subnet_bridge_get(uint16_t net_idx, uint16_t addr, uint8_t *status)
{
	return 0;
}

int bt_mesh_brg_cfg_cli_subnet_bridge_set(uint16_t net_idx, uint16_t addr, uint8_t val,
					  uint8_t *status)
{
	return 0;
}
