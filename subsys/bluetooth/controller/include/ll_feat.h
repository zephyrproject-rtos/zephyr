 ...
 */
#define LL_LENGTH_OCTETS_TX_MAX GENERIC_MIN(CONFIG_BT_BUF_ACL_TX_SIZE, 251U)
...
#define BT_CTLR_ISO_TX_BUFFER_SIZE GENERIC_MIN((CONFIG_BT_ISO_TX_MTU + \
						BT_HCI_ISO_SDU_TS_HDR_SIZE), \
						GENERIC_MAX(CONFIG_BT_CTLR_ISO_TX_BUFFER_SIZE, \
							    (BT_HCI_ISO_SDU_TS_HDR_SIZE + 1U)))
#else
#define BT_CTLR_ISO_TX_BUFFER_SIZE GENERIC_MAX(CONFIG_BT_CTLR_ISO_TX_BUFFER_SIZE, \
					       (BT_HCI_ISO_SDU_TS_HDR_SIZE + 1U))
...
#define LL_CIS_OCTETS_TX_MAX GENERIC_MIN(CONFIG_BT_CTLR_CONN_ISO_PDU_LEN_MAX, \
...
#define LL_BIS_OCTETS_TX_MAX GENERIC_MIN(CONFIG_BT_CTLR_ADV_ISO_PDU_LEN_MAX, \
					 (BT_CTLR_ISO_TX_BUFFER_SIZE - \
					  BT_HCI_ISO_SDU_TS_HDR_SIZE))
