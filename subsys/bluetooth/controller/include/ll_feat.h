...
#define LL_FEAT_BIT_PERIP_FEAT_REQ BIT64(BT_LE_FEAT_BIT_SLAVE_FEAT_REQ)
#else /* !CONFIG_BT_CTLR_PERIP_FEAT_REQ */
#define LL_FEAT_BIT_PERIP_FEAT_REQ 0
