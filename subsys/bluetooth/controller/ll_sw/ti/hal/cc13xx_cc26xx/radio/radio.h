...
#define TI_DOES_NOT_SUPPORT_GENERIC_PDU_TX_SO_THIS_PDU_IS_UNSPEC 0
#define TI_DOES_NOT_SUPPORT_GENERIC_PDU_TX_SO_THIS_PDU_IS_ADV 1
#define TI_DOES_NOT_SUPPORT_GENERIC_PDU_TX_SO_THIS_PDU_IS_DATA 2

typedef void (*radio_isr_cb_t)(void *param);

void isr_radio(void *arg);
#define radio_isr_set(cb, param)                                               \
	__radio_isr_set(__FILE__, __func__, __LINE__, #cb, cb, param)
...
u8_t radio_adv_chan_map_get(void);
void radio_adv_chan_map_set(u8_t map);
