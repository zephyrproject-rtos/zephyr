...
static void cis_lazy_get(struct ll_conn_iso_stream *cis);
static void mfy_cis_lazy_get(void *param);
...
{
	static memq_link_t link;
	static struct mayfly mfy = {0, 0, &link, NULL, mfy_cis_lazy_get};
	uint32_t ret;
