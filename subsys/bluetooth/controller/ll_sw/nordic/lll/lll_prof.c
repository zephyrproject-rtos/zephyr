...
#define LLL_PROF_ULL_HIGH_MAX_US 245 /* Max. Radio + LLL + ULL High, O(1) */
#define LLL_PROF_ULL_LOW_MAX_US  550 /* Max. ULL Low, O(n) n is ticker nodes */
#elif defined(CONFIG_SOC_COMPATIBLE_NRF54LX)
#define LLL_PROF_RADIO_MAX_US    92  /* Max. Radio Rx/Tx ISR, O(1)*/
#define LLL_PROF_LLL_MAX_US      62  /* Max. LLL prepare, O(1) */
...
#define LLL_PROF_ULL_LOW_MAX_US  1191 /* Max. ULL Low, O(n) n is ticker nodes */
