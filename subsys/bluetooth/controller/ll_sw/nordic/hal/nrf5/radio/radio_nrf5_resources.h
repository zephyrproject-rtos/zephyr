...
#define HAL_EVENT_TIMER_DEFERRED_TRX_CC_OFFSET   3
#define HAL_EVENT_TIMER_DEFERRED_TX_EVENT        NRF_TIMER_EVENT_COMPARE3
#define HAL_EVENT_TIMER_INTENSET_DEFERRED_TX_Msk TIMER_INTENSET_COMPARE3_Msk
