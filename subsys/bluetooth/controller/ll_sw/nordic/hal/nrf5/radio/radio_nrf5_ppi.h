 ...
 * PDU do not include CTE after CRC, the EVENTS_PHYEND will be generated with a short delay.
 * That influences maintenance of TISF by software switch. To address the issue additional
 ...
 * In case there is a CTEInfo in the received PDU, a EVENTS_CTEPRESENT will be generated by
 ...
 */
static inline void
hal_radio_sw_switch_phyend_delay_compensation_config_set(uint8_t phyend_delay_cc,
							 uint8_t radio_enable_ppi)
{
