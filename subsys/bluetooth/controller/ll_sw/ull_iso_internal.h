 ...
 */
#define BT_CTLR_ISO_TX_SDU_LEN_MAX GENERIC_MIN(((CONFIG_BT_CTLR_ISO_TX_BUFFER_SIZE * \
...
#define BT_CTLR_ISO_TX_MIN_PDU_LEN \
	GENERIC_MIN(COND_CODE_1(IS_ENABLED(CONFIG_BT_CTLR_ADV_ISO), \
...
#define BT_CTLR_ISO_TX_PDU_BUFFERS \
	(DIV_ROUND_UP(BT_CTLR_ISO_TX_SDU_LEN_MAX, \
		      GENERIC_MIN((CONFIG_BT_CTLR_ISO_TX_BUFFER_SIZE - \
