...
#define BT_CTLR_MAX_CONNECTABLE (1U + GENERIC_MIN(((CONFIG_BT_MAX_CONN) - 1U), \
						  (BT_CTLR_ADV_SET)))
#else
#define BT_CTLR_MAX_CONNECTABLE GENERIC_MAX(1U, (BT_CTLR_ADV_SET))
#endif
...
#define PDU_ADV_SIZE  GENERIC_MAX(PDU_AC_LL_SIZE_MAX, \
...
#define PDU_RX_NODE_POOL_ELEMENT_SIZE MROUND(NODE_RX_HEADER_SIZE + \
					     GENERIC_MAX(GENERIC_MAX(PDU_ADV_SIZE, \
						     GENERIC_MAX(PDU_DATA_SIZE, \
							 PDU_CTRL_SIZE)), \
