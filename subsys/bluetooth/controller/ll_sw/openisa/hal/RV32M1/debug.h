...
#define DEBUG_INIT() \
	do { \
		...
		\
		gpio_pin_set_raw(DEBUG0_PORT, DEBUG0_PIN, 1); \
		gpio_pin_set_raw(DEBUG0_PORT, DEBUG0_PIN, 0); \
	} while (0)

#define DEBUG_CPU_SLEEP(flag) gpio_pin_set_raw(DEBUG0_PORT, DEBUG0_PIN, flag)

#define DEBUG_TICKER_ISR(flag) gpio_pin_set_raw(DEBUG1_PORT, DEBUG1_PIN, flag)

#define DEBUG_TICKER_TASK(flag) gpio_pin_set_raw(DEBUG1_PORT, DEBUG1_PIN, flag)

#define DEBUG_TICKER_JOB(flag) gpio_pin_set_raw(DEBUG2_PORT, DEBUG2_PIN, flag)

#define DEBUG_RADIO_ISR(flag) gpio_pin_set_raw(DEBUG7_PORT, DEBUG7_PIN, flag)

#define DEBUG_RADIO_XTAL(flag) gpio_pin_set_raw(DEBUG8_PORT, DEBUG8_PIN, flag)

#define DEBUG_RADIO_ACTIVE(flag) gpio_pin_set_raw(DEBUG9_PORT, DEBUG9_PIN, flag)

#define DEBUG_RADIO_CLOSE(flag) \
	do { \
		if (!flag) { \
			gpio_pin_set_raw(DEBUG3_PORT, DEBUG3_PIN, flag); \
			gpio_pin_set_raw(DEBUG4_PORT, DEBUG4_PIN, flag); \
			gpio_pin_set_raw(DEBUG5_PORT, DEBUG5_PIN, flag); \
			gpio_pin_set_raw(DEBUG6_PORT, DEBUG6_PIN, flag); \
		} \
	} while (0)
