...
LLL_CHAN_METRICS void lll_chan_metrics_chan_set(uint8_t chan);
LLL_CHAN_METRICS void lll_chan_metrics_chan_bad(void);
LLL_CHAN_METRICS void lll_chan_metrics_chan_good(void);
