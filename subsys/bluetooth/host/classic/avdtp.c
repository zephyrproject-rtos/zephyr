...
static struct bt_avdtp_service_category_handler category_handler[]  = {
	{0, 0, 0, 0, NULL},                                  /*None*/
	{0, 0, 0, BT_AVDTP_BAD_MEDIA_TRANSPORT_FORMAT, NULL},/*BT_AVDTP_SERVICE_MEDIA_TRANSPORT*/
	{0, 0, 0, BT_AVDTP_BAD_LENGTH, NULL},                /*BT_AVDTP_SERVICE_REPORTING*/
	{sizeof(struct bt_avdtp_recovery_capabilities),
	 sizeof(struct bt_avdtp_recovery_capabilities),      /*BT_AVDTP_SERVICE_MEDIA_RECOVERY*/
	 0, BT_AVDTP_BAD_RECOVERY_FORMAT, bt_avdtp_check_media_recovery_type},
	{sizeof(struct bt_avdtp_content_protection_capabilities), UINT8_MAX,
	 1, BT_AVDTP_BAD_CP_FORMAT, NULL},                /*BT_AVDTP_SERVICE_CONTENT_PROTECTION*/
	{sizeof(struct bt_avdtp_header_compression_capabilities),
	 sizeof(struct bt_avdtp_header_compression_capabilities),
	 0, BT_AVDTP_BAD_LENGTH, NULL},                   /*BT_AVDTP_SERVICE_HEADER_COMPRESSION*/
	{sizeof(struct bt_avdtp_multiplexing_capabilities),
	 sizeof(struct bt_avdtp_multiplexing_capabilities),/*BT_AVDTP_SERVICE_MULTIPLEXING*/
	 0, BT_AVDTP_BAD_MULTIPLEXING_FORMAT, NULL},
	{sizeof(struct bt_avdtp_media_codec_capabilities), UINT8_MAX,
	 1, BT_AVDTP_BAD_LENGTH, NULL},                   /*BT_AVDTP_SERVICE_MEDIA_CODEC*/
