...
/*
 * The array size of `bt_l2cap_br_meta` should be the same as the buffer count of buffer pool
 * `br_sig_pool`.
 */
#define L2CAP_BR_BUFFER_COUNT CONFIG_BT_MAX_CONN
...
struct bt_l2cap_br_meta {
	...
	uint8_t flags;
	struct k_work work;
} bt_l2cap_br_meta[L2CAP_BR_BUFFER_COUNT];
...
NET_BUF_POOL_FIXED_DEFINE(br_sig_pool, L2CAP_BR_BUFFER_COUNT,
