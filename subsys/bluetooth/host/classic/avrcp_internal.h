...
#define AVRCP_CT_COVER_ART_GET_IMAGE_PROPERTIES_ENABLE AVRCP_CT_COVER_ART_GET_IMAGE_PROPERTIES
#else
#define AVRCP_CT_COVER_ART_GET_IMAGE_PROPERTIES_ENABLE 0
#endif /* CONFIG_BT_AVRCP_CT_COVER_ART_GET_IMAGE_PROPERTIES */

#if defined(CONFIG_BT_AVRCP_CT_COVER_ART_GET_IMAGE)
#define AVRCP_CT_COVER_ART_GET_IMAGE_ENABLE AVRCP_CT_COVER_ART_GET_IMAGE
#else
#define AVRCP_CT_COVER_ART_GET_IMAGE_ENABLE 0
#endif /* CONFIG_BT_AVRCP_CT_COVER_ART_GET_IMAGE */

#if defined(CONFIG_BT_AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL)
#define AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL_ENABLE AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL
#else
#define AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL_ENABLE 0
#endif /* CONFIG_BT_AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL */

#define AVRCP_CT_COVER_ART_ENABLE \
	(AVRCP_CT_COVER_ART_GET_IMAGE_PROPERTIES_ENABLE | \
	 AVRCP_CT_COVER_ART_GET_IMAGE_ENABLE | \
	 AVRCP_CT_COVER_ART_GET_LINKED_THUMBNAIL_ENABLE)
