...
static const struct {
	...
	{BT_PBAP_PULL_PHONE_BOOK_TYPE, bt_pbap_pce_pull_phonebook},
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(pull_vcard_listing, NULL, "<name> [srmp(0/1)]", cmd_pull_vcard_listing, 2, 1),
	SHELL_CMD_ARG(pull_vcard_entry, NULL, "<name> [srmp(0/1)]", cmd_pull_vcard_entry, 2, 1),
