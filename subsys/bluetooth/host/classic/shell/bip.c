...
static int cmd_bip_client_put_image(const struct shell *sh, size_t argc, char *argv[])
{
	...
	err = bt_obex_add_header_body_or_end_body(bip_app.tx_buf, bip_app.client._client.tx.mopl,
...
static int cmd_bip_server_get_caps(const struct shell *sh, size_t argc, char *argv[])
{
	...
	err = bt_obex_add_header_body_or_end_body(bip_app.tx_buf, bip_app.server._server.tx.mopl,
