...
void bt_hci_le_cs_read_remote_supported_capabilities_complete(struct net_buf *buf)
{
	...
	remote_cs_capabilities.num_config_supported =
	...
	remote_cs_capabilities.num_antennas_supported =
	...
	remote_cs_capabilities.subfeatures_supported = sys_le16_to_cpu(evt->subfeatures_supported);
