...
static K_KERNEL_STACK_DEFINE(acl_tx_thread_stack, CONFIG_BT_HCI_TX_STACK_SIZE);
#endif

static struct k_thread cmd_tx_thread_data;
static K_KERNEL_STACK_DEFINE(cmd_tx_thread_stack, CONFIG_BT_HCI_TX_STACK_SIZE);
...
#define EV_COUNT (1 + CONFIG_BT_MAX_CONN + CONFIG_BT_MAX_ISO_CONN)
#else
