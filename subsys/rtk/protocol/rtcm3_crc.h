...
#ifndef _ZEPHYR_SUBSYS_RTK_PROTOCOL_RTCM3_CRC_H_
#define _ZEPHYR_SUBSYS_RTK_PROTOCOL_RTCM3_CRC_H_
 ...
 */
static inline uint32_t rtcm3_crc24q(const uint8_t *data, const uint32_t size)
{
	uint32_t crc = 0;
...
#endif /* _ZEPHYR_SUBSYS_RTK_PROTOCOL_RTCM3_CRC_H_ */
