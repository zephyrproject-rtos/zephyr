...
#define BASE_SERVICE_INSTANCE_NAME CONFIG_OPENTHREAD_ZEPHYR_BORDER_ROUTER_BASE_SERVICE_NAME
#define MODEL_NAME		   CONFIG_OPENTHREAD_ZEPHYR_BORDER_ROUTER_MODEL_NAME

extern char base_service_instance_name[], vendor_name[], model_name[];
