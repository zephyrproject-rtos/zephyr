...
static void ail_connection_handler(uint64_t mgmt_event, struct net_if *iface __unused,
...
static void ail_ipv6_address_event_handler(uint64_t mgmt_event, struct net_if *iface __unused,
					   void *info __unused, size_t info_length __unused,
					   void *user_data __unused)
{
...
#if defined(CONFIG_OPENTHREAD_ZEPHYR_BORDER_ROUTER_IPV4)
static void ail_ipv4_address_event_handler(uint64_t mgmt_event, struct net_if *iface __unused,
					   void *info __unused, size_t info_length __unused,
					   void *user_data __unused)
{
	if (net_if_l2(iface) != &NET_L2_GET_NAME(ETHERNET)) {
