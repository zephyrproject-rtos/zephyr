...
static void gptp_mi_port_announce_information_state_machine(int port)
{
	...
	case GPTP_PA_INFO_SUPERIOR_MASTER_PORT:
		 ...
		 * priority vector without using an intermediate messagePrioriry
		 * structure.
		 */
