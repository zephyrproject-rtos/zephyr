...
#if CONFIG_NET_PKT_BUF_RX_COUNT <= 0
#error "Minimum value for CONFIG_NET_PKT_BUF_RX_COUNT is 1"
#endif

#if CONFIG_NET_PKT_BUF_TX_COUNT <= 0
#error "Minimum value for CONFIG_NET_PKT_BUF_TX_COUNT is 1"
#endif
...
NET_BUF_POOL_VAR_DEFINE(rx_bufs, CONFIG_NET_PKT_BUF_RX_COUNT, CONFIG_NET_PKT_BUF_DATA_POOL_SIZE,
			CONFIG_NET_PKT_BUF_USER_DATA_SIZE, NULL);
NET_BUF_POOL_VAR_DEFINE(tx_bufs, CONFIG_NET_PKT_BUF_TX_COUNT, CONFIG_NET_PKT_BUF_DATA_POOL_SIZE,
			CONFIG_NET_PKT_BUF_USER_DATA_SIZE, NULL);
