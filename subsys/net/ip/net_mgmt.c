...
NET_BMEM static struct mgmt_event_entry
				events[CONFIG_NET_MGMT_EVENT_QUEUE_SIZE];
NET_BMEM static u32_t global_event_mask;
NET_BMEM static sys_slist_t event_callbacks;
NET_BMEM static s16_t in_event;
NET_BMEM static s16_t out_event;
