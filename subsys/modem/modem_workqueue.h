...
#ifndef ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_WORKQUEUE_H_
#define ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_WORKQUEUE_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_WORKQUEUE_H_ */
