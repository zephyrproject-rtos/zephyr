...
SHELL_STATIC_SUBCMD_SET_CREATE(device_cmds,
	SHELL_CMD_ARG(pid, NULL,
		      SHELL_HELP("Set device's Product ID", "<idProduct>"),
		      cmd_device_pid, 2, 0),
	SHELL_CMD_ARG(vid, NULL,
		      SHELL_HELP("Set device's Vendor ID", "<idVendor>"),
		      cmd_device_vid, 2, 0),
	SHELL_CMD_ARG(bcd_usb, &dsub_config_speed,
		      SHELL_HELP("Set device's USB specification version", "<speed> <bcdUSB>"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(class_cmds,
	SHELL_CMD_ARG(register, &dsub_node_name,
		      SHELL_HELP("Register class instance", "<name> <speed> <config>"),
		      cmd_register, 4, 0),
	SHELL_CMD_ARG(unregister, &dsub_node_name,
		      SHELL_HELP("Unregister class instance", "<name> <speed> <config>"),
		      cmd_unregister, 4, 0),
	SHELL_SUBCMD_SET_END
);
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_usbd_cmds,
	SHELL_CMD_ARG(defstr, NULL,
		      SHELL_HELP("Add default string descriptors", NULL),
		      cmd_usbd_default_strings, 1, 0),
	SHELL_CMD_ARG(defcfg, NULL,
		      SHELL_HELP("Initialize default configuration with all classes", NULL),
		      cmd_usbd_default_config, 1, 0),
	SHELL_CMD_ARG(init, NULL,
		      SHELL_HELP("Initialize USB device support", NULL),
		      cmd_usbd_init, 1, 0),
	SHELL_CMD_ARG(enable, NULL,
		      SHELL_HELP("Enable USB device support", NULL),
		      cmd_usbd_enable, 1, 0),
	SHELL_CMD_ARG(disable, NULL,
		      SHELL_HELP("Disable USB device support", NULL),
	...
	SHELL_CMD_ARG(select, &dsub_context_name,
		      SHELL_HELP("Select USB device context", "<context name>"),
		      cmd_select, 2, 0),
	...
	SHELL_CMD_ARG(wakeup, NULL,
		      SHELL_HELP("Signal remote wakeup", NULL),
