 ...
 * for the in-three boards in the Zephyr project.
 */
...
static int rf_cb(void *const priv,
...
static int wf_cb(void *const priv,
		 const uint32_t block, const uint16_t size,
...
USBD_DFU_DEFINE_IMG(slot0_image, "slot0_image", &slot0_data, rf_cb, wf_cb, next_cb);
#endif
...
USBD_DFU_DEFINE_IMG(slot1_image, "slot1_image", &slot1_data, rf_cb, wf_cb, next_cb);
#endif
