...
static const void *usbtmc_get_desc(struct usbd_class_data *const c_data,
...
static const struct usbd_class_api usbtmc_api = {
...
static struct usbd_usbtmc_desc usbtmc_desc_##n = {				\
	...
	.nil_desc = {								\
		...
		.bDescriptorType = 0,						\
										...
										\
const static struct usb_desc_header *const usbtmc_fs_desc_##n[] = {		\
	...
	(struct usb_desc_header *) &usbtmc_desc_##n.nil_desc,			\
										...
										\
IF_ENABLED(USBD_SUPPORTS_HIGH_SPEED, (						\
const static struct usb_desc_header *const usbtmc_hs_desc_##n[] = {		\
	(struct usb_desc_header *) &usbtmc_desc_##n.if0,			\
