...
struct loopback_desc {
	...
	struct usb_co_descriptor if0_ss_out_co;
	struct usb_ep_descriptor if0_ss_in_ep;
	struct usb_co_descriptor if0_ss_in_co;
	...
	struct usb_co_descriptor if1_int_ss_out_co;
	struct usb_ep_descriptor if1_int_ss_in_ep;
	struct usb_co_descriptor if1_int_ss_in_co;
	...
	struct usb_co_descriptor if2_0_iso_ss_in_co;
	struct usb_ep_descriptor if2_0_iso_ss_out_ep;
	struct usb_co_descriptor if2_0_iso_ss_out_co;
	...
	struct usb_co_descriptor if2_1_iso_ss_in_co;
	struct usb_ep_descriptor if2_1_iso_ss_out_ep;
	struct usb_co_descriptor if2_1_iso_ss_out_co;
...
const static struct usb_desc_header *lb_ss_desc_##x[] = {			\
	...
	(struct usb_desc_header *) &lb_desc_##x.if1_int_ss_in_co,		\
	(struct usb_desc_header *) &lb_desc_##x.if1_int_ss_out_ep,		\
	(struct usb_desc_header *) &lb_desc_##x.if1_int_ss_out_co,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_0,				\
	(struct usb_desc_header *) &lb_desc_##x.if2_0_iso_ss_in_ep,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_0_iso_ss_in_co,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_0_iso_ss_out_ep,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_0_iso_ss_out_co,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_1,				\
	(struct usb_desc_header *) &lb_desc_##x.if2_1_iso_ss_in_ep,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_1_iso_ss_in_co,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_1_iso_ss_out_ep,		\
	(struct usb_desc_header *) &lb_desc_##x.if2_1_iso_ss_out_co,		\
	(struct usb_desc_header *) &lb_desc_##x.nil_desc,			\
};
