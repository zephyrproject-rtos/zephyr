...
#define USBH_SHELL_UHC_NODE DT_CHOSEN(zephyr_uhc)
#else
#define USBH_SHELL_UHC_NODE DT_NODELABEL(zephyr_uhc0)
#endif

USBH_CONTROLLER_DEFINE(uhs_ctx, DEVICE_DT_GET(USBH_SHELL_UHC_NODE));
