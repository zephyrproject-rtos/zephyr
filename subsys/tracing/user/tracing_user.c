...
void __weak sys_trace_gpio_pin_configured_output_user(const struct device *port, gpio_pin_t pin,
						      gpio_flags_t flags) {}
void __weak sys_trace_gpio_pin_configured_input_user(const struct device *port, gpio_pin_t pin,
						     gpio_flags_t flags) {}
void __weak sys_trace_gpio_pin_event_attached_user(const struct device *port,
						   struct gpio_callback *callback) {}
void __weak sys_trace_gpio_pin_event_removed_user(const struct device *port,
						  struct gpio_callback *callback) {}
void __weak sys_trace_gpio_pin_event_executed_user(const struct device *port,
						   struct gpio_callback *callback) {}
