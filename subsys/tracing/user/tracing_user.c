...
void __weak sys_trace_k_work_submit_to_queue_enter(struct k_work_q *queue, struct k_work *work) {}
void __weak sys_trace_k_work_submit_to_queue_exit(struct k_work_q *queue, struct k_work *work, int ret) {}
...
void __weak sys_trace_k_work_cancel_sync_enter(struct k_work *work, struct k_work_sync *sync) {}
void __weak sys_trace_k_work_cancel_sync_blocking(struct k_work *work, struct k_work_sync *sync) {}
void __weak sys_trace_k_work_cancel_sync_exit(struct k_work *work, struct k_work_sync *sync, bool ret) {}
...
void __weak sys_trace_k_work_queue_stop_blocking(struct k_work_q *queue, k_timeout_t timeout) {}
void __weak sys_trace_k_work_queue_stop_exit(struct k_work_q *queue, k_timeout_t timeout, int ret) {}
...
void __weak sys_trace_k_work_schedule_for_queue_enter(struct k_work_q *queue, struct k_work_delayable *dwork, k_timeout_t delay) {}
void __weak sys_trace_k_work_schedule_for_queue_exit(struct k_work_q *queue, struct k_work_delayable *dwork, k_timeout_t delay, int ret) {}
void __weak sys_trace_k_work_schedule_enter(struct k_work_delayable *dwork, k_timeout_t delay) {}
void __weak sys_trace_k_work_schedule_exit(struct k_work_delayable *dwork, k_timeout_t delay, int ret) {}
void __weak sys_trace_k_work_reschedule_for_queue_enter(struct k_work_q *queue, struct k_work_delayable *dwork, k_timeout_t delay) {}
void __weak sys_trace_k_work_reschedule_for_queue_exit(struct k_work_q *queue, struct k_work_delayable *dwork, k_timeout_t delay, int ret) {}
void __weak sys_trace_k_work_reschedule_enter(struct k_work_delayable *dwork, k_timeout_t delay) {}
void __weak sys_trace_k_work_reschedule_exit(struct k_work_delayable *dwork, k_timeout_t delay, int ret) {}
void __weak sys_trace_k_work_flush_delayable_enter(struct k_work_delayable *dwork, struct k_work_sync *sync) {}
void __weak sys_trace_k_work_flush_delayable_exit(struct k_work_delayable *dwork, struct k_work_sync *sync, bool ret) {}
void __weak sys_trace_k_work_cancel_delayable_enter(struct k_work_delayable *dwork) {}
void __weak sys_trace_k_work_cancel_delayable_exit(struct k_work_delayable *dwork, int ret) {}
void __weak sys_trace_k_work_cancel_delayable_sync_enter(struct k_work_delayable *dwork, struct k_work_sync *sync) {}
void __weak sys_trace_k_work_cancel_delayable_sync_exit(struct k_work_delayable *dwork, struct k_work_sync *sync, bool ret) {}
...
void __weak sys_trace_k_work_poll_submit_to_queue_enter(struct k_work_q *work_q, struct k_work_poll *work, k_timeout_t timeout) {}
void __weak sys_trace_k_work_poll_submit_to_queue_blocking(struct k_work_q *work_q, struct k_work_poll *work, k_timeout_t timeout) {}
void __weak sys_trace_k_work_poll_submit_to_queue_exit(struct k_work_q *work_q, struct k_work_poll *work, k_timeout_t timeout, int ret) {}
void __weak sys_trace_k_work_poll_submit_enter(struct k_work_poll *work, k_timeout_t timeout) {}
void __weak sys_trace_k_work_poll_submit_exit(struct k_work_poll *work, k_timeout_t timeout, int ret) {}
...
void __weak sys_trace_k_poll_api_signal_init(struct k_poll_signal *signal) {}
void __weak sys_trace_k_poll_api_signal_reset(struct k_poll_signal *signal) {}
void __weak sys_trace_k_poll_api_signal_check(struct k_poll_signal *signal) {}
void __weak sys_trace_k_poll_api_signal_raise(struct k_poll_signal *signal, int ret) {}
...
void __weak sys_trace_k_condvar_signal_blocking(struct k_condvar *condvar, k_timeout_t timeout) {}
void __weak sys_trace_k_condvar_signal_exit(struct k_condvar *condvar, int ret) {}
void __weak sys_trace_k_condvar_broadcast_enter(struct k_condvar *condvar) {}
void __weak sys_trace_k_condvar_broadcast_exit(struct k_condvar *condvar, int ret) {}
void __weak sys_trace_k_condvar_wait_enter(struct k_condvar *condvar, k_timeout_t timeout) {}
void __weak sys_trace_k_condvar_wait_exit(struct k_condvar *condvar, k_timeout_t timeout, int ret) {}
...
void __weak sys_trace_k_queue_queue_insert_blocking(struct k_queue *queue, bool alloc, k_timeout_t timeout) {}
void __weak sys_trace_k_queue_queue_insert_exit(struct k_queue *queue, bool alloc, int ret) {}
...
/* LIFO tracing weak stubs */
void __weak sys_trace_k_lifo_init_enter(struct k_lifo *lifo) {}
void __weak sys_trace_k_lifo_init_exit(struct k_lifo *lifo) {}
void __weak sys_trace_k_lifo_put_enter(struct k_lifo *lifo, void *data) {}
void __weak sys_trace_k_lifo_put_exit(struct k_lifo *lifo, void *data) {}
void __weak sys_trace_k_lifo_alloc_put_enter(struct k_lifo *lifo, void *data) {}
void __weak sys_trace_k_lifo_alloc_put_exit(struct k_lifo *lifo, void *data, int ret) {}
void __weak sys_trace_k_lifo_get_enter(struct k_lifo *lifo, k_timeout_t timeout) {}
void __weak sys_trace_k_lifo_get_exit(struct k_lifo *lifo, k_timeout_t timeout, void *ret) {}
...
void __weak sys_trace_k_pipe_init(struct k_pipe *pipe, unsigned char *buffer, size_t size) {}
...
void __weak sys_trace_k_pipe_write_enter(struct k_pipe *pipe, void *data, size_t len, k_timeout_t timeout) {}
void __weak sys_trace_k_pipe_write_blocking(struct k_pipe *pipe, k_timeout_t timeout) {}
void __weak sys_trace_k_pipe_write_exit(struct k_pipe *pipe, int ret) {}
void __weak sys_trace_k_pipe_read_enter(struct k_pipe *pipe, void *data, size_t len, k_timeout_t timeout) {}
...
void __weak sys_trace_k_heap_aligned_alloc_enter(struct k_heap *heap, k_timeout_t timeout) {}
void __weak sys_trace_k_heap_alloc_helper_blocking(struct k_heap *heap, k_timeout_t timeout) {}
void __weak sys_trace_k_heap_aligned_alloc_exit(struct k_heap *heap, k_timeout_t timeout, void *ret) {}
...
void __weak sys_trace_k_heap_calloc_enter(struct k_heap *heap, k_timeout_t timeout) {}
void __weak sys_trace_k_heap_calloc_exit(struct k_heap *heap, k_timeout_t timeout, void *ret) {}
void __weak sys_trace_k_heap_free(struct k_heap *heap) {}
void __weak sys_trace_k_heap_realloc_enter(struct k_heap *h, void *ptr, size_t bytes, k_timeout_t timeout) {}
void __weak sys_trace_k_heap_realloc_exit(struct k_heap *h, void *ptr, size_t bytes, k_timeout_t timeout, void *ret) {}
void __weak sys_trace_k_heap_sys_k_aligned_alloc_enter(struct k_heap *heap) {}
void __weak sys_trace_k_heap_sys_k_aligned_alloc_exit(struct k_heap *heap, void *ret) {}
void __weak sys_trace_k_heap_sys_k_malloc_enter(struct k_heap *heap) {}
void __weak sys_trace_k_heap_sys_k_malloc_exit(struct k_heap *heap, void *ret) {}
void __weak sys_trace_k_heap_sys_k_free_enter(struct k_heap *heap, struct k_heap **heap_ref) {}
void __weak sys_trace_k_heap_sys_k_free_exit(struct k_heap *heap, struct k_heap **heap_ref) {}
void __weak sys_trace_k_heap_sys_k_calloc_enter(struct k_heap *heap) {}
void __weak sys_trace_k_heap_sys_k_calloc_exit(struct k_heap *heap, void *ret) {}
void __weak sys_trace_k_heap_sys_k_realloc_enter(struct k_heap *heap, void *ptr) {}
void __weak sys_trace_k_heap_sys_k_realloc_exit(struct k_heap *heap, void *ptr, void *ret) {}

/* Memory slab tracing weak stubs */
void __weak sys_trace_k_mem_slab_init(struct k_mem_slab *slab, int rc) {}
void __weak sys_trace_k_mem_slab_alloc_enter(struct k_mem_slab *slab, k_timeout_t timeout) {}
void __weak sys_trace_k_mem_slab_alloc_blocking(struct k_mem_slab *slab, k_timeout_t timeout) {}
void __weak sys_trace_k_mem_slab_alloc_exit(struct k_mem_slab *slab, k_timeout_t timeout, int ret) {}
...
void __weak sys_trace_k_event_post_enter(struct k_event *event, uint32_t events, uint32_t events_mask) {}
void __weak sys_trace_k_event_post_exit(struct k_event *event, uint32_t events, uint32_t events_mask) {}
void __weak sys_trace_k_event_wait_enter(struct k_event *event, uint32_t events, uint32_t options, k_timeout_t timeout) {}
void __weak sys_trace_k_event_wait_blocking(struct k_event *event, uint32_t events, uint32_t options, k_timeout_t timeout) {}
...
void __weak sys_trace_pm_device_runtime_put_enter(const struct device *dev) {}
void __weak sys_trace_pm_device_runtime_put_exit(const struct device *dev, int ret) {}
void __weak sys_trace_pm_device_runtime_put_async_enter(const struct device *dev, k_timeout_t delay) {}
void __weak sys_trace_pm_device_runtime_put_async_exit(const struct device *dev, k_timeout_t delay, int ret) {}
...
void __weak sys_trace_socket_init(int sock, int family, int type, int proto) {}
...
void __weak sys_trace_socket_bind_enter(int sock, const struct sockaddr *addr, socklen_t addrlen) {}
void __weak sys_trace_socket_bind_exit(int sock, int ret) {}
void __weak sys_trace_socket_connect_enter(int sock, const struct sockaddr *addr, socklen_t addrlen) {}
...
void __weak sys_trace_socket_accept_exit(int sock, const struct sockaddr *addr, const socklen_t *addrlen, int ret) {}
void __weak sys_trace_socket_sendto_enter(int sock, size_t len, int flags, const struct sockaddr *dest_addr, socklen_t addrlen) {}
void __weak sys_trace_socket_sendto_exit(int sock, int ret) {}
void __weak sys_trace_socket_sendmsg_enter(int sock, const struct msghdr *msg, int flags) {}
void __weak sys_trace_socket_sendmsg_exit(int sock, int ret) {}
void __weak sys_trace_socket_recvfrom_enter(int sock, size_t max_len, int flags, struct sockaddr *addr, socklen_t *addrlen) {}
void __weak sys_trace_socket_recvfrom_exit(int sock, const struct sockaddr *src_addr, const socklen_t *addrlen, int ret) {}
void __weak sys_trace_socket_recvmsg_enter(int sock, const struct msghdr *msg, int flags) {}
void __weak sys_trace_socket_recvmsg_exit(int sock, const struct msghdr *msg, int ret) {}
...
void __weak sys_trace_socket_poll_enter(struct zsock_pollfd *fds, int nfds, int timeout) {}
void __weak sys_trace_socket_poll_exit(struct zsock_pollfd *fds, int nfds, int ret) {}
void __weak sys_trace_socket_getsockopt_enter(int sock, int level, int optname) {}
void __weak sys_trace_socket_getsockopt_exit(int sock, int level, int optname, void *optval, const socklen_t *optlen, int ret) {}
void __weak sys_trace_socket_setsockopt_enter(int sock, int level, int optname, const void *optval, socklen_t optlen) {}
void __weak sys_trace_socket_setsockopt_exit(int sock, int ret) {}
void __weak sys_trace_socket_getpeername_enter(int sock) {}
void __weak sys_trace_socket_getpeername_exit(int sock, struct sockaddr *addr, const socklen_t *addrlen, int ret) {}
void __weak sys_trace_socket_getsockname_enter(int sock) {}
void __weak sys_trace_socket_getsockname_exit(int sock, struct sockaddr *addr, const socklen_t *addrlen, int ret) {}
...
void __weak sys_trace_gpio_pin_interrupt_configure_enter(const struct device *port, gpio_pin_t pin,
						  gpio_flags_t flags) {}

void __weak sys_trace_gpio_pin_interrupt_configure_exit(const struct device *port, gpio_pin_t pin,
						  int ret) {}

void __weak sys_trace_gpio_pin_configure_enter(const struct device *port, gpio_pin_t pin,
					gpio_flags_t flags) {}

void __weak sys_trace_gpio_pin_configure_exit(const struct device *port, gpio_pin_t pin, int ret) {}

void __weak sys_trace_gpio_port_get_direction_enter(const struct device *port, gpio_port_pins_t map,
					     gpio_port_pins_t inputs, gpio_port_pins_t outputs) {}

void __weak sys_trace_gpio_port_get_direction_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_pin_get_config_enter(const struct device *port, gpio_pin_t pin, int ret) {}

void __weak sys_trace_gpio_pin_get_config_exit(const struct device *port, gpio_pin_t pin, int ret) {}

void __weak sys_trace_gpio_port_get_raw_enter(const struct device *port, gpio_port_value_t *value) {}

void __weak sys_trace_gpio_port_get_raw_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_port_set_masked_raw_enter(const struct device *port, gpio_port_pins_t mask,
					      gpio_port_value_t value) {}

void __weak sys_trace_gpio_port_set_masked_raw_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_port_set_bits_raw_enter(const struct device *port, gpio_port_pins_t pins) {}

void __weak sys_trace_gpio_port_set_bits_raw_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_port_clear_bits_raw_enter(const struct device *port, gpio_port_pins_t pins) {}

void __weak sys_trace_gpio_port_clear_bits_raw_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_port_toggle_bits_enter(const struct device *port, gpio_port_pins_t pins) {}

void __weak sys_trace_gpio_port_toggle_bits_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_init_callback_enter(struct gpio_callback *callback,
					gpio_callback_handler_t handler, gpio_port_pins_t pin_mask) {}

void __weak sys_trace_gpio_init_callback_exit(struct gpio_callback *callback) {}

void __weak sys_trace_gpio_add_callback_enter(const struct device *port, struct gpio_callback *callback) {}

void __weak sys_trace_gpio_add_callback_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_remove_callback_enter(const struct device *port,
						struct gpio_callback *callback) {}

void __weak sys_trace_gpio_remove_callback_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_get_pending_int_enter(const struct device *dev) {}

void __weak sys_trace_gpio_get_pending_int_exit(const struct device *port, int ret) {}

void __weak sys_trace_gpio_fire_callbacks_enter(sys_slist_t *list, const struct device *port,
					 gpio_pin_t pins) {}

void __weak sys_trace_gpio_fire_callback(const struct device *port, struct gpio_callback *callback) {}
...
void __weak sys_trace_rtio_txn_next_enter(const struct rtio *r, const struct rtio_iodev_sqe *iodev_sqe)
{
	printk("txn_next_enter: rtio: %p\t iodev_sqe: %p\n", r, iodev_sqe);
}

void __weak sys_trace_rtio_txn_next_exit(const struct rtio *r, const struct rtio_iodev_sqe *iodev_sqe)
{
	printk("txn_next_exit: rtio: %p\t iodev_sqe: %p\n", r, iodev_sqe);
}

void __weak sys_trace_rtio_chain_next_enter(const struct rtio *r, const struct rtio_iodev_sqe *iodev_sqe)
{
	printk("chain_next_enter: rtio: %p\t iodev_sqe: %p\n", r, iodev_sqe);
}

void __weak sys_trace_rtio_chain_next_exit(const struct rtio *r, const struct rtio_iodev_sqe *iodev_sqe)
{
...
void __weak sys_trace_timer_start(struct k_timer *timer, k_timeout_t duration, k_timeout_t period) {}
