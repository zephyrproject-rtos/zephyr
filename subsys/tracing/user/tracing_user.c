...
_def_func(sys_trace_gpio_pin_interrupt_configure_enter_user, const struct device *port,
							      gpio_pin_t pin, gpio_flags_t flags);
_def_func(sys_trace_gpio_pin_interrupt_configure_exit_user, const struct device *port,
							     gpio_pin_t pin, int ret);
_def_func(sys_trace_gpio_pin_configure_enter_user, const struct device *port, gpio_pin_t pin,
						    gpio_flags_t flags);
_def_func(sys_trace_gpio_pin_configure_exit_user, const struct device *port, gpio_pin_t pin,
						   int ret);
_def_func(sys_trace_gpio_port_get_direction_enter_user, const struct device *port,
							 gpio_port_pins_t map,
							 gpio_port_pins_t inputs,
							 gpio_port_pins_t outputs);
_def_func(sys_trace_gpio_port_get_direction_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_pin_get_config_enter_user, const struct device *port, gpio_pin_t pin,
						     int ret);
_def_func(sys_trace_gpio_pin_get_config_exit_user, const struct device *port, gpio_pin_t pin,
						    int ret);
_def_func(sys_trace_gpio_port_get_raw_enter_user, const struct device *port,
						   gpio_port_value_t *value);
_def_func(sys_trace_gpio_port_get_raw_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_port_set_masked_raw_enter_user, const struct device *port,
							  gpio_port_pins_t mask,
							  gpio_port_value_t value);
_def_func(sys_trace_gpio_port_set_masked_raw_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_port_set_bits_raw_enter_user, const struct device *port,
							gpio_port_pins_t pins);
_def_func(sys_trace_gpio_port_set_bits_raw_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_port_clear_bits_raw_enter_user, const struct device *port,
							  gpio_port_pins_t pins);
_def_func(sys_trace_gpio_port_clear_bits_raw_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_port_toggle_bits_enter_user, const struct device *port,
						       gpio_port_pins_t pins);
_def_func(sys_trace_gpio_port_toggle_bits_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_init_callback_enter_user, struct gpio_callback *callback,
						    gpio_callback_handler_t handler,
						    gpio_port_pins_t pin_mask);
_def_func(sys_trace_gpio_init_callback_exit_user, struct gpio_callback *callback);
_def_func(sys_trace_gpio_add_callback_enter_user, const struct device *port,
						   struct gpio_callback *callback);
_def_func(sys_trace_gpio_add_callback_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_remove_callback_enter_user, const struct device *port,
						      struct gpio_callback *callback);
_def_func(sys_trace_gpio_remove_callback_exit_user, const struct device *port, int ret);
_def_func(sys_trace_gpio_get_pending_int_enter_user, const struct device *dev);
_def_func(sys_trace_gpio_get_pending_int_exit_user, const struct device *dev, int ret);
_def_func(sys_trace_gpio_fire_callbacks_enter_user, sys_slist_t *list, const struct device *port,
						     gpio_pin_t pins);
_def_func(sys_trace_gpio_fire_callback_user, const struct device *port,
					      struct gpio_callback *callback);
