...
void sys_trace_gpio_pin_interrupt_configure_enter(const struct device *port, gpio_pin_t pin,
						   gpio_flags_t flags);
void sys_trace_gpio_pin_interrupt_configure_exit(const struct device *port, gpio_pin_t pin, int ret);
...
void sys_trace_gpio_remove_callback_enter(const struct device *port, struct gpio_callback *callback);
...
void sys_trace_k_work_cancel_delayable_sync_exit(struct k_work_delayable *dwork, struct k_work_sync *sync, bool ret);
...
void sys_trace_k_heap_calloc_enter(struct k_heap *heap, k_timeout_t timeout);
void sys_trace_k_heap_calloc_exit(struct k_heap *heap, k_timeout_t timeout, void *ret);
...
void sys_trace_k_heap_realloc_exit(struct k_heap *h, void *ptr, size_t bytes, k_timeout_t timeout, void *ret);
...
void sys_trace_pm_device_runtime_put_async_exit(const struct device *dev, k_timeout_t delay, int ret);
...
void sys_trace_socket_bind_enter(int sock, const struct sockaddr *addr, socklen_t addrlen);
void sys_trace_socket_bind_exit(int sock, int ret);
void sys_trace_socket_connect_enter(int sock, const struct sockaddr *addr, socklen_t addrlen);
...
void sys_trace_socket_accept_exit(int sock, const struct sockaddr *addr, const socklen_t *addrlen, int ret);
void sys_trace_socket_sendto_enter(int sock, size_t len, int flags, const struct sockaddr *dest_addr, socklen_t addrlen);
...
void sys_trace_socket_recvfrom_enter(int sock, size_t max_len, int flags, struct sockaddr *addr, socklen_t *addrlen);
void sys_trace_socket_recvfrom_exit(int sock, const struct sockaddr *src_addr, const socklen_t *addrlen, int ret);
...
void sys_trace_socket_poll_enter(struct zsock_pollfd *fds, int nfds, int timeout);
void sys_trace_socket_poll_exit(struct zsock_pollfd *fds, int nfds, int ret);
void sys_trace_socket_getsockopt_enter(int sock, int level, int optname);
void sys_trace_socket_getsockopt_exit(int sock, int level, int optname, void *optval, const socklen_t *optlen, int ret);
void sys_trace_socket_setsockopt_enter(int sock, int level, int optname, const void *optval, socklen_t optlen);
void sys_trace_socket_setsockopt_exit(int sock, int ret);
void sys_trace_socket_getpeername_enter(int sock);
void sys_trace_socket_getpeername_exit(int sock, struct sockaddr *addr, const socklen_t *addrlen, int ret);
void sys_trace_socket_getsockname_enter(int sock);
void sys_trace_socket_getsockname_exit(int sock, struct sockaddr *addr, const socklen_t *addrlen, int ret);
...
#define sys_port_trace_k_thread_join_enter(thread, timeout) sys_trace_thread_join_enter(thread, timeout)
#define sys_port_trace_k_thread_join_blocking(thread, timeout) sys_trace_thread_join_blocking(thread, timeout)
#define sys_port_trace_k_thread_join_exit(thread, timeout, ret) sys_trace_thread_join_exit(thread, timeout, ret)
...
#define sys_port_trace_k_thread_busy_wait_enter(usec_to_wait) sys_trace_thread_busy_wait_enter(usec_to_wait)
#define sys_port_trace_k_thread_busy_wait_exit(usec_to_wait) sys_trace_thread_busy_wait_exit(usec_to_wait)
...
#define sys_port_trace_k_work_submit_to_queue_enter(queue, work) sys_trace_k_work_submit_to_queue_enter(queue, work)
#define sys_port_trace_k_work_submit_to_queue_exit(queue, work, ret) sys_trace_k_work_submit_to_queue_exit(queue, work, ret)
...
#define sys_port_trace_k_work_flush_blocking(work, timeout) sys_trace_k_work_flush_blocking(work, timeout)
...
#define sys_port_trace_k_work_cancel_sync_enter(work, sync) sys_trace_k_work_cancel_sync_enter(work, sync)
#define sys_port_trace_k_work_cancel_sync_blocking(work, sync) sys_trace_k_work_cancel_sync_blocking(work, sync)
#define sys_port_trace_k_work_cancel_sync_exit(work, sync, ret) sys_trace_k_work_cancel_sync_exit(work, sync, ret)
...
#define sys_port_trace_k_work_queue_stop_enter(queue, timeout) sys_trace_k_work_queue_stop_enter(queue, timeout)
#define sys_port_trace_k_work_queue_stop_blocking(queue, timeout) sys_trace_k_work_queue_stop_blocking(queue, timeout)
#define sys_port_trace_k_work_queue_stop_exit(queue, timeout, ret) sys_trace_k_work_queue_stop_exit(queue, timeout, ret)
#define sys_port_trace_k_work_queue_drain_enter(queue) sys_trace_k_work_queue_drain_enter(queue)
#define sys_port_trace_k_work_queue_drain_exit(queue, ret) sys_trace_k_work_queue_drain_exit(queue, ret)
#define sys_port_trace_k_work_queue_unplug_enter(queue) sys_trace_k_work_queue_unplug_enter(queue)
#define sys_port_trace_k_work_queue_unplug_exit(queue, ret) sys_trace_k_work_queue_unplug_exit(queue, ret)

#define sys_port_trace_k_work_delayable_init(dwork) sys_trace_k_work_delayable_init(dwork)
#define sys_port_trace_k_work_schedule_for_queue_enter(queue, dwork, delay) sys_trace_k_work_schedule_for_queue_enter(queue, dwork, delay)
#define sys_port_trace_k_work_schedule_for_queue_exit(queue, dwork, delay, ret) sys_trace_k_work_schedule_for_queue_exit(queue, dwork, delay, ret)
#define sys_port_trace_k_work_schedule_enter(dwork, delay) sys_trace_k_work_schedule_enter(dwork, delay)
#define sys_port_trace_k_work_schedule_exit(dwork, delay, ret) sys_trace_k_work_schedule_exit(dwork, delay, ret)
#define sys_port_trace_k_work_reschedule_for_queue_enter(queue, dwork, delay) sys_trace_k_work_reschedule_for_queue_enter(queue, dwork, delay)
#define sys_port_trace_k_work_reschedule_for_queue_exit(queue, dwork, delay, ret) sys_trace_k_work_reschedule_for_queue_exit(queue, dwork, delay, ret)
#define sys_port_trace_k_work_reschedule_enter(dwork, delay) sys_trace_k_work_reschedule_enter(dwork, delay)
#define sys_port_trace_k_work_reschedule_exit(dwork, delay, ret) sys_trace_k_work_reschedule_exit(dwork, delay, ret)
#define sys_port_trace_k_work_flush_delayable_enter(dwork, sync) sys_trace_k_work_flush_delayable_enter(dwork, sync)
#define sys_port_trace_k_work_flush_delayable_exit(dwork, sync, ret) sys_trace_k_work_flush_delayable_exit(dwork, sync, ret)
#define sys_port_trace_k_work_cancel_delayable_enter(dwork) sys_trace_k_work_cancel_delayable_enter(dwork)
#define sys_port_trace_k_work_cancel_delayable_exit(dwork, ret) sys_trace_k_work_cancel_delayable_exit(dwork, ret)
#define sys_port_trace_k_work_cancel_delayable_sync_enter(dwork, sync) sys_trace_k_work_cancel_delayable_sync_enter(dwork, sync)
#define sys_port_trace_k_work_cancel_delayable_sync_exit(dwork, sync, ret) sys_trace_k_work_cancel_delayable_sync_exit(dwork, sync, ret)
...
#define sys_port_trace_k_work_poll_submit_to_queue_enter(work_q, work, timeout) sys_trace_k_work_poll_submit_to_queue_enter(work_q, work, timeout)
#define sys_port_trace_k_work_poll_submit_to_queue_blocking(work_q, work, timeout) sys_trace_k_work_poll_submit_to_queue_blocking(work_q, work, timeout)
#define sys_port_trace_k_work_poll_submit_to_queue_exit(work_q, work, timeout, ret) sys_trace_k_work_poll_submit_to_queue_exit(work_q, work, timeout, ret)
#define sys_port_trace_k_work_poll_submit_enter(work, timeout) sys_trace_k_work_poll_submit_enter(work, timeout)
#define sys_port_trace_k_work_poll_submit_exit(work, timeout, ret) sys_trace_k_work_poll_submit_exit(work, timeout, ret)
#define sys_port_trace_k_work_poll_cancel_enter(work) sys_trace_k_work_poll_cancel_enter(work)
#define sys_port_trace_k_work_poll_cancel_exit(work, ret) sys_trace_k_work_poll_cancel_exit(work, ret)
...
#define sys_port_trace_k_poll_api_signal_raise(signal, ret) sys_trace_k_poll_api_signal_raise(signal, ret)
...
#define sys_port_trace_k_condvar_signal_blocking(condvar, timeout) sys_trace_k_condvar_signal_blocking(condvar, timeout)
#define sys_port_trace_k_condvar_signal_exit(condvar, ret) sys_trace_k_condvar_signal_exit(condvar, ret)
#define sys_port_trace_k_condvar_broadcast_enter(condvar) sys_trace_k_condvar_broadcast_enter(condvar)
#define sys_port_trace_k_condvar_broadcast_exit(condvar, ret) sys_trace_k_condvar_broadcast_exit(condvar, ret)
#define sys_port_trace_k_condvar_wait_enter(condvar, timeout) sys_trace_k_condvar_wait_enter(condvar, timeout)
#define sys_port_trace_k_condvar_wait_exit(condvar, timeout, ret) sys_trace_k_condvar_wait_exit(condvar, timeout, ret)
...
#define sys_port_trace_k_queue_queue_insert_enter(queue, alloc) sys_trace_k_queue_queue_insert_enter(queue, alloc)
#define sys_port_trace_k_queue_queue_insert_blocking(queue, alloc, timeout) sys_trace_k_queue_queue_insert_blocking(queue, alloc, timeout)
#define sys_port_trace_k_queue_queue_insert_exit(queue, alloc, ret) sys_trace_k_queue_queue_insert_exit(queue, alloc, ret)
...
#define sys_port_trace_k_queue_alloc_append_exit(queue, ret) sys_trace_k_queue_alloc_append_exit(queue, ret)
...
#define sys_port_trace_k_queue_alloc_prepend_enter(queue) sys_trace_k_queue_alloc_prepend_enter(queue)
#define sys_port_trace_k_queue_alloc_prepend_exit(queue, ret) sys_trace_k_queue_alloc_prepend_exit(queue, ret)
#define sys_port_trace_k_queue_insert_enter(queue) sys_trace_k_queue_insert_enter(queue)
#define sys_port_trace_k_queue_insert_blocking(queue, timeout) sys_trace_k_queue_insert_blocking(queue, timeout)
...
#define sys_port_trace_k_queue_append_list_exit(queue, ret) sys_trace_k_queue_append_list_exit(queue, ret)
#define sys_port_trace_k_queue_merge_slist_enter(queue) sys_trace_k_queue_merge_slist_enter(queue)
#define sys_port_trace_k_queue_merge_slist_exit(queue, ret) sys_trace_k_queue_merge_slist_exit(queue, ret)
#define sys_port_trace_k_queue_get_enter(queue, timeout) sys_trace_k_queue_get_enter(queue, timeout)
#define sys_port_trace_k_queue_get_blocking(queue, timeout) sys_trace_k_queue_get_blocking(queue, timeout)
#define sys_port_trace_k_queue_get_exit(queue, timeout, ret) sys_trace_k_queue_get_exit(queue, timeout, ret)
...
#define sys_port_trace_k_queue_unique_append_enter(queue) sys_trace_k_queue_unique_append_enter(queue)
#define sys_port_trace_k_queue_unique_append_exit(queue, ret) sys_trace_k_queue_unique_append_exit(queue, ret)
...
#define sys_port_trace_k_fifo_alloc_put_enter(fifo, data) sys_trace_k_fifo_alloc_put_enter(fifo, data)
#define sys_port_trace_k_fifo_alloc_put_exit(fifo, data, ret) sys_trace_k_fifo_alloc_put_exit(fifo, data, ret)
#define sys_port_trace_k_fifo_put_list_enter(fifo, head, tail) sys_trace_k_fifo_put_list_enter(fifo, head, tail)
#define sys_port_trace_k_fifo_put_list_exit(fifo, head, tail) sys_trace_k_fifo_put_list_exit(fifo, head, tail)
#define sys_port_trace_k_fifo_put_slist_enter(fifo, list) sys_trace_k_fifo_put_slist_enter(fifo, list)
...
#define sys_port_trace_k_fifo_get_exit(fifo, timeout, ret) sys_trace_k_fifo_get_exit(fifo, timeout, ret)
...
#define sys_port_trace_k_lifo_alloc_put_enter(lifo, data) sys_trace_k_lifo_alloc_put_enter(lifo, data)
#define sys_port_trace_k_lifo_alloc_put_exit(lifo, data, ret) sys_trace_k_lifo_alloc_put_exit(lifo, data, ret)
#define sys_port_trace_k_lifo_get_enter(lifo, timeout) sys_trace_k_lifo_get_enter(lifo, timeout)
#define sys_port_trace_k_lifo_get_exit(lifo, timeout, ret) sys_trace_k_lifo_get_exit(lifo, timeout, ret)
...
#define sys_port_trace_k_stack_alloc_init_exit(stack, ret) sys_trace_k_stack_alloc_init_exit(stack, ret)
...
#define sys_port_trace_k_stack_pop_blocking(stack, timeout) sys_trace_k_stack_pop_blocking(stack, timeout)
#define sys_port_trace_k_stack_pop_exit(stack, timeout, ret) sys_trace_k_stack_pop_exit(stack, timeout, ret)
...
#define sys_port_trace_k_msgq_put_front_enter(msgq, timeout) sys_trace_k_msgq_put_front_enter(msgq, timeout)
#define sys_port_trace_k_msgq_put_front_blocking(msgq, timeout) sys_trace_k_msgq_put_front_blocking(msgq, timeout)
#define sys_port_trace_k_msgq_put_front_exit(msgq, timeout, ret) sys_trace_k_msgq_put_front_exit(msgq, timeout, ret)
...
#define sys_port_trace_k_mbox_message_put_enter(mbox, timeout) sys_trace_k_mbox_message_put_enter(mbox, timeout)
#define sys_port_trace_k_mbox_message_put_blocking(mbox, timeout) sys_trace_k_mbox_message_put_blocking(mbox, timeout)
#define sys_port_trace_k_mbox_message_put_exit(mbox, timeout, ret) sys_trace_k_mbox_message_put_exit(mbox, timeout, ret)
#define sys_port_trace_k_mbox_put_enter(mbox, timeout) sys_trace_k_mbox_put_enter(mbox, timeout)
#define sys_port_trace_k_mbox_put_exit(mbox, timeout, ret) sys_trace_k_mbox_put_exit(mbox, timeout, ret)
...
#define sys_port_trace_k_mbox_get_blocking(mbox, timeout) sys_trace_k_mbox_get_blocking(mbox, timeout)
#define sys_port_trace_k_mbox_get_exit(mbox, timeout, ret) sys_trace_k_mbox_get_exit(mbox, timeout, ret)
...
#define sys_port_trace_k_pipe_write_enter(pipe, data, len, timeout) sys_trace_k_pipe_write_enter(pipe, data, len, timeout)
#define sys_port_trace_k_pipe_write_blocking(pipe, timeout) sys_trace_k_pipe_write_blocking(pipe, timeout)
#define sys_port_trace_k_pipe_write_exit(pipe, ret) sys_trace_k_pipe_write_exit(pipe, ret)
#define sys_port_trace_k_pipe_read_enter(pipe, data, len, timeout) sys_trace_k_pipe_read_enter(pipe, data, len, timeout)
#define sys_port_trace_k_pipe_read_blocking(pipe, timeout) sys_trace_k_pipe_read_blocking(pipe, timeout)
...
#define sys_port_trace_k_heap_aligned_alloc_enter(heap, timeout) sys_trace_k_heap_aligned_alloc_enter(heap, timeout)
#define sys_port_trace_k_heap_alloc_helper_blocking(heap, timeout) sys_trace_k_heap_alloc_helper_blocking(heap, timeout)
#define sys_port_trace_k_heap_aligned_alloc_exit(heap, timeout, ret) sys_trace_k_heap_aligned_alloc_exit(heap, timeout, ret)
#define sys_port_trace_k_heap_alloc_enter(heap, timeout) sys_trace_k_heap_alloc_enter(heap, timeout)
#define sys_port_trace_k_heap_alloc_exit(heap, timeout, ret) sys_trace_k_heap_alloc_exit(heap, timeout, ret)
#define sys_port_trace_k_heap_calloc_enter(heap, timeout) sys_trace_k_heap_calloc_enter(heap, timeout)
#define sys_port_trace_k_heap_calloc_exit(heap, timeout, ret) sys_trace_k_heap_calloc_exit(heap, timeout, ret)
#define sys_port_trace_k_heap_free(heap) sys_trace_k_heap_free(heap)
#define sys_port_trace_k_heap_realloc_enter(h, ptr, bytes, timeout) sys_trace_k_heap_realloc_enter(h, ptr, bytes, timeout)
#define sys_port_trace_k_heap_realloc_exit(h, ptr, bytes, timeout, ret) sys_trace_k_heap_realloc_exit(h, ptr, bytes, timeout, ret)
#define sys_port_trace_k_heap_sys_k_aligned_alloc_enter(heap) sys_trace_k_heap_sys_k_aligned_alloc_enter(heap)
#define sys_port_trace_k_heap_sys_k_aligned_alloc_exit(heap, ret) sys_trace_k_heap_sys_k_aligned_alloc_exit(heap, ret)
#define sys_port_trace_k_heap_sys_k_malloc_enter(heap) sys_trace_k_heap_sys_k_malloc_enter(heap)
#define sys_port_trace_k_heap_sys_k_malloc_exit(heap, ret) sys_trace_k_heap_sys_k_malloc_exit(heap, ret)
#define sys_port_trace_k_heap_sys_k_free_enter(heap, heap_ref) sys_trace_k_heap_sys_k_free_enter(heap, heap_ref)
#define sys_port_trace_k_heap_sys_k_free_exit(heap, heap_ref) sys_trace_k_heap_sys_k_free_exit(heap, heap_ref)
#define sys_port_trace_k_heap_sys_k_calloc_enter(heap) sys_trace_k_heap_sys_k_calloc_enter(heap)
#define sys_port_trace_k_heap_sys_k_calloc_exit(heap, ret) sys_trace_k_heap_sys_k_calloc_exit(heap, ret)
#define sys_port_trace_k_heap_sys_k_realloc_enter(heap, ptr) sys_trace_k_heap_sys_k_realloc_enter(heap, ptr)
#define sys_port_trace_k_heap_sys_k_realloc_exit(heap, ptr, ret) sys_trace_k_heap_sys_k_realloc_exit(heap, ptr, ret)

#define sys_port_trace_k_mem_slab_init(slab, rc) sys_trace_k_mem_slab_init(slab, rc)
#define sys_port_trace_k_mem_slab_alloc_enter(slab, timeout) sys_trace_k_mem_slab_alloc_enter(slab, timeout)
#define sys_port_trace_k_mem_slab_alloc_blocking(slab, timeout) sys_trace_k_mem_slab_alloc_blocking(slab, timeout)
#define sys_port_trace_k_mem_slab_alloc_exit(slab, timeout, ret) sys_trace_k_mem_slab_alloc_exit(slab, timeout, ret)
...
#define sys_port_trace_pm_system_suspend_exit(ticks, state) sys_trace_pm_system_suspend_exit(ticks, state)

#define sys_port_trace_pm_device_runtime_get_enter(dev) sys_trace_pm_device_runtime_get_enter(dev)
#define sys_port_trace_pm_device_runtime_get_exit(dev, ret) sys_trace_pm_device_runtime_get_exit(dev, ret)
#define sys_port_trace_pm_device_runtime_put_enter(dev) sys_trace_pm_device_runtime_put_enter(dev)
#define sys_port_trace_pm_device_runtime_put_exit(dev, ret) sys_trace_pm_device_runtime_put_exit(dev, ret)
#define sys_port_trace_pm_device_runtime_put_async_enter(dev, delay) sys_trace_pm_device_runtime_put_async_enter(dev, delay)
#define sys_port_trace_pm_device_runtime_put_async_exit(dev, delay, ret) sys_trace_pm_device_runtime_put_async_exit(dev, delay, ret)
#define sys_port_trace_pm_device_runtime_enable_enter(dev) sys_trace_pm_device_runtime_enable_enter(dev)
#define sys_port_trace_pm_device_runtime_enable_exit(dev, ret) sys_trace_pm_device_runtime_enable_exit(dev, ret)
#define sys_port_trace_pm_device_runtime_disable_enter(dev) sys_trace_pm_device_runtime_disable_enter(dev)
#define sys_port_trace_pm_device_runtime_disable_exit(dev, ret) sys_trace_pm_device_runtime_disable_exit(dev, ret)

#define sys_port_trace_socket_init(sock, family, type, proto) sys_trace_socket_init(sock, family, type, proto)
...
#define sys_port_trace_socket_bind_enter(sock, addr, addrlen) sys_trace_socket_bind_enter(sock, addr, addrlen)
#define sys_port_trace_socket_bind_exit(sock, ret) sys_trace_socket_bind_exit(sock, ret)
#define sys_port_trace_socket_connect_enter(sock, addr, addrlen) sys_trace_socket_connect_enter(sock, addr, addrlen)
#define sys_port_trace_socket_connect_exit(sock, ret) sys_trace_socket_connect_exit(sock, ret)
#define sys_port_trace_socket_listen_enter(sock, backlog) sys_trace_socket_listen_enter(sock, backlog)
...
#define sys_port_trace_socket_accept_exit(sock, addr, addrlen, ret) sys_trace_socket_accept_exit(sock, addr, addrlen, ret)
#define sys_port_trace_socket_sendto_enter(sock, len, flags, dest_addr, addrlen) sys_trace_socket_sendto_enter(sock, len, flags, dest_addr, addrlen)
#define sys_port_trace_socket_sendto_exit(sock, ret) sys_trace_socket_sendto_exit(sock, ret)
#define sys_port_trace_socket_sendmsg_enter(sock, msg, flags) sys_trace_socket_sendmsg_enter(sock, msg, flags)
#define sys_port_trace_socket_sendmsg_exit(sock, ret) sys_trace_socket_sendmsg_exit(sock, ret)
#define sys_port_trace_socket_recvfrom_enter(sock, max_len, flags, addr, addrlen) sys_trace_socket_recvfrom_enter(sock, max_len, flags, addr, addrlen)
#define sys_port_trace_socket_recvfrom_exit(sock, src_addr, addrlen, ret) sys_trace_socket_recvfrom_exit(sock, src_addr, addrlen, ret)
#define sys_port_trace_socket_recvmsg_enter(sock, msg, flags) sys_trace_socket_recvmsg_enter(sock, msg, flags)
#define sys_port_trace_socket_recvmsg_exit(sock, msg, ret) sys_trace_socket_recvmsg_exit(sock, msg, ret)
#define sys_port_trace_socket_fcntl_enter(sock, cmd, flags) sys_trace_socket_fcntl_enter(sock, cmd, flags)
...
#define sys_port_trace_socket_poll_enter(fds, nfds, timeout) sys_trace_socket_poll_enter(fds, nfds, timeout)
#define sys_port_trace_socket_poll_exit(fds, nfds, ret) sys_trace_socket_poll_exit(fds, nfds, ret)
#define sys_port_trace_socket_getsockopt_enter(sock, level, optname) sys_trace_socket_getsockopt_enter(sock, level, optname)
#define sys_port_trace_socket_getsockopt_exit(sock, level, optname, optval, optlen, ret) sys_trace_socket_getsockopt_exit(sock, level, optname, optval, optlen, ret)
#define sys_port_trace_socket_setsockopt_enter(sock, level, optname, optval, optlen) sys_trace_socket_setsockopt_enter(sock, level, optname, optval, optlen)
...
#define sys_port_trace_socket_getpeername_exit(sock, addr, addrlen, ret) sys_trace_socket_getpeername_exit(sock, addr, addrlen, ret)
#define sys_port_trace_socket_getsockname_enter(sock) sys_trace_socket_getsockname_enter(sock)
#define sys_port_trace_socket_getsockname_exit(sock, addr, addrlen, ret) sys_trace_socket_getsockname_exit(sock, addr, addrlen, ret)
#define sys_port_trace_socket_socketpair_enter(family, type, proto, sv) sys_trace_socket_socketpair_enter(family, type, proto, sv)
#define sys_port_trace_socket_socketpair_exit(sockA, sockB, ret) sys_trace_socket_socketpair_exit(sockA, sockB, ret)

#define sys_port_trace_net_recv_data_enter(iface, pkt) sys_trace_net_recv_data_enter(iface, pkt)
#define sys_port_trace_net_recv_data_exit(iface, pkt, ret) sys_trace_net_recv_data_exit(iface, pkt, ret)
