...
#ifndef SENSS_SENSOR_H_
#define SENSS_SENSOR_H_
...
int senss_sensor_get_reporters(
		...
		const senss_sensor_handle_t *reporter_handles, int max_handles);
...
typedef int (*senss_sensor_process_t)(
		const struct device *dev,
		senss_sensor_handle_t reporter,
		void *buf, int size);
