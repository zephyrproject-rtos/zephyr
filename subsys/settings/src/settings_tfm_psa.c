...
#define SETTINGS_PSA_UID_RANGE_BEGIN CONFIG_PSA_PS_UID_SETTINGS_TFM_RANGE_START
#define SETTINGS_PSA_UID_RANGE_SIZE  CONFIG_PSA_PS_UID_SETTINGS_TFM_RANGE_SIZE
...
#define SETTINGS_PSA_UID_RANGE_BEGIN CONFIG_PSA_ITS_UID_SETTINGS_TFM_RANGE_START
#define SETTINGS_PSA_UID_RANGE_SIZE  CONFIG_PSA_ITS_UID_SETTINGS_TFM_RANGE_SIZE
