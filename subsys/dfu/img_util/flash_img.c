...
#if DT_RANGES_HAS_IDX(DT_PARENT(DT_NODELABEL(UPLOAD_FLASH_AREA_LABEL)), 0) == 1
/* For subpartitions, go up an extra node to get the flash controller */
#define UPLOAD_FLASH_AREA_CONTROLLER \
	DT_PARENT(DT_GPARENT(DT_NODELABEL(UPLOAD_FLASH_AREA_LABEL)))
#else
#define UPLOAD_FLASH_AREA_CONTROLLER \
