...
{
	return (struct mctp_binding_i2c_smbus_target *)
		((char *)cfg -
		 offsetof(struct mctp_binding_i2c_smbus_target, i2c_target_cfg));
}
...
mctp_i2c_smbus_target_from_work(struct k_work *work)
{
	return (struct mctp_binding_i2c_smbus_target *)
		((char *)work -
		 offsetof(struct mctp_binding_i2c_smbus_target, tx_work));
}
...
mctp_i2c_smbus_target_from_binding(struct mctp_binding *binding)
{
	return (struct mctp_binding_i2c_smbus_target *)
		((char *)binding -
		 offsetof(struct mctp_binding_i2c_smbus_target, binding));
}
