...
K_MEM_SLAB_DEFINE(osal_thread_slab, OSAL_THREAD_CB_SZ, CONFIG_OSAL_MAX_THREADS, sizeof(void *));
				 ...
				 uint32_t stack_size, int priority)
{
	...
	tid = k_thread_create(&t->thread, t->stack, eff_size, thread_trampoline, t, NULL, NULL,
