...
static const uint8_t *event_latency_to_states(const struct pm_event_domain *event_domain,
				       ...
				       int64_t event_uptime_ticks)
{
	...
	event_device_event_states = event_latency_to_states(event_domain, event_latency_us);
