...
/* Merge the confidence of multiple signals, where the overall confidence
 * equals to the minimum value of all participating signals' confidence.
 *
...
int cpu_workload_estimate_get(int cpu_id, struct cpu_workload_estimate *estimate)
{
	 ...
	 *
	 * Ready backlog is a required signal for unified estimate, not an optional signal.
	 */
	 ...
	 *
	 * Runtime history is an optional signal here. The system might have just started up,
