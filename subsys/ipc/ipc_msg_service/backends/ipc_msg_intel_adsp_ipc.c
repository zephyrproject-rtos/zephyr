...
static int intel_adsp_ipc_send(const struct device *dev, void *token, uint8_t msg_type,
			       const void *data)
{
	int ret;
...
static int intel_adsp_ipc_query(const struct device *dev, void *token, uint8_t query_type,
