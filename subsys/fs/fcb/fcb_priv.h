...
struct flash_sector const *fcb_getnext_sector(struct fcb *fcbp, struct flash_sector const *sector);
...
int fcb_sector_hdr_init(struct fcb *fcbp, struct flash_sector const *sector, uint16_t id);
int fcb_sector_hdr_read(struct fcb *fcbp, struct flash_sector const *sector, struct fcb_disk_area *fdap);
