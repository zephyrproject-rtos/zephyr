...
Alternatively, `STM32CubeProgrammer`_ or JLink can also be used to flash the board using
...
If you want to use the `STM32CubeProgrammer`_ runner, so its
:ref:`installation <stm32cubeprog-flash-host-tools>` is required.
