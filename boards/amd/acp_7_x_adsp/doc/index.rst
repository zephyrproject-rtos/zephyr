...
.. zephyr:board:: acp_7_x_adsp

Overview
********

ACP 7.X is Audio co-processor in AMD SoC based on HiFi5 DSP Xtensa Architecture,
...
Xtensa OS (XTOS) and run on a ACP 7.X AMD platforms.
...
- Board features:
  ...
  - RAM: 4MB HP SRAM & 512KB configurable IRAM/DRAM
  - Audio Interfaces:
...
The ACP 7.X SoC operates with an audio clock frequency ranging from 200 to 1000 MHz.
...
The bottom three variables are specific to acp_7_x.
...
.. code-block:: shell
   ...
   export TOOLCHAIN_VER=RI-2022.9-linux
   export XTENSA_CORE=ACP73x_HiFi5_NNE_PROD
...
.. zephyr-app-commands::
   ...
   :board: acp_7_x_adsp/acp_7_x
   :goals: build

Flashing
========

AMD supports only signed images flashing on ACP 7.X platforms
