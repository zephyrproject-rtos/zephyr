...
Applications for the ``bt510/nrf52840`` board configuration can be built, flashed, and
...
The ``bt510/nrf52840`` board does not have an on-board J-Link debug IC
...
:zephyr_file:`boards/lairdconnect/bt510/bt510_nrf52840.dts`.
