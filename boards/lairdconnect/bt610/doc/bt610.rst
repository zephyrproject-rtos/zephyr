...
Applications for the ``bt610/nrf52840`` board configuration can be
...
The ``bt610/nrf52840`` board does not have an on-board J-Link debug IC
...
:zephyr_file:`boards/lairdconnect/bt610/bt610_nrf52840.dts`.
