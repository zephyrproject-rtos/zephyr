...
The Nice!Nano hardware provides support for the Nordic
...
* :abbr:`WDT (Watchdog Timer)`
   ...
   .. figure:: img/nicenano.jpg
         :align: center
         :alt: Original Nice!Nano

   Original Nice!Nano

   .. figure:: img/tenstar_red_nrf52840.jpg
         :align: center
         :alt: Tenstar Red Clone
...
Informations about clones can be found at `Clone Wiki`_.
