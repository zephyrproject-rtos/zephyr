.. zephyr:board:: kit_psoc4_hvms_128k_lite

Overview
********

The `KIT_PSOC4-HVMS-128K_LITE`_ is a lite kit based on the PSOC™ 4 HVMS 128K
family, featuring a PSOC™ 4 HVMS 128K (CY8C4147LWE-HVS135X) microcontroller
with an Arm® Cortex®-M0+ core running at up to 48 MHz.

Key features include 128 KB flash, 16 KB SRAM, and an onboard KitProg3
programmer/debugger with USB Micro-B connectivity.

Hardware
********

- **SoC:** PSOC™ 4 HVMS 128K (CY8C4147LWE-HVS135X)
...
For more information about the PSOC™ 4 HVMS 128K and KIT_PSOC4-HVMS-128K_LITE:

- `PSOC 4 SoC Website`_
- `KIT_PSOC4-HVMS-128K_LITE Board Website`_

Kit Contents
============

- PSOC™ 4 HVMS 128K Lite kit board
...
The PSOC™ 4 HVMS 128K uses the Internal Main Oscillator (IMO) as the default
...
The PSOC™ 4 HVMS 128K has four SCB (Serial Communication Block) interfaces
...
.. zephyr-app-commands::
   ...
   :board: kit_psoc4_hvms_128k_lite
   :goals: build
...
The `KIT_PSOC4-HVMS-128K_LITE`_ includes an onboard programmer/debugger
(`KitProg3`_) which can be used to program and debug the PSOC™ 4 HVMS 128K
Cortex-M0+ core.
...
the `KIT_PSOC4-HVMS-128K_LITE`_. Use the serial terminal of your choice
...
.. tabs::
   ...
   .. group-tab:: Windows
      ...
      .. code-block:: shell
         ...
         west build -b kit_psoc4_hvms_128k_lite -p always samples/hello_world
         west flash
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build vX.Y.Z ***
   Hello World! kit_psoc4_hvms_128k_lite
...
GDB debugging on the PSOC™ 4 HVMS 128K Cortex-M0+ core.

References
**********

.. _KIT_PSOC4-HVMS-128K_LITE:
    https://www.infineon.com/cms/en/product/evaluation-boards/kit_psoc4-hvms-128k-lite/
...
.. _KIT_PSOC4-HVMS-128K_LITE Board Website:
    https://www.infineon.com/cms/en/product/evaluation-boards/kit_psoc4-hvms-128k-lite/
