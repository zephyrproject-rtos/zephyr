...
Hardware
********
Detail Hardware feature for the RA6M5 MCU group can be found at `RA6M5 Group User's Manual Hardware`_

.. figure:: ra6m5-block-diagram.jpg
	:width: 442px
	:align: center
...
Detail Hardware feature for the EK-RA6M5 MCU can be found at `EK-RA6M5 - User's Manual`_
...
Applications for the ``ek_ra6m5`` board configuration can be
