...
Hardware
********
Detail Hardware feature for the RA6M3 MCU group can be found at `RA6M3 Group User's Manual Hardware`_

.. figure:: ra6m3-block-diagram.jpg
	:width: 442px
	:align: center
...
Applications for the ``ek_ra6m3`` board configuration can be
