...
Hardware
********
Detail Hardware feature for the RA6E1 MCU group can be found at `RA6E1 Group User's Manual Hardware`_

.. figure:: ra6e1-block-diagram.jpg
	:width: 442px
	:align: center
...
Detail Hardware feature for the FPB-RA6E1 MCU can be found at `FPB-RA6E1 - User's Manual`_
...
Applications for the ``fpb_ra6e1`` board configuration can be
