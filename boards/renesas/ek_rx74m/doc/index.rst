...
- RX74M MCU: `RX74M Group User's Manual Hardware`_
- EK-RX74M board: `EK-RX74M - User's Manual`_
...
1. Connect the USB DEBUG1 connector to a host PC. Set the DIP SW (SW6) to Debug
   on-board mode as described in `EK-RX74M - User's Manual`_
...
**********
- `EK-RX74M Website`_
- `RX74M MCU group Website`_

.. _EK-RX74M Website:
   https://www.renesas.com/en/design-resources/boards-kits/ek-rx74m

.. _RX74M MCU group Website:
   https://www.renesas.com/en/products/rx74m

.. _EK-RX74M - User's Manual:
   https://www.renesas.com/en/document/mat/ek-rx74m-v1-users-manual

.. _RX74M Group User's Manual Hardware:
   https://www.renesas.com/en/document/mah/rx74m-group-users-manual-hardware
