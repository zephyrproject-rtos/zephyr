...
Detail Hardware feature for the EK-RA6E2 MCU can be found at `EK-RA6E2 - User's Manual`_
...
Applications for the ``ek_ra6e2`` board configuration can be
