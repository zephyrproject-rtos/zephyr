...
The ``rza3ul_smarc`` board supports the following hardware features:
...
There are two options to write IPL:
  ...
  1. (Recommended) Follow ''4. Tutorial: Your First RZ MPU Project - Blinky'' of `Getting Started with RZ/A Flexible Software Package`_ to start writing a blinky sample with FSP. The IPL will be written to flash by default in debugging time.
