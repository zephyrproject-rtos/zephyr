.. zephyr:board:: ek_rx74n

Overview
********

The EK-RX74N is an Evaluation Kit for the Renesas RX74N MCU Group, part of the RX700
Series. It enables users to seamlessly evaluate the features of the RX74N MCU group
...
- Gigabit Ethernet Module (ETHM), RGMII interface
- USB High Speed and USB Full Speed, host and function
- eXpanded SPI (XSPI) interface for external OctaFlash and OctalRAM

**MCU Native Pin Access**

- 600 MHz RX74N MCU (R5K574NCB4AE) in 320-pin, LFBGA package
- Native pin access through 30 x 2-pin x 2-piece and 20 x 2-pin breakout pin headers
- MCU and USB module current measurement points for current consumption measurement
...
- 512 Mbit External OctaFlash and 256 Mbit External OctalRAM
  (present in the MCU Native Pin Access area of the EK-RX74N board)
...
- Five popular ecosystems expansions
...
- Ethernet connector (RGMII interface)
...
- RX74N MCU: `RX74N Group User's Manual Hardware`_
- EK-RX74N board: `EK-RX74N - User's Manual`_
...
Applications for the ``ek_rx74n`` board configuration can be
...
.. code-block:: console
   ...
   ***** Booting Zephyr OS v4.4.0-xxx-xxxxxxxxxxxxx *****
   Hello World! ek_rx74n

Flashing
========

Program can be flashed to EK-RX74N via the on-board E2 emulator On Board (E2OB)
...
1. Connect the USB DEBUG1 connector to a host PC. Set the DIP SW (SW6) to Debug
   on-board mode as described in `EK-RX74N - User's Manual`_
...
**********
- `EK-RX74N Website`_
- `RX74N MCU group Website`_

.. _EK-RX74N Website:
   https://www.renesas.com/en/design-resources/boards-kits/ek-rx74n

.. _RX74N MCU group Website:
   https://www.renesas.com/en/products/rx74n

.. _EK-RX74N - User's Manual:
   https://www.renesas.com/en/document/mat/ek-rx74n-v1-users-manual

.. _RX74N Group User's Manual Hardware:
   https://www.renesas.com/en/document/mah/rx74n-group-users-manual-hardware
