...
- RX74N MCU: RX74N Group User's Manual Hardware
- EK-RX74N board: EK-RX74N - User's Manual
...
1. Connect the USB DEBUG1 connector to a host PC. Set the DIP SW (SW6) to Debug
   on-board mode as described in EK-RX74N - User's Manual.
...
- EK-RX74N Website
- RX74N MCU group Website
- RX74N Group User's Manual Hardware
- EK-RX74N - User's Manual
