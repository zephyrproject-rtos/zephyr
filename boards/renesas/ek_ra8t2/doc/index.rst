.. zephyr:board:: ek_ra8t2

Overview
********

The EK-RA8T2, an Evaluation Kit for RA8T2 MCU Group, enables users to seamlessly evaluate the features
of the RA8T2 MCU group and develop embedded systems applications.
...
- Multiple clock sources - RA8T2 MCU oscillator and sub-clock oscillator crystals, providing precision
...
- RA8T2 MCU: `RA8T2 Group User's Manual Hardware`_
- EK-RA8T2 board: `EK-RA8T2 - User's Manual`_
...
The EK-RA8T2 supports dual core operation with both the Cortex-M85 (CPU0) and Cortex-M33 (CPU1) cores.
...
Applications for the ``ek_ra8t2`` board configuration can be
...
Open a serial terminal, reset the board (press the reset switch), and you should
...
.. zephyr-app-commands::
   :tool: west
   :zephyr-app: samples/hello_world
   :board: ek_ra8t2/r7ka8t2lflcac/cm33
   :goals: build flash
   :west-args: --sysbuild
...
The program can be flashed to EK-RA8T2 via the on-board SEGGER J-Link debugger.
SEGGER J-Link's drivers are available at https://www.segger.com/downloads/jlink/

To flash the program to the board:

1. Connect to J-Link OB via USB port to host PC
2. Make sure J-Link OB jumper is in default configuration as described in `EK-RA8T2 - User's Manual`_
...
.. _EK-RA8T2 Website:
   https://www.renesas.com/en/design-resources/boards-kits/ek-ra8t2

.. _RA8T2 MCU group Website:
   https://www.renesas.com/en/products/ra8t2

.. _EK-RA8T2 - User's Manual:
   https://www.renesas.com/en/document/mat/ek-ra8t2-v1-users-manual

.. _RA8T2 Group User's Manual Hardware:
   https://www.renesas.com/en/document/mah/ra8t2-group-users-manual-hardware
