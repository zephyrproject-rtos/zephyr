...
an LSM6DS3TR-C 6-axis IMU, USB HS, NFCT, and an external SPI flash (PY25Q128HA, 128 Mbit).
...
The console is available over USB CDC ACM on the USB HS port.
...
The XIAO nRF54LM20B contains a SAMD11 with CMSIS-DAP, allowing flashing, debugging, logging, etc.
over the USB port.
