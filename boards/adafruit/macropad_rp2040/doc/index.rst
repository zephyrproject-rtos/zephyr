...
The easiest way to program and debug the MacroPad RP2040 is to use the built-in
UF2 bootloader. To enter the UF2 bootloader, hold down the rotary encoder button
and, while continuing to hold it, press and release the reset button.
