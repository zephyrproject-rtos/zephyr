...
.. figure:: img/adafruit_feather_esp32s3_tft.webp
   :width: 640px
   :align: center
   :alt: Board Name
...
The current ``adafruit_feather_esp32s3_tft`` board target supports the following
hardware features:
...
board configuration. Here is an example for the
