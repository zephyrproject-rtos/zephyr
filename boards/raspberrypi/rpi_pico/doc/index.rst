...
In this sample, **RPI_PICO_DEBUG_ADAPTER** specifies what debug adapter is used for debugging.
...
You can also use other supported tools, such as `BlackMagic Probe`_,
...
Run the following command, or drag-and-dropped the uf2 file to the device,
