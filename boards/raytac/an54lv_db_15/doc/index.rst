.. zephyr:board:: raytac_an54lv_db_15

Overview
********

The Raytac AN54LV-DB-15 demonstration board is a development board based on the Raytac AN54LV-15 module.
...
The Raytac AN54LV-DB-15 has two crystal oscillators:
...
- Module Demo Board built by AN54LV-15
...
Applications for the ``raytac_an54lv_db_15/nrf54l15/cpuapp`` board can be
built, flashed, and debugged in the usual way. See
:ref:`build_an_application` and :ref:`application_run` for more details on
building and running.

.. note::
    The ``raytac_an54lv_db_15`` board does not have an on-board J-Link debug IC;
...
To build and program the sample to the Raytac AN54LV-DB-15, complete the following steps:

First, connect the Raytac AN54LV-DB-15's J10 connector to you computer using a USB to TTL
...
.. zephyr-app-commands::
   ...
   :board: raytac_an54lv_db_15/nrf54l15/cpuapp
   :goals: build flash
