.. zephyr:board:: pocketbeagle_2_industrial

Overview
********

PocketBeagle 2 Industrial is a computational platform powered by a TI AM6254 SoC.

See the `PocketBeagle 2 Industrial Product Page`_ for details.

Hardware
********

PocketBeagle 2 Industrial features the TI AM62x SoC based around an Arm Cortex-A53 multicore
...
Additionally, PocketBeagle 2 Industrial also contains an MSPM0L1105 SoC which serves as EEPROM and ADC.
...
Key differences from PocketBeagle 2:

- Industrial temperature range support
- 1GB DDR4 RAM (up from 512MB DDR4 RAM on PocketBeagle 2)
- 64GB eMMC flash (not populated on PocketBeagle 2)
...
.. zephyr-app-commands::
   :board: pocketbeagle_2_industrial/am6254/a53
...
.. note::
   Zephyr by default uses P2.5 and P2.7 as UART RX and TX respectively.
...
.. zephyr-app-commands::
   :board: pocketbeagle_2_industrial/am6254/m4
   :zephyr-app: samples/hello_world
   :goals: build
...
.. zephyr-app-commands::
   :board: pocketbeagle_2_industrial/mspm0l1105
...
* `PocketBeagle 2 Industrial Product Page`_
* `Documentation <https://docs.beagleboard.org/boards/pocketbeagle-2/index.html>`_

.. _PocketBeagle 2 Industrial Product Page:
   https://www.beagleboard.org/boards/pocketbeagle-2-industrial
