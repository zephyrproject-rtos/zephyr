...
- Setting it default entry in :file:`/boot/firmware/extlinux/extlinux.conf`.
...
.. note::
   ...
   instructions to work, a firmware that enables SWD debugging needs to be flashed. Alternatively,
   one can get the same effect by doing a power-on-reset on the mspm0l1105.
