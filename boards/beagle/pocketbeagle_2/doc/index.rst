...
Zephyr is ported to run on the both A53 cores and/or M4F core on AM62x and MSPM0L1105.
...
To test the A53 core, we build the :zephyr:code-sample:`minimal` sample with the following command.
