.. zephyr:board:: aipi_eyes_s1

Overview
********

AiPi-Eyes-S1 is a multi-functional Wi-Fi 6 + BLE5.3 development board developed
...
the back of the board. It has an ES8388 audio codec, two differential microphones and two speaker connectors. The audio section is not described by the devicetree yet.

The ``aipi_eyes_s1`` and ``aipi_eyes_s2`` boards carry the same module wired identically on
every module pin, and share their devicetree.
...
The ``aipi_eyes_s1`` board uses UART0 as default serial port. It is connected to
...
camera connector, the J9 header and the audio section.
...
+-----------+---------------------------------------------------------------+
| GPIO3     | Display data/command select                                   |
+-----------+---------------------------------------------------------------+
| GPIO4     | Display clock                                                 |
+-----------+---------------------------------------------------------------+
| GPIO5     | Display chip select                                           |
+-----------+---------------------------------------------------------------+
| GPIO6     | Audio MCLK, TF card DATA3                                     |
+-----------+---------------------------------------------------------------+
...
+-----------+---------------------------------------------------------------+
| GPIO10    | Audio I2S DI, TF card DATA1                                   |
+-----------+---------------------------------------------------------------+
| GPIO11    | Audio I2S FS, TF card CMD                                     |
+-----------+---------------------------------------------------------------+
| GPIO12    | Audio I2S DO, TF card DATA0                                   |
+-----------+---------------------------------------------------------------+
| GPIO13    | Camera reset                                                  |
+-----------+---------------------------------------------------------------+
| GPIO14    | Audio I2S BCLK                                                |
+-----------+---------------------------------------------------------------+
| GPIO23    | Camera MCLK                                                   |
+-----------+---------------------------------------------------------------+
...
pins with the display data line and the audio section.
...
#. Run your favorite terminal program to listen for output. Under Linux the
   ...
   .. code-block:: console
      ...
      *** Booting Zephyr OS build v4.4.0 ***
      Hello World! aipi_eyes_s1/bl618m05q2i

Congratulations, you have ``aipi_eyes_s1`` configured and running Zephyr.
