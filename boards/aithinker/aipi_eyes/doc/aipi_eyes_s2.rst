...
the back of the board. It has one microphone and brings I2S out to the J10 header instead of carrying an audio codec. The audio section is not described by the devicetree yet.

The ``aipi_eyes_s2`` and ``aipi_eyes_s1`` boards carry the same module wired identically on
