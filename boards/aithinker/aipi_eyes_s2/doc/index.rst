...
AiPi-Eyes-S2 is a Wi-Fi 6 + BLE5.3 module developed by Shenzhen Ai-Thinker Technology
...
- `aipi_eyes_s2 Schematics`_ (switch lang to CN if dead link)
...
#. Run your favorite terminal program to listen for output. Under Linux the
   ...
   .. code-block:: console
      ...
      *** Booting Zephyr OS build v4.3.0 ***
      Hello World! aipi_eyes_s2/bl618m65q2i
