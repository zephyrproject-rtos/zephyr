...
The WeAct STM32G474 Core Board is based on the STM32G474CBU6 microcontroller. The board provides essential features in a compact form factor with USB Type-C connectivity.
...
The ``weact_stm32g474_core`` board target supports the following hardware features:
...
+------------+------------+-------------------------------------+
| FDCAN      | on-chip    | FDCAN Controller                    |
+------------+------------+-------------------------------------+
| SPI        | on-chip    | spi                                 |
+------------+------------+-------------------------------------+
| I2C        | on-chip    | i2c                                 |
...
Key Pin Assignments (verified from schematic):
--------------------------------------------
