...
+===========================+==============+=============================================================================+==========================+=========+
| IMU                       | ICM-42670-P  | `Datasheet <https://invensense.tdk.com/download-pdf/icm-42670-p-datasheet/>` | `Link <https://crates.io/crates/icm42670>`__   | 0x68    |
+---------------------------+--------------+-----------------------------------------------------------------------------+--------------------------+---------+
| Temperature and Humidity  | SHTC3        | `Datasheet <https://www.sensirion.com/en/environmental-sensors/humidity-sensors/digital-humidity-sensor-shtc3-our-new-standard-for-consumer-electronics/>` | `Link <https://crates.io/crates/shtcx>`__       | 0x70    |
+---------------------------+--------------+-----------------------------------------------------------------------------+--------------------------+---------+
