.. zephyr:board:: lp_em_cc2340r53

Overview
********

The Texas Instruments CC2340R53 LaunchPad™ (LP_EM_CC2340R53) is a
development kit for the SimpleLink™ multi-Standard CC2340R53 wireless MCU.
...
The CC2340R53 LaunchPad™ development kit features the CC2340R53 wireless MCU.
...
Low Energy and IEEE® 802.15.4. Compared to the CC2340R5, the CC2340R53 provides
64 KiB of SRAM instead of 36 KiB.
...
This device is also supported in the `TI OpenOCD Fork`_.
...
Then you can connect with a serial terminal, for example minicom or putty with the following settings:
...
Applications for the ``CC2340R53 LaunchPad`` board configuration can be built and
...
.. _TI CC2340R53 LaunchPad Product Page:
   https://www.ti.com/tool/LP-EM-CC2340R53
