.. zephyr:board:: cc1312r1_launchxl

Overview
********

The Texas Instruments CC1312R LaunchPad™ (LAUNCHXL-CC1312R1) is a
development kit for the SimpleLink™ multi-Standard CC1312R wireless MCU.

See the `TI CC1312R1 LaunchPad Product Page`_ for details.

Hardware
********

The CC1312R LaunchPad™ development kit features the CC1312R wireless MCU.
...
The CC1312R wireless MCU has a 48 MHz Arm® Cortex®-M4F SoC and an
integrated sub-1GHz transceiver supporting the IEEE® 802.15.4g
protocol.

See the `TI CC1312R Product Page`_ for additional details.
...
| Pin   | Function  | Usage               |
+=======+===========+=====================+
| DIO2  | UART0_RX  | UART_RXD            |
+-------+-----------+---------------------+
| DIO3  | UART0_TX  | UART_TXD            |
+-------+-----------+---------------------+
...
Applications for the ``CC1312R LaunchPad`` board configuration can be built and
...
CC1312R1 LaunchPad Quick Start Guide:
  http://www.ti.com/lit/pdf/swru525

.. _TI CC1312R1 LaunchPad Product Page:
   https://www.ti.com/tool/LAUNCHXL-CC1312R1

.. _TI CC1312R Product Page:
   https://www.ti.com/product/CC1312R
