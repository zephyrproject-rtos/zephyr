...
Before OpenOCD is public, one can clone the repo `https://github.com/nmenon/openocd/tree/mspm0`, and then this can be built with
...
Then after the build, it is possible to flash the device by passing additional arguments to `west flash`
