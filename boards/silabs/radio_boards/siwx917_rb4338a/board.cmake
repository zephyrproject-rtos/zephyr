...
# Set the flash file based on whether signing is enabled.

set(FLASH_FILE ${PROJECT_BINARY_DIR}/$<IF:$<BOOL:${CONFIG_SIWX91X_SILABS_COMMANDER_SIGN}>,${KERNEL_NAME}_signed.bin.rps,${KERNEL_BIN_NAME}.rps>)
