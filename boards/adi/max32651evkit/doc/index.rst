...
To sign the firmware image, user needs to enable :kconfig:option:`CONFIG_SOC_FAMILY_MAX32_SECURE_SOC_SIGNING`
and specify the path to the private key using :kconfig:option:`CONFIG_SOC_FAMILY_MAX32_SECURE_SOC_KEY_PATH`.
...
.. zephyr-app-commands::
   ...
   :board: max32651evkit
   :goals: build
   :build-args: -DCONFIG_SOC_FAMILY_MAX32_SECURE_SOC_SIGNING=y -DCONFIG_SOC_FAMILY_MAX32_SECURE_SOC_KEY_PATH="C:/analog/SecureBootTools/devices/MAX32651/keys/maximtestcrk.key"
