...
implement ultra low-power wireless solutions using MAX32690 Arm |reg| Cortex |reg|-M4F
and Bluetooth |reg| 5.2 Low Energy (LE). The board also includes the MAX77654 PMIC
