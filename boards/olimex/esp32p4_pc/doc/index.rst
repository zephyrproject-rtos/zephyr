...
audio output, and expansion headers for application development. For more
information, see the `ESP32-P4-PC Product Page`_ and the
`ESP32-P4-PC Hardware Repository`_.
