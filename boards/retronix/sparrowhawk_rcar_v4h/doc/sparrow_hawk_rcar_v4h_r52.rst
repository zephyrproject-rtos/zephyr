.. _sparrow_hawk_rcar_v4h_boards:

Retronix Sparrow Hawk V4H
#########################
...
.. figure:: img/v4h_sparrow_hawk.jpg
   :align: center
   :alt: Retronix Sparrow Hawk

Hardware
********

Hardware capabilities of the board can be found on `Retronix Sparrow Hawk`_ page.
The below diagram shows the functionality of Renesas R-Car V4H SoC.

.. figure:: img/v4h_block_diagram.jpg
   :align: center
   :alt: R-Car V4H block diagram
...
Some terminal software support transfering file via serial using Kermit protocol. Use this U-Boot commands:
