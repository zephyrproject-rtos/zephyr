...
The W6300 is connected through a private PIO QSPI transport using GPIO 16
through GPIO 22, with the interrupt signal on GPIO 15. These signals are shared
with the board's edge connector.
