...
The OLIMEX-STM32-P103 board is based on the STMicroelectronics STM32F103RB ARM
Cortex-M3 CPU.

.. figure:: img/olimex_stm32_p103.png
     :width: 540px
     :align: center
     :height: 454px
     :alt: OLIMEX-STM32-P103
...
`OLIMEX-STM32-P103 website`_ and `OLIMEX-STM32-P103 user manual`_.
...
The olimex_stm32_p103 board configuration supports the following
hardware features:
...
.. figure:: img/olimex-stm32-p103-front.png
     :width: 739px
     :align: center
     :height: 530px
     :alt: OLIMEX-STM32-P103 connectors

     OLIMEX-STM32-P103 connectors
...
OLIMEX-STM32-P103 has two external oscillators. The frequency of
the slow clock is 32.768 kHz. The frequency of the main clock
is 8 MHz. The processor can setup HSE to drive the master clock,
which can be set as high as 64 MHz.

Programming and Debugging
*************************
The OLIMEX-STM32-P103 board does not include an embedded debug tool
...
Flashing an application to the Olimex-STM32-P103
================================================
...
.. zephyr-app-commands::
   ...
   :board: olimex_stm32_p103
   :goals: build flash

Run a serial host program to connect to the RS232 port on your board:
...
.. code-block:: console
  ...
  *** Booting Zephyr OS build v2.3.0-rc1-101-ga455ab1bf6de  ***
  Hello World! olimex_stm32_p103
...
.. _OLIMEX-STM32-P103 website:
   https://www.olimex.com/Products/ARM/ST/STM32-P103/

.. _OLIMEX-STM32-P103 user manual:
