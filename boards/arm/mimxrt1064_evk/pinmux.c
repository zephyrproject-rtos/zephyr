...
#if DT_HAS_NODELABEL_STATUS_OKAY(enet)
...
#if DT_HAS_NODELABEL_STATUS_OKAY(lcdif)
...
#if DT_HAS_NODELABEL_STATUS_OKAY(flexpwm2_pwm3)
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_09_FLEXPWM2_PWMA03, 0);
#endif

#if DT_HAS_NODELABEL_STATUS_OKAY(csi)
