...
The K22F SoC has six UARTs. One is configured for the console, another for BT
...
The FRDM-K22F includes the :ref:`nxp_opensda` serial and debug adapter built
...
:ref:`nxp_opensda_pyocd` page using the `DAPLink FRDM-K22F Firmware`_. The
...
With these mechanisms, applications for the ``frdm_k22f`` board
