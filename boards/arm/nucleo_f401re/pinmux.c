...
#ifdef CONFIG_SPI_1
	/*
	 * SPI_1 bus connects to Arduino connector and may potentially
	 * have external devices attached to it. So let raise clk and
	 * data gpios speed to avoid issue #9028.
	 */
