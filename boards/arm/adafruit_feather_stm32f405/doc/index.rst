...
Only JLink programming is supported through Zephyr at this time. Use
of the built in DFU-Util bootloader is possible by following the
instructions on the Learn website.
...
#. Connect the Adafruit Feather STM32F405 using the Jlink SWD probe.
