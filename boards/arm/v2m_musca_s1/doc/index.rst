...
This board is deprecated. The Non-Secure variant depended on TF-M,
which has removed platform support for Musca-S1, so support has been
removed from Zephyr. The secure variant of the board still builds,
but has been deprecated and will be removed in Zephyr v5.0.
