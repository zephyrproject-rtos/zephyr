...
Zephyr applications use the nrf9160_pca10090 board configuration
to run on the nRF9160 DK (PCA10090) hardware. The
nRF9160 PCA10090 is a single-board development kit for evaluation
