...
:zephyr_file:`boards/arm/cc8mnano_dvk/cc8mnano_dvk_defconfig`.
...
CC8MN DVK board was tested with the following pinmux controller
configuration.
...
The CC8MN DVK board doesn't have QSPI flash for the M4 and it needs
...
configuration is done in the file ``boards/arm/cc8mnano_dvk/cc8mnano_dvk.dts``
...
CC8MN DVK board can be debugged by connecting an external JLink
...
.. code-block:: console
   ...
   ***** Booting Zephyr OS build zephyr-v2.0.0-1859-g292afe8533c0 *****
   Hello World! cc8mnano_dvk

References
==========

.. _NXP website:
   https://www.nxp.com/design/development-boards/i.mx-evaluation-and-development-boards/evaluation-kit-for-thebr-i.mx-8m-mini-applications-processor:8MNINILPD4-EVK
