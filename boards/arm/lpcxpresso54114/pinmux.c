...
#if DT_HAS_NODELABEL_STATUS_OKAY(gpio0)
...
#if DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(flexcomm4), nxp_lpc_i2c)
...
#if DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(flexcomm5), nxp_lpc_spi)
