...
/* Red LED */
#define RED_GPIO_NAME	CONFIG_GPIO_LPC_MCUX_PORT0_NAME
#define RED_GPIO_PIN    29

/* Green LED */
#define GREEN_GPIO_NAME CONFIG_GPIO_LPC_MCUX_PORT1_NAME
#define GREEN_GPIO_PIN  10

/* Blue LED */
#define BLUE_GPIO_NAME  CONFIG_GPIO_MCUX_PORT1_NAME
