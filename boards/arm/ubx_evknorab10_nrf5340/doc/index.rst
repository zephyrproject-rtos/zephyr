...
The ubx_evknorab10_nrf5340_cpuapp build target provides support for the
application core on the NORA-B1 module. The ubx_evknorab10_nrf5340_cpunet
build target provides support for the network core on the NORA-B1 module.
