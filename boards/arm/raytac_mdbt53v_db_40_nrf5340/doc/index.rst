...
The Raytac MDBT53V-DB-40 hardware provides support for the
Nordic Semiconductor nRF5340 ARM Cortex-M4F CPU and the following devices:

The raytac_mdbt53v_db_40_nrf5340_cpuapp build target provides support for the application
core on the nRF5340 SoC. The raytac_mdbt53v_db_40_nrf5340_cpunet build target provides
