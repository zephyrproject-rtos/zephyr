.. _nucleo_wb55cg_usb_dongle:

ST Nucleo WB55CG USB Dongle
###########################

Overview
********

The Nucleo WB55CG USB dongle is a multi-protocol wireless and ultra-low-power device
...
STM32WB55CG is an ultra-low-power dual core Arm Cortex-M4 MCU 64 MHz,Cortex-M0 32MHz
...
The Zephyr nucleo_wb55cg USB dongle configuration supports the following hardware features:
...
``boards/arm/nucleo_wb55cg_dongle/nucleo_wb55cg_dongle_defconfig``
...
Applications for the ``nucleo_wb55cg_dongle`` board configuration can be built the
...
.. code-block:: console
   ...
   $ pyocd pack --install stm32wb55cg
