...
#if DT_HAS_NODELABEL_STATUS_OKAY(uart3)
	/* UART3 RX, TX */
...
#if DT_HAS_NODELABEL_STATUS_OKAY(spi0)
...
#if DT_HAS_NODELABEL_STATUS_OKAY(i2c0)
	/* I2C0 SCL, SDA */
...
#if DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(ftm3), nxp_kinetis_ftm_pwm)
...
#if DT_HAS_NODELABEL_STATUS_OKAY(flexcan0)
	/* FlexCAN0 RX, TX */
