...
#if DT_NODE_HAS_STATUS(DT_NODELABEL(spi1), okay) && defined(CONFIG_SPI)
...
#endif
#if DT_NODE_HAS_STATUS(DT_NODELABEL(spi2), okay) && defined(CONFIG_SPI)
#ifdef CONFIG_SPI_STM32_USE_HW_SS
...
#endif
#if DT_NODE_HAS_STATUS(DT_NODELABEL(adc1), okay) && defined(CONFIG_ADC)
