...
in the `Modified Reference Design`_:
...
For the ``demo`` variant, build the ``ae350_demo.fs`` image from the `Modified Reference Design`_
...
The default :zephyr:board:`tang_mega_138k_pro_dock` configuration uses XIP. Flash the application
