...
CMSIS-DAP to work, the voltage of the two halves must match.
...
daughterboard the solder jumpers at the bottom right must be bridged for
USB-C power to work.
...
Applications for the ``nrf54l15_discovery/nrf54l15/cpuapp`` board target can be
built in the usual way (see :ref:`build_an_application` for more details).

Flashing
========

The daughter board is factory-programmed with Nordic's IFMCU CMSIS-DAP.

#. Compile a Zephyr application; we'll use :zephyr:code-sample:`blinky`.

   .. zephyr-app-commands::
      :app: zephyr/samples/basic/blinky
      :board: nrf54l15_discovery/nrf54l15/cpuapp
      :goals: build
