.. zephyr:board:: nrf52840_stamp

Overview
********

The nRF52840 Stamp is a nRF52840 development board designed by Icy Electronics
, featuring the nRF52840 BLE SoC on a small stamp-like form.
...
Applications for the ``nrf52840_stamp/nrf52840`` board target can be
...
#. Compile a Zephyr application; we'll use :zephyr:code-sample:`blinky`.
   ...
   .. zephyr-app-commands::
      ...
      :board: nrf52840_stamp/nrf52840/uf2
      :goals: build
...
.. _nRF52840 Stamp:
   https://github.com/cheyao/nrf52840-microstamp
