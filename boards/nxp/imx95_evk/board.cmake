...
if(CONFIG_BOARD_NXP_SPSDK_IMAGE)
  board_set_flasher_ifnset(spsdk)

  board_runner_args(spsdk "--family=mimx9596")
  board_runner_args(spsdk "--bootloader=${ZEPHYR_HAL_NXP_MODULE_DIR}/zephyr/blobs/imx-firmware/imx95-19x19-lpddr5-evk/imx-boot-imx95-19x19-lpddr5-evk-sd.bin-flash_all")
