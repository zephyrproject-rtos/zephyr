...
+-------+-------------+---------------------------+
| PTA0  | ADC0        | ADC0 Channel 0            |
+-------+-------------+---------------------------+
| PTA1  | ADC0        | ADC0 Channel 1            |
+-------+-------------+---------------------------+
| PTA0  | CMP0        | CMP0 IN 0                 |
+-------+-------------+---------------------------+
| PTE5  | FLEXCAN0    | CAN0 TX                   |
+-------+-------------+---------------------------+
| PTE4  | FLEXCAN0    | CAN0 RX                   |
+-------+-------------+---------------------------+
