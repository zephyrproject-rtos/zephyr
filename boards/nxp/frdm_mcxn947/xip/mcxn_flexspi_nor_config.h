...
typedef struct flexspi_config {
	...
	uint32_t reserved1;
	/* [0x030-0x03b] Arguments/Parameters for device
	...
	/* [0x044-0x044] Device Type:  See Flash Type
...
typedef struct _flexspi_nor_image_config {
	union {
		flexspi_nor_config_t fcb_config;
		uint8_t fcb_data[512];
	};
	uint32_t image_version;
} flexspi_nor_image_config;
