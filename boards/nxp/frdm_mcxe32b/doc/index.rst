.. zephyr:board:: frdm_mcxe32b

Overview
********
The FRDM-MCXE32B board is a design and evaluation platform based on the NXP
MCXE32B microcontroller (MCU). The NXP MCXE32B MCU is based on dual Arm
Cortex-M7 cores, running at speeds of up to 160 MHz with a 2.97 to 5.5V supply.

Hardware
********

- MCXE32B dual Arm Cortex-M7 microcontroller running up to 160 MHz
- 4MB dual-bank on chip Flash
- 320KB SRAM + 192KB TCM
- On-board MCU-Link debugger with CMSIS-DAP
- Arduino Header, mikroBUS

For more information about the MCXE32B SoC and FRDM-MCXE32B board, refer to the
...
| PTC14 | GPIO        | Blue LED                  |
+-------+-------------+---------------------------+
| PTD5  | GPIO/EIRQ13 | User button (SW3)         |
+-------+-------------+---------------------------+
...
The MCXE32B SoC is configured to use PLL running at 160MHz as a source for
the system clock.

Serial Port
===========

The MCXE32B LPUART5 is used for the console.
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build v4.4.0-xxxx-gxxxxxxxxxxxx ***
   Hello World! frdm_mcxe32b/mcxe32b/cpu0
