...
The user buttons USER_BTN1 and USER_BTN2 is connected to onboard GPIO expander
PCAL6524 by default, but can be changed to connect to FRDM-IMX93 GPIO. An devicetree
