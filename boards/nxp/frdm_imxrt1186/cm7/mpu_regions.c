...
#define QSPI_FLASH_SIZE                 DT_REG_SIZE_BY_IDX(DT_NODELABEL(flexspi2), 1)
...
#define REGION_QSPI_FLASH_BASE_ADDRESS   DT_REG_ADDR_BY_IDX(DT_NODELABEL(flexspi2), 1)
...
#if DT_NODE_HAS_STATUS_OKAY(DT_NODELABEL(w25q128jv))
