...
Programming and Debugging (M33 in NETC MIX, M70 in M70 MIX, M71 in M71 MIX)
***************************************************************************
...
.. zephyr-app-commands::
   :zephyr-app: samples/hello_world
   :board: imx943_evk/mimx94398/m70
   :goals: build

.. zephyr-app-commands::
   :zephyr-app: samples/hello_world
   :board: imx943_evk/mimx94398/m71
   :goals: build
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build v4.2.0-803-g5537e8d9b3f1 ***
   Hello World! imx943_evk/mimx94398/m70

.. code-block:: console

   *** Booting Zephyr OS build v4.2.0-803-g2f145e66dce2 ***
   Hello World! imx943_evk/mimx94398/m71
