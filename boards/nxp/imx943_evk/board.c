 ...
 * end of PRE_KERNEL instead. Where the SoC registers its own initialization
 * under SYS_ANCHOR_soc_init, run after that too; the variants of this board
 * that have no such entry simply have no dependency.
 */
