...
- ``s32k5xxcvb/s32k566/r52``, for S32K566 Cortex-R52, code executed from CPE SRAM by default.
...
The board does not offer serial port access via the USB port or jumper header. To visualize the serial output,
a motherboard is required. Please refer to :ref:`nxp_s32k5xx_mb` shield setup for details.
...
.. code-block:: console
   ...
   west <debug/flash> --startup-args elfFile=<elf_path> coreType=<m7/cpe> loadTo=<mram/sram> core=<core_id>
