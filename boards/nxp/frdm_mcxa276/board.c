...
#define CLOCK_INIT_CORE_CLOCK               1800000000U
#define BOARD_BOOTCLOCKFROHF180M_CORE_CLOCK 1800000000U
/* System clock frequency. */
extern uint32_t SystemCoreClock;

static int frdm_mcxa276_init(void)
{
	uint32_t coreFreq;
...
SYS_INIT(frdm_mcxa276_init, PRE_KERNEL_1, CONFIG_BOARD_INIT_PRIORITY);
