.. zephyr:board:: numaker_m3351ki

Overview
********

The NuMaker M3351KI is a microcontroller platform with comprehensive peripheral integration
specially developed by Nuvoton. The NuMaker-M3351KI is based on the NuMicro® M3351
series MCU with ARM® -Cortex®-M33 core.

Features:
=========
- 32-bit Arm Cortex®-M33 M3351KICAE MCU
- Core clock up to 144 MHz
- 1024 KB embedded Dual Bank Flash and 128 KB SRAM
...
More information about the board can be found at the `NuMaker M3351KI User Manual`_.
...
More details about the supported peripherals are available in `M3351 TRM`_
...
.. _NuMaker M3351KI User Manual:
   https://www.nuvoton.com/products/microcontrollers/arm-cortex-m33-mcus/m3351-series/
.. _M3351 TRM:
   https://www.nuvoton.com/products/microcontrollers/arm-cortex-m33-mcus/m3351-series/
