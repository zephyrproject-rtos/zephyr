.. zephyr:board:: esp32s3_zero

Overview
********

The ESP32-S3-Zero is an ESP32S3 development board from Waveshare with a small footprint,
ideal for wearables and other compact projects. This board integrates complete Wi-Fi and Bluetooth
Low Energy functions and a GPIO extension port.
...
ESP32-S3-Zero includes the following features:

- Dual core 32-bit Xtensa Microprocessor (Tensilica LX7), running up to 240MHz
- Additional vector instructions support for AI acceleration
- 512KB of SRAM
- 2MB of in-package PSRAM
- 4MB of in-package flash memory
...
.. zephyr-app-commands::
   ...
   :board: esp32s3_zero/esp32s3/procpu
   :goals: build
   :west-args: --sysbuild
   :compact:
...
The usual ``flash`` target will work with the ``esp32s3_zero`` board
...
.. _ESP32-S3-Zero Waveshare Wiki: https://www.waveshare.com/wiki/ESP32-S3-Zero
