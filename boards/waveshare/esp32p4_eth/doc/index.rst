.. zephyr:board:: waveshare_esp32p4_eth

Overview
********

Waveshare ESP32-P4-ETH is a high-performance dual-core RISC-V development board
based on the ESP32-P4 chip designed by Waveshare. It supports MIPI-CSI and
MIPI-DSI interfaces, as well as common peripherals such as SPI, I2S, I2C, LED
PWM, MCPWM, RMT, ADC, UART, and TWAI\ :sup:`TM`. It also supports USB OTG 2.0
HS, Ethernet, and SDIO Host 3.0 for high-speed connectivity.
