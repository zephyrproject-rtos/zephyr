...
`Microchip M2S010-MKR-KIT Quick Start Guide <https://ww1.microchip.com/downloads/aemdocuments/documents/fpga/ProductDocuments/UserGuides/microsemi_digikey_quick_start_guide_120x180mm.pdf>`_.
...
.. list-table::
    ...
    * - ``led0``
      - ``DDRIO47PB0``
      - Exposed in Zephyr as LED0
    * - LED1
      - ``DDRIO47NB0``
      - On-board red LED
    * - LED2 / LED3
      - ``DDRIO44PB0`` and ``DDRIO44NB0``
      - Middle pair in the 8-LED bank
    * - LED4
      - ``DDRIO43PB0``
      - On-board red LED
    * - LED5
...
.. list-table::
    ...
    * - Function
      ...
      - External device
    * - Main oscillator
      - ``XTLOSC_MAIN_XTAL/EXTAL``
      - 32.768 kHz crystal
    * - Auxiliary osc.
      - ``XTLOSC_AUX_XTAL/EXTAL``
...
.. list-table::
    ...
    * - ``SPI_0_HOLD_N``
      ...
      - AT25SF161 HOLD#
    * - ``LIGHT_SDA``
      - ``MSIO4NB2 / USB_DATA3_B``
      - LTR-329ALS SDA
    * - ``LIGHT_SCL``
      - ``MSIO4PB2 / USB_DATA2_B``
      - LTR-329ALS SCL
...
.. list-table::
    ...
    * - ``MOD1_RX``
      ...
      - ESP8266 RXI
    * - ``MOD1_CE``
      - ``MSIO3NB2 / USB_DATA1_B``
      - ESP8266 CHPD
    * - ``MOD1_RST``
      - ``MSIO3PB2 / USB_DATA0_B``
      - ESP8266 reset
    * - ``MOD1_GPIO2``
      - ``MSIO0NB2 / USB_DATA7_B``
      - ESP8266 GPIO2
    * - ``MOD1_GPIO0``
      - ``MSIO5NB2 / USB_DATA5_B``
      - ESP8266 GPIO0
    * - spare routing
      - ``MSIO5PB2 / USB_DATA4_B``
      - Marked ``BANK2_UNUSED1``
    * - spare routing
      - ``MSIO6PB2 / USB_DATA6_B``
      - Marked ``BANK2_UNUSED2``
