.. zephyr:board:: pic32cz_ca90_cult

Overview
********

The PIC32CZ CA90 Curiosity Ultra development board is a hardware platform
to evaluate the Microchip PIC32CZ CA90 microcontroller, and the
development board part number is EV16W43A.
...
3. Build the Application
   ...
   .. code-block:: console
      ...
      west build -b pic32cz_ca90_cult -p -s samples/basic/blinky

   This will build the Blinky application for the ``pic32cz_ca90_cult`` board.
...
.. _PIC32CZ CA90 Curiosity Ultra User Guide:
