.. zephyr:board:: pic32cm_sg00_cpro

Overview
********

The PIC32CM SG00 Curiosity Pro evaluation kit is a hardware platform
to evaluate the Microchip PIC32CM SG microcontrollers, and the
evaluation kit part number is EA51N28A. This kit provides a comprehensive
set of features that allow users to explore the PIC32CM SG peripherals
and gain insight into integrating the device into their own designs.

Hardware
********

- 100-pin TQFP PIC32CM5112SG00100 microcontroller
...
- Programming and debugging of on-board PIC32CM SG through Serial Wire Debug (SWD) and on-board PKoB4 debugger
...
3. Build the Application
   ...
   .. code-block:: console
      ...
      west build -b pic32cm_sg00_cpro -p -s samples/basic/blinky

   This will build the Blinky application for the ``pic32cm_sg00_cpro`` board.
...
.. code-block:: json

   {
      ...
      "configurations": [
         {
               "name": "Debug (J-Link, PIC32CM5112SG00100)",
               "type": "cortex-debug",
               "request": "launch",
               "servertype": "jlink",
               "device": "PIC32CM5112SG00100",
               "interface": "swd",
...
PIC32CM SG Product Page:
   https://www.microchip.com/en-us/product/PIC32CM5112SG00100

PIC32CM SG Product Family Page:
   https://www.microchip.com/en-us/products/microcontrollers/32-bit-mcus/pic32-sam/pic32cx-sg

.. _PIC32CM SG00 Curiosity Pro evaluation kit Page:
   https://www.microchip.com/en-us/development-tool/ea51n28a
