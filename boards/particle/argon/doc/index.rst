...
The particle_argon/nrf52840 board configuration supports the following
hardware features:
...
Applications for the ``particle_argon/nrf52840`` board configuration can be
