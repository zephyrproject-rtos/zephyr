...
==================================================================
  ...
  it's a good idea to first go through this list of basic AT commands over
  a USB COM port on a PC. For reference, you can find all the AT commands for
  the HL78xx modules in the Source.
...
Set ``--shield _swir_hl78xx_ev_kit`` when you invoke ``west build``. For
example:

.. zephyr-app-commands::
   :zephyr-app: samples/driver/modem/hello_hl78xx
   :board: st/nucleo_u575zi_q
   :shield: _swir_hl78xx_ev_kit
   :goals: build
