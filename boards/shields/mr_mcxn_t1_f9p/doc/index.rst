...
The NEO-F9P requires an external multi-band GNSS antenna, attached at the
ANT1 U.FL connector.

An optional backup battery, attached at the BAT1 connector, feeds the
receiver V_BCKP pin so time and configuration survive power removal, and a
diode with a 1k series path from the GPS 3.3 V rail maintains V_BCKP while
...
- `NEO-F9P product page <https://www.u-blox.com/en/product/neo-f9p-module>`_
