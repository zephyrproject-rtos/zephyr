...
.. note::
   ...
   - To use with EK-RA8D1 board, a `LCD converter <https://oshpark.com/shared_projects/pzfp0mCD>`_
     may be needed to connect this shield to the Parallel Graphics Expansion Port (J57).
