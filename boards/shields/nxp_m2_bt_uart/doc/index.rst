...
Pins assignment of the NXP :zephyr:board:`mimxrt1060_evk` EVKC revision M.2 BT UART
======================================================================
+---------------+-----------------+---------------------------+
| Name          | Function        | Usage                     |
+===============+=================+===========================+
| GPIO_AD_B1_04 | LPUART3_CTS     | For Hardware flow-control |
+---------------+-----------------+---------------------------+
| GPIO_AD_B1_05 | LPUART3_RTS     | For Hardware flow-control |
+---------------+-----------------+---------------------------+
| GPIO_AD_B1_06 | LPUART3_TX      | For BT HCI Transmit       |
+---------------+-----------------+---------------------------+
| GPIO_AD_B1_07 | LPUART3_RX      | For BT HCI Receive        |
+---------------+-----------------+---------------------------+
