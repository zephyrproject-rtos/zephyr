...
The MB1835 shield provides a 2.47-inch round TFT-LCD with MIPI DSI interface
...
``st_mb1835`` and adding the necessary device tree properties.

Set ``--shield "st_mb1835"`` when you invoke ``west build``. For example:
...
- `MB1835 Schematic <https://www.st.com/resource/en/schematic_pack/mb1835-vdd1v8-b01-schematic.pdf>`_
