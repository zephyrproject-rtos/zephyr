...
board_runner_args(openocd --cmd-pre-init "source [find bl70xl.cfg]")
...
board_runner_args(openocd --gdb-init "mem 0x2201c000 0x22020000 rw")
board_runner_args(openocd --gdb-init "mem 0x4201c000 0x42020000 rw")
board_runner_args(openocd --gdb-init "mem 0x22020000 0x22034000 rw")
board_runner_args(openocd --gdb-init "mem 0x42020000 0x42034000 rw")
