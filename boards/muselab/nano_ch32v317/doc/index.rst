...
The MuseLab nanoCH32V317 is a development board for the RISC-V based CH32V317WCU6
SOC.
...
The QingKe V4F 32-bit RISC-V processor of the MuseLab nanoCH32V317 is clocked by an
external crystal and runs at 144 MHz.

The chip's most unique feature is an integrated Ethernet MAC and PHY that supports
100BASE-TX Ethernet.

The `WCH webpage on CH32V31x`_ contains the processor's information and the datasheet.
MuseLab nanoCH32V317 board schematics can be found on `nanoCH32V317 git repository`_.
...
.. _WCH webpage on CH32V31x: https://www.wch-ic.com/downloads/CH32V20x_30xDS0_PDF.html
