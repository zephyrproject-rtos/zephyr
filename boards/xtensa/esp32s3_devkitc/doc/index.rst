...
and Bluetooth Low Energy functions. For more information, check [1]_

Hardware
********

ESP32-S3 [2]_ is a low-power MCU-based system on a chip (SoC) with integrated 2.4 GHz Wi-Fi
...
For more information, check the datasheet at ESP32-S3 Datasheet [3]_.
...
Download and install OpenOCD from [4]_.
...
.. [3] https://www.espressif.com/sites/default/files/documentation/esp32-s3_datasheet_en.pdf
.. [4] https://github.com/openocd-org/openocd
.. [5] https://docs.espressif.com/projects/esp-idf/en/latest/esp32s3/api-guides/jtag-debugging/
