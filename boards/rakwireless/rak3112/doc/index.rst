...
The RAK3112 board is flashed using the ``esptool`` runner, which is the default for ESP32-based boards in Zephyr.
...
Run a serial terminal to connect with your board. The RAK3112's uart0 will be used for the serial console.
...
.. code-block:: console
   ...
   Hello World! rak3112/esp32s3/procpu
