...
{
	(void)pinctrl_update_states(PINCTRL_DT_DEV_CONFIG_GET(DT_NODELABEL(pwm0)), pwm0_states,
				    ARRAY_SIZE(pwm0_states));
	(void)pinctrl_update_states(PINCTRL_DT_DEV_CONFIG_GET(DT_NODELABEL(pwm1)), pwm1_states,
				    ARRAY_SIZE(pwm1_states));
	(void)pinctrl_update_states(PINCTRL_DT_DEV_CONFIG_GET(DT_NODELABEL(pwm2)), pwm2_states,
