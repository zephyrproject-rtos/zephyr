...
#if defined(CONFIG_BOARD_RAK11162_STM32WLE5XX)
...
#endif /* defined(CONFIG_BOARD_RAK11162_STM32WLE5XX) */

#if defined(CONFIG_BOARD_RAK11162_ESP32C2)
...
static const struct pinctrl_state ledc0_states[] = {
	{
		.pins = ledc0_default,
		.pin_cnt = ARRAY_SIZE(ledc0_default),
		.id = PINCTRL_STATE_DEFAULT,
	},
	{
		.pins = ledc0_sleep,
		.pin_cnt = ARRAY_SIZE(ledc0_sleep),
		.id = PINCTRL_STATE_SLEEP,
	},
};
#endif /* defined(CONFIG_PWM) */

#endif /* defined(CONFIG_BOARD_RAK11162_ESP32C2) */
