.. zephyr:board:: nrf54lv10dk

Overview
********

.. note::
   You can find more information about the nRF54LV10A SoC on the `nRF54LV10A website`_.
   For the nRF54LV10A technical documentation and other resources (such as
   SoC Datasheet), see the `nRF54L documentation`_ page.

The nRF54LV10 Development Kit hardware provides support for the Nordic Semiconductor
nRF54LV10A Arm Cortex-M33 CPU.
...
Applications for the ``nrf54lv10dk/nrf54lv10a/cpuapp`` board target can be
built, flashed, and debugged in the usual way. See
:ref:`build_an_application` and :ref:`application_run` for more details on
building and running.

Applications for the ``nrf54lv10dk/nrf54lv10a/cpuflpr`` board target need
...
.. code-block:: console
   ...
   west build -p -b nrf54lv10dk/nrf54lv10a/cpuflpr samples/hello_world --sysbuild
...
.. _nRF54LV10A website: https://www.nordicsemi.com/Products/nRF54LV10A
