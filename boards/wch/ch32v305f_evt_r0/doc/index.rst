...
The QingKe V4F 32-bit RISC-V processor of the WCH CH32V305F-EVT-R0 is clocked by an
external crystal and runs at 144 MHz.

The `WCH webpage on CH32V30x`_ contains the processor's information and the datasheet.
WCH CH32V305F-EVT-R0 board schematics can be found on `CH32V307 openwch git repository`_.
...
to change leds status to "okay" in :zephyr_file:`boards/wch/ch32v305f_evt_r0/ch32v305f_evt_r0.dts`.
