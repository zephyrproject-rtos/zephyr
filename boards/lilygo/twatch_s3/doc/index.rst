...
LILYGO T-Watch S3 is an ESP32S3 based smartwatch with the following features:
...
The board features a single micro USB connector which can be used for debug serial
as well as for JTAG flashing/debugging thanks to the integrated JTAG support in
the chip.
...
+-----------------+-------------------------------+
| PMU             | Partial                       |
|                 |    - regulators are supported |
|                 |    - battery charging not yet |
+-----------------+-------------------------------+
| RTC             | Yes                           |
+-----------------+-------------------------------+
| Hatic           | Yes                           |
