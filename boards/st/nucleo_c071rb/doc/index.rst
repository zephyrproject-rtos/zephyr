...
The Zephyr ``nucleo_c071rb`` board configuration supports the following hardware features:
...
Applications for the ``nucleo_c071rb`` board configuration can be built and
