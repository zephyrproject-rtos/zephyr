...
if(CONFIG_BUILD_WITH_TFM)
  ...
  if(CONFIG_HAS_FLASH_LOAD_OFFSET)
    MATH(EXPR TFM_HEX_BASE_ADDRESS_NS
      "${CONFIG_STM32_INT_FLASH_SECURE_BASE_ADDRESS}+${CONFIG_FLASH_LOAD_OFFSET}"
    )
  else()
    set(TFM_HEX_BASE_ADDRESS_NS ${CONFIG_STM32_INT_FLASH_SECURE_BASE_ADDRESS})
  endif()
  ...
  math(EXPR tfm_fwm_boot_address
    "${tfm_partition_offset}+${CONFIG_STM32_INT_FLASH_SECURE_BASE_ADDRESS}+0x400"
  )
