...
based on the Arm® Cortex®-A35 (1.5 GHz) and Cortex®-M33
processors.
...
- STM32MP215FAN3 microprocessor based on the Arm® Cortex®-A35 up to 1.5 GHz
  and Cortex®-M33 at 300 MHz in a VFBGA273 package
...
- External DDR memory up to 4 Gbytes
  ...
  - DDR4-1600 16-bit
  - LPDDR4-1600 16-bit
- 456-Kbyte internal SRAM: 256-Kbyte AXI SYSRAM, 64-Kbyte AHB SRAM, 128-Kbyte
  AHB SRAM with ECC in backup domain, 8-Kbyte SRAM with ECC in backup domain
...
- 3x dual master port, high-performance, general-purpose, direct memory access
  controller (HPDMA), 16 channels each
...
- 6x SPI (50 Mbit/s, including 3 with full duplex I2S audio class accuracy via internal audio PLL or external
...
set up the Cortex®-A35 core with a Linux® environment. The Cortex®-M33 core
runs Zephyr as a coprocessor, and it requires the Cortex®-A35 to load and
start the firmware using remoteproc.
