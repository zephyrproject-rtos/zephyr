...
The Zephyr nucleo_f031k6/stm32f031x6 board configuration supports the following hardware features:
...
:zephyr_file:`boards/st/nucleo_f031k6/nucleo_f031k6_stm32f031x6_defconfig`
...
Applications for the ``nucleo_f031k6/stm32f031x6`` board configuration can be built and
...
.. zephyr-app-commands::
   ...
   :board: nucleo_f031k6/stm32f031x6
   :goals: build flash
