...
the B-G474E-DPOW1 Discovery kit, based on the USB 2.0 FS Type-C |trade| connector
...
- STM32G474RET6 Arm |reg| Cortex |reg|-M4 core-based microcontroller, featuring 512 Kbytes
  of Flash memory and 128 Kbytes of SRAM, in LQFP64 package
- USB Type-C |trade| with USB 2.0 FS interface compatible with USB-PD 3.0
...
- Flexible power-supply options: ST-LINK USB VBUS or USB Type-C |trade| VBUS or external source
