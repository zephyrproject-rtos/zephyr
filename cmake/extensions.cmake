...
function(zephyr_include_directories)
  foreach(arg ${ARGV})
    ...
    target_include_directories(zephyr PUBLIC ${path})
  endforeach()
endfunction()
...
function(zephyr_system_include_directories)
  foreach(arg ${ARGV})
    ...
    target_include_directories(zephyr SYSTEM PUBLIC ${path})
  endforeach()
endfunction()

function(zephyr_compile_definitions)
  target_compile_definitions(zephyr PUBLIC ${ARGV})
endfunction()

function(zephyr_compile_options)
  target_compile_options(zephyr PUBLIC ${ARGV})
endfunction()

function(zephyr_link_libraries)
  target_link_libraries(zephyr PUBLIC ${ARGV})
endfunction()

function(zephyr_cc_option)
  foreach(arg ${ARGV})
    target_cc_option(zephyr PUBLIC ${arg})
  endforeach()
endfunction()
