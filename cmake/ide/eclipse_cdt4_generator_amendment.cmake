...
#   ${BINARY_DIR_INCLUDE_GENERATED_H}/cmake_intdef.h
...
#   ${BINARY_DIR_INCLUDE_GENERATED_H}/autoconf.h to
#   CMAKE_EXTRA_GENERATOR_C_SYSTEM_DEFINED_MACROS.
#
...
set(OUTPUT_FILE ${BINARY_DIR_INCLUDE_GENERATED_H}/cmake_intdef.h)
...
if (${_work_mode} STREQUAL "C and CXX includes, defines in Eclipse with project defines")
  ...
  message("")
  message("   -imacros ${BINARY_DIR_INCLUDE_GENERATED_H}/cmake_intdef.h")
...
if ( (${_work_mode} STREQUAL "C and CXX includes, defines in .settings - [EXPERIMENTAL]") OR
  ...
  if (${_work_mode} STREQUAL "C and CXX includes, defines in .settings with project defines - [EXPERIMENTAL]")
    file(APPEND ${OUTPUT_FILE} "\t\t\t<provider class=\"org.eclipse.cdt.managedbuilder.language.settings.providers.GCCBuiltinSpecsDetector\" console=\"false\" id=\"org.eclipse.cdt.managedbuilder.core.GCCBuiltinSpecsDetector\" keep-relative-paths=\"false\" name=\"Zephyr autoconf and SDK Compiler Settings\" parameter=\"${CROSS_COMPILE}\${COMMAND} \${FLAGS} -imacros ${BINARY_DIR_INCLUDE_GENERATED_H}/cmake_intdef.h -imacros ${AUTOCONF_H} -E -P -v -dD &quot;\${INPUTS}&quot;\" store-entries-with-project=\"true\">\n")
  else ()
...
if ( (${_work_mode} STREQUAL "C and CXX includes, defines in .cproject without __cplusplus") OR
  ...
  file(STRINGS ${BINARY_DIR_INCLUDE_GENERATED_H}/cmake_intdef.h _int_comp_def)
