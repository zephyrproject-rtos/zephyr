...
if(CONFIG_RISCV_ISA_EXT_ZICBOM)
  string(APPEND riscv_march "_zicbom")
endif()

if(CONFIG_RISCV_ISA_EXT_ZICBOZ)
  string(APPEND riscv_march "_zicboz")
endif()

if(CONFIG_RISCV_ISA_EXT_ZIC64B)
  string(APPEND riscv_march "_zic64b")
endif()
...
# T-Head extensions
if(CONFIG_RISCV_ISA_EXT_XTHEAD_BA)
  string(APPEND riscv_march "_xtheadba")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_BB)
  string(APPEND riscv_march "_xtheadbb")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_BS)
  string(APPEND riscv_march "_xtheadbs")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_CMO)
  string(APPEND riscv_march "_xtheadcmo")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_CONDMOV)
  string(APPEND riscv_march "_xtheadcondmov")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_FMEMIDX)
  string(APPEND riscv_march "_xtheadfmemidx")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_FMV)
  string(APPEND riscv_march "_xtheadfmv")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_INT)
  string(APPEND riscv_march "_xtheadint")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_MAC)
  string(APPEND riscv_march "_xtheadmac")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_MEMIDX)
  string(APPEND riscv_march "_xtheadmemidx")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_MEMPAIR)
  string(APPEND riscv_march "_xtheadmempair")
endif()
if(CONFIG_RISCV_ISA_EXT_XTHEAD_SYNC)
  string(APPEND riscv_march "_xtheadsync")
endif()
