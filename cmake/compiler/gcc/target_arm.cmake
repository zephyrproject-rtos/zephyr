...
if(CONFIG_ARM64)
  ...
  if(CONFIG_FPU)
    if    (CONFIG_FP_SOFTABI)
      list(APPEND TOOLCHAIN_C_FLAGS            -mfpu=${FPU_FOR_${GCC_M_CPU}} -mfloat-abi=softfp)
      list(APPEND TOOLCHAIN_LD_FLAGS  NO_SPLIT -mfpu=${FPU_FOR_${GCC_M_CPU}} -mfloat-abi=softfp)
    elseif(CONFIG_FP_HARDABI)
      list(APPEND TOOLCHAIN_C_FLAGS            -mfpu=${FPU_FOR_${GCC_M_CPU}} -mfloat-abi=hard)
      list(APPEND TOOLCHAIN_LD_FLAGS  NO_SPLIT -mfpu=${FPU_FOR_${GCC_M_CPU}} -mfloat-abi=hard)
    else()
