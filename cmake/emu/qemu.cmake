...
if(CONFIG_FLASH_INTEL_PFLASH_CFI01)
  ...
  if(CONFIG_RISCV)
    ...
    dt_has_chosen(has_pflash_controller PROPERTY "zephyr,flash-controller")
    if(has_pflash_controller)
      dt_chosen(pflash_controller_path PROPERTY "zephyr,flash-controller")
      dt_reg_size(pflash_size_bytes PATH "${pflash_controller_path}")
      math(EXPR PFLASH_SIZE "${pflash_size_bytes} / 1024")
    else()
