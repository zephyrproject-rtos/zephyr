...
add_custom_target(espressif_qemu_efuse_image ALL
  COMMAND ${PYTHON_EXECUTABLE} -c
    "from pathlib import Path; p=Path; data=bytes.fromhex(''.join(p(r'${ESPRESSIF_QEMU_EFUSE_HEX}').read_text().split())); p(r'${ESPRESSIF_QEMU_EFUSE_BIN}').write_bytes(data.ljust(${ESPRESSIF_QEMU_EFUSE_SIZE}, b'\\0'))"
