...
if("${ARCH}" STREQUAL "arm")
  ...
  elseif(CONFIG_CPU_CORTEX_R5)
    ...
    # Fixed logic: Only add +nofp when FPU is explicitly disabled
    if(NOT CONFIG_FPU OR NOT CONFIG_CPU_HAS_FPU)
      set(GCC_M_CPU ${GCC_M_CPU}+nofp)
    elseif(CONFIG_FPU AND CONFIG_CPU_HAS_FPU AND NOT CONFIG_VFP_FEATURE_DOUBLE_PRECISION)
      set(GCC_M_CPU ${GCC_M_CPU}+nofp.dp)
    endif()
    # For TDA4VM with full VFP: use plain cortex-r5 (no suffix)
