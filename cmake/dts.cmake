...
if(SUPPORTS_DTS)
  ...
  # A convenience for debugging. This doesn't capture dependencies on
  # devicetree bindings, so it's mostly useful for debugging
  # gen_defines itself.
  add_custom_command(
    OUTPUT ${ZEPHYR_DTS} ${DEVICETREE_CONF} ${DEVICETREE_UNFIXED_H}
    COMMAND ${CMD_NEW_EXTRACT}
    DEPENDS ${ZEPHYR_BASE}/scripts/dts/gen_defines.py
    WORKING_DIRECTORY ${PROJECT_BINARY_DIR}
    USES_TERMINAL)
  add_custom_target(gen_defines DEPENDS ${ZEPHYR_DTS})
