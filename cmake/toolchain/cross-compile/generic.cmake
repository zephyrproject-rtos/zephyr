...
# of the same name.
#
# Per-board toolchain paths are supported via
# CROSS_COMPILE_${NORMALIZED_BOARD_TARGET} with fallback to the global
# CROSS_COMPILE
#
# The env var has the lowest precedence.

zephyr_get(CROSS_COMPILE VAR CROSS_COMPILE_${NORMALIZED_BOARD_TARGET} CROSS_COMPILE)
zephyr_get(CROSS_COMPILE_TOOLCHAIN_PATH VAR CROSS_COMPILE_TOOLCHAIN_PATH_${NORMALIZED_BOARD_TARGET} CROSS_COMPILE_TOOLCHAIN_PATH)
