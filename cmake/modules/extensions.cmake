...
function(add_llext_target target_name)
  ...
  set(backup_for_reorder_sects_cmd)
  set(reorder_sects_cmd)

  if (CONFIG_LLEXT_TYPE_ELF_OBJECT)
    set(backup_for_reorder_sects_cmd
      COMMAND ${CMAKE_COMMAND} -E copy ${llext_pkg_output} ${llext_pkg_output}.bak
    )
    set(reorder_sects_cmd
