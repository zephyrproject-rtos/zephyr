...
function(kconfig_configuration_files)
  ...
  set(KCONFIG_ROOT ${KCONFIG_ROOT} PARENT_SCOPE)
  zephyr_get(KCONFIG_VARIANT_SOURCE SYSBUILD LOCAL)
  set(KCONFIG_VARIANT_SOURCE ${KCONFIG_VARIANT_SOURCE} PARENT_SCOPE)

  if(NOT DEFINED BOARD_DEFCONFIG)
    zephyr_file(CONF_FILES ${BOARD_DIRECTORIES} DEFCONFIG BOARD_DEFCONFIG)
    set(BOARD_DEFCONFIG ${BOARD_DEFCONFIG} PARENT_SCOPE)
  endif()
  ...
  if(CONF_FILE)
    ...
    set(CONF_FILE_AS_LIST ${CONF_FILE_AS_LIST} PARENT_SCOPE)
  endif()
  ...
  if(EXTRA_CONF_FILE)
    ...
    set(EXTRA_CONF_FILE_AS_LIST ${EXTRA_CONF_FILE_AS_LIST} PARENT_SCOPE)
  endif()
  ...
  if(TOOLCHAIN_HAS_NEWLIB)
    ...
    set(toolchain_has_newlib n)
  endif()

  if(TOOLCHAIN_HAS_PICOLIBC)
    set(toolchain_has_picolibc y)
  else()
    set(toolchain_has_picolibc n)
  endif()

  if(TOOLCHAIN_HAS_GLIBCXX)
    set(toolchain_has_glibcxx y)
  else()
    set(toolchain_has_glibcxx n)
  endif()

  if(TOOLCHAIN_HAS_LIBCXX)
    set(toolchain_has_libcxx y)
  else()
    set(toolchain_has_libcxx n)
  endif()
  ...
  set(APP_DIR ${APP_DIR} PARENT_SCOPE)
  ...
  set(COMMON_KCONFIG_ENV_SETTINGS
    ...
    TOOLCHAIN_HAS_NEWLIB=${toolchain_has_newlib}
    TOOLCHAIN_HAS_PICOLIBC=${toolchain_has_picolibc}
    TOOLCHAIN_HAS_GLIBCXX=${toolchain_has_glibcxx}
    TOOLCHAIN_HAS_LIBCXX=${toolchain_has_libcxx}
  ...
  set(COMMON_KCONFIG_ENV_SETTINGS ${COMMON_KCONFIG_ENV_SETTINGS} PARENT_SCOPE)
endfunction()

function(kconfig_targets)
...
function(kconfig_configuration_merging)
  ...
  set(cli_config_list ${cli_config_list} PARENT_SCOPE)

  if(extra_kconfig_options)
    set(EXTRA_KCONFIG_OPTIONS_FILE ${PROJECT_BINARY_DIR}/misc/generated/extra_kconfig_options.conf)
    set(EXTRA_KCONFIG_OPTIONS_FILE ${EXTRA_KCONFIG_OPTIONS_FILE} PARENT_SCOPE)
    file(WRITE
  ...
  if(KCONFIG_VARIANT_SOURCE)
    set(merge_config_files ${KCONFIG_VARIANT_SOURCE})
  endif()
  ...
  if(EXISTS ${DOTCONFIG} AND EXISTS ${merge_config_files_checksum_file})
    ...
    if(${merge_config_files_checksum}${merge_kconfig_checksum} STREQUAL
      ${merge_config_files_checksum_prev}
    )
...
macro(kconfig_init)
  kconfig_var_setup()
  kconfig_configuration_files()
  kconfig_targets()
  kconfig_configuration_merging()
  kconfig_import()
endmacro()
