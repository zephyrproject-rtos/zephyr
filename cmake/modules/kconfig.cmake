...
if(SYSBUILD)
  ...
  set(sysbuild_namespaces "${SYSBUILD_NAME}_;all_")
  if(SYSBUILD_MAIN_APP)
    list(INSERT sysbuild_namespaces 1 "")
  endif()
  list(JOIN sysbuild_namespaces "|" sysbuild_namespaces_regex)

  foreach (name ${sysbuild_variable_names})
    if("${name}" MATCHES "^(${sysbuild_namespaces_regex})(${KCONFIG_NAMESPACE}_.*)$")
      set(org_name ${CMAKE_MATCH_2})
      foreach(namespace IN LISTS sysbuild_namespaces)
        if(DEFINED ${org_name})
          break()
        endif()
        get_property(${org_name} TARGET sysbuild_cache PROPERTY ${namespace}${org_name})
      endforeach()
