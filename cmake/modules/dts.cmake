...
set(GEN_EXPR_NUMS_SCRIPT        ${DT_SCRIPTS}/gen_expr_nums.py)
...
set(UTIL_EXPR_NUMS_GENERATED_H  ${BINARY_DIR_INCLUDE_GENERATED}/util_expr_nums_generated.h)
...
#
# Run GEN_EXPR_NUMS_SCRIPT.
#

set(CMD_GEN_EXPR_NUMS ${PYTHON_EXECUTABLE} ${GEN_EXPR_NUMS_SCRIPT}
${DEVICETREE_GENERATED_H} --outfile ${UTIL_EXPR_NUMS_GENERATED_H}.new
)

execute_process(
	COMMAND ${CMD_GEN_EXPR_NUMS}
  WORKING_DIRECTORY ${PROJECT_BINARY_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
zephyr_file_copy(${UTIL_EXPR_NUMS_GENERATED_H}.new ${UTIL_EXPR_NUMS_GENERATED_H} ONLY_IF_DIFFERENT)
file(REMOVE ${UTIL_EXPR_NUMS_GENERATED_H}.new)
message(STATUS "Generated expr_dec_generated.h: ${UTIL_EXPR_NUMS_GENERATED_H}")
