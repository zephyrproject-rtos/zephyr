  ...
  foreach(shld ${SHIELD_AS_LIST})
    ...
    foreach (opt IN LISTS opts_list)
      ...
      elseif (${opt} MATCHES [[^([a-zA-Z_][a-zA-Z0-9_]+)(=[a-zA-Z0-9_]*)?$]])
        ...
        string(TOUPPER "SHIELD_OPTION_${derived_name}_${opt_name}" opt_fullname_upper)
	string(PREPEND definitions "#define ${opt_fullname_upper}_DEFINED 1\n")
	string(PREPEND definitions "#define ${opt_fullname_upper} ${opt_value}\n")
      endif()
    endforeach()
