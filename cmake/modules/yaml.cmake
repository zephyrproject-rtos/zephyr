...
# or 'yaml_generate(NAME <name>)' are called.
#
...
#                has to be written using 'yaml_generate()' for these to be
#                properly expanded.
#
function(yaml_set)
...
#
# Schedule writing the YAML context <name>, expanding generator expressions
# referring to the specified target, to a file. The operation will not be
# performed before this function returns; instead, the file will be written as
# a pre-build step of the specified target.
#
# NAME <name>:  Name of the YAML context
...
function(yaml_generate)
  ...
  zephyr_check_arguments_required(${CMAKE_CURRENT_FUNCTION} ARG_YAML NAME TARGET)
  internal_yaml_context_required(NAME ${ARG_YAML_NAME})
