...
function(to_yaml in_json level yaml mode)
  ...
  elseif(mode STREQUAL "TEMP_GENEX")
    # Temporary output mode, genexes will be expanded
    set(expand_lists FALSE)
    set(escape_quotes FALSE) # will be done by yaml-filter.cmake
    set(comment_genexes FALSE)
  elseif(mode STREQUAL "FINAL_GENEX")
    # Final post-processed output, genexes have already been expanded
    set(expand_lists TRUE)
    set(escape_quotes FALSE) # already done by yaml-filter.cmake
    set(comment_genexes TRUE) # (safe option, there really shouldn't be any!)
  else()
