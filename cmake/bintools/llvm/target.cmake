...
if ("${ARCH}" STREQUAL "arm")
  find_program(CMAKE_OBJCOPY ${triple}-objcopy PATH ${ZEPHYR_SDK_INSTALL_DIR}/${triple}/bin NO_DEFAULT_PATH)
  find_program(CMAKE_READELF ${triple}-readelf PATH ${ZEPHYR_SDK_INSTALL_DIR}/${triple}/bin NO_DEFAULT_PATH)
else()
