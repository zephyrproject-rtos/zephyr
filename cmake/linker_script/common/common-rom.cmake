...
if(CONFIG_SAFETY_TEST)
  zephyr_linker_section(NAME safety_test KVMA RAM_REGION GROUP RODATA_REGION)
  zephyr_linker_section_obj_level(SECTION safety_test LEVEL EARLY)
  zephyr_linker_section_obj_level(SECTION safety_test LEVEL PRE_KERNEL_1)
  zephyr_linker_section_obj_level(SECTION safety_test LEVEL PRE_KERNEL_2)
  zephyr_linker_section_obj_level(SECTION safety_test LEVEL POST_KERNEL)
  zephyr_linker_section_obj_level(SECTION safety_test LEVEL APPLICATION)
