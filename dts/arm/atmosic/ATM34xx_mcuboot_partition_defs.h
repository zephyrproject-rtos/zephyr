...
// reservation
#define ATM_FAST_CODE_SIZE (ATM_SLOT0_SIZE - ATM_SPE_SIZE \
	- ATM_IMG_TRAILER_RSVD_SIZE)
#elif (RUN_IN_FLASH == 1)
#undef ATM_SPE_SIZE
// SPE occupies the entire slot less any trailer reservation
#define ATM_SPE_SIZE (ATM_SLOT0_SIZE - ATM_IMG_TRAILER_RSVD_SIZE)
...
#define ATM_NSPE_SIZE    ATM_SLOT2_SIZE
...
#define ATM_SLOT3_NODE_ID           cece0061
