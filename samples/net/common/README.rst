...
features like Wireguard VPN support.
...
.. warning::
   ...
   Also the IPv4 and IPv6 addresses used in the samples are not to be used
   in any live network. These IPv4 and IPv6 addresses are meant for documentation
   use only and are not routable.
