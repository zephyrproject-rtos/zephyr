...
static APP_BMEM u8_t rx_buffer[APP_MQTT_BUFFER_SIZE];
static APP_BMEM u8_t tx_buffer[APP_MQTT_BUFFER_SIZE];
...
static APP_BMEM struct sockaddr_storage socks5_proxy;
#endif
