...
static struct net_app_ctx udp6[CONFIG_NET_TC_COUNT];
#endif
#if defined(CONFIG_NET_IPV4)
static struct net_app_ctx udp4[CONFIG_NET_TC_COUNT];
#endif
...
struct configs {
	struct data ipv4[CONFIG_NET_TC_COUNT];
	struct data ipv6[CONFIG_NET_TC_COUNT];
};

static struct configs conf = {
	.ipv4 = {
		[0 ... (CONFIG_NET_TC_COUNT - 1)] = {
			.proto = "IPv4",
			.family = AF_INET,
		}
	},
