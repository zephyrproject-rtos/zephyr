...
To do this set `MEASURE_WITH_COMPENSATION` to `1` in the source file.
...
To make use of the heater set `USE_HEATER` to `1` in the source file.
...
for the :ref:`blackpill_f411ce` board, as well as an overlay config to redirect
the console output to USB.
