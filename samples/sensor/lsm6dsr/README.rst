...
LSM6DSR: IMU sensor Monitor
###########################

Overview
********
This sample sets the LSM6DSR accelerometer and gyroscope to 104Hz
...
.. note:: The magn row is displayed only when running sample onto 96b_argonkey board, where a magnetometer is connected to LSM6DSR.
