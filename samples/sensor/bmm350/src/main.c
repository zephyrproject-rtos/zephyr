			    ...
			    const struct sensor_trigger *trig)
{
	...
	report_mag[0] = (float)mag[0].val1 + (float)mag[0].val2 / 100.0;
	report_mag[1] = (float)mag[1].val1 + (float)mag[1].val2 / 100.0;
	report_mag[2] = (float)mag[2].val1 + (float)mag[2].val2 / 100.0;
