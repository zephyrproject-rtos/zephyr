...
The application works as a Hands-Free Gateway. After the Bluetooth Host stack is initialized, the
GAP discovery procedure will be started automatically. The target device is Hands-Free Unit (The
major of COD is 0x04 (:c:macro:`BT_COD_MAJOR_AUDIO_VIDEO`), the minor of the COD is 0x02
...
.. graphviz::
   ...
   digraph bluetooth_hfp_ag {
       ...
       subgraph cluster_hf {
           ...
           HFP_APP [label="HFP AG Application"];
       ...
       BT_HOST -> HFP_APP [label="AG Callbacks"];
       HFP_APP -> BT_HOST [label="AG APIs"];
