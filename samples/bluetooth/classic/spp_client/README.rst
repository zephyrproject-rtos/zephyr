...
This sample scans for BR/EDR devices, prefers a peer named ``spp_server`` (falling
back to the strongest RSSI), discovers the standard Serial Port service
(UUID 0x1101) via SDP, opens an RFCOMM channel, and sends periodic test data.
