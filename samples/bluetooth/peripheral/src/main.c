...
static struct bt_gatt_attr attrs[] = {
	...
	BT_GATT_CCC(0x0008, hrmc_ccc_cfg, hrmc_ccc_cfg_changed),
	...
	BT_GATT_DESCRIPTOR(&blvl_uuid, BT_GATT_PERM_READ, read_blvl, NULL,
			   &battery),
	BT_GATT_CCC(0x0010, blvl_ccc_cfg, blvl_ccc_cfg_changed),
	...
	BT_GATT_DESCRIPTOR(&ct_uuid, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
			   read_ct, write_ct, ct),
	BT_GATT_CCC(0x0014, ct_ccc_cfg, ct_ccc_cfg_changed),
