...
#define AVAILABLE_SOURCE_CONTEXT (BT_AUDIO_CONTEXT_TYPE_UNSPECIFIED | \
				  ...
				  BT_AUDIO_CONTEXT_TYPE_MEDIA | \
				  BT_AUDIO_CONTEXT_TYPE_GAME)
#define SUPPORTED_FRAME_SIZE_MIN STREAM_TX_MIN_SDU_SIZE
#define SUPPORTED_FRAME_SIZE_MAX STREAM_TX_MAX_SDU_SIZE

static const struct bt_audio_codec_cap lc3_codec_cap = BT_AUDIO_CODEC_CAP_LC3(
	BT_AUDIO_CODEC_CAP_FREQ_ANY, BT_AUDIO_CODEC_CAP_DURATION_10,
	BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(1), SUPPORTED_FRAME_SIZE_MIN,
	SUPPORTED_FRAME_SIZE_MAX, 1u,
