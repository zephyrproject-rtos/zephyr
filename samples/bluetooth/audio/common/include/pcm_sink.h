...
#ifndef ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_PCM_SINK_H_
#define ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_PCM_SINK_H_
 ...
 * implementation (pcm_sink_i2s.c, or pcm_sink_none.c for decode-only builds)
 * owns the final transport and, where applicable, the external codec.
 */
...
#endif /* ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_PCM_SINK_H_ */
