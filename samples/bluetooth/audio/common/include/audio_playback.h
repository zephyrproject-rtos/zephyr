...
#ifndef ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_AUDIO_PLAYBACK_H_
#define ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_AUDIO_PLAYBACK_H_
...
#endif /* ZEPHYR_SAMPLES_BLUETOOTH_AUDIO_COMMON_AUDIO_PLAYBACK_H_ */
