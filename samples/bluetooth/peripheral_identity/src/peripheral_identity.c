...
#if defined(CONFIG_BT_GATT_CLIENT)
static void conn_write_cmd(struct bt_conn *conn, void *data)
{
...
#if defined(CONFIG_BT_GATT_CLIENT)
				printk("Write Command to all connected...\n");
				bt_conn_foreach(BT_CONN_TYPE_LE, conn_write_cmd, NULL);
#endif /* CONFIG_BT_GATT_CLIENT */
