...
Using the controller with a Zephyr host
=======================================

This is describes how to hook up a board running this sample to a board running
...
Then it's just a matter of physically connecting the RX, TX (RTS, CTS if
flow-control) lines together.
