.. zephyr:code-sample:: ble_peripheral_gap_svc
   :name: Peripheral GAP service non default implementation
   :relevant-api: bluetooth

   Implement a dummy peripheral with GAP service that limits the accepted names
...
Additionally the fact that the name has been change would be logged immediately.
