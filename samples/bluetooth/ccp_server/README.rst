.. zephyr:code-sample:: bluetooth_ccp_server
...
This sample can be found under :zephyr_file:`samples/bluetooth/ccp_server` in the Zephyr tree.
...
.. zephyr-app-commands::
   :zephyr-app: samples/bluetooth/ccp_server/
