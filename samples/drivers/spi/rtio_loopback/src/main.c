...
#define SAMPLE_SPI_CONTROLLER_CONFIG \
	(SPI_WORD_SET(8) | SAMPLE_CONFIG_MODE | SAMPLE_CONFIG_BIT_ORDER | SPI_OP_MODE_CONTROLLER)

#define SAMPLE_SPI_TARGET_CONFIG \
	(SPI_WORD_SET(8) | SAMPLE_CONFIG_MODE | SAMPLE_CONFIG_BIT_ORDER | SPI_OP_MODE_PERIPHERAL)
