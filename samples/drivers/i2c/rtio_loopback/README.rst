.. zephyr:code-sample:: i2c-rtio-loopback
   ...
   Demo I2C transfers between I2C controller and custom I2C target using RTIO.
...
Any board which meets the requirenments must use an overlay to specify which
