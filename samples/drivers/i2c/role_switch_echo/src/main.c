 ...
 *
 * Minimal I2C role-switch echo sample.
 *
 * Two boards are used:
...
#error "role_switch_i2c alias target is not enabled in the overlay"
#endif
...
#if defined(CONFIG_ROLE_SWITCH_ECHO_ROLE_REQUESTER) || \
	defined(CONFIG_ROLE_SWITCH_ECHO_ROLE_RESPONDER)
...
#if defined(CONFIG_ROLE_SWITCH_ECHO_ROLE_RESPONDER)
...
#endif /* CONFIG_ROLE_SWITCH_ECHO_ROLE_RESPONDER */
...
#endif /* CONFIG_ROLE_SWITCH_ECHO_ROLE_REQUESTER */
