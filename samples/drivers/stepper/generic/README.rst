.. zephyr:code-sample:: stepper_generic
   :name: Stepper generic
   :relevant-api: stepper_interface


   Rotate a generic stepper motor in 4 different modes.
...
and continuous_anticlockwise. The sample also demonstrates how to use the stepper callback to
change the direction of the stepper after a certain number of steps.

Use ``sw0`` to change the mode of the stepper.
