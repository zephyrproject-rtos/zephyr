...
This sample demonstrates how to use the Local Interconnect Network (LIN) API to control an RGB LED
...
the LIN bus on the EK-RA8M1 board, an external LIN bus transceiver :ref:`mikroe_lin_click_shield` must be
