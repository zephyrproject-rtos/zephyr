...
#define ADGM3121_NODE DT_COMPAT_GET_ANY_STATUS_OKAY(adi_adgm3121)
#elif DT_HAS_COMPAT_STATUS_OKAY(adi_adgm3121_gpio)
#define ADGM3121_NODE DT_COMPAT_GET_ANY_STATUS_OKAY(adi_adgm3121_gpio)
#endif
