.. zephyr:code-sample:: espressif_rmt_bytes_encoder
   :name: Espressif RMT with bytes encoder
   :relevant-api: espressif_rmt

   Espressif RMT loopback application to demonstrate API usage with bytes encoder.

Overview
********

This sample sends a RMT signal on one pin and read it back on another pin using Espressif RMT and bytes encoder.
...
.. zephyr-app-commands::
   :zephyr-app: samples/drivers/misc/espressif_rmt/bytes_encoder
