...
void pufs_rsa2048_verify_test(const struct device *dev)
{
	...
	struct sign_ctx lvCipherCtx = {0};
	struct sign_pkt lvCipherPkt = {0};

	const uint8_t pub_key[272] = {0}; // TODO Fill
	const uint8_t sig[256] = {0}; // TODO Fill
	const uint8_t *in_buf = "RSA2048 Signature Verification Test";
