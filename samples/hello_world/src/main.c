...
void pufs_rsa2048_verify_test(const struct device *pufs)
{
	...
	const uint8_t pub_key[] = {
		};

	const uint8_t sig[] = {
		};

	const uint32_t in_buf[] = {
		0x001c0001, 0x31303050, 0x31303043, 0x00000001, 0x00000800, 0x000007ac, 0xc1d80142,
		0x4c425346, 0x00010001, 0x00000001, 0x00000540, 0xa020005c, 0xa020005c, 0x00000040,
		0x00000000, 0x00000020, 0x00000104, 0x1c000100, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0xd4ac0000, 0x01180000, 0x61e02000, 0x80800004, 0x00001187, 0x00461e02,
		0x18780800, 0xe0200001, 0x80000461, 0x00118780, 0x461e0200, 0x78080000, 0x20000118,
		0x000461e0, 0x11878080, 0x1e020000, 0x08000046, 0x00011878, 0x0461e020, 0x87808000,
		0x02000011, 0x0000461e, 0x01187808, 0x61e02000, 0x80800004, 0x00001187, 0x00461e02,
		0x18780800, 0xe0200001, 0x80000461, 0x00118780, 0x461e0200, 0x78080000, 0x20000118,
		0x000461e0, 0x11878080, 0x1e020000, 0x08000046, 0x00011878, 0x0461e020, 0x87808000,
		0x02000011, 0x0000461e, 0x01187808, 0x61e02000, 0x80800004, 0x00001187, 0x00461e02,
		0x18780800, 0xe0200001, 0x80000461, 0x00118780, 0x461e0200, 0x78080000, 0x40080018,
		0x200061e0, 0x01878100, 0x1e040080, 0x10020006, 0x08001878, 0x0061e040, 0x87810020,
		0x04008001, 0x0200061e, 0x00187810, 0x61e04008, 0x81002000, 0x00800187, 0x00061e04,
		0x18781002, 0xe0400800, 0x00200061, 0x80018781, 0x061e0400, 0x78100200, 0x40080018,
		0x200061e0, 0x01878100, 0x1e040080, 0x10020006, 0x08001878, 0x0061e040, 0x87810020,
		0x04008001, 0x0200061e, 0x00187810, 0x61e04008, 0x81002000, 0x00800187, 0x00061e04,
		0x18781002, 0xe0400800, 0x00200061, 0x80018781, 0x061e0400, 0x78100200, 0x40080018,
		0x200061e0, 0x01878100, 0x1e040080, 0x10020006, 0x08001878, 0x0061e040, 0x87810020,
		0x04008001, 0x0200061e, 0x1e01f810, 0x00000000, 0x02000600, 0x00187810, 0x61e04008,
		0x81002000, 0x00800187, 0x00061e04, 0x18781002, 0xe0400800, 0x00200061, 0x80018781,
		0x061e0400, 0x78100200, 0x40080018, 0x200061e0, 0x01878100, 0x1e040080, 0x10020006,
		0x08001878, 0x0061e040, 0x87810020, 0x04008001, 0x0200061e, 0x00187810, 0x61e04008,
		0x81002000, 0x00800187, 0x00061e04, 0x18781002, 0xe0400800, 0x00200061, 0x80018781,
		0x30f02004, 0xc0801000, 0x004000c3, 0x00030f02, 0x0c3c0801, 0xf0200400, 0x80100030,
		0x4000c3c0, 0x030f0200, 0x3c080100, 0x2004000c, 0x100030f0, 0x00c3c080, 0x0f020040,
		0x08010003, 0x04000c3c, 0x0030f020, 0xc3c08010, 0x02004000, 0x0100030f, 0x000c3c08,
		0x30f02004, 0xc0801000, 0x004000c3, 0x00030f02, 0x0c3c0801, 0xf0200400, 0x80100030,
		0x00f00fc0, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
		...
		0xef695fb9, 0xc4035b37, 0x561d8df3, 0x3db697ad, 0x97919c2a, 0xf29db8c2, 0xd4601533,
		0x59a15ea8, 0x96579a15, 0x9dae26fc, 0x77bfba25, 0x50e72678, 0xcff13b7b, 0x5d80dad3,
		0xc5afd1cd, 0x37b0691a, 0x8a3cde61, 0xfb352d13, 0x0587d910, 0x9323e6f0, 0x8a9fb36c,
		0x625b02e4, 0x85478c0c, 0x445e4730, 0x95fd91d3, 0x6550c9e0, 0x2b6efaf1, 0x3ed2dd48,
		0xdc81f442, 0xddcb4ab2, 0x3638e061, 0x933f0644, 0xff9b804f, 0xfa1a08bb, 0x722d28af,
		0x79587927, 0x4596cb4e, 0x78d44112, 0xea2632d9, 0x9218d959, 0xf714f8a3, 0xeca567c8,
		0x7aa8c686, 0xb355a925, 0x8e365649, 0xab3b252b, 0xfd6c64e7, 0x30b5235e, 0x6eefad43,
		0x2acfed69, 0xbec0f7ba, 0x40d0e6f0, 0x5cc0e5cf, 0x2ca160a5, 0xfad8d3e6, 0xc57ee25c,
		0x85191288, 0x75741093, 0x8f219cad, 0xb0f422cd, 0xfc9fecae, 0x130361de, 0x541f1d4f,
		0x8261ecfd, 0xa554c3b8, 0x00007ef9, 0x00000004, 0x00000000, 0xa558d2c0, 0x00007ef9,
		0xa557a038, 0x00007ef9, 0xa5576900, 0x00007ef9, 0x00000005, 0x00000000, 0xa558d2c0,
		0x00007ef9, 0xa557a040, 0x00007ef9, 0xa5576900, 0x00007ef9, 0xbfaab6b0, 0x00005cf3,
		0xa5576700};
	...
	lvSignPkt.in_buf = (uint8_t *)in_buf;
	lvSignPkt.in_len = sizeof(in_buf);

	lvStatus = sign_begin_session(pufs, &lvSignCtx, CRYPTO_SIGN_ALGO_RSA2048);
	if (lvStatus != 0) {
		printf("%s sign_begin_session Failed! %s\n", ATTR_ERR, ATTR_RST);
	} else {
		printf("%s sign_begin_session Success! %s\n", ATTR_INF, ATTR_RST);
		printf("%s in_buf_addr:0x%08x in_buf_len:%d bytes %s\n", ATTR_INF,
