...
void pufs_decryption_test(const struct device *pufs)
{
	...
	Key: 0x30,0x13,0x53,0x33,0x44,0x12,0xff,0x22,0x31,0x53,0xbb,0x13,0x07,0x19,0x84,0x0d,0xd5,0x3c,0x3f,0xc0,0x09,0x83,0x11,0x35,0x30,0x2d,0xdc,0xc0,0x0b,0xb9,0x4e,0x30

	Cipher Text: 0x9c,0x87,0xe4,0xef,0xd5,0xeb,0xf3,0xb7,0xb6,0xff,0x58,0xfb,0x05,0x5b,0x26,0xa5,0x61,0xd9,0xaa,0xf4,0xa1,0x3c,0xb2,0x28,0x94,0xe3,0x49,
	0x91,0xba,0xc0,0x46,0x83,0x60,0x86,0xb2,0x6e,0xf0,0x59,0xa6,0x6c,0xc8,0x21,0xb1,0x4f,0xfc,0x55,0x6a,0x45,0x8a,0x1d,0xd8,0x03,0x48,0xc3,0xe4,0x68,0x32,
	0xd8,0x7e,0x40,0x9e,0xf7,0x88,0x57
	*/
	int lvStatus = 0;
	struct cipher_ctx lvCipherCtx = {0};
	struct cipher_pkt lvCipherPkt = {0};

	const uint8_t enc32_key[] = {
									0x30,0x13,0x53,0x33,
									0x44,0x12,0xff,0x22,
									0x31,0x53,0xbb,0x13,
									0x07,0x19,0x84,0x0d,
	...
	const uint8_t cipher_text[] = {
									0x9c,0x87,0xe4,0xef,0xd5,0xeb,0xf3,0xb7,
									0xb6,0xff,0x58,0xfb,0x05,0x5b,0x26,0xa5,
									0x61,0xd9,0xaa,0xf4,0xa1,0x3c,0xb2,0x28,
									0x94,0xe3,0x49,0x91,0xba,0xc0,0x46,0x83,
									0x60,0x86,0xb2,0x6e,0xf0,0x59,0xa6,0x6c,
									0xc8,0x21,0xb1,0x4f,0xfc,0x55,0x6a,0x45,
									0x8a,0x1d,0xd8,0x03,0x48,0xc3,0xe4,0x68,
									0x32,0xd8,0x7e,0x40,0x9e,0xf7,0x88,0x57
								 };

	const uint8_t *plain_text = "This is Junaid Aslam from Rapid Silicon doing Decryption Test...";
	const uint8_t decrypted_text[256] = {0};
...
int main(void)
{
	...
	if((pufs == NULL) || (!device_is_ready(pufs))) {
		...
		pufs_decryption_test(pufs); while(true);
		pufs_hash_test(pufs);
