...
#define BT_MESH_MODEL_OP_SENS_CAD_GET		BT_MESH_MODEL_OP_2(0x82, 0x34)
#define BT_MESH_MODEL_OP_SENS_CAD_SET		BT_MESH_MODEL_OP_1(0x55)
#define BT_MESH_MODEL_OP_SENS_CAD_SET_UNACK	BT_MESH_MODEL_OP_1(0x56)
...
#define BT_MESH_MODEL_OP_SENS_CAD_STATUS	BT_MESH_MODEL_OP_1(0x57)
