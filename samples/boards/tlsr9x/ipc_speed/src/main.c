...
int main(void)
{
	static uint8_t tx_buf[CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE] = {
		0xff, 0xff, 0xff, 0xff,
	}; /* Fill ID */

	static const size_t block_len[] = {
		4,
		CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 16 < 4 ?
			4 : CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 16,
		CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 8  < 4 ?
			4 : CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 8,
		CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 4  < 4 ?
			4 : CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 4,
		CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 2  < 4 ?
			4 : CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE / 2,
		CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE      < 4 ?
			4 : CONFIG_IPC_SERVICE_ICMSG_CB_BUF_SIZE,
	};
