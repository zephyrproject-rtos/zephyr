...
This application can be built with **sysbuild** and **SB_CONFIG_BOOTLOADER_MCUBOOT**
West flash will Download the build/mcuboot/zephyr/zephyr.bin at internal flash address 0x08000000
and the build/hello_world_xip/zephyr/zephyr.signed.bin at internal flash address 0x90000000 (chosen zephyr,code-partition)
...
.. zephyr-app-commands::
   ...
   :board: stm32h573i_dk
   :goals: run
   :west-args: --sysbuild -- -DSB_CONFIG_BOOTLOADER_MCUBOOT=y
   :compact:
