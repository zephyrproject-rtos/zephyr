...
const struct espi_vw_znames vw_names[] = {
	...
	{ ESPI_VWIRE_SIGNAL_SLV_BOOT_STS,	0x05u, 3, 1, "TARGET_BOOT_STS" },
	{ ESPI_VWIRE_SIGNAL_ERR_NON_FATAL,	0x05u, 2, 1, "ERR_NON_FATAL" },
	{ ESPI_VWIRE_SIGNAL_ERR_FATAL,		0x05u, 1, 0, "ERR_FATAL" },
	{ ESPI_VWIRE_SIGNAL_SLV_BOOT_DONE,	0x05u, 0, 1, "TARGET_BOOT_DONE" },
	...
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_0,		0x50u, 0, 1, "TARGET_GPIO_0" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_1,		0x50u, 1, 1, "TARGET_GPIO_1" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_2,		0x50u, 2, 1, "TARGET_GPIO_2" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_3,		0x50u, 3, 0, "TARGET_GPIO_3" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_4,		0x51u, 0, 1, "TARGET_GPIO_4" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_5,		0x51u, 1, 1, "TARGET_GPIO_5" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_6,		0x51u, 2, 1, "TARGET_GPIO_6" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_7,		0x51u, 3, 1, "TARGET_GPIO_7" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_8,		0x52u, 0, 1, "TARGET_GPIO_8" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_9,		0x52u, 1, 1, "TARGET_GPIO_9" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_10,	0x52u, 2, 1, "TARGET_GPIO_10" },
	{ ESPI_VWIRE_SIGNAL_SLV_GPIO_11,	0x52u, 3, 1, "TARGET_GPIO_11" },
};
