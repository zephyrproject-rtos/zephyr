...
void dspStart(void)
{
	...
	nxp_rtxxx_adsp_ctrl_load_section(adsp,
		adsp_img_reset_start, adsp_img_reset_size, NXP_RTXXX_ADSP_CTRL_SECTION_RESET);
	nxp_rtxxx_adsp_ctrl_load_section(adsp,
		adsp_img_text_start, adsp_img_text_size, NXP_RTXXX_ADSP_CTRL_SECTION_TEXT);
	nxp_rtxxx_adsp_ctrl_load_section(adsp,
		adsp_img_data_start, adsp_img_data_size, NXP_RTXXX_ADSP_CTRL_SECTION_DATA);
