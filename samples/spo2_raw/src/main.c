 ...
 * @brief This is a Baremetal SpO2 sensor Driver file for Mindgrove Silicon.This file contains the code to print the raw data retrived from the SpO2 module i.e the RED and IR value used to obtain the Heartrate and oxygen level.The module compatible for this code is MAX30100.
 * @date 2024-01-29
 *
