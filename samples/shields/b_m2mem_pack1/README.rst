...
The sample runs on any board that provides the ST M.2 serial memory connector
and the board-side Devicetree labels listed in the
:ref:`st_b_m2mem_pack1_shield` shield documentation. For this example, we use a
:zephyr:board:`nucleo_u3c5zi_q` board.

Select the shield variant that matches the fitted module:
