...
typedef struct
{
	...
	lv_obj_t *screen_1;
	bool screen_1_del;
	lv_obj_t *screen_1_foot;
	lv_obj_t *screen_1_man;
	lv_obj_t *screen_1_step_count;
	lv_obj_t *screen_1_hour;
	lv_obj_t *screen_1_label_3;
	lv_obj_t *screen_1_mins;
	lv_obj_t *screen_1_date;
	lv_obj_t *screen_1_slash;
...
LV_IMG_DECLARE(_Apple_Watch_Wallpaper_240x240);
LV_IMG_DECLARE(_icn_step_red_alpha_12x15);
