...
/* EXPORT__SYMBOL is just to shut checkpatch.pl up */
#define EXPORT__SYMBOL EXPORT_SYMBOL
EXPORT__SYMBOL(z_arm_thread_is_in_user_mode);
#undef EXPORT__SYMBOL
...
EXPORT_SYSCALL(k_event_init);
EXPORT_SYSCALL(k_event_wait);
