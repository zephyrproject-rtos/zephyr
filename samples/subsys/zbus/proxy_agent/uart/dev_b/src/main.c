...
#define PROXY_NODE DT_NODELABEL(uart_proxy_agent)
...
ZBUS_SHADOW_CHAN_DEFINE(request_channel,      /* Chan name */
			   struct request_data,  /* Message type */

			   PROXY_NODE,           /* Proxy agent name */
			   NULL,                 /* User data */
			   ZBUS_OBSERVERS_EMPTY, /* Observers */
			   ZBUS_MSG_INIT(0));    /* Initial value */

ZBUS_CHAN_DEFINE(response_channel,     /* Chan name */
...
ZBUS_PROXY_ADD_CHAN(PROXY_NODE, response_channel);
