...
without predeclaring the list of IDs. Each enumeration function holds
``fs->zms_lock`` for the duration of the traversal, to block writes from other
threads while iterating.
