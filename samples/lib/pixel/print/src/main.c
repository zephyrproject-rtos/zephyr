...
void print_image(void)
{
	...
	LOG_INF("hexdump:");
	pixel_hexdump_rgb24(rgb24frame, sizeof(rgb24frame), 16, 32);

	LOG_INF("truecolor:");
	pixel_print_buffer_truecolor(rgb24frame, sizeof(rgb24frame), 16, 32, VIDEO_PIX_FMT_RGB24);

	LOG_INF("256color:");
	pixel_print_buffer_256color(rgb24frame, sizeof(rgb24frame), 16, 32, VIDEO_PIX_FMT_RGB24);
}
