...
K_MSGQ_DEFINE(tty_msgq, sizeof(struct rpmsg_rcv_msg),16, 4); /* 16 messages * 20ms per frames
	                                                        covers 320ms of data */
...
platform_create_rpmsg_vdev(rpmsg_ns_bind_cb ns_cb)
{
