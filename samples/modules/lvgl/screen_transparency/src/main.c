...
static void initialize_gui(void)
{
	...
	/* Offsets are scaled relative to the default font's line height. */
	int32_t lh = lv_font_get_line_height(font);
