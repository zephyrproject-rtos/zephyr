...
foreach(image ${DEFAULT_IMAGE} swapped_app)
  ...
  if(NOT SB_CONFIG_SAMPLE_TFM_MCUBOOT_ENCRYPTION_NONE)
    set_config_int(${image} CONFIG_TFM_MCUBOOT_ENCRYPTION_KEY_LEN
      ${SB_CONFIG_SAMPLE_TFM_MCUBOOT_ENCRYPTION_KEY_LEN})
  endif()
endforeach()
...
# String from swapped_app/src/main.c
set(swapped_app_string "Swapped application booted")
...
add_custom_target(check_swapped_app_encryption ALL
  COMMAND ${CMAKE_COMMAND}
    ...
    -DSEARCH_STRING=${swapped_app_string}
