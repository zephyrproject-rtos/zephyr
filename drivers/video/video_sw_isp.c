...
static const struct video_format_cap fmts_in[] = {
	VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_RGB24), VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_RGB565),
	VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_YUYV),  VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_RGGB8),
	VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_GRBG8), VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_BGGR8),
	VIDEO_SW_ISP_FORMAT_CAP(VIDEO_PIX_FMT_GBRG8), {0},
};
