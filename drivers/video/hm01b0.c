...
#define HM01B0_CCI_INTEGRATION        HM01B0_REG16(0x0202)
#define HM01B0_CCI_ANALOG_GAIN        HM01B0_REG8(0x0205)
#define HM01B0_CCI_DIGITAL_GAIN       HM01B0_REG16(0x020E)
...
struct video_reg hm01b0_default_regs[] = {
	...
	{HM01B0_CCI_INTEGRATION,	0x0108},	/* Integration H           [Def: 0x01] */
	{HM01B0_CCI_ANALOG_GAIN,	0x00},	/* Analog Global Gain      [Def: 0x00] */
	{HM01B0_CCI_DAMPING_FACTOR,	0x20},	/* Damping Factor          [Def: 0x20] */
	{HM01B0_CCI_DIGITAL_GAIN,	0x0100},	/* Digital Gain High       [Def: 0x01] */
