...
#define DT_DRV_COMPAT omnivision_ov7725
#include <zephyr.h>
#include <device.h>
...
static struct ov7725_reg ov7725_init_reg_tb[] = {
	/*Output config*/
	{ OV7725_CLKRC,          0x00 },
	{ OV7725_COM7,           0x06 },
	{ OV7725_HSTART,         0x3f },
...
DEVICE_AND_API_INIT(ov7725, DT_INST_LABEL(0), &ov7725_init_0,
		    &ov7725_data_0, NULL,
