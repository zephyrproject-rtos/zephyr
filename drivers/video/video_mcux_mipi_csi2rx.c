...
static const struct mipi_csi2rx_config mipi_csi2rx_config_0 = {
	.base = (MIPI_CSI2RX_Type *)DT_INST_REG_ADDR(0),
	.sensor_dev = DEVICE_DT_GET(DT_INST_PHANDLE(0, sensor)),
};

static struct mipi_csi2rx_data mipi_csi2rx_data_0;

static int mipi_csi2rx_init_0(const struct device *dev)
{
	const struct mipi_csi2rx_config *config = dev->config;
...
DEVICE_DT_INST_DEFINE(0, &mipi_csi2rx_init_0, NULL, &mipi_csi2rx_data_0,
		      &mipi_csi2rx_config_0, POST_KERNEL, CONFIG_VIDEO_INIT_PRIORITY,
