...
static const struct video_format_cap ov7670_fmts[] = {
	VIDEO_FORMAT_CAP_DISCRETE(176, 144, VIDEO_PIX_FMT_RGB565), /* QCIF  */
	VIDEO_FORMAT_CAP_DISCRETE(320, 240, VIDEO_PIX_FMT_RGB565), /* QVGA  */
	VIDEO_FORMAT_CAP_DISCRETE(352, 288, VIDEO_PIX_FMT_RGB565), /* CIF   */
	VIDEO_FORMAT_CAP_DISCRETE(640, 480, VIDEO_PIX_FMT_RGB565), /* VGA   */
	VIDEO_FORMAT_CAP_DISCRETE(176, 144, VIDEO_PIX_FMT_YUYV),   /* QCIF  */
	VIDEO_FORMAT_CAP_DISCRETE(320, 240, VIDEO_PIX_FMT_YUYV),   /* QVGA  */
	VIDEO_FORMAT_CAP_DISCRETE(352, 288, VIDEO_PIX_FMT_YUYV),   /* CIF   */
	VIDEO_FORMAT_CAP_DISCRETE(640, 480, VIDEO_PIX_FMT_YUYV),   /* VGA   */
	{0}
};
#endif
