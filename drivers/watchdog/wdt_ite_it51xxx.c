...
/*
 * Because 0x1F00 register base is defined for timer node, we define 0x1F01
 * register base for WDT node, and then below address need to minus 1.
 */
/* 0x01: External Timer1/WDT Configuration */
#define REG_ETWCFG            (0x00)
...
/* 0x02: External Timer1 Prescaler */
#define REG_ET1PSR            (0x01)
#define WDT_ETPS_32P768_KHZ   0x00
#define WDT_ETPS_1P024_KHZ    0x01
#define WDT_ETPS_32_HZ        0x02
/* 0x03: External Timer1 Counter High Byte */
#define REG_ET1CNTLHR         (0x02)
/* 0x04: External Timer1 Counter Low Byte */
#define REG_ET1CNTLLR         (0x03)
/* 0x05: External Timer1/WDT Control */
#define REG_ETWCTRL           (0x04)
#define WDT_EWDSCEN           BIT(5)
#define WDT_EWDSCMS           BIT(4)
#define WDT_ET1TC             BIT(1)
#define WDT_ET1RST            BIT(0)
/* 0x06: External WDT Counter Low Byte */
#define REG_EWDCNTLR          (0x05)
/* 0x07: External WDT Key */
#define REG_EWDKEYR           (0x06)
/* 0x09: External WDT Counter High Byte */
#define REG_EWDCNTHR          (0x08)
...
static int wdt_it51xxx_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_INST_IRQN(0), 0, wdt_it51xxx_isr,
...
DEVICE_DT_INST_DEFINE(0, wdt_it51xxx_init, NULL,
			&wdt_it51xxx_dev_data, &wdt_it51xxx_cfg_0,
