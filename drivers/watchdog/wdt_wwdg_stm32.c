...
static u32_t wwdg_stm32_get_pclk(const struct device *dev)
{
 ...
 */
static u32_t wwdg_stm32_get_timeout(const struct device *dev, u32_t prescaler,
				    u32_t counter)
{
...
static int wwdg_stm32_setup(const struct device *dev, u8_t options)
{
