...
#define GPIO_RZ_IOPORT_TINT_STATUS_REG_CLEAR(tint_num) (R_INTC_IM33->TSCR &= ~BIT(tint_num))
...
#define GPIO_RZ_IOPORT_TINT_STATUS_REG_CLEAR(tint_num) (R_INTC_IA55->TSCR &= ~BIT(tint_num))
static const uint8_t gpio_rz_int[GPIO_RZ_MAX_PORT_NUM] = {0,  4,  9,  13, 17, 23, 28, 33, 38, 43,
							  47, 52, 56, 58, 63, 66, 70, 72, 76};

#elif defined(CONFIG_SOC_SERIES_RZV2H)
#define GPIO_RZ_IOPORT_P_REG_BASE_GET      (&R_GPIO->P20)
#define GPIO_RZ_IOPORT_PM_REG_BASE_GET     (&R_GPIO->PM20)
#define GPIO_RZ_IOPORT_PFC_REG_BASE_GET    (&R_GPIO->PFC20)
#define GPIO_RZ_IOPORT_TINT_STATUS_REG_GET (&R_INTC->TSCTR)

#ifdef CONFIG_CPU_CORTEX_M
#define GPIO_RZ_TINT_IRQ_OFFSET                   353
#define GPIO_RZ_IOPORT_TINT_SPURIOUS_HANDLE       0
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_GET (&R_INTC->INTM33SEL0)
#else /* Cortex-R */
#define GPIO_RZ_TINT_IRQ_OFFSET                   (GIC_SPI_INT_BASE + 353)
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_GET (&R_INTC->INTR8SEL0)
#endif

#define GPIO_RZ_MAX_PORT_NUM                           12
#define GPIO_RZ_IOPORT_TINT_STATUS_REG_CLEAR(tint_num) (R_INTC->TSCLR |= BIT(tint_num))
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_CLEAR(tint_num)                                      \
	GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_GET[int_num / 3] &= ~(0x3FF << ((int_num % 3) * 10));
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_SET(tint_num)                                        \
	GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_GET[int_num / 3] |= (int_num << ((int_num % 3) * 10));
...
#ifndef GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_CLEAR
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_CLEAR(tint_num)
#define GPIO_RZ_IOPORT_TINT_SELECT_SOURCE_REG_SET(tint_num)
#endif

#ifndef GPIO_RZ_IOPORT_TINT_STATUS_REG_GET
#define GPIO_RZ_IOPORT_TINT_STATUS_REG_GET (&R_INTC->TSCR)
#endif

#ifndef GPIO_RZ_IOPORT_TINT_SPURIOUS_HANDLE
#define GPIO_RZ_IOPORT_TINT_SPURIOUS_HANDLE 1
#endif
