...
static const struct gpio_sifive_config gpio_sifive_config0 = {
	.gpio_base_addr    = SIFIVE_GPIO0_BASE_ADDRESS,
	.gpio_irq_base     = SIFIVE_GPIO0_IRQ_0,
...
static void gpio_sifive_cfg_0(void)
{
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_0,
		    CONFIG_GPIO_SIFIVE_0_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_1,
		    CONFIG_GPIO_SIFIVE_1_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_2,
		    CONFIG_GPIO_SIFIVE_2_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_3,
		    CONFIG_GPIO_SIFIVE_3_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_4,
		    CONFIG_GPIO_SIFIVE_4_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_5,
		    CONFIG_GPIO_SIFIVE_5_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_6,
		    CONFIG_GPIO_SIFIVE_6_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_7,
		    CONFIG_GPIO_SIFIVE_7_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_8,
		    CONFIG_GPIO_SIFIVE_8_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_9,
		    CONFIG_GPIO_SIFIVE_9_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_10,
		    CONFIG_GPIO_SIFIVE_10_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_11,
		    CONFIG_GPIO_SIFIVE_11_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_12,
		    CONFIG_GPIO_SIFIVE_12_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_13,
		    CONFIG_GPIO_SIFIVE_13_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_14,
		    CONFIG_GPIO_SIFIVE_14_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_15,
		    CONFIG_GPIO_SIFIVE_15_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_16,
		    CONFIG_GPIO_SIFIVE_16_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_17,
		    CONFIG_GPIO_SIFIVE_17_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_18,
		    CONFIG_GPIO_SIFIVE_18_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_19,
		    CONFIG_GPIO_SIFIVE_19_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_20,
		    CONFIG_GPIO_SIFIVE_20_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_21,
		    CONFIG_GPIO_SIFIVE_21_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_22,
		    CONFIG_GPIO_SIFIVE_22_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_23,
		    CONFIG_GPIO_SIFIVE_23_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_24,
		    CONFIG_GPIO_SIFIVE_24_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_25,
		    CONFIG_GPIO_SIFIVE_25_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_26,
		    CONFIG_GPIO_SIFIVE_26_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_27,
		    CONFIG_GPIO_SIFIVE_27_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_28,
		    CONFIG_GPIO_SIFIVE_28_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_29,
		    CONFIG_GPIO_SIFIVE_29_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_30,
		    CONFIG_GPIO_SIFIVE_30_PRIORITY,
		    gpio_sifive_irq_handler,
		    DEVICE_GET(gpio_sifive_0),
		    0);
	IRQ_CONNECT(SIFIVE_GPIO0_IRQ_31,
