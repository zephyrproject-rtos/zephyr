...
typedef union _max14906_doi_level {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_interrupt {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_ovr_ld_chf {
	uint8_t reg_raw;
	struct {
		uint8_t OVL1:1; /* BIT0 */
		uint8_t OVL2:1;
...
typedef union _max14906_opn_wir_chf {
	uint8_t reg_raw;
	struct {
...
} max14906_opn_wir_chf;

typedef union _max14906_sht_vdd_chf {
	uint8_t reg_raw;
	struct {
...
} max14906_sht_vdd_chf;

typedef union _max14906_global_err {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_opn_wr_en {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_sht_vdd_en {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_config_di {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_config_do {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_config_curr_lim {
	uint8_t reg_raw;
	struct {
		uint8_t CL1:2; /* BIT0 */
		uint8_t CL2:2;
...
typedef union _max14906_config1 {
	uint8_t reg_raw;
	struct {
...
typedef union _max14906_config2 {
	uint8_t reg_raw;
	struct {
...
struct max149x6_config {
	...
	bool crc_en;
	max14906_config1 config1;
	max14906_config2 config2;
	max14906_config_curr_lim curr_lim;
	max14906_config_di config_do;
	max14906_config_do config_di;
...
struct max14906_data {
	...
	struct {
		max14906_doi_level doi_level;
		max14906_ovr_ld_chf ovr_ld;
		max14906_opn_wir_chf opn_wir;
		max14906_sht_vdd_chf sht_vdd;
	} chan;
	struct {
		max14906_opn_wr_en opn_wr_en;
		max14906_sht_vdd_en sht_vdd_en;
	} chan_en;
	struct {
		max14906_interrupt interrupt;
		max14906_global_err glob_err;
		max14906_mask mask;
	} glob;
};
