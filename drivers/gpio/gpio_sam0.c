...
DEVICE_AND_API_INIT(DT_GPIO_SAM0_PORTA_PARENT_LABEL, gpio_sam0_0,
		    DT_GPIO_SAM0_PORTA_LABEL, gpio_sam0_init,
...
DEVICE_AND_API_INIT(DT_GPIO_SAM0_PORTB_PARENT_LABEL, gpio_sam0_1,
		    DT_GPIO_SAM0_PORTB_LABEL, gpio_sam0_init,
