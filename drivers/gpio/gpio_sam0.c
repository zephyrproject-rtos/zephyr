...
static const struct gpio_sam0_config gpio_sam0_config_0 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_ATMEL_SAM0_GPIO_NGPIOS),
	},
...
static const struct gpio_sam0_config gpio_sam0_config_1 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_ATMEL_SAM0_GPIO_NGPIOS),
	},
...
static const struct gpio_sam0_config gpio_sam0_config_2 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_ATMEL_SAM0_GPIO_NGPIOS),
	},
...
static const struct gpio_sam0_config gpio_sam0_config_3 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_ATMEL_SAM0_GPIO_NGPIOS),
	},
