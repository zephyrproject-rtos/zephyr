...
static const struct gpio_cmsdk_ahb_cfg gpio_cmsdk_ahb_0_cfg = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_ARM_CMSDK_GPIO_NGPIOS),
	},
...
static const struct gpio_cmsdk_ahb_cfg gpio_cmsdk_ahb_1_cfg = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_ARM_CMSDK_GPIO_NGPIOS),
	},
...
static const struct gpio_cmsdk_ahb_cfg gpio_cmsdk_ahb_2_cfg = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_ARM_CMSDK_GPIO_NGPIOS),
	},
...
static const struct gpio_cmsdk_ahb_cfg gpio_cmsdk_ahb_3_cfg = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_ARM_CMSDK_GPIO_NGPIOS),
	},
