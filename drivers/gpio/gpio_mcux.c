...
DEVICE_AND_API_INIT(DT_NXP_KINETIS_GPIO_GPIO_A_PARENT_LABEL, gpio_mcux_porta,
		    DT_NXP_KINETIS_GPIO_GPIO_A_LABEL,
...
DEVICE_AND_API_INIT(DT_NXP_KINETIS_GPIO_GPIO_B_PARENT_LABEL, gpio_mcux_portb,
		    DT_NXP_KINETIS_GPIO_GPIO_B_LABEL,
...
DEVICE_AND_API_INIT(DT_NXP_KINETIS_GPIO_GPIO_C_PARENT_LABEL, gpio_mcux_portc,
		    DT_NXP_KINETIS_GPIO_GPIO_C_LABEL,
...
DEVICE_AND_API_INIT(DT_NXP_KINETIS_GPIO_GPIO_D_PARENT_LABEL, gpio_mcux_portd,
		    DT_NXP_KINETIS_GPIO_GPIO_D_LABEL,
...
DEVICE_AND_API_INIT(DT_NXP_KINETIS_GPIO_GPIO_E_PARENT_LABEL, gpio_mcux_porte,
