...
static const struct gpio_mcux_config gpio_mcux_porta_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_NXP_KINETIS_GPIO_NGPIOS),
	},
...
static const struct gpio_mcux_config gpio_mcux_portb_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_NXP_KINETIS_GPIO_NGPIOS),
	},
...
static const struct gpio_mcux_config gpio_mcux_portc_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_NXP_KINETIS_GPIO_NGPIOS),
	},
...
static const struct gpio_mcux_config gpio_mcux_portd_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_NXP_KINETIS_GPIO_NGPIOS),
	},
...
static const struct gpio_mcux_config gpio_mcux_porte_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_4_NXP_KINETIS_GPIO_NGPIOS),
	},
