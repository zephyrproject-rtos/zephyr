...
static const struct gpio_sam_config port_a_sam_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_ATMEL_SAM_GPIO_NGPIOS),
	},
...
static const struct gpio_sam_config port_b_sam_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_ATMEL_SAM_GPIO_NGPIOS),
	},
...
static const struct gpio_sam_config port_c_sam_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_ATMEL_SAM_GPIO_NGPIOS),
	},
...
static const struct gpio_sam_config port_d_sam_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_ATMEL_SAM_GPIO_NGPIOS),
	},
...
static const struct gpio_sam_config port_e_sam_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_4_ATMEL_SAM_GPIO_NGPIOS),
	},
