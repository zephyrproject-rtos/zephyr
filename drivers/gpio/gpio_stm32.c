...
#if DT_HAS_NODELABEL_STATUS_OKAY(gpioa)
GPIO_DEVICE_INIT_STM32(a, A);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioa) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpiob)
GPIO_DEVICE_INIT_STM32(b, B);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpiob) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpioc)
GPIO_DEVICE_INIT_STM32(c, C);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioc) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpiod)
GPIO_DEVICE_INIT_STM32(d, D);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpiod) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpioe)
GPIO_DEVICE_INIT_STM32(e, E);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioe) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpiof)
GPIO_DEVICE_INIT_STM32(f, F);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpiof) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpiog)
GPIO_DEVICE_INIT_STM32(g, G);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpiog) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpioh)
GPIO_DEVICE_INIT_STM32(h, H);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioh) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpioi)
GPIO_DEVICE_INIT_STM32(i, I);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioi) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpioj)
GPIO_DEVICE_INIT_STM32(j, J);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpioj) */

#if DT_HAS_NODELABEL_STATUS_OKAY(gpiok)
GPIO_DEVICE_INIT_STM32(k, K);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(gpiok) */
