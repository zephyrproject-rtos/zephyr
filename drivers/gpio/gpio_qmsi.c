...
DEVICE_DEFINE(DT_GPIO_QMSI_0_PARENT_NAME, gpio_0,
	      DT_GPIO_QMSI_0_NAME, &gpio_qmsi_init,
...
DEVICE_DEFINE(DT_GPIO_QMSI_1_PARENT_NAME, gpio_aon,
	      DT_GPIO_QMSI_1_NAME, &gpio_qmsi_init,
