...
#define GPIO_LITEX_HAS_OE                                                                          \
	(GPIO_LITEX_ANY_HAS_OE || (GPIO_LITEX_ALL_HAS_OE || gpio_config->oe_addr != 0))
#define GPIO_LITEX_HAS_OUT                                                                         \
	(GPIO_LITEX_ANY_HAS_OUT || (GPIO_LITEX_ALL_HAS_OUT || gpio_config->out_addr != 0))
#define GPIO_LITEX_HAS_IN                                                                          \
	(GPIO_LITEX_ANY_HAS_IN || (GPIO_LITEX_ALL_HAS_IN || gpio_config->in_addr != 0))
					      ...
					      enum gpio_int_trig trig)
{
	...
	if (!GPIO_LITEX_HAS_OUT || !(GPIO_LITEX_ALL_HAS_IRQ || gpio_config->ev_enable_addr != 0)) {
		return -ENOTSUP;
	}
					 ...
					 gpio_port_pins_t *inputs, gpio_port_pins_t *outputs)
{
	...
	if (!GPIO_LITEX_HAS_OE) {
		oe_reg = GPIO_LITEX_HAS_OUT ? UINT32_MAX : 0;
	} else {
