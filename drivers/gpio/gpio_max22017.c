...
static int gpio_adi_max22017_pin_interrupt_configure(const struct device *dev,
					     gpio_pin_t pin,
...
static int gpio_adi_max22017_manage_cb(const struct device *dev,
...
#define GPIO_MAX22017_DEVICE(id)                                                          \
	...
	DEVICE_DT_INST_DEFINE(id, gpio_adi_max22017_init, NULL, NULL,                     \
			      ...
			      CONFIG_DAC_MAX22017_INIT_PRIORITY, &gpio_adi_max22017_api);
