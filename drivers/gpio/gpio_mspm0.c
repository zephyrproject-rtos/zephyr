...
/* IOMUX_PINCM* values start from 0. So make UINT8_MAX as the invalid value. */
#define INVALID_PINCM UINT8_MAX
...
#elif defined(CONFIG_SOC_MSPM0L1117)
#define NUM_GPIOA_PIN 32
static uint8_t gpioa_pincm_lut[NUM_GPIOA_PIN] = {
	IOMUX_PINCM1,  IOMUX_PINCM2,  IOMUX_PINCM7,  IOMUX_PINCM8,  IOMUX_PINCM9,  IOMUX_PINCM10,
	IOMUX_PINCM11, IOMUX_PINCM14, IOMUX_PINCM19, IOMUX_PINCM20, IOMUX_PINCM21, IOMUX_PINCM22,
	IOMUX_PINCM34, IOMUX_PINCM35, IOMUX_PINCM36, IOMUX_PINCM37, IOMUX_PINCM38, IOMUX_PINCM39,
	IOMUX_PINCM40, IOMUX_PINCM41, IOMUX_PINCM42, IOMUX_PINCM46, IOMUX_PINCM47, IOMUX_PINCM53,
	IOMUX_PINCM54, IOMUX_PINCM55, IOMUX_PINCM59, IOMUX_PINCM60, IOMUX_PINCM3,  INVALID_PINCM,
	INVALID_PINCM, IOMUX_PINCM6,
};
#else
...
#endif /* CONFIG_SOC_MSPM0L1105 || CONFIG_SOC_MSPM0L1106 */
#define gpioa_pins    NUM_GPIOA_PIN
#else
...
static uint8_t gpiob_pincm_lut[NUM_GPIOB_PIN] = {
	INVALID_PINCM, INVALID_PINCM, IOMUX_PINCM15, IOMUX_PINCM16, INVALID_PINCM,
	INVALID_PINCM, IOMUX_PINCM23, IOMUX_PINCM24, IOMUX_PINCM25, IOMUX_PINCM26,
	INVALID_PINCM, INVALID_PINCM, INVALID_PINCM, INVALID_PINCM, IOMUX_PINCM31,
	IOMUX_PINCM32, IOMUX_PINCM33, IOMUX_PINCM43, IOMUX_PINCM44, IOMUX_PINCM45,
	IOMUX_PINCM48, INVALID_PINCM, INVALID_PINCM, INVALID_PINCM, IOMUX_PINCM52,
};
#else
				    ...
				    gpio_flags_t flags)
{
	...
	if (config->pincm_lut[pin] == INVALID_PINCM) {
		return -EINVAL;
	}
