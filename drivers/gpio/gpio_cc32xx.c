...
static const struct gpio_cc32xx_config gpio_cc32xx_a0_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_TI_CC32XX_GPIO_NGPIOS),
	},
...
static const struct gpio_cc32xx_config gpio_cc32xx_a1_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_TI_CC32XX_GPIO_NGPIOS),
	},
...
static const struct gpio_cc32xx_config gpio_cc32xx_a2_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_TI_CC32XX_GPIO_NGPIOS),
	},
...
static const struct gpio_cc32xx_config gpio_cc32xx_a3_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_TI_CC32XX_GPIO_NGPIOS),
	},
