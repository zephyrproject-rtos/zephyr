...
typedef union _max22190_fault1 {
	uint8_t reg_raw;
	struct {
...
typedef union _max22190_fault1_en {
	uint8_t reg_raw;
	struct {
...
typedef union _max22190_fault2 {
	uint8_t reg_raw;
	struct {
...
typedef union _max22190_fault2_en {
	uint8_t reg_raw;
	struct {
...
typedef union _max22190_filter {
	uint8_t reg_raw;
	struct {
...
#define MAX22190_FILTER_BY_IDX(id, idx) {							\
	.reg_bits.max22190_DELAY = MAX22190_FILTER_SET_DELAY(DT_INST_PROP_BY_IDX(id, filter_delays,\
											idx)),\
