...
static int gpio_cc23x0_get_config(const struct device *port, gpio_pin_t pin,
				  gpio_flags_t *flags)
{
	uint32_t outFlag = 0;
...
DEVICE_DT_INST_DEFINE(0, gpio_cc23x0_init, NULL, &gpio_cc23x0_data_0,
