...
typedef union _max14916_interrupt {
	uint8_t reg_raw;
	struct {
...
typedef union _max14916_config1 {
	uint8_t reg_raw;
	struct {
...
typedef union _max14916_config2 {
	uint8_t reg_raw;
	struct {
...
typedef union _max14916_global_err {
	uint8_t reg_raw;
	struct {
...
struct max149x6_config {
	...
	bool crc_en;
	max14916_config1 config1;
	max14916_config2 config2;
...
struct max14916_data {
	...
	struct {
		max14916_interrupt interrupt;
		max14916_global_err glob_err;
		max14916_mask mask;
	} glob;
};
