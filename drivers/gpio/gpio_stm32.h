...
#define STM32_PINCFG_MODE_OUTPUT	(STM32_MODE_OUT_MAX_SPEED_50MHZ | \
					 STM32_CNF_OUT_GENERAL_PURPOSE)
#define STM32_PINCFG_MODE_INPUT_FLOAT	STM32_CNFMODE_INPUT_FLOAT
#define STM32_PINCFG_MODE_INPUT_PUPD	STM32_CNFMODE_INPUT_PUPD
#define STM32_PINCFG_MODE_ANALOG	STM32_CNFMODE_ANALOG

#define STM32_PINCFG_PUSH_PULL		STM32_CNF_OUT_PUSH_PULL
#define STM32_PINCFG_OPEN_DRAIN		STM32_CNF_OUT_OPEN_DRAIN
