...
#define STM32_PINCFG_MODE_OUTPUT	(STM32_MODE_OUTPUT	\
					 | STM32_CNF_GP_OUTPUT	\
					 | STM32_CNF_PUSH_PULL)
#define STM32_PINCFG_MODE_INPUT_FLOAT	(STM32_MODE_INPUT	\
					 | STM32_CNF_IN_FLOAT)
#define STM32_PINCFG_MODE_INPUT_PUPD	(STM32_MODE_INPUT	\
					 | STM32_CNF_IN_PUPD)
...
#define STM32_PINCFG_PULL_UP		STM32_PUPD_PULL_UP
#define STM32_PINCFG_PULL_DOWN		STM32_PUPD_PULL_DOWN
#else
#define STM32_PINCFG_MODE_OUTPUT	STM32_MODER_OUTPUT_MODE
#define STM32_PINCFG_MODE_INPUT_FLOAT	STM32_MODER_INPUT_MODE
#define STM32_PINCFG_MODE_INPUT_PUPD	STM32_MODER_INPUT_MODE
