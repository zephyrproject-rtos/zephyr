...
static const struct imx_gpio_config imx_gpio_1_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_1_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_2_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_2_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_3_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_3_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_4_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_4_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_5_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_5_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_6_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_6_NGPIOS),
	},
...
static const struct imx_gpio_config imx_gpio_7_config = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_GPIO_IMX_PORT_7_NGPIOS),
	},
