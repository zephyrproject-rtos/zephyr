...
#define CREATE_GPIO_DEVICE(n)                                                                      \
	...
	static struct gpio_altera_config gpio_config_##n = {                                       \
		...
		.irq_num = COND_CODE_1(DT_INST_IRQ_HAS_IDX(n, 0), (DT_INST_IRQN(n)), (0)), .cfg_func = gpio_altera_cfg_func_##n,              \
			 .outset = DT_INST_PROP(n, outset), .outclear = DT_INST_PROP(n, outclear), \
	};                                                                                         \
                                                                                                   \
