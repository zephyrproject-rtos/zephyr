...
static int gpio_npm2100_pin_interrupt_configure(const struct device *dev, gpio_pin_t pin,
...
static const struct gpio_driver_api gpio_npm2100_api = {
	...
	.pin_interrupt_configure = gpio_npm2100_pin_interrupt_configure,
};
