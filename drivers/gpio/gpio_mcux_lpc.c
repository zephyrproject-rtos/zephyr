...
static int gpio_mcux_lpc_port0_init(struct device *dev);
...
DEVICE_AND_API_INIT(gpio_mcux_lpc_port0, CONFIG_GPIO_LPC_MCUX_PORT0_NAME,
	gpio_mcux_lpc_port0_init, &gpio_mcux_lpc_port0_data,
	&gpio_mcux_lpc_port0_config, POST_KERNEL,
	CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_mcux_lpc_driver_api);

static int gpio_mcux_lpc_port0_init(struct device *dev)
{
	/* put irq connect code when required */
	return 0;
}

#endif /* CONFIG_GPIO_LPC_MCUX_PORT0 */

#ifdef CONFIG_GPIO_LPC_MCUX_PORT1

static int gpio_mcux_lpc_port1_init(struct device *dev);
...
DEVICE_AND_API_INIT(gpio_mcux_lpc_port1, CONFIG_GPIO_LPC_MCUX_PORT1_NAME,
	gpio_mcux_lpc_port1_init, &gpio_mcux_lpc_port1_data,
...
#endif /* CONFIG_GPIO_LPC_MCUX_PORT1 */
