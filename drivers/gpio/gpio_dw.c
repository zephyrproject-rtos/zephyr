...
static const struct gpio_dw_config gpio_config_0 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_0_SNPS_DESIGNWARE_GPIO_NGPIOS),
	},
...
static const struct gpio_dw_config gpio_dw_config_1 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_1_SNPS_DESIGNWARE_GPIO_NGPIOS),
	},
...
static const struct gpio_dw_config gpio_dw_config_2 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_2_SNPS_DESIGNWARE_GPIO_NGPIOS),
	},
...
static const struct gpio_dw_config gpio_dw_config_3 = {
	.common = {
		.available = GPIO_AVAILABLE_PINS(DT_INST_3_SNPS_DESIGNWARE_GPIO_NGPIOS),
	},
