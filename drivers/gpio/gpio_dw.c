...
DEVICE_DEFINE(NULL, gpio_dw_0, CONFIG_GPIO_DW_0_NAME, gpio_dw_initialize,
	      gpio_dw_device_ctrl, &gpio_0_runtime, &gpio_config_0,
	      POST_KERNEL, CONFIG_GPIO_DW_INIT_PRIORITY,
	      &api_funcs);
#else
DEVICE_AND_API_INIT(NULL, gpio_dw_0, CONFIG_GPIO_DW_0_NAME, gpio_dw_initialize,
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(NULL, gpio_dw_1, CONFIG_GPIO_DW_1_NAME, gpio_dw_initialize,
	      gpio_dw_device_ctrl, &gpio_1_runtime, &gpio_dw_config_1,
	      POST_KERNEL, CONFIG_GPIO_DW_INIT_PRIORITY,
	      &api_funcs);
#else
DEVICE_AND_API_INIT(NULL, gpio_dw_1, CONFIG_GPIO_DW_1_NAME, gpio_dw_initialize,
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(NULL, gpio_dw_2, CONFIG_GPIO_DW_2_NAME, gpio_dw_initialize,
	      gpio_dw_device_ctrl, &gpio_2_runtime, &gpio_dw_config_2,
	      POST_KERNEL, CONFIG_GPIO_DW_INIT_PRIORITY,
	      &api_funcs);
#else
DEVICE_AND_API_INIT(NULL, gpio_dw_2, CONFIG_GPIO_DW_2_NAME, gpio_dw_initialize,
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(NULL, gpio_dw_3, CONFIG_GPIO_DW_3_NAME, gpio_dw_initialize,
	      gpio_dw_device_ctrl, &gpio_3_runtime, &gpio_dw_config_3,
	      POST_KERNEL, CONFIG_GPIO_DW_INIT_PRIORITY,
	      &api_funcs);
#else
DEVICE_AND_API_INIT(NULL, gpio_dw_3, CONFIG_GPIO_DW_3_NAME, gpio_dw_initialize,
