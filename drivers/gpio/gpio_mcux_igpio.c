...
static int mcux_igpio_port_get_raw(const struct device *dev, u32_t *value)
{
	const struct mcux_igpio_config *config = dev->config_info;
	GPIO_Type *base = config->base;
...
static int mcux_igpio_port_set_bits_raw(const struct device *dev, u32_t mask)
{
	const struct mcux_igpio_config *config = dev->config_info;
	GPIO_Type *base = config->base;
...
static int mcux_igpio_port_toggle_bits(const struct device *dev, u32_t mask)
{
	const struct mcux_igpio_config *config = dev->config_info;
	GPIO_Type *base = config->base;
...
static int mcux_igpio_enable_callback(const struct device *dev,
				      gpio_pin_t pin)
{
	struct mcux_igpio_data *data = dev->driver_data;
...
static int mcux_igpio_disable_callback(const struct device *dev,
				       gpio_pin_t pin)
{
	struct mcux_igpio_data *data = dev->driver_data;
