...
#define USB_DWC2_GOTGCTL			0x0000UL
#define USB_DWC2_GOTGCTL_TESTMODE_CORR_EUSB2	BIT(31)
#define USB_DWC2_GOTGCTL_RESERVED_30_29		GENMASK(30, 29)
#define USB_DWC2_GOTGCTL_EUSB2_PHY_DISC_SUPP	BIT(28)
#define USB_DWC2_GOTGCTL_CHIRPEN		BIT(27)
#define USB_DWC2_GOTGCTL_MULTVALIDBC		GENMASK(26, 22)
#define USB_DWC2_GOTGCTL_CURMOD			BIT(21)
#define USB_DWC2_GOTGCTL_OTGVER			BIT(20)
#define USB_DWC2_GOTGCTL_BSESVLD		BIT(19)
#define USB_DWC2_GOTGCTL_ASESVLD		BIT(18)
#define USB_DWC2_GOTGCTL_DBNCTIME		BIT(17)
#define USB_DWC2_GOTGCTL_CONIDSTS		BIT(16)
#define USB_DWC2_GOTGCTL_DBNCEFLTRBYPASS	BIT(15)
#define USB_DWC2_GOTGCTL_RSVD			GENMASK(14, 13)
#define USB_DWC2_GOTGCTL_EHEN			BIT(12)
#define USB_DWC2_GOTGCTL_DEVHNPEN		BIT(11)
#define USB_DWC2_GOTGCTL_HSTSETHNPEN		BIT(10)
#define USB_DWC2_GOTGCTL_HNPREQ			BIT(9)
#define USB_DWC2_GOTGCTL_HSTNEGSCS		BIT(8)
#define USB_DWC2_GOTGCTL_BVALIDOVVAL		BIT(7)
#define USB_DWC2_GOTGCTL_BVALIDOVEN		BIT(6)
#define USB_DWC2_GOTGCTL_AVALIDOVVAL		BIT(5)
#define USB_DWC2_GOTGCTL_AVALIDOVEN		BIT(4)
#define USB_DWC2_GOTGCTL_VBVALIDOVVAL		BIT(3)
#define USB_DWC2_GOTGCTL_VBVALIDOVEN		BIT(2)
#define USB_DWC2_GOTGCTL_SESREQ			BIT(1)
#define USB_DWC2_GOTGCTL_SESREQSCS		BIT(0)
...
#define USB_DWC2_GUSBCFG			0x000C
#define USB_DWC2_GUSBCFG_CORRUPTTXPKT		BIT(31)
#define USB_DWC2_GUSBCFG_FORCEDEVMODE		BIT(30)
#define USB_DWC2_GUSBCFG_FORCEHSTMODE		BIT(29)
#define USB_DWC2_GUSBCFG_TXENDDELAY		BIT(28)
#define USB_DWC2_GUSBCFG_IC_USBTRAFCTL		BIT(27)
#define USB_DWC2_GUSBCFG_IC_USBCAP		BIT(26)
#define USB_DWC2_GUSBCFG_ULPI			BIT(25)
#define USB_DWC2_GUSBCFG_INDICATOR		BIT(24)
#define USB_DWC2_GUSBCFG_COMPLEMENT		BIT(23)
#define USB_DWC2_GUSBCFG_TERMSELDLPULSE		BIT(22)
#define USB_DWC2_GUSBCFG_ULPIEXTVBUSINDICATOR	BIT(21)
#define USB_DWC2_GUSBCFG_ULPIEXTVBUSDRV		BIT(20)
#define USB_DWC2_GUSBCFG_ULPICLKSUSM		BIT(19)
#define USB_DWC2_GUSBCFG_ULPIAUTORES		BIT(18)
#define USB_DWC2_GUSBCFG_OTGI2CSEL		BIT(16)
#define USB_DWC2_GUSBCFG_PHYLPWRCLKSEL		BIT(15)
#define USB_DWC2_GUSBCFG_RESERVED_14		BIT(14)
#define USB_DWC2_GUSBCFG_USBTRDTIM		GENMASK(13, 10)
#define USB_DWC2_GUSBCFG_HNPCAP			BIT(9)
#define USB_DWC2_GUSBCFG_SRPCAP			BIT(8)
#define USB_DWC2_GUSBCFG_DDRSEL			BIT(7)
#define USB_DWC2_GUSBCFG_PHYSEL			BIT(6)
#define USB_DWC2_GUSBCFG_FSINTF			BIT(5)
#define USB_DWC2_GUSBCFG_ULPI_UTMI_SEL		BIT(4)
#define USB_DWC2_GUSBCFG_PHYIF			BIT(3)
#define USB_DWC2_GUSBCFG_TOUTCAL		GENMASK(2, 0)
