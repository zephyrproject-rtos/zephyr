...
typedef union {
    struct {
        uint32_t xfersize: 19;  // Note: Width depends on hardware parameters.
        uint32_t pktcnt: 10;    // Note: Width depends on hardware parameters.
        uint32_t pid: 2;
        uint32_t dopng: 1;
    };
    uint32_t val;
...
typedef struct {
    volatile uint32_t hcchar;                           // 0x00
    volatile uint32_t hcsplt;                           // 0x04
    volatile uint32_t hcint;                            // 0x08
    volatile uint32_t hcintmsk;                         // 0x0c
    volatile uint32_t hctsiz;                           // 0x10
    volatile uint32_t hcdma;                            // 0x14
    volatile uint32_t reserved_0x18[1];                 // 0x18
    volatile uint32_t hcdmab;                           // 0x1c

    // volatile usb_dwc2_hcchar_reg_t hcchar_reg;       // 0x00
    // volatile usb_dwc2_hcsplt_reg_t hcsplt_reg;       // 0x04
    // volatile usb_dwc2_hcint_reg_t hcint_reg;         // 0x08
    // volatile usb_dwc2_hcintmsk_reg_t hcintmsk_reg;   // 0x0c
    // volatile usb_dwc2_hctsiz_reg_t hctsiz_reg;       // 0x10
    // volatile usb_dwc2_hcdma_reg_t hcdma_reg;         // 0x14
    // uint32_t reserved_0x18[1];                       // 0x18
    // volatile usb_dwc2_hcdmab_reg_t hcdmab_reg;       // 0x1c
