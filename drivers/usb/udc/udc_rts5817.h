...
/* System NX_MODE register (absolute address, outside USB block) */
#define R_SYS_NX_MODE           0x401E2018UL
#define FW_CFG_LC_RC_EN_OFFSET  2UL
#define FW_CFG_LC_RC_EN         BIT(FW_CFG_LC_RC_EN_OFFSET)
#define FORCE_NXTAL_MODE_OFFSET 1UL
#define FORCE_NXTAL_MODE        BIT(FORCE_NXTAL_MODE_OFFSET)

/* Clock source analog registers (absolute address) */
#define R_CLK_SOURCE_ANA_CFG0 0x401E1C00UL
#define R_CLK_SOURCE_ANA_CFG1 0x401E1C04UL

/* Bits of R_CLK_SOURCE_ANA_CFG0 */
#define REF_CAP_FW_OFFSET          0UL
#define REF_CAP_FW_MASK            GENMASK(2, 0)
#define REF_CURRENT_FW_OFFSET      16UL
#define REF_CURRENT_FW_MASK        GENMASK(22, 16)
#define REG_CK2P2M_RCLC_SEL_OFFSET 24UL
#define REG_CK2P2M_RCLC_SEL        BIT(REG_CK2P2M_RCLC_SEL_OFFSET)

/* Bits of R_CLK_SOURCE_ANA_CFG1 */
#define REG_LCEN_OFFSET 0UL
#define REG_LCEN        BIT(REG_LCEN_OFFSET)

/* Bits of R_USB2_CTL_CFG1 (relative to usb2_ana_base) */
#define EXT_CTRL_OFFSET 19UL
#define EXT_CTRL        BIT(EXT_CTRL_OFFSET)

/* Bits of R_USB2_PHY_CFG2 (relative to usb2_ana_base) */
#define FORCE_FREQ_TOP_RST_OFFSET 29UL
#define FORCE_FREQ_TOP_RST        BIT(FORCE_FREQ_TOP_RST_OFFSET)

/* PUF OTP config flag bits and offsets */
#define PUF_RC_44P4M_FLAG       BIT(19)
#define PUF_RC_CAP_44P4M_OFFSET 31
#define PUF_RC_CUR_44P4M_OFFSET 32
