...
void nrf_usbd_legacy_ep_max_packet_size_set(nrf_usbd_common_ep_t ep, uint16_t size);
...
nrfx_err_t nrf_usbd_legacy_init(nrf_usbd_common_event_handler_t event_handler)
{
...
void nrf_usbd_legacy_uninit(void)
{
...
nrf_usbd_common_ep_status_t nrf_usbd_legacy_ep_status_get(nrf_usbd_common_ep_t ep, size_t *p_size)
{
...
bool nrf_usbd_legacy_ep_is_busy(nrf_usbd_common_ep_t ep)
{
