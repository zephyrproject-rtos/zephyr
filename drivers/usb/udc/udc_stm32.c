...
#define UDC_STM32_OTG_HS_PHY_ULPI	    1U
#define UDC_STM32_FS_EMBEDDED_PHY	    2U
#define UDC_STM32_OTG_HS_EMBEDDED_PHY	    3U
 ...
 * - UDC_STM32_OTG_HS_PHY_ULPI: UTMI+ Low Pin Interface for external high-speed PHY.
 * - UDC_STM32_FS_EMBEDDED_PHY: on-chip full-speed PHY.
 * - UDC_STM32_OTG_HS_EMBEDDED_PHY: on-chip high-speed PHY.
 */
...
/* If the ULPI interface for an external high-speed PHY is enabled, it is assumed to be chosen. */
	...
	physel = UDC_STM32_OTG_HS_PHY_ULPI;
	...
	physel = UDC_STM32_FS_EMBEDDED_PHY;
	...
	physel = UDC_STM32_OTG_HS_EMBEDDED_PHY;
#else
