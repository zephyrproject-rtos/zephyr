...
#define UDC_STM32_PHY_HAS_EMBEDDED_HS_COMPAT(usb_node)	UTIL_OR(		\
	DT_NODE_HAS_COMPAT(UDC_STM32_PHY(usb_node), st_stm32_usbphyc),		\
 ...
 */
#define UDC_STM32_NODE_LIMITED_TO_FS(usb_node)	UTIL_OR(			\
	IS_EQ(UDC_STM32_NODE_PHY_ITFACE(usb_node), PHY_PCD_EMBEDDED),		\
