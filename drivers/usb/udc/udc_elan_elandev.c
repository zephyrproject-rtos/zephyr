...
static void e967_epx_init(const struct device *dev)
{
	...
	pepx->reg_data_cnt = (volatile uint32_t *)REG_EP1_DATA_CNT;
	pepx->reg_data_buf = (volatile uint32_t *)REG_EP1_DATA_BUF;
	...
	pepx->reg_data_cnt = (volatile uint32_t *)REG_EP2_DATA_CNT;
	pepx->reg_data_buf = (volatile uint32_t *)REG_EP2_DATA_BUF;
	...
	pepx->reg_data_cnt = (volatile uint32_t *)REG_EP3_DATA_CNT;
	pepx->reg_data_buf = (volatile uint32_t *)REG_EP3_DATA_BUF;
	...
	pepx->reg_data_cnt = (volatile uint32_t *)REG_EP4_DATA_CNT;
	pepx->reg_data_buf = (volatile uint32_t *)REG_EP4_DATA_BUF;
}
