...
#define USB_DW_GAHBCFG_HBSTLEN_OFFSET 1
#define USB_DW_GAHBCFG_HBSTLEN_MASK 0xf
#define USB_DW_GAHBCFG_HBSTLEN_INCR4 5
#define USB_DW_GAHBCFG_DESCDMA BIT(23)
...
#define USB_DW_DEPCTL_NEXTEP_MASK 0xf
#define USB_DW_DEPCTL_NEXTEP_OFFSET 11
