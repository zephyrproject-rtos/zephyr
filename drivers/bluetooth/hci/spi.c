...
#define GPIO_CS_PIN		DT_INST_SPI_DEV_CS_GPIO_PIN(0)
#define GPIO_CS_FLAGS		DT_INST_SPI_DEV_CS_GPIO_FLAGS(0)
...
{
	cs_dev = device_get_binding(DT_INST_SPI_DEV_CS_GPIO_LABEL(0));
	if (!cs_dev) {
