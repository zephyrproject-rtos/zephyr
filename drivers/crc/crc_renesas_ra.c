...
static const struct crc_driver_api crc_renesas_ra_driver_api = {
	.crc_begin = crc_renesas_ra_begin,
	.crc_update = crc_renesas_ra_update,
	.crc_finish = crc_renesas_ra_finish,
};
...
#define CRC_RA_INIT(idx)                                                                           \
	...
	DEVICE_DT_INST_DEFINE(idx, crc_ra_init, NULL, &crc_renesas_ra_data_##idx,                  \
			      &crc_renesas_ra_cfg_##idx, POST_KERNEL, CONFIG_CRC_INIT_PRIORITY,    \
			      &crc_renesas_ra_driver_api);
