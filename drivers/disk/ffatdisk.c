...
#define FFAT_BS_TOT_SEC16(n)								\
	(DT_INST_PROP(n, sector_count) > UINT16_MAX ? 0 : DT_INST_PROP(n, sector_count))
...
#define FFAT32_DATA_START(n)	(FFAT32_RD_START(n) + FFAT32_RD_CLUSTERS)
