...
BUILD_ASSERT(DT_NUM_INST_STATUS_OKAY(DT_DRV_COMPAT) <= CONFIG_USBH_MSC_LUN_COUNT,
	     "More zephyr,usb-msc-disk nodes than CONFIG_USBH_MSC_LUN_COUNT logical units");
