...
#define CREATE_SDMMC_DW_DEVICE(inst)					\
	...
	static struct dw_sdmmc_priv dw_sdmmc_priv_##inst = {		\
		...
		.info = {						\
			...
			.ocr_voltage = OCR_3_3_3_4 | OCR_3_2_3_3,	\
									...
									\
	DEVICE_DT_INST_DEFINE(inst, disk_dw_sdmmc_init, NULL,		\
			    &dw_sdmmc_priv_##inst, NULL, POST_KERNEL,	\
			    CONFIG_SDMMC_INIT_PRIORITY,			\
			    NULL);					\

DT_INST_FOREACH_STATUS_OKAY(CREATE_SDMMC_DW_DEVICE)
