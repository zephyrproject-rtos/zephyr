...
int dhara_nand_is_bad(const struct dhara_nand *n, dhara_block_t b)
{
	...
	int block_status = NAND_BLOCK_BAD;
	int ret;

	ret = flash_ex_op(ctx->info.dev, NAND_FLASH_IS_BAD_BLOCK, (uintptr_t)&b, &block_status);
	if (ret == -ENOTSUP) {
