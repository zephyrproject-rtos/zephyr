...
void esp32_clock_peripheral_init(void)
{
	...
	if (reset_reason_is_cpu_reset()) {
		...
		common_perip_clk = SYSTEM_WDG_CLK_EN | SYSTEM_I2S0_CLK_EN |
				   ...
				   SYSTEM_UART1_CLK_EN |
#endif
				   SYSTEM_SPI2_CLK_EN | SYSTEM_I2C_EXT0_CLK_EN |
				   SYSTEM_UHCI0_CLK_EN | SYSTEM_RMT_CLK_EN | SYSTEM_LEDC_CLK_EN |
		...
		wifi_bt_sdio_clk = SYSTEM_WIFI_CLK_WIFI_EN | SYSTEM_WIFI_CLK_BT_EN_M |
				   SYSTEM_WIFI_CLK_I2C_CLK_EN | SYSTEM_WIFI_CLK_UNUSED_BIT12;
	}
	...
	common_perip_clk |= SYSTEM_I2S0_CLK_EN |
			    ...
			    SYSTEM_RMT_CLK_EN | SYSTEM_UHCI1_CLK_EN | SYSTEM_SPI3_CLK_EN |
			    SYSTEM_SPI4_CLK_EN | SYSTEM_I2C_EXT1_CLK_EN | SYSTEM_I2S1_CLK_EN |
			    SYSTEM_SPI2_DMA_CLK_EN | SYSTEM_SPI3_DMA_CLK_EN;
