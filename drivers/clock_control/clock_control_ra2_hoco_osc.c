...
static
int hoco_driver_api_on(const struct device *dev, clock_control_subsys_t sys)
{
...
static
int hoco_driver_api_off(const struct device *dev, clock_control_subsys_t sys)
{
	struct ra_root_osc_data *dat = dev->data;
...
static
int hoco_driver_api_get_rate(const struct device *dev,
...
hoco_driver_api_get_status(const struct device *dev, clock_control_subsys_t sys)
{
