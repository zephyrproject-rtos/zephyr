...
static
int mosc_driver_api_on(const struct device *dev, clock_control_subsys_t sys)
{
...
static
int mosc_driver_api_off(const struct device *dev, clock_control_subsys_t sys)
{
	struct ra_root_osc_data *dat = dev->data;
...
static
int mosc_driver_api_get_rate(const struct device *dev,
...
mosc_driver_api_get_status(const struct device *dev, clock_control_subsys_t sys)
{
