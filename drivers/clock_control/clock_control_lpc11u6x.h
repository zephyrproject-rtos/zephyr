...
#define LPC11U6X_SYS_AHB_CLK_CTRL_CT16B0   (1 << 7)
#define LPC11U6X_SYS_AHB_CLK_CTRL_CT16B1   (1 << 8)
#define LPC11U6X_SYS_AHB_CLK_CTRL_CT32B0   (1 << 9)
#define LPC11U6X_SYS_AHB_CLK_CTRL_CT32B1   (1 << 10)
#define LPC11U6X_SYS_AHB_CLK_CTRL_SSP0     (1 << 11)
...
struct lpc11u6x_syscon_regs {
	...
	volatile uint32_t wdt_osc_ctrl; /* Watchdog oscillator control */
	...
	volatile uint32_t usb_pll_clk_uen; /* USB PLL clock source update */
	...
	volatile uint32_t frg_clk_div; /* USART 1-4 fractional baud rate generator clock divider */
	...
	volatile uint32_t uart_frg_div;  /* USART1-4 fractional generator divider */
	volatile uint32_t uart_frg_mult; /* USART1-4 fractional generator multiplier */
	volatile const uint32_t reserved10;
	volatile uint32_t ext_trace_cmd;        /* External trace buffer command */
	...
	volatile uint32_t pd_sleep_cfg; /* Deep-sleep power-down states */
	volatile uint32_t pd_awake_cfg; /* Power-down states for wake-up from deep-sleep */
