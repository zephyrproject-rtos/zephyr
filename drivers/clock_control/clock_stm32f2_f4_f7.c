...
BUILD_ASSERT(STM32_PLLSAI_R_ENABLED == STM32_PLLSAI_POST_R_ENABLED,
	...
	(defined(CONFIG_SOC_SERIES_STM32F4X) && (RCC_PLLN_MIN_VALUE == 192))
#ifdef STM32_PLL_ENABLED
BUILD_ASSERT((STM32_PLL_N_MULTIPLIER >= 192),
	     "STM32F2x and STM32F401x series require PLL mul-n >= 192");
#endif /* STM32_PLL_ENABLED */
#ifdef STM32_PLLI2S_ENABLED
BUILD_ASSERT(STM32_PLLI2S_N_MULTIPLIER >= 192,
	     "STM32F2x and STM32F401x series require PLLI2S mul-n >= 192");
#endif /* STM32_PLLI2S_ENABLED */
#endif /* CONFIG_SOC_SERIES_STM32F2X || (CONFIG_SOC_SERIES_STM32F4X && RCC_PLLN_MIN_VALUE == 192) */
