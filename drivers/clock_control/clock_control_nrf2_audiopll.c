...
#define SHIM_MIN_FREQUENCY 10666667
#define SHIM_MAX_FREQUENCY 13333293

#define SHIM_DEFAULT_PRESCALER AUDIOPLL_DIV_4
...
BUILD_ASSERT(DT_INST_PROP(0, frequency) >= SHIM_MIN_FREQUENCY);
BUILD_ASSERT(DT_INST_PROP(0, frequency) <= SHIM_MAX_FREQUENCY);
 ...
 *
 *   frequency = 10666667 + (((13333293 - 10666667) / 65535) * freq_fraction)
 *   frequency = 10666667 + ((2666626 / 65535) * freq_fraction)
 *   frequency = ((10666667 * 65535) + (2666626 * freq_fraction)) / 65535
 *   frequency = (699040021845 + (2666626 * freq_fraction)) / 65535
 *
 * Isolate freq_fraction:
 *
 *   frequency = (699040021845 + (2666626 * freq_fraction)) / 65535
 *   frequency * 65535 = 699040021845 + (2666626 * freq_fractio)
 *   (frequency * 65535) - 699040021845 = 2666626 * freq_fractio
 *   freq_fractio = ((frequency * 65535) - 699040021845) / 2666626
 */
static uint16_t shim_frequency_to_freq_fraction(uint32_t frequency)
{
	...
	freq_fraction *= 65535;
	freq_fraction -= 699040021845;
	freq_fraction /= 2666626;
