...
/*
 * Expand to one case per peripheral instance. `dt` is the DT-binding prefix
 * (uppercase, e.g. LPUART -> MCUX_LPUART0_CLK); `sdk` is the MCUXpresso SDK
 * enum prefix (CamelCase, e.g. Lpuart -> kCLOCK_Lpuart0). LISTIFY iterates
 * 0..(N-1) where N is FSL_FEATURE_SOC_<IP>_COUNT, so undefined SDK
 * identifiers on derivative SoCs are never referenced.
 */
#define MC_CGM_ENABLE_CASE(i, dt, sdk) \
	case MCUX_##dt##i##_CLK: \
		CLOCK_EnableClock(kCLOCK_##sdk##i); \
		return 0;

#define MC_CGM_RATE_CASE(i, dt, sdk) \
	case MCUX_##dt##i##_CLK: \
		*rate = CLOCK_GetFreq(kCLOCK_##sdk##i##Clk); \
		return 0;
...
static int mc_cgm_clock_control_on(const struct device *dev, clock_control_subsys_t sub_system)
{
	...
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_FLEXCAN_COUNT),
		MC_CGM_ENABLE_CASE, (), FLEXCAN, Flexcan)
#endif

#if defined(CONFIG_UART_MCUX_LPUART) && defined(FSL_FEATURE_SOC_LPUART_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPUART_COUNT), MC_CGM_ENABLE_CASE, (), LPUART, Lpuart)
#endif

#if defined(CONFIG_SPI_NXP_LPSPI) && defined(FSL_FEATURE_SOC_LPSPI_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPSPI_COUNT), MC_CGM_ENABLE_CASE, (), LPSPI, Lpspi)
#endif

#if defined(CONFIG_I2C_MCUX_LPI2C) && defined(FSL_FEATURE_SOC_LPI2C_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPI2C_COUNT), MC_CGM_ENABLE_CASE, (), LPI2C, Lpi2c)
#endif

#if defined(CONFIG_COUNTER_MCUX_STM) && defined(FSL_FEATURE_SOC_STM_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_STM_COUNT), MC_CGM_ENABLE_CASE, (), STM, Stm)
#endif

#if defined(CONFIG_COUNTER_NXP_PIT) && defined(FSL_FEATURE_SOC_PIT_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_PIT_COUNT), MC_CGM_ENABLE_CASE, (), PIT, Pit)
#endif

#if defined(CONFIG_COMPARATOR_NXP_LPCMP) && defined(FSL_FEATURE_SOC_LPCMP_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPCMP_COUNT), MC_CGM_ENABLE_CASE, (), CMP, Lpcmp)
#endif

#if defined(CONFIG_ADC_NXP_SAR_ADC) && defined(FSL_FEATURE_SOC_ADC_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_ADC_COUNT), MC_CGM_ENABLE_CASE, (), ADC, Adc)
#endif
...
#if defined(CONFIG_CAN_MCUX_FLEXCAN) && defined(FSL_FEATURE_SOC_FLEXCAN_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_FLEXCAN_COUNT), MC_CGM_RATE_CASE, (), FLEXCAN, Flexcan)
#endif

#if defined(CONFIG_UART_MCUX_LPUART) && defined(FSL_FEATURE_SOC_LPUART_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPUART_COUNT), MC_CGM_RATE_CASE, (), LPUART, Lpuart)
#endif

#if defined(CONFIG_SPI_NXP_LPSPI) && defined(FSL_FEATURE_SOC_LPSPI_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPSPI_COUNT), MC_CGM_RATE_CASE, (), LPSPI, Lpspi)
#endif

#if defined(CONFIG_I2C_MCUX_LPI2C) && defined(FSL_FEATURE_SOC_LPI2C_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPI2C_COUNT), MC_CGM_RATE_CASE, (), LPI2C, Lpi2c)
#endif

#if defined(CONFIG_COUNTER_MCUX_STM) && defined(FSL_FEATURE_SOC_STM_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_STM_COUNT), MC_CGM_RATE_CASE, (), STM, Stm)
#endif

#if defined(CONFIG_COUNTER_NXP_PIT) && defined(FSL_FEATURE_SOC_PIT_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_PIT_COUNT), MC_CGM_RATE_CASE, (), PIT, Pit)
#endif
 ...
 */
#if defined(CONFIG_COMPARATOR_NXP_LPCMP) && defined(FSL_FEATURE_SOC_LPCMP_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_LPCMP_COUNT), MC_CGM_RATE_CASE, (), CMP, Cmp)
#endif

#if defined(CONFIG_ADC_NXP_SAR_ADC) && defined(FSL_FEATURE_SOC_ADC_COUNT)
	LISTIFY(MC_CGM_COUNT(FSL_FEATURE_SOC_ADC_COUNT), MC_CGM_RATE_CASE, (), ADC, Adc)
#endif
