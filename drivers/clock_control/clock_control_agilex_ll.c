...
#include "clock_control_agilex_ll.h"

LOG_MODULE_REGISTER(clock_control_agilex_ll, CONFIG_CLOCK_CONTROL_LOG_LEVEL);
...
uint32_t get_uart_clk(void)
{
	...
	mainpll_nocdiv = sys_read32(clock_ll.mainpll_addr + CLKMGR_MAINPLL_NOCDIV);
...
uint32_t get_mmc_clk(void)
{
	...
	sdmmc_ctr = sys_read32(clock_ll.ctl_addr + CLKMGR_INTEL_SDMMCCTR);
