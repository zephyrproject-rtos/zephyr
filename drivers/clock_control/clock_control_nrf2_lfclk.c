...
#if DT_INST_NODE_HAS_PROP(0, lfxo_clock) && DT_NODE_HAS_STATUS(DT_INST_PROP(0, lfxo_clock), okay)
...
static const uint16_t max_accuracy = DT_PROP(DT_INST_PROP(0, synth_clock), accuracy_ppm);
