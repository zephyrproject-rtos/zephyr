...
__unused static uint32_t get_hclk_frequency(void)
{
	uint32_t sysclk = 0;
	...
	case LL_RCC_SYS_CLKSOURCE_STATUS_PLL1:
		sysclk = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL_M_DIVISOR,
					       ...
					       clock_control_subsys_t sub_system, uint32_t *rate)
{
	...
	case STM32_SRC_PLL1_P:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL_M_DIVISOR,
					     STM32_PLL_N_MULTIPLIER, STM32_PLL_P_DIVISOR);
		break;
	...
	case STM32_SRC_PLL1_S:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL_M_DIVISOR,
					     STM32_PLL_N_MULTIPLIER, STM32_PLL_S_DIVISOR);
		break;
	...
	case STM32_SRC_PLL2_P:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL2_M_DIVISOR,
	...
	case STM32_SRC_PLL2_S:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL2_M_DIVISOR,
					     STM32_PLL2_N_MULTIPLIER, STM32_PLL2_S_DIVISOR);
		break;
	case STM32_SRC_PLL2_T:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL2_M_DIVISOR,
					     STM32_PLL2_N_MULTIPLIER, STM32_PLL2_T_DIVISOR);
		break;
#endif /* CONFIG_SOC_SERIES_STM32H7RSX */
#endif /* STM32_PLL2_ENABLED */
#if defined(STM32_PLL3_ENABLED)
	case STM32_SRC_PLL3_P:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL3_M_DIVISOR,
	...
	case STM32_SRC_PLL3_S:
		*rate = get_pllout_frequency(get_pllsrc_frequency(), STM32_PLL3_M_DIVISOR,
					     STM32_PLL3_N_MULTIPLIER, STM32_PLL3_S_DIVISOR);
		break;
...
__unused static void set_up_fixed_clock_sources(void)
{
...
void stm32_system_clock_update(void)
{
	...
	case 0x18: /* PLL1 used as system clock  source */
		...
		if (pllm != 0U) {
			...
			pllp = (((RCC->PLL1DIVR1 & RCC_PLL1DIVR1_DIVP) >> RCC_PLL1DIVR1_DIVP_Pos) +
				1U);
