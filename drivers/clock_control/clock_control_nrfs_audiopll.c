 ...
 *
 * Fold in subtraction for better fixed-point accuracy:
 *
 *   freq_fraction = (384 * frequency - 4096000000) / 15625
 */
static uint16_t shim_frequency_to_freq_fraction(uint32_t frequency)
{
	int64_t freq_fraction = frequency;

	return CLAMP(DIV_ROUND_CLOSEST(384 * freq_fraction - 4096000000LL, 15625), 0, UINT16_MAX);
}
