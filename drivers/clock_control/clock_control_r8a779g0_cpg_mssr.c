...
static struct cpg_clk_info_table core_props[] = {
	...
	RCAR_CORE_CLK_INFO_ITEM(R8A779G0_CLK_SASYNCPERD1, RCAR_CPG_NONE, RCAR_CPG_NONE,
				RCAR_CPG_KHZ(266660)),
	RCAR_CORE_CLK_INFO_ITEM(R8A779G0_CLK_SASYNCPERD4, RCAR_CPG_NONE, RCAR_CPG_NONE,
				RCAR_CPG_KHZ(66660)),
	RCAR_CORE_CLK_INFO_ITEM(R8A779G0_CLK_CPEX, RCAR_CPG_NONE, RCAR_CPG_NONE,
				RCAR_CPG_KHZ(8330)),
...
static struct cpg_clk_info_table mod_props[] = {
	...
	RCAR_MOD_CLK_INFO_ITEM(628, R8A779G0_CLK_SASYNCPERD4), /* PWM */
	RCAR_MOD_CLK_INFO_ITEM(702, R8A779G0_CLK_S0D12_PER),   /* SCIF0 */
	RCAR_MOD_CLK_INFO_ITEM(911, R8A779G0_CLK_CPEX),        /* CMT 1 */
	RCAR_MOD_CLK_INFO_ITEM(912, R8A779G0_CLK_CPEX),        /* CMT 2 */
	RCAR_MOD_CLK_INFO_ITEM(913, R8A779G0_CLK_CPEX),        /* CMT 3 */
