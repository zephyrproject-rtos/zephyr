...
#define SAM0_GCLK_DECLARE(n)						     \
	static const struct sam0_gclk_config sam0_gclk_config_##n = {	     \
		.clock_frequency = DT_FIXED_CLOCK_GCLK##n##_CLOCK_FREQUENCY, \
		.gen_id = n,						     \
	};								     \
	DEVICE_AND_API_INIT(sam0_gclk_##n, DT_FIXED_CLOCK_GCLK##n##_LABEL,   \
			    sam0_gclk_init, NULL, &sam0_gclk_config_##n,     \
			    PRE_KERNEL_1, 0, &sam0_gclk_api)

#ifdef DT_FIXED_CLOCK_GCLK0_CLOCK_FREQUENCY
SAM0_GCLK_DECLARE(0);
#endif
