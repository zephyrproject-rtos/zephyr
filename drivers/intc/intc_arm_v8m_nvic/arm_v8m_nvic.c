...
static const struct intc_arm_v8m_nvic_config config = {
...
static void arm_v8m_nvic_vector_wrapper(void)
{
#ifdef CONFIG_TRACING_ISR
	sys_trace_isr_enter();
#endif
