...
typedef void (*intc_arm_v7m_nvic_vector_t)(void);
...
{
	struct intc_arm_v7m_nvic_data *data = dev->data;
...
#define ARM_V7M_NVIC_VECTOR_DEFINE(intln, _)							\
...
#define ARM_V7M_NVIC_VECTORS_DEFINE(intlns)							\
	_Pragma("GCC diagnostic push")								\
	_Pragma("GCC diagnostic ignored \"-Wattributes\"")					\
	LISTIFY(intlns, ARM_V7M_NVIC_VECTOR_DEFINE, (), _)					\
	_Pragma("GCC diagnostic pop")

#define ARM_V7M_NVIC_VECTOR_TABLE_ENTRY_DEFINE(intln, _) \
	INTC_DT_VECTOR_SYMBOL(DT_DRV_INST(0), intln)

#define ARM_V7M_NVIC_VECTOR_TABLE_ENTRIES_DEFINE(n) \
	LISTIFY(n, ARM_V7M_NVIC_VECTOR_TABLE_ENTRY_DEFINE, (,), _)

ARM_V7M_NVIC_VECTORS_DEFINE(DT_INST_PROP(0, interrupt_lines))

intc_arm_v7m_nvic_vector_t __irq_vector_table _irq_vector_table[] = {
	ARM_V7M_NVIC_VECTOR_TABLE_ENTRIES_DEFINE(DT_INST_PROP(0, interrupt_lines))
};

static struct intc_arm_v7m_nvic_data data;
