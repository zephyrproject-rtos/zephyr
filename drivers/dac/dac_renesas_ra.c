...
#if DT_PROP(DT_PARENT(DT_DRV_INST(0)), renesas_dac_has_output_amplifier)
	config_extend->output_amplifier_enabled = channel_cfg->buffered;
#elif DT_PROP(DT_PARENT(DT_DRV_INST(0)), renesas_dac_has_chargepump)
...
#if DT_PROP(DT_PARENT(DT_DRV_INST(0)), renesas_dac_has_internal_output)
...
#if DT_PROP(DT_PARENT(DT_DRV_INST(0)), renesas_dac_has_davrefcr)
