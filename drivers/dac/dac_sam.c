 ...
 *
 * Remarks:
 * Only SAME70, SAMV71, SAM4S series devices are currently supported. Please submit a
 * patch.
 */
...
BUILD_ASSERT(IS_ENABLED(CONFIG_SOC_SERIES_SAME70) || IS_ENABLED(CONFIG_SOC_SERIES_SAMV71) ||
		     IS_ENABLED(CONFIG_SOC_SERIES_SAM4S),
	     "Only SAME70, SAMV71, SAM4S series devices are currently supported.");
...
#if defined(CONFIG_SOC_SERIES_SAMV71) || defined(CONFIG_SOC_SERIES_SAME70)
