...
#ifndef __INTEL_DAI_DRIVER_UAOL_REGS_H__
#define __INTEL_DAI_DRIVER_UAOL_REGS_H__

#include <stdint.h>

/* UAOL HDAML registers */
...
/* ALH registers */
#if CONFIG_SOC_INTEL_ACE15_MTPM
#define STRMzTXDA_OFFSET(z)			(0x000 + 4 * (z))
#define STRMzRXDA_OFFSET(z)			(0x100 + 4 * (z))
#endif
...
#endif /* __INTEL_DAI_DRIVER_UAOL_REGS_H__ */
