...
enum ipc4_uaol_aux_config_tlv_type {
	IPC4_UAOL_AUX_CONFIG_TLV_XHCI_CONTROLLER_BDF    = 0,
	IPC4_UAOL_AUX_CONFIG_TLV_UAOL_CONFIG            = 1,
	IPC4_UAOL_AUX_CONFIG_TLV_FIFO_SAO               = 2,
...
enum ipc4_uaol_dma_control_tlv_type {
	IPC4_UAOL_DMA_CONTROL_TLV_SET_EP_TABLE          = 0,
	IPC4_UAOL_DMA_CONTROL_TLV_RESET_EP_TABLE        = 1,
	IPC4_UAOL_DMA_CONTROL_TLV_SET_EP_INFO           = 3,
	IPC4_UAOL_DMA_CONTROL_TLV_SET_EP_FEEDBACK_INFO  = 4,
	IPC4_UAOL_DMA_CONTROL_TLV_SET_FEEDBACK_PERIOD   = 5,
};
