 ...
 */
__pinned_func void z_loapic_int_vec_set(unsigned int irq,   /* IRQ number of the interrupt */
...
DEVICE_DT_INST_DEFINE(0, loapic_init, PM_DEVICE_DT_INST_GET(0), NULL, NULL, PRE_KERNEL_1,
