...
#elif defined(CONFIG_SOC_SERIES_STM32MP2X)
	return (LL_EXTI_IsActiveRisingFlag_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line)) ||
		LL_EXTI_IsActiveFallingFlag_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line)));
#else
...
#elif defined(CONFIG_SOC_SERIES_STM32MP2X)
	LL_EXTI_ClearRisingFlag_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line));
	LL_EXTI_ClearFallingFlag_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line));
#else
...
#elif defined(CONFIG_SOC_SERIES_STM32MP2X)
	LL_C2_EXTI_EnableIT_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line));
#else
...
#elif defined(CONFIG_SOC_SERIES_STM32MP2X)
	LL_C2_EXTI_DisableIT_0_31(EXTI2, stm32_exti_linenum_to_src_cfg_line(line));
#else
...
#if defined(CONFIG_SOC_SERIES_STM32MP2X)
	uint32_t exti_line = stm32_exti_linenum_to_src_cfg_line(line);
#endif

	switch (trg) {
#if defined(CONFIG_SOC_SERIES_STM32MP2X)
	case STM32_GPIO_IRQ_TRIG_NONE:
	LL_EXTI_DisableRisingTrig_0_31(EXTI2, exti_line);
	LL_EXTI_DisableFallingTrig_0_31(EXTI2, exti_line);
	break;
	case STM32_GPIO_IRQ_TRIG_RISING:
	LL_EXTI_EnableRisingTrig_0_31(EXTI2, exti_line);
	LL_EXTI_DisableFallingTrig_0_31(EXTI2, exti_line);
	break;
	case STM32_GPIO_IRQ_TRIG_FALLING:
	LL_EXTI_EnableFallingTrig_0_31(EXTI2, exti_line);
	LL_EXTI_DisableRisingTrig_0_31(EXTI2, exti_line);
	break;
