...
#define irqsteer_arch_irq_enable(irq)     irq_enable(irq);
#define irqsteer_arch_irq_disable(irq)    irq_disable(irq);
#define irqsteer_arch_irq_is_enabled(irq) irq_is_enabled(irq);
#else
