...
#define RTC_STM32_EXTI_LINE_NUM	DT_INST_PROP(0, alrm_exti_line)
...
static inline void ll_func_exti_enable_rtc_alarm_it(uint32_t line_num)
{
...
static inline void ll_func_exti_clear_rtc_alarm_flag(uint32_t line_num)
{
#if defined(CONFIG_SOC_SERIES_STM32U5X) || defined(CONFIG_SOC_SERIES_STM32WBAX)
...
void rtc_stm32_isr(const struct device *dev)
{
	...
	ll_func_exti_clear_rtc_alarm_flag(RTC_STM32_EXTI_LINE_NUM);
}
 ...
 */
	...
	ll_func_exti_enable_rtc_alarm_it(RTC_STM32_EXTI_LINE_NUM);
