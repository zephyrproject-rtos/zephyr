					   ...
					   const struct rtc_time *timeptr)
{
	...
	DL_RTC_Common_enableInterrupt(cfg->base, DL_RTC_COMMON_INTERRUPT_CALENDAR_ALARM1);
}
					   ...
					   const struct rtc_time *timeptr)
{
	...
	DL_RTC_Common_enableInterrupt(cfg->base, DL_RTC_COMMON_INTERRUPT_CALENDAR_ALARM2);
}
