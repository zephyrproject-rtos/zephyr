...
/**
 * @brief Configuration structure for TM1637.
 */
...
/**
 * @brief Configuration instance for TM1637.
 */
const struct tm1637_config tm1637_cfg = {
	.clk = GPIO_DT_SPEC_INST_GET(0, clk_gpios),
	.dio = GPIO_DT_SPEC_INST_GET(0, dio_gpios),
};

/**
 * @brief Delay for TM1637 communication.
 */
...
/**
 * @brief Start TM1637 communication.
 *
 * @param cfg TM1637 configuration.
...
/**
 * @brief Stop TM1637 communication.
 *
 * @param cfg TM1637 configuration.
 * @return 0 on success, negative errno on failure.
 */
...
/**
 * @brief Write a single byte to TM1637.
 *
 * @param cfg TM1637 configuration.
...
/**
 * @brief Digit to segment mapping for TM1637.
 */
...
/**
 * @brief Display raw segments at a specific position.
 */
...
/**
 * @brief Display a number on the TM1637.
 */
