					...
					const uint8_t *data, size_t len)
{
	...
	/* Datas are send as a command following the mipi_cbi api */
			 ...
			 const struct display_buffer_descriptor *desc, const void *buf)
{
	...
	ssd1327_write_bus_cmd(dev, SSD1327_SET_COLUMN_ADDR, x_position, sizeof(x_position));
	ssd1327_write_bus_cmd(dev, SSD1327_SET_ROW_ADDR, y_position, sizeof(y_position));
