...
#define EPD_PANEL_NUMOF_ROWS_PER_PAGE	8U
#define SSD16XX_PANEL_FIRST_PAGE	0U
#define SSD16XX_PANEL_FIRST_GATE	0U
#define SSD16XX_PIXELS_PER_BYTE		8U
...
static inline int ssd16xx_set_ram_ptr(const struct device *dev,
...
static int ssd16xx_update_display(const struct device *dev)
{
	...
	return ssd16xx_write_cmd(dev, SSD16XX_CMD_MASTER_ACTIVATION,
				 NULL, 0);
}
