...
static int dummy_display_write(const struct device *dev, const uint16_t x, const uint16_t y,
...
static int dummy_display_set_brightness(const struct device *dev, const uint8_t brightness)
{
	return 0;
}

static int dummy_display_set_contrast(const struct device *dev, const uint8_t contrast)
{
	return 0;
}
