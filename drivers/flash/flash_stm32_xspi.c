...
#if DT_INST_NODE_HAS_PROP(0, four_byte_opcodes)
	.four_byte_opcodes = DT_INST_PROP(0, four_byte_opcodes),
#endif /* four_byte_opcodes */
#if DT_INST_NODE_HAS_PROP(st_stm32_ospi_nor, requires_ulbpr)
	.requires_ulbpr = DT_INST_PROP(0, requires_ulbpr),
#endif /* requires_ulbpr */
	.pcfg = PINCTRL_DT_DEV_CONFIG_GET(STM32_XSPI_NODE),
#if DT_INST_NODE_HAS_PROP(0, reset_gpios)
	.reset = GPIO_DT_SPEC_INST_GET(0, reset_gpios),
	.reset_gpios_duration = DT_INST_PROP(0, reset_gpios_duration),
#endif /* reset_gpios */
#if DT_INST_NODE_HAS_PROP(0, sfdp_bfp)
