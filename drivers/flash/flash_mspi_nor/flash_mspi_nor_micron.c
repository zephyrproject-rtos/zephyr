...
struct flash_mspi_device_data mt35xu02gcba_octal = {
...
struct flash_mspi_device_data mt25qu512abb_quad = {
...
static int mxicy_mx25r_post_switch_mode(const struct device *dev)
{
	...
	uint32_t freq = FLASH_DATA(dev)->dev_cfg.freq;
	int rc;
	uint8_t status;
	...
	flash_mspi_command_set(dev, &FLASH_DATA(dev)->jedec_cmds->config);
...
struct flash_mspi_device_data mxicy_mx25u_single = {
...
struct flash_mspi_device_data mxicy_mx25u_octal = {
	.jedec_id = {0xc2, 0x84, 0x37}, /* MT25QU512ABB */
	FLASH_PAGE_LAYOUT_DEFINE(CONFIG_FLASH_MSPI_NOR_LAYOUT_PAGE_SIZE, 0x100000)
	.flash_size = 0x100000,
	.dev_cfg = {
...
struct flash_mspi_device_data mxicy_mx25r_single = {
...
struct flash_mspi_device_data mxicy_mx25r_quad = {
	.jedec_id = {0xc2, 0x28, 0x17}, /* MX25R6435F */
	FLASH_PAGE_LAYOUT_DEFINE(CONFIG_FLASH_MSPI_NOR_LAYOUT_PAGE_SIZE, 0x800000)
	.flash_size = 0x800000,
	.dev_cfg = {
...
const struct flash_mspi_device_data *micron_flash_devs[] = {
	&mt35xu02gcba_octal,
	&mt25qu512abb_quad,
	&mxicy_mx25u_single,
	&mxicy_mx25u_octal,
