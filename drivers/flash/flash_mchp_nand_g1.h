...
/**
 * @file
 * @brief Microchip NAND Flash G1 driver.
 */

#ifndef _ZEPHYR_DRIVERS_FLASH_FLASH_MCHP_NAND_G1_H_
#define _ZEPHYR_DRIVERS_FLASH_FLASH_MCHP_NAND_G1_H_
...
#endif /* _ZEPHYR_DRIVERS_FLASH_FLASH_MCHP_NAND_G1_H_ */
