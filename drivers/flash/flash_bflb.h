...
struct bflb_header_flash_cfg {
	/* Serial flash interface mode,
	 * bit0-3:spi mode, bit4:unwrap, bit5:32-bits addr mode support
	 */
	uint8_t io_mode;
	...
	uint8_t clk_delay;
	/* SPI clock phase invert,
	 * bit0:clck invert, bit1:rx invert, bit2-4:pad delay, bit5-7:pad delay
	 */
	uint8_t clk_invert;
