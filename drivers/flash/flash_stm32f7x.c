 ...
 * sothers select sector, So we remap sector number.
 */
...
#endif /* defined(FLASH_OPTCR_nDBANK) */

	regs->cr &= (STM32F7X_SECTOR_MASK & CR_PSIZE_MASK);
	regs->cr |= FLASH_PSIZE_BYTE;
	regs->cr |= FLASH_CR_SER | (sector << FLASH_CR_SNB_Pos);
...
static const struct flash_pages_layout stm32f7_flash_layout_single_bank[] = {
	/* RM0410, table 5: STM32F76xxG and STM32F77xxG in single bank */
	{.pages_count = 4, .pages_size = KB(32)},
	{.pages_count = 1, .pages_size = KB(128)},
	{.pages_count = 3, .pages_size = KB(256)},
};
static const struct flash_pages_layout stm32f7_flash_layout_dual_bank[] = {
	/* RM0410, table 6: STM32F76xxG and STM32F77xxG in dual bank */
	{.pages_count = 4, .pages_size = KB(16)},
	{.pages_count = 1, .pages_size = KB(64)},
	{.pages_count = 3, .pages_size = KB(128)},
	{.pages_count = 4, .pages_size = KB(16)},
...
static const struct flash_pages_layout stm32f7_flash_layout_single_bank[] = {
	/* RM0410, table 3: STM32F76xxI and STM32F77xxI in single bank */
	{.pages_count = 4, .pages_size = KB(32)},
	{.pages_count = 1, .pages_size = KB(128)},
	{.pages_count = 7, .pages_size = KB(256)},
};
static const struct flash_pages_layout stm32f7_flash_layout_dual_bank[] = {
	/* RM0410, table 4: STM32F76xxI and STM32F77xxI in dual bank */
	{.pages_count = 4, .pages_size = KB(16)},
	{.pages_count = 1, .pages_size = KB(64)},
