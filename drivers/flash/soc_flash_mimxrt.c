...
flexspi_device_config_t s26kl_deviceconfig = {
	...
	.isSck2Enabled = false,
	.flashSize = DT_FLASH_SIZE,     /* Flash size must be confiured in kBytes! */
...
const uint32_t s26kl_lut[CUSTOM_LUT_LENGTH] = {
	/* Read Data */
	...
	[4 * HYPERFLASH_CMD_LUT_SEQ_IDX_WRITEENABLE + 6] =
		FLEXSPI_LUT_SEQ(kFLEXSPI_Command_DDR, kFLEXSPI_8PAD, 0x00, kFLEXSPI_Command_DDR, kFLEXSPI_8PAD, 0x02),  // ADDR 0x2AA
			     ...
			     void *data, size_t len)
{
	...
	uint32_t addr = offset + CONFIG_FLASH_BASE_ADDRESS;
