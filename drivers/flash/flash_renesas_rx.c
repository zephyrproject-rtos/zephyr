 ...
 */
#if CONFIG_FLASH_RENESAS_RX_BGO_ENABLED
...
#define GET_WRITE_BLOCK_SIZE(index) COND_CODE_1(IS_FLASH_DF(DT_REG_ADDR(index)), (1), (4))
...
#define FLASH_RX_INIT(index)                                                                       \
	...
	static struct flash_rx_config flash_rx_config_##index = {                                  \
		.flash_rx_parameters = {                                                           \
			.erase_value = (0xff),                                                     \
			.write_block_size = GET_WRITE_BLOCK_SIZE(index),                           \
		}};                                                                                \
