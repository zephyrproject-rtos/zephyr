...
static int qspi_flash_rz_read_jedec_id(const struct device *dev, uint8_t *id)
{
	...
	spi_flash_direct_transfer_t trans = {.command = SPI_NOR_CMD_RDID,
					     .address = 0,
					     .data = 0,
					     .command_length = 1U,
					     .address_length = 0U,
					   ...
					   size_t len)
{
	...
	spi_flash_direct_transfer_t trans = {.command = QSPI_CMD_RDSFDP,
					     .address = addr,
					     .data = 0,
					     .command_length = 1U,
					     .address_length = 3U,
				  ...
				  uint8_t data_length)
{
	...
	spi_flash_direct_transfer_t trans = {.command = command,
					     .address = 0U,
					     .data = tx_data,
					     .command_length = 1U,
					     .address_length = 0U,
