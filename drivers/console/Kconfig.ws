...
config WS_CONSOLE_LINE_BUF_SIZE
...
config WS_CONSOLE_LINE_BUF_NUMBERS
	...
	WS_CONSOLE_LINE_BUF_SIZE and this current option to get the
	best possible buffer settings you need.

config WS_CONSOLE_SEND_TIMEOUT
...
config WS_CONSOLE_SEND_THRESHOLD
...
config WS_CONSOLE_INIT_PRIORITY
