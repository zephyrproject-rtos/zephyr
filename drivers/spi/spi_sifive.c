...
int spi_config(const struct device *dev, u32_t frequency, u16_t operation)
{
	u32_t div;
	u32_t fmt_len;
...
void spi_sifive_send(const struct device *dev, u16_t frame)
{
...
u16_t spi_sifive_recv(const struct device *dev)
{
	u32_t val;
