...
#define SPIS_PINS_CROSS_DOMAIN(inst)			\
	DT_INST_PROP(inst, cross_domain_pins_supported)

#define SPIS_PINS_CROSS_DOMAIN_OR(inst)	SPIS_PINS_CROSS_DOMAIN(inst) ||

#if (DT_INST_FOREACH_STATUS_OKAY(SPIS_PINS_CROSS_DOMAIN_OR) 0)
