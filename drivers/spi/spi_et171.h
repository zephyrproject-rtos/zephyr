...
#define REG_WR_TRANS_CNT 0x18
#define REG_RD_TRANS_CNT 0x1C
...
#define SPI_WR_TRANS_CNT(base) (base + REG_WR_TRANS_CNT)
#define SPI_RD_TRANS_CNT(base) (base + REG_RD_TRANS_CNT)
...
#define MAX_TRANSFER_CNT		(256 * 1024)
