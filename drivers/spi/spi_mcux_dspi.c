...
DEVICE_AND_API_INIT(DT_SPI_0_PARENT_NAME, spi_mcux_0,
		    DT_SPI_0_NAME, &spi_mcux_init,
...
DEVICE_AND_API_INIT(DT_SPI_1_PARENT_NAME, spi_mcux_1,
		    DT_SPI_1_NAME, &spi_mcux_init,
...
DEVICE_AND_API_INIT(DT_SPI_2_PARENT_NAME, spi_mcux_2,
		    DT_SPI_2_NAME, &spi_mcux_init,
