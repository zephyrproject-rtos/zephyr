				    ...
				    const struct spi_buf_set *rx_bufs)
{
	...
	regs->CTRLA.reg = (1 << QSPI_CTRLA_LASTXFER_Pos) | (1 << QSPI_CTRLA_ENABLE_Pos);
...
static const struct spi_driver_api sam0_quadspi_driver_api = {
	...
	.transceive_async = sam0_quadspi_transceive_async,
#endif
...
#define SAM0_QUADSPI_DEVICE_INIT(n)                                            \
	...
	DEVICE_DT_INST_DEFINE(n, &sam0_quadspi_init, device_pm_control_nop,    \
			      &sam0_quadspi_dev_data_##n,                      \
			      &sam0_quadspi_config_##n, POST_KERNEL,           \
