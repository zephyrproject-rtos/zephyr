...
#define DT_DRV_COMPAT nxp_lpc_spi_nb
...
LOG_MODULE_REGISTER(spi_mcux_flexcomm_nb, CONFIG_SPI_LOG_LEVEL);
...
static void cleanup_dma_context(const struct device *spi_dev, int status);
