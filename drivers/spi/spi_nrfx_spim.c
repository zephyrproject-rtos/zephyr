...
#define SPI_NRFX_SPIM_DEFINE(idx)					       \
	...
	static const struct spi_nrfx_config spi_##idx##z_config = {	       \
		...
		IF_ENABLED(UTIL_AND(					       \
			...
			(.cross_domain = true,				       \
			 .default_port =				       \
				SPIM_PROP(idx, cross_domain_default_port),))   \
	};								       \
