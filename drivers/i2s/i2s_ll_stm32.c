...
static int start_dma(struct device *dev_dma, u32_t channel,
		     ...
		     bool dst_addr_increment, u32_t blk_size)
{
...
static int i2s_stm32_translate_direction(struct stream *stream)
{
	switch (stream->direction) {
	case STM32_DMA_MEMORY_TO_MEMORY:
		stream->dma_cfg.channel_direction = MEMORY_TO_MEMORY;
		break;
	case STM32_DMA_MEMORY_TO_PERIPH:
		stream->dma_cfg.channel_direction = MEMORY_TO_PERIPHERAL;
		break;
	case STM32_DMA_PERIPH_TO_MEMORY:
		stream->dma_cfg.channel_direction = PERIPHERAL_TO_MEMORY;
		break;
	default:
		LOG_ERR("Direction from dts parse failed.");
		return -EINVAL;
	}
...
static int i2s_stm32_initialize(struct device *dev)
{
	...
	i2s_stm32_translate_direction(&dev_data->tx);
	i2s_stm32_translate_direction(&dev_data->rx);
...
static int rx_stream_start(struct stream *stream, struct device *dev)
{
	...
	ret = start_dma(dev_data->dev_dma_rx, stream->dma_channel,
			...
			stream->dst_addr_increment, stream->cfg.block_size);
	if (ret < 0) {
...
static struct i2s_stm32_data i2s_stm32_data_1 = {
	.rx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_1_DMA_SRC_DATA_SIZE_RX,  /* 16bit default */
			.dest_data_size = DT_I2S_1_DMA_DST_DATA_SIZE_RX,    /* 16bit default */
			.source_burst_length = DT_I2S_1_DMA_SRC_BURST_LENGTH_RX, /* SINGLE transfer */
			.dest_burst_length = DT_I2S_1_DMA_DST_BURST_LENGTH_RX,
			.channel_priority = DT_I2S_1_DMA_PRIORITY_RX,
			.dma_callback = dma_rx_callback,
		},
		.direction = DT_I2S_1_DMA_DIRECTION_RX,
	...
	.tx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_1_DMA_SRC_DATA_SIZE_TX,  /* 16bit default */
			.dest_data_size = DT_I2S_1_DMA_DST_DATA_SIZE_TX,    /* 16bit default */
			.source_burst_length = DT_I2S_1_DMA_SRC_BURST_LENGTH_TX,
			.dest_burst_length = DT_I2S_1_DMA_DST_BURST_LENGTH_TX, /* SINGLE transfer */
		...
		.direction = DT_I2S_1_DMA_DIRECTION_TX,
...
static struct i2s_stm32_data i2s_stm32_data_2 = {
	.rx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_2_DMA_SRC_DATA_SIZE_RX,  /* 16bit default */
			.dest_data_size = DT_I2S_2_DMA_DST_DATA_SIZE_RX,    /* 16bit default */
			.source_burst_length = DT_I2S_2_DMA_SRC_BURST_LENGTH_RX, /* SINGLE transfer */
			.dest_burst_length = DT_I2S_2_DMA_DST_BURST_LENGTH_RX,
		...
		.direction = DT_I2S_2_DMA_DIRECTION_RX,
		.stream_start = rx_stream_start,
		.stream_disable = rx_stream_disable,
		.queue_drop = rx_queue_drop,
	...
	.tx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_2_DMA_SRC_DATA_SIZE_TX,  /* 16bit default */
			.dest_data_size = DT_I2S_2_DMA_DST_DATA_SIZE_TX,    /* 16bit default */
			.source_burst_length = DT_I2S_2_DMA_SRC_BURST_LENGTH_TX,
			.dest_burst_length = DT_I2S_2_DMA_DST_BURST_LENGTH_TX, /* SINGLE transfer */
		...
		.direction = DT_I2S_2_DMA_DIRECTION_TX,
		.stream_start = tx_stream_start,
		.stream_disable = tx_stream_disable,
		.queue_drop = tx_queue_drop,
...
static struct i2s_stm32_data i2s_stm32_data_3 = {
	.rx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_3_DMA_SRC_DATA_SIZE_RX,  /* 16bit default */
			.dest_data_size = DT_I2S_3_DMA_DST_DATA_SIZE_RX,    /* 16bit default */
			.source_burst_length = DT_I2S_3_DMA_SRC_BURST_LENGTH_RX, /* SINGLE transfer */
			.dest_burst_length = DT_I2S_3_DMA_DST_BURST_LENGTH_RX,
		...
		.direction = DT_I2S_3_DMA_DIRECTION_RX,
		.stream_start = rx_stream_start,
		.stream_disable = rx_stream_disable,
		.queue_drop = rx_queue_drop,
	...
	.tx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_3_DMA_SRC_DATA_SIZE_TX,  /* 16bit default */
			.dest_data_size = DT_I2S_3_DMA_DST_DATA_SIZE_TX,    /* 16bit default */
			.source_burst_length = DT_I2S_3_DMA_SRC_BURST_LENGTH_TX,
			.dest_burst_length = DT_I2S_3_DMA_DST_BURST_LENGTH_TX, /* SINGLE transfer */
		...
		.direction = DT_I2S_3_DMA_DIRECTION_TX,
		.stream_start = tx_stream_start,
		.stream_disable = tx_stream_disable,
		.queue_drop = tx_queue_drop,
...
static struct i2s_stm32_data i2s_stm32_data_4 = {
	.rx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_4_DMA_SRC_DATA_SIZE_RX,  /* 16bit default */
			.dest_data_size = DT_I2S_4_DMA_DST_DATA_SIZE_RX,    /* 16bit default */
			.source_burst_length = DT_I2S_4_DMA_SRC_BURST_LENGTH_RX, /* SINGLE transfer */
			.dest_burst_length = DT_I2S_4_DMA_DST_BURST_LENGTH_RX,
		...
		.direction = DT_I2S_4_DMA_DIRECTION_RX,
		.stream_start = rx_stream_start,
		.stream_disable = rx_stream_disable,
		.queue_drop = rx_queue_drop,
	...
	.tx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_4_DMA_SRC_DATA_SIZE_TX,  /* 16bit default */
			.dest_data_size = DT_I2S_4_DMA_DST_DATA_SIZE_TX,    /* 16bit default */
			.source_burst_length = DT_I2S_4_DMA_SRC_BURST_LENGTH_TX,
			.dest_burst_length = DT_I2S_4_DMA_DST_BURST_LENGTH_TX, /* SINGLE transfer */
		...
		.direction = DT_I2S_4_DMA_DIRECTION_TX,
		.stream_start = tx_stream_start,
		.stream_disable = tx_stream_disable,
		.queue_drop = tx_queue_drop,
...
static struct i2s_stm32_data i2s_stm32_data_5 = {
	.rx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_5_DMA_SRC_DATA_SIZE_RX,  /* 16bit default */
			.dest_data_size = DT_I2S_5_DMA_DST_DATA_SIZE_RX,    /* 16bit default */
			.source_burst_length = DT_I2S_5_DMA_SRC_BURST_LENGTH_RX, /* SINGLE transfer */
			.dest_burst_length = DT_I2S_5_DMA_DST_BURST_LENGTH_RX,
		...
		.direction = DT_I2S_5_DMA_DIRECTION_RX,
		.stream_start = rx_stream_start,
		.stream_disable = rx_stream_disable,
		.queue_drop = rx_queue_drop,
	...
	.tx = {
		...
		.dma_cfg = {
			...
			.source_data_size = DT_I2S_5_DMA_SRC_DATA_SIZE_TX,  /* 16bit default */
			.dest_data_size = DT_I2S_5_DMA_DST_DATA_SIZE_TX,    /* 16bit default */
			.source_burst_length = DT_I2S_5_DMA_SRC_BURST_LENGTH_TX,
			.dest_burst_length = DT_I2S_5_DMA_DST_BURST_LENGTH_TX, /* SINGLE transfer */
		...
		.direction = DT_I2S_5_DMA_DIRECTION_TX,
		.stream_start = tx_stream_start,
		.stream_disable = tx_stream_disable,
		.queue_drop = tx_queue_drop,
