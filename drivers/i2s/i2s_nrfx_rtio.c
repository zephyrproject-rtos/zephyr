...
static bool is_clk_controller(const struct i2s_iodev_config *i2s_cfg)
{
...
static void find_suitable_clock(const struct i2s_nrfx_rtio_config *drv_cfg,
				nrfx_i2s_config_t *nrfx_cfg,
				const struct i2s_iodev_config *i2s_cfg)
{
...
static int stream_try_start(const struct device *dev)
{
	...
	struct block_bufs bufs;
	struct i2s_iodev_config i2s_cfg;
	int ret;
	...
	i2s_get_config_iodev(iodev, &i2s_cfg);
