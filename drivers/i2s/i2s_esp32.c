...
static int i2s_esp32_config_check(const struct device *dev, enum i2s_dir dir,
				  const struct i2s_config *i2s_cfg, uint8_t *data_format)
{
	struct i2s_esp32_data *dev_data = dev->data;
	const struct i2s_esp32_cfg *dev_cfg = dev->config;
	const struct i2s_esp32_stream *stream;
...
static int i2s_esp32_config_apply(const struct device *dev, enum i2s_dir dir,
				  const struct i2s_config *i2s_cfg, uint8_t data_format)
{
	const struct i2s_esp32_cfg *dev_cfg = dev->config;
	const struct i2s_esp32_stream *stream;
			       ...
			       const struct i2s_config *i2s_cfg)
{
	...
	err = i2s_esp32_config_check(dev, dir, i2s_cfg, &data_format);
	if (err < 0) {
		return err;
	}
	...
	err = i2s_esp32_config_apply(dev, dir, i2s_cfg, data_format);
	if (err < 0) {
		return err;
	}
