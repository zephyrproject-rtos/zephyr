...
#define DT_DRV_COMPAT zephyr_reset_mmio
#define RESET_MMIO_INIT(n)                                                                         \
	...
	DEVICE_DT_INST_DEFINE(n, NULL, NULL, NULL, &reset_mmio_dev_config_##n, POST_KERNEL,        \
			      CONFIG_KERNEL_INIT_PRIORITY_DEVICE, &reset_mmio_driver_api);
