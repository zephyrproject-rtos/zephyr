...
/* LDO descriptors */
static const struct sf32lb_ldo_desc sf32lb_ldo18_desc = {
	.enable_mask = PMUC_PERI_LDO_EN_LDO18_Msk,
	.pd_mask = PMUC_PERI_LDO_LDO18_PD_Msk,
};

static const struct sf32lb_ldo_desc sf32lb_ldo2_3v3_desc = {
	.enable_mask = PMUC_PERI_LDO_EN_VDD33_LDO2_Msk,
	.pd_mask = PMUC_PERI_LDO_VDD33_LDO2_PD_Msk,
};

static const struct sf32lb_ldo_desc sf32lb_ldo3_3v3_desc = {
...
#define REGULATOR_SF32LB_DEFINE(node_id, _desc)                                                    \
	static struct regulator_sf32lb_data data_##node_id;                                        \
                                                                                                   \
	static const struct regulator_sf32lb_config config_##node_id = {                           \
		.common = REGULATOR_DT_COMMON_CONFIG_INIT(node_id),                                \
		.reg = DT_REG_ADDR(DT_PARENT(node_id)) + SF32LB_PERI_LDO_OFFSET,                   \
		.desc = _desc,                                                                     \
	};                                                                                         \
                                                                                                   \
	DEVICE_DT_DEFINE(node_id, regulator_sf32lb_init, NULL, &data_##node_id, &config_##node_id, \
			 PRE_KERNEL_1, CONFIG_REGULATOR_SF32LB_LDO_INIT_PRIORITY,                  \
			 &regulator_sf32lb_api);

/* LDO18 */
#define DT_DRV_COMPAT sifli_sf32lb_ldo18
#define REGULATOR_SF32LB_LDO18_DEFINE(inst)                                                        \
	REGULATOR_SF32LB_DEFINE(DT_DRV_INST(inst), &sf32lb_ldo18_desc)

DT_INST_FOREACH_STATUS_OKAY(REGULATOR_SF32LB_LDO18_DEFINE)

#undef DT_DRV_COMPAT

/* LDO2 3V3 */
#define DT_DRV_COMPAT sifli_sf32lb_ldo2_3v3
#define REGULATOR_SF32LB_LDO2_3V3_DEFINE(inst)                                                     \
	REGULATOR_SF32LB_DEFINE(DT_DRV_INST(inst), &sf32lb_ldo2_3v3_desc)

DT_INST_FOREACH_STATUS_OKAY(REGULATOR_SF32LB_LDO2_3V3_DEFINE)

#undef DT_DRV_COMPAT

/* LDO3 3V3 */
#define DT_DRV_COMPAT sifli_sf32lb_ldo3_3v3
#define REGULATOR_SF32LB_LDO3_3V3_DEFINE(inst)                                                     \
	REGULATOR_SF32LB_DEFINE(DT_DRV_INST(inst), &sf32lb_ldo3_3v3_desc)

DT_INST_FOREACH_STATUS_OKAY(REGULATOR_SF32LB_LDO3_3V3_DEFINE)
