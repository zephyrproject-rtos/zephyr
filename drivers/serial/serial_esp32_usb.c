...
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
static void serial_esp32_usb_isr(const void *arg);
#endif
...
static void IRAM_ATTR serial_esp32_usb_isr(const void *arg)
{
...
static void serial_esp32_usb_irq_configure(void)
{
	IRQ_CONNECT(DT_INST_IRQN_BY_IDX(0, 0), IRQ_DEFAULT_PRIORITY,
		    serial_esp32_usb_isr, DEVICE_DT_INST_GET(0), ESP_INTR_FLAG_IRAM);
