...
static const struct uart_sifive_device_config uart_sifive_dev_cfg_0 = {
	.port         = SIFIVE_UART0_BASE_ADDRESS,
	.sys_clk_freq = uart_sifive_port_0_clk_freq,
	.baud_rate    = CONFIG_UART_SIFIVE_PORT_0_BAUD_RATE,
...
DEVICE_AND_API_INIT(uart_sifive_0, CONFIG_UART_SIFIVE_PORT_0_NAME,
		    uart_sifive_init,
...
static const struct uart_sifive_device_config uart_sifive_dev_cfg_1 = {
	.port         = SIFIVE_UART1_BASE_ADDRESS,
	.sys_clk_freq = uart_sifive_port_1_clk_freq,
	.baud_rate    = CONFIG_UART_SIFIVE_PORT_1_BAUD_RATE,
...
DEVICE_AND_API_INIT(uart_sifive_1, CONFIG_UART_SIFIVE_PORT_1_NAME,
		    uart_sifive_init,
