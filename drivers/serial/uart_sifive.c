...
DEVICE_AND_API_INIT(DT_SIFIVE_UART_0_PARENT_LABEL, uart_sifive_0,
		    DT_SIFIVE_UART_0_LABEL,
		    uart_sifive_init,
...
DEVICE_AND_API_INIT(DT_SIFIVE_UART_1_PARENT_LABEL, uart_sifive_1,
		    DT_SIFIVE_UART_1_LABEL,
		    uart_sifive_init,
