...
static const uint32_t uart_bee_baudrate_table[][3] = {
	{271, 10, 0x24A}, /* 9600    */
	{150, 8, 0x3EF},  /* 19200   */
	{20, 12, 0x252},  /* 115200  */
	{11, 10, 0x3BB},  /* 230400  */
...
static int uart_bee_configure(const struct device *dev, const struct uart_config *cfg)
{
	...
	uart_init_struct.UART_Div = uart_bee_baudrate_table[baudrate_idx][0];
	uart_init_struct.UART_Ovsr = uart_bee_baudrate_table[baudrate_idx][1];
	uart_init_struct.UART_OvsrAdj = uart_bee_baudrate_table[baudrate_idx][2];
