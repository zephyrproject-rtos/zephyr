...
/*
 * This thread is a workaround for not implemented IRQs in Mi-V.
 * Since we cannot rely on IRQs, the rx_thread is working instead
 * and polling for data. The thread calls the registered callback
 * when data arrives.
 */
