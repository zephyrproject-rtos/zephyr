...
DEVICE_AND_API_INIT(DT_UART_MCUX_0_PARENT_NAME, uart_0, DT_UART_MCUX_0_NAME,
		    &uart_mcux_init,
...
DEVICE_AND_API_INIT(DT_UART_MCUX_1_PARENT_NAME, uart_1, DT_UART_MCUX_1_NAME,
		    &uart_mcux_init,
...
DEVICE_AND_API_INIT(DT_UART_MCUX_2_PARENT_NAME, uart_2, DT_UART_MCUX_2_NAME,
		    &uart_mcux_init,
...
DEVICE_AND_API_INIT(DT_UART_MCUX_3_PARENT_NAME, uart_3, DT_UART_MCUX_3_NAME,
		    &uart_mcux_init,
...
DEVICE_AND_API_INIT(DT_UART_MCUX_4_PARENT_NAME, uart_4, DT_UART_MCUX_4_NAME,
		    &uart_mcux_init,
...
DEVICE_AND_API_INIT(DT_UART_MCUX_5_PARENT_NAME, uart_5, DT_UART_MCUX_5_NAME,
		    &uart_mcux_init,
