...
DEVICE_DT_INST_DEFINE(0, uart_cmsdk_apb_init, NULL, &uart_cmsdk_apb_dev_data_0,
		      &uart_cmsdk_apb_dev_cfg_0, PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
...
static void uart_cmsdk_apb_irq_config_func_0(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(0), DT_INST_IRQ(0, priority), uart_cmsdk_apb_isr,
...
static void uart_cmsdk_apb_irq_config_func_0(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(0, tx, irq), DT_INST_IRQ_BY_NAME(0, tx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(0), 0);
	irq_enable(DT_INST_IRQ_BY_NAME(0, tx, irq));

	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(0, rx, irq), DT_INST_IRQ_BY_NAME(0, rx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(0), 0);
...
DEVICE_DT_INST_DEFINE(1, uart_cmsdk_apb_init, NULL, &uart_cmsdk_apb_dev_data_1,
		      &uart_cmsdk_apb_dev_cfg_1, PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		      &uart_cmsdk_apb_driver_api);
...
static void uart_cmsdk_apb_irq_config_func_1(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(1), DT_INST_IRQ(1, priority), uart_cmsdk_apb_isr,
...
static void uart_cmsdk_apb_irq_config_func_1(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(1, tx, irq), DT_INST_IRQ_BY_NAME(1, tx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(1), 0);
	irq_enable(DT_INST_IRQ_BY_NAME(1, tx, irq));

	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(1, rx, irq), DT_INST_IRQ_BY_NAME(1, rx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(1), 0);
...
DEVICE_DT_INST_DEFINE(2, uart_cmsdk_apb_init, NULL, &uart_cmsdk_apb_dev_data_2,
		      &uart_cmsdk_apb_dev_cfg_2, PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		      &uart_cmsdk_apb_driver_api);
...
static void uart_cmsdk_apb_irq_config_func_2(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(2), DT_INST_IRQ_BY_NAME(2, priority, irq), uart_cmsdk_apb_isr,
...
static void uart_cmsdk_apb_irq_config_func_2(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(2, tx, irq), DT_INST_IRQ_BY_NAME(2, tx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(2), 0);
	irq_enable(DT_INST_IRQ_BY_NAME(2, tx, irq));

	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(2, rx, irq), DT_INST_IRQ_BY_NAME(2, rx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(2), 0);
...
DEVICE_DT_INST_DEFINE(3, uart_cmsdk_apb_init, NULL, &uart_cmsdk_apb_dev_data_3,
		      &uart_cmsdk_apb_dev_cfg_3, PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		      &uart_cmsdk_apb_driver_api);
...
static void uart_cmsdk_apb_irq_config_func_3(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(3), DT_INST_IRQ(3, priority), uart_cmsdk_apb_isr,
...
static void uart_cmsdk_apb_irq_config_func_3(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(3, tx, irq), DT_INST_IRQ_BY_NAME(3, tx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(3), 0);
	irq_enable(DT_INST_IRQ_BY_NAME(3, tx, irq));

	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(3, rx, irq), DT_INST_IRQ_BY_NAME(3, rx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(3), 0);
...
DEVICE_DT_INST_DEFINE(4, uart_cmsdk_apb_init, NULL, &uart_cmsdk_apb_dev_data_4,
		      &uart_cmsdk_apb_dev_cfg_4, PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		      &uart_cmsdk_apb_driver_api);
...
static void uart_cmsdk_apb_irq_config_func_4(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(4), DT_INST_IRQ_BY_NAME(4, priority, irq), uart_cmsdk_apb_isr,
...
static void uart_cmsdk_apb_irq_config_func_4(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(4, tx, irq), DT_INST_IRQ_BY_NAME(4, tx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(4), 0);
	irq_enable(DT_INST_IRQ_BY_NAME(4, tx, irq));

	IRQ_CONNECT(DT_INST_IRQ_BY_NAME(4, rx, irq), DT_INST_IRQ_BY_NAME(4, rx, priority),
		    uart_cmsdk_apb_isr, DEVICE_DT_INST_GET(4), 0);
