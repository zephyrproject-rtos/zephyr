...
DEVICE_AND_API_INIT(DT_UART_PSOC6_UART_5_PARENT_NAME, uart_5,
		    DT_UART_PSOC6_UART_5_NAME,
...
DEVICE_AND_API_INIT(DT_UART_PSOC6_UART_6_PARENT_NAME, uart_6,
		    DT_UART_PSOC6_UART_6_NAME,
		    uart_psoc6_init, NULL,
