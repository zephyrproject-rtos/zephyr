...
#define CY_PSOC6_UART_IRQ_CFG_FUNC_INIT(n)				\
	.irq_config_func = cy_psoc6_uart##n##_irq_config
#define CY_PSOC6_UART_DECL_CONF(n)					\
	CY_PSOC6_UART_IRQ_FUNC(n)					\
	CY_PSOC6_UART_DECLARE_CFG(n, CY_PSOC6_UART_IRQ_CFG_FUNC_INIT(n))
...
#else
#define CY_PSOC6_UART_IRQ_CFG_FUNC_INIT
#define CY_PSOC6_UART_DECL_CONF(n)					\
	CY_PSOC6_UART_DECLARE_CFG(n, CY_PSOC6_UART_IRQ_CFG_FUNC_INIT)
#define CY_PSOC6_UART_DECL_DATA(n)
...
#define CY_PSOC6_UART_INIT(n)						    \
	...
	static const struct cypress_psoc6_config cy_psoc6_uart##n##_config; \
									    \
	DEVICE_AND_API_INIT(uart_##n##_psoc6, DT_INST_LABEL(n),		    \
			    &uart_psoc6_init, CY_PSOC6_UART_DECL_DATA_PTR(n),\
			    &cy_psoc6_uart##n##_config, PRE_KERNEL_1,	    \
			    CONFIG_KERNEL_INIT_PRIORITY_DEVICE,		    \
			    &uart_psoc6_driver_api);			    \
									    \
	CY_PSOC6_UART_DECL_CONF(n)
