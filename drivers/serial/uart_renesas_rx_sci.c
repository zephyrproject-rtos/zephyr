...
#define _R_SCI_PinSet_SCI(channel) R_SCI_PinSet_SCI##channel
#define R_SCI_PinSet_SCI(channel)  _R_SCI_PinSet_SCI(channel)
...
#define UART_RX_INIT(index)                                                                        \
	...
	static const struct uart_rx_sci_config uart_rx_sci_config_##index = {                      \
		...
		.sci_pinset = R_SCI_PinSet_SCI(DT_PROP(DT_INST_PARENT(index), channel)),           \
	};                                                                                         \
                                                                                                   \
