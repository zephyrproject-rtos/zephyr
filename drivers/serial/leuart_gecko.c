...
DEVICE_AND_API_INIT(DT_SILABS_GECKO_LEUART_0_PARENT_LABEL, leuart_0,
		    DT_SILABS_GECKO_LEUART_0_LABEL,
...
DEVICE_AND_API_INIT(DT_SILABS_GECKO_LEUART_1_PARENT_LABEL, leuart_1,
		    DT_SILABS_GECKO_LEUART_1_LABEL,
