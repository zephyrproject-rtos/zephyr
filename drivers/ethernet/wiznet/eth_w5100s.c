...
#define W5100S_DEFINE(node)                                                                        \
	WIZNET_DEVICE_DEFINE(node, w5100s_init, &w5100s_api_funcs, &w5100s_phy_driver_api,         \
			     &w5100s_ops, &w5100s_regs, CONFIG_ETH_W5100S_RX_THREAD_STACK_SIZE,    \
			     CONFIG_ETH_W5100S_RX_THREAD_PRIO, CONFIG_ETH_W5100S_TIMEOUT,          \
			     CONFIG_ETH_W5100S_POLL_PERIOD, CONFIG_ETH_W5100S_MONITOR_PERIOD, 500, \
			     100)
