...
#define MC_YTPHY_RESET_HOLD_TIME_MS 10
#define MC_YTPHY_RESET_DEASSERT_TIMEOUT_MS 30
...
static int mc_ytphy_reset(const struct device *dev)
{
	...
	if (config->reset_gpio.port) {
		...
		k_busy_wait(USEC_PER_MSEC * MC_YTPHY_RESET_HOLD_TIME_MS);
		...
		k_msleep(MC_YTPHY_RESET_DEASSERT_TIMEOUT_MS);
