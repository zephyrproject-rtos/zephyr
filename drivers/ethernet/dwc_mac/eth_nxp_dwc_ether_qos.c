...
static const clock_control_subsys_t eth0_clocks[] = {
	NXP_ETH_CLOCK_SUBSYS(mac_clk),
	NXP_ETH_CLOCK_SUBSYS(mac_clk_tx),
	NXP_ETH_CLOCK_SUBSYS(mac_clk_rx),
	NXP_ETH_CLOCK_SUBSYS(mac_clk_ptp),
};
