...
#define ETH_MCUX_FIXED_LINK \
	DT_HAS_NODE(ETH_MCUX_FIXED_LINK_NODE)
...
#define ETH_MCUX_FIXED_LINK_HALF_DUPLEX \
	DT_PROP(ETH_MCUX_FIXED_LINK_NODE, half_duplex)
