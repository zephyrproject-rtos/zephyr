...
{
	struct eth_context *eth_ctx = (struct eth_context *)dev->fixed->driver_data;
	int ret = 0;
...
{
	struct eth_context *context = iface->fixed->driver_data;
...
{
	struct ptp_context *ptp_context = dev->fixed->driver_data;
