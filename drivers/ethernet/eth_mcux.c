...
ETH_NET_DEVICE_INIT(DT_ETH_MCUX_0_PARENT_NAME, eth_mcux_0,
		    DT_ETH_MCUX_0_NAME, eth_0_init,
...
DEVICE_AND_API_INIT(DT_ETH_MCUX_0_NAME, mcux_ptp_clock_0,
		    PTP_CLOCK_NAME, ptp_mcux_init,
