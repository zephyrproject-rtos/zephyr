				       ...
				       bool add)
{
	...
	return renesas_ra_eswm_bridge_setif(config->eswm_dev, data->fsp_cfg.channel, br, add);
}
					...
					bool start)
{
	...
	return renesas_ra_eswm_bridge_setfwd(config->eswm_dev, data->fsp_cfg.channel, br, start);
}
