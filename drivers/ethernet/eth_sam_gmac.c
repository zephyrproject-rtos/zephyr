...
ETH_NET_DEVICE_INIT(NULL, eth0_sam_gmac, CONFIG_ETH_SAM_GMAC_NAME,
		    eth_initialize, &eth0_data, &eth0_config,
...
DEVICE_AND_API_INIT(NULL, gmac_ptp_clock_0, PTP_CLOCK_NAME, ptp_gmac_init,
