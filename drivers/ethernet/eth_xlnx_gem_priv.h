 ...
 * [00]       BD used bit
 */
#define ETH_XLNX_GEM_RXBD_WRAP_BIT			BIT(1)
#define ETH_XLNX_GEM_RXBD_USED_BIT			BIT(0)
 ...
 */
#define ETH_XLNX_GEM_RXBD_BCAST_BIT			BIT(31)
#define ETH_XLNX_GEM_RXBD_MCAST_HASH_MATCH_BIT		BIT(30)
#define ETH_XLNX_GEM_RXBD_UCAST_HASH_MATCH_BIT		BIT(29)
#define ETH_XLNX_GEM_RXBD_SPEC_ADDR_MATCH_BIT		BIT(27)
#define ETH_XLNX_GEM_RXBD_SPEC_ADDR_MASK		0x00000003
#define ETH_XLNX_GEM_RXBD_SPEC_ADDR_SHIFT		25
#define ETH_XLNX_GEM_RXBD_BIT24				BIT(24)
#define ETH_XLNX_GEM_RXBD_BITS23_22_MASK		0x00000003
#define ETH_XLNX_GEM_RXBD_BITS23_22_SHIFT		22
#define ETH_XLNX_GEM_RXBD_VLAN_TAG_DETECTED_BIT		BIT(21)
#define ETH_XLNX_GEM_RXBD_PRIO_TAG_DETECTED_BIT		BIT(20)
#define ETH_XLNX_GEM_RXBD_VLAN_PRIORITY_MASK		0x00000007
#define ETH_XLNX_GEM_RXBD_VLAN_PRIORITY_SHIFT		17
#define ETH_XLNX_GEM_RXBD_CFI_BIT			BIT(16)
#define ETH_XLNX_GEM_RXBD_END_OF_FRAME_BIT		BIT(15)
#define ETH_XLNX_GEM_RXBD_START_OF_FRAME_BIT		BIT(14)
#define ETH_XLNX_GEM_RXBD_FCS_STATUS_BIT		BIT(13)
 ...
 */
#define ETH_XLNX_GEM_TXBD_USED_BIT			BIT(31)
#define ETH_XLNX_GEM_TXBD_WRAP_BIT			BIT(30)
#define ETH_XLNX_GEM_TXBD_RETRY_BIT			BIT(29)
#define ETH_XLNX_GEM_TXBD_TX_FRAME_CORRUPT_BIT		BIT(27)
#define ETH_XLNX_GEM_TXBD_LATE_COLLISION_BIT		BIT(26)
#define ETH_XLNX_GEM_TXBD_CKSUM_OFFLOAD_ERROR_MASK	0x00000007
#define ETH_XLNX_GEM_TXBD_CKSUM_OFFLOAD_ERROR_SHIFT	20
#define ETH_XLNX_GEM_TXBD_NO_CRC_BIT			BIT(16)
#define ETH_XLNX_GEM_TXBD_LAST_BIT			BIT(15)
...
#define ETH_XLNX_SLCR_GEMX_CLK_CTRL_CLKACT_BIT		0x00000001
 ...
 * (shared between Zynq-7000 and UltraScale, register identifiers
 * may vary slightly between the Zynq-7000 TRM and the UltraScale+
 ...
 * [17]       Transmit PFC Priority Based Pause Frame
 * [16]       Enable PFC Priority Based Pause Frame
 ...
 */
#define ETH_XLNX_GEM_NWCTRL_FLUSH_NEXT_RX_DPRAM_PKT_BIT	BIT(18)
#define ETH_XLNX_GEM_NWCTRL_PFC_PRIO_PAUSETX_BIT	BIT(17)
#define ETH_XLNX_GEM_NWCTRL_PFC_PRIO_PAUSEEN_BIT	BIT(16)
#define ETH_XLNX_GEM_NWCTRL_RXTSTAMP_BIT		BIT(15)
#define ETH_XLNX_GEM_NWCTRL_ZERO_QNT_PAUSETX_BIT	BIT(12)
#define ETH_XLNX_GEM_NWCTRL_PAUSETX_BIT			BIT(11)
#define ETH_XLNX_GEM_NWCTRL_HALTTX_BIT			BIT(10)
#define ETH_XLNX_GEM_NWCTRL_STARTTX_BIT			BIT(9)
#define ETH_XLNX_GEM_NWCTRL_BACK_PRESSURE_BIT		BIT(8)
#define ETH_XLNX_GEM_NWCTRL_STATWEN_BIT			BIT(7)
#define ETH_XLNX_GEM_NWCTRL_STATINC_BIT			BIT(6)
#define ETH_XLNX_GEM_NWCTRL_STATCLR_BIT			BIT(5)
#define ETH_XLNX_GEM_NWCTRL_MDEN_BIT			BIT(4)
#define ETH_XLNX_GEM_NWCTRL_TXEN_BIT			BIT(3)
#define ETH_XLNX_GEM_NWCTRL_RXEN_BIT			BIT(2)
#define ETH_XLNX_GEM_NWCTRL_LOOPEN_BIT			BIT(1)
 ...
 */
#define ETH_XLNX_GEM_NWCFG_IGNIPGRXERR_BIT		BIT(30)
#define ETH_XLNX_GEM_NWCFG_BADPREAMBEN_BIT		BIT(29)
#define ETH_XLNX_GEM_NWCFG_IPG_STRETCH_BIT		BIT(28)
#define ETH_XLNX_GEM_NWCFG_SGMIIEN_BIT			BIT(27)
#define ETH_XLNX_GEM_NWCFG_FCSIGNORE_BIT		BIT(26)
#define ETH_XLNX_GEM_NWCFG_HDRXEN_BIT			BIT(25)
#define ETH_XLNX_GEM_NWCFG_RXCHKSUMEN_BIT		BIT(24)
#define ETH_XLNX_GEM_NWCFG_PAUSECOPYDI_BIT		BIT(23)
...
#define ETH_XLNX_GEM_NWCFG_FCSREM_BIT			BIT(17)
#define ETH_XLNX_GEM_NWCFG_LENGTHERRDSCRD_BIT		BIT(16)
#define ETH_XLNX_GEM_NWCFG_RXOFFS_MASK			0x00000003
#define ETH_XLNX_GEM_NWCFG_RXOFFS_SHIFT			14
#define ETH_XLNX_GEM_NWCFG_PAUSEEN_BIT			BIT(13)
#define ETH_XLNX_GEM_NWCFG_RETRYTESTEN_BIT		BIT(12)
#define ETH_XLNX_GEM_NWCFG_TBIINSTEAD_BIT		BIT(11)
#define ETH_XLNX_GEM_NWCFG_1000_BIT			BIT(10)
#define ETH_XLNX_GEM_NWCFG_EXTADDRMATCHEN_BIT		BIT(9)
#define ETH_XLNX_GEM_NWCFG_1536RXEN_BIT			BIT(8)
#define ETH_XLNX_GEM_NWCFG_UCASTHASHEN_BIT		BIT(7)
#define ETH_XLNX_GEM_NWCFG_MCASTHASHEN_BIT		BIT(6)
#define ETH_XLNX_GEM_NWCFG_BCASTDIS_BIT			BIT(5)
#define ETH_XLNX_GEM_NWCFG_COPYALLEN_BIT		BIT(4)
#define ETH_XLNX_GEM_NWCFG_NVLANDISC_BIT		BIT(2)
#define ETH_XLNX_GEM_NWCFG_FDEN_BIT			BIT(1)
#define ETH_XLNX_GEM_NWCFG_100_BIT			BIT(0)
 ...
 * [04]       Transmit buffer underrun -> ZynqMP/UltraScale+ ONLY!
 * [03]       Set 'used' bit in TX BD encountered
 * [02]       Set 'used' bit in RX BD encountered
 * [01]       Frame received
 * [00]       PHY management done
 */
#define ETH_XLNX_GEM_IXR_TSU_SECONDS_INCREMENT_BIT	BIT(26)
#define ETH_XLNX_GEM_IXR_PTPPSTX_BIT			BIT(25)
#define ETH_XLNX_GEM_IXR_PTPPDRTX_BIT			BIT(24)
#define ETH_XLNX_GEM_IXR_PTPSTX_BIT			BIT(23)
#define ETH_XLNX_GEM_IXR_PTPDRTX_BIT			BIT(22)
#define ETH_XLNX_GEM_IXR_PTPPSRX_BIT			BIT(21)
#define ETH_XLNX_GEM_IXR_PTPPDRRX_BIT			BIT(20)
#define ETH_XLNX_GEM_IXR_PTPSRX_BIT			BIT(19)
#define ETH_XLNX_GEM_IXR_PTPDRRX_BIT			BIT(18)
#define ETH_XLNX_GEM_IXR_PARTNER_PGRX_BIT		BIT(17)
#define ETH_XLNX_GEM_IXR_AUTONEG_COMPLETE_BIT		BIT(16)
#define ETH_XLNX_GEM_IXR_EXTERNAL_INT_BIT		BIT(15)
#define ETH_XLNX_GEM_IXR_PAUSE_TX_BIT			BIT(14)
#define ETH_XLNX_GEM_IXR_PAUSE_ZERO_BIT			BIT(13)
#define ETH_XLNX_GEM_IXR_PAUSE_NONZERO_BIT		BIT(12)
#define ETH_XLNX_GEM_IXR_HRESP_NOT_OK_BIT		BIT(11)
#define ETH_XLNX_GEM_IXR_RX_OVERRUN_BIT			BIT(10)
#define ETH_XLNX_GEM_IXR_LINK_CHANGE			BIT(9)
#define ETH_XLNX_GEM_IXR_TX_COMPLETE_BIT		BIT(7)
#define ETH_XLNX_GEM_IXR_TX_CORRUPT_BIT			BIT(6)
#define ETH_XLNX_GEM_IXR_RETRY_LIMIT_OR_LATE_COLL_BIT	BIT(5)
#if defined(CONFIG_SOC_XILINX_ZYNQMP)
#define ETH_XLNX_GEM_IXR_TX_UNDERRUN_BIT		BIT(4)
#elif defined(CONFIG_SOC_FAMILY_XILINX_ZYNQ7000)
#define ETH_XLNX_GEM_IXR_TX_UNDERRUN_BIT		0
#endif
#define ETH_XLNX_GEM_IXR_TX_USED_BIT			BIT(3)
#define ETH_XLNX_GEM_IXR_RX_USED_BIT			BIT(2)
#define ETH_XLNX_GEM_IXR_FRAME_RX_BIT			BIT(1)
#define ETH_XLNX_GEM_IXR_PHY_MGMNT_BIT			BIT(0)
#define ETH_XLNX_GEM_IXR_ERRORS_MASK \
	(ETH_XLNX_GEM_IXR_TX_UNDERRUN_BIT | \
	 ETH_XLNX_GEM_IXR_RETRY_LIMIT_OR_LATE_COLL_BIT | \
	 ETH_XLNX_GEM_IXR_TX_CORRUPT_BIT | \
	 ETH_XLNX_GEM_IXR_RX_OVERRUN_BIT | \
	 ETH_XLNX_GEM_IXR_HRESP_NOT_OK_BIT)
#define ETH_XLNX_GEM_IXR_ALL_RELEVANT_MASK \
	(ETH_XLNX_GEM_IXR_FRAME_RX_BIT | \
	 ETH_XLNX_GEM_IXR_TX_COMPLETE_BIT | \
	 ETH_XLNX_GEM_IXR_ERRORS_MASK)
 ...
 */
#define ETH_XLNX_GEM_MDIO_IDLE_BIT			BIT(2)
#define ETH_XLNX_GEM_MDIO_IN_STATUS_BIT			BIT(1)
