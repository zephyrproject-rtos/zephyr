...
#define INTEL_IGC_SRRCTL(n)			(INTEL_IGC_SRRCTL_BASE_ADDR + \
						(INTEL_IGC_SRRCTL_OFFSET * (n)))
#define INTEL_IGC_SRRCTL_BSIZEPKT_MASK		GENMASK(6, 0)

/* Convert as 1024 Bytes resolution */
#define INTEL_IGC_SRRCTL_BSIZEPKT(x)		FIELD_PREP(INTEL_IGC_SRRCTL_BSIZEPKT_MASK, \
							   (x) / 1024)
#define INTEL_IGC_SRRCTL_BSIZEHDR_MASK		GENMASK(13, 8)

/* Covert as 64 Bytes resolution */
#define INTEL_IGC_SRRCTL_BSIZEHDR(x)		FIELD_PREP(INTEL_IGC_SRRCTL_BSIZEHDR_MASK, \
							   (x) / 64)
...
#define INTEL_IGC_RDBAL(n)			(INTEL_IGC_RDBAL_BASE_ADDR + \
						 (INTEL_IGC_RDBAL_OFFSET * (n)))

/* Receive Descriptor Base Address High */
#define INTEL_IGC_RDBAH_BASE_ADDR		0x0C004
#define INTEL_IGC_RDBAH_OFFSET			0x40
#define INTEL_IGC_RDBAH(n)			(INTEL_IGC_RDBAH_BASE_ADDR + \
						 (INTEL_IGC_RDBAH_OFFSET * (n)))

/* Receive Descriptor Ring Length */
#define INTEL_IGC_RDLEN_BASE_ADDR		0x0C008
#define INTEL_IGC_RDLEN_OFFSET			0x40
#define INTEL_IGC_RDLEN(n)			(INTEL_IGC_RDLEN_BASE_ADDR + \
						 (INTEL_IGC_RDLEN_OFFSET * (n)))

/* Receive Descriptor Head */
#define INTEL_IGC_RDH_BASE_ADDR			0x0C010
#define INTEL_IGC_RDH_OFFSET			0x40
#define INTEL_IGC_RDH(n)			(INTEL_IGC_RDH_BASE_ADDR + \
						 (INTEL_IGC_RDH_OFFSET * (n)))

/* Receive Descriptor Tail */
#define INTEL_IGC_RDT_BASE_ADDR			0x0C018
#define INTEL_IGC_RDT_OFFSET			0x40
#define INTEL_IGC_RDT(n)			(INTEL_IGC_RDT_BASE_ADDR + \
						 (INTEL_IGC_RDT_OFFSET * (n)))

/* Receive Descriptor Control */
#define INTEL_IGC_RXDCTL_BASE_ADDR		0x0C028
#define INTEL_IGC_RXDCTL_OFFSET			0x40
#define INTEL_IGC_RXDCTL(n)			(INTEL_IGC_RXDCTL_BASE_ADDR + \
						 (INTEL_IGC_RXDCTL_OFFSET * (n)))
...
#define INTEL_IGC_RQDPC(n)			(INTEL_IGC_RQDPC_BASE_ADDR + \
						 (INTEL_IGC_RQDPC_OFFSET * (n)))
...
#define INTEL_IGC_TQDPC(n)			(INTEL_IGC_TQDPC_BASE + \
						 (INTEL_IGC_TQDPC_OFFSET * (n)))

#define INTEL_IGC_GIO_MASTER_DISABLE_TIMEOUT	800
#define INTEL_IGC_READ_NVM_TIMEOUT		10
#define INTEL_IGC_ALEN				6

#define INTEL_IGC_RAL(i)			(((i) <= 15) ? (0x05400 + ((i) * 8)) : \
						 (0x054E0 + ((i - 16) * 8)))
#define INTEL_IGC_RAH(i)			(((i) <= 15) ? (0x05404 + ((i) * 8)) : \
						 (0x054E4 + ((i - 16) * 8)))
...
struct eth_intel_igc_mac_data {
	...
	uint8_t mac_addr[INTEL_IGC_ALEN];
