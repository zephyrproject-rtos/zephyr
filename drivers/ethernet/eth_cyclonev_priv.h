...
/* Emac Base Addresses */
#define EMAC0_ADDR 0xFF700000
#define EMAC1_ADDR 0xFF702000
...
/* The byte offset of the SYSMGR_EMAC register from the beginning of the component. */
#define SYSMGR_EMAC_OFST	0x60
/* The byte offset of the SYSMGR_FPGAINTF_INDIV register from the beginning of the component. */
...
#define EMAC_DMA_INT_EN_ADDR(base) (uint32_t)((base) + EMAC_DMA_INT_EN_OFST)
	/* Interrupt Enable */
#define EMAC_DMAGRP_AXI_BUS_MODE_ADDR(base) (uint32_t)((base) \
	+ EMAC_DMAGRP_AXI_BUS_MODE_OFST)
	/* AXI Bus Mode */
#define EMAC_DMAGRP_AHB_OR_AXI_STATUS_ADDR(base) (uint32_t)((base)\
	+ EMAC_DMAGRP_AHB_OR_AXI_STATUS_OFST)
	/* AHB or AXI Status */
#define GMACGRP_CONTROL_STATUS_ADDR(base) (uint32_t)((base) \
	+ EMAC_GMACGRP_SGMII_RGMII_SMII_CONTROL_STATUS_OFST) /* SGMII RGMII SMII Control Status */
...
#define EMAC_GMAC_INT_STAT_ADDR(base) (uint32_t)((base) + EMAC_GMAC_INT_STAT_OFST)
	/* Interrupt Status */
#define GMACGRP_MAC_CONFIG_ADDR(base) \
	(uint32_t)((base)+EMAC_GMACGRP_MAC_CONFIGURATION_OFST)
	/* MAC Configuration */
 ...
 * -------------------------------------------------------------------------------------------
 * RDES1 |CTRL(31)|Reserv[30:29]|Buff2ByteCt[28:16]|CTRL[15:14] Reservr(13)|Buff1ByteCt[12:0]|
 * -------------------------------------------------------------------------------------------
...
static const uint32_t Emac_Addr[] = {
	EMAC0_ADDR,
	EMAC1_ADDR
};

static const uint32_t Rstmgr_Permodrst_Emac_Set_Msk[] = {
	RSTMGR_PERMODRST_EMAC0_SET_MSK,
	RSTMGR_PERMODRST_EMAC1_SET_MSK
};

static const uint32_t Sysmgr_Core_Emac_Phy_Intf_Sel_Set_Msk[] = {
	SYSMGR_EMAC0_PHY_INTF_SEL_SET_MSK,
	SYSMGR_EMAC1_PHY_INTF_SEL_SET_MSK
};

static const uint32_t Sysmgr_Fpgaintf_En_3_Emac_Set_Msk[] = {
	SYSMGR_FPGAINTF_MODULE_EMAC_0_SET_MSK,
	SYSMGR_FPGAINTF_MODULE_EMAC_1_SET_MSK
};

static const uint32_t Sysmgr_Emac_Phy_Intf_Sel_E_Rgmii[] = {
	SYSMGR_EMAC0_PHY_INTF_SEL_E_RGMII,
