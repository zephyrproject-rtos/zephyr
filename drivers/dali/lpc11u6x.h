...
struct lpc_syscon { /*!< (@ 0x40048000) SYSCON Structure                                       */
	...
	volatile uint32_t RTCOSCCTRL; /*!< (@ 0x4004801C) Ultra-low power 32 kHz oscillator output control */
	...
	volatile uint32_t FRGCLKDIV;    /*!< (@ 0x400480A0) Clock divider for the common fractional baud rate generator of USART1 to USART4 */
