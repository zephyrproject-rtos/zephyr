...
#if DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(can1), st_stm32_can) && \
    DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(can2), st_stm32_can)
...
#if DT_HAS_NODE_STATUS_OKAY_AND_COMPAT(DT_NODELABEL(can2), st_stm32_can)
