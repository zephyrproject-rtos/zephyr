 ...
 * read_reg/write_reg.
 *
 * Unlike can_sam0.c: that driver writes Atmel MCLK/GCLK registers
 * directly, requires atmel,assigned-clocks, and folds both M_CAN
 * interrupt lines onto one vector.
 */
