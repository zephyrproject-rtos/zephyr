...
#define XCANFD_BUS_SPEED_MIN 1000
#define XCANFD_BUS_SPEED_MAX 8000000
...
#define XCANFD_ICR_CLEAR_ALL       GENMASK(31, 0) /* Write-1-to-clear all interrupt bits */
...
#define XCANFD_TXMSG_FRAME_ADDR(n)   (XCANFD_TXMSG_BASE_OFFSET + XCANFD_CANFD_FRAME_SIZE * (n))
#define XCANFD_RXMSG_FRAME_ADDR(n)   (XCANFD_RXMSG_BASE_OFFSET + XCANFD_CANFD_FRAME_SIZE * (n))
#define XCANFD_RXMSG_2_FRAME_ADDR(n) (XCANFD_RXMSG_2_BASE_OFFSET + XCANFD_CANFD_FRAME_SIZE * (n))
...
/*
 * Nominal (arbitration) phase Bit Timing Register field widths for the CANFD
 * 2.0 IP found on Versal/Versal2/VersalNET (the non-CANFD_v1_0 variant in the
 * Xilinx embeddedsw xcanfd_hw.h). TS1 is 8 bits, TS2 and SJW are 7 bits.
 */
#define XCANFD_BTR_SJW_MASK_CANFD   GENMASK(22, 16) /* Synchronous jump width mask */
#define XCANFD_BTR_TS2_MASK_CANFD   GENMASK(14, 8)  /* Time segment 2 mask */
#define XCANFD_BTR_TS1_MASK_CANFD   GENMASK(7, 0)   /* Time segment 1 mask */
/*
 * Data phase Fast Bit Timing Register field widths for the same IP: TS1 is
 * 5 bits, TS2 and SJW are 4 bits. Shifts are identical to the nominal phase.
 */
#define XCANFD_F_BTR_SJW_MASK_CANFD GENMASK(19, 16) /* Data phase SJW mask */
#define XCANFD_F_BTR_TS2_MASK_CANFD GENMASK(11, 8)  /* Data phase time segment 2 mask */
#define XCANFD_F_BTR_TS1_MASK_CANFD GENMASK(4, 0)   /* Data phase time segment 1 mask */
...
/* SR (Status Register) error state bit masks */
#define XCANFD_SR_ESTAT_MASK  GENMASK(8, 7) /* Error Status bits [8:7] */
#define XCANFD_SR_ERRWRN_MASK BIT(6)        /* Error Warning (counter >= 96) */

/* SR ESTAT field values (bits 8:7) */
#define XCANFD_SR_ESTAT_SHIFT   7
#define XCANFD_SR_ESTAT_ACTIVE  0x1 /* Error Active (01b) */
#define XCANFD_SR_ESTAT_BUSOFF  0x2 /* Bus Off (10b) */
#define XCANFD_SR_ESTAT_PASSIVE 0x3 /* Error Passive (11b) */
...
#define XCANFD_BRPR_TDCO_MASK       GENMASK(13, 8) /* Transmitter Delay Compensation Offset */
#define XCANFD_BRPR_TDCO_SHIFT      8              /* TDCO field shift */
#define XCANFD_TDCO_MAX             63U            /* Maximum TDC offset (6-bit field) */
#define XCANFD_IXR_RXFOFLW_1_MASK   BIT(15)        /* RX FIFO 1 Overflow mask */
...
#define XCANFD_IXR_RXOFLW_MASK      BIT(6)         /* RX FIFO 0 Overflow mask */
...
/* ESR (Error Status Register) bit masks */
#define XCANFD_ESR_F_BERR_MASK  BIT(11) /* Bit Error in CAN FD Data Phase */
#define XCANFD_ESR_F_STER_MASK  BIT(10) /* Stuff Error in CAN FD Data Phase */
#define XCANFD_ESR_F_FMER_MASK  BIT(9)  /* Form Error in CAN FD Data Phase */
#define XCANFD_ESR_F_CRCER_MASK BIT(8)  /* CRC Error in CAN FD Data Phase */
#define XCANFD_ESR_ACKER_MASK   BIT(4)  /* ACK Error */
#define XCANFD_ESR_BERR_MASK    BIT(3)  /* Bit Error */
#define XCANFD_ESR_STER_MASK    BIT(2)  /* Stuff Error */
#define XCANFD_ESR_FMER_MASK    BIT(1)  /* Form Error */
#define XCANFD_ESR_CRCER_MASK   BIT(0)  /* CRC Error */
...
#define XCANFD_MIN_FILTER_INDEX 1U
#define XCANFD_MAX_FILTER_INDEX 32U
...
/*
 * Nominal (arbitration) phase timing limits, derived from the CANFD 2.0 BTR
 * field widths above: TS1 (prop_seg + phase_seg1) is 8 bits, TS2 (phase_seg2)
 * and SJW are 7 bits. The register stores (value - 1), so the maximum segment
 * value is (2^width). prop_seg is folded into phase_seg1 (TS1), so PROP_SEG is
 * fixed at 0. The prescaler is an 8-bit field, so the maximum divider is 256.
 */
...
#define XCANFD_TIMING_SJW_MAX        0x80 /* 7-bit SJW field */
#define XCANFD_TIMING_PROP_SEG_MAX   0x00
#define XCANFD_TIMING_PHASE_SEG1_MAX 0x100 /* 8-bit TS1 field */
#define XCANFD_TIMING_PHASE_SEG2_MAX 0x80  /* 7-bit TS2 field */
#define XCANFD_TIMING_PRESCALER_MAX  0x100 /* 8-bit prescaler field */

/*
 * Data phase timing limits, derived from the F_BTR field widths: TS1 is 5 bits,
 * TS2 and SJW are 4 bits. Prescaler is the same 8-bit field as the nominal phase.
 */
#define XCANFD_TIMING_DATA_SJW_MIN        0x1
#define XCANFD_TIMING_DATA_PROP_SEG_MIN   0x00
#define XCANFD_TIMING_DATA_PHASE_SEG1_MIN 0x02
#define XCANFD_TIMING_DATA_PHASE_SEG2_MIN 0x02
#define XCANFD_TIMING_DATA_PRESCALER_MIN  0x01

#define XCANFD_TIMING_DATA_SJW_MAX        0x10 /* 4-bit SJW field */
#define XCANFD_TIMING_DATA_PROP_SEG_MAX   0x00
#define XCANFD_TIMING_DATA_PHASE_SEG1_MAX 0x20 /* 5-bit TS1 field */
#define XCANFD_TIMING_DATA_PHASE_SEG2_MAX 0x10 /* 4-bit TS2 field */
#define XCANFD_TIMING_DATA_PRESCALER_MAX  0x100

/* Timeout value (in milliseconds) for waiting on hardware state changes. */
#define XCANFD_TIMEOUT_MS 1
