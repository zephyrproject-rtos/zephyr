...
/* Not all i.MX RT11xx SoCs implement a WDOG4 instance */
#if defined(SRC_SRSR_WDOG4_RST_B_M7_MASK)
#define MCUX_RESET_WDOG4_M7_FLAG SRC_SRSR_WDOG4_RST_B_M7_MASK
#else
#define MCUX_RESET_WDOG4_M7_FLAG 0U
#endif
...
#define MCUX_RESET_WATCHDOG_FLAG                                                                   \
	(SRC_SRSR_WDOG_RST_B_M7_MASK | SRC_SRSR_WDOG3_RST_B_M7_MASK | MCUX_RESET_WDOG4_M7_FLAG)
