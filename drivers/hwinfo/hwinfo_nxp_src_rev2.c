...
/* WDOG4 is not present on all RT11xx parts */
#if defined(SRC_SRSR_WDOG4_RST_B_M7_MASK)
#define NXP_RESET_WDOG4_FLAG SRC_SRSR_WDOG4_RST_B_M7_MASK
#else
#define NXP_RESET_WDOG4_FLAG 0U
#endif
#define NXP_RESET_WATCHDOG_FLAG                                                                   \
	(SRC_SRSR_WDOG_RST_B_M7_MASK | SRC_SRSR_WDOG3_RST_B_M7_MASK | NXP_RESET_WDOG4_FLAG)
...
/* WDOG4 is not present on all RT11xx parts */
#if defined(SRC_SRSR_WDOG4_RST_B_M4_MASK)
#define NXP_RESET_WDOG4_FLAG SRC_SRSR_WDOG4_RST_B_M4_MASK
#else
#define NXP_RESET_WDOG4_FLAG 0U
#endif
#define NXP_RESET_WATCHDOG_FLAG                                                                   \
	(SRC_SRSR_WDOG_RST_B_M4_MASK | SRC_SRSR_WDOG3_RST_B_M4_MASK | NXP_RESET_WDOG4_FLAG)
