 ...
 *
 * Neither divides by the counter rate. A target without a 64-bit divide has to
 * call into libgcc for one, from the scheduler on whatever thread arms a
 * timeout and paying a stack frame there.
 */
