...
static inline int z_vrfy_led_blink(const struct device *dev, u32_t led,
...
static inline int z_vrfy_led_on(const struct device *dev, u32_t led)
{
...
static inline int z_vrfy_led_off(const struct device *dev, u32_t led)
{
