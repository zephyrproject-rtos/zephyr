...
#ifndef ETR_MODE_MODE_CIRCULARBUF
...
/* ATB Funnel Control Register common values */
#define ATBFUNNEL_CTRLREG_ENS_ALL  0xFF /* Enable all slave ports (ENS0-ENS7) */
#define ATBFUNNEL_CTRLREG_ENS_NONE 0x00 /* Disable all slave ports */

/* ATB Replicator ID Filter Register common values */
#define ATBREPLICATOR_IDFILTER_FORWARD_ALL 0x00000000 /* Forward all trace IDs */
#define ATBREPLICATOR_IDFILTER_BLOCK_ALL   0xFFFFFFFF /* Block all trace IDs */
