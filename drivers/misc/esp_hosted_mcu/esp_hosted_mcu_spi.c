				       ...
				       uint8_t *rx)
{
	 ...
	 * is word aligned because a controller moving it by DMA may not accept
	 * an unaligned address or length.
	 */
	static uint8_t rx_buf[ESP_HOSTED_MCU_FRAME_SIZE] __aligned(4);
