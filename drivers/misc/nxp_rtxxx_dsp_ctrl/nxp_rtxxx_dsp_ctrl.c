				  ...
				  enum nxp_rtxxx_dsp_ctrl_section_type section)
{
	...
	struct nxp_rtxxx_dsp_ctrl_config *cfg = (struct nxp_rtxxx_dsp_ctrl_config *)dev->config;
...
static struct nxp_rtxxx_dsp_ctrl_api nxp_rtxxx_dsp_ctrl_api = {.load_section =
									 dsp_ctrl_load_section,
