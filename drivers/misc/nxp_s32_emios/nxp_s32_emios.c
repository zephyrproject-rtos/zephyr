...
#define NXP_S32_EMIOS_GENERATE_GLOBAL_CONFIG(n)                                                    \
	BUILD_ASSERT(                                                                              \
		IN_RANGE(DT_INST_PROP(n, clock_divider), MIN_GLOB_PRESCALER, MAX_GLOB_PRESCALER),  \
...
#define NXP_S32_EMIOS_MASTER_BUS_VERIFY(node_id)                                                   \
	BUILD_ASSERT(                                                                              \
		IN_RANGE(DT_PROP(node_id, period), MIN_MASTER_BUS_PERIOD, MAX_MASTER_BUS_PERIOD),  \
...
#define NXP_S32_EMIOS_INIT_DEVICE(n)                                                               \
	...
	DEVICE_DT_INST_DEFINE(n, &nxp_s32_emios_init, NULL, NULL, &nxp_s32_emios_##n##_config,     \
			      POST_KERNEL, CONFIG_NXP_S32_EMIOS_INIT_PRIORITY, NULL);
