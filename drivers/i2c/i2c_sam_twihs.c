...
static void write_msg_start(Twihs *const twihs, struct twihs_msg *msg, uint8_t daddr)
{
	/* Set slave address. */
...
static void read_msg_start(Twihs *const twihs, struct twihs_msg *msg, uint8_t daddr)
{
