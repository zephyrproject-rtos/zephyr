...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(unregister, &dsub_device_name,
		      SHELL_HELP("Unegister an i2c-target from its respective bus",
				 "<device>"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_i2c_cmds,
	SHELL_CMD_ARG(scan, &dsub_device_name,
		      SHELL_HELP("Scan I2C devices", "<device>"),
		      cmd_i2c_scan, 2, 0),
	SHELL_CMD_ARG(recover, &dsub_device_name,
		      SHELL_HELP("Recover I2C bus", "<device>"),
		      cmd_i2c_recover, 2, 0),
	...
	SHELL_CMD_ARG(direct_read, &dsub_device_name,
		      SHELL_HELP("Read byte stream directly from an I2C device without "
