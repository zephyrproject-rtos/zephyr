...
#define DEV_CLK_PINMUX(idx)     DEVICE_DT_GET(DT_PHANDLE_BY_IDX \
	(DT_NODELABEL(pinctrl_i2c_clk##idx), pinctrls, 0))
#define DEV_DATA_PINMUX(idx)    DEVICE_DT_GET(DT_PHANDLE_BY_IDX \
	(DT_NODELABEL(pinctrl_i2c_data##idx), pinctrls, 0))
