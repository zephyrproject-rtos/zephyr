...
BUILD_ASSERT(IS_ENABLED(CONFIG_PCIE), "RTS5912 I2C in DT needs CONFIG_PCIE");
...
#define I2C_RTS5912_STUCK       (1 << 4)
#define I2C_RTS5912_NACK        (1 << 5)

#define I2C_RTS5912_ERR_MASK (I2C_RTS5912_CMD_ERROR | I2C_RTS5912_STUCK | I2C_RTS5912_NACK)
