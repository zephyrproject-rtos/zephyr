...
#define I2C_CPU_INT_IMASK_TIMEOUTA BIT(14)
...
#define TI_MSPM0_CONTROLLER_INTERRUPTS                                                             \
	(I2C_CPU_INT_IMASK_CARBLOST_SET | I2C_CPU_INT_IMASK_CNACK_SET |                            \
	 ...
	 I2C_CPU_INT_IMASK_CTXDONE_SET | I2C_CPU_INT_IMASK_TIMEOUTA_SET |                          \
...
static void i2c_mspm0_start_dispatch(const struct device *dev)
{
	...
	uint32_t addr_mode =
		(d->flags & I2C_MSG_ADDR_10_BITS) ? I2C_TSA_MMODE_MODE10 : I2C_TSA_MMODE_MODE7;
