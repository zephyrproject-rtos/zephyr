...
static struct i2c_gecko_config i2c_gecko_config_0 = {
	.base = (I2C_TypeDef *)CONFIG_I2C_GECKO_0_BASE_ADDRESS,
	.clock = cmuClock_I2C0,
	.i2cInit = I2C_INIT_DEFAULT,
	.pin_sda = PIN_I2C0_SDA,
	.pin_scl = PIN_I2C0_SCL,
	.loc = CONFIG_I2C_GECKO_0_LOCATION,
	.bitrate = CONFIG_I2C_GECKO_0_CLOCK_FREQUENCY,
};

static struct i2c_gecko_data i2c_gecko_data_0;

DEVICE_AND_API_INIT(i2c_gecko_0, CONFIG_I2C_GECKO_0_LABEL, &i2c_gecko_init,
...
static struct i2c_gecko_config i2c_gecko_config_1 = {
	.base = (I2C_TypeDef *)CONFIG_I2C_GECKO_1_BASE_ADDRESS,
	.clock = cmuClock_I2C1,
	.i2cInit = I2C_INIT_DEFAULT,
	.pin_sda = PIN_I2C1_SDA,
	.pin_scl = PIN_I2C1_SCL,
	.loc = CONFIG_I2C_GECKO_1_LOCATION,
	.bitrate = CONFIG_I2C_GECKO_1_CLOCK_FREQUENCY,
};

static struct i2c_gecko_data i2c_gecko_data_1;

DEVICE_AND_API_INIT(i2c_gecko_1, CONFIG_I2C_GECKO_1_LABEL, &i2c_gecko_init,
