...
#define I2C_NRFX_TWIM_DEVICE(idx)					       \
	BUILD_ASSERT_MSG(						       \
		I2C_NRFX_TWIM_FREQUENCY(				       \
			DT_ALIAS_I2C_##idx##_CLOCK_FREQUENCY)		       \
		!= I2C_NRFX_TWIM_INVALID_FREQUENCY,			       \
		"Wrong I2C " #idx " frequency setting in dts");		       \
	static int twim_##idx##_init(struct device *dev)		       \
	{								       \
		IRQ_CONNECT(DT_ALIAS_I2C_##idx##_IRQ_0,			       \
			    DT_ALIAS_I2C_##idx##_IRQ_0_PRIORITY,	       \
	...
	static const struct i2c_nrfx_twim_config twim_##idx##z_config = {      \
		...
		.config = {						       \
			.scl       = DT_ALIAS_I2C_##idx##_SCL_PIN,	       \
			.sda       = DT_ALIAS_I2C_##idx##_SDA_PIN,	       \
			.frequency = I2C_NRFX_TWIM_FREQUENCY(		       \
				DT_ALIAS_I2C_##idx##_CLOCK_FREQUENCY)	       \
		}							       \
	};								       \
	DEVICE_DEFINE(twim_##idx,					       \
		      DT_ALIAS_I2C_##idx##_LABEL,			       \
		      twim_##idx##_init,				       \
