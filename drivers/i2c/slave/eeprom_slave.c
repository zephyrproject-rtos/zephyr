...
static u8_t i2c_eeprom_slave_0_buffer[(DT_EEPROM_SLAVE_0_SIZE * 1024)];

static const struct i2c_eeprom_slave_config i2c_eeprom_slave_0_cfg = {
	.controller_dev_name = DT_EEPROM_SLAVE_0_BUS_NAME,
	.address = DT_EEPROM_SLAVE_0_BASE_ADDRESS,
	.buffer_size = (DT_EEPROM_SLAVE_0_SIZE * 1024),
	.buffer = i2c_eeprom_slave_0_buffer
};

DEVICE_AND_API_INIT(i2c_eeprom_slave_0, DT_EEPROM_SLAVE_0_LABEL,
...
static u8_t i2c_eeprom_slave_1_buffer[(DT_EEPROM_SLAVE_1_SIZE * 1024)];

static const struct i2c_eeprom_slave_config i2c_eeprom_slave_1_cfg = {
	.controller_dev_name = DT_EEPROM_SLAVE_1_BUS_NAME,
	.address = DT_EEPROM_SLAVE_1_BASE_ADDRESS,
	.buffer_size = (DT_EEPROM_SLAVE_1_SIZE * 1024),
	.buffer = i2c_eeprom_slave_1_buffer
};

DEVICE_AND_API_INIT(i2c_eeprom_slave_1, DT_EEPROM_SLAVE_1_LABEL,
		    &i2c_eeprom_slave_init,
