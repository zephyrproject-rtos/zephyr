...
static u8_t i2c_eeprom_slave_0_buffer[(DT_INST_REG_SIZE(0))];
...
static const struct i2c_eeprom_slave_config i2c_eeprom_slave_0_cfg = {
	...
	.buffer_size = DT_INST_REG_SIZE(0),
...
static u8_t i2c_eeprom_slave_1_buffer[(DT_INST_REG_SIZE(1))];
...
static const struct i2c_eeprom_slave_config i2c_eeprom_slave_1_cfg = {
	...
	.buffer_size = DT_INST_REG_SIZE(1),
