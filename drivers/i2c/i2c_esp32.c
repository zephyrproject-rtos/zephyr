...
static void IRAM_ATTR i2c_esp32_isr(const void *arg)
{
...
#define ESP32_I2C_INIT(idx)                                                                        \
	...
	{                                                                                          \
		IRQ_CONNECT(DT_IRQN(I2C(idx)), IRQ_DEFAULT_PRIORITY, i2c_esp32_isr,                \
			    DEVICE_DT_GET(I2C(idx)),                                              \
			    ESP_INTR_FLAG_IRAM);                                                   \
		irq_enable(DT_IRQN(I2C(idx)));                                                     \
	}                                                                                          \
