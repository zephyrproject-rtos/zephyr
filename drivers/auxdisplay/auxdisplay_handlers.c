...
static inline int z_vrfy_auxdisplay_brightness_get(const struct device *dev, uint8_t *brightness)
{
	K_OOPS(K_SYSCALL_OBJ(dev, K_OBJ_DRIVER_AUXDISPLAY));
...
static inline int z_vrfy_auxdisplay_brightness_set(const struct device *dev, uint8_t brightness)
{
	K_OOPS(K_SYSCALL_OBJ(dev, K_OBJ_DRIVER_AUXDISPLAY));
...
static inline int z_vrfy_auxdisplay_backlight_get(const struct device *dev, uint8_t *backlight)
{
	K_OOPS(K_SYSCALL_OBJ(dev, K_OBJ_DRIVER_AUXDISPLAY));
...
static inline int z_vrfy_auxdisplay_backlight_set(const struct device *dev, uint8_t backlight)
{
	K_OOPS(K_SYSCALL_OBJ(dev, K_OBJ_DRIVER_AUXDISPLAY));
