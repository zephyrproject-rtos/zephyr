...
/*  Input voltage VDPM */
#define BQ25713_REG_IV_LOW                0x0A
#define BQ25713_REG_IV_DPM_MASK           GENMASK(13, 6)
#define BQ25713_REG_IV_DPM_STEP_uV        64000
#define BQ25713_REG_IV_DPM_OFFSET_uV      3200000
#define BQ25713_REG_IV_DPM_VOLTAGE_MIN_uV BQ25713_REG_IV_DPM_OFFSET_uV
#define BQ25713_REG_IV_DPM_VOLTAGE_MAX_uV 195200000
...
static inline int bq25713_read16(const struct device *dev, uint8_t reg, uint16_t *value)
{
	...
	const int status = i2c_burst_read_dt(&config->i2c, reg, i2c_data, sizeof(i2c_data));
...
{
	if (!IN_RANGE(voltage_ua, BQ25713_REG_IV_DPM_VOLTAGE_MIN_uV,
		      BQ25713_REG_IV_DPM_VOLTAGE_MAX_uV)) {
	...
	voltage_ua = CLAMP(voltage_ua, BQ25713_REG_IV_DPM_VOLTAGE_MIN_uV,
			   BQ25713_REG_IV_DPM_VOLTAGE_MAX_uV);
	v = (voltage_ua - BQ25713_REG_IV_DPM_OFFSET_uV) / BQ25713_REG_IV_DPM_STEP_uV;
	v = FIELD_PREP(BQ25713_REG_IV_DPM_MASK, v);
	return bq25713_write16(dev, BQ25713_REG_IV_LOW, v);
}
...
static int bq25713_get_vindpm(const struct device *dev, uint32_t *voltage_uv)
{
	...
	ret = bq25713_read16(dev, BQ25713_REG_IV_LOW, &value);
	if (ret < 0) {
		return ret;
	}
	value = FIELD_GET(BQ25713_REG_IV_DPM_MASK, value);

	*voltage_uv = (value * BQ25713_REG_IV_DPM_STEP_uV) + BQ25713_REG_IV_DPM_OFFSET_uV;
...
{
	struct bq25713_data *data = dev->data;
	union charger_propval value;

	int ret;

	value.const_charge_current_ua = data->ichg_ua;
	...
	value.const_charge_voltage_uv = data->vreg_uv;
	...
	return bq25713_set_minimum_system_voltage(dev, data->vsys_min_uv);
}
...
#define BQ25713_INIT(inst)                                                                         \
	...
	static const struct bq25713_config bq25713_config_##inst = {                               \
		.i2c = I2C_DT_SPEC_INST_GET(inst),                                                 \
                                                                                                   ...
                                                                                                   \
	static struct bq25713_data bq25713_data_##inst = {                                         \
		...
		.vsys_min_uv = DT_INST_PROP(inst, system_voltage_min_threshold_microvolt),         \
                                                                                                   ...
                                                                                                   \
	DEVICE_DT_INST_DEFINE(inst, bq25713_init, NULL, &bq25713_data_##inst,                      \
			      &bq25713_config_##inst, POST_KERNEL, CONFIG_CHARGER_INIT_PRIORITY,   \
			      &bq7513_driver_api);
