...
static void imx_usdhc_init_host_props(const struct device *dev)
{
	...
	props->host_caps_extra.bus_4_bit_support = (bool)(caps.flags & kUSDHC_Support4BitFlag);
	props->host_caps_extra.hs200_support = (bool)(cfg->mmc_hs200_1_8v);
	props->host_caps_extra.hs400_support = (bool)(cfg->mmc_hs400_1_8v);
}
