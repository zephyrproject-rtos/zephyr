 ...
 * @retval SDMMC status
 */
SDMMC_StatusTypeDef sdhc_stm32_ll_read_blocks(sdhc_stm32_ll_handle_t *hsd, uint8_t *pData,
...
static uint32_t sdhc_stm32_ll_convert_block_size(sdhc_stm32_ll_handle_t *hsd, uint32_t block_size)
{
	static const struct {
		...
		{1, SDMMC_DATABLOCK_SIZE_1B},         {2, SDMMC_DATABLOCK_SIZE_2B},
		{4, SDMMC_DATABLOCK_SIZE_4B},         {8, SDMMC_DATABLOCK_SIZE_8B},
		{16, SDMMC_DATABLOCK_SIZE_16B},       {32, SDMMC_DATABLOCK_SIZE_32B},
		{64, SDMMC_DATABLOCK_SIZE_64B},       {128, SDMMC_DATABLOCK_SIZE_128B},
		{256, SDMMC_DATABLOCK_SIZE_256B},     {512, SDMMC_DATABLOCK_SIZE_512B},
		{1024, SDMMC_DATABLOCK_SIZE_1024B},   {2048, SDMMC_DATABLOCK_SIZE_2048B},
		{4096, SDMMC_DATABLOCK_SIZE_4096B},   {8192, SDMMC_DATABLOCK_SIZE_8192B},
		{16384, SDMMC_DATABLOCK_SIZE_16384B},
	};

	for (size_t i = 0; i < ARRAY_SIZE(map) / sizeof(map[0]); i++) {
