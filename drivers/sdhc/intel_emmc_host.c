...
static int emmc_get_host_props(const struct device *dev, struct sdhc_host_props *props)
{
	...
	props->host_caps_extra.bus_4_bit_support = true;
	props->host_caps_extra.hs200_support = (bool)config->hs200_mode;
	props->host_caps_extra.hs400_support = (bool)config->hs400_mode;
