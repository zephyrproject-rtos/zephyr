...
static void sdhc_max32_init_props(const struct device *dev)
{
	...
	sdhc_data->props.host_caps_extra.bus_4_bit_support = false;
	...
	sdhc_data->props.host_caps_extra.hs200_support = false;
	sdhc_data->props.host_caps_extra.hs400_support = false;
