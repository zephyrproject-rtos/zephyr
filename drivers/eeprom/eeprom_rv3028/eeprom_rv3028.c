...
BUILD_ASSERT(CONFIG_EEPROM_RV3028_INIT_PRIORITY > CONFIG_RTC_INIT_PRIORITY,
	     "RV3028 EEPROM driver must be initialized after RV3028 RTC driver");
...
#define RV3028_EEPROM_INIT(inst)                                                                   \
	...
	DEVICE_DT_INST_DEFINE(inst, rv3028_eeprom_init, NULL, NULL, &rv3028_eeprom_config_##inst,  \
			      POST_KERNEL, CONFIG_EEPROM_RV3028_INIT_PRIORITY,                     \
			      &rv3028_eeprom_api);

DT_INST_FOREACH_STATUS_OKAY(RV3028_EEPROM_INIT);
