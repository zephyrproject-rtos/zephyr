...
#if !DT_NODE_HAS_PROP(DT_INST(0, atmel_at24), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(1, atmel_at24))
...
#if !DT_NODE_HAS_PROP(DT_INST(1, atmel_at24), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(2, atmel_at24))
...
#if !DT_NODE_HAS_PROP(DT_INST(2, atmel_at24), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(3, atmel_at24))
...
#if !DT_NODE_HAS_PROP(DT_INST(3, atmel_at24), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(1, atmel_at25))
#if !DT_SPI_DEV_HAS_CS(DT_INST(1, atmel_at25))
#define DT_INST_1_ATMEL_AT25_CS_GPIOS_CONTROLLER NULL
#define DT_INST_1_ATMEL_AT25_CS_GPIOS_PIN 0
#endif
#if !DT_NODE_HAS_PROP(DT_INST(1, atmel_at25), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(2, atmel_at25))
#if !DT_SPI_DEV_HAS_CS(DT_INST(2, atmel_at25))
#define DT_INST_2_ATMEL_AT25_CS_GPIOS_CONTROLLER NULL
#define DT_INST_2_ATMEL_AT25_CS_GPIOS_PIN 0
#endif
#if !DT_NODE_HAS_PROP(DT_INST(2, atmel_at25), wp_gpios)
...
#if DT_HAS_NODE(DT_INST(3, atmel_at25))
#if !DT_SPI_DEV_HAS_CS(DT_INST(3, atmel_at25))
#define DT_INST_3_ATMEL_AT25_CS_GPIOS_CONTROLLER NULL
#define DT_INST_3_ATMEL_AT25_CS_GPIOS_PIN 0
#endif
#if !DT_NODE_HAS_PROP(DT_INST(3, atmel_at25), wp_gpios)
