...
#define ESP32_IPM_INIT(idx)                                                                        \
	...
	{                                                                                          \
		IRQ_CONNECT(DT_INST_IRQN_BY_IDX(idx, 0), IRQ_DEFAULT_PRIORITY, esp32_ipm_isr,      \
	...
	{                                                                                          \
		IRQ_CONNECT(DT_INST_IRQN_BY_IDX(idx, 1), IRQ_DEFAULT_PRIORITY, esp32_ipm_isr,      \
			    DEVICE_DT_INST_GET(idx), ESP_INTR_FLAG_IRAM);                          \
		irq_enable(DT_INST_IRQN_BY_IDX(idx, 1));                                           \
	}                                                                                          \
                                                                                                   \
