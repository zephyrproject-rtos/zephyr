...
#define CR95HF_WFE_TAG_DETECTOR_ARRAY                                                              \
	{0,                                                                                        \
	 ...
	 CR95HF_ENTER_CTRL_DETECTION_H,                                                            \
	 CR95HF_ENTER_CTRL_DETECTION_L,                                                            \
	 CR95HF_WU_CTRL_DETECTION_H,                                                               \
	 CR95HF_WU_CTRL_DETECTION_L,                                                               \
	 CR95HF_LEAVE_CTRL_DETECTION_H,                                                            \
	 CR95HF_LEAVE_CTRL_DETECTION_L,                                                            \
	 CR95HF_DEFAULT_WU_PERIOD,                                                                 \
	 CR95HF_DEFAULT_OSC_START,                                                                 \
	 CR95HF_DEFAULT_DAC_START,                                                                 \
	 CR95HF_DEFAULT_DAC_DATA_H,                                                                \
	 CR95HF_DEFAULT_DAC_DATA_L,                                                                \
	 CR95HF_DEFAULT_SWING_COUNT,                                                               \
	 CR95HF_DEFAULT_MAX_SLEEP}

#define CR95HF_CMD_IDNREQUEST                                                                      \
	0x01 /* Requests short information about the CR95HF                                        \
	      * and its revision                                                                   \
	      */
#define CR95HF_CMD_PROTOCOLSELECT                                                                  \
	0x02 /* Selects the RF communication protocol and                                          \
	      * specifies certain protocol-related parameters                                      \
	      */
#define CR95HF_CMD_SENDRECV                                                                        \
	0x04 /* Sends data using the previously selected                                           \
	      * protocol and receives the tag response                                             \
	      */
#define CR95HF_CMD_IDLE                                                                            \
	0x07 /* Switches the CR95HF into a low consumption                                         \
	      * Wait for Event (WFE) mode                                                          \
	      */
#define CR95HF_CMD_RDREG                                                                           \
	0x08 /* Reads Wake-up event register or the Analog                                         \
	      * Register Configuration (ARC_B) register                                            \
	      */
#define CR95HF_CMD_WRREG                                                                           \
	0x09                     /* Writes Analog Register Configuration (ARC_B)                   \
...
#define CR95HF_SELECT_14443_A_ARRAY                                                                \
	{0,                                                                                        \
	 2,                                                                                        \
	 4,                                                                                        \
	 2,                                                                                        \
