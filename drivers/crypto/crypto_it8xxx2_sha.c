...
BUILD_ASSERT(DT_NUM_INST_STATUS_OKAY(DT_DRV_COMPAT) == 1, "unsupported sha instance");
...
static const uint32_t sha256_h0[SHA_SHA256_HASH_LEN_WORDS] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372,
