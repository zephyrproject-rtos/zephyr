...
int siwx91x_ap_enable(const struct device *dev, struct net_if *iface,
		      struct wifi_connect_req_params *params);
int siwx91x_ap_config_params(const struct device *dev, struct net_if *iface,
			     struct wifi_ap_config_params *params);
int siwx91x_ap_sta_disconnect(const struct device *dev, struct net_if *iface,
