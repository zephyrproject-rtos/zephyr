...
void siwx91x_sock_on_join_ipv4(const struct device *dev, struct net_if *iface);
void siwx91x_sock_on_join_ipv6(const struct device *dev, struct net_if *iface);
...
static inline void siwx91x_sock_on_join_ipv4(const struct device *dev, struct net_if *iface)
{
}

static inline void siwx91x_sock_on_join_ipv6(const struct device *dev, struct net_if *iface)
{
}
