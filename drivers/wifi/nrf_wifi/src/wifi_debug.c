				 ...
				 const char *argv[])
{
	...
	unsigned int mem_start_addr = 0;
	unsigned int mem_end_addr = 0;
...
SHELL_CMD_REGISTER(wifi_dbg,
		   &nrf_wifi_dbg_subcmds,
		   "nRF Wi-Fi debug shell commands",
		   NULL);


static int nrf_wifi_dbg_init(void)
{
	return 0;
}


SYS_INIT(nrf_wifi_dbg_init,
	 APPLICATION,
