...
/* Rate the firmware currently transmits to a station at, in kb/s, or 0
 * when it is not known.
 */
int bflb_wifi_phy_rate_kbps(uint8_t sta_idx);
/* 802.11b/g rates in 100 kbps units, indexed by the FW rate index. */
#define BFLB_WIFI_LEGACY_RATE_CNT 12
extern const uint16_t bflb_wifi_legacy_rates_100kbps[BFLB_WIFI_LEGACY_RATE_CNT];
