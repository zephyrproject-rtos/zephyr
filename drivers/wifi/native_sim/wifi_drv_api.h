...
#ifndef ZEPHYR_DRIVERS_WIFI_NATIVE_SIM_WIFI_DRV_API_H_
#define ZEPHYR_DRIVERS_WIFI_NATIVE_SIM_WIFI_DRV_API_H_
...
#endif /* ZEPHYR_DRIVERS_WIFI_NATIVE_SIM_WIFI_DRV_API_H_ */
