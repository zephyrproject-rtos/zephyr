...
static int set_cc(const struct device *dev, u8_t id, u32_t val, u32_t flags)
{
...
static int set_alarm(const struct device *dev, u8_t chan,
...
static void alarm_irq_handle(const struct device *dev, u32_t id)
{
