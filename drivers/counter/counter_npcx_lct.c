...
#elif DT_HAS_COMPAT_STATUS_OKAY(nuvoton_npck_lct_v1)
#define DT_DRV_COMPAT    nuvoton_npck_lct_v1
#endif
...
BUILD_ASSERT(DT_NUM_INST_STATUS_OKAY(nuvoton_npcx_lct_v1) +
	     ...
	     DT_NUM_INST_STATUS_OKAY(nuvoton_npck_lct_v1) <= 1,
...
#endif
#if defined(CONFIG_COUNTER_NPCX_NPCKN_V1)
	int irq;
#endif
};
