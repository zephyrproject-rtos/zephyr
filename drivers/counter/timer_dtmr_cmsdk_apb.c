...
static int dtmr_cmsdk_apb_get_value(const struct device *dev, u32_t *ticks)
{
	const struct dtmr_cmsdk_apb_cfg * const cfg =
						dev->config_info;
	struct dtmr_cmsdk_apb_dev_data *data = dev->driver_data;
...
static u32_t dtmr_cmsdk_apb_get_top_value(const struct device *dev)
{
	struct dtmr_cmsdk_apb_dev_data *data = dev->driver_data;
...
static u32_t dtmr_cmsdk_apb_get_pending_int(const struct device *dev)
{
	const struct dtmr_cmsdk_apb_cfg * const cfg =
						dev->config_info;
