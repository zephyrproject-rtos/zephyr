...
#define CADENCE_MSPI_IMPLEMENTED_DEV_CONFIG_PARAMS                                                 \
	(MSPI_DEVICE_CONFIG_BREAK_TIME | MSPI_DEVICE_CONFIG_MEM_BOUND |                            \
	 MSPI_DEVICE_CONFIG_ENDIAN | MSPI_DEVICE_CONFIG_CE_POL | MSPI_DEVICE_CONFIG_DQS |          \
	 MSPI_DEVICE_CONFIG_DATA_RATE | MSPI_DEVICE_CONFIG_CE_NUM | MSPI_DEVICE_CONFIG_IO_MODE |   \
	 MSPI_DEVICE_CONFIG_CPP | MSPI_DEVICE_CONFIG_FREQUENCY | MSPI_DEVICE_CONFIG_CE_POL)
