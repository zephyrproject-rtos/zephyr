...
/* Supported memory types for XSPI/OSPI */
...
#define MSPI_STM32_IS_VALID_MEMTYPE_APMEM         0

#elif defined(CONFIG_MSPI_STM32_XSPI)

#define MSPI_STM32_HAL_PREFIX HAL_XSPI_MEMTYPE_
/* Supported memory types for XSPI */
#define MSPI_STM32_IS_VALID_MEMTYPE_APMEM_16BITS  1
#define MSPI_STM32_IS_VALID_MEMTYPE_APMEM         1
/* Explicitly unsupported */
#define MSPI_STM32_IS_VALID_MEMTYPE_APMEMORY      0
#define APMEM        APMEM
#endif
