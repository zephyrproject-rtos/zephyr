				 ...
				 const struct adc_channel_cfg *channel_cfg)
{
	...
	adc_init(config->vref, pre_scale, config->sample_freq);
...
static const struct b91_adc_cfg cfg_0 = {
	.vref = DT_STRING_TOKEN(DT_DRV_INST(0), vref),
	.sample_freq = DT_STRING_TOKEN(DT_DRV_INST(0), sample_freq),
	.ref_internal = DT_STRING_TOKEN(DT_DRV_INST(0), vref) == ADC_VREF_1P2V ?
			1200 : 900,
};
...
#endif
	.ref_internal = cfg_0.ref_internal,
};
