...
#define DT_DRV_COMPAT sifli_sf32lb_adc
...
static int adc_sf32lb_init(const struct device *dev)
{
	...
	sys_clear_bit(config->base + ADC_CTRL_REG, GPADC_ADC_CTRL_REG_TIMER_TRIG_EN_Pos);
	sys_clear_bit(config->base + ADC_CTRL_REG, GPADC_ADC_CTRL_REG_DMA_EN_Pos);
	sys_set_bit(config->base + ADC_CTRL_REG, GPADC_ADC_CTRL_REG_FRC_EN_ADC_Pos);
	sys_set_bit(config->base + ADC_CTRL_REG, GPADC_ADC_CTRL_REG_CHNL_SEL_FRC_EN_Pos);
	sys_set_bit(config->base + ADC_CFG_REG1, GPADC_ADC_CFG_REG1_ANAU_GPADC_SE_Pos);
	sys_set_bit(config->base + ADC_CFG_REG1, GPADC_ADC_CFG_REG1_ANAU_GPADC_LDOREF_EN_Pos);
