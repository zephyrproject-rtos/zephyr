...
#include <esf/drivers/adc/ads1220.h>
...
#define IDAC1_ROUTING(n)  (uint8_t)((DT_INST_PROP_OR(n, idac1_routing, 0) << ADS1220_REG3_I1MUX_POS))
#define IDAC2_ROUTING(n)  (uint8_t)((DT_INST_PROP_OR(n, idac2_routing, 0) << ADS1220_REG3_I2MUX_POS))
...
#define ADS1220_INIT(n)                                                                    \
	...
	BUILD_ASSERT(DT_INST_PROP(n, continuous_conversion_mode) == false,                     \
