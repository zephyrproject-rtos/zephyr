...
static const struct adc_driver_api adc_ad4114_api = {
	.channel_setup = adc_ad4114_channel_setup,
	.read = adc_ad4114_read,
};

#define ADC_AD4114_FILL_MAP_INPUT(inst)                                                            \
	{                                                                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 0),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 1),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 2),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 3),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 4),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 5),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 6),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 7),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 8),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 9),                                          \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 10),                                         \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 11),                                         \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 12),                                         \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 13),                                         \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 14),                                         \
		DT_INST_PROP_BY_IDX(inst, map_inputs, 15),                                         \
	}
...
#define ADC_AD4114_DEVICE(inst)                                                                    \
	...
	static const struct adc_ad4114_config adc_ad4114_config_##inst = {                         \
		...
		.map_input = ADC_AD4114_FILL_MAP_INPUT(inst),                                      \
	};                                                                                         \
