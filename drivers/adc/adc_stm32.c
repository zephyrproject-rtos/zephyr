...
#endif /* CONFIG_ADC_STM32_DMA_HARDWARE_TRIGGER */
#endif
...
#if defined(CONFIG_ADC_STM32_DMA_HARDWARE_TRIGGER)
	if (data->counter_dev){
...
#define INIT_DMA_HARDWARE_TRIGGER(index)	\
	.counter_dev = DEVICE_DT_GET(DT_INST_PHANDLE(index, st_dma_trigger_timer)),	\
	.counter_addr = (TIM_TypeDef*)DT_REG_ADDR(DT_INST_PHANDLE(index, st_dma_trigger_timer))	\
