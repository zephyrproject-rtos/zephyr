...
struct adc_stm32_data {
	...
	u8_t resolution;
	u8_t channel_count;
#if defined(CONFIG_SOC_SERIES_STM32F0X) || defined(CONFIG_SOC_SERIES_STM32L0X) || defined(CONFIG_SOC_SERIES_STM32G0X)
	s8_t acq_time_index;
#endif
};
...
#endif
	/*
	 * F3, L4, WB, G4 and G0 ADC modules need some time to be stabilized
	 * before performing any enable or calibration actions.
	 */
#if defined(CONFIG_SOC_SERIES_STM32F3X) || \
	defined(CONFIG_SOC_SERIES_STM32L4X) || \
	defined(CONFIG_SOC_SERIES_STM32WBX) || \
