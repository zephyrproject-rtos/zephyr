						  ...
						  struct iadc_data *data)
{
	...
	const static struct oversampling_table {
		...
		{ 0, _IADC_CFG_OSRHS_HISPD2, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT12, 12}, /* default */
		{ 1, _IADC_CFG_OSRHS_HISPD2, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT12, 12 }, /* default */
		{ 2, _IADC_CFG_OSRHS_HISPD4, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT16, 13 }, /* 4x oversampling*/
		{ 3, _IADC_CFG_OSRHS_HISPD8, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT16, 14 }, /* 8x oversampling*/
		{ 4, _IADC_CFG_OSRHS_HISPD16, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT16, 15 }, /* 16x oversampling*/
		{ 5, _IADC_CFG_OSRHS_HISPD32, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT16, 16 }, /* 32x oversampling*/
		{ 6, _IADC_CFG_OSRHS_HISPD64, _IADC_CFG_DIGAVG_AVG1,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT20, 17 }, /* 64x oversampling*/
		{ 7, _IADC_CFG_OSRHS_HISPD64, _IADC_CFG_DIGAVG_AVG2,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT20, 18 }, /* 128x oversampling*/
		{ 8, _IADC_CFG_OSRHS_HISPD64, _IADC_CFG_DIGAVG_AVG4,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT20, 19 }, /* 256x oversampling*/
		{ 9, _IADC_CFG_OSRHS_HISPD64, _IADC_CFG_DIGAVG_AVG8,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT20, 20 }, /* 512x oversampling*/
		{ 10, _IADC_CFG_OSRHS_HISPD64, _IADC_CFG_DIGAVG_AVG16,
		 _IADC_SCANFIFOCFG_ALIGNMENT_RIGHT20, 21 }, /* 1024x oversampling*/
	};
	...
	if (data->resolution > 12 && IS_ENABLED(IADC_NO_EXTENDED_ALIGN)) {
		LOG_ERR("Unsupported resolution %d", data->resolution);
		return -EINVAL;
	}
