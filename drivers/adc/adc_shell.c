...
static struct adc_hdl {
	...
	DT_FOREACH_STATUS_OKAY(microchip_mcp3426, ADC_HDL_LIST_ENTRY)
	DT_FOREACH_STATUS_OKAY(microchip_mcp3427, ADC_HDL_LIST_ENTRY)
	DT_FOREACH_STATUS_OKAY(microchip_mcp3428, ADC_HDL_LIST_ENTRY)
