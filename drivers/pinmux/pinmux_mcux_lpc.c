...
#ifdef CONFIG_PINMUX_LPC_MCUX_PORT0
...
DEVICE_AND_API_INIT(pinmux_port0, CONFIG_PINMUX_LPC_MCUX_PORT0_NAME,
	&pinmux_mcux_lpc_init, NULL, &pinmux_mcux_lpc_port0_config,
	PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
	&pinmux_mcux_driver_api);
#endif

#ifdef CONFIG_PINMUX_LPC_MCUX_PORT1
...
DEVICE_AND_API_INIT(pinmux_port1, CONFIG_PINMUX_LPC_MCUX_PORT1_NAME,
