...
typedef enum {
	PINMUX_B91_PULLUP_DISABLE       = 0,
	PINMUX_B91_PULLUP_10K           = 3,
} pinmux_b91_pullup_type_e;
...
static inline int pinmux_b91_get_func_offset(uint32_t pin, uint8_t *offset)
{
	...
	case BIT(0): *offset = 0u; break;
	case BIT(1): *offset = 2u; break;
	case BIT(2): *offset = 4u; break;
	case BIT(3): *offset = 6u; break;
