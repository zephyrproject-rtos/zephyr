...
#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_000_036)
...
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_000_036) */

#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_040_076)
...
DEVICE_AND_API_INIT(pinmux_xec_port040_076,
		    ...
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
		    &pinmux_xec_driver_api);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_040_076) */

#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_100_136)
...
DEVICE_AND_API_INIT(pinmux_xec_port100_136,
		    ...
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
		    &pinmux_xec_driver_api);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_100_136) */

#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_140_176)
...
DEVICE_AND_API_INIT(pinmux_xec_port140_176,
		    ...
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
		    &pinmux_xec_driver_api);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_140_176) */

#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_200_236)
...
DEVICE_AND_API_INIT(pinmux_xec_port200_236,
		    ...
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
		    &pinmux_xec_driver_api);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_200_236) */

#if DT_HAS_NODELABEL_STATUS_OKAY(pinmux_240_276)
...
DEVICE_AND_API_INIT(pinmux_xec_port240_276,
		    ...
		    PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
		    &pinmux_xec_driver_api);
#endif /* DT_HAS_NODELABEL_STATUS_OKAY(pinmux_240_276) */
