				      ...
				      k_timeout_t timeout)
{
	...
	return z_impl_lin_response(dev, &msg_copy, timeout);
}
					   ...
					   const struct lin_filter *filter)
{
	...
	return z_impl_lin_set_rx_filter(dev, &filter_copy);
}
