...
DEVICE_AND_API_INIT(DT_FTM_0_PARENT_NAME, mcux_ftm_0,
		    DT_FTM_0_NAME, &mcux_ftm_init,
...
DEVICE_AND_API_INIT(DT_FTM_1_PARENT_NAME, mcux_ftm_1,
		    DT_FTM_1_NAME, &mcux_ftm_init,
...
DEVICE_AND_API_INIT(DT_FTM_2_PARENT_NAME, mcux_ftm_2,
		    DT_FTM_2_NAME, &mcux_ftm_init,
...
DEVICE_AND_API_INIT(DT_FTM_3_PARENT_NAME, mcux_ftm_3,
		    DT_FTM_3_NAME, &mcux_ftm_init,
