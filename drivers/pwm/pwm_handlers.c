...
static inline int z_vrfy_pwm_pin_set_cycles(struct device *dev, uint32_t pwm,
...
static inline int z_vrfy_pwm_get_cycles_per_sec(struct device *dev, uint32_t pwm,
					       uint64_t *cycles)
{
