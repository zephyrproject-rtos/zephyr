...
static int entropy_mcux_rng_get_entropy(const struct device *dev, uint8_t *buffer, uint16_t length)
{
...
DEVICE_DT_INST_DEFINE(0, entropy_mcux_rng_init, NULL, NULL, &entropy_mcux_config, PRE_KERNEL_1,
		      CONFIG_ENTROPY_INIT_PRIORITY, &entropy_mcux_rng_api_funcs);
