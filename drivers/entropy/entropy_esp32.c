...
static int entropy_esp32_get_entropy(const struct device *dev, uint8_t *buf, uint16_t len)
{
	assert(buf != NULL);
...
DEVICE_DT_INST_DEFINE(0, entropy_esp32_init, NULL, NULL, NULL, PRE_KERNEL_1,
