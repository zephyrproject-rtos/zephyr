...
#error "No rat has been selected."
	...
	} else if (IS_ENABLED(CONFIG_MODEM_HL7812) && IS_ENABLED(CONFIG_MODEM_HL78XX_RAT_GSM)) {

		cmd_set_rat = (const char *)SET_RAT_GSM_CMD_LEGACY;

		*rat_request = HL78XX_RAT_GSM;
	} else if (IS_ENABLED(CONFIG_MODEM_HL7812) && IS_ENABLED(CONFIG_MODEM_HL78XX_RAT_NBNTN)) {
