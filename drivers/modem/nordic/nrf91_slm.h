...
struct nrf91_slm_data {
	...
	/* Socket chat script */
	struct modem_chat_match sock_match;
	struct modem_chat_script_chat sock_script_chat;
	struct modem_chat_script sock_script;
	...
	struct sockaddr *sock_recv_addr;
	socklen_t *sock_recv_addrlen;
	struct k_sem sock_sem;
