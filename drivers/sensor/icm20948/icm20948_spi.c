...
static int icm20948_raw_read(struct icm20948_data *data, u8_t reg_addr, u8_t *value, u8_t len){
...
static int icm20948_spi_read_data(struct lis2dw12_data *data, u16_t reg_bank_addr,
				 u8_t *value, u8_t len)
{
...
static int icm20948_spi_write_data(struct lis2dw12_data *data, u16_t reg_bank_addr,
				  u8_t *value, u8_t len)
{
	if(icm20948_change_bank(data,reg_bank_addr)){
		return -EIO;
...
static int icm20948_spi_read_reg(struct lis2dw12_data *data, u16_t reg_bank_addr,
				u8_t *value)
{
	if(icm20948_change_bank(data,reg_bank_addr)){
		return -EIO;
...
static int icm20948_spi_write_reg(struct lis2dw12_data *data, u16_t reg_bank_addr,
				u8_t value)
{
...
static int icm20948_spi_update_reg(struct lis2dw12_data *data, u16_t reg_bank_addr,
