...
int kx022_trigger_init(const struct device *dev)
{
	...
	data->hw_tf->update_reg(data, KX022_REG_INC1, KX022_MAKS_INC1_INT_EN, KX022_INT1_EN);
	} else {
...
void kx022_motion_setup(const struct device *dev, sensor_trigger_handler_t handler)
{
	...
	if(IS_ENABLED(CONFIG_KX022_INT1_PIN)) {
	data->hw_tf->update_reg(data, KX022_REG_INC4, KX022_MAKS_INC4_WUFI1, KX022_INC4_WUFI1);
	} else {
	data->hw_tf->update_reg(data, KX022_REG_INC6, KX022_MAKS_INC6_WUFI2, KX022_MAKS_INC6_WUFI2);
	}
...
void kx022_drdy_setup(const struct device *dev, sensor_trigger_handler_t handler)
{
	...
	if(IS_ENABLED(CONFIG_KX022_INT1_PIN)) {
	data->hw_tf->update_reg(data, KX022_REG_INC4, KX022_MAKS_INC4_DRDYI1, KX022_INC4_DRDYI1);
	} else {
	data->hw_tf->update_reg(data, KX022_REG_INC6, KX022_MAKS_INC6_DRDYI2, KX022_INC6_DRDYI2);
	}
...
void kx022_tilt_setup(const struct device *dev, sensor_trigger_handler_t handler)
{
	...
	if(IS_ENABLED(CONFIG_KX022_INT1_PIN)) {
	data->hw_tf->update_reg(data, KX022_REG_INC4, KX022_MAKS_INC6_TPI2, KX022_INC4_TPI1);
	} else {
	data->hw_tf->update_reg(data, KX022_REG_INC6, KX022_MAKS_INC6_TPI2, KX022_INC6_TPI2);
	}
