...
{
	const struct lis2dw12_device_config *cfg = dev->fixed->config_info;
	struct lis2dw12_data *lis2dw12 = dev->fixed->driver_data;
...
{
	struct lis2dw12_data *data = dev->fixed->driver_data;
