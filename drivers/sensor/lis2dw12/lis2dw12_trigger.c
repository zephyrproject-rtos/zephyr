/*
 * STMicroelectronics LIS2DW12 trigger
 *
...
int lis2dw12_init_interrupt(struct device *dev)
{
	...
	k_thread_spawn(lis2dw12->thread_stack,
		       CONFIG_LIS2DW12_THREAD_STACK_SIZE,
		       (k_thread_entry_t)lis2dw12_thread, POINTER_TO_INT(dev),
	...
	gpio_pin_configure(lis2dw12->gpio, cfg->int_gpio_pin,
	...
	if (lis2dw12->hw_tf->write_reg(lis2dw12, LIS2DW12_CTRL3_ADDR, 0) < 0)
		return -EIO;
