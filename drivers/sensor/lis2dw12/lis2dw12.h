/*
 * STMicroelectronics LIS2DW12 driver header
 *
...
#ifndef __ACCEL_LIS2DW12_H
#define __ACCEL_LIS2DW12_H

#include <gpio.h>
#include <misc/util.h>
#include <sensor.h>

#define SYS_LOG_DOMAIN "LIS2DW1212"
...
struct lis2dw12_data {
	...
	char __stack thread_stack[CONFIG_LIS2DW12_THREAD_STACK_SIZE];
