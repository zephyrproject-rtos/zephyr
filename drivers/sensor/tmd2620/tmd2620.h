...
/* pulse length */
#define TMD2620_PCFG0_PPULSE_LEN_4US    ~(BIT(6) | BIT(7))
...
#define TMD2620_PCFG0_PPULSE        (BIT(0) | BIT(1) | BIT(2) | BIT(3) |\
					 BIT(4) | BIT(5))

#define TMD2620_PCFG1_REG       0x8F
/* proximity gain control */
#define TMD2620_PCFG1_PGAIN_X1      ~(BIT(6) | BIT(7))
...
static void tmd2620_setup_int(const struct tmd2620_config *config,
								bool enable)
{
