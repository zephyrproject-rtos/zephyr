...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM45686_SPI_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM45686_SPI_H_

#include <zephyr/device.h>
#include <zephyr/drivers/spi.h>

/**
@brief perform a single SPI write to a ICM45686 mreg register
 *
 ...
 */
int icm45686_write_mreg(const struct spi_dt_spec *bus, uint16_t reg, uint8_t data);
 ...
 * @return int 0 on success, negative error code otherwise
 */
int icm45686_update_mreg(const struct spi_dt_spec *bus, uint16_t reg, uint8_t mask, uint8_t data);
 ...
 * @return int 0 on success, negative error code otherwise
 */
int icm45686_read_mreg(const struct spi_dt_spec *bus, uint16_t reg, uint8_t *data, size_t len);

/**
@brief perform a single SPI write to a ICM45686 register
 *
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ICM45686_SPI_H_ */
