...
static struct icm42688_io_ops icm42688_spi_ops = {
	.read = icm42688_spi_read,
	.update_register = icm42688_spi_update_register,
	.single_write = icm42688_spi_single_write,
};
#endif

#if DT_ANY_INST_ON_BUS_STATUS_OKAY(i2c)
static struct icm42688_io_ops icm42688_i2c_ops = {
	.read = icm42688_i2c_read,
	.update_register = icm42688_i2c_update_register,
	.single_write = icm42688_i2c_single_write,
};
#endif
...
#define ICM42688_CONFIG_SPI(inst)                                                                 \
	.bus = {.spi = SPI_DT_SPEC_INST_GET(inst, ICM42688_SPI_CFG, 0U)},                             \
	.io_ops = &icm42688_spi_ops,                                                                  \
	.inst_on_bus = ICM42688_BUS_SPI,

#define ICM42688_CONFIG_I2C(inst)                                                                 \
	.bus = {.i2c = I2C_DT_SPEC_INST_GET(inst)},                                                   \
	.io_ops = &icm42688_i2c_ops,                                                                  \
	.inst_on_bus = ICM42688_BUS_I2C,

#define ICM42688_RTIO_DEFINE(inst)                                                                \
	COND_CODE_1(DT_INST_ON_BUS(inst, spi),                                                        \
	(SPI_DT_IODEV_DEFINE(icm42688_rtio_iodev_##inst, DT_DRV_INST(inst), ICM42688_SPI_CFG, 0U)),   \
...
#define ICM42688_INIT(inst)                                                                       \
	...
	static const struct icm42688_dev_cfg icm42688_cfg_##inst = {                                  \
		COND_CODE_1(DT_INST_ON_BUS(inst, spi),                                                    \
		(ICM42688_CONFIG_SPI(inst)),                                                              \
		(ICM42688_CONFIG_I2C(inst)))                                                              \
