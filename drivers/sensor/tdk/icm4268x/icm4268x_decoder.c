...
static int icm42686_read_imu_from_packet(const uint8_t *pkt, bool is_accel, int fs,
...
void icm42686_get_decoder(const struct sensor_decoder_api **decoder)
{
...
void icm42688_get_decoder(const struct sensor_decoder_api **decoder)
{
	*decoder = &SENSOR_DECODER_NAME();
}
