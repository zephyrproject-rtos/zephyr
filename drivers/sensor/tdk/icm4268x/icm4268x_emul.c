...
static void icm42686_emul_handle_write(const struct emul *target, uint8_t regn, uint8_t value)
{
	struct icm4268x_emul_data *data = target->data;
	...
	case REG_DEVICE_CONFIG:
		if (FIELD_GET(BIT_SOFT_RESET, value) == 1) {
			...
			data->reg[REG_WHO_AM_I] = WHO_AM_I_ICM42686;
...
static int icm42686_emul_io_spi(const struct emul *target, const struct spi_config *config,
				...
				const struct spi_buf_set *rx_bufs)
{
	...
	if (is_read) {
		...
		icm42686_emul_handle_write(target, regn, value);
	}
...
static int icm42686_emul_init(const struct emul *target, const struct device *parent)
{
	struct icm4268x_emul_data *data = target->data;
...
static const struct spi_emul_api icm42686_emul_spi_api = {
	.io = icm42686_emul_io_spi,
};
 ...
 */
static void icm42686_emul_get_accel_settings(const struct emul *target, int *fs_g, int *sensitivity,
					     int8_t *shift)
{
	uint8_t reg;
	...
	case ICM42686_BIT_ACCEL_UI_FS_32:
		fs_g_out = 32;
		...
		shift_out = 9;
		break;
	case ICM42686_BIT_ACCEL_UI_FS_16:
		fs_g_out = 16;
		sensitivity_out = 2048;
		shift_out = 8;
		break;
	case ICM42686_BIT_ACCEL_UI_FS_8:
		fs_g_out = 8;
		sensitivity_out = 4096;
		shift_out = 7;
		break;
	case ICM42686_BIT_ACCEL_UI_FS_4:
		fs_g_out = 4;
		sensitivity_out = 8192;
		shift_out = 6;
		break;
	case ICM42686_BIT_ACCEL_UI_FS_2:
		fs_g_out = 2;
					     ...
					     int8_t *shift)
{
	...
	switch ((reg & MASK_ACCEL_UI_FS_SEL) >> 5) {
	case ICM42688_BIT_ACCEL_UI_FS_16:
		fs_g_out = 16;
		sensitivity_out = 2048;
		/* shift is based on `fs_g * 9.8` since the final numbers will be in SI units of
		 * m/s^2, not g's
		...
		shift_out = 8;
		break;
	case ICM42688_BIT_ACCEL_UI_FS_8:
		fs_g_out = 8;
		sensitivity_out = 4096;
		shift_out = 7;
		break;
	case ICM42688_BIT_ACCEL_UI_FS_4:
		fs_g_out = 4;
		sensitivity_out = 8192;
		shift_out = 6;
		break;
	case ICM42688_BIT_ACCEL_UI_FS_2:
		fs_g_out = 2;
		sensitivity_out = 16384;
		shift_out = 5;
		break;
 ...
 */
static void icm42686_emul_get_accel_ranges(const struct emul *target, q31_t *lower, q31_t *upper,
					   q31_t *epsilon, int8_t *shift)
{
	int fs_g;
	int sensitivity;

	icm42686_emul_get_accel_settings(target, &fs_g, &sensitivity, shift);
 ...
 */
static void icm42686_emul_get_gyro_settings(const struct emul *target, int *fs_mdps,
					    int *sensitivity, int8_t *shift)
{
	...
	case ICM42686_BIT_GYRO_UI_FS_4000:
		...
		break;
	case ICM42686_BIT_GYRO_UI_FS_2000:
		fs_mdps_out = 2000000;
		sensitivity_out = 164;
		shift_out = 6; /* +/- 34.90659 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_1000:
		fs_mdps_out = 1000000;
		sensitivity_out = 328;
		shift_out = 5; /* +/- 17.44444 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_500:
		fs_mdps_out = 500000;
		sensitivity_out = 655;
		shift_out = 4; /* +/- 8.72222 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_250:
		fs_mdps_out = 250000;
		sensitivity_out = 1310;
		shift_out = 3; /* +/- 4.36111 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_125:
		fs_mdps_out = 125000;
		sensitivity_out = 2620;
		shift_out = 2; /* +/- 2.18055 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_62_5:
		fs_mdps_out = 62500;
		sensitivity_out = 5243;
		shift_out = 1; /* +/- 1.09027 */
		break;
	case ICM42686_BIT_GYRO_UI_FS_31_25:
		fs_mdps_out = 31250;
					    ...
					    int *sensitivity, int8_t *shift)
{
	...
	switch ((reg & MASK_GYRO_UI_FS_SEL) >> 5) {
	case ICM42688_BIT_GYRO_UI_FS_2000:
		fs_mdps_out = 2000000;
		sensitivity_out = 164;
		shift_out = 6; /* +/- 34.90659 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_1000:
		fs_mdps_out = 1000000;
		sensitivity_out = 328;
		shift_out = 5; /* +/- 17.44444 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_500:
		fs_mdps_out = 500000;
		sensitivity_out = 655;
		shift_out = 4; /* +/- 8.72222 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_250:
		fs_mdps_out = 250000;
		sensitivity_out = 1310;
		shift_out = 3; /* +/- 4.36111 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_125:
		fs_mdps_out = 125000;
		sensitivity_out = 2620;
		shift_out = 2; /* +/- 2.18055 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_62_5:
		fs_mdps_out = 62500;
		sensitivity_out = 5243;
		shift_out = 1; /* +/- 1.09027 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_31_25:
		fs_mdps_out = 31250;
		sensitivity_out = 10486;
		shift_out = 0; /* +/- 0.54513 */
		break;
	case ICM42688_BIT_GYRO_UI_FS_15_625:
		fs_mdps_out = 15625;
 ...
 *        register config
 */
static void icm42686_emul_get_gyro_ranges(const struct emul *target, q31_t *lower, q31_t *upper,
					  q31_t *epsilon, int8_t *shift)
{
	/* millidegrees/second */
	int fs_mdps;
	...
	icm42686_emul_get_gyro_settings(target, &fs_mdps, &sensitivity, shift);
...
static int icm42686_emul_backend_get_sample_range(const struct emul *target,
						  ...
						  q31_t *upper, q31_t *epsilon, int8_t *shift)
{
	...
	case SENSOR_CHAN_ACCEL_Z:
		icm42686_emul_get_accel_ranges(target, lower, upper, epsilon, shift);
		break;
	case SENSOR_CHAN_GYRO_X:
	case SENSOR_CHAN_GYRO_Y:
	case SENSOR_CHAN_GYRO_Z:
		icm42686_emul_get_gyro_ranges(target, lower, upper, epsilon, shift);
		break;
	default:
		return -ENOTSUP;
	}
...
static int icm42686_emul_backend_set_channel(const struct emul *target, struct sensor_chan_spec ch,
					     const q31_t *value, int8_t shift)
{
	...
	case SENSOR_CHAN_ACCEL_Z:
		...
		icm42686_emul_get_accel_settings(target, NULL, &sensitivity, NULL);
	...
	case SENSOR_CHAN_GYRO_Z:
		...
		icm42686_emul_get_gyro_settings(target, NULL, &sensitivity, NULL);
		reg_val =
...
static const struct emul_sensor_driver_api icm42686_emul_sensor_driver_api = {
	.set_channel = icm42686_emul_backend_set_channel,
	.get_sample_range = icm42686_emul_backend_get_sample_range,
};
...
#define ICM4268X_EMUL_DEFINE(n, name, who_am_i, api)						\
	EMUL_DT_INST_DEFINE(n, name##_emul_init, &icm4268x_emul_data_##n,			\
			    &icm4268x_emul_cfg_##n, &api, &name##_emul_sensor_driver_api)

#define ICM4268X_EMUL_SPI(n, name, who_am_i)							\
	static struct icm4268x_emul_data icm4268x_emul_data_##n;				\
	static const struct icm4268x_emul_cfg icm4268x_emul_cfg_##n;				\
	ICM4268X_EMUL_DEFINE(n, name, who_am_i, name##_emul_spi_api)

#define ICM42688_EMUL_SPI(n)									\
	ICM4268X_EMUL_SPI(n, icm42688, WHO_AM_I_ICM42688)

#define ICM42686_EMUL_SPI(n)									\
	ICM4268X_EMUL_SPI(n, icm42686, WHO_AM_I_ICM42686)

#undef DT_DRV_COMPAT
#define DT_DRV_COMPAT invensense_icm42686
DT_INST_FOREACH_STATUS_OKAY(ICM42686_EMUL_SPI)
