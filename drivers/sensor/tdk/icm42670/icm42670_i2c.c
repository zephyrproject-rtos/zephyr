...
static inline int i2c_read_mreg(const union icm42670_bus *bus, uint8_t reg, uint8_t bank,
...
static inline int i2c_write_mreg(const union icm42670_bus *bus, uint16_t reg, uint8_t bank,
				 uint8_t buf)
{
