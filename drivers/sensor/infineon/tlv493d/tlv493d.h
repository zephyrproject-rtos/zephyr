...
#define TLV493D_Z2_PD                BIT(4)
#define TLV493D_Z2_FF                BIT(5)
#define TLV493D_Z2_TEST              BIT(6)
#define TLV493D_MODE1_OPERATING_MODE GENMASK(1, 0)
#define TLV493D_MODE2_PT             BIT(5)
...
struct tlv493d_data {
	...
	int16_t z;
	int16_t t;
	uint8_t rd_regs[TLV493D_RD_REG_MAX];
	uint8_t wr_regs[TLV493D_WR_REG_MAX];
