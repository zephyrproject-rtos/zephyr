...
INA2XX_REG_DEFINE(ina226_config, INA226_REG_CONFIG, 16, 0);
INA2XX_REG_DEFINE(ina226_cal, INA226_REG_CALIB, 16, 0);
INA2XX_REG_DEFINE(ina226_id, INA226_REG_MANUFACTURER_ID, 16, 0);
...
static struct ina2xx_channels ina226_channels = {
	.bus_voltage = &ina226_bus_voltage,
#ifdef CONFIG_INA226_VSHUNT
	.shunt_voltage = &ina226_shunt_voltage,
#else
	.shunt_voltage = NULL,
#endif
