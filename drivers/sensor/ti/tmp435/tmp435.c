...
void tmp435_get_status(const struct tmp435_config *cfg, uint8_t *status)
{
	int ret;

	ret = tmp435_reg_read(cfg, TMP435_STATUS_REG, status, 1);
}
...
#warning "tmp435 driver enabled without any devices"
#endif
