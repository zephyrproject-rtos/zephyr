...
static int16_t tmp114_odr_value(const struct sensor_value *frequency)
{
	...
	switch (freq_micro) {
	case 156000000:
		conv = TMP114_DT_ODR_6_4_MS; /* 6.4 ms */
		break;
	case 32000000:
		conv = TMP114_DT_ODR_31_25_MS; /* 32.25 ms */
		break;
	case 16000000:
		conv = TMP114_DT_ODR_62_5_MS; /* 62.5 ms */
		break;
	case 8000000:
		conv = TMP114_DT_ODR_125_MS; /* 125 ms */
		break;
	case 4000000:
		conv = TMP114_DT_ODR_250_MS; /* 250 ms */
		break;
	case 2000000:
		conv = TMP114_DT_ODR_500_MS; /* 500 ms */
		break;
	case 1000000:
		conv = TMP114_DT_ODR_1000_MS; /* 1 s */
		break;
	case 500000:
		conv = TMP114_DT_ODR_2000_MS; /* 2 s */
		break;
	default:
		return -EINVAL;
	}
