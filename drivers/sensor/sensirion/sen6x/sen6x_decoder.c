...
static int sen6x_get_channel_index(struct sen6x_encoded_data *edata, enum sensor_channel chan)
{
...
{
	struct sen6x_encoded_data *edata = (struct sen6x_encoded_data *)buffer;
	int ret;
