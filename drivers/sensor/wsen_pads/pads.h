...
#ifndef ZEPHYR_DRIVERS_SENSOR_PADS_PADS_H_
#define ZEPHYR_DRIVERS_SENSOR_PADS_PADS_H_
...
struct pads_data {
	...
	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_PADS_THREAD_STACK_SIZE);
...
#endif /* ZEPHYR_DRIVERS_SENSOR_PADS_PADS_H_ */
