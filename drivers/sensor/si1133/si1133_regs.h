...
#define SI1133_X_ORDER_MASK_SHIFT		4
#define SI1133_Y_ORDER_MASK				0x0007
#define SI1133_Y_ORDER_MASK_SHIFT		0

/*******************************************************************************
 *******    Si1133 Register and Parameter Bit Definitions  *********************
 ******************************************************************************/

#define SI1133_REG_RESPONSE0_RUNNING_MASK		0x80
#define SI1133_REG_RESPONSE0_RUNNING_SHIFT		(7)
#define SI1133_REG_RESPONSE0_RUNNING(x) \
		(((x) << SI1133_REG_RESPONSE0_RUNNING_SHIFT) & SI1133_REG_RESPONSE0_RUNNING_MASK)

#define SI1133_REG_RESPONSE0_SUSPEND_MASK		0x40
#define SI1133_REG_RESPONSE0_SUSPEND_SHIFT		(6)
#define SI1133_REG_RESPONSE0_SUSPEND(x) \
		(((x) << SI1133_REG_RESPONSE0_SUSPEND_SHIFT) & SI1133_REG_RESPONSE0_SUSPEND_MASK)

#define SI1133_REG_RESPONSE0_SLEEP_MASK			0x20
#define SI1133_REG_RESPONSE0_SLEEP_SHIFT		(5)
#define SI1133_REG_RESPONSE0_SLEEP(x) \
		(((x) << SI1133_REG_RESPONSE0_SLEEP_SHIFT) & SI1133_REG_RESPONSE0_SLEEP_MASK)

#define SI1133_REG_RESPONSE0_CMD_ERR_MASK		0x10
#define SI1133_REG_RESPONSE0_CMD_ERR_SHIFT		(4)
#define SI1133_REG_RESPONSE0_CMD_ERR(x) \
		(((x) << SI1133_REG_RESPONSE0_CMD_ERR_SHIFT) & SI1133_REG_RESPONSE0_CMD_ERR_MASK)

#define SI1133_REG_RESPONSE0_CMMND_CTR_MASK		0x0F
#define SI1133_REG_RESPONSE0_CMMND_CTR_SHIFT	(0)
#define SI1133_REG_RESPONSE0_CMMND_CTR(x) \
		((x) & SI1133_REG_RESPONSE0_CMMND_CTR_MASK)


enum SI1133_CMD_ERR {

	SI1133_CMD_ERR_NONE = 0,

	SI1133_CMD_ERR_CMD_INVALID = SI1133_REG_RESPONSE0_CMD_ERR_MASK | SI1133_REG_RESPONSE0_CMMND_CTR(0),
	SI1133_CMD_ERR_PARAM_INVALID = SI1133_REG_RESPONSE0_CMD_ERR_MASK | SI1133_REG_RESPONSE0_CMMND_CTR(1),
	SI1133_CMD_ERR_ADC_OVERFLOW = SI1133_REG_RESPONSE0_CMD_ERR_MASK | SI1133_REG_RESPONSE0_CMMND_CTR(2),
	SI1133_CMD_ERR_BUFFER_OVERFLOW = SI1133_REG_RESPONSE0_CMD_ERR_MASK | SI1133_REG_RESPONSE0_CMMND_CTR(3)
};
