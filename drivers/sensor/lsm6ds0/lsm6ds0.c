...
{
	struct lsm6ds0_data *data = dev->fixed->driver_data;
	const struct lsm6ds0_config *config = dev->fixed->config_info;
...
{
	const struct lsm6ds0_config * const config = dev->fixed->config_info;
	struct lsm6ds0_data *data = dev->fixed->driver_data;
