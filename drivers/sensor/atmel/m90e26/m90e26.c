			      ...
			      struct sensor_value *value)
{
	...
	case M90E26_SENSOR_CHANNEL_CURRENT: {
		...
		ret |= m90e26_convert_current_reg((m90e26_data_value_t *)&data->current_values.Irms, &current_value->Irms);
		ret |= m90e26_convert_current_reg((m90e26_data_value_t *)&data->current_values.Irms2, &current_value->Irms2);
		break;
	}
	case M90E26_SENSOR_CHANNEL_FREQUENCY:
	...
	case M90E26_SENSOR_CHANNEL_PHASE_ANGLE: {
		...
		ret |= m90e26_convert_phase_angle_reg(
			(m90e26_data_value_t *)&data->phase_angle_values.Pangle,
	...
	case M90E26_SENSOR_CHANNEL_POWER_FACTOR: {
		...
		ret |= m90e26_convert_power_factor_reg(
			(m90e26_data_value_t *)&data->power_factor_values.PowerF,
...
#define M90E26_DEFAULT_CONFIG_REGISTER_VALUES                                              \
	{                                                                                      \
		.FuncEn = {CONFIG_M90E26_FUNCEN}, .SagTh = {CONFIG_M90E26_SAGTH},                  \
		.SmallPMod = {CONFIG_M90E26_SMALLPMOD}, .PLconstH = {CONFIG_M90E26_PLCONSTH},      \
		.PLconstL = {CONFIG_M90E26_PLCONSTL}, .Lgain = {CONFIG_M90E26_LGAIN},              \
		.Lphi = {CONFIG_M90E26_LPHI}, .Ngain = {CONFIG_M90E26_NGAIN},                      \
		.Nphi = {CONFIG_M90E26_NPHI}, .PStartTh = {CONFIG_M90E26_PSTARTTH},                \
		.PNolTh = {CONFIG_M90E26_PNOLTH}, .QStartTh = {CONFIG_M90E26_QSTARTTH},            \
		.QNolTh = {CONFIG_M90E26_QNOLTH}, .MMode = {CONFIG_M90E26_MMODE},                  \
		.Ugain = {CONFIG_M90E26_UGAIN}, .IgainL = {CONFIG_M90E26_IGAINL},                  \
		.IgainN = {CONFIG_M90E26_IGAINN}, .Uoffset = {CONFIG_M90E26_UOFFSET},              \
		.IoffsetL = {CONFIG_M90E26_IOFFSETL}, .IoffsetN = {CONFIG_M90E26_IOFFSETN},        \
		.PoffsetL = {CONFIG_M90E26_POFFSETL}, .QoffsetL = {CONFIG_M90E26_QOFFSETL},        \
		.PoffsetN = {CONFIG_M90E26_POFFSETN}, .QoffsetN = {CONFIG_M90E26_QOFFSETN},        \
	}
...
static struct m90e26_data m90e26_data_##inst = {                                                        \
		...
		.config_registers = M90E26_DEFAULT_CONFIG_REGISTER_VALUES,                                      \
	                                                                                                    ...
	                                                                                                    \
	static const struct m90e26_config m90e26_config_##inst = {COND_CODE_1(DT_INST_ON_BUS(inst, spi),    \
			    (M90E26_CONFIG_SPI(inst)),			                                                    \
			    (M90E26_CONFIG_UART(inst)))                                                             \
			IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, irq0_gpios), (.irq = GPIO_DT_SPEC_INST_GET(inst, irq0_gpios),)) \
