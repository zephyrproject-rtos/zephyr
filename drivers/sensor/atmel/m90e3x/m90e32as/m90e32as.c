...
static inline int m90e32as_read_register(const struct device *dev, 
                                         const m90e3x_register_t reg, 
...
static inline int m90e32as_write_register(const struct device *dev, 
...
static void m90e32as_reload_config(const struct device *dev)
{
  ...
  m90e32as_write_register(dev, 
                          MeterEn, 
                          &data->m90e32as_config_registers.MeterEn);
  m90e32as_write_register(dev, 
                          ChannelMapI, 
                          &data->m90e32as_config_registers.ChannelMapI);
  m90e32as_write_register(dev, 
                          ChannelMapU, 
                          &data->m90e32as_config_registers.ChannelMapU);
  m90e32as_write_register(dev, 
                          SagPeakDetCfg, 
                          &data->m90e32as_config_registers.SagPeakDetCfg);
  m90e32as_write_register(dev, 
                          OVthCfg, 
                          &data->m90e32as_config_registers.OVthCfg);
  m90e32as_write_register(dev, 
                          ZXConfig, 
                          &data->m90e32as_config_registers.ZXConfig);
  m90e32as_write_register(dev, 
                          SagTh, 
                          &data->m90e32as_config_registers.SagTh);
  m90e32as_write_register(dev, 
                          PhaseLossTh, 
                          &data->m90e32as_config_registers.PhaseLossTh);
  m90e32as_write_register(dev, 
                          InWarnTh, 
                          &data->m90e32as_config_registers.InWarnTh);
  m90e32as_write_register(dev, 
                          OIth, 
                          &data->m90e32as_config_registers.OIth);
  m90e32as_write_register(dev, 
                          FreqLoTh, 
                          &data->m90e32as_config_registers.FreqLoTh);
  m90e32as_write_register(dev, 
                          FreqHiTh, 
                          &data->m90e32as_config_registers.FreqHiTh);
  m90e32as_write_register(dev, 
                          PMPwrCtrl, 
                          &data->m90e32as_config_registers.PMPwrCtrl);
  m90e32as_write_register(dev, 
                          IRQ0MergeCfg, 
                          &data->m90e32as_config_registers.IRQ0MergeCfg);
  
  // Low Power Mode Registers

  m90e32as_write_register(dev, 
                          DetectCtrl, 
                          &data->m90e32as_config_registers.DetectCtrl);
  m90e32as_write_register(dev, 
                          DetectTh1, 
                          &data->m90e32as_config_registers.DetectTh1);
  m90e32as_write_register(dev, 
                          DetectTh2, 
                          &data->m90e32as_config_registers.DetectTh2);
  m90e32as_write_register(dev, 
                          DetectTh3, 
                          &data->m90e32as_config_registers.DetectTh3);
  m90e32as_write_register(dev, 
                          IDCoffsetA, 
                          &data->m90e32as_config_registers.IDCoffsetA);
  m90e32as_write_register(dev, 
                          IDCoffsetB, 
                          &data->m90e32as_config_registers.IDCoffsetB);
  m90e32as_write_register(dev, 
                          IDCoffsetC, 
                          &data->m90e32as_config_registers.IDCoffsetC);
  m90e32as_write_register(dev, 
                          UDCoffsetA, 
                          &data->m90e32as_config_registers.UDCoffsetA);
  m90e32as_write_register(dev, 
                          UDCoffsetB, 
                          &data->m90e32as_config_registers.UDCoffsetB);
  m90e32as_write_register(dev, 
                          UDCoffsetC, 
                          &data->m90e32as_config_registers.UDCoffsetC);
  m90e32as_write_register(dev, 
                          UGainTAB, 
                          &data->m90e32as_config_registers.UGainTAB);
  m90e32as_write_register(dev, 
                          UGainTC, 
                          &data->m90e32as_config_registers.UGainTC);
  m90e32as_write_register(dev, 
                          PhiFreqComp, 
                          &data->m90e32as_config_registers.PhiFreqComp);
  m90e32as_write_register(dev, 
                          LOGIrms0, 
                          &data->m90e32as_config_registers.LOGIrms0);
  m90e32as_write_register(dev, 
                          LOGIrms1, 
                          &data->m90e32as_config_registers.LOGIrms1);
  m90e32as_write_register(dev, 
                          F0, 
                          &data->m90e32as_config_registers.F0);
  m90e32as_write_register(dev, 
                          T0, 
                          &data->m90e32as_config_registers.T0);
  m90e32as_write_register(dev, 
                          PhiAIrms01, 
                          &data->m90e32as_config_registers.PhiAIrms01);
  m90e32as_write_register(dev, 
                          PhiAIrms2, 
                          &data->m90e32as_config_registers.PhiAIrms2);
  m90e32as_write_register(dev, 
                          GainAIrms01, 
                          &data->m90e32as_config_registers.GainAIrms01);
  m90e32as_write_register(dev, 
                          GainAIrms2, 
                          &data->m90e32as_config_registers.GainAIrms2);
  m90e32as_write_register(dev, 
                          PhiBIrms01, 
                          &data->m90e32as_config_registers.PhiBIrms01);
  m90e32as_write_register(dev, 
                          PhiBIrms2, 
                          &data->m90e32as_config_registers.PhiBIrms2);
  m90e32as_write_register(dev, 
                          GainBIrms01, 
                          &data->m90e32as_config_registers.GainBIrms01);
  m90e32as_write_register(dev, 
                          GainBIrms2, 
                          &data->m90e32as_config_registers.GainBIrms2);
  m90e32as_write_register(dev, 
                          PhiCIrms01, 
                          &data->m90e32as_config_registers.PhiCIrms01);
  m90e32as_write_register(dev, 
                          PhiCIrms2, 
                          &data->m90e32as_config_registers.PhiCIrms2);
  m90e32as_write_register(dev, 
                          GainCIrms01, 
                          &data->m90e32as_config_registers.GainCIrms01);
  m90e32as_write_register(dev, 
                          GainCIrms2, 
                          &data->m90e32as_config_registers.GainCIrms2);

  // Configuration Registers

  m90e32as_write_register(dev, 
                          PLconstH, 
                          &data->m90e32as_config_registers.PLconstH);
  m90e32as_write_register(dev, 
                          PLconstL, 
                          &data->m90e32as_config_registers.PLconstL);
  m90e32as_write_register(dev, 
                          MMode0, 
                          &data->m90e32as_config_registers.MMode0);
  m90e32as_write_register(dev, 
                          MMode1, 
                          &data->m90e32as_config_registers.MMode1);
  m90e32as_write_register(dev, 
                          PStartTh, 
                          &data->m90e32as_config_registers.PStartTh);
  m90e32as_write_register(dev, 
                          QStartTh, 
                          &data->m90e32as_config_registers.QStartTh);
  m90e32as_write_register(dev, 
                          SStartTh, 
                          &data->m90e32as_config_registers.SStartTh);
  m90e32as_write_register(dev, 
                          PPhaseTh, 
                          &data->m90e32as_config_registers.PPhaseTh);
  m90e32as_write_register(dev, 
                          QPhaseTh, 
                          &data->m90e32as_config_registers.QPhaseTh);
  m90e32as_write_register(dev, 
                          SPhaseTh, 
                          &data->m90e32as_config_registers.SPhaseTh);
  // Calibration Registers

  m90e32as_write_register(dev, 
                          PoffsetA, 
                          &data->m90e32as_config_registers.PoffsetA);
  m90e32as_write_register(dev, 
                          QoffsetA, 
                          &data->m90e32as_config_registers.QoffsetA);
  m90e32as_write_register(dev, 
                          PoffsetB, 
                          &data->m90e32as_config_registers.PoffsetB);
  m90e32as_write_register(dev, 
                          QoffsetB, 
                          &data->m90e32as_config_registers.QoffsetB);
  m90e32as_write_register(dev, 
                          PoffsetC, 
                          &data->m90e32as_config_registers.PoffsetC);
  m90e32as_write_register(dev, 
                          QoffsetC, 
                          &data->m90e32as_config_registers.QoffsetC);
  m90e32as_write_register(dev, 
                          PQGainA, 
                          &data->m90e32as_config_registers.PQGainA);
  m90e32as_write_register(dev, 
                          PhiA, 
                          &data->m90e32as_config_registers.PhiA);
  m90e32as_write_register(dev, 
                          PQGainB, 
                          &data->m90e32as_config_registers.PQGainB);
  m90e32as_write_register(dev, 
                          PhiB, 
                          &data->m90e32as_config_registers.PhiB);
  m90e32as_write_register(dev, 
                          PQGainC, 
                          &data->m90e32as_config_registers.PQGainC);
  m90e32as_write_register(dev, 
                          PhiC, 
                          &data->m90e32as_config_registers.PhiC);

  // Fundamental/Harmonic Calibration Registers

  m90e32as_write_register(dev, 
                          PoffsetAF, 
                          &data->m90e32as_config_registers.PoffsetAF);
  m90e32as_write_register(dev, 
                          PoffsetBF, 
                          &data->m90e32as_config_registers.PoffsetBF);
  m90e32as_write_register(dev, 
                          PoffsetCF, 
                          &data->m90e32as_config_registers.PoffsetCF);
  m90e32as_write_register(dev, 
                          PGainAF, 
                          &data->m90e32as_config_registers.PGainAF);
  m90e32as_write_register(dev, 
                          PGainBF, 
                          &data->m90e32as_config_registers.PGainBF);
  m90e32as_write_register(dev, 
                          PGainCF, 
                          &data->m90e32as_config_registers.PGainCF);
  // Measurement Calibration Registers

  m90e32as_write_register(dev, 
                          UgainA, 
                          &data->m90e32as_config_registers.UgainA);
  m90e32as_write_register(dev, 
                          IgainA, 
                          &data->m90e32as_config_registers.IgainA);
  m90e32as_write_register(dev, 
                          UoffsetA, 
                          &data->m90e32as_config_registers.UoffsetA);
  m90e32as_write_register(dev, 
                          UgainB, 
                          &data->m90e32as_config_registers.UgainB);
  m90e32as_write_register(dev, 
                          IgainB, 
                          &data->m90e32as_config_registers.IgainB);
  m90e32as_write_register(dev, 
                          UoffsetB, 
                          &data->m90e32as_config_registers.UoffsetB);
  m90e32as_write_register(dev, 
                          UgainC, 
                          &data->m90e32as_config_registers.UgainC);
  m90e32as_write_register(dev, 
                          IgainC, 
                          &data->m90e32as_config_registers.IgainC);
  m90e32as_write_register(dev, 
                          UoffsetC, 
                          &data->m90e32as_config_registers.UoffsetC);
...
static int m90e32as_pm_action(const struct device *dev,
...
static int m90e32as_convert_energy_values_to_sensor_values(const struct device *dev, 
                                                                       ...
                                                                       struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_fundamental_energy_sensor_data *fundamental_energy_sensor_values = (struct m90e3x_fundamental_energy_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->APenergyTF,
                                  m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->APenergyTF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->APenergyAF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->APenergyAF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->APenergyBF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->APenergyBF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->APenergyCF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->APenergyCF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->ANenergyTF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->ANenergyTF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->ANenergyAF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->ANenergyAF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->ANenergyBF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->ANenergyBF));
  ret |= sensor_value_from_float(&fundamental_energy_sensor_values->ANenergyCF,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&fundamental_energy_values->ANenergyCF));

  return ret;
}

static int m90e32as_convert_harmonic_energy_values_to_sensor_values(const struct device *dev, 
                                                                    const struct m90e3x_harmonic_energy_data *harmonic_energy_values,
                                                                    struct sensor_value *sensor_values)
{
  /*
  * Conversion formulas from datasheet:
  ...
  */
  ...
  struct m90e3x_harmonic_energy_sensor_data *harmonic_energy_sensor_values = (struct m90e3x_harmonic_energy_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->APenergyTH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->APenergyTH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->APenergyAH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->APenergyAH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->APenergyBH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->APenergyBH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->APenergyCH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->APenergyCH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->ANenergyTH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->ANenergyTH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->ANenergyAH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->ANenergyAH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->ANenergyBH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->ANenergyBH));
  ret |= sensor_value_from_float(&harmonic_energy_sensor_values->ANenergyCH,
                                 m90e3x_convert_energy_reg((const m90e3x_data_value_t *)&harmonic_energy_values->ANenergyCH));

  return ret;
}

static int m90e32as_convert_power_values_to_sensor_values(const struct device *dev,
                                                          ...
                                                          struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_power_sensor_data *power_sensor_values = (struct m90e3x_power_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&power_sensor_values->PmeanT,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->PmeanA,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->PmeanB,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->PmeanC,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->QmeanT,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->QmeanA,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->QmeanB,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->QmeanC,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->SmeanT,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_values->SmeanT, 
                                                             (const m90e3x_data_value_t *)&power_values->SAmeanTLSB));
  ret |= sensor_value_from_float(&power_sensor_values->SmeanA,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->SmeanB,
  ...
  ret |= sensor_value_from_float(&power_sensor_values->SmeanC,
...
static int m90e32as_convert_fundamental_power_values_to_sensor_values(const struct device *dev,
                                                                      ...
                                                                      struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_fundamental_power_sensor_data *power_fundamental_sensor_values = (struct m90e3x_fundamental_power_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&power_fundamental_sensor_values->PmeanTF,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_fundamental_values->PmeanTF, 
                                                             (const m90e3x_data_value_t *)&power_fundamental_values->PmeanTFLSB));
  ret |= sensor_value_from_float(&power_fundamental_sensor_values->PmeanAF,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_fundamental_values->PmeanAF, 
                                                             (const m90e3x_data_value_t *)&power_fundamental_values->PmeanAFLSB));
  ret |= sensor_value_from_float(&power_fundamental_sensor_values->PmeanBF,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_fundamental_values->PmeanBF, 
                                                             (const m90e3x_data_value_t *)&power_fundamental_values->PmeanBFLSB));
  ret |= sensor_value_from_float(&power_fundamental_sensor_values->PmeanCF,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_fundamental_values->PmeanCF, 
                                                             (const m90e3x_data_value_t *)&power_fundamental_values->PmeanCFLSB));

  return ret;
}

static int m90e32as_convert_harmonic_power_values_to_sensor_values(const struct device *dev,
                                                                   const struct m90e3x_harmonic_power_data *power_harmonic_values,
                                                                   struct sensor_value *sensor_values)
{
  /*
   * Conversion formulas from datasheet:
  ...
  struct m90e3x_harmonic_power_sensor_data *harmonic_power_sensor_values = (struct m90e3x_harmonic_power_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&harmonic_power_sensor_values->PmeanTH,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_harmonic_values->PmeanTH, 
                                                             (const m90e3x_data_value_t *)&power_harmonic_values->PmeanTHLSB));
  ret |= sensor_value_from_float(&harmonic_power_sensor_values->PmeanAH,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_harmonic_values->PmeanAH, 
                                                             (const m90e3x_data_value_t *)&power_harmonic_values->PmeanAHLSB));
  ret |= sensor_value_from_float(&harmonic_power_sensor_values->PmeanBH,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_harmonic_values->PmeanBH, 
                                                             (const m90e3x_data_value_t *)&power_harmonic_values->PmeanBHLSB));
  ret |= sensor_value_from_float(&harmonic_power_sensor_values->PmeanCH,
                                 m90e3x_convert_power32_regs((const m90e3x_data_value_t *)&power_harmonic_values->PmeanCH, 
                                                             (const m90e3x_data_value_t *)&power_harmonic_values->PmeanCHLSB));

  return ret;
}

static int m90e32as_convert_urms_values_to_sensor_values(const struct device *dev,
                                                         ...
                                                         struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_voltage_rms_sensor_data *urms_sensor_values = (struct m90e3x_voltage_rms_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&urms_sensor_values->UrmsA,
                                 m90e3x_convert_voltage32_regs((const m90e3x_data_value_t *)&urms_values->UrmsA, 
                                                               (const m90e3x_data_value_t *)&urms_values->UrmsALSB));
  ret |= sensor_value_from_float(&urms_sensor_values->UrmsB,
                                 m90e3x_convert_voltage32_regs((const m90e3x_data_value_t *)&urms_values->UrmsB, 
                                                               (const m90e3x_data_value_t *)&urms_values->UrmsBLSB));
  ret |= sensor_value_from_float(&urms_sensor_values->UrmsC,
...
static int m90e32as_convert_irms_values_to_sensor_values(const struct device *dev,
                                                         ...
                                                         struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_current_rms_sensor_data *irms_sensor_values = (struct m90e3x_current_rms_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&irms_sensor_values->IrmsN, 
                                 irms_values->IrmsN * 0.001f);
  ret |= sensor_value_from_float(&irms_sensor_values->IrmsA,
                                 m90e3x_convert_current32_regs((const m90e3x_data_value_t *)&irms_values->IrmsA, 
                                                               (const m90e3x_data_value_t *)&irms_values->IrmsALSB));
  ret |= sensor_value_from_float(&irms_sensor_values->IrmsB,
                                 m90e3x_convert_current32_regs((const m90e3x_data_value_t *)&irms_values->IrmsB, 
                                                               (const m90e3x_data_value_t *)&irms_values->IrmsBLSB));
  ret |= sensor_value_from_float(&irms_sensor_values->IrmsC,
...
static int m90e32as_convert_peak_values_to_sensor_values(const struct device *dev,
                                                         ...
                                                         struct sensor_value *sensor_values)
{
  ...
  struct m90e32as_peak_sensor_data *peak_sensor_values = (struct m90e32as_peak_sensor_data *)sensor_values;
  const struct m90e32as_config_registers *m90e32as_config_registers = &((const struct m90e3x_data *)dev->data)->m90e32as_config_registers;

  ret |= sensor_value_from_float(&peak_sensor_values->UpkA,
                                 m90e32as_config_registers->UgainA.uint16 * peak_values->UPeakA / 819200.0f);
  ret |= sensor_value_from_float(&peak_sensor_values->UpkB,
                                 m90e32as_config_registers->UgainB.uint16 * peak_values->UPeakB / 819200.0f);
  ret |= sensor_value_from_float(&peak_sensor_values->UpkC,
                                 m90e32as_config_registers->UgainC.uint16 * peak_values->UPeakC / 819200.0f);
  ret |= sensor_value_from_float(&peak_sensor_values->IpkA,
                                 m90e32as_config_registers->IgainA.uint16 * peak_values->IPeakA / 8192000.0f);
  ret |= sensor_value_from_float(&peak_sensor_values->IpkB,
                                 m90e32as_config_registers->IgainB.uint16 * peak_values->IPeakB / 8192000.0f);
  ret |= sensor_value_from_float(&peak_sensor_values->IpkC,
                                 m90e32as_config_registers->IgainC.uint16 * peak_values->IPeakC / 8192000.0f);
  return ret;
}

static int m90e32as_convert_phase_angle_values_to_sensor_values(const struct device *dev,
                                                                ...
                                                                struct sensor_value *sensor_values)
{
  ...
  struct m90e3x_phase_angle_sensor_data *phase_angle_sensor_values = (struct m90e3x_phase_angle_sensor_data *)sensor_values;

  ret |= sensor_value_from_float(&phase_angle_sensor_values->PAngleA,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->PAngleA));
  ret |= sensor_value_from_float(&phase_angle_sensor_values->PAngleB,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->PAngleB));
  ret |= sensor_value_from_float(&phase_angle_sensor_values->PAngleC,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->PAngleC));
  ret |= sensor_value_from_float(&phase_angle_sensor_values->UAngleA,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->UangleA));
  ret |= sensor_value_from_float(&phase_angle_sensor_values->UAngleB,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->UangleB));
  ret |= sensor_value_from_float(&phase_angle_sensor_values->UAngleC,
                                 m90e32as_convert_phase_angle_reg((const m90e3x_data_value_t *)&phase_angle_values->UangleC));
                                ...
                                struct sensor_value *value)
{
  ...
  case SENSOR_CHAN_ALL:
    ...
    break;
  case M90E3X_SENSOR_CHANNEL_ENERGY:
    ret = m90e32as_convert_energy_values_to_sensor_values(dev, 
                                                          &data->energy_values, 
                                                          value);
    break;
  case M90E3X_SENSOR_CHANNEL_FUNDAMENTAL_ENERGY:
    ret = m90e32as_convert_fundamental_energy_values_to_sensor_values(dev, 
                                                                      &data->fundamental_energy_values, 
                                                                      value);
    break;
  case M90E3X_SENSOR_CHANNEL_HARMONIC_ENERGY:
    ret = m90e32as_convert_harmonic_energy_values_to_sensor_values(dev, 
                                                                  &data->harmonic_energy_values, 
                                                                  value);
    break;
  case M90E3X_SENSOR_CHANNEL_POWER:
    ret = m90e32as_convert_power_values_to_sensor_values(dev, 
                                                         &data->power_values, 
                                                         value);
    break;
  case M90E3X_SENSOR_CHANNEL_FUNDAMENTAL_POWER:
    ret = m90e32as_convert_fundamental_power_values_to_sensor_values(dev, 
                                                                     &data->fundamental_power_values, 
                                                                     value);
    break;
  case M90E3X_SENSOR_CHANNEL_HARMONIC_POWER:
    ret = m90e32as_convert_harmonic_power_values_to_sensor_values(dev, 
                                                                 &data->harmonic_power_values, 
                                                                 value);
    break;
  case M90E3X_SENSOR_CHANNEL_VOLTAGE:
    ret = m90e32as_convert_urms_values_to_sensor_values(dev, 
                                                        &data->voltage_rms_values, 
                                                        value);
    break;
  case M90E3X_SENSOR_CHANNEL_CURRENT:
    ret = m90e32as_convert_irms_values_to_sensor_values(dev, 
                                                        &data->current_rms_values, 
                                                        value);
    break;
  case M90E3X_SENSOR_CHANNEL_PEAK:
    ret = m90e32as_convert_peak_values_to_sensor_values(dev, &data->peak_values, value);
    break;
  case M90E3X_SENSOR_CHANNEL_FREQUENCY:
    ret = sensor_value_from_float(value, data->Freq * 0.01f);
    break;
  case M90E3X_SENSOR_CHANNEL_PHASE_ANGLE:
    ret = m90e32as_convert_phase_angle_values_to_sensor_values(dev, 
                                                               &data->phase_angle_values, 
                                                               value);
    break;
  case M90E3X_SENSOR_CHANNEL_TEMPERATURE:
...
static void m90e32as_gpio_callback_irq0(const struct device *port, 
...
static void m90e32as_gpio_callback_irq1(const struct device *port, 
                                        struct gpio_callback *cb, 
                                        uint32_t pins)
{
...
static void m90e32as_gpio_callback_wrn_out(const struct device *port, 
                                           struct gpio_callback *cb, 
                                           uint32_t pins)
{
...
static void m90e32as_gpio_callback_cf1(const struct device *port, 
                                       struct gpio_callback *cb, 
                                       uint32_t pins)
{
...
static void m90e32as_gpio_callback_cf2(const struct device *port, 
                                       struct gpio_callback *cb, 
                                       uint32_t pins)
{
...
static void m90e32as_gpio_callback_cf3(const struct device *port, 
                                       struct gpio_callback *cb, 
                                       uint32_t pins)
{
...
static void m90e32as_gpio_callback_cf4(const struct device *port,
                                       struct gpio_callback *cb, 
                                       uint32_t pins)
{
...
static int m90e32as_trigger_set(const struct device *dev,
                                ...
                                sensor_trigger_handler_t handler)
{
  ...
  case M90E3X_SENSOR_TRIG_TYPE_IRQ0:
      if (gpio_is_ready_dt(&cfg->irq0)) {
          ...
          gpio_init_callback(&data->irq0_ctx.gpio_cb, 
                              m90e32as_gpio_callback_irq0, 
                              BIT(cfg->irq0.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_IRQ1:
      if (gpio_is_ready_dt(&cfg->irq1)) {
          ...
          gpio_init_callback(&data->irq1_ctx.gpio_cb, 
                              m90e32as_gpio_callback_irq1, 
                              BIT(cfg->irq1.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_WRN_OUT:
      if (gpio_is_ready_dt(&cfg->wrn_out)) {
          ...
          gpio_init_callback(&data->wrn_out_ctx.gpio_cb, 
                              m90e32as_gpio_callback_wrn_out, 
                              BIT(cfg->wrn_out.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_CF1:
      if (gpio_is_ready_dt(&cfg->cf1)) {
          ...
          gpio_init_callback(&data->cf1.gpio_cb, 
                              m90e32as_gpio_callback_cf1, 
                              BIT(cfg->cf1.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_CF2:
      if (gpio_is_ready_dt(&cfg->cf2)) {
          ...
          gpio_init_callback(&data->cf2.gpio_cb, 
                              m90e32as_gpio_callback_cf2, 
                              BIT(cfg->cf2.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_CF3:
      if (gpio_is_ready_dt(&cfg->cf3)) {
          ...
          gpio_init_callback(&data->cf3.gpio_cb, 
                              m90e32as_gpio_callback_cf3, 
                              BIT(cfg->cf3.pin));
  ...
  case M90E3X_SENSOR_TRIG_TYPE_CF4:
      if (gpio_is_ready_dt(&cfg->cf4)) {
          ...
          gpio_init_callback(&data->cf4.gpio_cb, 
                              m90e32as_gpio_callback_cf4, 
                              BIT(cfg->cf4.pin));
...
#define M90E32AS_DEVICE(inst)                                               \
  ...
  static const struct m90e3x_config m90e32as_config_##inst = {              \
      ...
      IF_ENABLED(CONFIG_PM_DEVICE, (.pm_mode_ops = &m90e3x_pm_mode_ops, ))  \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, irq0_gpios),                   \
                (.irq0 = GPIO_DT_SPEC_INST_GET(inst, irq0_gpios), ))        \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, irq1_gpios),                   \
                (.irq1 = GPIO_DT_SPEC_INST_GET(inst, irq1_gpios), ))        \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, wrn_out_gpios),                \
                (.wrn_out = GPIO_DT_SPEC_INST_GET(inst, wrn_out_gpios), ))  \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cf1_gpios),                    \
                (.cf1 = GPIO_DT_SPEC_INST_GET(inst, cf1_gpios), ))          \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cf2_gpios),                    \
                (.cf2 = GPIO_DT_SPEC_INST_GET(inst, cf2_gpios), ))          \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cf3_gpios),                    \
                (.cf3 = GPIO_DT_SPEC_INST_GET(inst, cf3_gpios), ))          \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cf4_gpios),                    \
                (.cf4 = GPIO_DT_SPEC_INST_GET(inst, cf4_gpios), ))          \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, pm0_gpios),                    \
                (.pm0 = GPIO_DT_SPEC_INST_GET(inst, pm0_gpios), ))          \
      IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, pm1_gpios),                    \
                (.pm1 = GPIO_DT_SPEC_INST_GET(inst, pm1_gpios), ))          \
  };                                                                        \
                                                                            \
