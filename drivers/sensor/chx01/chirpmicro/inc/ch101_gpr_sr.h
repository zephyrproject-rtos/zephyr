...
extern const char *ch101_gpr_sr_version;
...
uint8_t ch101_gpr_sr_init(ch_dev_t *dev_ptr, ch_group_t *grp_ptr, uint8_t i2c_addr, uint8_t dev_num,
			  uint8_t i2c_bus_index);

#endif /* CH101_GPR_SR_H_ */
