...
static const struct ism330dhcx_config ism330dhcx_config = {
	...
	.gpio_cs_port	    = DT_INST_SPI_DEV_CS_GPIO_LABEL(0),
	.cs_gpio	    = DT_INST_SPI_DEV_CS_GPIO_PIN(0),
...
#error "BUS MACRO NOT DEFINED IN DTS"
...
#if DT_INST_NODE_HAS_PROP(0, drdy_gpios) && DT_PROP_HAS_IDX(1)
	...
	.int_pin = 2,
#endif /* CONFIG_ISM330DHCX_INT_PIN_* */
#endif /* DT_INST_NODE_HAS_PROP(0, drdy_gpios) && DT_PROP_HAS_IDX(1) */
