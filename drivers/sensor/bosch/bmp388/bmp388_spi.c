...
static int bmp388_reg_read_spi(const union bmp388_bus *bus, uint8_t start, uint8_t *buf, int size)
{
	uint8_t addr;
...
static int bmp388_reg_write_spi(const union bmp388_bus *bus, uint8_t reg, uint8_t val)
{
