...
static K_THREAD_STACK_DEFINE(bmm350_thread_stack,
...
static void bmm350_work_handler(struct k_work *work)
{
	...
	struct bmm350_data *data = CONTAINER_OF(work,
						struct bmm350_data,
						work);
	/*lint +e26 +e10 +e124 +e40 +e413 +e30 +e578 +e514 +e516*/
...
static void bmm350_gpio_callback(const struct device *port,
				 struct gpio_callback *cb,
				 uint32_t pin)
{
	/*lint -e26 -e10 -e124 -e40 -e413 -e30 -e578 -e514 -e516*/
	struct bmm350_data *data = CONTAINER_OF(cb,
						struct bmm350_data,
						gpio_cb);
	/*lint +e26 +e10 +e124 +e40 +e413 +e30 +e578 +e514 +e516*/
	ARG_UNUSED(port);
...
#elif defined(CONFIG_BMM350_TRIGGER_DIRECT)
	bmm350_handle_interrupts(data->dev);
#endif
}

int bmm350_trigger_set(
...
int bmm350_trigger_mode_init(const struct device *dev)
{
	...
	k_thread_create(
		...
		NULL,
		NULL,
		K_PRIO_COOP(CONFIG_BMM350_THREAD_PRIORITY),
		0,
		K_NO_WAIT);
#elif defined(CONFIG_BMM350_TRIGGER_GLOBAL_THREAD)
	...
	defined(CONFIG_BMM350_TRIGGER_DIRECT)
	data->dev = dev;
#endif
