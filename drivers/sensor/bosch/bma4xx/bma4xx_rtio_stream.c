...
static void bma4xx_fifo_count_cb(struct rtio *r, const struct rtio_sqe *sqe, void *arg)
{
	...
	const uint8_t reg_addr =
		BMA4XX_REG_I2C_READ_BIT | FIELD_GET(BMA4XX_REG_ADDRESS_MASK, BMA4XX_REG_FIFO_DATA);
...
static void bma4xx_int_status_cb(struct rtio *r, const struct rtio_sqe *sqr, void *arg)
{
	...
	uint8_t reg = BMA4XX_REG_I2C_READ_BIT |
		      FIELD_GET(BMA4XX_REG_ADDRESS_MASK, BMA4XX_REG_FIFO_LENGTH_0);
...
void bma4xx_fifo_event(const struct device *dev)
{
	...
	uint8_t reg =
		BMA4XX_REG_I2C_READ_BIT | FIELD_GET(BMA4XX_REG_ADDRESS_MASK, BMA4XX_REG_INT_STAT_1);
