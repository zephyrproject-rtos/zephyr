				  ...
				  uint16_t max_count, void *data_out)
{
	...
	case SENSOR_CHAN_ACCEL_XYZ: {
		...
		bma4xx_convert_raw_accel_to_q31(edata->accel_xyz.x, &out->readings[0].x);
		bma4xx_convert_raw_accel_to_q31(edata->accel_xyz.y, &out->readings[0].y);
		bma4xx_convert_raw_accel_to_q31(edata->accel_xyz.z, &out->readings[0].z);
