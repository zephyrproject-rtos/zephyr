...
{
	struct ms5837_data *data = dev->fixed->driver_data;
	const struct ms5837_config *cfg = dev->fixed->config_info;
	int err;
...
static int ms5837_read_prom(struct device *i2c_master, const uint8_t i2c_address,
