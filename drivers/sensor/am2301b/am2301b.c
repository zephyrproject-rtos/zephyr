...
#define AM2301B_MASK_MEASUREMENT_BUSY          BIT(7)
...
static int am2301b_fetch_measurement_data(const struct am2301b_config *cfg,
				...
				enum sensor_channel chan)
{
	...
	case SENSOR_CHAN_HUMIDITY:
		return am2301b_fetch_measurement_data(cfg, data);
	default:
		return -ENOTSUP;
	}
}
...
{
	const static int32_t power20_of_2 = BIT(20);
...
#define AM2301B_INST(inst)						             \
	...
	SENSOR_DEVICE_DT_INST_DEFINE(inst, am2301b_init, NULL, &am2301b_data_##inst, \
