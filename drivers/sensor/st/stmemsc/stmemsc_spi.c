 ...
 * SPI read
 */
int stmemsc_spi_read(const struct spi_dt_spec *stmemsc, uint8_t reg_addr, uint8_t *value,
		     uint8_t len)
{
 ...
 * SPI write
 */
int stmemsc_spi_write(const struct spi_dt_spec *stmemsc, uint8_t reg_addr, uint8_t *value,
		      uint8_t len)
{
...
int stmemsc_spi_read_incr(const struct spi_dt_spec *stmemsc, uint8_t reg_addr, uint8_t *value,
			  uint8_t len)
{
...
int stmemsc_spi_write_incr(const struct spi_dt_spec *stmemsc, uint8_t reg_addr, uint8_t *value,
			   uint8_t len)
{
	reg_addr |= STMEMSC_SPI_ADDR_AUTO_INCR;
