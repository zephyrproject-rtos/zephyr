...
#define LIS2DH_EN_IA2_INT1		BIT(5)
#define LIS2DH_EN_DRDY1_INT1		BIT(4)
#define LIS2DH_EN_321DA_INT1		BIT(3)
#define LIS2DH_EN_FIFO_WTM_INT1		BIT(2)
#define LIS2DH_EN_FIFO_OVRN_INT1	BIT(1)
#define LIS2DH_FIFO_INT1_MASK \
	(LIS2DH_EN_FIFO_WTM_INT1 | LIS2DH_EN_FIFO_OVRN_INT1)
#define LIS2DH_FIFO_CONFLICT_INT1_MASK                                                     \
	(LIS2DH_EN_CLICK_INT1 | LIS2DH_EN_IA_INT1 | LIS2DH_EN_IA2_INT1 |                  \
	 LIS2DH_EN_DRDY1_INT1 | LIS2DH_EN_321DA_INT1)
