...
static int lsm6dsl_i2c_read_data(const struct device *dev, uint8_t reg_addr, uint8_t *value,
				 uint8_t len)
{
...
static int lsm6dsl_i2c_write_data(const struct device *dev, uint8_t reg_addr, uint8_t *value,
				  uint8_t len)
{
	const struct lsm6dsl_config *cfg = dev->config;
...
static int lsm6dsl_i2c_read_reg(const struct device *dev, uint8_t reg_addr, uint8_t *value)
{
	const struct lsm6dsl_config *cfg = dev->config;
...
static int lsm6dsl_i2c_update_reg(const struct device *dev, uint8_t reg_addr, uint8_t mask,
				  uint8_t value)
{
	const struct lsm6dsl_config *cfg = dev->config;
