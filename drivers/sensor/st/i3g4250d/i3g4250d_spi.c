...
static int i3g4250d_spi_read(const struct device *dev, uint8_t reg, uint8_t *data, uint16_t len)
{
	int ret;
...
static int i3g4250d_spi_write(const struct device *dev, uint8_t reg, uint8_t *data, uint16_t len)
{
	int ret;
	const struct i3g4250d_device_config *config = dev->config;
