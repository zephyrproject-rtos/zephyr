...
static_assert(sizeof(struct tofsense_can_data_frame) == CAN_DATA_FRAME_LENGTH,
...
static_assert(sizeof(struct tofsense_can_query_data_frame) == CAN_QUERY_FRAME_LENGTH,
