...
#ifndef ZEPHYR_DRIVERS_SENSOR_HIDS_HIDS_H_
#define ZEPHYR_DRIVERS_SENSOR_HIDS_HIDS_H_
...
struct hids_data {
	...
	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_HIDS_THREAD_STACK_SIZE);
	struct k_thread thread;
	struct k_sem drdy_sem;
#elif defined(CONFIG_HIDS_TRIGGER_GLOBAL_THREAD)
	struct k_work work;
#endif
#endif /* CONFIG_HIDS_TRIGGER */
};
...
#endif /* ZEPHYR_DRIVERS_SENSOR_HIDS_HIDS_H_ */
