				...
				enum sensor_channel chan)
{
	...
	if (i2c_burst_read(data->i2c_master, config->i2c_slave_addr,
			   LPS22HB_REG_PRESS_OUT_XL, (u8_t *)out, 5) < 0) {
					 ...
					 s32_t raw_val)
{
	/* val = raw_val / 4096 */
	val->val1 = raw_val >> 12;
	val->val2 = ((s32_t)(raw_val & 0x0FFF) * 100L) >> 12;
}
...
static int lps22hb_init(struct device *dev)
{
	...
	dev->driver_api = &lps22hb_api_funcs;
...
DEVICE_INIT(lps22hb, CONFIG_LPS22HB_DEV_NAME, lps22hb_init,
