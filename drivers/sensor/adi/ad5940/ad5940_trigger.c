...
#if defined(CONFIG_AD5940_TRIGGER_OWN_THREAD) || defined(CONFIG_AD5940_TRIGGER_GLOBAL_THREAD)
...
#endif /* CONFIG_AD5940_TRIGGER_OWN_THREAD || CONFIG_AD5940_TRIGGER_GLOBAL_THREAD */
