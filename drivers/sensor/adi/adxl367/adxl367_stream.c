...
static void adxl367_fifo_read_cb(struct rtio *rtio_ctx, const struct rtio_sqe *sqe, int result, void *arg)
{
	const struct device *dev = (const struct device *)arg;
...
static void adxl367_process_fifo_samples_cb(struct rtio *r, const struct rtio_sqe *sqe, int result, void *arg)
{
	const struct device *dev = (const struct device *)arg;
	struct adxl367_data *data = (struct adxl367_data *)dev->data;
	const struct adxl367_dev_config *cfg = (const struct adxl367_dev_config *)dev->config;
...
static void adxl367_process_status_cb(struct rtio *r, const struct rtio_sqe *sqe, int result, void *arg)
{
	const struct device *dev = (const struct device *)arg;
	struct adxl367_data *data = (struct adxl367_data *) dev->data;
	const struct adxl367_dev_config *cfg = (const struct adxl367_dev_config *) dev->config;
