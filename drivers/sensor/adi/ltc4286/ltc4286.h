...
/* MFR Common (MFR_COMMON) */
#define LTC4286_COMMON_ALERT_LATCH BIT(7)
#define LTC4286_COMMON_PMB_BUSY    BIT(6)

/* MFR FLT pin config (MFR_FLT_CONFIG) */
#define LTC4286_FLT_CFG_OP_TO_FAULT BIT(1)
#define LTC4286_FLT_CFG_OT_TO_FAULT BIT(0)

/* MFR Reboot Control (MFR_REBOOT_CONTROL) */
#define LTC4286_REBOOT_CONTROL_INIT   GENMASK(5, 4)
#define LTC4286_REBOOT_CONTROL_REBOOT BIT(3)
#define LTC4286_REBOOT_CONTROL_DELAY  GENMASK(2, 0)
...
/* System Status 1 Statuses (MFR_SYSTEM_STATUS1) */
#define LTC4286_STATUS_MFR_SYS_STAT1_ALERT   BIT(15)
#define LTC4286_STATUS_MFR_SYS_STAT1_L_ALERT BIT(14)
#define LTC4286_STATUS_MFR_SYS_POWER_LOSS    BIT(11)
#define LTC4286_STATUS_MFR_SYS_RESET_DONE    BIT(10)
#define LTC4286_STATUS_MFR_SYS_AVG_DONE      BIT(7)
#define LTC4286_STATUS_MFR_SYS_ADC_CONV      BIT(6)
#define LTC4286_STATUS_MFR_SYS_STAT2_SET     BIT(0)

/* System Status 2 Statuses (MFR_SYSTEM_STATUS2) */
#define LTC4286_STATUS_MFR_SYS_POWER_FAILED_WARN BIT(15)
#define LTC4286_STATUS_MFR_SYS_FET_SHORT_WARN    BIT(14)
#define LTC4286_STATUS_MFR_SYS_VDS_UV_WARN       BIT(3)
#define LTC4286_STATUS_MFR_SYS_VDS_OV_WARN       BIT(2)
#define LTC4286_STATUS_MFR_SYS_IOUT_UC_WARN      BIT(1)
#define LTC4286_STATUS_MFR_SYS_PIN_UP_WARN       BIT(0)
...
#define LTC4286_FAULT_OP_TIMER         GENMASK(15, 5)
#define LTC4286_FAULT_OP_RESPONSE_MASK GENMASK(4, 3)
#define LTC4286_FAULT_OP_RETRY_MASK    GENMASK(2, 0)

#define LTC4286_FAULT_RESP_IGNORE 0
#define LTC4286_FAULT_RESP_TYP1   1
#define LTC4286_FAULT_RESP_TYP2   2
#define LTC4286_FAULT_RESP_TYP3   3
...
struct ltc4286_data {
	...
	uint16_t iout_sample;
	uint16_t pin_sample;
	uint16_t temp_sample;
	uint16_t status_flags_sample;
	uint16_t status_flags_mfr_sys_status1;
	uint16_t status_flags_mfr_sys_status2;
	uint8_t status_flags_vout;
	uint8_t status_flags_iout;
	uint8_t status_flags_input;
	uint8_t status_flags_temp;
	uint8_t status_flags_cml;
	uint8_t status_flags_other;
	uint8_t status_flags_mfr_spec;
	bool is_write_protect;
