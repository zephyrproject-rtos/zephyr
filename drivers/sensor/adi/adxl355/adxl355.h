...
/* FIFO Watermark */
#define ADXL355_FIFO_MAX_ENTRIES 96

/* External Clock */
#define ADXL355_ENABLE_EXT_CLK  1
#define ADXL355_DISABLE_EXT_CLK 0

/* External Sync */
#define ADXL355_INTERNAL_SYNC         0
#define ADXL355_EXT_SYNC_NO_INTP_FILT 1
#define ADXL355_EXT_SYNC_INTP_FILT    2

/* I2C High Speed Mode */
#define ADXL355_ENABLE_I2C_HS  1
#define ADXL355_DISABLE_I2C_HS 0

/* Interrupt Polarity */
#define ADXL355_INT_POL_ACTIVE_HIGH 1
#define ADXL355_INT_POL_ACTIVE_LOW  0
