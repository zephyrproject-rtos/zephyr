...
#define ISDS_2536030320001_CONFIG_COMMON(inst)                                                     \
	...
	ISDS_2536030320001_CONFIG_OPTIONAL(inst) ISDS_2536030320001_CONFIG_IRQ(inst)
...
#define ISDS_2536030320001_CONFIG_WE_INTERFACE(inst)                                               \
...
#define ISDS_2536030320001_SELECT_CONFIG(inst)                                                     \
	COND_CODE_1(DT_INST_ON_BUS(inst, i2c),                         \
...
#define ISDS_2536030320001_DEFINE(inst)                                                            \
	static struct isds_2536030320001_data isds_2536030320001_data_##inst =                     \
		ISDS_2536030320001_CONFIG_WE_INTERFACE(inst);                                      \
	static const struct isds_2536030320001_config isds_2536030320001_config_##inst =           \
		ISDS_2536030320001_SELECT_CONFIG(inst);                                            \
