...
static const struct sensor_driver_api pads_2511020213301_driver_api = {
...
#ifdef CONFIG_WSEN_PADS_2511020213301_PRESSURE_THRESHOLD
#define PADS_2511020213301_CFG_THRESHOLD(inst)                                                     \
...
#define PADS_2511020213301_CONFIG_COMMON(inst)                                                     \
	...
	PADS_2511020213301_CFG_THRESHOLD(inst).alpf_configuration =                                \
		(PADS_filterConf_t)DT_INST_PROP(inst, additional_low_pass_filter_configuration),   \
	COND_CODE_1(DT_INST_NODE_HAS_PROP(inst, additional_low_pass_filter),                       \
		    (.alpf = PADS_enable), (.alpf = PADS_disable)),                                \
...
#define PADS_2511020213301_DEFINE(inst)                                                            \
	static struct pads_2511020213301_data pads_2511020213301_data_##inst = COND_CODE_1(        \
	...
	static const struct pads_2511020213301_config pads_2511020213301_config_##inst =           \
		COND_CODE_1(DT_INST_ON_BUS(inst, i2c), (PADS_2511020213301_CONFIG_I2C(inst)), ())  \
			COND_CODE_1(DT_INST_ON_BUS(inst, spi),                                     \
