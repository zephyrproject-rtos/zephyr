...
static const struct sensor_driver_api itds_2533020201601_driver_api = {
...
#define ITDS_2533020201601_CONFIG_COMMON(inst)                                                     \
	...
	COND_CODE_1(DT_INST_NODE_HAS_PROP(inst, low_noise),                                        \
		    (.low_noise = (ITDS_state_t)ITDS_enable),                                      \
		    (.low_noise = (ITDS_state_t)ITDS_disable)),                                    \
	ITDS_2533020201601_CONFIG_TAP(inst) ITDS_2533020201601_CONFIG_FREEFALL(inst)               \
...
#define ITDS_2533020201601_DEFINE(inst)                                                            \
	static struct itds_2533020201601_data itds_2533020201601_data_##inst = COND_CODE_1(        \
