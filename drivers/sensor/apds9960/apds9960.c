...
DEVICE_AND_API_INIT(DT_AVAGO_APDS9960_0_PARENT_LABEL, apds9960,
		    DT_AVAGO_APDS9960_0_LABEL, &apds9960_init,
		    &apds9960_data, NULL, POST_KERNEL,
		    CONFIG_SENSOR_INIT_PRIORITY, &apds9960_driver_api);
#else
DEVICE_DEFINE(DT_AVAGO_APDS9960_0_PARENT_LABEL, apds9960,
	      DT_AVAGO_APDS9960_0_LABEL, apds9960_init,
