...
#define BMP3XX_BUS_SPI_BMP388 DT_HAS_COMPAT_ON_BUS_STATUS_OKAY(bosch_bmp388, spi)
#define BMP3XX_BUS_I2C_BMP388 DT_HAS_COMPAT_ON_BUS_STATUS_OKAY(bosch_bmp388, i2c)
#define BMP3XX_BUS_SPI_BMP390 DT_HAS_COMPAT_ON_BUS_STATUS_OKAY(bosch_bmp390, spi)
#define BMP3XX_BUS_I2C_BMP390 DT_HAS_COMPAT_ON_BUS_STATUS_OKAY(bosch_bmp390, i2c)
