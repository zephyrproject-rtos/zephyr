...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM42370_SPI_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM42370_SPI_H_
 ...
 */
int icm42370_write_mreg(const struct spi_dt_spec *bus, uint16_t reg, uint8_t data);
 ...
 * @return int 0 on success, negative error code otherwise
 */
int icm42370_read_mreg(const struct spi_dt_spec *bus, uint16_t reg, uint8_t *data, size_t len);

/**
 * @brief perform a single SPI write to a ICM42370 register
 *
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ICM42370_SPI_H_ */
