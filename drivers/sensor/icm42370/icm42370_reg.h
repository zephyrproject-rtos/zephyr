...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM42370_REG_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM42370_REG_H_
...
#define BIT_INT_WOM_X_INT1_EN		BIT(0)
#define BIT_INT_WOM_Y_INT1_EN		BIT(1)
#define BIT_INT_WOM_Z_INT1_EN		BIT(2)
#define BIT_INT_SMD_INT1_EN		BIT(3)
#define BIT_INT_I3C_PROT_ERR_INT1_EN	BIT(6)
...
#define BIT_INT_STATUS_WOM_XYZ		GENMASK(2, 0)
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ICM42370_REG_H_ */
