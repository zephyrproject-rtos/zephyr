 ...
 *   (3) client send request with callback function provided, driver returns
 *       transaction id
 *   (4) driver call the callback function once the transaction complete
 *   (5) ... repeats (3) to (4) to send more request
 *   (6) client close channel
 *   (7) ... repeats (2) to (6) to reopen the channel and send request
 *   (8) unregister the client at the end
 *
...
LOG_MODULE_REGISTER(sip_svc_ll, CONFIG_ARM_SIP_SVC_LOG_LEVEL);
