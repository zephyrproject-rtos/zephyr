 ...
 */
#define DT_DRV_COMPAT sifli_sf32lb_mipi_dbi
				       ...
				       const struct mipi_dbi_config *dbi_config)
{
	...
	uint32_t clk_div;
	uint32_t lcdc_clk = 48000000U;
	uint32_t freq = 2000000U;
				     ...
				     const struct mipi_dbi_config *dbi_config)
{
	...
	case MIPI_DBI_MODE_SPI_4WIRE:
		...
		mipi_dbi_sf32lb_spi_config(dev, dbi_config);
		break;
...
static const struct mipi_dbi_driver_api dbi_sf32lb_api = {
