...
static bool cs40l5x_regmap_is_ready_i2c(const struct device *const dev)
{
...
static struct device *cs40l5x_regmap_get_device_i2c(const struct device *const dev)
{
	const struct cs40l5x_config *const config = dev->config;
...
static int cs40l5x_regmap_read_i2c(const struct device *const dev, const uint32_t addr,
...
static int cs40l5x_regmap_write_i2c(const struct device *const dev, const uint32_t *const tx,
				    const uint32_t len)
{
	const struct cs40l5x_config *const config = dev->config;
...
const struct cs40l5x_bus_io cs40l5x_bus_io_i2c = {
	.is_ready = cs40l5x_regmap_is_ready_i2c,
	.get_device = cs40l5x_regmap_get_device_i2c,
	.read = cs40l5x_regmap_read_i2c,
	.write = cs40l5x_regmap_write_i2c,
};
