...
/**
 * @struct ti_sci_msg_resp_reboot
 * @brief Response to system reboot request
 * @param hdr: Generic Header
 *
 * Response to TI_SCI_MSG_SYS_RESET.
 */
struct ti_sci_msg_resp_reboot {
	struct ti_sci_msg_hdr hdr;
} __packed;
 ...
 * @brief Response to set device state request
 * @param hdr:	Generic Header
 *
 * Response to TI_SCI_MSG_SET_DEVICE_STATE.
 */
struct ti_sci_msg_resp_set_device_state {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_device_resets
 * @brief Response to set device resets request
 * @param hdr: Generic Header
 *
 * Response to TI_SCI_MSG_SET_DEVICE_RESETS.
 */
struct ti_sci_msg_resp_set_device_resets {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_clock_state
 * @brief Response to set clock state request
 * @param hdr: Generic Header
 *
 * Response to TI_SCI_MSG_SET_CLOCK_STATE.
 */
struct ti_sci_msg_resp_set_clock_state {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_clock_parent
 * @brief Response to set clock parent request
 * @param hdr:	Generic Header
 *
 * Response to TI_SCI_MSG_SET_CLOCK_PARENT.
 */
struct ti_sci_msg_resp_set_clock_parent {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_clock_freq
 * @brief Response to set clock frequency request
 * @param hdr:	Generic Header
 *
 * Response to TI_SCI_MSG_SET_CLOCK_FREQ.
 */
struct ti_sci_msg_resp_set_clock_freq {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_proc_request
 * @brief Response to processor request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_PROC_REQUEST.
 */
struct ti_sci_msg_resp_proc_request {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_proc_release
 * @brief Response to processor release request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_PROC_RELEASE.
 */
struct ti_sci_msg_resp_proc_release {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_proc_handover
 * @brief Response to processor handover request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_PROC_HANDOVER.
 */
struct ti_sci_msg_resp_proc_handover {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_proc_boot_config
 * @brief Response to set processor boot configuration request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_SET_PROC_BOOT_CONFIG.
 */
struct ti_sci_msg_resp_set_proc_boot_config {
	struct ti_sci_msg_hdr hdr;
} __packed;
...
/**
 * @struct ti_sci_msg_resp_set_proc_boot_ctrl
 * @brief Response to set processor boot control request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_SET_PROC_BOOT_CTRL.
 */
struct ti_sci_msg_resp_set_proc_boot_ctrl {
	struct ti_sci_msg_hdr hdr;
} __packed;
 ...
 * @brief Response to set firewall region request
 * @param hdr: Generic Header
 *
 * Response to TISCI_MSG_FWL_SET.
 */
struct ti_sci_msg_fwl_set_firewall_region_resp {
	struct ti_sci_msg_hdr hdr;
} __packed;
