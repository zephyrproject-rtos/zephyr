...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_scmi_base_cmds,
	SHELL_CMD(revision, NULL,
		  SHELL_HELP("SCMI Base get revision info\n",
		  "Usage: scmi base revision\n"),
		  scmi_shell_base_revision),
	SHELL_CMD_ARG(discover_agent, NULL,
		  SHELL_HELP("SCMI Base discover an agent\n",
		  "Usage: scmi base discover_agent [agent_id]\n"),
		  scmi_shell_base_discover_agent, 1, 2),
	SHELL_CMD_ARG(device_permission, NULL,
		  SHELL_HELP("SCMI Base set an agent permissions to access device\n",
		  "Usage: scmi base discover_agent <agent_id> <device_id> <allow := 0|1>\n"),
		  scmi_shell_base_device_permission, 4, 0),
	SHELL_CMD_ARG(reset_agent_cfg, NULL,
		  SHELL_HELP("SCMI Base reset an agent configuration\n",
		  "Usage: scmi base reset_agent_cfg <agent_id> <reset_perm := 0|1>\n"),
		  scmi_shell_base_reset_agent_cfg, 3, 0),
	SHELL_SUBCMD_SET_END);

SHELL_SUBCMD_ADD((scmi), base, &sub_scmi_base_cmds, "SCMI Base proto commands.",
		 NULL, 0, 0);
