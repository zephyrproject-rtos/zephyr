...
#ifdef CONFIG_NVMEM_PROVIDER_PSA_ITS
#include <psa/internal_trusted_storage.h>
#endif
#ifdef CONFIG_NVMEM_PROVIDER_PSA_PS
...
#ifdef CONFIG_NVMEM_PROVIDER_PSA_WRITE
...
static uint8_t nvmem_psa_rmw_buf[CONFIG_NVMEM_PROVIDER_PSA_WRITE_BUF_SIZE];
...
#endif /* CONFIG_NVMEM_PROVIDER_PSA_WRITE */

static DEVICE_API(nvmem_provider, nvmem_psa_api) = {
	.read = nvmem_psa_read,
#ifdef CONFIG_NVMEM_PROVIDER_PSA_WRITE
