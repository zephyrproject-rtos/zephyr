...
/* PWR_CTL (0x02) */
#define TAS2563_PWR_MODE_MASK           GENMASK(1, 0)
...
#define TAS2563_AMP_LEVEL_MASK          GENMASK(5, 1)
...
#define TAS2563_SAMP_RATE_MASK          GENMASK(3, 1)
...
#define TAS2563_RX_SCFG_MASK            GENMASK(5, 4)
...
#define TAS2563_RX_SLOT_LEFT_MASK       GENMASK(3, 0)
#define TAS2563_RX_SLOT_RIGHT_MASK      GENMASK(7, 4)

/* TDM_CFG4 (0x0A) */
#define TAS2563_TX_EDGE                 BIT(0)
#define TAS2563_TX_OFFSET_MASK          GENMASK(3, 1)
...
#define TAS2563_BOOST_MODE_MASK         GENMASK(7, 6)
#define TAS2563_BOOST_MODE_CLASS_H      0x00
#define TAS2563_BOOST_MODE_CLASS_G      0x01
#define TAS2563_BOOST_MODE_ALWAYS_ON    0x02
#define TAS2563_BOOST_MODE_ALWAYS_OFF   0x03

/* INT_CLK_CFG (0x30) */
#define TAS2563_IRQ_PIN_CFG_MASK        GENMASK(1, 0)
