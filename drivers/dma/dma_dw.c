...
static int dw_dma_config(const struct device *dev, u32_t channel,
...
static int dw_dma_reload(const struct device *dev, u32_t channel,
...
static int dw_dma_transfer_start(const struct device *dev, u32_t channel)
{
	const struct dw_dma_dev_cfg *const dev_cfg = DEV_CFG(dev);
...
static int dw_dma_transfer_stop(const struct device *dev, u32_t channel)
{
	const struct dw_dma_dev_cfg *const dev_cfg = DEV_CFG(dev);
