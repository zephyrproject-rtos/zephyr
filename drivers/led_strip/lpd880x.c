...
#define DT_INST_0_COLORWAY_LPD880X_BASE_ADDRESS DT_REG_ADDR(DT_INST(0, colorway_lpd8806))
#define DT_INST_0_COLORWAY_LPD880X_BUS_NAME DT_BUS_LABEL(DT_INST(0, colorway_lpd8806))
#define DT_INST_0_COLORWAY_LPD880X_LABEL DT_LABEL(DT_INST(0, colorway_lpd8806))
#define DT_INST_0_COLORWAY_LPD880X_SPI_MAX_FREQUENCY DT_PROP(DT_INST(0, colorway_lpd8806), spi_max_frequency)
#else
#define DT_INST_0_COLORWAY_LPD880X DT_INST_0_COLORWAY_LPD8803
#define DT_INST_0_COLORWAY_LPD880X_BASE_ADDRESS DT_REG_ADDR(DT_INST(0, colorway_lpd8803))
#define DT_INST_0_COLORWAY_LPD880X_BUS_NAME DT_BUS_LABEL(DT_INST(0, colorway_lpd8803))
#define DT_INST_0_COLORWAY_LPD880X_LABEL DT_LABEL(DT_INST(0, colorway_lpd8803))
#define DT_INST_0_COLORWAY_LPD880X_SPI_MAX_FREQUENCY DT_PROP(DT_INST(0, colorway_lpd8803), spi_max_frequency)
#endif
