...
static int ws2812_espressif_rmt_update_rbg(const struct device *dev,
...
static DEVICE_API(led_strip, ws2812_espressif_rmt_api) = {
	.update_rgb = ws2812_espressif_rmt_update_rbg,
...
#define WS2812_ESPRESSIF_RMT_DEVICE(idx)                                            \
	...
	static struct ws2812_espressif_rmt_data ws2812_espressif_rmt_##idx##_data = {   \
	...
	DEVICE_DT_INST_DEFINE(idx, ws2812_espressif_rmt_init, NULL,                     \
		&ws2812_espressif_rmt_##idx##_data, &ws2812_espressif_rmt_##idx##_cfg,      \
