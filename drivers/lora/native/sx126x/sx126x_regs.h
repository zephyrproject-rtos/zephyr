...
/* GFSK modulation limits (from SX1261/2 datasheet Table 4-1) */
#define SX126X_GFSK_BR_MIN_BPS     600U
#define SX126X_GFSK_BR_MAX_BPS     300000U
#define SX126X_GFSK_FDEV_MIN_HZ    600U
#define SX126X_GFSK_FDEV_MAX_HZ    200000U
/* Deviation plus half the bit rate, the occupied bandwidth the part is rated for */
#define SX126X_GFSK_FDEV_BR_MAX_HZ 250000U
