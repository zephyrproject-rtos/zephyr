...
static int mbox_stm32_hsem_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_INST_IRQN(0), DT_INST_IRQ(0, priority), mbox_dispatcher,
...
DEVICE_DT_INST_DEFINE(0, mbox_stm32_hsem_init, NULL, &stm32_hsem_mbox_data, &stm32_hsem_mbox_conf,
		      POST_KERNEL, CONFIG_MBOX_INIT_PRIORITY, &mbox_stm32_hsem_driver_api);
