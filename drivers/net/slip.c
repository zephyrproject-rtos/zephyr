...
ETH_NET_DEVICE_INIT(NULL, slip, CONFIG_SLIP_DRV_NAME,
		    slip_init, &slip_context_data, NULL,
...
NET_DEVICE_INIT(NULL, slip, CONFIG_SLIP_DRV_NAME, slip_init, &slip_context_data,
