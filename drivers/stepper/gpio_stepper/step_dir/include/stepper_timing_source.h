...
#ifndef ZEPHYR_DRIVER_STEPPER_GPIO_STEPPER_STEP_DIR_STEPPER_TIMING_SOURCE_H_
#define ZEPHYR_DRIVER_STEPPER_GPIO_STEPPER_STEP_DIR_STEPPER_TIMING_SOURCE_H_
...
#endif /* ZEPHYR_DRIVER_STEPPER_GPIO_STEPPER_STEP_DIR_STEPPER_TIMING_SOURCE_H_ */
