...
#define TMC5XXX_RAMPSTAT_VZERO_MASK BIT(10)
#define TMC5XXX_VZERO										   \
	(TMC5XXX_RAMPSTAT_VZERO_MASK >> TMC5XXX_RAMPSTAT_INT_SHIFT)
...
#define TMC5XXX_RAMPMODE(motor)  ((uint8_t)(0x00 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_XACTUAL(motor)   ((uint8_t)(0x01 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_VACTUAL(motor)   ((uint8_t)(0x02 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_VSTART(motor)    ((uint8_t)(0x03 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_A1(motor)        ((uint8_t)(0x04 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_V1(motor)        ((uint8_t)(0x05 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_AMAX(motor)      ((uint8_t)(0x06 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_VMAX(motor)      ((uint8_t)(0x07 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_DMAX(motor)      ((uint8_t)(0x08 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_D1(motor)        ((uint8_t)(0x0A | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_VSTOP(motor)     ((uint8_t)(0x0B | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_TZEROWAIT(motor) ((uint8_t)(0x0C | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_XTARGET(motor)   ((uint8_t)(0x0D | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_SWMODE(motor)    ((uint8_t)(0x14 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_RAMPSTAT(motor)  ((uint8_t)(0x15 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_CHOPCONF(motor)  ((uint8_t)(0x6C | TMC50XX_MOTOR_ADDR_DRV(motor)))
#define TMC5XXX_COOLCONF(motor)  ((uint8_t)(0x6D | TMC50XX_MOTOR_ADDR_DRV(motor)))
#define TMC5XXX_DRVSTATUS(motor) ((uint8_t)(0x6F | TMC50XX_MOTOR_ADDR_DRV(motor)))
#define TMC5XXX_IHOLD_IRUN(motor) ((uint8_t)(0x10 | TMC50XX_MOTOR_ADDR(motor)))
...
#define TMC50XX_VCOOLTHRS(motor)  ((uint8_t)(0x11 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_VHIGH(motor)      ((uint8_t)(0x12 | TMC50XX_MOTOR_ADDR(motor)))
