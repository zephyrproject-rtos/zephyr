...
struct tmc22xx_config {
	...
	enum stepper_amp_micro_step_resolution *msx_resolutions;
};

struct tmc22xx_data {
	enum stepper_amp_micro_step_resolution resolution;
};
...
static DEVICE_API(stepper_amp, tmc22xx_stepper_amp_api) = {
...
#define TMC22XX_STEPPER_DEFINE(inst, msx_table)                                                    \
	...
	DEVICE_DT_INST_DEFINE(inst, tmc22xx_stepper_init, NULL, &tmc22xx_data_##inst,              \
			      ...
			      &tmc22xx_stepper_amp_api);

#define DT_DRV_COMPAT adi_tmc2209
static enum stepper_amp_micro_step_resolution tmc2209_msx_resolutions[MSX_PIN_STATE_COUNT] = {
	STEPPER_AMP_MICRO_STEP_8,
	STEPPER_AMP_MICRO_STEP_32,
	STEPPER_AMP_MICRO_STEP_64,
	STEPPER_AMP_MICRO_STEP_16,
};
