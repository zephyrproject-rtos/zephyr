...
static int a4979_set_micro_step_res(const struct device *dev,
				    const enum stepper_amp_micro_step_resolution micro_step_res)
{
	const struct a4979_config *config = dev->config;
	...
	case STEPPER_AMP_MICRO_STEP_1:
		m0_value = 0;
		m1_value = 0;
		break;
	case STEPPER_AMP_MICRO_STEP_2:
		m0_value = 1;
		m1_value = 0;
		break;
	case STEPPER_AMP_MICRO_STEP_4:
		m0_value = 0;
		m1_value = 1;
		break;
	case STEPPER_AMP_MICRO_STEP_16:
		m0_value = 1;
		m1_value = 1;
		break;
	default:
...
static DEVICE_API(stepper_amp, a4979_stepper_amp_api) = {
	.enable = a4979_enable,
...
#define A4979_DEVICE(inst)                                                                         \
	...
	DEVICE_DT_INST_DEFINE(inst, a4979_init, NULL, &a4979_data_##inst, &a4979_config_##inst,    \
			      POST_KERNEL, CONFIG_STEPPER_INIT_PRIORITY, &a4979_stepper_amp_api);
