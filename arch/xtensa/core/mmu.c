 ...
 *
 * This precomputes the necessary values for registers that we need to
 * program when switching page tables. This is on a per-domain basis as
 ...
 *
 * This initializes paging which enables MMU.
 *
