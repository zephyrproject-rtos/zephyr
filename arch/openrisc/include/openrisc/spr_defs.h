...
#ifndef _ZEPHYR_ARCH_OPENRISC_INCLUDE_OPENRISC_SPR_DEFS_H_
#define _ZEPHYR_ARCH_OPENRISC_INCLUDE_OPENRISC_SPR_DEFS_H_
...
#define SPR_CPUCFGR_AECSRP	0x00004000  /* Arithmetic Exception Control/Status Registers
					     * (ARCR/AESR) Present
					     */
...
#endif /* _ZEPHYR_ARCH_OPENRISC_INCLUDE_OPENRISC_SPR_DEFS_H_ */
