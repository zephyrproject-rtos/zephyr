...
void z_riscv_pmp_init(void)
{
	 ...
	 */
	set_pmp_entry(&index, PMP_NONE | COND_CODE_1(CONFIG_PMP_NO_LOCK, (0x0), (PMP_L)),
		      0,
	...
	set_pmp_entry(&index, PMP_R | PMP_X | COND_CODE_1(CONFIG_PMP_NO_LOCK, (0x0), (PMP_L)),
...
#if defined(CONFIG_MEM_ATTR) || defined(CONFIG_PMP_NO_LOCK)
	/*
