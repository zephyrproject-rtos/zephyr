 ...
 */
#undef __ZEPHYR_SUPERVISOR__
#include <atomic.h>
#include <toolchain.h>
#include <arch/cpu.h>
#include <arch/arc/v2/atomic_lock.h>
#include <syscall_handler.h>


Z_SYSCALL_HANDLER(arc_atomic_lock)
{
	return z_impl_arc_atomic_lock();
}

Z_SYSCALL_HANDLER(arc_atomic_unlock, key)
{
	z_impl_arc_atomic_unlock(key);
	return 0;
}
