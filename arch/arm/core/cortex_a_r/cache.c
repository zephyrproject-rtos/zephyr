...
{
	/* Invalidate outer before inner, matching arch_dcache_invd_range() */
#ifdef CONFIG_OUTER_CACHE
	z_arm_outer_cache_invd_all();
#endif
...
#ifdef CONFIG_OUTER_CACHE
	z_arm_outer_cache_flush_and_invd_all();
#endif
