...
#if defined(CONFIG_ARMV7_R) || defined(CONFIG_ARM_A_PROFILE_AARCH32) || defined(CONFIG_ARMV5)
...
#ifdef CONFIG_ARMV5
	/*
	 * ARMv5 doesn't have TPIDRURO and doesn't support SMP either;
	 * on this arch version, _current_cpu is hardcoded instead,
