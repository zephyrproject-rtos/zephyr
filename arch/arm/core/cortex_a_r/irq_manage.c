...
/*
 * For Cortex-A and Cortex-R cores, the architecture interrupt control
 * functions map onto the root interrupt controller API (intc_root_*)
 * provided by the controller driver, see include/zephyr/arch/arm/irq.h.
 * With CONFIG_ARM_CUSTOM_INTERRUPT_CONTROLLER the SoC provides them instead.
 */
