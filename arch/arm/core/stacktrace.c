...
{
	/* rely on compiler to do the right thing and not have nnnn as 13/15 */
...
{
	uint32_t *vsp = (uint32_t *)ucb->vrs[13];
	uint8_t mask = unwind_exec_get_next(ucb);

	/* 10110001_00000000 or 10110001_xxxxyyyy, xxxx != 0000 */
