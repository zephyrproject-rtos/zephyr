...
#ifndef _STM32F7X_CLOCK_H_
#define _STM32F7X_CLOCK_H_

/**
 * @brief Driver for Reset & Clock Control of STM32F4X family processor.
 *
 * Based on reference manual:
 *   RM0410 Reference manual STM32F7xx
 *   advanced ARM ® -based 32-bit MCUs
 *
 * Chapter 5. Reset and Clock control (RCC) for STM43F401xB/C and STM32F401xD/E
 */

enum {
	STM32F7X_RCC_CFG_PLL_SRC_HSI = 0x0,
	STM32F7X_RCC_CFG_PLL_SRC_HSE = 0x1,
};

enum {
	STM32F7X_RCC_CFG_SYSCLK_SRC_HSI = 0x0,
	STM32F7X_RCC_CFG_SYSCLK_SRC_HSE = 0x1,
	STM32F7X_RCC_CFG_SYSCLK_SRC_PLL = 0x2,
};

enum {
	STM32F7X_RCC_CFG_PLLP_DIV_2 = 0x0,
	STM32F7X_RCC_CFG_PLLP_DIV_4 = 0x1,
	STM32F7X_RCC_CFG_PLLP_DIV_6 = 0x2,
	STM32F7X_RCC_CFG_PLLP_DIV_8 = 0x3,
};

enum {
	STM32F7X_RCC_CFG_HCLK_DIV_0  = 0x0,
	STM32F7X_RCC_CFG_HCLK_DIV_2  = 0x4,
	STM32F7X_RCC_CFG_HCLK_DIV_4  = 0x5,
	STM32F7X_RCC_CFG_HCLK_DIV_8  = 0x6,
	STM32F7X_RCC_CFG_HCLK_DIV_16 = 0x7,
};

enum {
	STM32F7X_RCC_CFG_SYSCLK_DIV_0	 = 0x0,
	STM32F7X_RCC_CFG_SYSCLK_DIV_2	 = 0x8,
	STM32F7X_RCC_CFG_SYSCLK_DIV_4	 = 0x9,
	STM32F7X_RCC_CFG_SYSCLK_DIV_8	 = 0xa,
	STM32F7X_RCC_CFG_SYSCLK_DIV_16	 = 0xb,
	STM32F7X_RCC_CFG_SYSCLK_DIV_64	 = 0xc,
	STM32F7X_RCC_CFG_SYSCLK_DIV_128	 = 0xd,
	STM32F7X_RCC_CFG_SYSCLK_DIV_256	 = 0xe,
	STM32F7X_RCC_CFG_SYSCLK_DIV_512	 = 0xf,
};
...
/* Helpers */
enum {
	STM32F7X_RCC_APB1ENR_PWREN = 0x10000000U,
};
