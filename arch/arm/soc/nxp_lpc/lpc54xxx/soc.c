...
static ALWAYS_INLINE void clkInit(void)
{
	...
	CLOCK_SetFLASHAccessCyclesForFreq(BOARD_BOOTCLOCKFROHF48M_CORE_CLOCK);

    /* Set up high frequency FRO output to selected frequency */
	CLOCK_SetupFROClocking(BOARD_BOOTCLOCKFROHF48M_CORE_CLOCK);
...
#ifdef CONFIG_GPIO_LPC_MCUX_PORT0
	CLOCK_EnableClock(kCLOCK_Gpio0);
#endif

#ifdef CONFIG_GPIO_LPC_MCUX_PORT1
