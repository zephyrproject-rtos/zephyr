...
#if defined(CONFIG_PICOLIBC_USE_MODULE) || !__has_include(<sys/_pthreadtypes.h>)
/* <sys/_pthreadtypes.h> and <pthread.h> not available in module or in picolibc >= 1.8.10 */
