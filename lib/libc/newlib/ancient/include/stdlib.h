...
#ifndef ZEPHYR_LIB_LIBC_NEWLIB_ANCIENT_INCLUDE_STDLIB_H_
#define ZEPHYR_LIB_LIBC_NEWLIB_ANCIENT_INCLUDE_STDLIB_H_
...
#endif /* ZEPHYR_LIB_LIBC_NEWLIB_ANCIENT_INCLUDE_STDLIB_H_ */
