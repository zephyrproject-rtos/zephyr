...
#elif CONFIG_ARC
	#if !defined(CONFIG_HARVARD) && CONFIG_SRAM_SIZE > 0
		#define RAMABLE_REGION_START CONFIG_SRAM_BASE_ADDRESS
		#define RAMABLE_REGION_SIZE CONFIG_SRAM_SIZE
	#else
		#define RAMABLE_REGION_START CONFIG_DCCM_BASE_ADDRESS
		#define RAMABLE_REGION_SIZE CONFIG_DCCM_SIZE
	#endif
#define USED_RAM_SIZE  (USED_RAM_END_ADDR - RAMABLE_REGION_START)
#define MAX_HEAP_SIZE ((KB(RAMABLE_REGION_SIZE)) - USED_RAM_SIZE)
#elif CONFIG_XTENSA
