...
#ifndef ZEPHYR_LIB_LIBC_MINIMAL_INCLUDE_THREADS_H_
#define ZEPHYR_LIB_LIBC_MINIMAL_INCLUDE_THREADS_H_
...
#endif /* ZEPHYR_LIB_LIBC_MINIMAL_INCLUDE_THREADS_H_ */
