...
uint32_t crc32_k_4_2_update(uint32_t crc, uint8_t const *const data, size_t const len)
{
	 ...
	 */
	static uint32_t const table[16] = {0x00000000, 0x93a409eb, 0xb4ec1a3d, 0x274813d6,
