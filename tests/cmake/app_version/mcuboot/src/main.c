...
{
	zassert_str_equal("development", STRINGIFY(APP_EXTRAVERSION));
	zassert_str_equal("5.6.7-development", APP_VERSION_STRING);
	zassert_str_equal("5.6.7-development+89", APP_VERSION_EXTENDED_STRING);
	zassert_str_equal("5.6.7+89", APP_VERSION_TWEAK_STRING);
}
