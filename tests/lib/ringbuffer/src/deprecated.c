 ...
 */
ZTEST(deprecated_ringbuffer_api, test_ring_buffer_main)
{
	int ret, i;
	int put_count = 0;
	uint32_t getdata[6];
...
static void tringbuf_get(const void *p)
{
	...
	zassert_equal(memcmp(rx_data, static_data[index].buffer, size32 * sizeof(uint32_t)), 0);
}
...
/*test cases*/
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_init)
{
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_declare_pow2)
{
	zassert_true(ring_buf_is_empty(&ringbuf_pow2));
	zassert_equal(ring_buf_item_space_get(&ringbuf_pow2), (1 << POW));
}

ZTEST(deprecated_ringbuffer_api, test_ringbuffer_declare_size)
{
 ...
 * @see ring_buf_item_put, ring_buf_item_get
 */
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_put_get_thread)
{
	pbuf = &ringbuf;
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_put_get_isr)
{
	pbuf = &ringbuf;
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_put_get_thread_isr)
{
	pbuf = &ringbuf;
	tringbuf_put((const void *)0);
	irq_offload(tringbuf_put, (const void *)1);
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_put_get_discard)
{
	pbuf = &ringbuf;
	tringbuf_put((const void *)0);
	tringbuf_put((const void *)1);
 ...
 * @see ring_buf_item_put, ring_buf_item_get
 */
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_pow2_put_get_thread_isr)
{
	pbuf = &ringbuf_pow2;
	tringbuf_put((const void *)0);
	irq_offload(tringbuf_put, (const void *)1);
 ...
 * @see ring_buf_item_put, ring_buf_item_get
 */
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_size_put_get_thread_isr)
{
	pbuf = &ringbuf_size;
	tringbuf_put((const void *)0);
	irq_offload(tringbuf_put, (const void *)1);
 ...
 */
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_raw)
{
	int i;
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_alloc_put)
{
...
ZTEST(deprecated_ringbuffer_api, test_byte_put_free)
{
...
ZTEST(deprecated_ringbuffer_api, test_capacity)
{
	uint32_t capacity;
...
ZTEST(deprecated_ringbuffer_api, test_size)
{
	uint32_t size;
...
ZTEST(deprecated_ringbuffer_api, test_peek)
{
	uint32_t size;
	uint8_t byte = 0x42;
	static uint8_t buf[RINGBUFFER_SIZE];
...
ZTEST(deprecated_ringbuffer_api, test_reset)
{
	uint8_t indata[] = {1, 2, 3, 4, 5};
 ...
 * @see ring_buf_item_put, ring_buf_item_get
 */
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_array_perf)
{
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_partial_putting)
{
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_partial_getting)
{
	uint8_t indata[RINGBUFFER_SIZE];
	uint8_t outdata[RINGBUFFER_SIZE];
	uint32_t len;
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_equal_bufs)
{
	struct ring_buf buf_ii;
	uint8_t *data;
	uint32_t claimed;
...
ZTEST(deprecated_ringbuffer_api, test_ringbuffer_performance)
{
	uint8_t buf[16];
...
ZTEST_SUITE(deprecated_ringbuffer_api, NULL, NULL, NULL, NULL, NULL);
