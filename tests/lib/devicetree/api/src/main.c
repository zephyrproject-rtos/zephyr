...
{
	zassert_equal(DT_CHILD_NUM_ON_BUS(TEST_CONTROLLER, generic), 4, "");
	zassert_equal(DT_INST_CHILD_NUM_ON_BUS(0, generic), 4, "");
	zassert_equal(DT_CHILD_NUM_ON_BUS_STATUS_OKAY(TEST_CONTROLLER, generic), 3, "");
	zassert_equal(DT_INST_CHILD_NUM_ON_BUS_STATUS_OKAY(0, generic), 3, "");
}
