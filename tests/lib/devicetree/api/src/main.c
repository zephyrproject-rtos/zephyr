...
ZTEST(devicetree_api, test_phandles)
{
	...
	zassert_equal(DT_PHA_ELEM_NAME_BY_IDX(TEST_PH, foos, 0), "A");
	zassert_equal(DT_PHA_ELEM_NAME_BY_IDX(TEST_PH, foos, 1), "b-c");
	zassert_equal(DT_PHA_ELEM_NAME_BY_IDX(TEST_PH, pwms, 0), "red");
	zassert_equal(DT_PHA_ELEM_NAME_BY_IDX(TEST_PH, pwms, 1), "green");
