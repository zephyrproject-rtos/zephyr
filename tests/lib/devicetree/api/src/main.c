...
ZTEST(devicetree_api, test_map)
{
	...
	zassert_equal(DT_MAP_ENTRY_CHILD_SPECIFIER_HAS_IDX(TEST_GPIO_CONNECTOR, gpio_map, 1, 1), 1);
	zassert_equal(DT_MAP_ENTRY_CHILD_SPECIFIER_HAS_IDX(TEST_GPIO_CONNECTOR, gpio_map, 1, 2), 0);
