...
static void test_nodelabel_props(void)
{
	...
	zassert_equal(DT_NODE_NUM_NODELABEL(TEST_NODELABEL), 3, "");
	zassert_true(!strcmp(STRINGIFY(DT_NODE_NODELABEL(TEST_NODELABEL, 0)),
			     "test_nodelabel"), "");
	zassert_true(!strcmp(STRINGIFY(DT_NODE_NODELABEL(TEST_NODELABEL, 1)),
			     "TEST_NODELABEL_ALLCAPS"), "");
	zassert_true(!strcmp(STRINGIFY(DT_NODE_NODELABEL(TEST_NODELABEL, 2)),
			     "test_gpio_1"), "");
