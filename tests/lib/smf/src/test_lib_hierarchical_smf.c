...
{
	zassert_equal(smf_get_current_executing_state(SMF_CTX(obj)), &test_states[PARENT_AB],
...
{
	zassert_equal(smf_get_current_executing_state(SMF_CTX(obj)), &test_states[PARENT_C],
