    ...
    const q31_t *input1, const q31_t *input2, const q31_t *ref, size_t length)
{
    ...
    /* Run test function */
    arm_and_q31(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_and_q31, 3, in_bitwise1, in_bitwise2, ref_and, 3);
DEFINE_TEST_VARIANT4(arm_and_q31, 8, in_bitwise1, in_bitwise2, ref_and, 8);
DEFINE_TEST_VARIANT4(arm_and_q31, 11, in_bitwise1, in_bitwise2, ref_and, 11);

static void test_arm_or_q31(
    const q31_t *input1, const q31_t *input2, const q31_t *ref, size_t length)
{
    q31_t *output;
    ...
    /* Run test function */
    arm_or_q31(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_or_q31, 3, in_bitwise1, in_bitwise2, ref_or, 3);
DEFINE_TEST_VARIANT4(arm_or_q31, 8, in_bitwise1, in_bitwise2, ref_or, 8);
DEFINE_TEST_VARIANT4(arm_or_q31, 11, in_bitwise1, in_bitwise2, ref_or, 11);

static void test_arm_not_q31(
    const q31_t *input1, const q31_t *ref, size_t length)
{
    q31_t *output;
    ...
    /* Run test function */
    arm_not_q31(input1, output, length);
...
DEFINE_TEST_VARIANT3(arm_not_q31, 3, in_bitwise1, ref_not, 3);
DEFINE_TEST_VARIANT3(arm_not_q31, 8, in_bitwise1, ref_not, 8);
DEFINE_TEST_VARIANT3(arm_not_q31, 11, in_bitwise1, ref_not, 11);

static void test_arm_xor_q31(
    const q31_t *input1, const q31_t *input2, const q31_t *ref, size_t length)
{
    q31_t *output;
    ...
    /* Run test function */
    arm_xor_q31(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_xor_q31, 3, in_bitwise1, in_bitwise2, ref_xor, 3);
DEFINE_TEST_VARIANT4(arm_xor_q31, 8, in_bitwise1, in_bitwise2, ref_xor, 8);
DEFINE_TEST_VARIANT4(arm_xor_q31, 11, in_bitwise1, in_bitwise2, ref_xor, 11);
...
void test_basicmath_q31(void)
{
    ztest_test_suite(basicmath_q31,
        ...
        ztest_unit_test(test_arm_and_q31_3),
        ztest_unit_test(test_arm_and_q31_8),
        ztest_unit_test(test_arm_and_q31_11),
        ztest_unit_test(test_arm_or_q31_3),
        ztest_unit_test(test_arm_or_q31_8),
        ztest_unit_test(test_arm_or_q31_11),
        ztest_unit_test(test_arm_not_q31_3),
        ztest_unit_test(test_arm_not_q31_8),
        ztest_unit_test(test_arm_not_q31_11),
        ztest_unit_test(test_arm_xor_q31_3),
        ztest_unit_test(test_arm_xor_q31_8),
        ztest_unit_test(test_arm_xor_q31_11)
        );
