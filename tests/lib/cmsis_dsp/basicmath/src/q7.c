...
static void test_arm_dot_prod_q7(
    const q7_t *input1, const q7_t *input2, const q31_t *ref, size_t length)
{
    q31_t *output;
    ...
    const q7_t *input1, const q7_t *input2, const q7_t *ref, size_t length)
{
    ...
    /* Run test function */
    arm_and_q7(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_and_q7, 15, in_bitwise1, in_bitwise2, ref_and, 15);
DEFINE_TEST_VARIANT4(arm_and_q7, 32, in_bitwise1, in_bitwise2, ref_and, 32);
DEFINE_TEST_VARIANT4(arm_and_q7, 47, in_bitwise1, in_bitwise2, ref_and, 47);

static void test_arm_or_q7(
    const q7_t *input1, const q7_t *input2, const q7_t *ref, size_t length)
{
    q7_t *output;
    ...
    /* Run test function */
    arm_or_q7(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_or_q7, 15, in_bitwise1, in_bitwise2, ref_or, 15);
DEFINE_TEST_VARIANT4(arm_or_q7, 32, in_bitwise1, in_bitwise2, ref_or, 32);
DEFINE_TEST_VARIANT4(arm_or_q7, 47, in_bitwise1, in_bitwise2, ref_or, 47);

static void test_arm_not_q7(
    const q7_t *input1, const q7_t *ref, size_t length)
{
    q7_t *output;
    ...
    /* Run test function */
    arm_not_q7(input1, output, length);
...
DEFINE_TEST_VARIANT3(arm_not_q7, 15, in_bitwise1, ref_not, 15);
DEFINE_TEST_VARIANT3(arm_not_q7, 32, in_bitwise1, ref_not, 32);
DEFINE_TEST_VARIANT3(arm_not_q7, 47, in_bitwise1, ref_not, 47);

static void test_arm_xor_q7(
    const q7_t *input1, const q7_t *input2, const q7_t *ref, size_t length)
{
    q7_t *output;
    ...
    /* Run test function */
    arm_xor_q7(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_xor_q7, 15, in_bitwise1, in_bitwise2, ref_xor, 15);
DEFINE_TEST_VARIANT4(arm_xor_q7, 32, in_bitwise1, in_bitwise2, ref_xor, 32);
DEFINE_TEST_VARIANT4(arm_xor_q7, 47, in_bitwise1, in_bitwise2, ref_xor, 47);
...
void test_basicmath_q7(void)
{
    ztest_test_suite(basicmath_q7,
        ...
        ztest_unit_test(test_arm_and_q7_15),
        ztest_unit_test(test_arm_and_q7_32),
        ztest_unit_test(test_arm_and_q7_47),
        ztest_unit_test(test_arm_or_q7_15),
        ztest_unit_test(test_arm_or_q7_32),
        ztest_unit_test(test_arm_or_q7_47),
        ztest_unit_test(test_arm_not_q7_15),
        ztest_unit_test(test_arm_not_q7_32),
        ztest_unit_test(test_arm_not_q7_47),
        ztest_unit_test(test_arm_xor_q7_15),
        ztest_unit_test(test_arm_xor_q7_32),
        ztest_unit_test(test_arm_xor_q7_47)
        );
