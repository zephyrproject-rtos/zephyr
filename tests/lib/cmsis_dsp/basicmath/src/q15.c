...
static void test_arm_add_q15(
    const q15_t *input1, const q15_t *input2, const q15_t *ref, size_t length)
{
    q15_t *output;
...
static void test_arm_dot_prod_q15(
    const q15_t *input1, const q15_t *input2, const q63_t *ref, size_t length)
{
    q63_t *output;
    ...
    const q15_t *input1, const q15_t *input2, const q15_t *ref, size_t length)
{
    ...
    /* Run test function */
    arm_and_q15(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_and_q15, 7, in_bitwise1, in_bitwise2, ref_and, 7);
DEFINE_TEST_VARIANT4(arm_and_q15, 16, in_bitwise1, in_bitwise2, ref_and, 16);
DEFINE_TEST_VARIANT4(arm_and_q15, 23, in_bitwise1, in_bitwise2, ref_and, 23);

static void test_arm_or_q15(
    const q15_t *input1, const q15_t *input2, const q15_t *ref, size_t length)
{
    q15_t *output;
    ...
    /* Run test function */
    arm_or_q15(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_or_q15, 7, in_bitwise1, in_bitwise2, ref_or, 7);
DEFINE_TEST_VARIANT4(arm_or_q15, 16, in_bitwise1, in_bitwise2, ref_or, 16);
DEFINE_TEST_VARIANT4(arm_or_q15, 23, in_bitwise1, in_bitwise2, ref_or, 23);

static void test_arm_not_q15(
    const q15_t *input1, const q15_t *ref, size_t length)
{
    q15_t *output;
    ...
    /* Run test function */
    arm_not_q15(input1, output, length);
...
DEFINE_TEST_VARIANT3(arm_not_q15, 7, in_bitwise1, ref_not, 7);
DEFINE_TEST_VARIANT3(arm_not_q15, 16, in_bitwise1, ref_not, 16);
DEFINE_TEST_VARIANT3(arm_not_q15, 23, in_bitwise1, ref_not, 23);

static void test_arm_xor_q15(
    const q15_t *input1, const q15_t *input2, const q15_t *ref, size_t length)
{
    q15_t *output;
    ...
    /* Run test function */
    arm_xor_q15(input1, input2, output, length);
...
DEFINE_TEST_VARIANT4(arm_xor_q15, 7, in_bitwise1, in_bitwise2, ref_xor, 7);
DEFINE_TEST_VARIANT4(arm_xor_q15, 16, in_bitwise1, in_bitwise2, ref_xor, 16);
DEFINE_TEST_VARIANT4(arm_xor_q15, 23, in_bitwise1, in_bitwise2, ref_xor, 23);
...
void test_basicmath_q15(void)
{
    ztest_test_suite(basicmath_q15,
        ...
        ztest_unit_test(test_arm_and_q15_7),
        ztest_unit_test(test_arm_and_q15_16),
        ztest_unit_test(test_arm_and_q15_23),
        ztest_unit_test(test_arm_or_q15_7),
        ztest_unit_test(test_arm_or_q15_16),
        ztest_unit_test(test_arm_or_q15_23),
        ztest_unit_test(test_arm_not_q15_7),
        ztest_unit_test(test_arm_not_q15_16),
        ztest_unit_test(test_arm_not_q15_23),
        ztest_unit_test(test_arm_xor_q15_7),
        ztest_unit_test(test_arm_xor_q15_16),
        ztest_unit_test(test_arm_xor_q15_23)
        );
