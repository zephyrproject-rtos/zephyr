...
#define REL_ERROR_THRESH    (2.0e-6)
    ...
    const uint32_t *input1, const uint32_t *ref, size_t length)
{
    ...
    /* Validate output */
    zassert_true(
        test_snr_error_f32(buf_length, output, (float32_t *)ref, SNR_ERROR_THRESH),
        ASSERT_MSG_SNR_LIMIT_EXCEED);

    zassert_true(
        test_rel_error_f32(buf_length, output, (float32_t *)ref, REL_ERROR_THRESH),
    ...
    const uint32_t *input1, const uint32_t *input2, const uint32_t *ref, size_t length)
{
    ...
    /* Validate output */
    zassert_true(
        test_snr_error_f32(2, output, (float32_t *)ref, SNR_ERROR_THRESH),
        ASSERT_MSG_SNR_LIMIT_EXCEED);

    zassert_true(
        test_rel_error_f32(2, output, (float32_t *)ref, REL_ERROR_THRESH),
        ASSERT_MSG_REL_ERROR_LIMIT_EXCEED);
    ...
    const uint32_t *input1, const uint32_t *ref, size_t length)
{
    ...
    /* Validate output */
    zassert_true(
        test_snr_error_f32(length, output, (float32_t *)ref, SNR_ERROR_THRESH),
        ASSERT_MSG_SNR_LIMIT_EXCEED);

    zassert_true(
        test_rel_error_f32(length, output, (float32_t *)ref, REL_ERROR_THRESH),
        ASSERT_MSG_REL_ERROR_LIMIT_EXCEED);
    ...
    const uint32_t *input1, const uint32_t *input2, const uint32_t *ref, size_t length)
{
    ...
    zassert_true(
        test_snr_error_f32(
            buf_length, output, (float32_t *)ref, SNR_ERROR_THRESH),
        ASSERT_MSG_SNR_LIMIT_EXCEED);

    zassert_true(
        test_rel_error_f32(
            buf_length, output, (float32_t *)ref, REL_ERROR_THRESH),
        ASSERT_MSG_REL_ERROR_LIMIT_EXCEED);
