...
#define ABS_ERROR_THRESH_Q15    ((q15_t)20)
    ...
    const q15_t *input1, const q15_t *ref, size_t length)
{
    ...
    zassert_true(
        test_near_equal_q15(buf_length, output, ref, ABS_ERROR_THRESH_Q15),
...
static void test_arm_cmplx_dot_prod_q15(
    const q15_t *input1, const q15_t *input2, const q31_t *ref, size_t length)
{
    q31_t *output;
