    ...
    for (index = 0; index < length; index++)
    {
        ...
        switch (op)
        {
            ...
            case OP_ROGERSTANIMOTO:
                val = arm_rogerstanimoto_distance(input1, input2, DIMS_VEC);
                break;
            case OP_RUSSELLRAO:
                val = arm_russellrao_distance(input1, input2, DIMS_VEC);
                break;
            case OP_SOKALMICHENER:
                val = arm_sokalmichener_distance(input1, input2, DIMS_VEC);
                break;
            case OP_SOKALSNEATH:
                val = arm_sokalsneath_distance(input1, input2, DIMS_VEC);
                break;
            case OP_YULE:
