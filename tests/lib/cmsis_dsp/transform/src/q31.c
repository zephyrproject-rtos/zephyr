...
DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_16, &arm_cfft_sR_q31_len16,
    in_cfft_noisy_16, ref_cfft_noisy_16, 32);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_32, &arm_cfft_sR_q31_len32,
    in_cfft_noisy_32, ref_cfft_noisy_32, 64);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_64, &arm_cfft_sR_q31_len64,
    in_cfft_noisy_64, ref_cfft_noisy_64, 128);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_128, &arm_cfft_sR_q31_len128,
    in_cfft_noisy_128, ref_cfft_noisy_128, 256);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_256, &arm_cfft_sR_q31_len256,
    in_cfft_noisy_256, ref_cfft_noisy_256, 512);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_512, &arm_cfft_sR_q31_len512,
    in_cfft_noisy_512, ref_cfft_noisy_512, 1024);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_1024, &arm_cfft_sR_q31_len1024,
    in_cfft_noisy_1024, ref_cfft_noisy_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_2048, &arm_cfft_sR_q31_len2048,
    in_cfft_noisy_2048, ref_cfft_noisy_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cfft_q31, noisy_4096, &arm_cfft_sR_q31_len4096,
    in_cfft_noisy_4096, ref_cfft_noisy_4096, 8192);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_16, &arm_cfft_sR_q31_len16,
    in_cfft_step_16, ref_cfft_step_16, 32);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_32, &arm_cfft_sR_q31_len32,
    in_cfft_step_32, ref_cfft_step_32, 64);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_64, &arm_cfft_sR_q31_len64,
    in_cfft_step_64, ref_cfft_step_64, 128);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_128, &arm_cfft_sR_q31_len128,
    in_cfft_step_128, ref_cfft_step_128, 256);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_256, &arm_cfft_sR_q31_len256,
    in_cfft_step_256, ref_cfft_step_256, 512);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_512, &arm_cfft_sR_q31_len512,
    in_cfft_step_512, ref_cfft_step_512, 1024);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_1024, &arm_cfft_sR_q31_len1024,
    in_cfft_step_1024, ref_cfft_step_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_2048, &arm_cfft_sR_q31_len2048,
    in_cfft_step_2048, ref_cfft_step_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cfft_q31, step_4096, &arm_cfft_sR_q31_len4096,
    in_cfft_step_4096, ref_cfft_step_4096, 8192);

static void test_arm_cifft_q31(
    const arm_cfft_instance_q31 *inst, int scale_factor,
    const q31_t *input, const q31_t *ref, size_t length)
{
    size_t index;
    ...
    /* Validate output */
    zassert_true(
        test_snr_error_q31(length, output, scaled_ref, SNR_ERROR_THRESH),
        ASSERT_MSG_SNR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_16, &arm_cfft_sR_q31_len16, 4,
    in_cifft_noisy_16, in_cfft_noisy_16, 32);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_32, &arm_cfft_sR_q31_len32, 5,
    in_cifft_noisy_32, in_cfft_noisy_32, 64);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_64, &arm_cfft_sR_q31_len64, 6,
    in_cifft_noisy_64, in_cfft_noisy_64, 128);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_128, &arm_cfft_sR_q31_len128, 7,
    in_cifft_noisy_128, in_cfft_noisy_128, 256);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_256, &arm_cfft_sR_q31_len256, 8,
    in_cifft_noisy_256, in_cfft_noisy_256, 512);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_512, &arm_cfft_sR_q31_len512, 9,
    in_cifft_noisy_512, in_cfft_noisy_512, 1024);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_1024, &arm_cfft_sR_q31_len1024, 10,
    in_cifft_noisy_1024, in_cfft_noisy_1024, 2048);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_2048, &arm_cfft_sR_q31_len2048, 11,
    in_cifft_noisy_2048, in_cfft_noisy_2048, 4096);

DEFINE_TEST_VARIANT5(arm_cifft_q31, noisy_4096, &arm_cfft_sR_q31_len4096, 12,
    in_cifft_noisy_4096, in_cfft_noisy_4096, 8192);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_16, &arm_cfft_sR_q31_len16, 4,
    in_cifft_step_16, in_cfft_step_16, 32);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_32, &arm_cfft_sR_q31_len32, 5,
    in_cifft_step_32, in_cfft_step_32, 64);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_64, &arm_cfft_sR_q31_len64, 6,
    in_cifft_step_64, in_cfft_step_64, 128);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_128, &arm_cfft_sR_q31_len128, 7,
    in_cifft_step_128, in_cfft_step_128, 256);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_256, &arm_cfft_sR_q31_len256, 8,
    in_cifft_step_256, in_cfft_step_256, 512);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_512, &arm_cfft_sR_q31_len512, 9,
    in_cifft_step_512, in_cfft_step_512, 1024);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_1024, &arm_cfft_sR_q31_len1024, 10,
    in_cifft_step_1024, in_cfft_step_1024, 2048);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_2048, &arm_cfft_sR_q31_len2048, 11,
    in_cifft_step_2048, in_cfft_step_2048, 4096);

DEFINE_TEST_VARIANT5(arm_cifft_q31, step_4096, &arm_cfft_sR_q31_len4096, 12,
    in_cifft_step_4096, in_cfft_step_4096, 8192);

void test_transform_q31(void)
{
    ztest_test_suite(transform_q31,
    ...
    ztest_run_test_suite(transform_q31);
}
