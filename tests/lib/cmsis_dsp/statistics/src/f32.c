...
static void test_arm_entropy_f32(void)
{
    ...
    {
        output[index] = arm_entropy_f32(input, in_entropy_dim[index + 1]);
...
static void test_arm_logsumexp_f32(void)
{
    ...
    for (index = 0; index < length; index++)
    {
        output[index] = arm_logsumexp_f32(input, in_logsumexp_dim[index + 1]);
...
static void test_arm_kullback_leibler_f32(void)
{
    ...
    for (index = 0; index < length; index++)
    {
        output[index] = arm_kullback_leibler_f32(
