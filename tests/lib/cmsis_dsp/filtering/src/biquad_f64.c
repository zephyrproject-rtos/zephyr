...
static void test_arm_biquad_cascade_df2t_f64_default(void)
{
    ...
    /* Initialise instance */
    /* FIXME: ARM-software/CMSIS_5#784 */
    arm_biquad_cascade_df2T_init_f64(&inst, 3, (float64_t *)coeff, state);
    ...
    {
        /* Run test function */
        /* FIXME: ARM-software/CMSIS_5#785 */
        arm_biquad_cascade_df2T_f64(
            &inst, (float64_t *)input, output, block_size);
...
static void test_arm_biquad_cascade_df2t_f64_rand(void)
{
    ...
    for (sample_index = 0; sample_index < sample_count; sample_index++)
    {
        ...
        arm_biquad_cascade_df2T_init_f64(
            &inst, stage_count, (float64_t *)coeff, state);
