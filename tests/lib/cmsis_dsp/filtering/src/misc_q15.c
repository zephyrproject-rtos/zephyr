...
static void test_arm_correlate_q15(
    size_t in1_length, size_t in2_length, const q15_t *ref, size_t ref_length)
{
    q15_t *output;
    ...
    zassert_true(
        test_near_equal_q15(ref_length, ref, output, ABS_ERROR_THRESH_Q15),
...
#define DEFINE_CORRELATE_TEST(a, b) \
    DEFINE_TEST_VARIANT4(arm_correlate_q15, a##_##b, \
...
#define DEFINE_CONV_TEST(a, b) \
    DEFINE_TEST_VARIANT4(arm_conv_q15, a##_##b, \
