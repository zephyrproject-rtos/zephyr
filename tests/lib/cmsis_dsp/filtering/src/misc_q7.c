...
static void test_arm_correlate_q7(
    size_t in1_length, size_t in2_length, const q7_t *ref, size_t ref_length)
{
    q7_t *output;
    ...
    zassert_true(
        test_near_equal_q7(ref_length, ref, output, ABS_ERROR_THRESH_Q7),
...
#define DEFINE_CORRELATE_TEST(a, b) \
    DEFINE_TEST_VARIANT4(arm_correlate_q7, a##_##b, \
...
#define DEFINE_CONV_TEST(a, b) \
    DEFINE_TEST_VARIANT4(arm_conv_q7, a##_##b, \
