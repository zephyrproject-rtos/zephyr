...
DEFINE_TEST_VARIANT3(op2, arm_mat_add_q31, OP2_ADD, ref_add, ARRAY_SIZE(ref_add));
DEFINE_TEST_VARIANT3(op2, arm_mat_sub_q31, OP2_SUB, ref_sub, ARRAY_SIZE(ref_sub));
