...
DEFINE_TEST_VARIANT3(matrix_unary_q15,
	op2, arm_mat_add_q15, OP2_ADD,
	ref_add, ARRAY_SIZE(ref_add));
DEFINE_TEST_VARIANT3(matrix_unary_q15,
	op2, arm_mat_sub_q15, OP2_SUB,
...
DEFINE_TEST_VARIANT4(matrix_unary_q15,
	op1, arm_mat_scale_q15, OP1_SCALE,
	ref_scale, ARRAY_SIZE(ref_scale), false);
DEFINE_TEST_VARIANT4(matrix_unary_q15,
	op1, arm_mat_trans_q15, OP1_TRANS,
...
DEFINE_TEST_VARIANT3(matrix_unary_q15,
	op2v, arm_mat_vec_mult_q15, OP2V_VEC_MULT,
...
DEFINE_TEST_VARIANT4(matrix_unary_q15,
	op1c, arm_mat_cmplx_trans_q15, OP1C_CMPLX_TRANS,
	ref_cmplx_trans, ARRAY_SIZE(ref_cmplx_trans) / 2, true);

ZTEST_SUITE(matrix_unary_q15, NULL, NULL, NULL, NULL, NULL);
