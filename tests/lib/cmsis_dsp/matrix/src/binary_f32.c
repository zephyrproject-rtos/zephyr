    ...
    const uint32_t *ref, size_t length)
{
    ...
    for (index = 0; index < NUM_MATRICES; index++)
    {
        ...
        /* Load matrix data */
        memcpy(mat_in1.pData, input1, rows * internal * sizeof(float32_t));
        memcpy(mat_in2.pData, input2, internal * columns * sizeof(float32_t));
    ...
    const uint32_t *ref, size_t length)
{
    ...
    for (index = 0; index < NUM_MATRICES; index++)
    {
        ...
        /* Load matrix data */
        memcpy(mat_in1.pData, input1, 2 * rows * internal * sizeof(float32_t));
        memcpy(mat_in2.pData, input2, 2 * internal * columns * sizeof(float32_t));
