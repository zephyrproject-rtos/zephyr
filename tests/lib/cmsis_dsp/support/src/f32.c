...
/* FIXME: Remove this once the merge and quick sort issues are resolved */
...
DEFINE_TEST_VARIANT5(arm_sort_out, merge_11,
    in_sort, ref_sort, 11,
    ARM_SORT_MERGE, ARM_SORT_ASCENDING);
...
DEFINE_TEST_VARIANT5(arm_sort_const, merge_16,
    in_sort_const, ref_sort_const, 16,
    ARM_SORT_MERGE, ARM_SORT_ASCENDING);
...
static void test_arm_spline(
    const uint32_t *input_x, const uint32_t *input_y, const uint32_t *input_xq,
    const uint32_t *ref, size_t length, uint32_t n, arm_spline_type type)
{
    float32_t *output;
    ...
    /* Initialise spline */
    arm_spline_init_f32(&inst, n, type);

    /* Run test function */
    arm_spline_f32(&inst, (float32_t *)input_x, (float32_t *)input_y,
        (float32_t *)input_xq, output, length);
...
void test_support_f32(void)
{
    ztest_test_suite(support_f32,
        ...
        /* FIXME: Merge sort algorithm faults */
        /*
        ztest_unit_test(test_arm_sort_out_merge_11),
        ztest_unit_test(test_arm_sort_const_merge_16),
        */
        /* FIXME: Quick sort algorithm hangs */
        /*
