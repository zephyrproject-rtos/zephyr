...
ZTEST_P(bit_rev, test_sys_bit_rev32)
{
	...
	actual = sys_bit_rev32(tc->input);
	zexpect_equal(actual, tc->expected, "Unexpected 32-bit reversal for 0x%08x: got 0x%08x, "
		      "expected 0x%08x", tc->input, actual, tc->expected);

	actual = sys_bit_rev32(tc->expected);
	zexpect_equal(actual, tc->input, "32-bit reversal should be symmetric for 0x%08x: "
		      "reversing 0x%08x gave 0x%08x", tc->input, tc->expected, actual);
}
...
ZTEST_P(bit_rev, test_sys_bit_rev16)
{
	...
	actual = sys_bit_rev16(tc->input);
	zexpect_equal(actual, tc->expected, "Unexpected 16-bit reversal for 0x%04x: got 0x%04x, "
		      "expected 0x%04x", tc->input, actual, tc->expected);

	actual = sys_bit_rev16(tc->expected);
	zexpect_equal(actual, tc->input, "16-bit reversal should be symmetric for 0x%04x: "
		      "reversing 0x%04x gave 0x%04x", tc->input, tc->expected, actual);
}
...
ZTEST_P(bit_rev, test_sys_bit_rev8)
{
	...
	actual = sys_bit_rev8(tc->input);
	zexpect_equal(actual, tc->expected, "Unexpected 8-bit reversal for 0x%02x: got 0x%02x, "
		      "expected 0x%02x", tc->input, actual, tc->expected);

	actual = sys_bit_rev8(tc->expected);
	zexpect_equal(actual, tc->input, "8-bit reversal should be symmetric for 0x%02x: "
		      "reversing 0x%02x gave 0x%02x", tc->input, tc->expected, actual);
}
