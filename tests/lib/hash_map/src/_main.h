...
#define INSERT_FUNC(map, key, value, old_value, old_key) (INSERT_FUNC_NAME(map, GET_KEY(key), value, old_value, old_key))
#define CONTAINS_KEY_FUNC(map, key) (CONTAINS_KEY_FUNC_NAME(map, GET_KEY(key)))
#define REMOVE_FUNC(map, key, old_value, old_key) (REMOVE_FUNC_NAME(map, GET_KEY(key), old_value, old_key))
