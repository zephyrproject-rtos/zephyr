...
void dns_query_invalid_timeout(void)
{
	int ret;
...
void dns_query_invalid_context(void)
{
	int ret;
...
void dns_query_invalid_callback(void)
{
	int ret;
...
void dns_query_invalid_query(void)
{
	int ret;
...
void dns_query_server_count(void)
{
...
void dns_query_ipv4_server_count(void)
{
	struct dns_resolve_context *ctx = dns_resolve_get_default();
...
void dns_query_ipv6_server_count(void)
{
	struct dns_resolve_context *ctx = dns_resolve_get_default();
	int i, count = 0, port = 0;
...
void dns_query_ipv4_timeout(void)
{
	int expected_status = DNS_EAI_CANCELED;
	int ret;
...
void dns_query_ipv6_timeout(void)
{
	int expected_status = DNS_EAI_CANCELED;
	int ret;
...
void dns_query_ipv4_cancel(void)
{
	int expected_status = DNS_EAI_CANCELED;
	u16_t dns_id;
	int ret;
...
void dns_query_ipv6_cancel(void)
{
	int expected_status = DNS_EAI_CANCELED;
	u16_t dns_id;
	int ret;
