...
static int msg_sendto(struct mqtt_sn_client *client, void *buf, size_t sz,
...
static ssize_t tp_recvfrom(struct mqtt_sn_client *client, void *buffer,
			   size_t length, void *src_addr, size_t *addrlen)
{
...
{
	static uint8_t advertise[] = {5, 0x00, 0x0c, 0, 3};
	static uint8_t connack[] = {3, 0x05, 0x00};
	int err;
