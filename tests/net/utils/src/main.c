...
ZTEST_USER(net_utils_fn, test_net_addr)
{
	int count, pass;
...
ZTEST(net_utils_fn, test_addr_parse)
{
...
ZTEST(net_utils_fn, test_ip_checksum)
{
	uint16_t sum_got;
	uint16_t sum_exp;
...
ZTEST_SUITE(net_utils_fn, NULL, NULL, NULL, NULL, NULL);
