...
static struct net_6lo_data test_data_1 = {
	...
	.ipv6.src = src_sam00,
	.ipv6.dst = dst_dam00,
	.nh.udp.src_port = net_htons(udp_src_port_4bit),
	.nh.udp.dst_port = net_htons(udp_dst_port_4bit),
	.nh.udp.len = 0x00,
	.nh.udp.chksum = 0x00,
...
static struct net_6lo_data test_data_2 = {
	...
	.ipv6.src = src_sam01,
	.ipv6.dst = dst_dam01,
	.nh.udp.src_port = net_htons(udp_src_port_8bit_y),
	.nh.udp.dst_port = net_htons(udp_dst_port_8bit),
	.nh.udp.len = 0x00,
	.nh.udp.chksum = 0x00,
	.hdr_diff = NET_IPV6UDPH_LEN - IPHC_SIZE - NHC_SIZE -
...
static struct net_6lo_data test_data_3 = {
	...
	.ipv6.src = src_sam10,
	.ipv6.dst = dst_dam10,
	.nh.udp.src_port = net_htons(udp_src_port_8bit),
	.nh.udp.dst_port = net_htons(udp_dst_port_8bit_y),
	.nh.udp.len = 0x00,
	.nh.udp.chksum = 0x00,
	.hdr_diff = NET_IPV6UDPH_LEN - IPHC_SIZE - NHC_SIZE -
...
static struct net_6lo_data test_data_4 = {
	...
	.nh.udp.src_port = net_htons(udp_src_port_16bit),
	.nh.udp.dst_port = net_htons(udp_dst_port_16bit),
	.nh.udp.len = 0x00,
	.nh.udp.chksum = 0x00,
	.hdr_diff = NET_IPV6UDPH_LEN - IPHC_SIZE - NHC_SIZE -
...
static struct net_6lo_data test_data_8 = {
	...
	.ipv6.flow = 0x0,
	.ipv6.len = 0,
	.ipv6.nexthdr = NET_IPPROTO_ICMPV6,
	.ipv6.hop_limit = 0xff,
	.ipv6.src = src_sam10,
	.ipv6.dst = dst_m1_dam10,
