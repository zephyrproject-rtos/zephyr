...
void test_ipv6_multi_frags(void)
{
	struct net_pkt *pkt;
	struct net_buf *frag;
...
void test_pkt_read_append(void)
{
...
void test_pkt_read_write_insert(void)
{
...
void test_fragment_compact(void)
{
	struct net_pkt *pkt;
