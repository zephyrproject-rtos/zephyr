...
on another network is refused, once; that a released address can be handed out
again; that a declined address is not handed out again; and that an Inform is
answered without an address or a lease.
