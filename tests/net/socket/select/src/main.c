...
ZTEST_USER(socket_select_test_suite, test_fd_set)
{
	fd_set set;
...
ZTEST_USER(socket_select_test_suite, test_select)
{
	int res;
	int c_sock;
	int s_sock;
...
ZTEST_SUITE(socket_select_test_suite, NULL, setup, NULL, NULL, NULL);
