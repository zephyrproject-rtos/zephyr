...
ZTEST(socket_getnameinfo_test_suite, test_getnameinfo_ipv4)
{
...
ZTEST(socket_getnameinfo_test_suite, test_getnameinfo_ipv6)
{
...
ZTEST_SUITE(socket_getnameinfo_test_suite, NULL, NULL, NULL, NULL, NULL);
