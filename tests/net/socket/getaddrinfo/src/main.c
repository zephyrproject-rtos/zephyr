...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_ok)
{
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_cancelled)
{
	struct addrinfo *res = NULL;
	int ret;
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_no_host)
{
	struct addrinfo *res = NULL;
	int ret;
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_num_ipv4)
{
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_num_ipv6)
{
	struct zsock_addrinfo *res = NULL;
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_flags_numerichost)
{
	int ret;
	struct zsock_addrinfo *res = NULL;
	struct zsock_addrinfo hints = {
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_ipv4_hints_ipv6)
{
	struct zsock_addrinfo *res = NULL;
	struct zsock_addrinfo hints = {
		.ai_family = AF_INET6,
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_ipv6_hints_ipv4)
{
	struct zsock_addrinfo *res = NULL;
	struct zsock_addrinfo hints = {
		.ai_family = AF_INET,
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_port_invalid)
{
	int ret;
	struct zsock_addrinfo *res = NULL;
...
ZTEST(socket_getaddrinfo_test_suite, test_getaddrinfo_null_host)
{
	struct sockaddr_in *saddr;
...
ZTEST_SUITE(socket_getaddrinfo_test_suite, NULL, test_getaddrinfo_setup, NULL, NULL, NULL);
