...
ZTEST(socket_net_mgmt_test_suite, test_net_mgmt_catch_kernel)
{
	test_net_mgmt_catch_events();
}

ZTEST(socket_net_mgmt_test_suite, test_net_mgmt_catch_user)
{
	test_net_mgmt_catch_events();
}

ZTEST(socket_net_mgmt_test_suite, test_net_mgmt_cleanup)
{
...
ZTEST(socket_net_mgmt_test_suite, test_ethernet_set_qav_kernel)
{
	test_ethernet_set_qav();
}

ZTEST(socket_net_mgmt_test_suite, test_ethernet_set_qav_user)
{
	test_ethernet_set_qav();
}
...
ZTEST(socket_net_mgmt_test_suite, test_ethernet_get_qav_kernel)
{
	test_ethernet_get_qav();
}

ZTEST(socket_net_mgmt_test_suite, test_ethernet_get_qav_user)
{
	test_ethernet_get_qav();
}
...
ZTEST(socket_net_mgmt_test_suite, test_ethernet_get_unknown_opt_kernel)
{
	test_ethernet_get_unknown_option();
}

ZTEST(socket_net_mgmt_test_suite, test_ethernet_get_unknown_opt_user)
{
	test_ethernet_get_unknown_option();
}
...
ZTEST(socket_net_mgmt_test_suite, test_ethernet_set_unknown_opt_kernel)
{
	test_ethernet_set_unknown_option();
}

ZTEST(socket_net_mgmt_test_suite, test_ethernet_set_unknown_opt_user)
{
	test_ethernet_set_unknown_option();
}
...
ZTEST_SUITE(socket_net_mgmt_test_suite, NULL, setup, NULL, NULL, NULL);
