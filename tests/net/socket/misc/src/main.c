...
ZTEST(socket_misc_test_suite, test_gethostname)
{
...
ZTEST(socket_misc_test_suite, test_inet_pton)
{
	int res;
	uint8_t buf[32];
...
ZTEST(socket_misc_test_suite, test_ipv4)
{
	test_ipv4_so_bindtodevice();
	test_ipv4_getpeername();
}

ZTEST(socket_misc_test_suite, test_ipv6)
{
