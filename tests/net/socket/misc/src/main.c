...
ZTEST_USER(net_socket_misc, test_gethostname)
{
...
ZTEST_USER(net_socket_misc, test_inet_pton)
{
	int res;
	uint8_t buf[32];
...
ZTEST_USER(net_socket_misc, test_ipv4)
{
	test_ipv4_so_bindtodevice();
	test_ipv4_getpeername();
}

ZTEST_USER(net_socket_misc, test_ipv6)
{
	test_ipv6_so_bindtodevice();
	test_ipv6_getpeername();
}

ZTEST_SUITE(net_socket_misc, NULL, setup, NULL, NULL, NULL);
