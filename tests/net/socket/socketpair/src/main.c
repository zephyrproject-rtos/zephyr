...
#ifndef TEST_IN_USERSPACE
ZTEST(socketpair_test_suite, test_soketpair)
{
	test_socketpair_poll_delayed_data();
	test_socketpair_poll_close_remote_end_POLLIN();
	test_socketpair_poll_close_remote_end_POLLOUT();
	test_socketpair_poll_signalling_POLLIN();
	test_socketpair_poll_signalling_POLLOUT();
}
#endif

#ifdef TEST_IN_USERSPACE
ZTEST_USER(socketpair_test_suite, test_soketpair_user)
{
	test_socketpair_AF_LOCAL__SOCK_STREAM__0();
	test_socketpair_AF_UNIX__SOCK_STREAM__0();
	test_socketpair_expected_failures();
	test_socketpair_unsupported_calls();
	test_socketpair_fcntl();
	test_socketpair_read_nonblock();
	test_socketpair_write_nonblock();
	test_socketpair_read_block();
	test_socketpair_write_block();
	test_socketpair_close_one_end_and_read_from_the_other();
	test_socketpair_close_one_end_and_write_to_the_other();
	test_socketpair_poll_timeout();
	test_socketpair_poll_timeout_nonblocking();
	test_socketpair_poll_immediate_data();

}
#endif
ZTEST_SUITE(socketpair_test_suite, NULL, NULL, NULL, NULL, NULL);
