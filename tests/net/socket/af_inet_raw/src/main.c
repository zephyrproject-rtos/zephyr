...
static void test_raw_sock_send(sa_family_t family)
{
...
ZTEST(socket_af_inet_raw, test_raw_v4_sock_send)
{
	test_raw_sock_send(AF_INET);
}

ZTEST(socket_af_inet_raw, test_raw_v6_sock_send)
{
