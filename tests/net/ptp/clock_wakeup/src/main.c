...
static int fake_precision_clock_ptp_init(struct precision_clock_ptp_adapter *adapter,
...
fake_precision_clock_ptp_get(const struct precision_clock_ptp_adapter *adapter)
{
...
#define precision_clock_ptp_init    fake_precision_clock_ptp_init
#define precision_clock_ptp_get     fake_precision_clock_ptp_get
...
#undef precision_clock_ptp_get
#undef precision_clock_ptp_init
...
ZTEST(ptp_clock_wakeup, test_pi_servo_uses_configured_gains)
{
	...
	zassert_equal(ptp_clk.sync_discipline.config.kp_num, CONFIG_PRECISION_TIMING_PI_KP,
		      "proportional gain should come from Kconfig");
	zassert_equal(ptp_clk.sync_discipline.config.ki_num, CONFIG_PRECISION_TIMING_PI_KI,
