...
ETH_NET_DEVICE_INSTANCE(eth_fake1, eth_fake_init, NULL,
		    &eth_fake_data1, NULL, &eth_fake_api_funcs, NET_ETH_MTU);

ETH_NET_DEVICE_INSTANCE(eth_fake2, eth_fake_init, NULL,
		    &eth_fake_data2, NULL, &eth_fake_api_funcs, NET_ETH_MTU);
