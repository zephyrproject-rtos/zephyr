...
extern uint8_t fifo_popped_data[DATA_LEN];
extern uint8_t lifo_pushed_data[DATA_LEN];
extern uint8_t lifo_popped_data[DATA_LEN];
extern uint8_t stack_pushed_data[DATA_LEN];
extern uint8_t stack_popped_data[DATA_LEN];
extern uint8_t ring_buffer_pushed_data[DATA_LEN];
extern uint8_t ring_buffer_popped_data[DATA_LEN];
