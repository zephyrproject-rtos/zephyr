...
#elif defined(CONFIG_LOG_MODE_IMMEDIATE) && defined(CONFIG_NO_OPTIMIZATIONS)
#define SIMPLE_USAGE 1520
#define HEXDUMP_USAGE 1504
#define MORE_ARGS_USAGE 1584
#endif
...
#define MORE_ARGS_USAGE 672
#elif !defined(CONFIG_LOG_MODE_IMMEDIATE) && defined(CONFIG_NO_OPTIMIZATIONS)
#define SIMPLE_USAGE 240
#define HEXDUMP_USAGE 240
#define MORE_ARGS_USAGE 240
#elif defined(CONFIG_LOG_MODE_IMMEDIATE) && defined(CONFIG_NO_OPTIMIZATIONS)
#define SIMPLE_USAGE 1072
#define HEXDUMP_USAGE 1072
#define MORE_ARGS_USAGE 1104
#endif
