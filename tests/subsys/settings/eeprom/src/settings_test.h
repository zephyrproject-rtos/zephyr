...
#ifndef _SETTINGS_TEST_EEPROM_H
#define _SETTINGS_TEST_EEPROM_H
...
#define SETTINGS_TEST_VAL_STR_CNT   64
#define SETTINGS_TEST_FLASH_CNT   4
...
extern char val_string[SETTINGS_TEST_VAL_STR_CNT][SETTINGS_MAX_VAL_LEN];
extern char test_ref_value[SETTINGS_TEST_VAL_STR_CNT][SETTINGS_MAX_VAL_LEN];
