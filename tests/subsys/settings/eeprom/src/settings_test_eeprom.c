...
char val_string[SETTINGS_TEST_VAL_STR_CNT][SETTINGS_MAX_VAL_LEN];
char test_ref_value[SETTINGS_TEST_VAL_STR_CNT][SETTINGS_MAX_VAL_LEN];
...
void test_main(void)
{
	ztest_test_suite(test_config_eeprom,
			 /* Config tests */
	...
	ztest_run_test_suite(test_config_eeprom);
}
