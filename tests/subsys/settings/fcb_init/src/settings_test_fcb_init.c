...
/* leverage that this area has to be embedded flash part */
	...
	DT_NODE_HAS_PROP(DT_MEM_FROM_FIXED_PARTITION(CODE_PARTITION_NODE), write_block_size)
#define FLASH_WRITE_BLOCK_SIZE \
	DT_PROP(DT_MEM_FROM_FIXED_PARTITION(CODE_PARTITION_NODE), write_block_size)
