...
USBD_DESC_MANUFACTURER_DEFINE(test_mfg, "ZEPHYR");
USBD_DESC_PRODUCT_DEFINE(test_product, "Zephyr USB Test");
USBD_DESC_STRING_RAM_DEFINE(test_sn, "0123456789ABCDEF", USBD_DUT_STRING_SERIAL_NUMBER);
