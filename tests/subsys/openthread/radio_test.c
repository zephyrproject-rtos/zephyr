...
static int rssi_scan_mock(const struct device *dev, u16_t duration,
			  energy_scan_done_cb_t done_cb)
{
	zassert_equal(dev, &radio, "Device handle incorrect.");
