...
/* Builds an 8-byte J1939 NAME array using the same bit layout as
 * j1939_ac_name_config_to_byte_array, so a synthetic "foreign" address-claim frame can be
 * injected without a second J1939_NODE_DEFINE.
 */
