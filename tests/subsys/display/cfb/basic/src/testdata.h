...
extern uint32_t kerning_3_2tofu1016[];
extern uint32_t kerning_3_rightclip_1_2rectspace1016[];
extern uint32_t kerning_3_rightclip_1_2tofu1016[];
extern uint32_t outside_bottom_left[];
extern uint32_t outside_bottom_left_tofu1016[];
extern uint32_t outside_bottom_right[];
extern uint32_t outside_bottom_right_tofu1016[];
extern uint32_t outside_top_left[];
extern uint32_t outside_top_left_tofu1016[];
extern uint32_t outside_top_right[];
extern uint32_t outside_top_right_tofu1016[];
