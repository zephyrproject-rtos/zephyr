...
#if DT_REG_ADDR(DT_PARENT(SLOT1_PARTITION_NODE))
	/* Sub-partition handling */
	zassert_equal(FIXED_PARTITION_NODE_OFFSET(SLOT1_PARTITION_NODE),
		(DT_REG_ADDR(SLOT1_PARTITION_NODE) - DT_REG_ADDR(DT_PARENT(SLOT1_PARTITION_NODE))));
#else
	/* Partition handling */
	zassert_equal(FIXED_PARTITION_NODE_OFFSET(SLOT1_PARTITION_NODE),
		(DT_REG_ADDR(SLOT1_PARTITION_NODE) - DT_REG_ADDR(DT_PARENT(
								DT_PARENT(SLOT1_PARTITION_NODE)))));
#endif
