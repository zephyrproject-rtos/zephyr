...
ZTEST(modem_chat, test_runtime_script_chat)
{
	...
	ret = modem_chat_script_chat_set_matches(&test_script_chat, test_response_matches,
	...
	ret = modem_chat_script_chat_set_matches(&test_script_chat, test_response_matches, 0);
	zassert_equal(ret, -EINVAL, "Should have failed to set response matches");

	ret = modem_chat_script_chat_set_matches(&test_script_chat, NULL, 1);
	zassert_equal(ret, -EINVAL, "Should have failed to set response matches");
}
...
ZTEST(modem_chat, test_runtime_script)
{
	...
	ret = modem_chat_script_set_chats(&test_script, test_script_chats,
	...
	ret = modem_chat_script_set_chats(&test_script, test_script_chats, 0);
	zassert_equal(ret, -EINVAL, "Should have failed to set script chats");

	ret = modem_chat_script_set_chats(&test_script, NULL, 1);
	zassert_equal(ret, -EINVAL, "Should have failed to set script chats");

	ret = modem_chat_script_set_matches(&test_script, test_abort_matches,
	...
	ret = modem_chat_script_set_matches(&test_script, test_abort_matches, 0);
	zassert_equal(ret, -EINVAL, "Should have failed to set abort matches");

	ret = modem_chat_script_set_matches(&test_script, NULL, 1);
	zassert_equal(ret, -EINVAL, "Should have failed to set abort matches");
}
