...
ZBUS_PROXY_ADD_CHAN(PROXY_NODE, test_channel_1);
ZBUS_PROXY_ADD_CHAN(PROXY_NODE, test_channel_2);
ZBUS_SHADOW_CHAN_DEFINE(test_shadow_channel_1, uint32_t, PROXY_NODE, NULL, ZBUS_OBSERVERS_EMPTY,
			   ZBUS_MSG_INIT(0));
ZBUS_SHADOW_CHAN_DEFINE(test_shadow_channel_2, uint32_t, PROXY_NODE, NULL, ZBUS_OBSERVERS_EMPTY,
			   ZBUS_MSG_INIT(0));
