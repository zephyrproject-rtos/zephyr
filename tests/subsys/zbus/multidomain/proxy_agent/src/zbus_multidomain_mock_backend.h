...
#define _ZBUS_GENERATE_BACKEND_CONFIG_ZBUS_MULTIDOMAIN_TYPE_MOCK(_name, _nodelabel)                \
	static struct zbus_multidomain_mock_config _name##_backend_config = {.nodelabel =          \
										     _nodelabel};
