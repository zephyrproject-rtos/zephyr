 ...
 */
_ZBUS_GENERATE_BACKEND_CONFIG_ZBUS_MULTIDOMAIN_TYPE_IPC(test_agent, fake_ipc);
...
ZTEST(ipc_backend, test_backend_recv)
{
	...
	k_sleep(K_MSEC(1)); /* Ensure works finish */
...
ZTEST(ipc_backend, test_backend_invalid_message)
{
	...
	struct zbus_proxy_agent_msg invalid_msg = {.type = 99, .id = 743};
