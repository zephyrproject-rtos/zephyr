...
PM_EVENT_DEVICE_DT_DEFINE(TEST_EVENT_DEVICE_0, test_event_domain_event_device_request);
...
PM_EVENT_DEVICE_DT_DEFINE(TEST_EVENT_DEVICE_1, test_event_domain_event_device_request);
