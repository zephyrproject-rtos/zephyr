...
ZTEST_USER(riscv_pmp_memattr_entries, test_pmp_change_perm_invalid_permission)
{
...
ZTEST_USER(riscv_pmp_memattr_entries, test_pmp_change_perm_invalid_region_index)
{
...
ZTEST_USER(riscv_pmp_memattr_entries, test_successful_permission_change)
{
