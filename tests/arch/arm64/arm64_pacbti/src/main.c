 ...
 */
static bool demo_mode;	/* Flag to control payload behavior */
...
ZTEST(arm64_pacbti, test_pac_authentication_failure)
{
	assert_pac_support();
...
ZTEST(arm64_pacbti, test_pac_attack_demonstration)
{
...
ZTEST(arm64_pacbti, test_bti_violation_detection)
{
	int ret;
