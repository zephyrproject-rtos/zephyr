...
{
	zassert_true(IS_ALIGNED((uintptr_t)__dcacheline_exclusive_noinit_start,
				CONFIG_DCACHE_LINE_SIZE));
	zassert_true(
		IS_ALIGNED((uintptr_t)__dcacheline_exclusive_noinit_end, CONFIG_DCACHE_LINE_SIZE));

	zassert_between_inclusive((uintptr_t)__dcacheline_exclusive_noinit_start,
				  (uintptr_t)__noinit_start, (uintptr_t)__noinit_end);

	zassert_true((uintptr_t)__dcacheline_exclusive_noinit_end >
...
{
	zassert_true(
		IS_ALIGNED((uintptr_t)__dcacheline_exclusive_data_start, CONFIG_DCACHE_LINE_SIZE));
	zassert_true(
		IS_ALIGNED((uintptr_t)__dcacheline_exclusive_data_end, CONFIG_DCACHE_LINE_SIZE));

#ifdef CONFIG_XIP
	zassert_between_inclusive((uintptr_t)__dcacheline_exclusive_data_start,
				  (uintptr_t)__data_region_start, (uintptr_t)__data_region_end);
#endif

	zassert_true((uintptr_t)__dcacheline_exclusive_data_end >
