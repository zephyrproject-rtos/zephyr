...
ZTEST(test_kconfig_functions, test_dt_partition_mtd)
{
	...
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000_0, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000_800, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000_800_0,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000_800_400,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_1000_1000,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000_0, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000_800, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000_800_0,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000_800_400,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_3000_1000,
		CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_DUMMY_4000, CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH);

	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_0, CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000_0,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000_800,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000_800_0,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000_800_400,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_1000_1000,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);
	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_RANGE_4000,
		CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH);

	zassert_true(strcmp(CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH,
			    CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH) != 0,
	      "CONFIG_KCONFIG_DT_DUMMY_FLASH_PATH equal to CONFIG_KCONFIG_DT_MTD_RANGE_FLASH_PATH");

	zassert_str_equal(CONFIG_KCONFIG_DT_MTD_INVALID_NODE, "");
}
