 ...
 *  As a NULL is passed to bt_id_reset() for the address and 'BT_DEV_READY' is set,
 ...
 *  isn't in the ID list. As a NULL is passed to bt_id_reset() for the address and 'BT_DEV_READY'
 ...
 *  the address and 'BT_DEV_READY' is set.
