...
void helper_pdu_verify_length_req(const char *file, uint32_t line, struct pdu_data *pdu, void *param)
{
	...
	zassert_equal(pdu->llctrl.length_req.max_rx_octets, p->max_rx_octets, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_req.max_tx_octets, p->max_tx_octets, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_req.max_rx_time, p->max_rx_time, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_req.max_tx_time, p->max_tx_time, "Error code mismatch.\nCalled at %s:%d\n", file, line);
}
...
void helper_pdu_verify_length_rsp(const char *file, uint32_t line, struct pdu_data *pdu, void *param)
{
	...
	zassert_equal(pdu->llctrl.length_rsp.max_rx_octets, p->max_rx_octets, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_rsp.max_tx_octets, p->max_tx_octets, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_rsp.max_rx_time, p->max_rx_time, "Error code mismatch.\nCalled at %s:%d\n", file, line);
	zassert_equal(pdu->llctrl.length_rsp.max_tx_time, p->max_tx_time, "Error code mismatch.\nCalled at %s:%d\n", file, line);
}
