...
// #include <sys/byteorder.h> -- included in stdlib
#include <sys/slist.h>
#include <sys/util.h>
...
helper_pdu_verify_func_t *const helper_pdu_verify[] = {
	helper_pdu_verify_version_ind,	  helper_pdu_verify_feature_req,
	helper_pdu_verify_feature_rsp,	  helper_pdu_verify_reject_ind,
	helper_pdu_verify_reject_ext_ind, helper_pdu_verify_enc_req,
	helper_pdu_verify_enc_rsp,	  helper_pdu_verify_start_enc_req,
	helper_pdu_verify_start_enc_rsp,  helper_pdu_verify_phy_req,
	helper_pdu_verify_phy_rsp,	  helper_pdu_verify_phy_update_ind,
...
void lt_tx_real(const char *file, u32_t line, helper_pdu_opcode_t opcode, struct ull_cp_conn *conn, void *param)
{
	...
	rx = malloc(sizeof(struct node_rx_pdu));
