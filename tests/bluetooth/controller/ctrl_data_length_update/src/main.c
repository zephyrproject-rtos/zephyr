...
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_loc)
{
	uint8_t err;
	struct node_tx *tx;
 ...
 *    |                            |                              |
 */
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_loc_unknown_rsp)
{
	uint8_t err;
	struct node_tx *tx;
 ...
 *    |                            |                              |
 */
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_loc_invalid_rsp)
{
	uint8_t err;
	struct node_tx *tx;
 ...
 *    |                            |                              |
 */
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_loc_no_eff_change)
{
	uint8_t err;
	struct node_tx *tx;
...
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_loc_no_eff_change2)
{
	uint8_t err;
	struct node_tx *tx;
	struct node_rx_pdu *ntf;
...
ZTEST(bluetooth_ctrl_data_length_update_periph, test_data_length_update_periph_loc)
{
	uint64_t err;
	struct node_tx *tx;
	struct node_rx_pdu *ntf;
...
ZTEST(bluetooth_ctrl_data_length_update_central, test_data_length_update_central_rem)
{
	struct node_tx *tx;
...
ZTEST(bluetooth_ctrl_data_length_update_periph, test_data_length_update_periph_rem)
{
	struct node_tx *tx;
...
ZTEST(bluetooth_ctrl_data_length_update_periph, test_data_length_update_periph_rem_and_loc)
{
	uint64_t err;
	struct node_tx *tx;
...
ZTEST(bluetooth_ctrl_data_length_update_util, test_data_length_update_dle_max_time_get)
{
...
ZTEST_SUITE(bluetooth_ctrl_data_length_update_util, NULL, NULL, setup, NULL, NULL);
ZTEST_SUITE(bluetooth_ctrl_data_length_update_central, NULL, NULL, setup, NULL, NULL);
ZTEST_SUITE(bluetooth_ctrl_data_length_update_periph, NULL, NULL, setup, NULL, NULL);
