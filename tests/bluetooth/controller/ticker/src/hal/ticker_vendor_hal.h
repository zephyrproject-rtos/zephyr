...
#ifndef HAL_TICKER_VENDOR_HAL_H_MOCK
#define HAL_TICKER_VENDOR_HAL_H_MOCK

#include <zephyr/sys/util.h>

/* Mock ticker vendor HAL definitions for unit testing */
...
#endif /* HAL_TICKER_VENDOR_HAL_H_MOCK */
