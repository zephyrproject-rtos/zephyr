...
testing_apps_loc="${ZEPHYR_BASE}/tests/bluetooth/bsim_bt/bism_test_noisy_env"
...
Execute "./${bsim_peripheral_exe_name}" -s=${simulation_id} -d=1 &
Execute ./bs_2G4_phy_v1 -s=${simulation_id} -D=2 -sim_length=50e6 &
