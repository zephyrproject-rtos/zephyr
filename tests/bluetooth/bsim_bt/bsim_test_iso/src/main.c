...
static void test_iso_main(void)
{
	...
	iso_tx_qos.interval = 10000; /* us */
	iso_tx_qos.latency = 10; /* milliseconds */
	iso_tx_qos.sdu = 502; /* bytes */
	iso_tx_qos.rtn = 2;
	iso_tx_qos.phy = BT_GAP_LE_PHY_2M;
	bis_iso_qos.tx = &iso_tx_qos;
	bis_iso_qos.rx = NULL;
	bis_iso_qos.packing = 0; /* 0 - sequential; 1 - interleaved */
	bis_iso_qos.framing = 0; /* 0 - unframed; 1 - framed */
...
static void test_iso_recv_main(void)
{
	...
	big_param.bis_bitfield = BIT(0); /* BIS index 0 selected */
	big_param.mse = 1;
