...
static void tbs_hold_call_cb(const struct bt_conn *conn, uint8_t call_index)
{
...
static bool tbs_authorize_cb(const struct bt_conn *conn)
{
	return conn == tbs_conn;
}
...
static void test_main(void)
{
	...
	if (err != BT_CCP_RESULT_CODE_SUCCESS) {
