...
simulation that cannot be run directly from twister
...
RESULTS_FILE=${ZEPHYR_BASE}/myresults.xml SEARCH_PATH=tests/bluetooth/bsim_bt/edtt_ble_test_app/tests_scripts tests/bluetooth/bsim_bt/run_parallel.sh
