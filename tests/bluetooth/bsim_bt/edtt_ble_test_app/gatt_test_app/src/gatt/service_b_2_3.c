...
static struct bt_gatt_attr service_b_2_3_attrs[] = {
    ...
    BT_GATT_CUD(cha_user_des_value, BT_GATT_PERM_READ, 0x93),
    BT_GATT_CEP(&cha_ext_pro_value, 0x94),
    BT_GATT_DESCRIPTOR(BT_UUID_DES_V5D4__128_BIT_UUID,
        BT_GATT_PERM_READ,
        read_des_v5d4__128_bit_uuid, NULL, &des_v5d4__128_bit_uuid_value, 0x95),
    BT_GATT_CPF(&cha_format_value, 0x96)
};

static struct bt_gatt_service service_b_2_3_svc = BT_GATT_SERVICE(service_b_2_3_attrs);
