...
static u8_t   value_v14_value[] = { 'L', 'e', 'n', 'g', 't', 'h', ' ', 'i', 's', ' ', '\0' };
static struct bt_gatt_cpf cha_format_value = { 0x19, 0x00, 0x3000, 0x01, 0x0000 };
static u8_t   value_v15_value = 0x65;
static struct bt_gatt_cpf cha_format_1_value = { 0x04, 0x00, 0x2701, 0x01, 0x0001 };
static u16_t  value_v6_value = 0x1234;
static struct bt_gatt_cpf cha_format_2_value = { 0x06, 0x00, 0x2710, 0x01, 0x0002 };
static u32_t  value_v7_value = 0x01020304;
static struct bt_gatt_cpf cha_format_3_value = { 0x08, 0x00, 0x2717, 0x01, 0x0003 };
 ...
 */
static ssize_t read_str_value(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_value_v15(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    const u8_t *value = attr->user_data;

    return bt_gatt_attr_read(conn, attr, buf, len, offset, value, sizeof(value_v15_value));
}
 ...
 */
static ssize_t write_value_v15(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, u16_t len, u16_t offset, u8_t flags)
{
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_value_v6(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    const u16_t *value = attr->user_data;
    u16_t value_v6_conv = sys_cpu_to_le16(*value);

    return bt_gatt_attr_read(conn, attr, buf, len, offset, &value_v6_conv, sizeof(value_v6_conv));
}
 ...
 * @return       Number of bytes written, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t write_value_v6(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, u16_t len, u16_t offset, u8_t flags)
{
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_value_v7(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    const u32_t *value = attr->user_data;
    u32_t value_v7_conv = sys_cpu_to_le32(*value);

    return bt_gatt_attr_read(conn, attr, buf, len, offset, &value_v7_conv, sizeof(value_v7_conv));
}
 ...
 * @return       Number of bytes written, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t write_value_v7(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, u16_t len, u16_t offset, u8_t flags)
{
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_value_v16(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    ...
    return bt_gatt_attr_read(conn, attr, buf, len, offset, &value_v16_conv, sizeof(value_v16_conv));
}
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_agg_format(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    ...
    return bt_gatt_attr_read(conn, attr, buf, len, offset, &agg_format_conv, sizeof(agg_format_conv));
}
 ...
 * @return       Number of bytes read, or in case of an error - BT_GATT_ERR() with a specific ATT error code.
 */
static ssize_t read_value_v17(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, u16_t len, u16_t offset)
{
    const u8_t *value = attr->user_data;

    return bt_gatt_attr_read(conn, attr, buf, len, offset, value, sizeof(value_v17_value));
}

#define BT_GATT_CHRC_NONE 0

static struct bt_gatt_attr service_f_1_attrs[] = {
    BT_GATT_PRIMARY_SERVICE(BT_UUID_SERVICE_F, 0xA0),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V14,
        BT_GATT_CHRC_READ,
        BT_GATT_PERM_READ,
        read_str_value, NULL, &value_v14_value, 0xA1),
    BT_GATT_CPF(&cha_format_value, 0xA3),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V15,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
        read_value_v15, write_value_v15, &value_v15_value, 0xA4),
    BT_GATT_CPF(&cha_format_1_value, 0xA6),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V6,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
        read_value_v6, write_value_v6, &value_v6_value, 0xA7),
    BT_GATT_CPF(&cha_format_2_value, 0xA9),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V7,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
        read_value_v7, write_value_v7, &value_v7_value, 0xAA),
    BT_GATT_CPF(&cha_format_3_value, 0xAC),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V16,
        BT_GATT_CHRC_READ,
        BT_GATT_PERM_READ,
        read_value_v16, NULL, &value_v16_value, 0xAD),
    BT_GATT_DESCRIPTOR(BT_UUID_AGG_FORMAT,
        BT_GATT_PERM_READ,
        read_agg_format, NULL, &agg_format_value, 0xAF),
    BT_GATT_CHARACTERISTIC(BT_UUID_VALUE_V17,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_AUTH,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
        read_value_v17, NULL, &value_v17_value, 0xB0)
};

static struct bt_gatt_service service_f_1_svc = BT_GATT_SERVICE(service_f_1_attrs);
