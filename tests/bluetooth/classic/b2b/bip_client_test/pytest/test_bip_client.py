...
def bip_sec_sdp_discover_l2cap(bip_server, conn_type):
    ...
    bip_server.exec_command(f'bip_client_test sec_sdp_discover {conn_type}')
...
def bip_secondary_obex_connect(bip_client, bip_server, conn_type):
    ...
    bip_server.iexpect('bip_client_test sec_set_feats_funcs 0x1ff 0x1ffff', bip_server.shell.prompt)
    ...
    bip_server.iexpect(
        f'bip_client_test sec_connect_l2cap {psm_hex}', r'BIP secondary.*transport connected on.*'
    )
