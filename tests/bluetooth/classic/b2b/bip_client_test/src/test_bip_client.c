...
SHELL_STATIC_SUBCMD_SET_CREATE(
	bip_client_cmds,
	SHELL_CMD_ARG(sec_set_feats_funcs, NULL, "<features> <functions>", cmd_sec_set_feats_funcs,
		      3, 0),
	SHELL_CMD_ARG(sec_reg, NULL, "<type> Register secondary server", cmd_sec_reg, 2, 0),
	SHELL_CMD_ARG(sec_unreg, NULL, "Unregister secondary server", cmd_sec_unreg, 1, 0),
	SHELL_CMD_ARG(sec_sdp_discover, NULL, "<type> Secondary SDP discover", cmd_sec_sdp_discover,
		      2, 0),
	SHELL_CMD_ARG(sec_connect_l2cap, NULL, "<psm> Secondary L2CAP transport connect",
		      cmd_sec_connect_l2cap, 2, 0),
	SHELL_CMD_ARG(sec_conn, NULL, "<type> Secondary client connect", cmd_sec_conn, 2, 0),
	SHELL_CMD_ARG(sec_server_conn, NULL, "<success|error> [rsp_code]", cmd_sec_server_conn, 2,
		      1),
	SHELL_CMD_ARG(sec_server_abort, NULL, "<success|error> [rsp_code]", cmd_sec_server_abort, 2,
		      1),
	SHELL_CMD_ARG(sec_server_get_partial_image, NULL, "<noerror|error> [rsp_code]",
		      cmd_sec_server_get_partial_image, 2, 1),
	SHELL_CMD_ARG(sec_get_partial_image, NULL, "Secondary client get_partial_image",
		      cmd_sec_get_partial_image, 1, 0),
	SHELL_CMD_ARG(sec_abort, NULL, "Secondary client abort", cmd_sec_abort, 1, 0),
...
SHELL_CMD_ARG_REGISTER(bip_client_test, &bip_client_cmds,
		       "Bluetooth test bip client test sh commands", cmd_bip_client, 1, 1);
