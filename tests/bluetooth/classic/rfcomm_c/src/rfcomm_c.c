...
SHELL_STATIC_SUBCMD_SET_CREATE(rfcomm_s_cmds,
			       SHELL_CMD_ARG(register, NULL, "<server channel>",
					     cmd_register, 2, 0),
			       SHELL_CMD_ARG(connect, NULL, "<server channel>",
					     cmd_connect, 2, 0),
			       SHELL_CMD_ARG(disconnect, NULL, "<server channel>",
					     cmd_disconnect, 2, 0),
			       SHELL_CMD_ARG(send, NULL, "<server channel> <data>",
					     cmd_send, 3, 0),
