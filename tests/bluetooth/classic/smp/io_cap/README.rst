...
.. code-block:: shell
   ...
   west twister -v -p mimxrt1170_evk@B/mimxrt1176/cm7 --device-testing --device-serial COM4 -T tests/bluetooth/classic/smp/io_cap -O smp_io_cap --force-platform --west-flash --west-runner=jlink -X usb_hci:usb:0
