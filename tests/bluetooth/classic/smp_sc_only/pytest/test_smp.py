...
async def sm_sc_only_init(hci_port, shell, dut, address, log_name, dut_sec) -> None:
...
async def sm_sc_init_005(hci_port, shell, dut, address) -> None:
...
async def sm_sc_init_006(hci_port, shell, dut, address) -> None:
    await sm_sc_only_init(
        hci_port,
        shell,
        dut,
...
async def sm_sc_init_007(hci_port, shell, dut, address) -> None:
    await sm_sc_only_init(
        hci_port,
        shell,
        dut,
...
async def sm_sc_init_008(hci_port, shell, dut, address) -> None:
    await sm_sc_only_init(
        hci_port,
        shell,
        dut,
...
async def sm_sc_init_009(hci_port, shell, dut, address) -> None:
    class Delegate(PairingDelegate):
...
async def sm_sc_only_rsp(hci_port, shell, dut, address, log_name, dut_sec) -> None:
    class Delegate(PairingDelegate):
        async def compare_numbers(self, number: int, digits: int) -> bool:
            """Compare two numbers."""
            logger.info('Comparing number')
...
async def sm_sc_rsp_005(hci_port, shell, dut, address) -> None:
...
async def sm_sc_rsp_006(hci_port, shell, dut, address) -> None:
    await sm_sc_only_rsp(
        hci_port,
        shell,
        dut,
...
async def sm_sc_rsp_007(hci_port, shell, dut, address) -> None:
    await sm_sc_only_rsp(
        hci_port,
        shell,
        dut,
...
async def sm_sc_rsp_008(hci_port, shell, dut, address) -> None:
    await sm_sc_only_rsp(
        hci_port,
        shell,
        dut,
...
async def sm_sc_rsp_009(hci_port, shell, dut, address) -> None:
...
class TestSmpServer:
    def test_sm_sc_init_005(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        asyncio.run(sm_sc_init_005(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_init_006(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_init_006(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_init_007(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_init_007(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_init_008(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_init_008(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_init_009(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_init_009(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_rsp_005(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_rsp_005(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_rsp_006(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_rsp_006(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_rsp_007(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_rsp_007(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_rsp_008(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_rsp_008(hci, shell, dut, iut_address))
    ...
    def test_sm_sc_rsp_009(self, shell: Shell, dut: DeviceAdapter, smp_initiator_dut):
        ...
        hci, iut_address = smp_initiator_dut
        asyncio.run(sm_sc_rsp_009(hci, shell, dut, iut_address))
