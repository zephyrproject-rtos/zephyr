...
class TestOPP:
    ...
    are ordered to model one OBEX session lifecycle: OBEX connect (5.2), data
    operations (5.3-5.6), PDU utilities (5.8), OBEX disconnect (5.7), then the
    RFCOMM transport disconnect (5.1) last. Server response codes are configured
    ...
    def test_5_2_obex_connect_error(
    ...
    def test_5_2_obex_connect_success(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
        ...
        The client never sends a Target header (per OPP Spec 5.4), so a SUCCESS
    ...
    def test_5_3_push_success_final(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_3_push_continue_non_final(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_3_push_unsupported_media(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_3_push_entity_too_large(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_3_push_multiple_objects(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_3_push_abort_ongoing(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    # ==================================================================
    # 5.4 Business Card Pull (GET)
    # ==================================================================

    def test_5_4_pull_bcard_success(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_4_pull_bcard_multi_packet(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_4_pull_bcard_not_found(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_4_pull_bcard_forbidden_name(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_4_pull_bcard_abort_ongoing(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
        """BR_OPP_SERVER_PULL_BCARD_ABORT_ONGOING / BR_OPP_CLIENT_PULL_BCARD_ABORT_ONGOING
        Multi-packet pull mode is enabled so the first GET is answered with a
        CONTINUE and the GET stays outstanding, which is the precondition for
        this case: the abort lands on an operation that is really in progress.
        """
        client_dut, server_dut = duts[0], duts[1]
        client_sh, server_sh = shells[0], shells[1]
        _reset(server_sh)
        ...
        assert _cmd_expect(client_sh, client_dut, "opp_c abort", "OPP client abort success"), (
            "Client abort during GET failed"
        )
        assert _wait_for(server_dut, "OPP server abort handled"), "Server did not abort the GET"
        _reset(server_sh)

    # ==================================================================
    # 5.5 Business Card Exchange (PUT + GET)
    # ==================================================================

    def test_5_5_exchange_success(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_5_exchange_pull_not_found(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    # ==================================================================
    # 5.6 Abort Ongoing Request
    # ==================================================================

    def test_5_6_abort_active_request(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_6_abort_no_active_request(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    # ==================================================================
    # 5.8 Service Discovery and PDU Utilities
    # ==================================================================

    def test_5_8_sdp_and_pdu(self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready):
    ...
    # ==================================================================
    # 5.7 OBEX Disconnection (single OBEX disconnect for the session)
    # ==================================================================

    def test_5_7_obex_disconnect_error(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    def test_5_7_obex_disconnect_success(
        self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready
    ):
    ...
    # ==================================================================
    # 5.1 Transport Disconnection (runs last; RFCOMM cannot be reconnected)
    # ==================================================================

    def test_5_1_transport(self, duts: list[DeviceAdapter], shells: list[Shell], transport_ready):
