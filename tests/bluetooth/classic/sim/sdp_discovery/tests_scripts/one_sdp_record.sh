...
# Create sdp_discovery directory if it doesn't exist
TEST_OUTPUT_DIR="${BT_CLASSIC_SIM}/${TEST_NAME}"
mkdir -p "$TEST_OUTPUT_DIR"

test_case_name="bluetooth.classic.sim.sdp.discover.one_record"
