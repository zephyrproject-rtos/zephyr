...
#define LOG_MODULE_NAME test_classic_l2cap_echo_sim_main
...
static void test_l2cap_args(void)
{
	static struct args_struct_t args[] = {
		{
			...
			.descript = "Bluetooth peer device address for L2CAP ECHO test",
		},
		ARG_TABLE_ENDMARKER
	};
...
NATIVE_TASK(test_l2cap_args, PRE_BOOT_1, 20);
