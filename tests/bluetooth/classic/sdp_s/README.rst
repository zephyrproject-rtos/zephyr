...
.. code-block:: shell
   ...
   west twister -v -p mimxrt1170_evk@B/mimxrt1176/cm7 --device-testing --device-serial COM4 -T tests/bluetooth/classic/sdp_s -O sdp_s --force-platform --west-flash --west-runner=jlink -X usb_hci:usb:0 -x CONFIG_BUILD_ONLY_NO_BLOBS=n
