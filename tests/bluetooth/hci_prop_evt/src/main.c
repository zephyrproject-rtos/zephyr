...
/* Prop callback. */
static void prop_cb(u8_t *data, size_t data_len)
{
...
{
	struct net_buf *buf;
	struct bt_hci_evt_prop_report *per;
...
static void test_hci_prop_evt_entry(void)
{
	...
	bt_hci_prop_register_cb(prop_cb);
