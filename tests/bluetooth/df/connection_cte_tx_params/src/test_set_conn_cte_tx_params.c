...
static void connection_setup(void *arg)
{
	ARG_UNUSED(arg);
...
static void connection_teardown(void *arg)
{
	ARG_UNUSED(arg);
...
ZTEST_SUITE(test_set_conn_cte_tx_params, NULL, bluetooth_setup, connection_setup,
