...
#if defined(CONFIG_BTTESTER_L2CAP_DATA_POOL_COUNT)
#define DATA_POOL_COUNT CONFIG_BTTESTER_L2CAP_DATA_POOL_COUNT
#else
#define DATA_POOL_COUNT CHANNELS
#endif /* CONFIG_BTTESTER_L2CAP_DATA_POOL_COUNT */
