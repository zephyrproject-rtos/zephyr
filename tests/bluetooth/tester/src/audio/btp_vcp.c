				      ...
				      void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_VCS, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
				       ...
				       void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_VOCS, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
				      ...
				      void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_VCP, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
