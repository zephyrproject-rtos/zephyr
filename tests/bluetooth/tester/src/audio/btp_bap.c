				       ...
				       void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_ASCS, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
				       ...
				       void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_PACS, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
					  ...
					  void *rsp, uint16_t *rsp_len)
{
	...
	tester_supported_commands(BTP_SERVICE_ID_BAP, rp->data, rsp_len);
	*rsp_len += sizeof(*rp);
