...
#define BTP_BAP_UNICAST_MAX_SNK_STREAMS_COUNT GENERIC_MIN( \
		CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SNK_COUNT, CONFIG_BT_ASCS_MAX_ASE_SNK_COUNT)
#define BTP_BAP_UNICAST_MAX_SRC_STREAMS_COUNT GENERIC_MIN( \
		CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SRC_COUNT, CONFIG_BT_ASCS_MAX_ASE_SRC_COUNT)
