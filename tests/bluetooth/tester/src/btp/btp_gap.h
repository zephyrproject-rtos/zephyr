...
struct btp_gap_ev_big_sync_established_ev {
	bt_addr_le_t address;
} __packed;

#define BTP_GAP_EV_BIS_SETUP			0x93
struct btp_gap_ev_bis_setup_ev {
	bt_addr_le_t address;
	uint8_t bis_id;
} __packed;

#define BTP_GAP_EV_BIS_STREAM_RECEIVED		0x94
struct btp_gap_ev_bis_stream_received_ev {
	bt_addr_le_t address;
	uint8_t bis_id;
	uint8_t data_len;
	uint8_t data[];
