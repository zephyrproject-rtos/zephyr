...
#define BTP_AVRCP_SET_ABSOLUTE_VOLUME 0x13
struct btp_avrcp_set_absolute_volume_cmd {
	bt_addr_le_t address;
	uint8_t volume;
} __packed;

#define BTP_AVRCP_SET_ADDRESSED_PLAYER 0x14
struct btp_avrcp_set_addressed_player_cmd {
	bt_addr_le_t address;
	uint16_t player_id;
} __packed;

#define BTP_AVRCP_GET_FOLDER_ITEMS 0x15
...
#define BTP_AVRCP_GET_TOTAL_NUMBER_OF_ITEMS 0x16
struct btp_avrcp_get_total_number_of_items_cmd {
	bt_addr_le_t address;
	uint8_t scope;
} __packed;

#define BTP_AVRCP_SET_BROWSED_PLAYER 0x17
struct btp_avrcp_set_browsed_player_cmd {
	bt_addr_le_t address;
	uint16_t player_id;
} __packed;

#define BTP_AVRCP_CHANGE_PATH 0x18
...
#define BTP_AVRCP_GET_ITEM_ATTRS 0x19
...
#define BTP_AVRCP_PLAY_ITEM 0x1a
...
#define BTP_AVRCP_ADD_TO_NOW_PLAYING 0x1c
...
#define BTP_AVRCP_TG_REGISTER_NOTIFICATION 0x1d
struct btp_avrcp_tg_register_notification_cmd {
	bt_addr_le_t address;
	uint8_t event_id;
} __packed;

#define BTP_AVRCP_TG_CONTROL_PLAYBACK 0x1e
...
#define BTP_AVRCP_TG_CHANGE_PATH 0x1f
...
#define BTP_AVRCP_CA_CT_CONNECT 0x20
struct btp_avrcp_ca_ct_connect_cmd {
	bt_addr_le_t address;
} __packed;

#define BTP_AVRCP_CA_CT_DISCONNECT 0x21
struct btp_avrcp_ca_ct_disconnect_cmd {
	bt_addr_le_t address;
} __packed;

#define BTP_AVRCP_CA_CT_GET_IMAGE_PROPS 0x22
struct btp_avrcp_ct_get_image_props_cmd {
	bt_addr_le_t address;
	uint8_t image_handle[7];
} __packed;

#define BTP_AVRCP_CA_CT_GET_IMAGE 0x23
...
#define BTP_AVRCP_CA_CT_GET_LINKED_THUMBNAIL 0x24
...
#define BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_RSP 0x91
...
#define BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP 0x92
struct btp_avrcp_set_addressed_player_rsp_ev {
	bt_addr_le_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_GET_FOLDER_ITEMS_RSP 0x93
...
#define BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_RSP 0x94
...
#define BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP 0x95
...
#define BTP_AVRCP_EV_CHANGE_PATH_RSP 0x96
...
#define BTP_AVRCP_EV_GET_ITEM_ATTRS_RSP 0x97
...
#define BTP_AVRCP_EV_PLAY_ITEM_RSP 0x98
struct btp_avrcp_play_item_rsp_ev {
	bt_addr_le_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_SEARCH_RSP 0x99
...
#define BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_RSP 0x9a
struct btp_avrcp_add_to_now_playing_rsp_ev {
	bt_addr_le_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_CA_CT_CONNECTED 0x9b
struct btp_avrcp_ca_ct_connected_ev {
	bt_addr_le_t address;
} __packed;

#define BTP_AVRCP_EV_CA_CT_DISCONNECTED 0x9c
struct btp_avrcp_ca_ct_disconnected_ev {
	bt_addr_le_t address;
} __packed;

#define BTP_AVRCP_EV_GET_IMAGE_PROPS_RSP 0x9d
...
#define BTP_AVRCP_EV_GET_IMAGE_RSP 0x9e
...
#define BTP_AVRCP_EV_GET_LINKED_THUMBNAIL_RSP 0x9f
