...
#define BTP_PBAP_PSE_PULL_PHONEBOOK_RSP		0x0f
...
#define BTP_PBAP_PSE_SET_PATH_RSP		0x12
...
#define BTP_PBAP_PSE_EV_PULL_PHONEBOOK		0x91
struct btp_pbap_pse_pull_phonebook_ev {
	bt_addr_le_t address;
	uint16_t buf_len;
	uint8_t buf[0];
} __packed;
...
#define BTP_PBAP_PSE_EV_SET_PATH		0x94
struct btp_pbap_pse_set_path_ev {
	bt_addr_le_t address;
	uint8_t flags;
	uint16_t buf_len;
	uint8_t buf[0];
