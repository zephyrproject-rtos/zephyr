...
#run all tests
RESULTS_FILE=${ZEPHYR_BASE}/banana.xml SEARCH_PATH=tests/bluetooth/bsim/ll/edtt/ tests/bluetooth/bsim/run_parallel.sh

#or just run one set:
tests/bluetooth/bsim/ll/edtt/tests_scripts/hci.sh
```
