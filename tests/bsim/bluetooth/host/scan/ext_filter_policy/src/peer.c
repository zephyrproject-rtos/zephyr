...
void entrypoint_peer(void)
{
	 ...
	 * - [peer] keep advertising until the DUT is done scanning
	 *
	 * [verdict]
	...
	/* Keep advertising until the DUT is done scanning. Passing here would stop the
	 * advertiser while the DUT still needs it on air.
	 */
	bk_sync_wait();
