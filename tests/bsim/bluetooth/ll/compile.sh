...
app=tests/bsim/bluetooth/ll/edtt/hci_test_app conf_file=prj_dut_llcp.conf compile
app=tests/bsim/bluetooth/ll/edtt/hci_test_app conf_file=prj_tst_llcp.conf compile
app=tests/bsim/bluetooth/ll/edtt/gatt_test_app conf_file=prj_llcp.conf compile
