...
LOG_MODULE_REGISTER(bsim_micp_peripheral, CONFIG_BTTESTER_LOG_LEVEL);

static void test_micp_peripheral(void)
{
	...
	bsim_btp_core_register(BTP_SERVICE_ID_MICS);
...
static const struct bst_test_instance test_sample[] = {
	{
		.test_id = "micp_peripheral",
		.test_descr = "Smoketest for the MICP peripheral BT Tester behavior",
		.test_main_f = test_micp_peripheral,
	},
	BSTEST_END_MARKER,
};

struct bst_test_list *test_micp_peripheral_install(struct bst_test_list *tests)
{
