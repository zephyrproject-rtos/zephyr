...
#define TEST_MSG_OP_1_RAW BT_MESH_MODEL_OP_SIG(0x0f)
#define TEST_MSG_OP_1     BT_MESH_MODEL_OPCODE(TEST_MSG_OP_1_RAW)
#define TEST_MSG_OP_2_RAW BT_MESH_MODEL_OP_SIG(0x10)
#define TEST_MSG_OP_2     BT_MESH_MODEL_OPCODE(TEST_MSG_OP_2_RAW)
