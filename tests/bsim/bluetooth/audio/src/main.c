...
extern struct bst_test_list *test_ccp_server_install(struct bst_test_list *tests);
extern struct bst_test_list *test_ccp_client_install(struct bst_test_list *tests);
...
bst_test_install_t test_installers[] = {
	...
	test_ccp_server_install,
	test_ccp_client_install,
	NULL,
};
