...
extern struct bst_test_list *test_csip_coordinator_install_invalid(struct bst_test_list *tests);
extern struct bst_test_list *test_csip_member_install_invalid(struct bst_test_list *tests);
...
bst_test_install_t test_installers[] = {
	...
	test_csip_coordinator_install_invalid,
	test_csip_member_install_invalid,
	//test_tbs_install,
