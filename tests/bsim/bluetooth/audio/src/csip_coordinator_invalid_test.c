...
static volatile bool set_locked_invalid;
...
static void test_coordinator_non_lockable(void)
{
	int err;
	char addr[BT_ADDR_LE_STR_LEN];
	uint8_t connected_member_count = 0;
	...
	printk("locking set of unlockable members\n");
	err = bt_csip_set_coordinator_lock(set_members, connected_member_count, &inst->info);
	if (err != 0) {
		PASS("succesfully failed (%d)\n", err);
		return;
	}
	printk("Set locked invalid: %d\n", set_locked_invalid);

	WAIT_FOR_COND(set_locked_invalid);

	PASS("No lock deployed\n");
}

static void test_coordinator_unranked(void)
{
	int err;
	char addr[BT_ADDR_LE_STR_LEN];
	uint8_t connected_member_count = 0;
...
static void test_coordinator_no_size(void)
{
	int err;
	char addr[BT_ADDR_LE_STR_LEN];
	uint8_t connected_member_count = 0;
...
static void test_coordinator_invalid_sirk(void)
{
	int err;
	char addr[BT_ADDR_LE_STR_LEN];
	uint8_t connected_member_count = 0;
...
static void test_coordinator_non_lockable_rank(void)
{
}


static const struct bst_test_instance test_csip[] = {
	{
		.test_id = "csip_set_coordinator_non_lockable",
		.test_post_init_f = test_init,
		.test_tick_f = test_tick,
		.test_main_f = test_coordinator_non_lockable,
	},
	{
		.test_id = "csip_set_coordinator_non_lockable_rank",
		.test_post_init_f = test_init,
		.test_tick_f = test_tick,
		.test_main_f = test_coordinator_non_lockable_rank,
	},
	{
		.test_id = "csip_set_coordinator_unranked",
		.test_post_init_f = test_init,
		.test_tick_f = test_tick,
		.test_main_f = test_coordinator_unranked,
	},
	{
		.test_id = "csip_set_coordinator_no_size",
		.test_post_init_f = test_init,
		.test_tick_f = test_tick,
		.test_main_f = test_coordinator_no_size,
	},
	{
		.test_id = "csip_set_coordinator_invalid_sirk",
		.test_post_init_f = test_init,
		.test_tick_f = test_tick,
