...
printf "\n\n======== Running CAP commander broadcast reception start error test =========\n\n"

Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_audio_prj_conf \
  -v=${VERBOSITY_LEVEL} -s=${SIMULATION_ID} -d=0 -testid=cap_commander_broadcast_reception_error \
...
Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_audio_prj_conf \
  ...
  -testid=cap_acceptor_broadcast_reception_reject_first \
