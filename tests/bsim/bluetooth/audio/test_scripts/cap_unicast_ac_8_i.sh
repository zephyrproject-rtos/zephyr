...
function Execute_AC_8_I() {
    printf "\n\n======== Running CAP AC_8_I with %s =========\n\n" $1

    Execute ./bs_${BOARD}_tests_bsim_bluetooth_audio_prj_conf \
        -v=${VERBOSITY_LEVEL} -s=${SIMULATION_ID} -d=0 -testid=cap_initiator_ac_8_i \
...
# Execute_AC_8_I 48_3_1 48_3_1 # CIS disconnect reason 0x3e
Execute_AC_8_I 48_4_1 48_4_1
# Execute_AC_8_I 48_5_1 48_5_1 # CIS disconnect reason 0x3e
# Execute_AC_8_I 48_6_1 48_6_1 # CIS disconnect reason 0x3e
