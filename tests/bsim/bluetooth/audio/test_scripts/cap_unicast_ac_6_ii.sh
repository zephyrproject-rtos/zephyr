...
function Execute_AC_6_II() {
    ...
    Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_audio_prj_conf \
        -v=${VERBOSITY_LEVEL} -s=${SIMULATION_ID} -d=0 -testid=cap_initiator_ac_6_ii \
        -RealEncryption=1 -rs=23 -D=3 -argstest sink_preset $1
...
Execute_AC_6_II 8_1_1
Execute_AC_6_II 8_2_1
Execute_AC_6_II 16_1_1
Execute_AC_6_II 16_2_1
Execute_AC_6_II 24_1_1
...
# Execute_AC_6_II 48_2_1 # bt_iso_chan_disconnected: 0x856afe0, reason 0x3d
Execute_AC_6_II 48_3_1
Execute_AC_6_II 48_4_1
Execute_AC_6_II 48_5_1
Execute_AC_6_II 48_6_1
