...
Execute ./bs_${BOARD}_samples_bluetooth_peripheral_hr_prj_conf_overlay-phy_coded_conf \
  -v=${verbosity_level} -s=${simulation_id} -d=0 -RealEncryption=1

Execute ./bs_${BOARD}_tests_bsim_bluetooth_samples_central_hr_peripheral_hr_prj_conf_overlay-phy_coded_conf \
