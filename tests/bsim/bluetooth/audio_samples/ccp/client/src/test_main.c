...
static void test_ccp_client_sample_init(void)
{
...
static const struct bst_test_instance test_sample[] = {
	{
		.test_id = "ccp_client",
		.test_descr = "Test based on the CCP client sample. "
		...
		.test_post_init_f = test_ccp_client_sample_init,
		.test_tick_f = test_ccp_client_sample_tick,
	},
	BSTEST_END_MARKER,
};

static struct bst_test_list *test_ccp_client_sample_install(struct bst_test_list *tests)
{
	tests = bst_add_tests(tests, test_sample);
	return tests;
}

bst_test_install_t test_installers[] = {test_ccp_client_sample_install, NULL};
