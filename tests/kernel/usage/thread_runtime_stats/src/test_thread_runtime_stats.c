...
ZTEST(usage_api, test_thread_since_collection_metrics) {
	...
	zassert_true(stats1.execution_cycles == stats1.execution_cycles_delta);
	zassert_true(stats1.execution_cycles == stats1.total_cycles);
	zassert_true(stats1.execution_cycles == stats1.total_cycles_delta);

	zassert_true(stats2.execution_cycles > stats1.execution_cycles);
	zassert_true(stats2.execution_cycles > stats2.execution_cycles_delta);
	zassert_true(stats2.execution_cycles == stats2.total_cycles);
	zassert_true(stats2.execution_cycles_delta == stats2.total_cycles_delta);
...
ZTEST(usage_api, test_cpu_since_collection_metrics) {
	...
	zassert_true(stats1.execution_cycles_delta == stats1.execution_cycles);
	zassert_true(stats1.total_cycles_delta == stats1.total_cycles);
	zassert_true(stats1.idle_cycles_delta == stats1.idle_cycles);
	...
	zassert_true(stats2.execution_cycles_delta < stats2.execution_cycles);
	zassert_true(stats2.total_cycles_delta < stats2.total_cycles);
	zassert_true(stats2.idle_cycles_delta < stats2.idle_cycles);
	...
	zassert_true(stats3.execution_cycles_delta > 0);
	zassert_true(stats3.execution_cycles_delta < stats3.execution_cycles);

	zassert_true(stats3.total_cycles_delta > 0);
	zassert_true(stats3.total_cycles_delta < stats3.total_cycles);

	zassert_true(stats3.idle_cycles_delta > 0);
	zassert_true(stats3.idle_cycles_delta < stats3.idle_cycles);
}
#else
ZTEST(usage_api, test_cpu_since_collection_metrics) {
}
