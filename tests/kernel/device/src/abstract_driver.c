 ...
 */
DEVICE_INSTANCE(my_driver_A, &common_driver_init,
		NULL, NULL, NULL,
		POST_KERNEL, &my_driver_A_api_funcs);

DEVICE_INSTANCE(my_driver_B, &common_driver_init,
		NULL, NULL, NULL,
		POST_KERNEL, &my_driver_B_api_funcs);
