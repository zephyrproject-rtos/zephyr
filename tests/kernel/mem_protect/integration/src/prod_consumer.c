...
/**
 * @brief Integration test of memory protection
 *
 * @details This test case is going to to verify:
 ...
 * - Use of APIs like ``k_queue_alloc_append()`` which require thread
 *   resource pools to be configured
