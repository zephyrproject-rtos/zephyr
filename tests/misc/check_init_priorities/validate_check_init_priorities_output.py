...
REFERENCE_OUTPUT_INITLEVELS = [
        ...
        "__init_posix_arch_console_init: posix_arch_console_init(__service_posix_arch_console_init)",
        "PRE_KERNEL_2",
        "__init_sys_clock_driver_init: sys_clock_driver_init(__service_sys_clock_driver_init)",
        "POST_KERNEL",
        "APPLICATION",
        "SMP",
]
