...
def _check_benchmark_results(output: str, core: str, constraints: STMLimits) -> None:
    ...
    ), f"Timing for log message with 0 arguments {latency_msg_0} us exceeds {threshold} us"
    ...
    ), f"Timing for log message with 1 argument {latency_msg_1} us exceeds {threshold} us"
    ...
    ), f"Timing for log message with 2 arguments {latency_msg_2} us exceeds {threshold} us"
    ...
    ), f"Timing for log message with 3 arguments {latency_msg_3} us exceeds {threshold} us"
    ...
    ), f"Timing for log message with string {latency_msg_string} us exceeds {threshold} us"

    # tracepoint
    latency_tracepoint_str = re.search(rf"{core}: Timing for tracepoint: (.+)us", output).group(1)
    ...
    ), f"Timing for tracepoint {latency_tracepoint} us exceeds {threshold} us"

    # tracepoint with 32-bit data
    ...
    ), f"Timing for tracepoint_d32 {latency_tracepoint_d32} us exceeds {threshold} us"
