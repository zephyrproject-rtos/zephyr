 ...
 *   -# stress_in_isr test: Check that we can append the next block immediatly after a
 * 	DMA_STATUS_BLOCK callback.
 *   -# loopstress test: Check that we can continously append block and check that the function
