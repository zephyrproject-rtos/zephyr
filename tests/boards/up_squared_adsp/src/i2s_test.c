 ...
 * @file
 *
 * @brief Test app to illustrate I2S transmission/reception on UP Squared ADSP
 *
 * The i2s_cavs driver is being used.
 *
 * In this test app, I2S transmission and reception are tested as follows:
 * I2S port #3 of UP Squared ADSP is configured for birectional mode
...
void test_i2s_bidirectional_transfer_configure(void)
{
	...
	k_mem_slab_init(&i2s_mem_slab, audio_buffers,
			BLOCK_SIZE_BYTES, NUM_I2S_BUFFERS);
...
K_THREAD_DEFINE(i2s_thread_id, STACKSIZE, i2s_thread,
