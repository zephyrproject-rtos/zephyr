...
static int tx_block_write_slab(const struct device *dev_i2s, int16_t val_l, int16_t val_r, int err,
...
int tx_block_write(const struct device *dev_i2s, int16_t val_l, int16_t val_r, int err)
{
	return tx_block_write_slab(dev_i2s, val_l, val_r, err, &tx_mem_slab);
}

static int rx_block_read_slab(const struct device *dev_i2s, int16_t val_l, int16_t val_r,
			      struct k_mem_slab *slab)
{
...
int rx_block_read(const struct device *dev_i2s, int16_t val_l, int16_t val_r)
{
	return rx_block_read_slab(dev_i2s, val_l, val_r, &rx_mem_slab);
}
