...
Test objective is to verify that the ESP32 and ESP32-S3 platforms correctly supports nested interrupts, where higher-priority interrupts can preempt lower-priority ones.
