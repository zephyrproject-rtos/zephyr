			  ...
			  void *user_data)
{
	...
	zassert_true(diff <= counter_us_to_ticks(dev, processing_limit_us),
		     "Unexpected distance between reported alarm value(" COUNTER_TICKS_FMT ") "
		     "and actual counter value (" COUNTER_TICKS_FMT "), top:" COUNTER_TICKS_FMT
		     " (processing time limit (%d us) might be exceeded?",
