...
{
	config_space[TEST_PTM_CAP_REG] = TEST_PTM_CAP_RESPONDER | PTM_CAP_ROOT;
...
ZTEST(pcie_ptm, test_root_requires_root_and_responder_capabilities)
{
	config_space[TEST_PTM_CAP_REG] = PTM_CAP_ROOT;
