...
ZTEST_USER(net_i2s_user_states, test_i2s_tx_transfer_configure_1)
#else
ZTEST(net_i2s_states, test_i2s_tx_transfer_configure_1)
#endif
{
	int ret;
...
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_rx_transfer_configure_1)
#else
ZTEST(net_i2s_states, test_i2s_rx_transfer_configure_1)
#endif
{
	int ret;
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_state_not_ready_neg)
#else
ZTEST(net_i2s_states, test_i2s_state_not_ready_neg)
#endif
{
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_state_ready_neg)
#else
ZTEST(net_i2s_states, test_i2s_state_ready_neg)
#endif
{
	int ret;
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_state_running_neg)
#else
ZTEST(net_i2s_states, test_i2s_state_running_neg)
#endif
{
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_state_stopping_neg)
#else
ZTEST(net_i2s_states, test_i2s_state_stopping_neg)
#endif
{
	if (IS_ENABLED(CONFIG_I2S_TEST_USE_I2S_DIR_BOTH)) {
		TC_PRINT("RX/TX transfer requires use of I2S_DIR_BOTH.\n");
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_user_states, test_i2s_state_error_neg)
#else
ZTEST(net_i2s_states, test_i2s_state_error_neg)
#endif
{
	if (IS_ENABLED(CONFIG_I2S_TEST_USE_I2S_DIR_BOTH)) {
		TC_PRINT("RX/TX transfer requires use of I2S_DIR_BOTH.\n");
