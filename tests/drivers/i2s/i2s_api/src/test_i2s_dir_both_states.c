...
ZTEST_USER(net_i2s_dir_both_user_states, test_i2s_dir_both_transfer_configure_1)
#else
ZTEST(net_i2s_dir_both_states, test_i2s_dir_both_transfer_configure_1)
#endif
{
	int ret;
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_dir_both_user_states, test_i2s_dir_both_state_running_neg)
#else
ZTEST(net_i2s_dir_both_states, test_i2s_dir_both_state_running_neg)
#endif
{
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_dir_both_user_states, test_i2s_dir_both_state_stopping_neg)
#else
ZTEST(net_i2s_dir_both_states, test_i2s_dir_both_state_stopping_neg)
#endif
{
	if (!dir_both_supported) {
		TC_PRINT("I2S_DIR_BOTH value is not supported.\n");
 ...
 */
#ifdef CONFIG_TEST_USERSPACE
ZTEST_USER(net_i2s_dir_both_user_states, test_i2s_dir_both_state_error_neg)
#else
ZTEST(net_i2s_dir_both_states, test_i2s_dir_both_state_error_neg)
#endif
{
	if (!dir_both_supported) {
		TC_PRINT("I2S_DIR_BOTH value is not supported.\n");
