...
static void test_location_event_handler(const struct device *dev, location_events_t events,
			void *user_data)
{

}

static struct location_driver_api test_location_api = {
...
void test_location_api_event_handler_set(void)
{
	...
	zassert_true(((struct test_driver_data *)test_driver1.data)->handler ==
				test_location_event_handler,
				"Incorrect event handler set for driver 1");
	...
	zassert_true(((struct test_driver_data *)test_driver2.data)->handler ==
				test_location_event_handler,
				"Incorrect event handler set for driver 2");
