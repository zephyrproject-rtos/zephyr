...
#define WM8960_POWER1_AINL 0x0020
#define WM8960_POWER1_AINR 0x0010
#define WM8960_POWER1_ADCL 0x0008
#define WM8960_POWER1_ADCR 0x0004
...
#define WM8960_POWER3_LMIC  0x0020
#define WM8960_POWER3_RMIC  0x0010
#define WM8960_POWER3_LOMIX 0x0008
#define WM8960_POWER3_ROMIX 0x0004
...
static void wm8960_emul_reset_registers(struct wm8960_emul_data *data)
{
	...
	/* Set default values for key registers (sourced from the datasheet) */
	data->reg[WM8960_REG_LEFT_INPUT_VOLUME] = 0x0097;
	data->reg[WM8960_REG_RIGHT_INPUT_VOLUME] = 0x0097;
	data->reg[WM8960_REG_LOUT1_VOLUME] = 0x0000;
	data->reg[WM8960_REG_ROUT1_VOLUME] = 0x0000;
	data->reg[WM8960_REG_CLOCKING_1] = 0x0000;
	data->reg[WM8960_REG_ADC_DAC_CTRL_1] = 0x0008;
	data->reg[WM8960_REG_ADC_DAC_CTRL_2] = 0x0000;
	data->reg[WM8960_REG_AUDIO_INTERFACE_1] = 0x000A;
	data->reg[WM8960_REG_CLOCKING_2] = 0x01C0;
	data->reg[WM8960_REG_AUDIO_INTERFACE_2] = 0x0000;
	data->reg[WM8960_REG_LEFT_DAC_VOLUME] = 0x00FF;
	data->reg[WM8960_REG_RIGHT_DAC_VOLUME] = 0x00FF;
	data->reg[WM8960_REG_3D_CONTROL] = 0x0000;
	data->reg[WM8960_REG_ALC1] = 0x007B;
	data->reg[WM8960_REG_ALC2] = 0x0100;
	data->reg[WM8960_REG_ALC3] = 0x0032;
	data->reg[WM8960_REG_NOISE_GATE] = 0x0000;
	data->reg[WM8960_REG_LEFT_ADC_VOLUME] = 0x00C3;
	data->reg[WM8960_REG_RIGHT_ADC_VOLUME] = 0x00C3;
	data->reg[WM8960_REG_ADDITIONAL_CONTROL_1] = 0x01C0;
	data->reg[WM8960_REG_ADDITIONAL_CONTROL_2] = 0x0000;
	data->reg[WM8960_REG_POWER_MGMT_1] = 0x0000;
	data->reg[WM8960_REG_POWER_MGMT_2] = 0x0000;
	data->reg[WM8960_REG_ADDITIONAL_CONTROL_3] = 0x0000;
	data->reg[WM8960_REG_ANTI_POP_1] = 0x0000;
	data->reg[WM8960_REG_ANTI_POP_2] = 0x0000;
	data->reg[WM8960_REG_ADCL_SIGNAL_PATH] = 0x0100;
	data->reg[WM8960_REG_ADCR_SIGNAL_PATH] = 0x0100;
	data->reg[WM8960_REG_LEFT_OUT_MIX_1] = 0x0050;
	data->reg[WM8960_REG_RIGHT_OUT_MIX_2] = 0x0050;
	data->reg[WM8960_REG_MONO_OUT_MIX_1] = 0x0000;
	data->reg[WM8960_REG_MONO_OUT_MIX_2] = 0x0000;
	data->reg[WM8960_REG_LOUT2_VOLUME] = 0x0000;
	data->reg[WM8960_REG_ROUT2_VOLUME] = 0x0000;
	data->reg[WM8960_REG_MONO_OUT_VOLUME] = 0x0040;
	data->reg[WM8960_REG_POWER_MGMT_3] = 0x0000;
	data->reg[WM8960_REG_CLASS_D_CONTROL_1] = 0x0037;
	data->reg[WM8960_REG_PLL_N] = 0x0000;
	data->reg[WM8960_REG_PLL_K1] = 0x0031;
	data->reg[WM8960_REG_PLL_K2] = 0x0038;
	data->reg[WM8960_REG_PLL_K3] = 0x00E9;
...
void wm8960_emul_set_reg(const struct emul *target, uint8_t reg_addr, uint16_t val)
{
	...
	if (reg_addr < WM8960_NUM_REGS) {
		...
		case WM8960_REG_POWER_MGMT_3:
			data->speaker_enabled = (val &
					 (WM8960_POWER3_LOMIX | WM8960_POWER3_ROMIX)) != 0;
			data->powered_up = data->dac_enabled || data->adc_enabled ||
					   data->headphone_enabled || data->speaker_enabled;
			break;
		default:
			     ...
			     void *unused_data)
{
	...
	if (data->current_reg < WM8960_NUM_REGS) {
		...
		case WM8960_REG_POWER_MGMT_3:
			/* Update output mixer power state */
			data->speaker_enabled = (data->reg[data->current_reg] &
					 (WM8960_POWER3_LOMIX | WM8960_POWER3_ROMIX)) != 0;
			data->powered_up = data->dac_enabled || data->adc_enabled ||
					   data->headphone_enabled || data->speaker_enabled;
			LOG_DBG("WM8960 emulator: Output mixer power state updated: %s",
				data->speaker_enabled ? "ON" : "OFF");
			break;
