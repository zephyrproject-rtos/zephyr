...
DT_FOREACH_CHILD_STATUS_OKAY(DT_NODELABEL(test_i2c0), DECLARE_ZTEST_PER_DEVICE)
DT_FOREACH_CHILD_STATUS_OKAY(DT_NODELABEL(test_i2c1), DECLARE_ZTEST_PER_DEVICE)
