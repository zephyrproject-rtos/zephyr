...
ZTEST_USER_F(bq27z746, test_get_props__returns_ok)
{
	...
	zassert_between_inclusive(props[0].avg_current_ua, -32768 * 1000, 32767 * 1000);
	zassert_between_inclusive(props[1].cycle_count, 0, 6553500);
	zassert_between_inclusive(props[2].current_ua, -32768 * 1000, 32767 * 1000);
	zassert_between_inclusive(props[3].full_charge_capacity_uah, 0, 32767 * 1000);
	zassert_between_inclusive(props[4].remaining_capacity_uah, 0, 32767 * 1000);
	zassert_between_inclusive(props[5].runtime_to_empty_mins, 0, 65535);
	zassert_between_inclusive(props[6].runtime_to_full_mins, 0, 65535);
	/* Not testing props[7]. This is the manufacturer access and has only status bits */
	zassert_between_inclusive(props[8].relative_state_of_charge_pct, 0, 100);
	zassert_between_inclusive(props[9].temperature_dk, 0, 32767);
	zassert_between_inclusive(props[10].voltage_uv, 0, 32767 * 1000);
	zassert_between_inclusive(props[11].sbs_at_rate, -32768, 32767);
	zassert_between_inclusive(props[12].sbs_at_rate_time_to_empty_mins, 0, 65535);
	zassert_between_inclusive(props[13].chg_voltage_uv, 0, 32767);
	zassert_between_inclusive(props[14].chg_current_ua, 0, 32767);
