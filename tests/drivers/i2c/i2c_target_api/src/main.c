...
static int run_full_read(const struct device *i2c, uint16_t addr, uint8_t addr_width,
...
static int run_partial_read(const struct device *i2c, uint16_t addr, uint8_t addr_width,
...
static int run_program_read(const struct device *i2c, uint16_t addr, uint8_t addr_width,
			    unsigned int offset)
{
	int ret, i;
