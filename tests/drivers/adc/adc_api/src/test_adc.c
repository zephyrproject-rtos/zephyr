...
/* Data of ADC io-injected-channels specified in devicetree. */
...
static void init_adc(void)
{
	...
	for (i = 0; i < LARGE_BUFFER_SIZE; ++i) {
		m_large_sample_buffer[i] = INVALID_ADC_VALUE;
	}
#endif /* CONFIG_ADC_INJECTED_CHANNELS */
...
static int test_task_asynchronous_call_with_injected(void)
{
	...
	check_samples(adc_injected_channels_count, m_injected_sample_buffer, BUFFER_SIZE);
