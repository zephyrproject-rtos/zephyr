...
#elif defined(CONFIG_BOARD_EFM32PG_STK3402A)
#include <soc.h>
#define ADC_DEVICE_NAME		DT_INST_0_SILABS_GECKO_ADC_LABEL
#define ADC_RESOLUTION		12
#define ADC_GAIN		ADC_GAIN_1
#define ADC_REFERENCE		ADC_REF_INTERNAL
#define ADC_ACQUISITION_TIME	ADC_ACQ_TIME_DEFAULT
#define ADC_1ST_CHANNEL_ID	0
#define ADC_1ST_CHANNEL_INPUT	_ADC_SINGLECTRL_POSSEL_TEMP
#define ADC_2ND_CHANNEL_ID	1
#define ADC_2ND_CHANNEL_INPUT	_ADC_SINGLECTRL_POSSEL_AVDD
