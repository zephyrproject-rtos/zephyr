...
ZTEST_USER(adc_emul_basic, test_adc_emul_single_value)
{
...
ZTEST_USER(adc_emul_basic, test_adc_emul_single_value_2ch)
{
...
ZTEST_USER(adc_emul_basic, test_adc_emul_custom_function)
{
 ...
 *        params.
 */
ZTEST_USER(adc_emul_basic, test_adc_emul_custom_function_2ch)
{
	struct handle_seq_params channel1_param;
 ...
 */
ZTEST_USER(adc_emul_basic, test_adc_emul_custom_function_and_value)
{
	struct handle_seq_params channel1_param;
	const uint16_t input1_mv = 1500;
	const uint16_t input2_mv = 1000;
...
ZTEST_USER(adc_emul_basic, test_adc_emul_gain)
{
 ...
 *        adc_read().
 */
ZTEST_USER(adc_emul_basic, test_adc_emul_input_higher_than_ref)
{
 ...
 */
ZTEST_USER(adc_emul_basic, test_adc_emul_reference)
{
...
ZTEST_USER(adc_emul_basic, test_adc_emul_ref_voltage_set)
{
	const uint16_t input1_mv = 4000;
	const uint16_t input2_mv = 2000;
...
ZTEST_SUITE(adc_emul_basic, NULL, test_init, NULL, NULL, NULL);
