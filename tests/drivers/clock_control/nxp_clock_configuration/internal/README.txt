NXP Internal Clock Test
#######################

This test is designed to verify the platform can boot from the highest
frequency internal oscillator available on the part. The core clock
configuration for this test should always be the highest frequency
configuration supported without external components by the SOC
