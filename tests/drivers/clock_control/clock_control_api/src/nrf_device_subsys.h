...
static const struct device_subsys_data subsys_data[] = {
	 ...
	 */
	{
		...
		.startup_us = (CLOCK_CONTROL_NRF_K32SRC == NRF_CLOCK_LFCLK_RC) ? 1000 : 500000
	}
...
static const struct device_subsys_data subsys_data_lfclk[] = {
	{
		.subsys = NULL,
		.startup_us = DT_ENUM_HAS_VALUE(
			DT_COMPAT_GET_ANY_STATUS_OKAY(nordic_nrf_clock_lfclk), k32src, rc) ?
			1000 : 500000
	}
};
