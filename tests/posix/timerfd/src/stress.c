...
typedef int (*timerfd_op_t)(int fd);
...
static const timerfd_op_t op[2] = {
	[READER] = read_op,
	[WRITER] = write_op,
};
...
static int write_op(int fd)
{
    return ioctl(fd, TFD_IOC_SET_TICKS, (uint64_t)1);
}
...
static void th_fun(void *arg1, void *arg2, void *arg3)
{
	...
	struct timerfd_fixture *fixture = arg2;
