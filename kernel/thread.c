...
#ifdef CONFIG_THREAD_RUNTIME_STACK_SAFETY
int z_impl_k_thread_runtime_stack_safety_full_check(const struct k_thread *thread,
				size_t *unused_ptr,
...
int z_impl_k_thread_runtime_stack_safety_threshold_check(const struct k_thread *thread,
				size_t *unused_ptr,
				k_thread_stack_safety_handler_t handler,
				void *arg)
{
...
#ifdef CONFIG_USERSPACE
int z_vrfy_k_thread_runtime_stack_safety_full_check(const struct k_thread *thread,
				size_t *unused_ptr,
				k_thread_stack_safety_handler_t handler,
				void *arg)
{
	...
	return z_impl_k_thread_runtime_stack_safety_full_check(thread, unused_ptr, handler, arg);
}
#include <zephyr/syscalls/k_thread_runtime_stack_safety_full_check_mrsh.c>

int z_vrfy_k_thread_runtime_stack_safety_threshold_check(struct k_thread *thread,
				size_t *unused_ptr,
				k_thread_stack_safety_handler_t handler,
				void *arg)
{
	...
	return z_impl_k_thread_runtime_stack_safety_threshold_check(thread,
				unused_ptr, handler, arg);
}
#include <zephyr/syscalls/k_thread_runtime_stack_safety_unused_threshold_set_mrsh.c>
