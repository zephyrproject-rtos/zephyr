...
* NXP SoC DTSI files have been reorganized by moving them into family-specific subdirectories
  under ``dts/arm/nxp``. See :ref:`NXP Devicetree layout <nxp_devicetree_layout>`.
