...
* Made these changes in other SoC series:
  ...
  * STM32H5 now supports stop mode and :kconfig:option:`CONFIG_PM`.
  * Enabled ART Accelerator I-cache, D-cache and prefetch on all STM32 compatible series.
  * STM32WL: Decreased Sub-GHz SPI frequency from 12 to 8MHz
  * Added support for :kconfig:option:`CONFIG_POWEROFF` on STM32C0 series.
  * Added support for Stop3 mode on STM32U5 series.
...
* Made these changes for ARM boards:
  ...
  * On ST STM32 boards, stm32cubeprogrammer runner could now be used to program external
...
* ADC
  ...
  * Added support for STM32H7RS series.
...
* Battery backed up RAM
  ...
  * Added support on STM32G0 and STM32H5 series.
...
* Ethernet
  ...
  * Added support for PTP on STM32 compatible series (STM32F7, STM32H5 and STM32H7).
...
* Flash
  ...
  * Added support of non busy wait polling on STM32 OSPI driver.
  * Added support for STM32 XSPI external nor flash driver (:dtcompatible:`st,stm32-xspi-nor`).
  * Added support for XIP on external nor flash on STM32 OSPI, QSPI and XSPI driver.
  * STM32 OSPI driver: clk, dqs, ncs ports can now be configured by device tree configurable,
    see :dtcompatible:`st,stm32-ospi`.
...
* GPIO
  ...
  * Added c:macro:`STM32_GPIO_WKUP` flag which allows to configure a pin as wakeup source from
    Power Off state on STM32 family.

* Hardware info

  * Added device EUI64 ID support and implementation for STM32 series.

* I2C

  * Added support for Ambiq Apollo3 series.
  * On STM32 V2 driver, added support for a new :kconfig:option:`CONFIG_I2C_STM32_V2_TIMING`
...
* Serial
  ...
  * Added DCache support in async DMA mode on STM32 driver.
  * Added support for STM32H7RS series.
...
* SPI
  ...
  * Added support for DMA support with DCache enabled on STM32 SPI driver.
  * Added support for STM32H7RS series.
