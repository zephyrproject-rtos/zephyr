...
* For ILI9341 controller, display mirroring configuration has been updated to conform with the
  described behavior of the sample ``samples/drivers/display``. (:github:`99267`).
