...
* Notes and migration tips:
  ...
  - Pinctrl headers already organized under ``nxp/<subdir>/...-pinctrl.dtsi`` were not affected.
  - If you need help locating affected includes, start by searching for the old include prefix and
    update each match to the correct family subdirectory.

    .. code-block:: console

      git grep "#include <nxp/nxp_" -- '*.dts' '*.dtsi'
  ...
  - Additional examples:
    ...
    .. code-block:: dts
      ...
      /* i.MX (M4/M7 cores) */
      #include <nxp/imx/nxp_imx8m_m4.dtsi>
      #include <nxp/imx/nxp_imx8ml_m7.dtsi>
