...
* Wi-Fi
  ...
  * The ESP32 Wi-Fi driver gained 802.11k/v/r and MBO support, all off by
    ...
    point on its own, and the application supplies the handler for the signal
    change event. A connection that pins a BSSID or a channel is associated
    without the BSS transition capability, since the Wi-Fi library would
