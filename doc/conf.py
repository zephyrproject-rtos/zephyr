...
# Requirement needs (with status/rtype/component fields and parent "trace"
# links) are generated by _scripts/gen_requirements.py; test/implementation
# needs and the traceability views are generated by zephyr.requirement_traceability.

needs_types = [
    {"directive": "req", "title": "Requirement", "prefix": "",
     "color": "#BFD8D2", "style": "node"},
    {"directive": "test", "title": "Test", "prefix": "",
     "color": "#DCB239", "style": "node"},
    {"directive": "impl", "title": "Implementation", "prefix": "",
     "color": "#DF744A", "style": "node"},
    {"directive": "design_need", "title": "Design", "prefix": "",
     "color": "#99CCEE", "style": "node"},
]

# Typed relationships. Forward links are emitted on the test/implementation/
# design needs; sphinx-needs creates the reverse ("*_back") links automatically,
# so a requirement shows the tests that verify it and its parents.
needs_links = {
    "trace": {"incoming": "Refined by", "outgoing": "Traces"},
    "validates": {"incoming": "Validated by", "outgoing": "Validates"},
    "implements": {"incoming": "Implemented by", "outgoing": "Implements"},
    "fulfills": {"incoming": "Fulfilled by", "outgoing": "Fulfills"},
}

needs_fields = {
    "component": {"description": "Component the requirement belongs to", "nullable": True},
    "rtype": {"description": "Requirement type (Functional/Non-Functional)", "nullable": True},
}

# Requirement UIDs (ZEP-SRS-x-y), C symbol names and test identifiers.
needs_id_regex = r"^[A-Za-z0-9_.-]+$"

# Machine-readable export of all needs and their relationships
# (<outdir>/needs.json), consumed by the traceability tooling in doc/_scripts/.
