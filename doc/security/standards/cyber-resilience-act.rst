...
.. admonition:: Key Dates
   ...
   * **September 11, 2026**: Manufacturers must report actively exploited vulnerabilities and severe
      incidents
...
For manufacturers, the CRA imposes essential cybersecurity requirements (`Annex I Part I`_) along
with vulnerability handling and reporting obligations (`Annex I Part II`_). For the Zephyr Project
...
According to definition in `Blue Guide`_ and `EU CRA Guidelines`_:
A product is placed on the market when it is made available for the first time on the Union market.
A product is made available on the Union market when it is supplied for distribution, consumption
or use on the Union market in the course of a commercial activity, whether in return for payment
or free of charge.
Placing on the market is applicable to every individual unit of a product series; development or
design dates are not relevant.
More information about "Placing on the market" can be found in the `EU CRA Guidelines`_. It details
specific cases like standalone software, source code releases and complex products.
...
**Vulnerability handling**
  Handle vulnerabilities when placing a product on the market.
...
* `European Commission CRA Guidelines (answer a lot of questions about interpration)
...
.. _`EU CRA Guidelines`: https://digital-strategy.ec.europa.eu/en/library/commission-publishes-new-guidance-support-timely-cyber-resilience-act-implementation
