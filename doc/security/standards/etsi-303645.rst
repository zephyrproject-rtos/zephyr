...
.. list-table:: ETSI 303645 provisions
    :header-rows: 1
    :widths: 17 43 43
    ...
    * - Provision
      ...
      - Justification
        ...
        .. _ETSI_Provision_4_1:
    * - Provision 4.1
      - A justification shall be recorded for each recommendation in
        the present document that is considered to be not applicable
        for or not fulfilled by the consumer IoT device.
      -
