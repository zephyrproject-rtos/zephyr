...
#. :file:`Kconfig.soc`: the base SoC configuration which defines a Kconfig SoC
   symbol and provides the SoC name to the Kconfig ``SOC`` setting.
...
.. _soc_porting_general_recommendations:

General recommendations
***********************

Placeholder for time being.
Do we have any general recommendations for SoC porting, like we have for Board
porting, :ref:`porting-general-recommendations`.
...
If you want to contribute your SoC to Zephyr, first -- thanks!

There are some extra things you'll need to do:

#. Make sure you've followed all the :ref:`soc_porting_general_recommendations`.
   They are requirements for SoCs included with Zephyr.
