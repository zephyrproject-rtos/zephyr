...
The header comprises the 1-byte Break, the Inter-Byte Space, the 1-byte SYNC (0x55),
...
and disables the transceiver automatically as part of :c:func:`lin_start` and
:c:func:`lin_stop`, so applications should not normally need to call the transceiver API
directly.

LIN Transceiver API Reference
*****************************
