...
The Zephyr requirements are managed in the ``reqmgmt`` repository using `StrictDoc <https://github.com/strictdoc-project/strictdoc>`_. The repo includes:
...
Set the UID to ``TBD`` so StrictDoc can generate it automatically in a later step.
