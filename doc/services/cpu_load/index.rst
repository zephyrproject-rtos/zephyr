...
The CPU Load subsys makes use of the ``usage`` kernel feature to implement ``cpu_load_get()``
...
This getter should be called on a periodic basis as to ensure that the CPU load is accurately represented
over time.
