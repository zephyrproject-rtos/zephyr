...
When using this Device Runtime Power Management, the Power Management subsystem
is able to change power states quickly because it does not need to spend time
