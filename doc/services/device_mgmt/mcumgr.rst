...
.. only:: html
    ...
    .. table:: Tools and Libraries for MCUmgr
        ...
        |                                                                                +---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+               |            |            |
        |                                                                                | Windows | Linux | mac | Mobile | Embedded | Serial | Bluetooth | UDP | LoRaWAN | OS | IMG | Stat | Settings | FS | Shell | Enum | Zephyr |               |            |            |
        +================================================================================+=========+=======+=====+========+==========+========+===========+=====+=========+====+=====+======+==========+====+=======+======+========+===============+============+============+
        ...
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
        | `smp <https://pypi.org/project/smp/>`_                                         | ✓       | ✓     | ✓   | ✓      | ✕        | N/A    | N/A       | N/A | N/A     | ✓  | ✓   | ✓    | ✓        | ✓  | ✓     | ✓    | ✓      | Library       | Python     | Apache-2.0 |
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
        ...
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
        | `zephyr-mcumgr <https://github.com/Finomnis/zephyr-mcumgr-client/>`_           | ✓       | ✓     | ✓   | ✕      | ✕        | ✓      | ✕         | ✕   | ✕       | ✓  | ✓   | ✕    | ✕        | ✓  | ✓     | ✕    | ✓      | Library and   | Rust,      | Apache-2.0 |
        |                                                                                |         |       |     |        |          |        |           |     |         |    |     |      |          |    |       |      |        | application   | Python     |            |
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
...
.. only:: latex
    ...
    .. table:: Tools and Libraries for MCUmgr
        ...
        |                                                                                | macOS         | UDP             |    |     |      |          |    |       |      |        |               |            |
        +--------------------------------------------------------------------------------+---------------+-----------------+----+-----+------+----------+----+-------+------+--------+---------------+------------+
        | `zephyr-mcumgr <https://github.com/Finomnis/zephyr-mcumgr-client/>`_           | Windows, |br| | Serial          | ✓  | ✓   | ✕    | ✕        | ✓  | ✓     | ✕    | ✓      | Library, App  | Rust,      |
        |                                                                                | Linux, |br|   |                 |    |     |      |          |    |       |      |        |               | Python     |
        |                                                                                | macOS         |                 |    |     |      |          |    |       |      |        |               |            |
        +--------------------------------------------------------------------------------+---------------+-----------------+----+-----+------+----------+----+-------+------+--------+---------------+------------+
