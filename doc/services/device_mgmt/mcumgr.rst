...
.. only:: html
    ...
    .. table:: Tools and Libraries for MCUmgr
        ...
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
        | `mcumgr-toolkit <https://github.com/Finomnis/mcumgr-toolkit/>`_                | ✓       | ✓     | ✓   | ✕      | ✕        | ✓      | ✕         | ✕   | ✕       | ✓  | ✓   | ✕    | ✕        | ✓  | ✓     | ✕    | ✓      | Library and   | Rust,      | Apache-2.0 |
        |                                                                                |         |       |     |        |          |        |           |     |         |    |     |      |          |    |       |      |        | application   | Python     |            |
        +--------------------------------------------------------------------------------+---------+-------+-----+--------+----------+--------+-----------+-----+---------+----+-----+------+----------+----+-------+------+--------+---------------+------------+------------+
...
.. only:: latex
    ...
    .. table:: Tools and Libraries for MCUmgr
        ...
        |                                                                                | macOS         | UDP             |    |     |      |          |    |       |      |        |               |            |
        +--------------------------------------------------------------------------------+---------------+-----------------+----+-----+------+----------+----+-------+------+--------+---------------+------------+
        | `mcumgr-toolkit <https://github.com/Finomnis/mcumgr-toolkit/>`_                | Windows, |br| | Serial          | ✓  | ✓   | ✕    | ✕        | ✓  | ✓     | ✕    | ✓      | Library, App  | Rust,      |
        |                                                                                | Linux, |br|   |                 |    |     |      |          |    |       |      |        |               | Python     |
        |                                                                                | macOS         |                 |    |     |      |          |    |       |      |        |               |            |
        +--------------------------------------------------------------------------------+---------------+-----------------+----+-----+------+----------+----+-------+------+--------+---------------+------------+
