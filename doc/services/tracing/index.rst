...
========================
Percepio View is a free-of-charge tracing tool based on `Percepio Tracealyzer`_, intended for debugging and verification of Zephyr applications.

.. figure:: percepio_view.png
    :align: center
    :alt: Percepio View
    :figclass: align-center
    :width: 80%
...
.. figure:: percepio_view_user_event.png
    :align: center
