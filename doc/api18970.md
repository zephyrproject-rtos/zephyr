...
cooperative thread unready before a reschedule point.

A function is cooperative-unsafe if it is rescheduling and at least one
path through it can make a calling cooperative thread unready before a
reschedule point.

#### Commentary

I.e. a cooperative-unsafe function could cause a cooperative thread
invoking it to be context-switched.
