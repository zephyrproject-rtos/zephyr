...
REDIRECTS = [
    ...
    ('guides/dts/api-usage', 'guides/build/dts/api-usage'),
    ('guides/dts/bindings', 'guides/build/dts/bindings'),
    ('guides/dts/design', 'guides/build/dts/design'),
    ('guides/dts/dt-vs-kconfig', 'guides/build/dt-vs-kconfig'),
    ('guides/dts/howtos', 'guides/build/dts/howtos'),
    ('guides/dts/index', 'guides/build/dts/index'),
    ('guides/dts/troubleshooting', 'guides/build/dts/troubleshooting'),
