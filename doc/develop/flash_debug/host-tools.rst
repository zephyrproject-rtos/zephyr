...
BlackMagic Probe (BMP) is an open-source debugging hardware incorporating gdb debug
...
Once in this mode, the application image can be uploaded by simply copying a ``.uf2`` file to the
mounted volume.
