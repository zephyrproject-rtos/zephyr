...
provided by defining them in ``PUNCOVER_ADDITIONAL_OPTS``.
...
.. zephyr-app-commands::
    ...
    :board: reel_board
    :goals: puncover
    :gen-args: -DCONFIG_STACK_USAGE=y -DCONFIG_CALLGRAPH_INFO=y -DPUNCOVER_ADDITIONAL_OPTS="-c puncover_config.yaml"
