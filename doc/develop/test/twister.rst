...
For information regarding how to use plugin filters, consult :ref:`Plugin Filter Documentation <_pluginFilterDocu>`.
For information regarding writing a custom plugin filter, visit the :ref:`Plugin Filter Creation <_pluginFilterCreation>` page.
