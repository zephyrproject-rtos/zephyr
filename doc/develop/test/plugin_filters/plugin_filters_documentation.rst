...
#.  Arguments
    ...
    *   The setup method of ``filter_id_regex.py`` is the following:
        ...
        Args and kwargs should still be included to prevent argument-related crashes,
        but, at least in this filter, they are left unused.
...
.. _pluginFilterCommandsPG:
    ...
    *   **--plugin-filter**, accepts a string containing filter data.
        ...
        .. code-block:: bash
            ...
            scripts/twister -T samples/philosophers --plugin-filter filter_id_regex regex_pattern='.*static'
            ...
            scripts/twister -T samples/philosophers --plugin-filter filter_id_regex.py regex_pattern='.*static'
...
.. _pluginFilterCommandsPGJS:
    ...
    *   **--plugin-filter-json-string**, accepts a json-formatted string containing filter data.
        ...
        .. code-block:: bash
            ...
            scripts/twister -T samples/philosophers --plugin-filter-json-string '[{"filter_file_path": "filter_id_regex", "kwargs": {"regex_pattern": ".*static"}}]'
            scripts/twister -T samples/philosophers --plugin-filter-json-string '[{"filter_file_path": "filter_id_regex.py", "args": [".*static"]}]'
            scripts/twister -T samples/philosophers --plugin-filter-json-string '[{"filter_file_path": "filter_id_regex.py", "kwargs": {"regex_pattern": ".*static"}}]'
