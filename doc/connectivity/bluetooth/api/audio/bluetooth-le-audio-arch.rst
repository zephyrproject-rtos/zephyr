...
The following tables show the required GATT sub-procedures for each of the
...
.. table:: GATT sub-procedures for LE Audio profiles
   ...
   | Exchange MTU                             |  C.1  |       |    I  |        |        |       |       |        |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Discover all primary services            |  C.2  |  C.2  |  I    |  C.2   |  C.2   |  C.2  |  C.2  |  C.2   |       |    C.2 |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Discover Primary services by UUID        |  C.2  |  C.2  |  I    |  C.2   |  C.2   |  C.2  |  C.2  |  C.2   |       |   C.2  |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Find Included Services                   |       |  O    |  I    |  M     |        |       |  O    |  C.6   |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Discover All characteristics of a server |  C.3  |  C.3  |  I    |  C.3   |  C.3   |       |  C.3  |  C.3   |       |  C.3   |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Discover Characteristic by UUID          |  C.3  |  C.3  |  I    |  C.3   |  C.3   |       |  C.3  |  C.3   |       |  C.3   |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Discover All Characteristic Descriptors  |  C.1  |  M    |  I    |  M     |        |       |  M    |  M     |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Read Characteristic Value                |  C.1  |  M    |  I    |  M     |        |  C.4  |  M    |  M     |       |  M     |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Read Using Characteristic UUID           |       |       |  I    |        |        |  C.4  |       |        |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Write Characteristic Value               |  C.1  |  C.4  |  I    |  M     |        |       |  C.4  |  M     |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Write Without Response                   |  C.1  |  C.4  |  I    |        |        |       |  C.4  |        |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Notifications                            |  C.1  |  M    |  I    |  O     |        |       |  M    |  M     |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Read Characteristic Descriptors          |  C.1  |  M    |  I    |  M     |        |       |  M    |  M     |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Write Characteristic Descriptors         |  C.1  |  M    |  I    |  C.5   |        |       |  M    |  M     |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Read Long Characteristic Value           |       |  M    |  I    |        |        |       |       |        |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
   | Write Long Characteristic Value          |  C.1  |       |  I    |        |        |       |       |        |       |        |
   +------------------------------------------+-------+-------+-------+--------+--------+-------+-------+--------+-------+--------+
...
* M Mandatory
* O Optional
* C.1 Mandatory for the Unicast client role
* C.2 Mandatory to support at least one Primary Service Discovery procedure
* C.3 Mandatory to support at least one Characteristic Discovery procedure
* C.4 Mandatory to support at least one
* C.5 Mandatory if the Notifications sub-procedure is supported
* C.6 Mandatory if AICS procedures are supported
* I Inherited
...
.. table:: GATT sub-procedures for LE Audio services
   ...
   +----------------------------------+--------+--------+--------+-------+--------+--------+-------+-------+--------+--------+-------+-------+--------+--------+
   | GATT sub-procedure               |  AICS  |  ASCS  |  BASS  |  CAS  |  CSIS  |  GMAS  |  HAS  |  MCS  |  MICS  |  PACS  |  TBS  |  VCS  |  VOCS  |  TMAS  |
   +==================================+========+========+========+=======+========+========+=======+=======+========+========+=======+=======+========+========+
...
* GMAS has no additional required GATT sub-procedures
* M Mandatory
