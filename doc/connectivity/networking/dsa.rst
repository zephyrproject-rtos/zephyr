...
For device driver, all needed to prepare are ``dsa_api``, private data if has, and ``dsa_port_config``.
The macro functions could be utilized. And below is an example of i.MX NETC.
