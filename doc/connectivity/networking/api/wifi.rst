...
To enable PSA crypto API supported Wi-Fi build, the :kconfig:option:`WIFI_NM_WPA_SUPPLICANT_CRYPTO_ALT` and the :kconfig:option:`WIFI_NM_WPA_SUPPLICANT_CRYPTO_MBEDTLS_PSA` need to be set.
