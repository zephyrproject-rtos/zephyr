...
:c:func:`k_ipi_signal`. Waiting for an IPI work item to be completed by the
targeted CPUs is done by calling :c:func:`k_ipi_work_wait`. Only a single
...
.. code-block:: c
    ...
    void my_isr(void)
    {
        ...
        k_ipi_work_add(&my_work, cpu_mask, remote_cpu_update);
