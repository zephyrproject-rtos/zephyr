...
The :c:macro:`RING_BUFFER_DECLARE` macro declares and statically initializes a ring buffer with the
specified size.
...
A ring buffer instance is declared using :c:macro:`RING_BUFFER_DECLARE()`.
...
.. code-block:: c
    ...
    RING_BUFFER_DECLARE(my_ring_buf, MY_RING_BUF_BYTES);
